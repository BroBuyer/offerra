...
{
    $map = [
        'en' => 'en-US', 'pl' => 'pl-PL', 'de' => 'de-CH', 'fr' => 'fr-FR',
...
{
    return SITE_NAME . ' Trading-Plattform auf dem Mobilgerät — Echtzeit-Chart BTC/USDT, Orderbuch und Kauf-/Verkaufsoberfläche';
}

function platform_image_caption(): string
{
    return SITE_NAME . ' — mobiles Trading mit Echtzeit-Kryptowährungs-Charts';
}
