<?php
// ─── Сайт / бренд / SEO ───────────────────────────────────────────────────
define('SITE_NAME', 'Tau Rendiheim');
define('SITE_URL', 'https://taurendiheim.org');
define('SITE_LANG', 'de');
...
define('CRM_FUNNEL', 'Tau Rendiheim');
define('CRM_COUNTRY', 'CH');
...
// ─── Форма ──────────────────────────────────────────────────────────────────
define('FORM_PHONE_COUNTRY', 'ch');
define('FORM_ALLOWED_COUNTRIES', 'ch');
...
define('KEITARO_CAMPAIGN_TOKEN', '6590651f5fe3328680542a88a6c0bb9ea5dce87'); // кампанія #646 taurendiheim
