...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__text">
      Ihre Anfrage bei <?= e(SITE_NAME) ?> wurde erhalten. Bitte erwarten Sie einen Anruf von unserem Berater.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <button type="submit" class="btn btn-primary btn-block submit">Kostenloses Konto eröffnen</button>
    ...
    <p class="form-legal">
      Mit dem Absenden Ihrer Daten akzeptieren Sie unsere
      <a href="privacy.php">Datenschutzerklärung</a> und die
