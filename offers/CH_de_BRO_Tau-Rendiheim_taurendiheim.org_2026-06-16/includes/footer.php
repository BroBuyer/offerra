...
<footer class="site-footer">
  <div class="container">
    ...
    <div class="footer-risk">
      <p>
        <?= e(SITE_NAME) ?> übernimmt keine Verantwortung für Verluste oder Schäden, die aus der Nutzung der Informationen auf dieser Website entstehen.
        Der Handel an Finanzmärkten ist mit Risiken verbunden. Investieren Sie nur Gelder, deren Verlust Sie sich leisten können. FX, CFDs und Kryptowährungen
        sind möglicherweise nicht für alle Anleger geeignet. Ziehen Sie in Erwägung, vor dem Handel einen qualifizierten Fachberater zu konsultieren.
      </p>
    </div>
