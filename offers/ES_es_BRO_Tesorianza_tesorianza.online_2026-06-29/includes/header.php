...
<header class="site-header" data-header>
  <div class="container header-inner">
    <a href="<?= page_url() ?>" class="logo" aria-label="<?= e(SITE_NAME) ?> — página de inicio">
    ...
    <div class="header-actions">
      <a href="sign.php" class="btn btn-primary btn-sm">Empezá ahora</a>
  ...
  <nav class="nav-mobile" data-mobile-nav aria-label="Navegación móvil" hidden>
    ...
    <a href="sign.php" class="btn btn-primary">Empezá ahora</a>
  </nav>
</header>
