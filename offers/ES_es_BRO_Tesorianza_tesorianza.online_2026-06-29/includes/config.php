<?php
// ─── Сайт / бренд / SEO ───────────────────────────────────────────────────
define('SITE_NAME', 'Tesorianza');
define('SITE_URL', 'https://tesorianza.online');
define('SITE_LANG', 'es');
...
define('CRM_API_KEY', 'define(\'CRM_API_KEY\', \'b15dtss21lmvlch8zheq1eukzb8840nw\');');
define('CRM_AFFILIATE_ID', 'BRO');
define('CRM_FUNNEL', 'Tesorianza');
define('CRM_COUNTRY', 'ES');
...
// ─── Форма ──────────────────────────────────────────────────────────────────
define('FORM_PHONE_COUNTRY', 'es');
define('FORM_ALLOWED_COUNTRIES', 'es');
...
define('KEITARO_CAMPAIGN_TOKEN', '63529997a2a879535c8a4cf6b61d5a317a7479'); // кампанія #680
