...
$page_description = 'Vytvořte si účet na ' . SITE_NAME . ' a začněte obchodovat s kryptoměnami, forexem a globálními trhy pomocí nástrojů podporovaných AI.';
...
<main>
  <section class="page-hero">
    <div class="container">
      ...
      <p class="lead">Připojte se k tisícům obchodníků. Minimální vklad <?= MIN_DEPOSIT ?> <?= CURRENCY ?>.</p>
    </div>
  </section>
  ...
  <section class="section-sm">
    <div class="container" style="max-width: 480px; margin-inline: auto;">
      <div class="form-card form-card-accent">
        <?php
        $form_id = 'signup-form';
        $form_heading = 'Zadejte své údaje níže';
