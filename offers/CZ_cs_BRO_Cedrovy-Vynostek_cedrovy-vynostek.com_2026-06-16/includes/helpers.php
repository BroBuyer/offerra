...
{
    return SITE_NAME . ' obchodní platforma na mobilu — graf BTC/USDT v reálném čase, kniha objednávek a rozhraní nákup/prodej';
}

function platform_image_caption(): string
{
    return SITE_NAME . ' — mobilní obchodování s grafy kryptoměn v reálném čase';
}
