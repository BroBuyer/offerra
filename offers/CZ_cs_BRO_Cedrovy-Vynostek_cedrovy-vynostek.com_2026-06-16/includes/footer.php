...
<footer class="site-footer">
  <div class="container">
    ...
    <div class="footer-risk">
      <p>
        <?= e(SITE_NAME) ?> nenese odpovědnost za případné ztráty nebo škody vyplývající z používání informací na tomto webu.
        Obchodování na finančních trzích je spojeno s rizikem. Investujte pouze prostředky, které si můžete dovolit ztratit. FX, CFD a kryptoměny
