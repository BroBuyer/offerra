...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__text">
      Vaše žádost u <?= e(SITE_NAME) ?> byla přijata. Vyčkejte prosím na telefonát od našeho manažera.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <button type="submit" class="btn btn-primary btn-block submit">Vytvořit účet zdarma</button>

    <?php
    $payment_context = 'registrace účtu';
    ...
    <p class="form-legal">
      ...
      <a href="conditions.php">podmínkami použití</a>.
    </p>
  </div>
</form>
