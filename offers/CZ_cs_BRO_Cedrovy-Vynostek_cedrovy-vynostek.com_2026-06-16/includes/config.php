<?php
// ─── Сайт / бренд / SEO ───────────────────────────────────────────────────
define('SITE_NAME', 'Cedrový Výnostek');
define('SITE_URL', 'https://cedrovy-vynostek.com');
define('SITE_LANG', 'cs');
...
define('CRM_FUNNEL', 'Cedrový Výnostek');
define('CRM_COUNTRY', 'CZ');
...
// ─── Форма ──────────────────────────────────────────────────────────────────
define('FORM_PHONE_COUNTRY', 'cz');
define('FORM_ALLOWED_COUNTRIES', 'cz');
...
define('KEITARO_CAMPAIGN_TOKEN', '709184b9a0a55a64ea9383632db46524c682b8'); // кампанія #623 cedrovyvynostek
