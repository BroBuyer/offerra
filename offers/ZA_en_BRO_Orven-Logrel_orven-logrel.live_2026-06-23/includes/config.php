<?php
// ─── Сайт / бренд / SEO ───────────────────────────────────────────────────
define('SITE_NAME', 'Orven Logrel');
define('SITE_URL', 'https://orven-logrel.live');
define('SITE_LANG', 'en');
...
define('CRM_FUNNEL', 'Orven Logrel');
define('CRM_COUNTRY', 'ZA');
...
// ─── Форма ──────────────────────────────────────────────────────────────────
define('FORM_PHONE_COUNTRY', 'za');
define('FORM_ALLOWED_COUNTRIES', 'za');
...
define('KEITARO_CAMPAIGN_TOKEN', '15843338472dc9c2f44b6f6722071d98fe7e6fa'); // кампанія #616 orvenlogrel
