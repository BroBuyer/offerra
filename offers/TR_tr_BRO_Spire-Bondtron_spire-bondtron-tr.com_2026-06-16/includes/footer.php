...
<footer class="site-footer">
  <div class="container">
    ...
    <div class="footer-risk">
      <p>
        <?= e(SITE_NAME) ?>, bu sitedeki bilgilerin kullanımından kaynaklanan olası kayıp veya zararlardan sorumlu değildir.
        Finansal piyasalarda işlem yapmak risk içerir. Yalnızca kaybetmeyi göze alabileceğiniz fonlarla yatırım yapın. FX, CFD ve kripto paralar
        her yatırımcı için uygun olmayabilir. İşlem yapmadan önce nitelikli bir uzmandan danışmanlık almayı değerlendirin.
      </p>
    </div>
