...
{
    return SITE_NAME . ' mobil işlem platformu — gerçek zamanlı BTC/USDT grafiği, emir defteri ve al/sat arayüzü';
}

function platform_image_caption(): string
{
    return SITE_NAME . ' — mobilde gerçek zamanlı kripto grafikleriyle işlem yapın';
}
