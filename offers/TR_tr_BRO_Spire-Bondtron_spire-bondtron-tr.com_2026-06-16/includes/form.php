...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__text">
      <?= e(SITE_NAME) ?> başvurunuz alındı. Sorumlumuzun sizi aramasını bekleyin.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <button type="submit" class="btn btn-primary btn-block submit">Ücretsiz hesap oluşturun</button>
