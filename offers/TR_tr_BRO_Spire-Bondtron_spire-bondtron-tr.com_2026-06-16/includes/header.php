...
<header class="site-header" data-header>
  <div class="container header-inner">
    ...
    <div class="header-actions">
      <a href="sign.php" class="btn btn-primary btn-sm">Hemen başlayın</a>
  ...
  <nav class="nav-mobile" data-mobile-nav aria-label="Mobil menü" hidden>
    ...
    <a href="sign.php" class="btn btn-primary">Hemen başlayın</a>
  </nav>
</header>
