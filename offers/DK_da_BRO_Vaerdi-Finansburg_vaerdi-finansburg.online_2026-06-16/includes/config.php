<?php
// ─── Сайт / бренд / SEO ───────────────────────────────────────────────────
define('SITE_NAME', 'Værdi Finansburg');
define('SITE_URL', 'https://vaerdi-finansburg.online');
define('SITE_LANG', 'da');
...
define('CRM_FUNNEL', 'Værdi Finansburg');
define('CRM_COUNTRY', 'DK');
...
// ─── Форма ──────────────────────────────────────────────────────────────────
define('FORM_PHONE_COUNTRY', 'dk');
define('FORM_ALLOWED_COUNTRIES', 'dk');
...
define('KEITARO_CAMPAIGN_TOKEN', '1349009d47671dfebea614a6e59a767cfd7e573'); // кампанія #659 vaerdifinansburg
