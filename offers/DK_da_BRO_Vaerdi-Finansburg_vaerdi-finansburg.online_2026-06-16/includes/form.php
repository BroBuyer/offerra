...
if (!in_array('dk', $allowed_countries, true)) {
    array_unshift($allowed_countries, 'dk');
}
...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__text">
      Vi har modtaget din forespørgsel hos <?= e(SITE_NAME) ?>. Vent venligst på et opkald fra vores rådgiver.
    </p>
  </div>
