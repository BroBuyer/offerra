...
$page_title = $page_title ?? SITE_NAME . ' | Handelsplatform';
$page_description = $page_description ?? 'Handl smartere med ' . SITE_NAME . ' — analyser i realtid, AI-signalering og en platform designet til krypto, forex og globale markeder.';
