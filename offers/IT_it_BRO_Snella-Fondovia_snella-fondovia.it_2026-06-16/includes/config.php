<?php
// ─── Сайт / бренд / SEO ───────────────────────────────────────────────────
define('SITE_NAME', 'Snella Fondovia');
define('SITE_URL', 'https://snella-fondovia.it');
define('SITE_LANG', 'it');                    
...
define('CRM_FUNNEL', 'Snella Fondovia');
...
define('KEITARO_CAMPAIGN_TOKEN', 'Xfx78snsN9hc5TJb');        // API токен (Загальні), НЕ ідентифікатор kHZgNVYx
