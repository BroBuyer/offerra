    ...
    <div class="container">
      <div class="trust-card">
        <div>
          ...
          <h3 style="margin-top: 0.75rem; font-size: 1.25rem;">A platform built for beginners</h3>
          <p style="margin-top: 0.5rem; color: var(--text-muted); max-width: 42rem;">
            Guided onboarding, dedicated support, and clear tools to help you trade with greater confidence.
          </p>
        </div>
      </div>
    </div>
