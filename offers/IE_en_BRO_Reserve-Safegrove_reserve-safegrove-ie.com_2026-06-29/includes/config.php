<?php
// ─── Сайт / бренд / SEO ───────────────────────────────────────────────────
define('SITE_NAME', 'Reserve Safegrove');
define('SITE_URL', 'https://reserve-safegrove-ie.com');
define('SITE_LANG', 'en');
...
define('CRM_FUNNEL', 'Reserve Safegrove');
define('CRM_COUNTRY', 'IE');
...
// ─── Форма ──────────────────────────────────────────────────────────────────
define('FORM_PHONE_COUNTRY', 'ie');
define('FORM_ALLOWED_COUNTRIES', 'ie');
...
define('KEITARO_CAMPAIGN_TOKEN', '8027151681532c10037d2ee02a3625da01ad04'); // кампанія #678
