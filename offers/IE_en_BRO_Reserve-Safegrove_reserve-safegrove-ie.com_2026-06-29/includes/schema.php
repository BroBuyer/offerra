...
function render_schema(string $page = 'home', array $extra = []): void {
    ...
    $organization = [
        ...
        'description' => 'AI-powered trading platform for crypto, forex, and global markets.',
    ];
    ...
    $software = [
        ...
        'description' => 'Smart trading platform with real-time market analysis and AI-assisted signals.',
