...
{
    return SITE_NAME . ' obchodná platforma na mobile — graf BTC/USDT v reálnom čase, order book a rozhranie nákup/predaj';
}

function platform_image_caption(): string
{
    return SITE_NAME . ' — obchodovanie z mobilu s grafmi kryptomien v reálnom čase';
}
