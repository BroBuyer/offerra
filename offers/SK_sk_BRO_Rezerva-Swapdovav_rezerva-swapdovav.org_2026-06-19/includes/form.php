...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__text">
      Vaša žiadosť v <?= e(SITE_NAME) ?> bola prijatá. Očakávajte hovor od nášho pracovníka.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <div class="form-grid">
      ...
      <label class="field field-full" data-field="email">
        ...
        <input class="input" type="email" name="email" placeholder="vy@email.sk" required autocomplete="email" inputmode="email">
      </label>
    ...
    <button type="submit" class="btn btn-primary btn-block submit">Vytvoriť účet zadarmo</button>

    <?php
    $payment_context = 'registrácia účtu';
    ...
    <p class="form-legal">
      Odoslaním údajov súhlasíte s našou
      <a href="privacy.php">Politikou ochrany súkromia</a> a
      <a href="conditions.php">Podmienkami používania</a>.
    </p>
  </div>
</form>
