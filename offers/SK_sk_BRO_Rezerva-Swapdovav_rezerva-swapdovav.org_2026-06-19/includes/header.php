...
<header class="site-header" data-header>
  <div class="container header-inner">
    ...
    <nav class="nav-desktop" aria-label="Hlavná navigácia">
      ...
      <a href="offer.php" class="<?= $active_page === 'offer' ? 'is-active' : '' ?>">Ponuka</a>
    ...
    <div class="header-actions">
      <a href="sign.php" class="btn btn-primary btn-sm">Začať teraz</a>
  ...
  <nav class="nav-mobile" data-mobile-nav aria-label="Mobilná navigácia" hidden>
    ...
    <a href="sign.php" class="btn btn-primary">Začať teraz</a>
  </nav>
</header>
