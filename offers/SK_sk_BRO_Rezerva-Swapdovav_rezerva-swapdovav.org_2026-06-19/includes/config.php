<?php
// ─── Сайт / бренд / SEO ───────────────────────────────────────────────────
define('SITE_NAME', 'Rezerva Swapdováv');
define('SITE_URL', 'https://rezerva-swapdovav.org');
define('SITE_LANG', 'sk');                    
...
define('CRM_FUNNEL', 'Rezerva Swapdováv');
define('CRM_COUNTRY', 'SK');        
...
// ─── Форма ──────────────────────────────────────────────────────────────────
define('FORM_PHONE_COUNTRY', 'sk');
define('FORM_ALLOWED_COUNTRIES', 'sk');
...
define('KEITARO_CAMPAIGN_TOKEN', 'wKhM9FQNpHPJpwZ2');        // API токен (Загальні), НЕ ідентифікатор kHZgNVYx
