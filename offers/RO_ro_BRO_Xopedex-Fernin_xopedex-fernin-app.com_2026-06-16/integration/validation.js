...
function setupFormValidation(form) {
  ...
  const phoneCountry = form.querySelector('input[name="phone_country"]')?.value || 'ro';
  ...
  form.addEventListener('submit', async (e) => {
    ...
    try {
      ...
      if (!data.ok) {
        showFormMessage(form, data.error || 'Ceva nu a funcționat. Încercați din nou mai târziu.');
        return;
      }
      ...
      console.error(err);
      showFormMessage(form, 'Eroare de conexiune. Verificați conexiunea la internet și încercați din nou.');
    } finally {
