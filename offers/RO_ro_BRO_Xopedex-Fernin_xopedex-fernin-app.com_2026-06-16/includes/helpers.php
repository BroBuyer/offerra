...
{
    return SITE_NAME . ' platformă de tranzacționare pe mobil — grafic BTC/USDT în timp real, carnet de ordine și interfață cumpără/vinde';
}

function platform_image_caption(): string
{
    return SITE_NAME . ' — tranzacționare de pe mobil cu grafice cripto în timp real';
}
