...
<footer class="site-footer">
  <div class="container">
    ...
    <div class="footer-risk">
      <p>
        <?= e(SITE_NAME) ?> nu este responsabil pentru eventuale pierderi sau daune rezultate din utilizarea informațiilor de pe acest site.
        Tranzacționarea pe piețele financiare implică riscuri. Investiți doar fonduri pe care vă puteți permite să le pierdeți. FX, CFD și criptomonedele
        pot să nu fie potrivite pentru toți investitorii. Luați în considerare consultarea unui profesionist calificat înainte de a tranzacționa.
      </p>
    </div>
