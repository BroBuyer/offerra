...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__text">
      Cererea ta la <?= e(SITE_NAME) ?> a fost primită. Așteaptă un apel de la reprezentantul nostru.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <button type="submit" class="btn btn-primary btn-block submit">Creează un cont gratuit</button>
    ...
    <p class="form-legal">
      Prin trimiterea datelor tale, accepți
      <a href="privacy.php">Politica de confidențialitate</a> și
      <a href="conditions.php">Termenii de utilizare</a>.
    </p>
  </div>
</form>
