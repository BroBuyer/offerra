...
<header class="site-header" data-header>
  <div class="container header-inner">
    <a href="<?= page_url() ?>" class="logo" aria-label="<?= e(SITE_NAME) ?> — página inicial">
    ...
    <div class="header-actions">
      <a href="sign.php" class="btn btn-primary btn-sm">Começar</a>
  ...
  <nav class="nav-mobile" data-mobile-nav aria-label="Navegação móvel" hidden>
    ...
    <a href="sign.php" class="btn btn-primary">Começar</a>
  </nav>
</header>
