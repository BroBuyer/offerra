...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__text">
      La tua richiesta con <?= e(SITE_NAME) ?> è stata ricevuta. Attendi una chiamata dal nostro responsabile.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <button type="submit" class="btn btn-primary btn-block submit">Crea un account gratuito</button>
    ...
    <p class="form-legal">
      ...
      <a href="privacy.php">Informativa sulla privacy</a> e i
