...
{
    return SITE_NAME . ' piattaforma di trading su mobile — grafico BTC/USDT in tempo reale, book ordini e interfaccia compra/vendi';
}

function platform_image_caption(): string
{
    return SITE_NAME . ' — trading da mobile con grafici sulle criptovalute in tempo reale';
}
