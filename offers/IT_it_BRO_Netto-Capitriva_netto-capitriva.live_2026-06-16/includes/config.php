<?php
// ─── Сайт / бренд / SEO ───────────────────────────────────────────────────
define('SITE_NAME', 'Netto Capitriva');
define('SITE_URL', 'https://netto-capitriva.live');
define('SITE_LANG', 'it');
...
define('CRM_FUNNEL', 'Netto Capitriva');
define('CRM_COUNTRY', 'IT');
...
// ─── Форма ──────────────────────────────────────────────────────────────────
define('FORM_PHONE_COUNTRY', 'it');
define('FORM_ALLOWED_COUNTRIES', 'it');
...
define('KEITARO_CAMPAIGN_TOKEN', '21699343e1bcadce7fe534f78bba7ed023a6d9f'); // кампанія #617 nettocapitriva
