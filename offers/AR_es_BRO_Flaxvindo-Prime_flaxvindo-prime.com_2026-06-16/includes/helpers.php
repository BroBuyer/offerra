...
define('PLATFORM_IMAGE_TEMPLATE', 'assets/img/platform/trading-platform-mobile.png');
...
function site_locale(): string
{
    $map = [
        ...
        'it' => 'it-IT', 'es' => 'es-AR', 'pt' => 'pt-PT', 'nl' => 'nl-NL',
...
function platform_image_path(): string
{
    ...
    $branded = 'assets/img/platform/' . site_slug() . '-trading-platform-mobile.png';
...
{
    return SITE_NAME . ' plataforma de trading en móvil — gráfico BTC/USDT en tiempo real, libro de órdenes e interfaz de compra/venta';
}

function platform_image_caption(): string
{
    return SITE_NAME . ' — trading desde el móvil con gráficos de criptomonedas en tiempo real';
}
