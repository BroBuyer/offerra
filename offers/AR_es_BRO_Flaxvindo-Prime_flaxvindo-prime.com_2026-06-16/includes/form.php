...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__text">
      Tu solicitud con <?= e(SITE_NAME) ?> fue recibida. Esperá una llamada de nuestro responsable.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <button type="submit" class="btn btn-primary btn-block submit">Creá una cuenta gratis</button>
