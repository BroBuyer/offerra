...
{
    return SITE_NAME . ' მობილური ტრეიდინგის პლატფორმა — BTC/USDT რეალურ დროში გრაფიკი, ორდერების წიგნი და ყიდვა/გაყიდვის ინტერფეისი';
}

function platform_image_caption(): string
{
    return SITE_NAME . ' — მობილური ტრეიდინგი კრიპტოვალუტების რეალურ დროში გრაფიკებით';
}
