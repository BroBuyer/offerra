...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__title">უკვე დარეგისტრირებული ხართ</p>
    <p class="form-already-registered__text">
      თქვენი მოთხოვნა <?= e(SITE_NAME) ?>-ში მიღებულია. დაელოდეთ ზარს ჩვენი მენეჯერისგან.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <div class="form-grid">
      <label class="field" data-field="fname">
        <span class="field-label">სახელი</span>
        <input
          class="input"
          type="text"
          name="fname"
      ...
      <label class="field" data-field="lname">
        <span class="field-label">გვარი</span>
        <input
          class="input"
          type="text"
          name="lname"
      ...
      <label class="field field-full" data-field="phone">
        <span class="field-label">ტელეფონი</span>
    ...
    <button type="submit" class="btn btn-primary btn-block submit">შექმენით უფასო ანგარიში</button>

    <?php
    $payment_context = 'ანგარიშის რეგისტრაცია';
    ...
    <p class="form-legal">
      მონაცემების გაგზავნით ეთანხმებით ჩვენს
      <a href="privacy.php">კონფიდენციალურობის პოლიტიკას</a> და
      <a href="conditions.php">გამოყენების პირობებს</a>.
    </p>
  </div>
</form>
