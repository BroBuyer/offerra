...
$page_title = $page_title ?? SITE_NAME . ' | ტრეიდინგის პლატფორმა';
$page_description = $page_description ?? 'ვაჭარეთ უფრო ჭკვიანურად ' . SITE_NAME . '-თან — რეალურ დროში ანალიტიკა, AI სიგნალები და სუფთა პლატფორმა კრიპტო, ფორექს და გლობალური ბაზრებისთვის.';
