  ...
  <section class="stats" aria-label="Platforma statistics">
    <div class="container stats-grid">
      ...
      <div class="stat-item">
        ...
        <div class="stat-label">Pārbaudīti lietotāji</div>
      </div>
      <div class="stat-item">
  ...
  <section class="platform-section" id="platform" aria-label="Tirdzniecības platforma preview">
    <div class="container platform-layout">
      ...
      <div class="platform-copy">
        <p class="eyebrow">Tirdzniecības platforma</p>
  ...
  <section class="section" id="features">
    <div class="container">
      <div class="section-header">
        ...
        <p class="lead">Drošība, speed, and intelligence — combined in one clean platform designed for modern traders.</p>
      </div>
    ...
    <div class="container">
      ...
      <div class="steps">
        <article class="step-card">
          <h3>Izveidojiet savu kontu</h3>
          <p>Reģistrēties with your details and get instant, secure access to the platform.</p>
        </article>
        <article class="step-card">
          <h3>Apstipriniet e-pastu</h3>
          <p>Confirm your address to unlock the full trading environment.</p>
        </article>
        <article class="step-card">
          <h3>Iemaksājiet kontā</h3>
          <p>Iemaksājiet vismaz <?= MIN_DEPOSIT ?> <?= CURRENCY ?> ar bankas pārskaitījumu, karti vai e-maku.</p>
        </article>
        <article class="step-card">
          <h3>Iestatiet stratēģiju</h3>
          <p>Define risk level and preferences — go manual or let AI automation handle execution.</p>
        </article>
        <article class="step-card">
          <h3>Sākt tirdzniecību</h3>
          <p>Enter the market with live charts, tools, and support whenever you need it.</p>
        </article>
      </div>

      <div style="text-align: center; margin-top: 2.5rem;">
        <a href="sign.php" class="btn btn-primary">Atvērt kontu now</a>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      ...
      <div class="specs-table">
        ...
        <div class="specs-row specs-row-highlight">
          ...
          <div class="specs-value">Professional 24/7 assistance — <a href="contacts.php" style="color: var(--accent); font-weight: 600;">Sazinieties ar mums</a></div>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="trust-card">
        <div>
          ...
          <h3 style="margin-top: 0.75rem; font-size: 1.25rem;"><?= e(SITE_NAME) ?> Atsauksmes</h3>
        </div>
