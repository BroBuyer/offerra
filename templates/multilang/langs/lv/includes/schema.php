...
function render_schema(string $page = 'home', array $extra = []): void {
    ...
    $organization = [
        ...
        'description' => 'AI-powered tirdzniecības platformas funkcijas for crypto, forex, and global markets.',
    ];
    ...
    $software = [
        ...
        'description' => 'Smart tirdzniecības platformas funkcijas with real-time market analysis and AI-assisted signals.',
