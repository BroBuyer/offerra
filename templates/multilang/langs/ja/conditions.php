...
$page_description = 'Read the terms and conditions for using the ' . SITE_NAME . ' 取引プラットフォーム and website.';
...
<main>
  ...
  <section class="section-sm">
    <div class="container prose">
      <p>By accessing <?= e(SITE_NAME) ?> you agree to these 利用規約. If you do not agree, please do not use our services.</p>
