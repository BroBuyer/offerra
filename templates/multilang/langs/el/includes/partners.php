...
$partners = [
    ...
    ['file' => 'partner-3.svg', 'alt' => 'MetaTrader — συνεργάτης πλατφόρμας συναλλαγών'],
    ...
    ['file' => 'partner-8.svg', 'alt' => 'Συνεργάτης συμμόρφωσης και χρηματοοικονομικής ασφάλειας'],
];
?>
<div class="partners-grid" role="list" aria-label="Αξιόπιστοι συνεργάτες υποδομής και πληρωμών του <?= e(SITE_NAME) ?>">
