...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__text">
      Έχουμε λάβει το αίτημά σας στο <?= e(SITE_NAME) ?>. Θα λάβετε σύντομα τηλεφώνημα από έναν ειδικό μας.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <p class="form-legal">
      ...
      <a href="privacy.php">Πολιτική απορρήτου</a> και τους
      <a href="conditions.php">Όρους χρήσης</a>.
    </p>
  </div>
</form>
