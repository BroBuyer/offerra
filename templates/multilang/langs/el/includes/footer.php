...
<footer class="site-footer">
  <div class="container">
    ...
    <div class="footer-risk">
      <p>
        Το <?= e(SITE_NAME) ?> δεν φέρει ευθύνη για ζημίες ή απώλειες που προκύπτουν από τη χρήση των πληροφοριών σε αυτόν τον ιστότοπο.
        Οι συναλλαγές στις χρηματοπιστωτικές αγορές ενέχουν κινδύνους. Επενδύστε μόνο κεφάλαια που μπορείτε να αντέξετε να χάσετε. Το forex, τα CFD και τα κρυπτονομίσματα
        ενδέχεται να μην είναι κατάλληλα για όλους τους επενδυτές. Πριν συναλλαγείτε, εξετάστε τη συμβουλή ενός εξειδικευμένου επαγγελματία.
      </p>
    </div>
