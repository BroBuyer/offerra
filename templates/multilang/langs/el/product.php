...
$page_description = 'Ανακαλύψτε τα εργαλεία συναλλαγών του ' . SITE_NAME . ' — ανάλυση σε πραγματικό χρόνο, σήματα AI, πρόσβαση σε πολλαπλές αγορές και αυτοματοποιημένες στρατηγικές.';
    ...
    <div class="container">
      <div class="features-grid">
        ...
        <article class="feature-card">
          ...
          <p>Τα μοντέλα machine learning αναδεικνύουν setups υψηλής πιθανότητας με σαφές πλαίσιο εισόδου και εξόδου.</p>
        </article>
        <article class="feature-card">
          <div class="feature-icon">
          ...
          <p>Ρυθμίστε bots με εξατομικευμένη διαχείριση κινδύνου: παρακολουθήστε και βελτιστοποιήστε, ή συναλλαγείτε χειροκίνητα παράλληλα.</p>
        </article>
        <article class="feature-card">
          <div class="feature-icon">
          ...
          <p>Εργαλεία stop-loss, take-profit και μεγέθους θέσης ενσωματωμένα σε κάθε λειτουργική ροή εργασίας.</p>
        </article>
        <article class="feature-card">
          <div class="feature-icon">
          ...
          <p>Ενιαία προβολή θέσεων, P&amp;L και κατανομής μεταξύ crypto και παραδοσιακών αγορών.</p>
        </article>
        <article class="feature-card">
          <div class="feature-icon">
      ...
      <div style="text-align: center; margin-top: 3rem;">
        <a href="sign.php" class="btn btn-primary">Δοκιμάστε το <?= e(SITE_NAME) ?> δωρεάν</a>
      </div>
    </div>
  </section>
</main>
