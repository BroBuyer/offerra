...
$page_description = 'Δημιουργήστε τον λογαριασμό σας στο ' . SITE_NAME . ' και ξεκινήστε συναλλαγές σε crypto, forex και παγκόσμιες αγορές με εργαλεία υποστηριζόμενα από AI.';
