...
$page_description = 'Κάντε συναλλαγές σε κρυπτονομίσματα, forex και παγκόσμιες αγορές με το ' . SITE_NAME . '. Ανάλυση σε πραγματικό χρόνο, σήματα με υποστήριξη AI και πλατφόρμα σχεδιασμένη για ταχύτητα και σαφήνεια.';
...
<main>
  ...
  <section class="hero">
    <div class="container hero-grid">
      <div class="hero-content">
        <p class="eyebrow">Πλατφόρμα συναλλαγών AI</p>
        <h1>Κάντε συναλλαγές πιο έξυπνα.<br><span class="text-accent">Αντιδράστε πιο γρήγορα.</span></h1>
        <p class="lead">
          Το νέο πρότυπο για συναλλαγές crypto και πολλαπλών αγορών. Προηγμένη ασφάλεια, διαφανή κόστη,
        ...
        <a href="sign.php" class="btn btn-primary">Ξεκινήστε συναλλαγές — ελάχ. <?= MIN_DEPOSIT ?> <?= CURRENCY ?></a>
      </div>
  ...
  <section class="platform-section" id="platform" aria-label="Επισκόπηση πλατφόρμας συναλλαγών">
    <div class="container platform-layout">
      <?php require __DIR__ . '/includes/platform-image.php'; ?>

      <div class="platform-copy">
        <p class="eyebrow">Πλατφόρμα συναλλαγών</p>
        <h2>Επαγγελματικά γραφήματα.<br>Έτοιμη για κινητό.</h2>
        <p class="lead">
          Καθαρή διεπαφή εμπνευσμένη από σύγχρονα ανταλλακτήρια, με δεδομένα BTC/USDT σε πραγματικό χρόνο, διαχείριση χαρτοφυλακίου
          και λειτουργία με ένα κλικ. Σχεδιασμένη για να σας δίνει σιγουριά από την πρώτη σύνδεση.
        </p>
        <ul class="platform-points">
          <li>Γραφήματα κηροπήγιο σε πραγματικό χρόνο</li>
          <li>Χαρτοφυλάκιο και P/L με μια ματιά</li>
          <li>Ασφαλής πίνακας λογαριασμού</li>
        </ul>
  ...
  <section class="section" id="features">
    <div class="container">
      <div class="section-header">
        ...
        <h2>Όλα όσα χρειάζεστε για να συναλλάσσεστε με εμπιστοσύνη</h2>
        <p class="lead">Ασφάλεια, ταχύτητα και ευφυΐα σε μία σαφή πλατφόρμα σχεδιασμένη για σύγχρονους traders.</p>
      </div>
      ...
      <div class="features-grid">
        ...
        <article class="feature-card">
          ...
          <h3>Σήματα αγοράς AI</h3>
          <p>Ακριβή insights σε πραγματικό χρόνο σάς βοηθούν να εντοπίζετε ευκαιρίες και να παίρνετε ταχύτερες, καλύτερα ενημερωμένες αποφάσεις.</p>
        </article>
        <article class="feature-card">
          <div class="feature-icon">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/></svg>
          </div>
          <h3>Αυτοματοποιημένες συναλλαγές</h3>
          <p>Τα bots με υποστήριξη AI λειτουργούν 24/7 για αποδοτική εκτέλεση στρατηγικών, ενώ διατηρείτε τον πλήρη έλεγχο.</p>
        </article>
        <article class="feature-card">
          <div class="feature-icon">
          ...
          <h3>Πρόσβαση σε πολλαπλές αγορές</h3>
          <p>Κάντε συναλλαγές σε crypto, forex, μετοχές και εμπορεύματα σε ένα ενιαίο περιβάλλον.</p>
        </article>
        <article class="feature-card">
          <div class="feature-icon">
        ...
        <article class="feature-card">
          ...
          <p>Μινιμαλιστικός σχεδιασμός που μειώνει τους περισπασμούς και σάς επιτρέπει να εστιάζετε στη στρατηγική, όχι στην πλοήγηση.</p>
        </article>
      </div>
    </div>
  </section>
  ...
  <section class="section section-sm" style="background: var(--surface); border-block: 1px solid var(--border);">
    <div class="container split">
      <div>
        ...
        <h2>Συναλλαγές σε Bitcoin, Ethereum και άλλα assets</h2>
  ...
  <section class="section" id="how-it-works">
    <div class="container">
      <div class="section-header centered">
        ...
        <h2>Από την εγγραφή στην πρώτη συναλλαγή σε λίγα λεπτά</h2>
        <p class="lead">Μια σαφής διαδρομή, χωρίς περιττή πολυπλοκότητα ή αβεβαιότητα.</p>
      </div>

      <div class="steps">
        <article class="step-card">
          <h3>Δημιουργήστε τον λογαριασμό σας</h3>
          <p>Εγγραφείτε με τα στοιχεία σας και αποκτήστε άμεση και ασφαλή πρόσβαση στην πλατφόρμα.</p>
        </article>
        <article class="step-card">
          <h3>Επαληθεύστε το email</h3>
          <p>Επιβεβαιώστε τη διεύθυνσή σας και ξεκλειδώστε την πλήρη εμπειρία συναλλαγών.</p>
        </article>
        <article class="step-card">
        ...
        <article class="step-card">
          <h3>Ξεκινήστε τις συναλλαγές</h3>
  ...
  <section class="section-sm payment-section">
    <div class="container" style="max-width: 720px; margin-inline: auto; text-align: center;">
      ...
      <h2 style="margin-bottom: 0.75rem;">Καταθέστε με τις μεθόδους που ήδη χρησιμοποιείτε</h2>
      <p class="lead" style="margin-bottom: 1.75rem;">Κάρτες, e-wallet και τραπεζικές μεταφορές, προστατευμένες με κρυπτογράφηση SSL.</p>
      <?php
    ...
    <div class="container">
      ...
      <div class="reviews-grid">
        <article class="review-card">
          ...
          <p class="review-text">Η εγγραφή πήρε λίγα λεπτά, τα κόστη είναι διαφανή και η υποστήριξη απαντά πραγματικά. Μια ομαλή και αξιόπιστη εμπειρία στην οποία συνεχίζω να βασίζομαι.</p>
        ...
        <article class="review-card">
          <div class="review-stars">★★★★★</div>
          <p class="review-text">Εδώ ξεκίνησα επιτέλους συναλλαγές crypto χωρίς κανένα παράπονο. Γρήγορη ρύθμιση και όλα εξηγημένα με σαφήνεια. Εξαιρετική επιλογή, ειδικά για να ξεκινήσετε σωστά.</p>
          <div class="review-author">
        ...
        <article class="review-card">
          <div class="review-stars">★★★★★</div>
          <p class="review-text">Σταθερή και αξιόπιστη. Απλό άνοιγμα λογαριασμού, σαφείς όροι και ικανή ομάδα. Μια εμπειρία συναλλαγών απροσδόκητα άνετη.</p>
          <div class="review-author">
        ...
        <article class="review-card">
          <div class="review-stars">★★★★★</div>
          <p class="review-text">Οι συναλλαγές δεν φαίνονται πλέον τόσο περίπλοκες όσο πριν. Απλή εγγραφή, σαφή κόστη και υποστήριξη όταν χρειάζεται. Για όσους ξεκινούν, κάνει πραγματικά τη διαφορά.</p>
          <div class="review-author">
            <div class="review-avatar">LP</div>
            <div>
              <div class="review-name">Laura Price</div>
              <div class="review-role">Ιδιώτρια επενδύτρια</div>
            </div>
          </div>
        </article>
      </div>
        ...
        <div class="faq-item">
          ...
          <div class="faq-content">
            <div class="faq-content-inner">
              Δημιουργήστε τον λογαριασμό σας με βασικά στοιχεία, ολοκληρώστε έναν σύντομο έλεγχο και καταθέστε τουλάχιστον <?= MIN_DEPOSIT ?> <?= CURRENCY ?>. Θα έχετε πλήρη πρόσβαση στην πλατφόρμα: ζωντανά γραφήματα, εργαλεία συναλλαγών και υποστηριζόμενη ένταξη.
            </div>
          </div>
        </div>
        <div class="faq-item">
          <button class="faq-trigger" type="button" aria-expanded="false">
            Είναι ασφαλή τα κεφάλαια και τα δεδομένα μου;
            <span class="faq-icon" aria-hidden="true"></span>
          </button>
          <div class="faq-content">
            <div class="faq-content-inner">
              Χρησιμοποιούμε κρυπτογράφηση SSL, έλεγχο ταυτότητας δύο παραγόντων και ασφαλείς διαδικασίες μέσω αξιόπιστων παρόχων. Τα προσωπικά σας δεδομένα αντιμετωπίζονται σύμφωνα με αυστηρά πρότυπα ασφαλείας.
            </div>
          </div>
        </div>
        <div class="faq-item">
          <button class="faq-trigger" type="button" aria-expanded="false">
            Πότε μπορώ να κάνω ανάληψη των κερδών;
            <span class="faq-icon" aria-hidden="true"></span>
          </button>
          <div class="faq-content">
            <div class="faq-content-inner">
              Μπορείτε να ζητήσετε ανάληψη ανά πάσα στιγμή από τον πίνακα ελέγχου. Η επεξεργασία διαρκεί συνήθως από 1 έως 3 εργάσιμες ημέρες. Κόστος και χρόνοι αναφέρονται πάντα εκ των προτέρων, χωρίς εκπλήξεις.
            </div>
          </div>
        </div>
        <div class="faq-item">
          <button class="faq-trigger" type="button" aria-expanded="false">
            Χρειάζομαι εμπειρία στις συναλλαγές;
            <span class="faq-icon" aria-hidden="true"></span>
          </button>
          <div class="faq-content">
            <div class="faq-content-inner">
              Καθόλου. Η υποστηριζόμενη ένταξη, οι διαισθητικοί οδηγοί και τα εργαλεία με υποστήριξη AI σάς βοηθούν να εξελιχθείτε με τον δικό σας ρυθμό. Και για κάθε επίπεδο εμπειρίας, η υποστήριξη είναι διαθέσιμη 24/7.
            </div>
          </div>
        </div>
        <div class="faq-item">
          <button class="faq-trigger" type="button" aria-expanded="false">
            Σε ποιες αγορές μπορώ να συναλλάσσομαι;
            <span class="faq-icon" aria-hidden="true"></span>
          </button>
          <div class="faq-content">
            <div class="faq-content-inner">
              Αποκτήστε πρόσβαση σε κρυπτονομίσματα, forex, παγκόσμιες μετοχές και εμπορεύματα σε μία ενιαία διεπαφή. Δεδομένα σε πραγματικό χρόνο, ενσωματωμένη ανάλυση και υποστήριξη τόσο για χειροκίνητες όσο και για αυτοματοποιημένες στρατηγικές.
            </div>
          </div>
        </div>
      </div>
  ...
  <section class="section-sm">
    <div class="container">
      <div class="section-header" style="margin-bottom: 2rem;">
        ...
        <h2>Βασικές λειτουργίες με μια ματιά</h2>
      </div>

      <div class="specs-table">
        <div class="specs-row">
          <div class="specs-label">Μηχανή συναλλαγών AI</div>
          <div class="specs-value">Προηγμένη ανάλυση αγοράς με machine learning</div>
        </div>
        <div class="specs-row">
          <div class="specs-label">Μέθοδοι χρηματοδότησης</div>
          <div class="specs-value">Κάρτες πληρωμής, τραπεζικές μεταφορές, PayPal, e-wallet</div>
        </div>
        <div class="specs-row">
          <div class="specs-label">Πρόσβαση από συσκευή</div>
          <div class="specs-value">Web, tablet και κινητό, πλήρως responsive</div>
        </div>
        <div class="specs-row">
        ...
        <div class="specs-row">
          <div class="specs-label">Ένταξη</div>
          <div class="specs-value">Γρήγορη ρύθμιση λογαριασμού με υποστηριζόμενη επαλήθευση</div>
        </div>
  ...
  <section class="section-sm">
    <div class="container">
      <div class="trust-card">
        <div>
          <span class="trust-badge">Αξιόπιστο</span>
  ...
  <section class="cta-band">
    <div class="container cta-band-grid">
      <div>
        <h2>Έτοιμοι να συναλλάσσεστε σε πλατφόρμα σχεδιασμένη για μέγιστη σαφήνεια;</h2>
      ...
      <div class="form-card">
        <?php
        $form_id = 'bottom-form';
        $form_heading = 'Δημιουργήστε τον δωρεάν λογαριασμό σας';
        require __DIR__ . '/includes/form.php';
        ?>
      </div>
    </div>
