...
$page_title = page_title('AI-Powered Prekybos platforma');
...
<main>
  ...
  <section class="hero">
    <div class="container hero-grid">
      <div class="hero-content">
        <p class="eyebrow">AI Prekybos platforma</p>
        ...
        <a href="sign.php" class="btn btn-primary">Pradėkite prekiauti — <?= MIN_DEPOSIT ?> <?= CURRENCY ?> min.</a>
      </div>

      <div class="form-card form-card-accent">
        <?php
        $form_id = 'hero-form';
        $form_heading = 'Atidarykite savoaccount in 2 minutes';
  ...
  <section class="stats" aria-label="Platforma statistics">
    <div class="container stats-grid">
      ...
      <div class="stat-item">
        ...
        <div class="stat-label">Patvirtinti vartotojai</div>
      </div>
      <div class="stat-item">
  ...
  <section class="platform-section" id="platform" aria-label="Prekybos platforma preview">
    <div class="container platform-layout">
      <?php require __DIR__ . '/includes/platform-image.php'; ?>

      <div class="platform-copy">
        <p class="eyebrow">Prekybos platforma</p>
        ...
        <ul class="platform-points">
          ...
          <li>Saugus account dashboard</li>
        </ul>
  ...
  <section class="section" id="features">
    <div class="container">
      <div class="section-header">
        ...
        <p class="lead">Saugumas, speed, and intelligence — combined in one clean platform designed for modern traders.</p>
      </div>
    ...
    <div class="container">
      ...
      <div class="steps">
        <article class="step-card">
          <h3>Susikurkite paskyrą</h3>
          <p>Užsiregistruoti with your details and get instant, secure access to the platform.</p>
        </article>
        <article class="step-card">
          <h3>Patvirtinkite el. pašto adresą</h3>
          <p>Confirm your address to unlock the full trading environment.</p>
        </article>
        <article class="step-card">
          <h3>Finansuokite savo sąskaitą</h3>
          <p>Įnešti mažiausiai<?= MIN_DEPOSIT ?> <?= CURRENCY ?>banko pavedimu, kortele arba elektronine pinigine.</p>
        </article>
        <article class="step-card">
          <h3>Nustatykite savo strategiją</h3>
          <p>Define risk level and preferences — go manual or let AI automation handle execution.</p>
        </article>
        <article class="step-card">
          <h3>Pradėkite prekiauti</h3>
          <p>Enter the market with live charts, tools, and support whenever you need it.</p>
        </article>
      </div>

      <div style="text-align: center; margin-top: 2.5rem;">
        <a href="sign.php" class="btn btn-primary">Atidaryti sąskaitą now</a>
      </div>
    </div>
  </section>
  ...
  <section class="section-sm">
    <div class="container">
      <div class="section-header centered" style="margin-bottom: 2rem;">
        <p class="eyebrow">Patikimas infrastructure</p>
  ...
  <section class="section-sm">
    <div class="container">
      ...
      <div class="specs-table">
        ...
        <div class="specs-row">
          <div class="specs-label">Rinkos</div>
        ...
        <div class="specs-row specs-row-highlight">
          <div class="specs-label">Palaikymas</div>
          <div class="specs-value">Professional 24/7 assistance — <a href="contacts.php" style="color: var(--accent); font-weight: 600;">Susisiekite su mumis</a></div>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section-sm">
    <div class="container">
      <div class="trust-card">
        <div>
          <span class="trust-badge">Patikimas</span>
          <h3 style="margin-top: 0.75rem; font-size: 1.25rem;"><?= e(SITE_NAME) ?> Atsiliepimai</h3>
        </div>
        <div class="trust-score">4.7</div>
        <div class="trust-stars">★★★★★</div>
        <div class="trust-meta">
          <strong>342</strong> reviews · Remiantis<strong>1,842</strong> ratings
        </div>
      </div>
    </div>
  </section>
