...
$page_description = 'Read the terms and conditions for using the ' . SITE_NAME . 'prekybos platforma and website.';
...
<main>
  ...
  <section class="section-sm">
    <div class="container prose">
      <p>By accessing <?= e(SITE_NAME) ?> you agree to these Naudojimo sąlygos. If you do not agree, please do not use our services.</p>
