...
$page_title = page_title_lead('Penawaran');
$page_description = 'Choose your ' . SITE_NAME . ' plan — start with a ' . MIN_DEPOSIT . ' ' . CURRENCY . ' minimum deposit and unlock the full platform trading.';
$page_canonical = page_url('offer.php');
$active_page = 'offer';
$schema_extra = ['breadcrumb' => [
  ['@type' => 'ListItem', 'position' => 1, 'name' => 'Home', 'item' => page_url()],
  ['@type' => 'ListItem', 'position' => 2, 'name' => 'Penawaran', 'item' => page_url('offer.php')],
]];
    ...
    <div class="container" style="max-width: 900px; margin-inline: auto;">
      <div class="specs-table" style="margin-bottom: 2rem;">
        <div class="specs-row specs-row-highlight">
          ...
          <div class="specs-value"><strong><?= MIN_DEPOSIT ?> <?= CURRENCY ?></strong> minimum deposit · Full platform · AI signals · Dukungan 24/7</div>
        </div>
        <div class="specs-row">
