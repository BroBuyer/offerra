...
$page_description = 'Valitse ' . SITE_NAME . '-pakettisi — aloita vähintään ' . MIN_DEPOSIT . ' ' . CURRENCY . ' talletuksella ja avaa koko kaupankäyntialusta.';
...
<main>
  <section class="page-hero">
    <div class="container">
      ...
      <h1>Hanki salkunseuranta — ilmaisena rekisteröitymisen yhteydessä</h1>
      <p class="lead">Aloita <?= MIN_DEPOSIT ?> <?= CURRENCY ?>. Skaalaa, kun olet valmis.</p>
    </div>
  </section>
    ...
    <div class="container" style="max-width: 900px; margin-inline: auto;">
      <div class="specs-table" style="margin-bottom: 2rem;">
        <div class="specs-row specs-row-highlight">
          ...
          <div class="specs-value"><strong><?= MIN_DEPOSIT ?> <?= CURRENCY ?></strong> minimitalletus · Koko alusta · Tekoälysignaalit · Tuki 24/7</div>
        </div>
        <div class="specs-row">
          <div class="specs-label">Mitä sisältyy</div>
          <div class="specs-value">Live-kaaviot, monimarkkinakaupankäynti, salkunseuranta, ohjattu aloitus</div>
        </div>
        <div class="specs-row">
