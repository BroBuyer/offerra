...
$page_description = 'Luo ' . SITE_NAME . '-tilisi ja aloita kaupankäynti kryptolla, valuuttamarkkinoilla ja maailmanmarkkinoilla tekoälypohjaisilla työkaluilla.';
...
<main>
  <section class="page-hero">
    <div class="container">
      ...
      <p class="lead">Liity tuhansien treidaajien joukkoon. Minimitalletus <?= MIN_DEPOSIT ?> <?= CURRENCY ?>.</p>
    </div>
  </section>
