...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__text">
      Pyyntösi palvelussa <?= e(SITE_NAME) ?> on vastaanotettu. Odota puhelua asiantuntijaltamme.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <button type="submit" class="btn btn-primary btn-block submit">Luo ilmainen tili</button>
    ...
    <p class="form-legal">
      ...
      <a href="privacy.php">tietosuojakäytäntömme</a> ja
      <a href="conditions.php">käyttöehtomme</a>.
    </p>
  </div>
</form>
