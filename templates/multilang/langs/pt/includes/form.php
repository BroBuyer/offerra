...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__text">
      O seu pedido com a <?= e(SITE_NAME) ?> foi recebido. Aguarde uma chamada do nosso gestor.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <div class="form-grid">
      <label class="field" data-field="fname">
        <span class="field-label">Nome próprio</span>
        <input
          class="input"
          type="text"
          name="fname"
    ...
    <button type="submit" class="btn btn-primary btn-block submit">Criar conta gratuita</button>
    ...
    <p class="form-legal">
      Ao submeter os seus dados, aceita a nossa
      <a href="privacy.php">Política de Privacidade</a> e os
