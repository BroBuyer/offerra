...
$page_description = 'Kontakta supporten til ' . SITE_NAME . ' eller tradingteamet vårt. Vi er tilgjengelige 24/7.';
...
<main>
  <section class="page-hero">
    <div class="container">
      ...
      <p class="lead">Profesjonell 24/7-support for kontospørsmål, handel og tekniske emner.</p>
    </div>
  </section>
