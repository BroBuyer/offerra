...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__text">
      Vaš zahtjev s <?= e(SITE_NAME) ?> je zaprimljen. Pričekajte poziv našeg upravitelja.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <div class="form-grid">
      ...
      <label class="field field-full" data-field="email">
        <span class="field-label">E-pošta</span>
    ...
    <button type="submit" class="btn btn-primary btn-block submit">Stvorite besplatni račun</button>
    ...
    <p class="form-legal">
      Slanjem svojih podataka prihvaćate našu
      <a href="privacy.php">Politiku privatnosti</a> i
      <a href="conditions.php">Uvjete korištenja</a>.
    </p>
  </div>
</form>
