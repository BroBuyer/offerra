...
$page_title = page_title_lead('Personvernbeleid');
...
<main>
  ...
  <section class="section-sm">
    <div class="container prose">
      ...
      <p>Avhengig av jurisdiksjonen din kan du ha rett til innsyn, retting eller sletting av personopplysninger. Kontakt oss via <?= e(SUPPORT_EMAIL) ?> for å utøve disse rettighetene.</p>

      <h2>Kontakt</h2>
      <p>Spørsmål om denne policyen? Kontakt oss via <a href="mailto:<?= e(SUPPORT_EMAIL) ?>" style="color: var(--accent);"><?= e(SUPPORT_EMAIL) ?></a></p>
    </div>
  </section>
</main>
