...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__text">
      Wir haben Ihre Anfrage bei <?= e(SITE_NAME) ?> erhalten. Unser Spezialist wird Sie in Kürze telefonisch kontaktieren.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <button type="submit" class="btn btn-primary btn-block submit">Kostenloses Konto erstellen</button>
    ...
    <p class="form-legal">
      Mit dem Absenden Ihrer Daten stimmen Sie unserer
      <a href="privacy.php">Datenschutzerklärung</a> und den
      <a href="conditions.php">Nutzungsbedingungen</a> zu.
    </p>
  </div>
</form>
