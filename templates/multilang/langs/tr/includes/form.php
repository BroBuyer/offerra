...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__text">
      <?= e(SITE_NAME) ?> için başvurunuzu aldık. Uzman ekibimiz kısa süre içinde sizinle iletişime geçecektir.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <button type="submit" class="btn btn-primary btn-block submit">Ucretsiz hesap olustur</button>
    ...
    <p class="form-legal">
      ...
      <a href="privacy.php">Gizlilik Politikamızı</a> ve
      <a href="conditions.php">Kullanım Koşullarımızı</a> kabul etmiş olursunuz.
    </p>
  </div>
</form>
