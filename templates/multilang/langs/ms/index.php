...
<main>
  ...
  <section class="platform-section" id="platform" aria-label="Platform dagangan preview">
    <div class="container platform-layout">
      <?php require __DIR__ . '/includes/platform-image.php'; ?>

      <div class="platform-copy">
        <p class="eyebrow">Platform dagangan</p>
  ...
  <section class="section" id="features">
    <div class="container">
      <div class="section-header">
        ...
        <p class="lead">Keselamatan, speed, and intelligence — combined in one clean platform designed for modern traders.</p>
      </div>
    ...
    <div class="container">
      ...
      <div class="steps">
        <article class="step-card">
          <h3>Cipta akaun anda</h3>
          <p>Daftar with your details and get instant, secure access to the platform.</p>
        </article>
        <article class="step-card">
          <h3>Sahkan e-mel anda</h3>
          <p>Confirm your address to unlock the full trading environment.</p>
        </article>
        <article class="step-card">
          <h3>Biayai akaun anda</h3>
          <p>Deposit minimum <?= MIN_DEPOSIT ?> <?= CURRENCY ?> melalui pindahan bank, kad atau e-wallet.</p>
        </article>
        <article class="step-card">
  ...
  <section class="section-sm">
    <div class="container">
      ...
      <div class="specs-table">
        ...
        <div class="specs-row">
          <div class="specs-label">Pasaran</div>
        ...
        <div class="specs-row specs-row-highlight">
          <div class="specs-label">Sokongan</div>
