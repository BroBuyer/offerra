  ...
  <section class="section">
    <div class="container split-lumen">
      <div>
        ...
        <p class="lead">
          Insight muncul ketika ia membantu — pendek, mudah dibaca dan mudah ditindak. Anda sentiasa sahkan setiap dagangan sendiri.
        </p>
        <ul class="feature-list">
          <li>Ringkasan pasar dalam bahasa mudah</li>
