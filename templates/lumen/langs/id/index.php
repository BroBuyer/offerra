...
$page_description = 'Platform pelaburan mudah dikuasakan AI — pasar yang jelas, keputusan berpandu dan pembukaan akun cepat di ' . SITE_NAME . '.';
  ...
  <section class="hero-lumen" aria-label="Pengenalan">
    ...
    <div class="container hero-lumen__grid">
      <div class="hero-lumen__copy">
        ...
        <p class="lead">
          Platform pelaburan moden yang menjelaskan pasar dalam bahasa mudah, menonjolkan insight AI yang berguna, dan membantu anda membuat dagangan tanpa kekacauan.
        </p>
    ...
    <div class="container">
      ...
      <ol class="steps-lumen">
        <li data-reveal>
          ...
          <p>Kongsi beberapa detail. Pengesahan singkat dan berpandu.</p>
        </li>
        <li data-reveal>
        ...
        <li data-reveal>
          ...
          <p>Ikuti insight dalam bahasa mudah dan letakkan pesanan ketika anda bersedia.</p>
        </li>
      </ol>
    </div>
  </section>
  ...
  <section class="section" id="ai">
    <div class="container split-lumen">
      <div data-reveal>
        ...
        <p class="lead">
          <?= e(SITE_NAME) ?> menukar hingar pasar kepada petunjuk pendek yang mudah dibaca — supaya anda kurang meneka dan lebih banyak memutuskan.
        </p>
        <ul class="feature-list">
          <li>Petunjuk beli / pegang / pantau yang jelas</li>
          <li>Peringatan risiko sebelum anda sahkan</li>
          <li>Antarmuka yang kekal tenang di bawah tekanan</li>
        </ul>
        <a href="sign.php" class="btn btn-primary">Coba platform</a>
      </div>
      <aside class="insight-panel" data-reveal aria-label="Contoh insight">
        ...
        <div class="insight-panel__meta">
          ...
          <span>Dipembaruan sebentar tadi</span>
        </div>
      </aside>
    </div>
  </section>
  ...
  <section class="section section-ink" id="join">
    <div class="container join-lumen" data-reveal>
      <div>
        ...
        <h2>Cipta <?= e(SITE_NAME) ?> akun Anda</h2>
      ...
      <div class="join-lumen__form">
        <?php
        $form_id = 'home-form';
        $form_heading = 'Buka dalam masa kurang 2 menit';
  ...
  <section class="section section-paper" id="trust">
    <div class="container" data-reveal>
      <div class="section-intro">
        ...
        <p class="lead">Pembayaran dan akses pasar melalui penyedia yang mapan.</p>
      </div>
      ...
      <div class="faq-list" data-faq>
        ...
        <div class="faq-item">
          ...
          <div class="faq-content">
            <div class="faq-content-inner">
              Anda bisa mula dari <?= MIN_DEPOSIT ?> <?= CURRENCY ?>. Yuran kekal kelihatan sebelum anda sahkan.
            </div>
          </div>
        </div>
        <div class="faq-item">
          <button class="faq-trigger" type="button" aria-expanded="false">
            Adakah dukungan tersedia?
            <span class="faq-icon" aria-hidden="true"></span>
          </button>
          <div class="faq-content">
            <div class="faq-content-inner">
              Ya — pasukan kami tersedia sepanjang masa untuk membantu pembiayaan dan penyediaan akun.
            </div>
          </div>
        </div>
      </div>
