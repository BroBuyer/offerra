...
<header class="site-header" data-header>
  <div class="container header-inner">
    ...
    <nav class="nav-desktop" aria-label="Κύρια πλοήγηση">
      ...
      <a href="product.php" class="<?= $active_page === 'product' ? 'is-active' : '' ?>">Πλατφόρμα</a>
      <a href="offer.php" class="<?= $active_page === 'offer' ? 'is-active' : '' ?>">Τιμολόγηση</a>
      <a href="faq.php" class="<?= $active_page === 'faq' ? 'is-active' : '' ?>">Συχνές ερωτήσεις</a>
      <a href="contacts.php" class="<?= $active_page === 'contacts' ? 'is-active' : '' ?>">Επικοινωνία</a>
    </nav>

    <div class="header-actions">
      <a href="sign.php" class="btn btn-primary btn-sm">Άνοιγμα λογαριασμού</a>
  ...
  <nav class="nav-mobile" data-mobile-nav aria-label="Πλοήγηση για κινητά" hidden>
