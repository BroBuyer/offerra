...
$page_title = $page_title ?? SITE_NAME . ' | Πλατφόρμα επενδύσεων με ΤΝ';
$page_description = $page_description ?? 'Επενδύστε και διαπραγματευτείτε με το ' . SITE_NAME . ' — μια καθαρή πλατφόρμα με υποστήριξη ΤΝ, σχεδιασμένη να κρατά τις αγορές απλές.';
