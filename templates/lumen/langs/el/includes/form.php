...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__text">
      Το αίτημά σας με <?= e(SITE_NAME) ?> ελήφθη. Περιμένετε κλήση από τον σύμβουλό μας.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <div class="form-grid">
      ...
      <label class="field field-full" data-field="email">
        ...
        <input class="input" type="email" name="email" placeholder="eg@email.com" required autocomplete="email" inputmode="email">
      </label>
    ...
    <button type="submit" class="btn btn-primary btn-block submit">Δημιουργία δωρεάν λογαριασμού</button>
    ...
    <p class="form-legal">
      Υποβάλλοντας τα στοιχεία σας, αποδέχεστε την
      <a href="privacy.php">Πολιτική απορρήτου</a> and
