...
<?php endif; ?>
    ...
    <button type="submit" class="btn btn-primary btn-block submit">Gratis account aanmaken</button>
    ...
    <p class="form-legal">
      Door uw gegevens te versturen gaat u akkoord met ons
      <a href="privacy.php">Privacybeleid</a> en de
