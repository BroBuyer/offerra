...
<header class="site-header" data-header>
  <div class="container header-inner">
    ...
    <nav class="nav-desktop" aria-label="Ana gezinme">
      ...
      <a href="offer.php" class="<?= $active_page === 'offer' ? 'is-active' : '' ?>">Fiyatlandırma</a>
      <a href="faq.php" class="<?= $active_page === 'faq' ? 'is-active' : '' ?>">SSS</a>
      <a href="contacts.php" class="<?= $active_page === 'contacts' ? 'is-active' : '' ?>">İletişim</a>
    </nav>

    <div class="header-actions">
      <a href="sign.php" class="btn btn-primary btn-sm">Hesap aç</a>
  ...
  <nav class="nav-mobile" data-mobile-nav aria-label="Mobil gezinme" hidden>
...
<div class="market-tape" aria-hidden="true">
  <div class="container market-tape-inner">
    ...
    <span class="tape-item"><strong>Piyasalar</strong> 24/7</span>
  </div>
</div>
