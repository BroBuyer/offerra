...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__text">
      <?= e(SITE_NAME) ?> talebiniz alındı. Lütfen yöneticimizin aramasını bekleyin.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <button type="submit" class="btn btn-primary btn-block submit">Ücretsiz hesap oluştur</button>
    ...
    <p class="form-legal">
      ...
      <a href="privacy.php">Gizlilik Politikası</a> ve
      <a href="conditions.php">Kullanım Koşulları</a>nı kabul etmiş olursunuz.
    </p>
  </div>
</form>
