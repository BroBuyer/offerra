...
$page_title = $page_title ?? SITE_NAME . ' | Platformă de investiții cu AI';
$page_description = $page_description ?? 'Investiți și tranzacționați cu ' . SITE_NAME . ' — o platformă clară asistată de AI, creată pentru a menține piețele simple.';
