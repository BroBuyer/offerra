...
<header class="site-header" data-header>
  <div class="container header-inner">
    <a href="<?= page_url() ?>" class="logo" aria-label="<?= e(SITE_NAME) ?> početna">
    ...
    <nav class="nav-desktop" aria-label="Glavna navigacija">
      ...
      <a href="offer.php" class="<?= $active_page === 'offer' ? 'is-active' : '' ?>">Cijene</a>
    ...
    <div class="header-actions">
      <a href="sign.php" class="btn btn-primary btn-sm">Otvori račun</a>
