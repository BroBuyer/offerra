...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__text">
      A(z) <?= e(SITE_NAME) ?> felé küldött kérelmét megkaptuk. Várja szakértőnk hívását.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <button type="submit" class="btn btn-primary btn-block submit">Ingyenes fiók létrehozása</button>
    ...
    <p class="form-legal">
      ...
      <a href="privacy.php">Adatvédelmi irányelveinket</a> és
      <a href="conditions.php">Felhasználási feltételeinket</a>.
    </p>
  </div>
</form>
