...
$page_title = $page_title ?? SITE_NAME . ' | MI-befektetési platform';
$page_description = $page_description ?? 'Fektessen be és kereskedjen a ' . SITE_NAME . ' segítségével — egy átlátható, MI-támogatott platform, amely egyszerűen tartja a piacokat.';
