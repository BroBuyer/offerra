...
<main>
  <section class="page-hero">
    <div class="container">
      ...
      <p class="lead">Ein klarer Einstieg. Nach der Einzahlung voller Zugang — inkl. KI-Einblicken und Live-Märkten.</p>
    </div>
  </section>
    ...
    <div class="container" style="max-width: 520px;">
      <div class="page-panel">
        ...
        <p class="prose">
          ...
          Charts, Tools und KI-Hilfe freischalten sich nach der Finanzierung.
        </p>
        <?php
        $form_id = 'offer-form';
