...
$page_title = $page_title ?? SITE_NAME . ' | Plateforme d’investissement IA';
$page_description = $page_description ?? 'Investissez et tradez avec ' . SITE_NAME . ' — une plateforme claire assistée par l’IA, conçue pour simplifier les marchés.';
