...
function render_schema(string $page = 'home', array $extra = []): void {
    ...
    $organization = [
        ...
        'description' => 'Une plateforme d’investissement claire assistée par l’IA pour les marchés crypto et multi-actifs.',
    ];
    ...
    $software = [
        ...
        'description' => 'Plateforme d’investissement IA simple avec marchés en direct, insights guidés et espace de trading serein.',
    ...
    $faq = [
        ...
        'mainEntity' => [
            ...
            [
                ...
                'acceptedAnswer' => [
                    '@type' => 'Answer',
                    'text' => 'Nous protégeons les comptes avec le chiffrement SSL, l’authentification à deux facteurs et une gestion sécurisée des fonds via des prestataires de confiance. Vos données personnelles sont traitées selon des politiques de sécurité strictes.',
                ],
            ],
            [
                '@type' => 'Question',
                ...
                'acceptedAnswer' => [
                    '@type' => 'Answer',
                    'text' => 'Les retraits peuvent être demandés à tout moment depuis le tableau de bord. Le traitement prend généralement 1 à 3 jours ouvrés selon la méthode. Frais et délais sont affichés à l’avance.',
                ],
            ],
            [
                '@type' => 'Question',
                ...
                'acceptedAnswer' => [
                    '@type' => 'Answer',
                    'text' => 'Aucune expérience préalable n’est requise. Un onboarding guidé, des tutoriels simples et des outils assistés par l’IA vous aident à votre rythme, avec un support 24 h/24.',
                ],
            ],
        ],
    ];
