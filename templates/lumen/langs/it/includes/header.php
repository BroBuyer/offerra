...
<header class="site-header" data-header>
  <div class="container header-inner">
    ...
    <nav class="nav-desktop" aria-label="Navigazione principale">
      ...
      <a href="product.php" class="<?= $active_page === 'product' ? 'is-active' : '' ?>">Piattaforma</a>
      <a href="offer.php" class="<?= $active_page === 'offer' ? 'is-active' : '' ?>">Prezzi</a>
    ...
    <div class="header-actions">
      <a href="sign.php" class="btn btn-primary btn-sm">Apri account</a>
