...
<header class="site-header" data-header>
  <div class="container header-inner">
    ...
    <nav class="nav-desktop" aria-label="Pagrindinė navigacija">
      <a href="<?= page_url() ?>" class="<?= $active_page === 'home' ? 'is-active' : '' ?>">Pradžia</a>
      <a href="product.php" class="<?= $active_page === 'product' ? 'is-active' : '' ?>">Platformaa</a>
      <a href="offer.php" class="<?= $active_page === 'offer' ? 'is-active' : '' ?>">Kainodara</a>
      <a href="faq.php" class="<?= $active_page === 'faq' ? 'is-active' : '' ?>">DUK</a>
      <a href="contacts.php" class="<?= $active_page === 'contacts' ? 'is-active' : '' ?>">Susisiekite</a>
    </nav>

    <div class="header-actions">
      <a href="sign.php" class="btn btn-primary btn-sm">Atidaryti sąskaitą</a>
