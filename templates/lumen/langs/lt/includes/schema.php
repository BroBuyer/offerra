...
function render_schema(string $page = 'home', array $extra = []): void {
    ...
    $faq = [
        ...
        'mainEntity' => [
            [
                ...
                'acceptedAnswer' => [
                    '@type' => 'Answer',
                    'text' => 'Susikurkite paskyrą per kelias minutes, atlikite trumpą patvirtinimo veiksmą ir papildykite savo sąskaitą minimaliu ' . MIN_DEPOSIT . ' ' . CURRENCY . ' depozitu. Jūs atrakinsite visą platformą, įskaitant tiesiogines diagramas ir prekybos įrankius.',
                ],
            ],
            [
                '@type' => 'Question',
    ...
    $howto = [
        ...
        'step' => [
            ['@type' => 'HowToStep', 'position' => 1, 'name' => 'Atidarykite paskyrą', 'text' => 'Prisiregistruokite naudodami pagrindinę informaciją ir gaukite saugią prieigą prie platformos.'],
            ...
            ['@type' => 'HowToStep', 'position' => 3, 'name' => 'Finansuokite savo sąskaitą', 'text' => 'Įneškite mažiausiai ' . MIN_DEPOSIT . ' ' . CURRENCY . ' banko pavedimu, kortele arba el. pinigine.'],
