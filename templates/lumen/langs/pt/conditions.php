...
$page_description = 'Leia os termos e condições de utilização da plataforma de trading e do site ' . SITE_NAME . '.';
...
<main>
  ...
  <section class="section-sm">
    <div class="container prose">
      ...
      <p>É responsável por manter a confidencialidade das credenciais da conta e por toda a atividade na sua conta.</p>

      <h2>Disponibilidade do serviço</h2>
      <p>Procuramos disponibilidade contínua, mas não garantimos acesso ininterrupto. Manutenção, condições de mercado ou problemas técnicos podem afetar o serviço.</p>

      <h2>Limitação de responsabilidade</h2>
      <p><?= e(SITE_NAME) ?> não é responsável por perdas de trading ou danos decorrentes do uso de informações neste site. Procure aconselhamento financeiro independente quando adequado.</p>
