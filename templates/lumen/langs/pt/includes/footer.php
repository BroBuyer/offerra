...
<footer class="site-footer">
  <div class="container">
    ...
    <div class="footer-risk">
      <p>
        <?= e(SITE_NAME) ?> não se responsabiliza por perdas ou danos decorrentes do uso das informações deste site. Operar nos mercados financeiros envolve risco. Invista apenas fundos que possa perder. FX, CFDs e criptomoedas podem não ser adequados para todos os investidores. Considere aconselhamento profissional antes de operar.
      </p>
    </div>
