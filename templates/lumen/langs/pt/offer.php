...
<main>
  <section class="page-hero">
    <div class="container">
      ...
      <h1>Começar a partir de <?= MIN_DEPOSIT ?> <?= CURRENCY ?></h1>
      <p class="lead">Uma entrada simples. Acesso completo após o financiamento — incluindo insights de IA e mercados em direto.</p>
    </div>
  </section>
  ...
  <section class="section-sm">
    <div class="container" style="max-width: 520px;">
      <div class="page-panel">
        ...
        <?php
        $form_id = 'offer-form';
        $form_heading = 'Criar a sua conta';
