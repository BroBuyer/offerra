...
<header class="site-header" data-header>
  <div class="container header-inner">
    ...
    <nav class="nav-desktop" aria-label="Navegación principal">
      ...
      <a href="product.php" class="<?= $active_page === 'product' ? 'is-active' : '' ?>">Plataforma</a>
      <a href="offer.php" class="<?= $active_page === 'offer' ? 'is-active' : '' ?>">Precios</a>
    ...
    <div class="header-actions">
      <a href="sign.php" class="btn btn-primary btn-sm">Abrir cuenta</a>
      <button class="menu-toggle" type="button" data-menu-toggle aria-label="Abrir menú" aria-expanded="false">
        <span></span><span></span>
      </button>
    </div>
  </div>
