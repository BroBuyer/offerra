...
<header class="site-header" data-header>
  <div class="container header-inner">
    ...
    <nav class="nav-desktop" aria-label="メインナビゲーション">
      ...
      <a href="product.php" class="<?= $active_page === 'product' ? 'is-active' : '' ?>">プラットフォーム</a>
      <a href="offer.php" class="<?= $active_page === 'offer' ? 'is-active' : '' ?>">料金</a>
    ...
    <div class="header-actions">
      <a href="sign.php" class="btn btn-primary btn-sm">口座を開設</a>
