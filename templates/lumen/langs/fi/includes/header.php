...
<header class="site-header" data-header>
  <div class="container header-inner">
    ...
    <nav class="nav-desktop" aria-label="Päänavigointi">
      <a href="<?= page_url() ?>" class="<?= $active_page === 'home' ? 'is-active' : '' ?>">Etusivu</a>
      <a href="product.php" class="<?= $active_page === 'product' ? 'is-active' : '' ?>">Alusta</a>
      <a href="offer.php" class="<?= $active_page === 'offer' ? 'is-active' : '' ?>">Hinnoittelu</a>
    ...
    <div class="header-actions">
      <a href="sign.php" class="btn btn-primary btn-sm">Avaa tili</a>
  ...
  <nav class="nav-mobile" data-mobile-nav aria-label="Mobiilinavigointi" hidden>
