...
$page_title = $page_title ?? SITE_NAME . ' | Tekoälypohjainen sijoitusalusta';
$page_description = $page_description ?? 'Sijoita ja käy kauppaa ' . SITE_NAME . '-palvelussa — selkeä tekoälyavusteinen alusta, joka pitää markkinat yksinkertaisina.';
