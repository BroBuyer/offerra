...
<main>
  ...
  <section class="section-sm">
    <div class="container prose">
      ...
      <h2>Tietoturva</h2>
      <p>Käytämme teknisiä ja organisatorisia toimenpiteitä, kuten SSL-salausta ja käyttöoikeuksien hallintaa, tietojesi suojaamiseksi.</p>

      <h2>Oikeutesi</h2>
      <p>Lainkäyttöalueestasi riippuen sinulla voi olla oikeus saada pääsy henkilötietoihisi, korjata niitä tai pyytää niiden poistamista. Käytä näitä oikeuksia ottamalla yhteyttä osoitteeseen <?= e(SUPPORT_EMAIL) ?>.</p>
