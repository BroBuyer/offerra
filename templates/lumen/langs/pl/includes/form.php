...
<?php endif; ?>
    ...
    <div class="form-grid">
      ...
      <label class="field field-full" data-field="email">
        ...
        <input class="input" type="email" name="email" placeholder="ty@email.com" required autocomplete="email" inputmode="email">
      </label>
    ...
    <button type="submit" class="btn btn-primary btn-block submit">Utwórz darmowe konto</button>

    <?php
    $payment_context = 'rejestracja konta';
    ...
    <p class="form-legal">
      Przesyłając dane, akceptujesz naszą
      <a href="privacy.php">Politykę prywatności</a> oraz
