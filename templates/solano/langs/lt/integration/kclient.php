...
class KClient
{
    ...
    /**
     * @var KHttpClientSąsaja
     */
    private $httpClient;

    /**
     * @var KDispatcherSąsaja
     */
    private $dispatcher;
    /**
     * @var bool
    ...
    public function setHttpClient(KHttpClientSąsaja $httpClient)
    {
        $this->httpClient = $httpClient;
        return $this;
    }

    public function setDispatcher(KDispatcherSąsaja $executor)
    {
    ...
    public function forceRedirectPasiūlyti()
    {
    ...
    public function getPasiūlyti($params = array(), $fallback = 'no_offer')
    {
        $result = $this->performRequest();
        $token = $this->getToken();
        if (empty($token)) {
        ...
        return $this->buildPasiūlytiUrl($params);
    }
    ...
    private function buildPasiūlytiUrl($params = array())
    {
...
class KDispatcher implements KDispatcherSąsaja
{
    public function sendHeaders($headers)
    {
        if (!empty($headers)) {
...
class KHttpClient implements KHttpClientSąsaja
{
    const POST = 'POST';
    const GET = 'GET';
