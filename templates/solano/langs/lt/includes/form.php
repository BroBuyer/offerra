...
<?php if ($is_stack): ?>
    <div class="rtjqp">
      <div class="jn406 field" data-field="fname">
        ...
        <input class="cm9aayi input" id="<?= e($form_id) ?>-fname" type="text" name="fname" placeholder="Vardas" required pattern="[^\d]+" autocomplete="given-name">
      </div>
      <div class="jn406 field" data-field="lname">
        <label class="field-label" for="<?= e($form_id) ?>-lname">Pavardė</label>
        <input class="cm9aayi input" id="<?= e($form_id) ?>-lname" type="text" name="lname" placeholder="Pavardė" required pattern="[^\d]+" autocomplete="family-name">
      </div>
      <div class="jn406 field" data-field="email">
      <label class="field-label" for="<?= e($form_id) ?>-email">El. paštas</label>
      <input class="cm9aayi input" id="<?= e($form_id) ?>-email" type="email" name="email" placeholder="El. paštas" required autocomplete="email" inputmode="email">
    </div>
...
<?php endif; ?>
    ...
    <div class="payrow" aria-label="Priimti mokėjimo būdai">
      ...
      <svg class="fai" role="img" aria-label="Banko pavedimas" viewBox="0 0 512 512"><use href="#i-building-columns"/></svg>
      <svg class="fai pay-ok" role="img" aria-label="Saugus" viewBox="0 0 512 512"><use href="#i-shield-halved"/></svg>
    </div>
