...
<div class="nrzt44 jx8jnza">
  ...
  <div>
      ...
      <div class="vdaz1q">
        <figure class="qkl7dd8" itemscope itemtype="https://schema.org/Review">
          <div class="dnjuv">
            ...
            <span class="ue1r1">+€2.200 in 4 maanden</span>
          </div>
    ...
    <section class="xrn58" data-u="sec" id="vzo0q" aria-labelledby="mzn56z">
      ...
      <div class="smnsm2" role="region" tabindex="0" aria-label="Geen spreadsheets. Geen schermen. Geen last-minute twijfels"><table class="by635s">
        ...
        <tbody>
          <tr><td>Orderuitvoering met AI</td><td class="bfe2o6f">✓</td><td class="byuav">beperkte openingstijden</td><td class="byuav">handmatig</td></tr>
          <tr><td>24/7 toezicht op alle markten</td><td class="bfe2o6f">✓</td><td class="byuav">papierwerk</td><td class="byuav">Op eigen houtje</td></tr>
          <tr><td>Orderrouting in minder dan een seconde</td><td class="bfe2o6f">✓</td><td class="byuav">alleen op niveau</td><td class="byuav">handmatig</td></tr>
          <tr><td>Rapporten in meerdere valuta</td><td class="bfe2o6f">✓</td><td class="byuav">beperkte openingstijden</td><td class="byuav">Op eigen houtje</td></tr>
          <tr><td>Account openen zonder papierwerk</td><td class="bfe2o6f">✓</td><td class="byuav">papierwerk</td><td class="byuav">handmatig</td></tr>
          <tr><td>Arbitrage tussen exchanges</td><td class="bfe2o6f">✓</td><td class="byuav">alleen op niveau</td><td class="byuav">Op eigen houtje</td></tr>
    ...
    <section class="xrn58" id="esypwbx" aria-labelledby="rq8es">
      ...
      <div class="wmuyc">
        <div>
          ...
          ?>
          <div class="vcf9ca"><label for="calc-dep">Startbedrag</label><span class="cj9i15q" id="csezcv1"><?= e(currency_symbol() . number_format($calc_default, 0, ',', '.')) ?></span></div>
          <input id="lsm9on" type="range" min="<?= (int) $calc_min ?>" max="<?= (int) $calc_max ?>" step="50" value="<?= (int) $calc_default ?>" aria-label="Startbedrag"/>
          <div class="vcf9ca"><label for="calc-mon">Maanden</label><span class="cj9i15q" id="ywprvgd">6</span></div>
          <input id="gqz8w" type="range" min="1" max="24" step="1" value="6" aria-label="Maanden"/>
          <p class="ifuciwq">De bedragen zijn indicatief. Uw werkelijke opbrengst hangt af van het bedrag dat u investeert en de strategie die u samen met uw analist kiest.</p>
        </div>
        <div class="gbastl">
    ...
    <section class="xrn58" data-u="sec" id="dmobczk" aria-labelledby="dl5sp">
      ...
      <ol class="zzk9i">
        <li><span class="vpx6kk">01</span><div><h3>Maak uw account aan</h3><p>Registreer u binnen enkele minuten met alleen uw e-mailadres.</p></div></li>
        <li><span class="vpx6kk">02</span><div><h3>Verifieer uw e-mail</h3><p>Bevestig uw adres om uw account te beschermen.</p></div></li>
        <li><span class="vpx6kk">03</span><div><h3>Stort geld</h3><p>Voeg kapitaal toe vanaf <?= e(money_min()) ?>, met de methode die u verkiest.</p></div></li>
    ...
    <section class="xrn58" data-u="sec" id="exd9dmd" aria-labelledby="rlolt2l">
      ...
      <div class="smnsm2" role="region" tabindex="0" aria-label="Handel in Bitcoin, Ethereum en meer"><table class="nd3owbf">
    ...
    <section class="xrn58" data-u="sec" id="sor9s" aria-labelledby="onidtj">
      ...
      <ol class="zzk9i">
        <li><span class="vpx6kk">01</span><div><h3>Uitvoering in minder dan een seconde op elke verbonden markt</h3><p><?= e(SITE_NAME) ?> onderhoudt permanente low-latency API-verbindingen met elke ondersteunde exchange. Wanneer het model een signaal genereert, wordt de order verzonden, uitgevoerd en in uw dashboard geregistreerd vóór de volgende tick.</p></div></li>
        <li><span class="vpx6kk">02</span><div><h3>Werkt 24/7, in elke marktsessie</h3><p>Cryptocurrency rust nooit, en <?= e(SITE_NAME) ?> ook niet. De engine blijft paren analyseren in weekenden en op feestdagen zodat u geen kans mist.</p></div></li>
        <li><span class="vpx6kk">03</span><div><h3>Rapporten in meerdere valuta</h3><p>Elk saldo, elke transactie en elke opname wordt in uw lokale valuta getoond. Geen verborgen conversiestappen op enig moment.</p></div></li>
        <li><span class="vpx6kk">04</span><div><h3>Gescheiden kapitaal</h3><p>Uw fondsen blijven op uw eigen rekening. <?= e(SITE_NAME) ?> bewaart ze nooit: de engine heeft alleen toestemming om orders te verzenden.</p></div></li>
        <li><span class="vpx6kk">05</span><div><h3>Beveiliging op bankniveau</h3><p>TLS-versleuteling op het hele platform, standaard tweestapsverificatie en kwartaal-audits van de infrastructuur door derden. Transactiebonnen geregistreerd op blockchain.</p></div></li>
        <li><span class="vpx6kk">06</span><div><h3>Drie activaklassen, één platform</h3><p>De meeste retailplatforms beperken u tot één markt. <?= e(SITE_NAME) ?> handelt in cryptocurrency, genoteerde aandelen en de belangrijkste valutaparen vanuit hetzelfde dashboard.</p></div></li>
        <li><span class="vpx6kk">07</span><div><h3>Vooraf ingestelde risicolimieten per positie</h3><p>Stop-loss, maximaal toegestaan verlies en kapitaalallocatielimieten worden per activaklasse ingesteld. De engine sluit automatisch elke transactie die een drempel overschrijdt en het incident wordt in uw auditlog vastgelegd.</p></div></li>
      </ol>
    </section>
