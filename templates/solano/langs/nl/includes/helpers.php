...
{
    return SITE_NAME . ' op mobiel: live BTC/USDT-grafiek, orderboek en koop-/verkoopinterface';
}

function platform_image_caption(): string
{
    return SITE_NAME . ' — mobiel gebruik met realtime cryptocurrency-grafieken';
}
