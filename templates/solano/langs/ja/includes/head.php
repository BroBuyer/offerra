...
$page_title = $page_title ?? (SITE_NAME . ' ᐉ ライブ投資を完全に把握');
$page_description = $page_description ?? ('リアルタイムで、資金が ' . SITE_NAME . ' とともにどのように働いているかをご覧ください。明確なレポート、専任アナリスト、AI。追加収入は ' . money_min());
...
window.APP_LANG = {
  ...
  valPhoneShort: '番号が短すぎます',
  valPhoneLong: '番号が長すぎます'
};
