...
$page_title = $page_title ?? (SITE_NAME . ' ᐉ Täysi hallinta live-sijoituksestanne');
$page_description = $page_description ?? ('Seuratkaa reaaliajassa, miten pääomanne työskentelee palvelussa ' . SITE_NAME . ': selkeät raportit, henkilökohtainen analyytikko ja tekoäly. Luokaa lisätuloa alkaen ' . money_min());
...
<a class="nd5hm" href="#top">Siirry sisältöön</a>
