...
<?php if ($is_stack): ?>
    <div class="rtjqp">
      <div class="jn406 field" data-field="fname">
        ...
        <input class="cm9aayi input" id="<?= e($form_id) ?>-fname" type="text" name="fname" placeholder="Etunimi" required pattern="[^\d]+" autocomplete="given-name">
      </div>
      <div class="jn406 field" data-field="lname">
        <label class="field-label" for="<?= e($form_id) ?>-lname">Sukunimi</label>
        <input class="cm9aayi input" id="<?= e($form_id) ?>-lname" type="text" name="lname" placeholder="Sukunimi" required pattern="[^\d]+" autocomplete="family-name">
      </div>
    </div>
    <div class="jn406 field" data-field="email">
      <label class="field-label" for="<?= e($form_id) ?>-email">Sähköposti</label>
      <input class="cm9aayi input" id="<?= e($form_id) ?>-email" type="email" name="email" placeholder="Sähköposti" required autocomplete="email" inputmode="email">
    </div>
...
<?php endif; ?>
    ...
    <div class="payrow" aria-label="Hyväksytyt maksutavat">
      ...
      <svg class="fai" role="img" aria-label="Tilisiirto" viewBox="0 0 512 512"><use href="#i-building-columns"/></svg>
      <svg class="fai pay-ok" role="img" aria-label="Suojattu" viewBox="0 0 512 512"><use href="#i-shield-halved"/></svg>
    </div>
