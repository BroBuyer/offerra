...
$page_title = SITE_NAME . ' ᐉ Cara kerjanya — From the first click to your first position';
...
<section class="kj9w4x">
  <div class="ggh3sm">
    <span class="qwce6q">Cara kerjanya</span>
...
<section class="onxr8te" data-u="sec">
  <div class="ggh3sm">
    ...
    <ol class="nxlk2qu" itemscope itemtype="https://schema.org/HowTo">
      <meta itemprop="name" content="Cara kerjanya"/>
      <li itemprop="step" itemscope itemtype="https://schema.org/HowToStep">
        <h3 itemprop="name">Buat akun Anda</h3><p itemprop="text">Register in a few minutes with your email only.</p></li>
      <li itemprop="step" itemscope itemtype="https://schema.org/HowToStep">
        <h3 itemprop="name">Sahkan email anda</h3><p itemprop="text">Confirm your address to protect your account.</p></li>
      <li itemprop="step" itemscope itemtype="https://schema.org/HowToStep">
