...
$page_title = 'Kebijakan Privasi ᐉ ' . SITE_NAME;
...
<section class="ykzi1">
  <div class="ggh3sm">
    <span class="vd7z9k">Hukum information</span>
    <h1>Kebijakan Privasi</h1>
    <p class="etpy2">How <?= e(SITE_NAME) ?> collects, uses and protects your personal information.</p>
  </div>
</section>
...
<section class="bqfjng">
  <div class="ggh3sm">
    ...
    <h2>1. Pengenalan</h2>
    <p><?= e(SITE_NAME) ?> ("we", "us", "our") is committed to protecting the privacy of visitors and clients. This Kebijakan Privasi explains what personal data we collect, why we collect it and how we process it when you use our website and services.</p>
    ...
    <ul>
      ...
      <li><strong>Hubungi data</strong> — email address, phone number, postal address.</li>
