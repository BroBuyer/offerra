...
<section class="pnylsh" data-hero="split" aria-labelledby="rrqdpt">
  <div class="nrzt44 qg0sgs">
    ...
    <div class="do1sdty">
      ...
      <a class="rs0voj6 krccqy8" href="<?= page_url('product.php') ?>">Cara kerjanya</a>
    </div>
    <ul class="eok92u">
      <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 6L9 17l-5-5"/></svg>SSL protection</li>
      <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 6L9 17l-5-5"/></svg>Dukungan 24/7</li>
...
<div class="acd048l">
      ...
      <div class="xnpe0qx"><b>24/7</b><span>Dukungan</span></div>
    </div>
...
<div class="nrzt44 jlt10">
  <details class="tte22iu" open aria-label="On this page">
    ...
    <ol>
      ...
      <li><a href="#dmobczk">Cara kerjanya</a></li>
...
<div class="nrzt44 ldrp4m">
    ...
    <section class="zx4mx9v" data-u="sec" id="vzo0q" aria-labelledby="mzn56z">
      ...
      <div class="ltouuo" role="region" tabindex="0" aria-label="No spreadsheets. No screens. No last-minute doubts"><table class="gvdhnr">
    ...
    <section class="zx4mx9v" id="esypwbx" aria-labelledby="rq8es">
      ...
      <div class="gvcm8u">
        ...
        <div class="arsqprf">
          ...
          <a class="rs0voj6 ggca24u" href="#jsyo6" style="margin-top:14px;width:100%">Buka akun</a>
        </div>
      </div>
    </section>
    ...
    <section class="zx4mx9v" id="rb8p3" aria-labelledby="dv0846">
      ...
      <form class="mwky634" id="sqw38g" novalidate>
        ...
        <div class="zuh4exq">
          ...
          <p class="vrwbx90" id="bpisnbk" hidden>Your answers are ready — leave your details and a specialist will talk them through.</p>
    ...
    <section class="zx4mx9v" data-u="sec" id="dmobczk" aria-labelledby="dl5sp">
      <div class="tewtadh">
        <span class="odwy4o">Cara kerjanya</span>
        <h2 id="dl5sp">Cara kerjanya</h2>
      ...
      <ol class="rho9v16">
        <li><span class="vio04">01</span><div><h3>Buat akun Anda</h3><p>Register in a few minutes with your email only.</p></div></li>
        <li><span class="vio04">02</span><div><h3>Sahkan email anda</h3><p>Confirm your address to protect your account.</p></div></li>
    ...
    <section class="zx4mx9v" data-u="sec" id="exd9dmd" aria-labelledby="rlolt2l">
      ...
      <div class="ltouuo" role="region" tabindex="0" aria-label="Trade Bitcoin, Ethereum and much more"><table class="kzp7d0j">
    ...
    <section class="zx4mx9v" id="nw3j7wd" aria-labelledby="wysa9hx">
      <div class="tewtadh">
        ...
        <h2 id="wysa9hx">Pertanyaan umum</h2>
      </div>
...
<!--reviews-block--><section aria-label="Client ratings" style="padding:3rem 1.25rem;background:var(--bg,#0b0f19)"><div style="max-width:68rem;margin:0 auto;background:var(--surface,#12182a);border:1px solid var(--border,rgba(255,255,255,.08));border-radius:18px;padding:24px 34px;display:flex;flex-wrap:wrap;align-items:center;justify-content:center;gap:18px 42px"><div style="text-align:center"><span style="display:inline-block;background:var(--accent,#e8b84b);color:var(--on-accent,#0b0d14);font:700 11px/1 Sora,system-ui,sans-serif;letter-spacing:.14em;padding:7px 12px;border-radius:6px;margin-bottom:10px">TRUSTED</span><div style="font:700 1.2rem Sora,system-ui,sans-serif;color:var(--text,#fff)"><?= e(SITE_NAME) ?> Ulasan</div></div><div style="font:800 2.7rem Sora,system-ui,sans-serif;color:var(--accent,#e8b84b);line-height:1;font-variant-numeric:tabular-nums">4.9</div><span style="position:relative;display:inline-block;font-size:1.55rem;line-height:1;letter-spacing:.1em" aria-hidden="true"><span style="color:var(--gold,#efb567);opacity:.25">★★★★★</span><span style="position:absolute;inset:0;overflow:hidden;white-space:nowrap;width:98.0%;color:var(--gold,#efb567)">★★★★★</span></span><div style="color:var(--muted,#9aa3b2);font-size:.95rem;font-variant-numeric:tabular-nums"><b style="color:var(--text,#fff)">817</b> reviews · Berdasarkan <b style="color:var(--text,#fff)">4,902</b> ratings</div></div></section><section class="lk9wh0" id="signup" aria-labelledby="fglj2pf">
  <div class="nrzt44 bxx9mk3">
    <div>
      ...
      <p class="etpy2">Buka akun account in minutes, deposit from a modest minimum and start tracking your progress transparently from day one.</p>
