...
$page_title = SITE_NAME . ' ᐉ Teljes élő kontroll a befektetése felett';
$page_description = 'Kövesse valós időben, hogyan dolgozik a tőkéje a(z) ' . SITE_NAME . ' platformon: átlátható jelentések, személyes elemző és MI. Extra jövedelem már ' . money_min();
...
<section class="tl154k" aria-labelledby="rrqdpt">
  <div class="ggh3sm">
    <span class="vd7z9k">MI + szakértő emberi elemzők</span>
    <h1 id="rrqdpt"><?= e(SITE_NAME) ?></h1>
    <p class="ymraes">Személyes pénzügyi elemző MI-támogatással, aki hétköznapi embereknek segít extra jövedelemforrást építeni — előzetes tapasztalat nélkül. Elemzője minden lépésnél vezeti, az irányítópult pedig valós időben mutatja, hogyan dolgozik a tőkéje.</p><!--hero-trust--><div style="margin:1.5rem -.7rem 1.6rem;font-size:.85rem;font-weight:500;line-height:1.7;color:var(--muted,#9aa3b2)"><span style="display:inline-flex;align-items:center;gap:.4rem;margin:.3rem .7rem;vertical-align:middle"><span aria-hidden="true">🛡</span>Szabályozott</span><span style="display:inline-flex;align-items:center;gap:.4rem;margin:.3rem .7rem;vertical-align:middle"><span aria-hidden="true">🔒</span>Elkülönített források</span><span style="display:inline-flex;align-items:center;gap:.4rem;margin:.3rem .7rem;vertical-align:middle"><span aria-hidden="true">👥</span>39 600 ügyfél</span><span style="display:inline-flex;align-items:center;gap:.4rem;margin:.3rem .7rem;vertical-align:middle"><span aria-hidden="true" style="color:var(--accent,#e8b84b)">★</span><span style="font-variant-numeric:tabular-nums">4.9</span> értékelés</span></div>
    <div class="vseuxnl">
      <a class="qou73xg fi3abjs" href="#nl3qm8">Kezdés — <?= e(money_min()) ?> min.</a>
      <a class="qou73xg ec2hno" href="<?= page_url('product.php') ?>">Hogyan működik</a>
    </div>
    <ul class="wxlxk">
      <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 6L9 17l-5-5"/></svg>SSL-védelem</li>
      <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 6L9 17l-5-5"/></svg>24/7 támogatás</li>
      <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 6L9 17l-5-5"/></svg>Gyors végrehajtás</li>
    </ul>
...
?>
    ...
    <div class="mcitl7d">
      <div class="ohqkun7"><b>33,000</b><span>Aktív felhasználók</span></div>
      <div class="ohqkun7"><b>€0.6B</b><span>Kereskedett volumen</span></div>
      <div class="ohqkun7"><b>99.8%</b><span>Jelzések rendelkezésre állása</span></div>
      <div class="ohqkun7"><b>24/7</b><span>Támogatás</span></div>
    </div>
  </div>
</section>
...
<div class="ggh3sm jx8jnza">
  <details class="tjbln" open aria-label="Ezen az oldalon">
    ...
    <ol>
      ...
      <li><a href="#dmobczk">Hogyan működik</a></li>
      <li><a href="#gp0nit">Bármely képernyőn</a></li>
      <li><a href="#esypwbx">Hozamok</a></li>
      <li><a href="#evp8w6d">Védelem</a></li>
      <li><a href="#vzo0q">Why <?= e(SITE_NAME) ?></a></li>
      <li><a href="#br1y4s">Mit mondanak a tagok</a></li>
      <li><a href="#vatll">Az Ön elemzője</a></li>
      <li><a href="#rb8p3">Az Ön kiindulópontja</a></li>
      <li><a href="#nw3j7wd">Kérdések</a></li>
    </ol>
    <a class="qou73xg fi3abjs" href="#nl3qm8">Kezdés — <?= e(money_min()) ?> min.</a>
  </details>
  ...
  <div>
    <section class="xrn58" data-u="sec" id="br1y4s" aria-labelledby="es9pra">
      <div class="wdsnx3j">
        <span class="vd7z9k">Mit mondanak a tagok</span>
      ...
      <div class="vdaz1q">
        <figure class="qkl7dd8" itemscope itemtype="https://schema.org/Review">
          ...
          <figcaption itemprop="author" itemscope itemtype="https://schema.org/Person">
            <b itemprop="name">Kovács Anna</b>Budapest
          </figcaption>
        ...
        <figure class="qkl7dd8" itemscope itemtype="https://schema.org/Review">
          ...
          <figcaption itemprop="author" itemscope itemtype="https://schema.org/Person">
            <b itemprop="name">Nagy Péter</b>Debrecen
          </figcaption>
          <meta itemprop="datePublished" content="2026-01-01"/>
          <div itemprop="reviewRating" itemscope itemtype="https://schema.org/Rating">
            <meta itemprop="ratingValue" content="5"/><meta itemprop="bestRating" content="5"/>
        ...
        <figure class="qkl7dd8" itemscope itemtype="https://schema.org/Review">
          ...
          <figcaption itemprop="author" itemscope itemtype="https://schema.org/Person">
            <b itemprop="name">Szabó Eszter</b>Szeged
          </figcaption>
          <meta itemprop="datePublished" content="2026-01-01"/>
          <div itemprop="reviewRating" itemscope itemtype="https://schema.org/Rating">
            <meta itemprop="ratingValue" content="5"/><meta itemprop="bestRating" content="5"/>
        ...
        <figure class="qkl7dd8" itemscope itemtype="https://schema.org/Review">
          ...
          <figcaption itemprop="author" itemscope itemtype="https://schema.org/Person">
            <b itemprop="name">Tóth Gábor</b>Pécs
          </figcaption>
          <meta itemprop="datePublished" content="2026-01-01"/>
          <div itemprop="reviewRating" itemscope itemtype="https://schema.org/Rating">
            <meta itemprop="ratingValue" content="5"/><meta itemprop="bestRating" content="5"/>
        ...
        <figure class="qkl7dd8" itemscope itemtype="https://schema.org/Review">
          ...
          <figcaption itemprop="author" itemscope itemtype="https://schema.org/Person">
            <b itemprop="name">Kiss Katalin</b>Győr
          </figcaption>
          <meta itemprop="datePublished" content="2026-01-01"/>
          <div itemprop="reviewRating" itemscope itemtype="https://schema.org/Rating">
            <meta itemprop="ratingValue" content="5"/><meta itemprop="bestRating" content="5"/>
        ...
        <figure class="qkl7dd8" itemscope itemtype="https://schema.org/Review">
          ...
          <figcaption itemprop="author" itemscope itemtype="https://schema.org/Person">
            <b itemprop="name">Varga László</b>Miskolc
          </figcaption>
          <meta itemprop="datePublished" content="2026-01-01"/>
          <div itemprop="reviewRating" itemscope itemtype="https://schema.org/Rating">
            <meta itemprop="ratingValue" content="5"/><meta itemprop="bestRating" content="5"/>
    ...
    <section class="xrn58" data-u="sec" id="vzo0q" aria-labelledby="mzn56z">
      ...
      <p style="margin-top:22px"><a class="qou73xg ec2hno" href="<?= page_url('offer.php') ?>">Miért mi</a></p>
    </section>
    ...
    <section class="xrn58" data-u="sec" id="evp8w6d" aria-labelledby="ykur4hl">
      <div class="tsgf5eq">
        <div>
          <div class="wdsnx3j">
            <span class="vd7z9k">Védelem</span>
        ...
        <img src="<?= asset('static/img/platform.webp') ?>" srcset="<?= asset('static/img/platform-640.webp') ?> 640w, <?= asset('static/img/platform.webp') ?> 800w" sizes="(max-width: 768px) 92vw, 680px" alt="Portfólióáttekintés a platformon belül" width="760" height="520" decoding="async" title="Portfólióáttekintés a platformon belül" loading="lazy">
      </div>
    </section>
    ...
    <section class="xrn58" data-u="sec" id="vatll" aria-labelledby="iouvw">
      <div class="tsgf5eq mudjf">
        ...
        <div>
          <div class="wdsnx3j">
            <span class="vd7z9k">Az Ön elemzője</span>
    ...
    <section class="xrn58" id="esypwbx" aria-labelledby="rq8es">
      <div class="wdsnx3j">
        <span class="vd7z9k">Hozamok</span>
      ...
      <div class="wmuyc">
        ...
        <div class="gbastl">
          ...
          <a class="qou73xg fi3abjs" href="#nl3qm8" style="margin-top:14px;width:100%">Nyisson fiókot</a>
        </div>
      </div>
    </section>
    ...
    <section class="xrn58" id="rb8p3" aria-labelledby="dv0846">
      <div class="wdsnx3j">
        <span class="vd7z9k">Találja meg a kiindulópontját</span>
      ...
      <form class="yw6xmlm" id="sqw38g" novalidate>
        ...
        <div class="beqazp3">
          <button class="qou73xg ec2hno sihas5z" type="button" hidden>Vissza</button>
          <p class="ubn7i4v" id="bpisnbk" hidden>A válaszok készen állnak — hagyja meg adatait, és egy szakértő átbeszéli őket Önnel.</p>
          <a class="qou73xg fi3abjs pk4h2" href="#nl3qm8">A kezdőtervem megtekintése</a>
        </div>
      </form>
    </section>
    ...
    <section class="xrn58" data-u="sec" id="dmobczk" aria-labelledby="dl5sp">
      <div class="wdsnx3j">
        <span class="vd7z9k">Hogyan működik</span>
      ...
      <p style="margin-top:22px"><a class="qou73xg ec2hno" href="<?= page_url('product.php') ?>">A teljes útmutató elolvasása</a></p>
    </section>

    <section class="xrn58" data-u="sec" id="exd9dmd" aria-labelledby="rlolt2l">
      <div class="wdsnx3j">
        <span class="vd7z9k">Élő piacok</span>
    ...
    <section class="xrn58" data-u="sec" id="gp0nit" aria-labelledby="jg778dx">
      <div class="tsgf5eq">
        <div>
          <div class="wdsnx3j">
            <span class="vd7z9k">Bármely képernyőn</span>
    ...
    <section class="xrn58" id="nw3j7wd" aria-labelledby="wysa9hx">
      <div class="wdsnx3j">
        <span class="vd7z9k">Kérdések</span>
      ...
      <div class="hnxh4ir" itemscope itemtype="https://schema.org/FAQPage">
        <details open itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
          ...
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <p itemprop="text">Fiókját megnyithatja és feltöltheti <?= e(money_min()) ?> minimumtól. További forrásokat bármikor hozzáadhat, ahogy a befektetési terve halad.</p>
          </div>
        </details>
        <details itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
          <summary><h3 itemprop="name">Hogyan működnek a kifizetések?</h3></summary>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <p itemprop="text">Kérjen kifizetést bármikor az irányítópultról. Az összeg a választott fizetési módra tér vissza a szokásos feldolgozási időkkel.</p>
          </div>
        </details>
        <details itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
          <summary><h3 itemprop="name">Biztonságban van a pénzem?</h3></summary>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <p itemprop="text">A fiókokat professzionális szintű biztonság és személyazonosság-ellenőrzés védi. Mint minden befektetésnél, tőkéje kockázatnak van kitéve, és az értékek csökkenhetnek vagy növekedhetnek.</p>
          </div>
        </details>
        <details itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
          <summary><h3 itemprop="name">Mennyi időbe telik elkezdeni a befektetést?</h3></summary>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <p itemprop="text">A legtöbb tag néhány perc alatt befejezi a regisztrációt. Az első befizetés feldolgozása után a tervet azonnal aktiválhatja.</p>
          </div>
        </details>
        <details itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
          <summary><h3 itemprop="name">Vannak rejtett díjak?</h3></summary>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <p itemprop="text">Minden költség átláthatóan megjelenik, mielőtt elköteleződik. Mindig látja, mi vonatkozik a tervére — meglepetések nélkül.</p>
          </div>
        </details>
        <details itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
          <summary><h3 itemprop="name">Mi a minimális életkor a regisztrációhoz?</h3></summary>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <p itemprop="text">Legalább 18 évesnek kell lennie fiók nyitásához és befektetéshez. Az életkor és a személyazonosság megerősítéséhez ellenőrzés kérhető.</p>
          </div>
        </details>
        <details itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
          <summary><h3 itemprop="name">Mely fizetési módokat fogadják el?</h3></summary>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <p itemprop="text">Elfogadjuk a szokásos módokat: debit- és hitelkártya, banki átutalás, kiválasztott e-pénztárcák és kriptovaluták. A pontos lehetőségek a befizetési lépésnél jelennek meg.</p>
          </div>
        </details>
        <details itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
          <summary><h3 itemprop="name">Mikor érhető el az ügyfélszolgálat?</h3></summary>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <p itemprop="text">Támogató csapatunk hétfőtől péntekig, 9:00–18:00 között érhető el, és vállalja, hogy minden megkeresésre egy munkanapon belül válaszol.</p>
          </div>
        </details>
        <details itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
          <summary><h3 itemprop="name">Hogyan kezelik a nyereségadót?</h3></summary>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <p itemprop="text">A befektetési nyereség adója az Ön országa szabályaitól függ, és az Ön felelőssége. Javasoljuk a saját nyilvántartást és minősített adótanácsadó megkeresését.</p>
          </div>
        </details>
        <details itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
          <summary><h3 itemprop="name">Mi a KYC-ellenőrzés, és miért szükséges?</h3></summary>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <p itemprop="text">A KYC (Know Your Customer) szabványos személyazonosság-ellenőrzés. Segít biztonságban tartani a fiókokat, és a befektetési számla nyitásának rutin része.</p>
          </div>
        </details>
        <details itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
          <summary><h3 itemprop="name">Szükségem van előzetes befektetési tapasztalatra?</h3></summary>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <p itemprop="text">Nem. Minden tagnak személyes pénzügyi elemzője van, aki minden lépésnél vezeti, így előzetes piaci tudás nem szükséges.</p>
          </div>
        </details>
        <details itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
          <summary><h3 itemprop="name">Ki kezeli a befektetéseimet?</h3></summary>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <p itemprop="text">Dedikált pénzügyi elemző MI-eszközökkel, az Ön céljai és kockázati szintje köré dolgozva. Az elemző a szakmai szakértelmet a technológiával ötvözi — a döntések emberiek maradnak.</p>
          </div>
        </details>
        <details itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
          <summary><h3 itemprop="name">Megfelel a platform a szabályozási szabványoknak?</h3></summary>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <p itemprop="text">Igen — megfelel a nemzeti pénzügyi és kiberbiztonsági szabványoknak, beépített fiókvédelemmel és ellenőrzéssel.</p>
          </div>
        </details>
        <details itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
          <summary><h3 itemprop="name">Hozzáadhatok később további forrásokat a fiókomhoz?</h3></summary>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <p itemprop="text">Igen. Fiókját bármikor feltöltheti, és elemzőjével igazíthatja a tervét, ahogy céljai változnak.</p>
          </div>
        </details>
      </div>
      <p style="margin-top:22px"><a class="qou73xg ec2hno" href="<?= page_url('faq.php') ?>">Minden kérdés megtekintése</a></p>
    </section>
  </div>
</div>

<!--reviews-block--><section aria-label="Ügyfélértékelések" style="padding:3rem 1.25rem;background:var(--bg,#0b0f19)"><div style="max-width:68rem;margin:0 auto;background:var(--surface,#12182a);border:1px solid var(--border,rgba(255,255,255,.08));border-radius:18px;padding:24px 34px;display:flex;flex-wrap:wrap;align-items:center;justify-content:center;gap:18px 42px"><div style="text-align:center"><span style="display:inline-block;background:var(--accent,#e8b84b);color:var(--on-accent,#0b0d14);font:700 11px/1 Sora,system-ui,sans-serif;letter-spacing:.14em;padding:7px 12px;border-radius:6px;margin-bottom:10px">MEGBÍZHATÓ</span><div style="font:700 1.2rem Sora,system-ui,sans-serif;color:var(--text,#fff)"><?= e(SITE_NAME) ?> Értékelés</div></div><div style="font:800 2.7rem Sora,system-ui,sans-serif;color:var(--accent,#e8b84b);line-height:1;font-variant-numeric:tabular-nums">4.9</div><span style="position:relative;display:inline-block;font-size:1.55rem;line-height:1;letter-spacing:.1em" aria-hidden="true"><span style="color:var(--gold,#efb567);opacity:.25">★★★★★</span><span style="position:absolute;inset:0;overflow:hidden;white-space:nowrap;width:98.0%;color:var(--gold,#efb567)">★★★★★</span></span><div style="color:var(--muted,#9aa3b2);font-size:.95rem;font-variant-numeric:tabular-nums"><b style="color:var(--text,#fff)">817</b> értékelés · Alapja <b style="color:var(--text,#fff)">4,902</b> értékelés</div></div></section><section class="bjiwuc" id="nlokf" aria-labelledby="fglj2pf">
  <div class="ggh3sm kdbtf1i">
    <div>
      <span class="vd7z9k">Kezdés</span>
