...
document.getElementById('okm3tz') && (document.getElementById('okm3tz').textContent = new Date().getFullYear());
...
var loc=window.OFFER_LOCALE||'hu-HU';
...
var skip=document.querySelector('.skip-link,.skip-link');if(skip)skip.focus();});
})();
