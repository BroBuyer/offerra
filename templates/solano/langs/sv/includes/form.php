...
$form_submit = $form_submit ?? 'Börja nu';
...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__text">
      Din förfrågan till <?= e(SITE_NAME) ?> har tagits emot. Vänta på ett samtal från vår rådgivare.
    </p>
  </div>
...
<?php if ($is_stack): ?>
    <div class="rtjqp">
      <div class="jn406 field" data-field="fname">
        <label class="field-label" for="<?= e($form_id) ?>-fname">Förnamn</label>
        <input class="cm9aayi input" id="<?= e($form_id) ?>-fname" type="text" name="fname" placeholder="Förnamn" required pattern="[^\d]+" autocomplete="given-name">
      </div>
      <div class="jn406 field" data-field="lname">
        <label class="field-label" for="<?= e($form_id) ?>-lname">Efternamn</label>
        <input class="cm9aayi input" id="<?= e($form_id) ?>-lname" type="text" name="lname" placeholder="Efternamn" required pattern="[^\d]+" autocomplete="family-name">
      </div>
    </div>
    <div class="jn406 field" data-field="email">
      <label class="field-label" for="<?= e($form_id) ?>-email">E-post</label>
      <input class="cm9aayi input" id="<?= e($form_id) ?>-email" type="email" name="email" placeholder="E-post" required autocomplete="email" inputmode="email">
    </div>
...
<?php endif; ?>
    ...
    <div class="payrow" aria-label="Godkända betalningsmetoder">
      ...
      <svg class="fai" role="img" aria-label="Banköverföring" viewBox="0 0 512 512"><use href="#i-building-columns"/></svg>
      <svg class="fai pay-ok" role="img" aria-label="Säkert" viewBox="0 0 512 512"><use href="#i-shield-halved"/></svg>
    </div>
    ...
    <p class="jvrey">
      Genom att fortsätta godkänner du vår integritetspolicy och våra användarvillkor.
