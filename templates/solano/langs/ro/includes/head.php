...
$page_title = $page_title ?? (SITE_NAME . ' ᐉ Control deplin asupra investiției dumneavoastră, live');
$page_description = $page_description ?? ('Urmăriți în timp real cum lucrează capitalul dumneavoastră cu ' . SITE_NAME . ': rapoarte clare, un analist personal și AI. Generați venituri suplimentare de la ' . money_min());
...
<a class="nd5hm" href="#top">Sari la conținut</a>
