...
$form_submit = $form_submit ?? 'Započnite sada';
...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__title">Već ste registrirani</p>
    <p class="form-already-registered__text">
      Vaš zahtjev kod <?= e(SITE_NAME) ?> je primljen. Pričekajte poziv našeg savjetnika.
    </p>
  </div>
...
<?php if ($is_stack): ?>
    <div class="rtjqp">
      <div class="jn406 field" data-field="fname">
        <label class="field-label" for="<?= e($form_id) ?>-fname">Ime</label>
        <input class="cm9aayi input" id="<?= e($form_id) ?>-fname" type="text" name="fname" placeholder="Ime" required pattern="[^\d]+" autocomplete="given-name">
      </div>
    ...
    <div class="jn406 field" data-field="email">
      <label class="field-label" for="<?= e($form_id) ?>-email">E-pošta</label>
      <input class="cm9aayi input" id="<?= e($form_id) ?>-email" type="email" name="email" placeholder="E-pošta" required autocomplete="email" inputmode="email">
    </div>
    <div class="jn406 field" data-field="phone">
      <label class="field-label" for="<?= e($form_id) ?>-phone">Telefon</label>
      <input class="cm9aayi input" id="<?= e($form_id) ?>-phone" type="tel" name="fullphone" placeholder="091 234 5678" autocomplete="tel" inputmode="tel">
...
<?php endif; ?>
    ...
    <div class="payrow" aria-label="Prihvaćeni načini plaćanja">
      ...
      <svg class="fai" role="img" aria-label="Bankovni prijenos" viewBox="0 0 512 512"><use href="#i-building-columns"/></svg>
      <svg class="fai pay-ok" role="img" aria-label="Sigurno" viewBox="0 0 512 512"><use href="#i-shield-halved"/></svg>
    </div>
    ...
    <p class="jvrey">
      Nastavkom prihvaćate pravila privatnosti i uvjete korištenja.
