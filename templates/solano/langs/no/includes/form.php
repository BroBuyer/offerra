...
<?php if ($is_stack): ?>
    ...
    <div class="jn406 field" data-field="phone">
      ...
      <input class="cm9aayi input" id="<?= e($form_id) ?>-phone" type="tel" name="fullphone" placeholder="412 34 567" autocomplete="tel" inputmode="tel">
...
<?php endif; ?>
    ...
    <div class="payrow" aria-label="Aksepterte betalingsmetoder">
