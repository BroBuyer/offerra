...
<?php if ($is_stack): ?>
    <div class="rtjqp">
      <div class="jn406 field" data-field="fname">
        ...
        <input class="cm9aayi input" id="<?= e($form_id) ?>-fname" type="text" name="fname" placeholder="Όνομα" required pattern="[^\d]+" autocomplete="given-name">
      </div>
      <div class="jn406 field" data-field="lname">
        <label class="field-label" for="<?= e($form_id) ?>-lname">Επώνυμο</label>
        <input class="cm9aayi input" id="<?= e($form_id) ?>-lname" type="text" name="lname" placeholder="Επώνυμο" required pattern="[^\d]+" autocomplete="family-name">
      </div>
    </div>
...
<?php endif; ?>
    ...
    <div class="payrow" aria-label="Αποδεκτές μέθοδοι πληρωμής">
