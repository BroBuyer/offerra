...
$page_title = $page_title ?? (SITE_NAME . ' ᐉ Πλήρης έλεγχος της ζωντανής επένδυσής σας');
$page_description = $page_description ?? ('Παρακολουθήστε σε πραγματικό χρόνο πώς εργάζεται το κεφάλαιό σας με το ' . SITE_NAME . ': σαφείς αναφορές, προσωπικός αναλυτής και τεχνητή νοημοσύνη. Δημιουργήστε επιπλέον εισόδημα από ' . money_min());
