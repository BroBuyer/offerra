...
$schema = [
  ...
  '@graph' => [
    [
      ...
      'name' => SITE_NAME,
      'url' => rtrim(SITE_URL, '/') . '/',
      'description' => 'Επενδυτική πλατφόρμα με τεχνητή νοημοσύνη, που αντιστοιχίζει κάθε μέλος με προσωπικό χρηματοοικονομικό αναλυτή.',
      'areaServed' => 'Greece',
      'logo' => page_url('static/img/icons/apple-touch-icon.png'),
      'image' => page_url('static/img/og.webp'),
      'contactPoint' => [
        '@type' => 'ContactPoint',
        'contactType' => 'υποστήριξη πελατών',
        'email' => SUPPORT_EMAIL,
