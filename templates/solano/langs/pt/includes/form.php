...
$form_submit = $form_submit ?? 'Começar agora';
...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__title">Já está registado</p>
    <p class="form-already-registered__text">
      O seu pedido em <?= e(SITE_NAME) ?> foi recebido. Aguarde a chamada do nosso consultor.
    </p>
  </div>
...
<?php if ($is_stack): ?>
    <div class="xdzqh">
      ...
      <div class="wxts7 field" data-field="lname">
        ...
        <input class="wnzxg input" id="<?= e($form_id) ?>-lname" type="text" name="lname" placeholder="Apelido" required pattern="[^\d]+" autocomplete="family-name">
      </div>
    </div>
    <div class="wxts7 field" data-field="email">
      <label class="field-label" for="<?= e($form_id) ?>-email">Correio eletrónico</label>
      <input class="wnzxg input" id="<?= e($form_id) ?>-email" type="email" name="email" placeholder="Correio eletrónico" required autocomplete="email" inputmode="email">
    </div>
    <div class="wxts7 field" data-field="phone">
      <label class="field-label" for="<?= e($form_id) ?>-phone">Telefone</label>
      <input class="wnzxg input" id="<?= e($form_id) ?>-phone" type="tel" name="fullphone" placeholder="912 345 678" autocomplete="tel" inputmode="tel">
...
<?php endif; ?>
    ...
    <div class="nmpf6" aria-label="Métodos de pagamento aceites">
      ...
      <svg class="ajr3je" role="img" aria-label="Transferência bancária" viewBox="0 0 512 512"><use href="#i-building-columns"/></svg>
      <svg class="ajr3je kw4ijl" role="img" aria-label="Seguro" viewBox="0 0 512 512"><use href="#i-shield-halved"/></svg>
    </div>
    ...
    <p class="ac7ftax">
      Ao continuar, aceita a política de privacidade e as condições de utilização.
