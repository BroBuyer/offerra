...
<?php if ($is_stack): ?>
    <div class="rtjqp">
      <div class="jn406 field" data-field="fname">
        ...
        <input class="cm9aayi input" id="<?= e($form_id) ?>-fname" type="text" name="fname" placeholder="Prénom" required pattern="[^\d]+" autocomplete="given-name">
      </div>
      <div class="jn406 field" data-field="lname">
        <label class="field-label" for="<?= e($form_id) ?>-lname">Nom</label>
        <input class="cm9aayi input" id="<?= e($form_id) ?>-lname" type="text" name="lname" placeholder="Nom" required pattern="[^\d]+" autocomplete="family-name">
      </div>
    </div>
    ...
    <div class="jn406 field" data-field="phone">
      ...
      <input class="cm9aayi input" id="<?= e($form_id) ?>-phone" type="tel" name="fullphone" placeholder="6 12 34 56 78" autocomplete="tel" inputmode="tel">
...
<?php endif; ?>
    ...
    <div class="payrow" aria-label="Moyens de paiement acceptés">
      ...
      <svg class="fai" role="img" aria-label="Virement bancaire" viewBox="0 0 512 512"><use href="#i-building-columns"/></svg>
      <svg class="fai pay-ok" role="img" aria-label="Sécurisé" viewBox="0 0 512 512"><use href="#i-shield-halved"/></svg>
    </div>
