...
$form_submit = $form_submit ?? 'Commencer';
...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__text">
      Votre demande auprès de <?= e(SITE_NAME) ?> a bien été reçue. Merci d’attendre l’appel de notre conseiller.
    </p>
  </div>
...
<?php if ($is_stack): ?>
    <div class="xdzqh">
      <div class="wxts7 field" data-field="fname">
        <label class="field-label" for="<?= e($form_id) ?>-fname">Prénom</label>
        <input class="wnzxg input" id="<?= e($form_id) ?>-fname" type="text" name="fname" placeholder="Prénom" required pattern="[^\d]+" autocomplete="given-name">
      </div>
      <div class="wxts7 field" data-field="lname">
        <label class="field-label" for="<?= e($form_id) ?>-lname">Nom</label>
        <input class="wnzxg input" id="<?= e($form_id) ?>-lname" type="text" name="lname" placeholder="Nom" required pattern="[^\d]+" autocomplete="family-name">
      </div>
    </div>
    ...
    <div class="wxts7 field" data-field="phone">
      <label class="field-label" for="<?= e($form_id) ?>-phone">Téléphone</label>
      <input class="wnzxg input" id="<?= e($form_id) ?>-phone" type="tel" name="fullphone" placeholder="6 12 34 56 78" autocomplete="tel" inputmode="tel">
...
<?php endif; ?>
    ...
    <div class="nmpf6" aria-label="Moyens de paiement acceptés">
      ...
      <svg class="ajr3je" role="img" aria-label="Virement bancaire" viewBox="0 0 512 512"><use href="#i-building-columns"/></svg>
      <svg class="ajr3je kw4ijl" role="img" aria-label="Sécurisé" viewBox="0 0 512 512"><use href="#i-shield-halved"/></svg>
    </div>
