...
$page_title = SITE_NAME . ' ᐉ Contrôle total de votre investissement en direct';
$page_description = 'Suivez en temps réel comment votre capital travaille avec ' . SITE_NAME . ' : des rapports clairs, un analyste personnel et l’IA. Générez un revenu supplémentaire à partir de ' . money_min();
...
<section class="tl154k" aria-labelledby="rrqdpt">
  <div class="ggh3sm">
    <span class="vd7z9k">IA + analystes humains experts</span>
    <h1 id="rrqdpt"><?= e(SITE_NAME) ?></h1>
    <p class="ymraes">Un analyste financier personnel, appuyé par l’IA, qui aide des personnes ordinaires à générer une source de revenus supplémentaire, sans expérience préalable. Votre analyste vous guide à chaque étape, tandis que le tableau de bord montre en temps réel comment votre capital travaille.</p><!--hero-trust--><div style="margin:1.5rem -.7rem 1.6rem;font-size:.85rem;font-weight:500;line-height:1.7;color:var(--muted,#9aa3b2)"><span style="display:inline-flex;align-items:center;gap:.4rem;margin:.3rem .7rem;vertical-align:middle"><span aria-hidden="true">🛡</span>Réglementé</span><span style="display:inline-flex;align-items:center;gap:.4rem;margin:.3rem .7rem;vertical-align:middle"><span aria-hidden="true">🔒</span>Fonds ségrégués</span><span style="display:inline-flex;align-items:center;gap:.4rem;margin:.3rem .7rem;vertical-align:middle"><span aria-hidden="true">👥</span>39 600 clients</span><span style="display:inline-flex;align-items:center;gap:.4rem;margin:.3rem .7rem;vertical-align:middle"><span aria-hidden="true" style="color:var(--accent,#e8b84b)">★</span><span style="font-variant-numeric:tabular-nums">4,9</span> note</span></div>
    <div class="vseuxnl">
      <a class="qou73xg fi3abjs" href="#nl3qm8">Commencer — <?= e(money_min()) ?> min.</a>
      <a class="qou73xg ec2hno" href="<?= page_url('product.php') ?>">Comment ça marche</a>
    </div>
    <ul class="wxlxk">
      <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 6L9 17l-5-5"/></svg>Protection SSL</li>
      <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 6L9 17l-5-5"/></svg>Assistance 24/7</li>
      <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 6L9 17l-5-5"/></svg>Exécution rapide</li>
    </ul>
...
?>
    ...
    <div class="mcitl7d">
      <div class="ohqkun7"><b>33 000</b><span>Utilisateurs actifs</span></div>
      <div class="ohqkun7"><b>€0,6B</b><span>Volume échangé</span></div>
      <div class="ohqkun7"><b>99,8%</b><span>Disponibilité des signaux</span></div>
      <div class="ohqkun7"><b>24/7</b><span>Assistance</span></div>
    </div>
  </div>
</section>
...
<div class="ggh3sm jx8jnza">
  <details class="tjbln" open aria-label="Sur cette page">
    ...
    <ol>
      ...
      <li><a href="#dmobczk">Comment ça marche</a></li>
      <li><a href="#gp0nit">Sur n’importe quel écran</a></li>
      <li><a href="#esypwbx">Rendements</a></li>
      <li><a href="#evp8w6d">Protections</a></li>
      <li><a href="#vzo0q">Pourquoi <?= e(SITE_NAME) ?></a></li>
      <li><a href="#br1y4s">Ce que disent les membres</a></li>
      <li><a href="#vatll">Votre analyste</a></li>
      <li><a href="#rb8p3">Votre point de départ</a></li>
  ...
  <div>
    <section class="xrn58" data-u="sec" id="br1y4s" aria-labelledby="es9pra">
      <div class="wdsnx3j">
        <span class="vd7z9k">Ce que disent les membres</span>
      ...
      <div class="vdaz1q">
        <figure class="qkl7dd8" itemscope itemtype="https://schema.org/Review">
          ...
          <figcaption itemprop="author" itemscope itemtype="https://schema.org/Person">
            <b itemprop="name">Camille Dupont</b>Paris
          </figcaption>
        ...
        <figure class="qkl7dd8" itemscope itemtype="https://schema.org/Review">
          ...
          <figcaption itemprop="author" itemscope itemtype="https://schema.org/Person">
            <b itemprop="name">Thomas Martin</b>Lyon
          </figcaption>
          <meta itemprop="datePublished" content="2026-01-01"/>
          <div itemprop="reviewRating" itemscope itemtype="https://schema.org/Rating">
            <meta itemprop="ratingValue" content="5"/><meta itemprop="bestRating" content="5"/>
        ...
        <figure class="qkl7dd8" itemscope itemtype="https://schema.org/Review">
          ...
          <figcaption itemprop="author" itemscope itemtype="https://schema.org/Person">
            <b itemprop="name">Léa Bernard</b>Marseille
          </figcaption>
          <meta itemprop="datePublished" content="2026-01-01"/>
          <div itemprop="reviewRating" itemscope itemtype="https://schema.org/Rating">
            <meta itemprop="ratingValue" content="5"/><meta itemprop="bestRating" content="5"/>
        ...
        <figure class="qkl7dd8" itemscope itemtype="https://schema.org/Review">
          ...
          <figcaption itemprop="author" itemscope itemtype="https://schema.org/Person">
            <b itemprop="name">Nicolas Petit</b>Toulouse
          </figcaption>
          <meta itemprop="datePublished" content="2026-01-01"/>
          <div itemprop="reviewRating" itemscope itemtype="https://schema.org/Rating">
            <meta itemprop="ratingValue" content="5"/><meta itemprop="bestRating" content="5"/>
        ...
        <figure class="qkl7dd8" itemscope itemtype="https://schema.org/Review">
          ...
          <figcaption itemprop="author" itemscope itemtype="https://schema.org/Person">
            <b itemprop="name">Chloé Moreau</b>Nantes
          </figcaption>
          <meta itemprop="datePublished" content="2026-01-01"/>
          <div itemprop="reviewRating" itemscope itemtype="https://schema.org/Rating">
            <meta itemprop="ratingValue" content="5"/><meta itemprop="bestRating" content="5"/>
        ...
        <figure class="qkl7dd8" itemscope itemtype="https://schema.org/Review">
          ...
          <figcaption itemprop="author" itemscope itemtype="https://schema.org/Person">
            <b itemprop="name">Antoine Roux</b>Bordeaux
          </figcaption>
          <meta itemprop="datePublished" content="2026-01-01"/>
          <div itemprop="reviewRating" itemscope itemtype="https://schema.org/Rating">
            <meta itemprop="ratingValue" content="5"/><meta itemprop="bestRating" content="5"/>
    ...
    <section class="xrn58" data-u="sec" id="vzo0q" aria-labelledby="mzn56z">
      <div class="wdsnx3j">
        <span class="vd7z9k">Pourquoi <?= e(SITE_NAME) ?></span>
      ...
      <p style="margin-top:22px"><a class="qou73xg ec2hno" href="<?= page_url('offer.php') ?>">Pourquoi nous</a></p>
    </section>
    ...
    <section class="xrn58" data-u="sec" id="evp8w6d" aria-labelledby="ykur4hl">
      <div class="tsgf5eq">
        <div>
          <div class="wdsnx3j">
            <span class="vd7z9k">Protections</span>
        ...
        <img src="<?= asset('static/img/platform.webp') ?>" srcset="<?= asset('static/img/platform-640.webp') ?> 640w, <?= asset('static/img/platform.webp') ?> 800w" sizes="(max-width: 768px) 92vw, 680px" alt="Aperçu du portefeuille dans la plateforme" width="760" height="520" decoding="async" title="Aperçu du portefeuille dans la plateforme" loading="lazy">
      </div>
    </section>
    ...
    <section class="xrn58" data-u="sec" id="vatll" aria-labelledby="iouvw">
      <div class="tsgf5eq mudjf">
        ...
        <div>
          <div class="wdsnx3j">
            <span class="vd7z9k">Votre analyste</span>
    ...
    <section class="xrn58" id="esypwbx" aria-labelledby="rq8es">
      <div class="wdsnx3j">
        <span class="vd7z9k">Rendements</span>
      ...
      <div class="wmuyc">
        ...
        <div class="gbastl">
          ...
          <a class="qou73xg fi3abjs" href="#nl3qm8" style="margin-top:14px;width:100%">Ouvrir un compte</a>
        </div>
      </div>
    </section>
    ...
    <section class="xrn58" id="rb8p3" aria-labelledby="dv0846">
      <div class="wdsnx3j">
        <span class="vd7z9k">Trouvez votre point de départ</span>
      ...
      <form class="yw6xmlm" id="sqw38g" novalidate>
        ...
        <div class="beqazp3">
          <button class="qou73xg ec2hno sihas5z" type="button" hidden>Retour</button>
          ...
          <a class="qou73xg fi3abjs pk4h2" href="#nl3qm8">Voir mon plan de départ</a>
        </div>
      </form>
    </section>
    ...
    <section class="xrn58" data-u="sec" id="dmobczk" aria-labelledby="dl5sp">
      <div class="wdsnx3j">
        <span class="vd7z9k">Comment ça marche</span>
      ...
      <p style="margin-top:22px"><a class="qou73xg ec2hno" href="<?= page_url('product.php') ?>">Lire le guide complet</a></p>
    </section>

    <section class="xrn58" data-u="sec" id="exd9dmd" aria-labelledby="rlolt2l">
      <div class="wdsnx3j">
        <span class="vd7z9k">Marchés en direct</span>
    ...
    <section class="xrn58" data-u="sec" id="gp0nit" aria-labelledby="jg778dx">
      <div class="tsgf5eq">
        <div>
          <div class="wdsnx3j">
            <span class="vd7z9k">Sur n’importe quel écran</span>
      ...
      <div class="hnxh4ir" itemscope itemtype="https://schema.org/FAQPage">
        <details open itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
          ...
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <p itemprop="text">Vous pouvez ouvrir et alimenter votre compte à partir de <?= e(money_min()) ?> minimum. Vous êtes libre d’ajouter davantage de fonds au fur et à mesure de votre plan d’investissement.</p>
          </div>
        </details>
        <details itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
          <summary><h3 itemprop="name">Comment fonctionnent les retraits ?</h3></summary>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <p itemprop="text">Demandez un retrait à tout moment depuis votre tableau de bord. Les fonds reviennent vers le moyen de paiement que vous avez choisi, avec les délais de traitement habituels.</p>
          </div>
        </details>
        <details itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
          <summary><h3 itemprop="name">Mon argent est-il conservé en sécurité ?</h3></summary>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <p itemprop="text">Les comptes sont protégés par une sécurité de niveau professionnel et des contrôles d’identité. Comme pour tout investissement, votre capital est à risque et les valeurs peuvent baisser comme augmenter.</p>
          </div>
        </details>
        <details itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
          <summary><h3 itemprop="name">Combien de temps faut-il pour commencer à investir ?</h3></summary>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <p itemprop="text">La plupart des membres terminent l’inscription en quelques minutes. Une fois votre premier dépôt traité, vous pouvez activer un plan immédiatement.</p>
          </div>
        </details>
        <details itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
          <summary><h3 itemprop="name">Y a-t-il des frais cachés ?</h3></summary>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <p itemprop="text">Tous les coûts sont affichés de façon transparente avant que vous vous engagiez. Vous verrez toujours ce qui s’applique à votre plan, sans surprise.</p>
          </div>
        </details>
        <details itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
          <summary><h3 itemprop="name">Quel est l’âge minimum pour s’inscrire ?</h3></summary>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <p itemprop="text">Vous devez avoir au moins 18 ans pour ouvrir un compte et investir. Une vérification peut être demandée pour confirmer votre âge et votre identité.</p>
          </div>
        </details>
        <details itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
          <summary><h3 itemprop="name">Quels moyens de paiement sont acceptés ?</h3></summary>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <p itemprop="text">Les moyens courants comme les cartes de débit et de crédit, les virements bancaires, certains portefeuilles électroniques et les cryptomonnaies sont acceptés. Les options exactes s’affichent à l’étape du dépôt.</p>
          </div>
        </details>
        <details itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
          <summary><h3 itemprop="name">Quand l’assistance client est-elle disponible ?</h3></summary>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <p itemprop="text">Notre équipe d’assistance est disponible du lundi au vendredi, de 9 h à 18 h, et s’engage à répondre à chaque demande sous un jour ouvré.</p>
          </div>
        </details>
        <details itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
          <summary><h3 itemprop="name">Comment sont gérés les impôts sur les plus-values ?</h3></summary>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <p itemprop="text">Les impôts sur les plus-values d’investissement dépendent des règles de votre pays et relèvent de votre responsabilité. Nous vous recommandons de conserver vos propres justificatifs et de consulter un conseiller fiscal qualifié.</p>
          </div>
        </details>
        <details itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
          <summary><h3 itemprop="name">Qu’est-ce que la vérification KYC et pourquoi est-elle exigée ?</h3></summary>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <p itemprop="text">Le KYC (Know Your Customer, « connaissance du client ») est un contrôle standard de votre identité. Il contribue à sécuriser les comptes et fait partie du processus habituel d’ouverture d’un compte d’investissement.</p>
          </div>
        </details>
        <details itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
          <summary><h3 itemprop="name">Ai-je besoin d’une expérience préalable en investissement ?</h3></summary>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <p itemprop="text">Non. Chaque membre dispose d’un analyste financier personnel qui vous guide à chaque étape, vous n’avez donc pas besoin de connaître déjà les marchés.</p>
          </div>
        </details>
        <details itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
          <summary><h3 itemprop="name">Qui gère mes investissements ?</h3></summary>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <p itemprop="text">Un analyste financier dédié, appuyé par des outils d’IA, qui travaille selon vos objectifs et votre niveau de risque. L’analyste combine expertise professionnelle et technologie — les décisions restent humaines.</p>
          </div>
        </details>
        <details itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
          <summary><h3 itemprop="name">La plateforme respecte-t-elle les normes réglementaires ?</h3></summary>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <p itemprop="text">Oui — elle répond aux normes financières et de cybersécurité nationales, avec protection du compte et vérification intégrées.</p>
          </div>
        </details>
        <details itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
          <summary><h3 itemprop="name">Puis-je ajouter davantage de fonds plus tard ?</h3></summary>
          <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <p itemprop="text">Oui. Vous pouvez alimenter votre compte à tout moment et ajuster votre plan avec votre analyste au fil de l’évolution de vos objectifs.</p>
          </div>
        </details>
      </div>
      <p style="margin-top:22px"><a class="qou73xg ec2hno" href="<?= page_url('faq.php') ?>">Voir toutes les questions</a></p>
    </section>
  </div>
</div>

<!--reviews-block--><section aria-label="Avis clients" style="padding:3rem 1.25rem;background:var(--bg,#0b0f19)"><div style="max-width:68rem;margin:0 auto;background:var(--surface,#12182a);border:1px solid var(--border,rgba(255,255,255,.08));border-radius:18px;padding:24px 34px;display:flex;flex-wrap:wrap;align-items:center;justify-content:center;gap:18px 42px"><div style="text-align:center"><span style="display:inline-block;background:var(--accent,#e8b84b);color:var(--on-accent,#0b0d14);font:700 11px/1 Sora,system-ui,sans-serif;letter-spacing:.14em;padding:7px 12px;border-radius:6px;margin-bottom:10px">FIABLE</span><div style="font:700 1.2rem Sora,system-ui,sans-serif;color:var(--text,#fff)"><?= e(SITE_NAME) ?> Avis</div></div><div style="font:800 2.7rem Sora,system-ui,sans-serif;color:var(--accent,#e8b84b);line-height:1;font-variant-numeric:tabular-nums">4,9</div><span style="position:relative;display:inline-block;font-size:1.55rem;line-height:1;letter-spacing:.1em" aria-hidden="true"><span style="color:var(--gold,#efb567);opacity:.25">★★★★★</span><span style="position:absolute;inset:0;overflow:hidden;white-space:nowrap;width:98.0%;color:var(--gold,#efb567)">★★★★★</span></span><div style="color:var(--muted,#9aa3b2);font-size:.95rem;font-variant-numeric:tabular-nums"><b style="color:var(--text,#fff)">817</b> avis · Basé sur <b style="color:var(--text,#fff)">4 902</b> notes</div></div></section><section class="bjiwuc" id="nlokf" aria-labelledby="fglj2pf">
  <div class="ggh3sm kdbtf1i">
    <div>
      <span class="vd7z9k">Commencer</span>
