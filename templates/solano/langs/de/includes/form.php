...
$form_submit = $form_submit ?? 'Jetzt starten';
...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__text">
      Ihre Anfrage bei <?= e(SITE_NAME) ?> ist eingegangen. Bitte warten Sie auf den Anruf unseres Beraters.
    </p>
  </div>
...
<?php if ($is_stack): ?>
    <div class="xdzqh">
      <div class="wxts7 field" data-field="fname">
        <label class="field-label" for="<?= e($form_id) ?>-fname">Vorname</label>
        <input class="wnzxg input" id="<?= e($form_id) ?>-fname" type="text" name="fname" placeholder="Vorname" required pattern="[^\d]+" autocomplete="given-name">
      </div>
      <div class="wxts7 field" data-field="lname">
        <label class="field-label" for="<?= e($form_id) ?>-lname">Nachname</label>
        <input class="wnzxg input" id="<?= e($form_id) ?>-lname" type="text" name="lname" placeholder="Nachname" required pattern="[^\d]+" autocomplete="family-name">
      </div>
    </div>
...
<?php endif; ?>
    ...
    <div class="nmpf6" aria-label="Akzeptierte Zahlungsmethoden">
      ...
      <svg class="ajr3je" role="img" aria-label="Überweisung" viewBox="0 0 512 512"><use href="#i-building-columns"/></svg>
      <svg class="ajr3je kw4ijl" role="img" aria-label="Sicher" viewBox="0 0 512 512"><use href="#i-shield-halved"/></svg>
    </div>
    ...
    <p class="ac7ftax">
      Mit dem Fortfahren akzeptieren Sie unsere Datenschutzerklärung und Nutzungsbedingungen.
