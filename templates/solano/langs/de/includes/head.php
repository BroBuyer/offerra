...
$page_title = $page_title ?? (SITE_NAME . ' ᐉ Volle Kontrolle über Ihre Investition, live');
$page_description = $page_description ?? ('Verfolgen Sie in Echtzeit, wie Ihr Kapital mit ' . SITE_NAME . ' arbeitet: klare Berichte, persönlicher Analyst und KI. Erzielen Sie Zusatzeinkommen ab ' . money_min());
...
<a class="nd5hm" href="#top">Zum Inhalt springen</a>
