...
<?php if ($is_stack): ?>
    <div class="rtjqp">
      <div class="jn406 field" data-field="fname">
        ...
        <input class="cm9aayi input" id="<?= e($form_id) ?>-fname" type="text" name="fname" placeholder="Navn" required pattern="[^\d]+" autocomplete="given-name">
      </div>
    ...
    <div class="jn406 field" data-field="phone">
      ...
      <input class="cm9aayi input" id="<?= e($form_id) ?>-phone" type="tel" name="fullphone" placeholder="12 34 56 78" autocomplete="tel" inputmode="tel">
...
<?php endif; ?>
    ...
    <div class="payrow" aria-label="Accepterede betalingsmetoder">
