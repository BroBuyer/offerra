...
{
    return SITE_NAME . ' — piattaforma di trading su mobile: grafico BTC/USDT in tempo reale, order book e interfaccia di acquisto/vendita';
}

function platform_image_caption(): string
{
    return SITE_NAME . ' — trading mobile con grafici crypto in tempo reale';
}
