...
$page_title = $page_title ?? (SITE_NAME . ' ᐉ Controllo in tempo reale del tuo investimento');
$page_description = $page_description ?? ('Segui in tempo reale come lavora il tuo capitale con ' . SITE_NAME . ': report chiari, un analista personale e l’IA. Genera un reddito extra a partire da ' . money_min());
...
window.APP_LANG = {
  ...
  valPhoneCountry: 'Prefisso internazionale non valido',
