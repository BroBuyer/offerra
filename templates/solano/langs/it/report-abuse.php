...
<section class="ykzi1">
  <div class="ggh3sm">
    ...
    <p class="etpy2">Aiutaci a proteggere <?= e(SITE_NAME) ?>. Segnala una frode sospetta, un’usurpazione d’identità o un uso improprio della nostra piattaforma o del nostro marchio.</p>
  </div>
</section>
