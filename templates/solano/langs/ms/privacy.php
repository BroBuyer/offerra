...
$page_title = 'Dasar Privasi ᐉ ' . SITE_NAME;
...
<section class="ykzi1">
  <div class="ggh3sm">
    <span class="vd7z9k">Undang-undang information</span>
    <h1>Dasar Privasi</h1>
...
<section class="bqfjng">
  <div class="ggh3sm">
    ...
    <h2>1. Pengenalan</h2>
    <p><?= e(SITE_NAME) ?> ("we", "us", "our") is committed to protecting the privacy of visitors and clients. This Dasar Privasi explains what personal data we collect, why we collect it and how we process it when you use our website and services.</p>
