...
$page_title = $page_title ?? (SITE_NAME . ' ᐉ Full control of your live investment');
$page_description = $page_description ?? ('Follow in real time how your capital works with ' . SITE_NAME . ': clear reports, a personal analyst and AI. Generate extra income from ' . money_min());
...
<script>
window.APP_LANG = {
  valTelefonInvalid: 'Masukkan nombor telefon yang sah',
  valTelefonCountry: 'Kod negara tidak sah',
  valTelefonShort: 'Nombor terlalu pendek',
  valTelefonLong: 'Nombor terlalu panjang'
};
