...
<?php if ($is_stack): ?>
    <div class="rtjqp">
      <div class="jn406 field" data-field="fname">
        ...
        <input class="cm9aayi input" id="<?= e($form_id) ?>-fname" type="text" name="fname" placeholder="Nama pertama" required pattern="[^\d]+" autocomplete="given-name">
      </div>
      <div class="jn406 field" data-field="lname">
        <label class="field-label" for="<?= e($form_id) ?>-lname">Nama keluarga</label>
        <input class="cm9aayi input" id="<?= e($form_id) ?>-lname" type="text" name="lname" placeholder="Nama keluarga" required pattern="[^\d]+" autocomplete="family-name">
      </div>
      <div class="jn406 field" data-field="email">
      <label class="field-label" for="<?= e($form_id) ?>-email">E-mel</label>
      <input class="cm9aayi input" id="<?= e($form_id) ?>-email" type="email" name="email" placeholder="E-mel" required autocomplete="email" inputmode="email">
    </div>
...
<?php endif; ?>
    ...
    <div class="payrow" aria-label="Accepted payment methods">
      ...
      <svg class="fai" role="img" aria-label="Pindahan bank" viewBox="0 0 512 512"><use href="#i-building-columns"/></svg>
