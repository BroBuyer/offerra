...
<?php if ($is_stack): ?>
    <div class="rtjqp">
      <div class="jn406 field" data-field="fname">
        ...
        <input class="cm9aayi input" id="<?= e($form_id) ?>-fname" type="text" name="fname" placeholder="Meno" required pattern="[^\d]+" autocomplete="given-name">
      </div>
      <div class="jn406 field" data-field="lname">
        <label class="field-label" for="<?= e($form_id) ?>-lname">Priezvisko</label>
        <input class="cm9aayi input" id="<?= e($form_id) ?>-lname" type="text" name="lname" placeholder="Priezvisko" required pattern="[^\d]+" autocomplete="family-name">
      </div>
...
<?php endif; ?>
    ...
    <div class="payrow" aria-label="Prijímané platobné metódy">
      ...
      <svg class="fai pay-ok" role="img" aria-label="Zabezpečené" viewBox="0 0 512 512"><use href="#i-shield-halved"/></svg>
    </div>
