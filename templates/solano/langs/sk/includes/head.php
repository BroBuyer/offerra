...
$page_title = $page_title ?? (SITE_NAME . ' ᐉ Plná kontrola nad vašou investíciou, naživo');
$page_description = $page_description ?? ('Sledujte v reálnom čase, ako váš kapitál pracuje s ' . SITE_NAME . ': prehľadné reporty, osobný analytik a AI. Generujte dodatočný príjem od ' . money_min());
