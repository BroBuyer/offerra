...
$page_title = 'Kullanım koşulları ᐉ ' . SITE_NAME;
$page_description = SITE_NAME . ' kullanım koşulları';
...
<section class="ykzi1">
  <div class="ggh3sm">
    <span class="vd7z9k">Yasal</span>
    <h1>Kullanım Koşulları</h1>
    <p class="etpy2"><?= e(SITE_NAME) ?> sitesine eriştiğinizde veya kullandığınızda geçerli kurallar.</p>
  </div>
</section>
...
<section class="bqfjng">
  <div class="ggh3sm">
    ...
    <p><?= e(SITE_NAME) ?> web sitesine ve hizmetlerine erişerek veya bunları kullanarak bu Kullanım Koşullarına bağlı olmayı kabul edersiniz. Kabul etmiyorsanız hizmetleri kullanmayın.</p>
    ...
    <p>Hizmetler herhangi bir garanti olmaksızın “olduğu gibi” ve “mevcut olduğu şekilde” sunulur. İşlem yapmak önemli kayıp riski içerir. Ayrıntılar için <a href="<?= page_url('risk-disclosure.php') ?>" style="color:var(--accent)">Risk bildirimi</a> bakın.</p>
    ...
    <h2>11. Tazminat</h2>
    <p>Bu Koşulları ihlalinizden veya hizmetleri kötüye kullanmanızdan doğan her türlü talebe karşı <?= e(SITE_NAME) ?>, bağlı kuruluşları ve personelini tazmin etmeyi ve sorumsuz tutmayı kabul edersiniz.</p>

    <h2>12. Askıya alma ve fesih</h2>
    <p>Bu Koşulları veya geçerli hukuku ihlal ettiğinize inanırsak, bildirimli veya bildirimsiz olarak hizmetlere erişimi istediğimiz zaman askıya alabilir veya sonlandırabiliriz.</p>

    <h2>13. Geçerli hukuk</h2>
    <p>Bu Koşullar, kanunlar ihtilafı ilkelerine bakılmaksızın <?= e(SITE_NAME) ?> merkezinin geçerli yasalarına tabidir.</p>

    <h2>14. Değişiklikler</h2>
    <p>Bu Koşulları zaman zaman değiştirebiliriz. Değişikliklerden sonra hizmetleri kullanmaya devam etmek, revize edilmiş Koşulların kabulü anlamına gelir.</p>

    <h2>15. İletişim</h2>
    <p>Bu Koşullarla ilgili sorular iletişim sayfamız üzerinden gönderilebilir.</p>
