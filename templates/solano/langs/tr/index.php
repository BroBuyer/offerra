...
<div class="ggh3sm jx8jnza">
  ...
  <div>
      ...
      <div class="vdaz1q">
        <figure class="qkl7dd8" itemscope itemtype="https://schema.org/Review">
          <div class="dnjuv">
            ...
            <span class="ue1r1">+2.200 € ile 4 ayda</span>
          </div>
    ...
    <section class="xrn58" data-u="sec" id="vzo0q" aria-labelledby="mzn56z">
      ...
      <div class="smnsm2" role="region" tabindex="0" aria-label="Tablo yok. Ekran yok. Son dakika şüphesi yok"><table class="by635s">
        ...
        <tbody>
          <tr><td>YZ emir yürütmesi</td><td class="bfe2o6f">✓</td><td class="byuav">sınırlı saatler</td><td class="byuav">elle</td></tr>
          <tr><td>Tüm piyasalarda 7/24 kapsama</td><td class="bfe2o6f">✓</td><td class="byuav">evrak işi</td><td class="byuav">kendi başınıza</td></tr>
          <tr><td>Saniyenin altında emir yönlendirme</td><td class="bfe2o6f">✓</td><td class="byuav">yalnızca tarife göre</td><td class="byuav">elle</td></tr>
          <tr><td>Çoklu para biriminde raporlama</td><td class="bfe2o6f">✓</td><td class="byuav">sınırlı saatler</td><td class="byuav">kendi başınıza</td></tr>
          <tr><td>Kâğıtsız hesap açılışı</td><td class="bfe2o6f">✓</td><td class="byuav">evrak işi</td><td class="byuav">elle</td></tr>
          <tr><td>Borsalar arası arbitraj</td><td class="bfe2o6f">✓</td><td class="byuav">yalnızca tarife göre</td><td class="byuav">kendi başınıza</td></tr>
    ...
    <section class="xrn58" id="esypwbx" aria-labelledby="rq8es">
      ...
      <div class="wmuyc">
        <div>
          ...
          ?>
          <div class="vcf9ca"><label for="calc-dep">Başlangıç tutarı</label><span class="cj9i15q" id="csezcv1"><?= e(currency_symbol() . number_format($calc_default, 0)) ?></span></div>
          <input id="lsm9on" type="range" min="<?= (int) $calc_min ?>" max="<?= (int) $calc_max ?>" step="50" value="<?= (int) $calc_default ?>" aria-label="Başlangıç tutarı"/>
          <div class="vcf9ca"><label for="calc-mon">Ay</label><span class="cj9i15q" id="ywprvgd">6</span></div>
          <input id="gqz8w" type="range" min="1" max="24" step="1" value="6" aria-label="Ay"/>
          <p class="ifuciwq">Rakamlar örnektir. Fiili getirileriniz yatırdığınız tutara ve analistinizle seçtiğiniz stratejiye bağlıdır.</p>
        </div>
        <div class="gbastl">
    ...
    <section class="xrn58" data-u="sec" id="dmobczk" aria-labelledby="dl5sp">
      ...
      <ol class="zzk9i">
        <li><span class="vpx6kk">01</span><div><h3>Hesabınızı oluşturun</h3><p>Yalnızca e-postanızla birkaç dakikada kaydolun.</p></div></li>
        <li><span class="vpx6kk">02</span><div><h3>E-postanızı doğrulayın</h3><p>Hesabınızı korumak için adresinizi onaylayın.</p></div></li>
        <li><span class="vpx6kk">03</span><div><h3>Fon yatırın</h3><p>Şu tutardan sermaye ekleyin: <?= e(money_min()) ?> tercih ettiğiniz yöntemle.</p></div></li>
    ...
    <section class="xrn58" data-u="sec" id="exd9dmd" aria-labelledby="rlolt2l">
      ...
      <div class="smnsm2" role="region" tabindex="0" aria-label="Bitcoin, Ethereum ve çok daha fazlasıyla işlem yapın"><table class="nd3owbf">
    ...
    <section class="xrn58" data-u="sec" id="sor9s" aria-labelledby="onidtj">
      ...
      <ol class="zzk9i">
        <li><span class="vpx6kk">01</span><div><h3>Bağlı her piyasada saniyenin altında yürütme</h3><p><?= e(SITE_NAME) ?> desteklenen her borsayla kalıcı, düşük gecikmeli API bağlantıları tutar. Model sinyal ürettiğinde emir bir sonraki tick’ten önce gönderilir, gerçekleşir ve panelinize kaydedilir.</p></div></li>
        <li><span class="vpx6kk">02</span><div><h3>Her piyasa seansında 7/24 çalışır</h3><p>Kripto durmaz, <?= e(SITE_NAME) ?> da durmaz. Motor, bir fırsatın kaçmaması için hafta sonları ve tatillerde de çiftleri analiz etmeye devam eder.</p></div></li>
        <li><span class="vpx6kk">03</span><div><h3>Çoklu para biriminde raporlama</h3><p>Her bakiye, her işlem ve her çekim yerel para biriminizde gösterilir. Hiçbir noktada gizli dönüşüm adımı yoktur.</p></div></li>
        <li><span class="vpx6kk">04</span><div><h3>Ayrılmış sermaye</h3><p>Fonlarınız kendi hesabınızda kalır. <?= e(SITE_NAME) ?> bunları asla tutmaz: motorun yalnızca emir gönderme izni vardır.</p></div></li>
        <li><span class="vpx6kk">05</span><div><h3>Banka düzeyinde güvenlik</h3><p>Platform genelinde TLS şifreleme, varsayılan iki adımlı doğrulama ve üç aylık üçüncü taraf altyapı denetimleri. İşlem makbuzları zincir üzerinde kaydedilir.</p></div></li>
        <li><span class="vpx6kk">06</span><div><h3>Üç varlık sınıfı, bir platform</h3><p>Çoğu bireysel platform sizi tek bir piyasayla sınırlar. <?= e(SITE_NAME) ?> aynı panelden kripto paralar, borsada işlem gören hisseler ve başlıca döviz çiftleriyle işlem yapar.</p></div></li>
        <li><span class="vpx6kk">07</span><div><h3>Her pozisyonda önceden ayarlanmış risk limitleri</h3><p>Stop-loss, kabul edilen maksimum zarar ve sermaye tahsis tavanları varlık sınıfına göre ayarlanır. Motor eşiği aşan her işlemi otomatik kapatır ve olay denetim geçmişinize kaydedilir.</p></div></li>
      </ol>
    </section>
