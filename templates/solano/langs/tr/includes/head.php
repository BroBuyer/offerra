...
$page_title = $page_title ?? (SITE_NAME . ' ᐉ Canlı yatırımınız üzerinde tam kontrol');
$page_description = $page_description ?? ('Sermayenizin ' . SITE_NAME . ' ile gerçek zamanlı nasıl çalıştığını izleyin: net raporlar, kişisel analist ve yapay zekâ. Ek gelir elde edin, şu tutardan: ' . money_min());
...
<a class="skip-link" href="#top">İçeriğe geç</a>
