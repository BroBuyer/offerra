<header class="dx8ngh3">
  <div class="nrzt44 yd4epmn">
    ...
    <nav class="gjm518" aria-label="Main">
      ...
      <a href="<?= page_url('product.php') ?>">How it works</a>
      ...
      <a class="rs0voj6 ggca24u sstr1ao" href="<?= page_url() ?>#jsyo6">Open your account</a>
    </nav>
    <div class="hdhwxf" hidden></div>
    <div class="eesqjj4">
      <a class="rs0voj6 ggca24u" href="<?= page_url() ?>#jsyo6">Open your account</a>
      <button class="vuppvr" aria-label="Open menu" aria-expanded="false" type="button">
