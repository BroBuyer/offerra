...
$page_title = SITE_NAME . ' ᐉ How it works — From the first click to your first position';
...
<section class="kj9w4x">
  <div class="ggh3sm">
    <span class="qwce6q">How it works</span>
  ...
  <div class="ggh3sm">
    ...
    <ol class="nxlk2qu" itemscope itemtype="https://schema.org/HowTo">
      ...
      <li itemprop="step" itemscope itemtype="https://schema.org/HowToStep">
        <h3 itemprop="name">Create your account</h3><p itemprop="text">Register in a few minutes with your email only.</p></li>
      <li itemprop="step" itemscope itemtype="https://schema.org/HowToStep">
        <h3 itemprop="name">Verify your email</h3><p itemprop="text">Confirm your address to protect your account.</p></li>
      <li itemprop="step" itemscope itemtype="https://schema.org/HowToStep">
        <h3 itemprop="name">Deposit funds</h3><p itemprop="text">Add capital from <?= e(money_min()) ?>, with the method you prefer.</p></li>
      <li itemprop="step" itemscope itemtype="https://schema.org/HowToStep">
        <h3 itemprop="name">Set your strategy</h3><p itemprop="text">Choose your goals; your analyst shapes the plan around you.</p></li>
      <li itemprop="step" itemscope itemtype="https://schema.org/HowToStep">
