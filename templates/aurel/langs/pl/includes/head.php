...
$page_title = $page_title ?? (SITE_NAME . ' ᐉ Pełna kontrola nad Państwa inwestycją, na żywo');
$page_description = $page_description ?? ('Śledź w czasie rzeczywistym, jak Państwa kapitał pracuje z ' . SITE_NAME . ': czytelne raporty, osobisty analityk i AI. Generuj dodatkowy dochód od ' . money_min());
...
<a class="nd5hm" href="#top">Przejdź do treści</a>
