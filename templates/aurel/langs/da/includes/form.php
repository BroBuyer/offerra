...
$form_submit = $form_submit ?? 'Kom i gang nu';
...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__text">
      Din anmodning hos <?= e(SITE_NAME) ?> er modtaget. Vent på opkald fra vores rådgiver.
    </p>
  </div>
...
<?php if ($is_stack): ?>
    ...
    <div class="wxts7 field" data-field="phone">
      ...
      <input class="wnzxg input" id="<?= e($form_id) ?>-phone" type="tel" name="fullphone" placeholder="12 34 56 78" autocomplete="tel" inputmode="tel">
...
<?php endif; ?>
    ...
    <div class="nmpf6" aria-label="Accepterede betalingsmetoder">
      ...
      <svg class="ajr3je" role="img" aria-label="Bankoverførsel" viewBox="0 0 512 512"><use href="#i-building-columns"/></svg>
    ...
    <p class="ac7ftax">
      Ved at fortsætte accepterer du privatlivspolitikken og brugsvilkårene.
