...
$form_submit = $form_submit ?? 'Mula sekarang';
...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__text">
      Permintaan anda dengan <?= e(SITE_NAME) ?> has been received. Sila tunggu for a call from our adviser.
    </p>
  </div>
...
<?php if ($is_stack): ?>
    <div class="xdzqh">
      <div class="wxts7 field" data-field="fname">
        <label class="field-label" for="<?= e($form_id) ?>-fname">Nama pertama</label>
        <input class="wnzxg input" id="<?= e($form_id) ?>-fname" type="text" name="fname" placeholder="Nama pertama" required pattern="[^\d]+" autocomplete="given-name">
      </div>
      <div class="wxts7 field" data-field="lname">
        <label class="field-label" for="<?= e($form_id) ?>-lname">Nama keluarga</label>
        <input class="wnzxg input" id="<?= e($form_id) ?>-lname" type="text" name="lname" placeholder="Nama keluarga" required pattern="[^\d]+" autocomplete="family-name">
      </div>
    </div>
    <div class="wxts7 field" data-field="email">
      <label class="field-label" for="<?= e($form_id) ?>-email">E-mel</label>
      <input class="wnzxg input" id="<?= e($form_id) ?>-email" type="email" name="email" placeholder="E-mel" required autocomplete="email" inputmode="email">
    </div>
...
<?php endif; ?>
    ...
    <div class="nmpf6" aria-label="Accepted payment methods">
      ...
      <svg class="ajr3je" role="img" aria-label="Pindahan bank" viewBox="0 0 512 512"><use href="#i-building-columns"/></svg>
      <svg class="ajr3je kw4ijl" role="img" aria-label="Selamat" viewBox="0 0 512 512"><use href="#i-shield-halved"/></svg>
    </div>
