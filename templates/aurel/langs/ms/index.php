...
<section class="tl154k" aria-labelledby="rrqdpt">
  <div class="ggh3sm">
    ...
    <div class="vseuxnl">
      ...
      <a class="qou73xg ec2hno" href="<?= page_url('product.php') ?>">Cara ia berfungsi</a>
    </div>
    <ul class="wxlxk">
...
?>
    ...
    <div class="mcitl7d">
      ...
      <div class="ohqkun7"><b>24/7</b><span>Sokongan</span></div>
    </div>
  </div>
</section>
...
<div class="ggh3sm jx8jnza">
  ...
  <div>
    ...
    <section class="xrn58" id="esypwbx" aria-labelledby="rq8es">
      ...
      <div class="wmuyc">
        ...
        <div class="gbastl">
          ...
          <a class="qou73xg fi3abjs" href="#nl3qm8" style="margin-top:14px;width:100%">Buka akaun</a>
        </div>
      </div>
    </section>
    ...
    <section class="xrn58" data-u="sec" id="dmobczk" aria-labelledby="dl5sp">
      <div class="wdsnx3j">
        <span class="vd7z9k">Cara ia berfungsi</span>
