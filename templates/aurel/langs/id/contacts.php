...
$page_title = 'Hubungi ' . SITE_NAME . ' ᐉ Kami siap membantu';
...
<section class="onxr8te" data-u="sec">
  <div class="ggh3sm">
    ...
    <ul class="skvsaz4">
      ...
      <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 6L9 17l-5-5"/></svg><span><a href="<?= page_url('product.php') ?>" style="color:var(--accent)">Cara kerjanya</a> — what happens after you register, step by step.</span></li>
  ...
  <div class="ggh3sm">
    ...
    <div class="smnsm2" role="region" tabindex="0"><table class="wcle1">
      ...
      <tbody>
        ...
        <tr><td>Callback request</td><td>Anything easier to explain by phone</td><td>Dukungan hours: Monday to Friday, 9:00–18:00</td></tr>
