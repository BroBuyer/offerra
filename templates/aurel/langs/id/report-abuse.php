...
$page_title = 'Laporkan penyalahgunaan ᐉ ' . SITE_NAME;
$page_description = 'Laporkan penyalahgunaan — ' . SITE_NAME;
...
<section class="bqfjng">
  <div class="ggh3sm">
    ...
    <p style="margin-top:36px">
      <a class="qou73xg fi3abjs" href="<?= page_url('contacts.php') ?>">Hubungi Trust and Safety</a>
      <a class="qou73xg ec2hno" href="<?= page_url() ?>" style="margin-left:8px">← Kembali ke beranda</a>
    </p>
  </div>
</section>
</main>
