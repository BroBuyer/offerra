...
<section class="onxr8te" data-u="sec">
  <div class="ggh3sm">
    ...
    <ul class="skvsaz4">
      ...
      <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 6L9 17l-5-5"/></svg><span>Dukungan specialists who handle onboarding, verification and withdrawals.</span></li>
    </ul>
  </div>
</section>
...
<section class="onxr8te" data-u="sec">
  <div class="ggh3sm">
    ...
    <ol class="nxlk2qu">
      ...
      <li><h3>Bringing in the human side</h3><p>Automation answers what and when; people answer why. Dukungan specialists were added so every member has someone to ask.</p></li>
...
<section class="onxr8te" data-u="sec">
  <div class="ggh3sm">
    ...
    <div class="luvxe">
      ...
      <div class="mvuhd"><b class="lfu72qs">24/7</b><span>Dukungan</span></div>
    </div>
  </div>
</section>
