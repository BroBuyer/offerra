...
$form_submit = $form_submit ?? 'Mulai sekarang';
...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__title">Anda sudah terdaftar</p>
    <p class="form-already-registered__text">
      Permintaan anda dengan <?= e(SITE_NAME) ?> has been received. Silakan tunggu for a call from our adviser.
    </p>
  </div>
...
<?php if ($is_stack): ?>
    <div class="xdzqh">
      <div class="wxts7 field" data-field="fname">
        <label class="field-label" for="<?= e($form_id) ?>-fname">Nama depan</label>
        <input class="wnzxg input" id="<?= e($form_id) ?>-fname" type="text" name="fname" placeholder="Nama depan" required pattern="[^\d]+" autocomplete="given-name">
      </div>
      <div class="wxts7 field" data-field="lname">
        <label class="field-label" for="<?= e($form_id) ?>-lname">Nama belakang</label>
        <input class="wnzxg input" id="<?= e($form_id) ?>-lname" type="text" name="lname" placeholder="Nama belakang" required pattern="[^\d]+" autocomplete="family-name">
      </div>
    </div>
    ...
    <div class="wxts7 field" data-field="phone">
      <label class="field-label" for="<?= e($form_id) ?>-phone">Telepon</label>
...
<?php endif; ?>
    ...
    <div class="nmpf6" aria-label="Accepted payment methods">
      ...
      <svg class="ajr3je" role="img" aria-label="Transfer bank" viewBox="0 0 512 512"><use href="#i-building-columns"/></svg>
