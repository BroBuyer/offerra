...
$page_title = 'Ketentuan Penggunaan ᐉ ' . SITE_NAME;
...
<section class="ykzi1">
  <div class="ggh3sm">
    <span class="vd7z9k">Hukum</span>
    <h1>Ketentuan Penggunaan</h1>
    <p class="rmct9">The rules that apply when you access or use <?= e(SITE_NAME) ?>.</p>
  </div>
</section>

<section class="bqfjng">
  <div class="ggh3sm">
    <p class="cs7fii">Terakhir diperbarui: January 2025</p>

    <h2>1. Acceptance of Terms</h2>
    <p>By accessing or using the website and services of <?= e(SITE_NAME) ?>, you agree to be bound by these Ketentuan Penggunaan. If you do not agree, do not use the services.</p>
    ...
    <h2>9. Disclaimers</h2>
    <p>The services are provided "as is" and "as available" without warranties of any kind. Trading involves a substantial risk of loss. See our <a href="<?= page_url('risk-disclosure.php') ?>" style="color:var(--accent)">Pengungkapan risiko</a> for further details.</p>
    ...
    <p style="margin-top:36px"><a class="qou73xg ec2hno" href="<?= page_url() ?>">← Kembali ke beranda</a></p>
  </div>
</section>
</main>
