...
<?php if ($is_stack): ?>
    <div class="xdzqh">
      <div class="wxts7 field" data-field="fname">
        ...
        <input class="wnzxg input" id="<?= e($form_id) ?>-fname" type="text" name="fname" placeholder="Ime" required pattern="[^\d]+" autocomplete="given-name">
      </div>
    ...
    <div class="wxts7 field" data-field="email">
      ...
      <input class="wnzxg input" id="<?= e($form_id) ?>-email" type="email" name="email" placeholder="E-pošta" required autocomplete="email" inputmode="email">
    </div>
    <div class="wxts7 field" data-field="phone">
      <label class="field-label" for="<?= e($form_id) ?>-phone">Telefon</label>
      <input class="wnzxg input" id="<?= e($form_id) ?>-phone" type="tel" name="fullphone" placeholder="091 234 5678" autocomplete="tel" inputmode="tel">
...
<?php endif; ?>
    ...
    <div class="nmpf6" aria-label="Prihvaćeni načini plaćanja">
      ...
      <svg class="ajr3je" role="img" aria-label="Bankovni prijenos" viewBox="0 0 512 512"><use href="#i-building-columns"/></svg>
      <svg class="ajr3je kw4ijl" role="img" aria-label="Sigurno" viewBox="0 0 512 512"><use href="#i-shield-halved"/></svg>
    </div>
