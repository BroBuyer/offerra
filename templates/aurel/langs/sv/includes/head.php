...
$page_title = $page_title ?? (SITE_NAME . ' ᐉ Full kontroll över din investering, live');
$page_description = $page_description ?? ('Följ i realtid hur ditt kapital arbetar med ' . SITE_NAME . ': tydliga rapporter, en personlig analytiker och AI. Skapa extra inkomst från ' . money_min());
...
<a class="nd5hm" href="#top">Hoppa till innehållet</a>
