...
$form_submit = $form_submit ?? 'Ξεκινήστε τώρα';
...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__title">Είστε ήδη εγγεγραμμένοι</p>
    <p class="form-already-registered__text">
      Το αίτημά σας με το <?= e(SITE_NAME) ?> έχει ληφθεί. Περιμένετε κλήση από τον σύμβουλό μας.
    </p>
  </div>
...
<?php if ($is_stack): ?>
    <div class="xdzqh">
      <div class="wxts7 field" data-field="fname">
        <label class="field-label" for="<?= e($form_id) ?>-fname">Όνομα</label>
        <input class="wnzxg input" id="<?= e($form_id) ?>-fname" type="text" name="fname" placeholder="Όνομα" required pattern="[^\d]+" autocomplete="given-name">
      </div>
      <div class="wxts7 field" data-field="lname">
        <label class="field-label" for="<?= e($form_id) ?>-lname">Επώνυμο</label>
        <input class="wnzxg input" id="<?= e($form_id) ?>-lname" type="text" name="lname" placeholder="Επώνυμο" required pattern="[^\d]+" autocomplete="family-name">
      </div>
    </div>
    ...
    <div class="wxts7 field" data-field="phone">
      <label class="field-label" for="<?= e($form_id) ?>-phone">Τηλέφωνο</label>
...
<?php endif; ?>
    ...
    <div class="nmpf6" aria-label="Αποδεκτές μέθοδοι πληρωμής">
      ...
      <svg class="ajr3je" role="img" aria-label="Τραπεζική μεταφορά" viewBox="0 0 512 512"><use href="#i-building-columns"/></svg>
      <svg class="ajr3je kw4ijl" role="img" aria-label="Ασφαλές" viewBox="0 0 512 512"><use href="#i-shield-halved"/></svg>
    </div>
    ...
    <p class="ac7ftax">
      Συνεχίζοντας αποδέχεστε την πολιτική απορρήτου και τους όρους χρήσης.
      <a href="<?= page_url('privacy.php') ?>">Απόρρητο</a>
      και τους
      <a href="<?= page_url('conditions.php') ?>">Όροι χρήσης</a>.
    </p>
  </div>
</form>
<?php
