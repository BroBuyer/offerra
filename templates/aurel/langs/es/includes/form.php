...
<?php endif; ?>
    ...
    <div class="nmpf6" aria-label="Métodos de pago aceptados">
      ...
      <svg class="ajr3je" role="img" aria-label="Transferencia bancaria" viewBox="0 0 512 512"><use href="#i-building-columns"/></svg>
