...
<section class="ykzi1">
  <div class="ggh3sm">
    ...
    <p class="rmct9">Padėkite mums apsaugoti <?= e(SITE_NAME) ?>. Praneškite apie įtariamą sukčiavimą, apsimetinėjimą arba piktnaudžiavimą mūsų platforma ar prekės ženklu.</p>
  </div>
</section>
