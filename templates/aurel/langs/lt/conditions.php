...
$page_title = „Naudojimo sąlygos ᐉ ' . SITE_NAME;
$page_description = „' . SITE_NAME naudojimo sąlygos;
...
<section class="ykzi1">
  <div class="ggh3sm">
    <span class="vd7z9k">Teisinė</span>
    <h1>Naudojimo sąlygos</h1>
    <p class="rmct9">Taisyklės, taikomos, kai pasiekiate arba naudojate <?= e(SITE_NAME) ?>.</p>
  </div>
</section>
...
<section class="bqfjng">
  <div class="ggh3sm">
    ...
    <h2>2. Tinkamumas</h2>
    <p>Turite būti bent 18 metų amžiaus (arba pilnametystės jūsų jurisdikcijoje) ir teisiškai pajėgus sudaryti įpareigojančią sutartį. Paslaugos nesiūlomos ribotos jurisdikcijos gyventojams, kur toks pasiūlymas būtų neteisėtas.</p>
    ...
    <h2>4. Paslaugos</h2>
    <p><?= e(SITE_NAME) ?>teikia technologines priemones ir edukacinę informaciją, susijusią su investavimu internetu. Mes nesame jūsų finansų patarėjai. Niekas šioje svetainėje nėra asmeninis patarimas dėl investavimo, mokesčių konsultacijos ar raginimas pirkti ar parduoti bet kokią finansinę priemonę.</p>
    ...
    <p>Visas svetainėje esantis turinys, prekių ženklai, programinė įranga ir medžiaga yra <?= e(SITE_NAME) ?> arba jo licencijos išdavėjų nuosavybė ir yra saugomi taikomų intelektinės nuosavybės įstatymų. Jums suteikiama ribota, neišskirtinė, atšaukiama licencija naudotis paslaugomis pagal numatytą paskirtį.</p>

    <h2>8. Trečiųjų šalių paslaugos</h2>
    <p>Platformoje gali būti nuorodų į trečiųjų šalių paslaugas arba jos gali būti integruotos. Mes nesame atsakingi nei už tokias paslaugas, nei už jų prieinamumą, tikslumą ar turinį.</p>

    <h2>9. Atsisakymas</h2>
    <p>Paslaugos teikiamos „tokios, kokios yra“ ir „kaip prieinamos“ be jokių garantijų. Prekyba susijusi su didele nuostolių rizika. Žiūrėkite mūsų<a href="<?= page_url('risk-disclosure.php') ?>" style="color:var(--accent)">Rizikos atskleidimas</a>Norėdami gauti daugiau informacijos.</p>
    ...
    <p>Klausimus apie šias sąlygas galite siųsti per mūsų kontaktų puslapį.</p>
