...
<section class="onxr8te" data-u="sec">
  <div class="ggh3sm">
    ...
    <ul class="skvsaz4">
      ...
      <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 6L9 17l-5-5"/></svg><span>Platformos inžinieriai, stebintys visą parą.</span></li>
