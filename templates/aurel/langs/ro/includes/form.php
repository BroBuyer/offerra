...
$form_submit = $form_submit ?? 'Începeți acum';
...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__title">Sunteți deja înregistrat</p>
    <p class="form-already-registered__text">
      Cererea ta către <?= e(SITE_NAME) ?> a fost primită. Vă rugăm să așteptați un apel de la consilierul nostru.
    </p>
  </div>
...
<?php if ($is_stack): ?>
    <div class="xdzqh">
      <div class="wxts7 field" data-field="fname">
        <label class="field-label" for="<?= e($form_id) ?>-fname">Prenume</label>
        <input class="wnzxg input" id="<?= e($form_id) ?>-fname" type="text" name="fname" placeholder="Prenume" required pattern="[^\d]+" autocomplete="given-name">
      </div>
      <div class="wxts7 field" data-field="lname">
        <label class="field-label" for="<?= e($form_id) ?>-lname">Nume</label>
        <input class="wnzxg input" id="<?= e($form_id) ?>-lname" type="text" name="lname" placeholder="Nume" required pattern="[^\d]+" autocomplete="family-name">
      </div>
    </div>
...
<?php endif; ?>
    ...
    <div class="nmpf6" aria-label="Metode de plată acceptate">
      ...
      <svg class="ajr3je" role="img" aria-label="Transfer bancar" viewBox="0 0 512 512"><use href="#i-building-columns"/></svg>
      <svg class="ajr3je kw4ijl" role="img" aria-label="Securizat" viewBox="0 0 512 512"><use href="#i-shield-halved"/></svg>
    </div>
    ...
    <p class="ac7ftax">
      Continuând, acceptați politica de confidențialitate și termenii de utilizare.
