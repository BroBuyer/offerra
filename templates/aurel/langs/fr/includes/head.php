...
$page_title = $page_title ?? (SITE_NAME . ' ᐉ Contrôle en direct de votre investissement');
$page_description = $page_description ?? ('Suivez en temps réel comment votre capital travaille avec ' . SITE_NAME . ' : des rapports clairs, un analyste personnel et l’IA. Générez un revenu complémentaire à partir de ' . money_min());
...
<a class="nd5hm" href="#top">Aller au contenu</a>
