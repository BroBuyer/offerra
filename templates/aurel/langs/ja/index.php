...
<div class="ggh3sm jx8jnza">
  ...
  <div>
      ...
      <div class="vdaz1q">
        <figure class="qkl7dd8" itemscope itemtype="https://schema.org/Review">
          <div class="dnjuv">
            ...
            <span class="ue1r1">4か月で+2,200€</span>
          </div>
    ...
    <section class="xrn58" data-u="sec" id="vzo0q" aria-labelledby="mzn56z">
      ...
      <div class="smnsm2" role="region" tabindex="0" aria-label="表計算も、複雑な画面も、直前の迷いもありません"><table class="by635s">
        <thead><tr><th scope="col">プラットフォーム</th><th scope="col"><?= e(SITE_NAME) ?></th><th scope="col">従来のブローカー</th><th scope="col">自力での取引</th></tr></thead>
        <tbody>
          <tr><td>AIによる注文執行</td><td class="bfe2o6f">✓</td><td class="byuav">時間制限あり</td><td class="byuav">手動</td></tr>
          <tr><td>すべての市場を24時間カバー</td><td class="bfe2o6f">✓</td><td class="byuav">書類手続き</td><td class="byuav">ご自身で</td></tr>
          <tr><td>1秒未満の注文ルーティング</td><td class="bfe2o6f">✓</td><td class="byuav">プランによる</td><td class="byuav">手動</td></tr>
          <tr><td>多通貨レポート</td><td class="bfe2o6f">✓</td><td class="byuav">時間制限あり</td><td class="byuav">ご自身で</td></tr>
          <tr><td>ペーパーレスの口座開設</td><td class="bfe2o6f">✓</td><td class="byuav">書類手続き</td><td class="byuav">手動</td></tr>
          <tr><td>取引所間アービトラージ</td><td class="bfe2o6f">✓</td><td class="byuav">プランによる</td><td class="byuav">ご自身で</td></tr>
    ...
    <section class="xrn58" id="esypwbx" aria-labelledby="rq8es">
      ...
      <div class="wmuyc">
        <div>
          ...
          ?>
          <div class="vcf9ca"><label for="calc-dep">開始金額</label><span class="cj9i15q" id="csezcv1"><?= e(currency_symbol() . number_format($calc_default, 0)) ?></span></div>
          <input id="lsm9on" type="range" min="<?= (int) $calc_min ?>" max="<?= (int) $calc_max ?>" step="50" value="<?= (int) $calc_default ?>" aria-label="開始金額"/>
          <div class="vcf9ca"><label for="calc-mon">月数</label><span class="cj9i15q" id="ywprvgd">6</span></div>
          <input id="gqz8w" type="range" min="1" max="24" step="1" value="6" aria-label="月数"/>
          <p class="ifuciwq">数値は例示です。実際のリターンは投資額と、アナリストと選ぶ戦略によって異なります。</p>
        </div>
        <div class="gbastl">
          <small>想定残高</small>
    ...
    <section class="xrn58" data-u="sec" id="dmobczk" aria-labelledby="dl5sp">
      ...
      <ol class="zzk9i">
        <li><span class="vpx6kk">01</span><div><h3>口座を作成</h3><p>メールアドレスだけで、数分で登録できます。</p></div></li>
        <li><span class="vpx6kk">02</span><div><h3>メールを確認</h3><p>口座を守るため、アドレスを確認してください。</p></div></li>
        <li><span class="vpx6kk">03</span><div><h3>資金を入金</h3><p> <?= e(money_min()) ?> から、ご希望の方法で資金を追加できます。</p></div></li>
    ...
    <section class="xrn58" data-u="sec" id="exd9dmd" aria-labelledby="rlolt2l">
      ...
      <div class="smnsm2" role="region" tabindex="0" aria-label="ビットコイン、イーサリアムなど幅広く取引"><table class="nd3owbf">
    ...
    <section class="xrn58" data-u="sec" id="sor9s" aria-labelledby="onidtj">
      ...
      <ol class="zzk9i">
        <li><span class="vpx6kk">01</span><div><h3>接続されたすべての市場で1秒未満の執行</h3><p><?= e(SITE_NAME) ?> は対応するすべての取引所と低遅延のAPI接続を常時維持します。モデルがシグナルを生成すると、次のティックの前に注文が送信・約定され、ダッシュボードに記録されます。</p></div></li>
        <li><span class="vpx6kk">02</span><div><h3>すべての市場セッションを通じ、24時間稼働します</h3><p>暗号資産は休まず、 <?= e(SITE_NAME) ?> も休みません。エンジンは週末や祝日もペアを分析し、機会を逃しません。</p></div></li>
        <li><span class="vpx6kk">03</span><div><h3>多通貨レポート</h3><p>残高、取引、出金はすべて現地通貨で表示されます。隠れた換算ステップはありません。</p></div></li>
        <li><span class="vpx6kk">04</span><div><h3>分別管理された資金</h3><p>資金はお客様ご自身の口座に残ります。 <?= e(SITE_NAME) ?> が資金を保有することはありません。エンジンには注文送信の権限のみがあります。</p></div></li>
        <li><span class="vpx6kk">05</span><div><h3>銀行水準のセキュリティ</h3><p>プラットフォーム全体のTLS暗号化、既定の二段階認証、四半期ごとの第三者インフラ監査。取引レシートはオンチェーンに記録されます。</p></div></li>
        <li><span class="vpx6kk">06</span><div><h3>3つの資産クラス、ひとつのプラットフォーム</h3><p>多くの個人向けプラットフォームは単一市場に限定します。 <?= e(SITE_NAME) ?> は同じダッシュボードから暗号資産、上場株式、主要通貨ペアを取引します。</p></div></li>
        <li><span class="vpx6kk">07</span><div><h3>すべてのポジションに事前設定のリスク限度</h3><p>ストップロス、許容最大損失、資金配分の上限は資産クラスごとに設定されます。閾値を超えた取引はエンジンが自動で決済し、監査履歴に記録されます。</p></div></li>
      </ol>
    </section>
