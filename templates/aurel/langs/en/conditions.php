...
$page_title = 'Terms of Use ᐉ ' . SITE_NAME;
...
<section class="bqfjng">
  <div class="ggh3sm">
    ...
    <h2>9. Disclaimers</h2>
    <p>The services are provided "as is" and "as available" without warranties of any kind. Trading involves a substantial risk of loss. See our <a href="<?= page_url('risk-disclosure.php') ?>" style="color:var(--accent)">Risk disclosure</a> for further details.</p>
