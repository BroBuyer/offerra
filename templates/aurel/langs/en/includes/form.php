...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__text">
      Your request with <?= e(SITE_NAME) ?> has been received. Please wait for a call from our adviser.
    </p>
  </div>
...
<?php if ($is_stack): ?>
    <div class="xdzqh">
      <div class="wxts7 field" data-field="fname">
        <label class="field-label" for="<?= e($form_id) ?>-fname">First name</label>
        <input class="wnzxg input" id="<?= e($form_id) ?>-fname" type="text" name="fname" placeholder="First name" required pattern="[^\d]+" autocomplete="given-name">
      </div>
      <div class="wxts7 field" data-field="lname">
        <label class="field-label" for="<?= e($form_id) ?>-lname">Last name</label>
        <input class="wnzxg input" id="<?= e($form_id) ?>-lname" type="text" name="lname" placeholder="Last name" required pattern="[^\d]+" autocomplete="family-name">
      </div>
    </div>
    ...
    <div class="wxts7 field" data-field="phone">
      <label class="field-label" for="<?= e($form_id) ?>-phone">Phone</label>
...
<?php endif; ?>
    ...
    <div class="nmpf6" aria-label="Accepted payment methods">
      ...
      <svg class="ajr3je" role="img" aria-label="Bank transfer" viewBox="0 0 512 512"><use href="#i-building-columns"/></svg>
      <svg class="ajr3je kw4ijl" role="img" aria-label="Secure" viewBox="0 0 512 512"><use href="#i-shield-halved"/></svg>
    </div>
