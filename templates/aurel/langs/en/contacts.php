...
$page_title = 'Contact ' . SITE_NAME . ' ᐉ We are here to help';
...
<section class="onxr8te" data-u="sec">
  <div class="ggh3sm">
    ...
    <ul class="skvsaz4">
      ...
      <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 6L9 17l-5-5"/></svg><span><a href="<?= page_url('product.php') ?>" style="color:var(--accent)">How it works</a> — what happens after you register, step by step.</span></li>
      <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 6L9 17l-5-5"/></svg><span><a href="<?= page_url('pricing.php') ?>" style="color:var(--accent)">Pricing</a> — what is free and where a cost can appear.</span></li>
    </ul>
...
<section class="onxr8te" data-u="sec">
  <div class="ggh3sm">
    ...
    <div class="smnsm2" role="region" tabindex="0"><table class="wcle1">
      ...
      <tbody>
        <tr><td>Email support — <a href="mailto:<?= e(SUPPORT_EMAIL) ?>"><?= e(SUPPORT_EMAIL) ?></a></td><td>Account questions, verification, withdrawals</td><td>We usually reply within one working day.</td></tr>
        <tr><td>Callback request</td><td>Anything easier to explain by phone</td><td>Support hours: Monday to Friday, 9:00–18:00</td></tr>
...
<section class="onxr8te" data-u="sec">
  <div class="ggh3sm op6k5h">
    ...
    <p>Email is the right choice for anything with an attachment: identity checks, withdrawal queries, questions about a statement. The callback form is for everything else, because most account questions are resolved faster in two minutes of conversation than in four messages.</p>
