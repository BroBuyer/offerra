...
$page_title = page_title('AI-Powered Platform trading');
...
<main>
  ...
  <section class="hero">
    <div class="container hero-grid">
      <div class="hero-content">
        <p class="eyebrow">AI Platform trading</p>
        ...
        <a href="sign.php" class="btn btn-primary">Mulai trading — <?= MIN_DEPOSIT ?> <?= CURRENCY ?> min.</a>
      </div>

      <div class="form-card form-card-accent">
        <?php
        $form_id = 'hero-form';
        $form_heading = 'Buka akun account in 2 minutes';
  ...
  <section class="stats" aria-label="Platform statistics">
    <div class="container stats-grid">
      ...
      <div class="stat-item">
        ...
        <div class="stat-label">Pengguna disahkan</div>
      </div>
      <div class="stat-item">
  ...
  <section class="platform-section" id="platform" aria-label="Platform trading preview">
    <div class="container platform-layout">
      <?php require __DIR__ . '/includes/platform-image.php'; ?>

      <div class="platform-copy">
        <p class="eyebrow">Platform trading</p>
        ...
        <ul class="platform-points">
          ...
          <li>Selamat account dashboard</li>
        </ul>
  ...
  <section class="section" id="features">
    <div class="container">
      <div class="section-header">
        ...
        <p class="lead">Keamanan, speed, and intelligence — combined in one clean platform designed for modern traders.</p>
      </div>
    ...
    <div class="container">
      ...
      <div class="steps">
        <article class="step-card">
          ...
          <p>Daftar with your details and get instant, secure access to the platform.</p>
        </article>
        <article class="step-card">
          <h3>Sahkan email anda</h3>
          <p>Confirm your address to unlock the full trading environment.</p>
        </article>
        <article class="step-card">
          <h3>Biayai akun Anda</h3>
          <p>Deposit minimum <?= MIN_DEPOSIT ?> <?= CURRENCY ?> melalui transfer bank, kad atau e-wallet.</p>
        </article>
        <article class="step-card">
          <h3>Tetapkan strategi anda</h3>
      ...
      <div style="text-align: center; margin-top: 2.5rem;">
        <a href="sign.php" class="btn btn-primary">Buka akun now</a>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      ...
      <div class="specs-table">
        ...
        <div class="specs-row specs-row-highlight">
          ...
          <div class="specs-value">Professional 24/7 assistance — <a href="contacts.php" style="color: var(--accent); font-weight: 600;">Hubungi kami</a></div>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="trust-card">
        <div>
          ...
          <h3 style="margin-top: 0.75rem; font-size: 1.25rem;"><?= e(SITE_NAME) ?> Ulasan</h3>
        </div>
        <div class="trust-score">4.7</div>
        <div class="trust-stars">★★★★★</div>
        <div class="trust-meta">
          <strong>342</strong> reviews · Berdasarkan <strong>1,842</strong> ratings
        </div>
      </div>
    </div>
  </section>
