...
<main>
  ...
  <section class="section-sm">
    <div class="container prose">
      <p>This Kebijakan Privasi describes how <?= e(SITE_NAME) ?> ("we", "us") collects and processes personal information when you use our website and services.</p>
      ...
      <ul>
        ...
        <li>To provide platform trading access and customer support</li>
