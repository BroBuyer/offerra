...
$page_description = 'Hubungi ' . SITE_NAME . ' support or our business team. We are available 24/7.';
    ...
    <div class="container" style="max-width: 640px; margin-inline: auto;">
      <div class="features-grid" style="grid-template-columns: 1fr;">
        ...
        <article class="feature-card">
          ...
          <p style="margin-bottom: 1rem;">Buka akun in minutes — no call required.</p>
          <a href="sign.php" class="btn btn-primary">Buat akun</a>
        </article>
      </div>
    </div>
  </section>
