...
$page_description = 'Crea tu cuenta en ' . SITE_NAME . ' y empieza a operar criptomonedas, forex y mercados globales con herramientas asistidas por IA.';
...
<main>
  <section class="page-hero">
    <div class="container">
      ...
      <p class="lead">Unete a miles de traders. Deposito minimo de <?= MIN_DEPOSIT ?> <?= CURRENCY ?>.</p>
    </div>
  </section>
  ...
  <section class="section-sm">
    <div class="container" style="max-width: 480px; margin-inline: auto;">
      <div class="form-card form-card-accent">
        <?php
        $form_id = 'signup-form';
        $form_heading = 'Completa tus datos a continuacion';
