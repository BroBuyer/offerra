...
<header class="site-header" data-header>
  <div class="container header-inner">
    <a href="<?= page_url() ?>" class="logo" aria-label="<?= e(SITE_NAME) ?> — pagina de inicio">
    ...
    <nav class="nav-desktop" aria-label="Navegacion principal">
  ...
  <nav class="nav-mobile" data-mobile-nav aria-label="Navegacion movil" hidden>
