...
const phoneErrorMap = {
  ...
  1: 'Μη έγκυρος εθνικός κωδικός',
  2: 'Ο αριθμός τηλεφώνου είναι πολύ μικρός',
  3: 'Ο αριθμός τηλεφώνου είναι πολύ μεγάλος',
...
/** Nome, cognome, email - validazione nativa del browser. */
...
function setupFormValidation(form) {
  ...
  form.addEventListener('submit', async (e) => {
    ...
    try {
      ...
      if (!data.ok) {
        showFormMessage(form, data.error || 'Παρουσιάστηκε σφάλμα. Δοκιμάστε ξανά αργότερα.');
        return;
      }
      ...
      console.error(err);
      showFormMessage(form, 'Σφάλμα σύνδεσης. Ελέγξτε τη σύνδεση στο διαδίκτυο και δοκιμάστε ξανά.');
    } finally {
