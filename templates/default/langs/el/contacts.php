...
$page_description = 'Επικοινωνήστε με την υποστήριξη της ' . SITE_NAME . ' ή την εμπορική μας ομάδα. Είμαστε διαθέσιμοι 24/7.';
...
<main>
  <section class="page-hero">
    <div class="container">
      ...
      <p class="lead">Επαγγελματική υποστήριξη 24/7 για ερωτήσεις σχετικά με λογαριασμό, trading και τεχνικά θέματα.</p>
    </div>
  </section>
    ...
    <div class="container" style="max-width: 640px; margin-inline: auto;">
      <div class="features-grid" style="grid-template-columns: 1fr;">
        ...
        <article class="feature-card">
          ...
          <p>Απαντάμε στα περισσότερα αιτήματα εντός λίγων ωρών. Τα επείγοντα θέματα που σχετίζονται με trading έχουν προτεραιότητα.</p>
        </article>
        <article class="feature-card">
          <h3>Έτοιμοι να ξεκινήσετε;</h3>
          <p style="margin-bottom: 1rem;">Ανοίξτε τον λογαριασμό σας σε λίγα λεπτά, χωρίς ανάγκη για τηλεφωνικές κλήσεις.</p>
