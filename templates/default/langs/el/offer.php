...
$page_description = 'Επιλέξτε την προσφορά της ' . SITE_NAME . ' - ξεκινήστε με ελάχιστη κατάθεση ' . MIN_DEPOSIT . ' ' . CURRENCY . ' και ξεκλειδώστε πλήρη πρόσβαση στην πλατφόρμα.';
    ...
    <div class="container" style="max-width: 900px; margin-inline: auto;">
      <div class="specs-table" style="margin-bottom: 2rem;">
        ...
        <div class="specs-row">
          ...
          <div class="specs-value">Γραφήματα σε πραγματικό χρόνο, multi-market trading, διαχείριση χαρτοφυλακίου, υποβοηθούμενο onboarding</div>
        </div>
        <div class="specs-row">
        ...
        <div class="specs-row">
          ...
          <div class="specs-value">Οποιαδήποτε στιγμή · 1-3 εργάσιμες ημέρες · Κόστη εμφανίζονται εκ των προτέρων</div>
        </div>
        <div class="specs-row">
          <div class="specs-label">Συσκευές</div>
          <div class="specs-value">Web, tablet, mobile - χωρίς εγκατάσταση</div>
        </div>
      </div>
      ...
      <div class="form-card form-card-accent" style="max-width: 480px; margin-inline: auto;">
        <?php
        $form_id = 'offer-form';
        $form_heading = 'Επωφεληθείτε τώρα από την προσφορά';
