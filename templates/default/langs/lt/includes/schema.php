...
function render_schema(string $page = 'home', array $extra = []): void {
    ...
    $organization = [
        ...
        'description' => 'AI-poweredprekybos platforma for crypto, forex, and global markets.',
    ];
    ...
    $software = [
        ...
        'description' => 'Smartprekybos platforma with real-time market analysis and AI-assisted signals.',
    ...
    $faq = [
        ...
        'mainEntity' => [
            ...
            [
                ...
                'acceptedAnswer' => [
                    '@type' => 'Answer',
                    'text' => 'No prior experience is required. Guided onboarding, simple tutorials, and AI-assisted tools help you learn at your own pace with 24/7 palaikymas available.',
                ],
            ],
        ],
    ];
