  ...
  <section class="section-sm">
    <div class="container" style="max-width: 800px; margin-inline: auto;">
      <div class="faq-list" data-faq>
        ...
        <div class="faq-item">
          ...
          <div class="faq-content">
            <div class="faq-content-inner">
              We use industry-standard SSL encryption, 2FA, and verified payment processors. Saugumas is built into every layer of the platform.
            </div>
          </div>
        </div>
        <div class="faq-item">
      ...
      <div style="text-align: center; margin-top: 2.5rem;">
        ...
        <a href="contacts.php" class="btn btn-outline">Susisiekite support</a>
      </div>
    </div>
  </section>
</main>
