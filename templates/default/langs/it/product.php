...
$page_title = page_title_lead('Prodotto');
$page_description = 'Scopri gli strumenti di trading di ' . SITE_NAME . ' - analisi in tempo reale, segnali AI, accesso multi-mercato e strategie automatizzate.';
$page_canonical = page_url('product.php');
$active_page = 'product';
$schema_extra = ['breadcrumb' => [
  ['@type' => 'ListItem', 'position' => 1, 'name' => 'Home', 'item' => page_url()],
  ['@type' => 'ListItem', 'position' => 2, 'name' => 'Prodotto', 'item' => page_url('product.php')],
]];
...
<main>
  <section class="page-hero">
    <div class="container">
      ...
      <h1>Analisi digitale progettata per i trader</h1>
      <p class="lead">Un'unica piattaforma. Tutti i mercati. Strumenti che seguono il tuo ritmo.</p>
    </div>
  </section>
    ...
    <div class="container">
      <div class="features-grid">
        ...
        <article class="feature-card">
          ...
          <h3>Motore segnali AI</h3>
          <p>I modelli di machine learning evidenziano setup ad alta probabilita con contesto chiaro per entrata e uscita.</p>
        </article>
        <article class="feature-card">
          <div class="feature-icon">
          ...
          <p>Configura bot con gestione del rischio personalizzata: monitora e ottimizza, oppure opera manualmente in parallelo.</p>
        </article>
        <article class="feature-card">
          <div class="feature-icon">
          ...
          <p>Strumenti stop-loss, take-profit e sizing delle posizioni integrati in ogni workflow operativo.</p>
        </article>
        <article class="feature-card">
          <div class="feature-icon">
        ...
        <article class="feature-card">
          ...
          <p>Guide pratiche e spiegazioni dei mercati per trader principianti e intermedi.</p>
        </article>
      </div>
