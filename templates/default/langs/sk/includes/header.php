...
<header class="site-header" data-header>
  <div class="container header-inner">
    <a href="<?= page_url() ?>" class="logo" aria-label="<?= e(SITE_NAME) ?> — domovská stránka">
    ...
    <nav class="nav-desktop" aria-label="Hlavní navigace">
      <a href="<?= page_url() ?>" class="<?= $active_page === 'home' ? 'is-active' : '' ?>">Domů</a>
      <a href="product.php" class="<?= $active_page === 'product' ? 'is-active' : '' ?>">Produkt</a>
      <a href="offer.php" class="<?= $active_page === 'offer' ? 'is-active' : '' ?>">Nabídka</a>
    ...
    <div class="header-actions">
      <a href="sign.php" class="btn btn-primary btn-sm">Začít</a>
      <button class="menu-toggle" type="button" data-menu-toggle aria-label="Otevřít menu" aria-expanded="false">
        <span></span><span></span>
      </button>
    </div>
  </div>
  ...
  <nav class="nav-mobile" data-mobile-nav aria-label="Mobilní navigace" hidden>
    ...
    <a href="sign.php" class="btn btn-primary">Začít</a>
  </nav>
</header>
