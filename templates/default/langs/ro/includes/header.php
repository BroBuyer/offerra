...
<header class="site-header" data-header>
  <div class="container header-inner">
    ...
    <nav class="nav-desktop" aria-label="Navigare principală">
      <a href="<?= page_url() ?>" class="<?= $active_page === 'home' ? 'is-active' : '' ?>">Acasă</a>
      <a href="product.php" class="<?= $active_page === 'product' ? 'is-active' : '' ?>">Produs</a>
      <a href="offer.php" class="<?= $active_page === 'offer' ? 'is-active' : '' ?>">Ofertă</a>
      <a href="contacts.php" class="<?= $active_page === 'contacts' ? 'is-active' : '' ?>">Contact</a>
      <a href="faq.php" class="<?= $active_page === 'faq' ? 'is-active' : '' ?>">Întrebări frecvente</a>
    </nav>

    <div class="header-actions">
      <a href="sign.php" class="btn btn-primary btn-sm">Începe</a>
      <button class="menu-toggle" type="button" data-menu-toggle aria-label="Deschide meniul" aria-expanded="false">
        <span></span><span></span>
      </button>
    </div>
  </div>
  ...
  <nav class="nav-mobile" data-mobile-nav aria-label="Navigare mobilă" hidden>
    ...
    <a href="sign.php" class="btn btn-primary">Începe</a>
  </nav>
</header>
