...
$page_title = page_title('AI-Powered 取引プラットフォーム');
...
<main>
  ...
  <section class="hero">
    <div class="container hero-grid">
      <div class="hero-content">
        <p class="eyebrow">AI 取引プラットフォーム</p>
        ...
        <a href="sign.php" class="btn btn-primary">取引を開始 — <?= MIN_DEPOSIT ?> <?= CURRENCY ?> min.</a>
      </div>

      <div class="form-card form-card-accent">
        <?php
        $form_id = 'hero-form';
        $form_heading = '本日、 account in 2 minutes';
  ...
  <!-- Stats -->
  <section class="stats" aria-label="プラットフォーム statistics">
  ...
  <!-- プラットフォーム phone (competitor-style: centered between stats & features) -->
  ...
  <section class="section" id="features">
    <div class="container">
      <div class="section-header">
        ...
        <p class="lead">セキュリティ, speed, and intelligence — combined in one clean platform designed for modern traders.</p>
      </div>
    ...
    <div class="container">
      ...
      <div class="steps">
        <article class="step-card">
          <h3>口座を作成</h3>
          <p>新規登録 with your details and get instant, secure access to the platform.</p>
        </article>
        <article class="step-card">
          <h3>メールアドレスを確認</h3>
        ...
        <article class="step-card">
          <h3>口座に入金する</h3>
          <p>最低 <?= MIN_DEPOSIT ?> <?= CURRENCY ?> を、銀行振込、カード、または電子ウォレットでご入金ください。</p>
        </article>
        <article class="step-card">
          <h3>戦略を設定する</h3>
      ...
      <div style="text-align: center; margin-top: 2.5rem;">
        <a href="sign.php" class="btn btn-primary">口座を開設 now</a>
      </div>
    </div>
  </section>
  ...
  <section class="section-sm">
    <div class="container">
      <div class="section-header centered" style="margin-bottom: 2rem;">
        <p class="eyebrow">信頼 infrastructure</p>
    ...
    <div class="container">
      ...
      <div class="specs-table">
        ...
        <div class="specs-row specs-row-highlight">
          ...
          <div class="specs-value">Professional 24/7 assistance — <a href="contacts.php" style="color: var(--accent); font-weight: 600;">お問い合わせ</a></div>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="trust-card">
        <div>
          ...
          <h3 style="margin-top: 0.75rem; font-size: 1.25rem;"><?= e(SITE_NAME) ?> レビュー</h3>
        </div>
