...
<footer class="site-footer">
  <div class="container">
    ...
    <div class="footer-risk">
      <p>
        <?= e(SITE_NAME) ?> is niet aansprakelijk voor verliezen of schade als gevolg van het gebruik van informatie op deze website.
        Handelen op financiele markten brengt risico's met zich mee. Investeer alleen kapitaal dat u kunt missen. Forex, CFD's en cryptovaluta
        zijn mogelijk niet geschikt voor alle beleggers. Overweeg professioneel advies voordat u begint met handelen.
      </p>
    </div>
