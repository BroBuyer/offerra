...
$page_description = $page_description ?? 'Käy kauppaa fiksummin ' . SITE_NAME . '-alustalla — reaaliaikainen analytiikka, tekoälysignaalit ja selkeä alusta kryptolle, forexille ja maailmanmarkkinoille.';
