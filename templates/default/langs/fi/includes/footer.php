...
<footer class="site-footer">
  <div class="container">
    ...
    <div class="footer-risk">
      <p>
        <?= e(SITE_NAME) ?> ei ole vastuussa mistään tappioista tai vahingoista, jotka johtuvat tällä sivustolla olevan tiedon käytöstä.
        Rahoitusmarkkinoilla kaupankäyntiin liittyy riski. Sijoita vain varoja, jotka voit menettää. FX, CFD:t ja kryptovaluutat
        eivät välttämättä sovi kaikille sijoittajille. Harkitse pätevän ammattilaisen neuvon hakemista ennen kaupankäyntiä.
      </p>
    </div>
