...
$page_description = 'Tutustu ' . SITE_NAME . '-kaupankäyntityökaluihin — reaaliaikainen analytiikka, tekoälysignaalit, monimarkkinapääsy ja automatisoidut strategiat.';
...
<main>
  <section class="page-hero">
    <div class="container">
      ...
      <p class="lead">Yksi alusta. Kaikki markkinat. Työkalut, jotka pysyvät tahdissasi.</p>
    </div>
  </section>
    ...
    <div class="container">
      <div class="features-grid">
        <article class="feature-card">
          ...
          <p>Live-hintasyötteet, kehittyneet indikaattorit ja markkinasyvyys kaikille tuetuille omaisuuserille.</p>
        </article>
        <article class="feature-card">
          <div class="feature-icon">
          ...
          <p>Koneoppimismallit nostavat esiin todennäköisiä asetelmia selkeällä sisään- ja ulosmenokontekstilla.</p>
        </article>
        <article class="feature-card">
          <div class="feature-icon">
          ...
          <p>Määritä botit omilla riskiparametreilla — aseta ja seuraa, tai käy kauppaa manuaalisesti rinnakkain.</p>
        </article>
        <article class="feature-card">
          <div class="feature-icon">
        ...
        <article class="feature-card">
          ...
          <h3>Salkun seuranta</h3>
          <p>Yhtenäinen näkymä omistuksiin, P&amp;L:ään ja allokaatioon krypton ja perinteisten markkinoiden välillä.</p>
        </article>
        <article class="feature-card">
          <div class="feature-icon">
          ...
          <h3>Oppimiskeskus</h3>
          <p>Ohjatut tutoriaalit ja markkinaselitykset sekä aloittelijoille että keskitasoisille treidaajille.</p>
        </article>
      </div>

      <div style="text-align: center; margin-top: 3rem;">
        <a href="sign.php" class="btn btn-primary">Kokeile <?= e(SITE_NAME) ?> -palvelua ilmaiseksi</a>
      </div>
    </div>
  </section>
</main>
