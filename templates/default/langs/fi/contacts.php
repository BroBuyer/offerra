...
$page_description = 'Ota yhteyttä ' . SITE_NAME . '-tukeen tai liiketoimintatiimiimme. Olemme tavoitettavissa 24/7.';
...
<main>
  <section class="page-hero">
    <div class="container">
      ...
      <p class="lead">Ammattimainen tuki ympäri vuorokauden tiliin, kaupankäyntiin ja teknisiin kysymyksiin.</p>
    </div>
  </section>
    ...
    <div class="container" style="max-width: 640px; margin-inline: auto;">
      <div class="features-grid" style="grid-template-columns: 1fr;">
        <article class="feature-card">
          ...
          <p style="margin-bottom: 1rem;">Yleisiin tiedusteluihin ja tiliapuun:</p>
          <a href="mailto:<?= e(SUPPORT_EMAIL) ?>" class="btn btn-outline"><?= e(SUPPORT_EMAIL) ?></a>
        </article>
        <article class="feature-card">
          <h3>Vastausaika</h3>
          <p>Useimpiin pyyntöihin vastataan muutamassa tunnissa. Kiireelliset kaupankäyntiongelmat priorisoidaan.</p>
        </article>
        <article class="feature-card">
