...
<header class="site-header" data-header>
  <div class="container header-inner">
    ...
    <nav class="nav-desktop" aria-label="Główna nawigacja">
    ...
    <div class="header-actions">
      <a href="sign.php" class="btn btn-primary btn-sm">Rozpocznij</a>
  ...
  <nav class="nav-mobile" data-mobile-nav aria-label="Nawigacja mobilna" hidden>
    ...
    <a href="sign.php" class="btn btn-primary">Rozpocznij</a>
  </nav>
</header>
