...
$page_description = 'Erstellen Sie ein Konto bei ' . SITE_NAME . ' und starten Sie den Handel mit Kryptowährungen, Forex und globalen Märkten mit KI-gestützten Tools.';
...
<main>
  <section class="page-hero">
    <div class="container">
      ...
      <p class="lead">Schließen Sie sich Tausenden Tradern an. Mindesteinzahlung <?= MIN_DEPOSIT ?> <?= CURRENCY ?>.</p>
    </div>
  </section>
