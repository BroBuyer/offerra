...
$page_description = 'Entdecken Sie das Angebot von ' . SITE_NAME . ' — starten Sie mit einer Mindesteinzahlung von ' . MIN_DEPOSIT . ' ' . CURRENCY . ' und erhalten Sie vollen Plattformzugang.';
...
<main>
  <section class="page-hero">
    <div class="container">
      ...
      <h1>Sichern Sie sich bei der Registrierung kostenlose Portfolioverwaltung</h1>
      <p class="lead">Starten Sie mit <?= MIN_DEPOSIT ?> <?= CURRENCY ?>. Wenn Sie bereit sind, können Sie jederzeit skalieren.</p>
    </div>
  </section>
    ...
    <div class="container" style="max-width: 900px; margin-inline: auto;">
      <div class="specs-table" style="margin-bottom: 2rem;">
        <div class="specs-row specs-row-highlight">
          ...
          <div class="specs-value"><strong><?= MIN_DEPOSIT ?> <?= CURRENCY ?></strong> Mindesteinzahlung · Vollzugang zur Plattform · KI-Signale · 24/7 Support</div>
        </div>
        <div class="specs-row">
      ...
      <div class="form-card form-card-accent" style="max-width: 480px; margin-inline: auto;">
        <?php
        $form_id = 'offer-form';
        $form_heading = 'Nutzen Sie das Angebot jetzt';
