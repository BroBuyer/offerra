...
$page_title = page_title_lead("Hinnat");
$page_description = "Hinnat" . ' — ' . SITE_NAME;
...
<main>
  <section class="sec">
    <div class="shell" style="max-width:760px">
      <h1>Aloita alkaen <?= e(MIN_DEPOSIT) ?> <?= e(CURRENCY) ?></h1>
      <div class="lede" style="margin-top:18px">
        <p>Täysi alustapääsy minimitalletuksen jälkeen. Ei piilotettuja maksuja — kustannukset näytetään läpinäkyvästi.</p>
      </div>
