...
$form_submit = $form_submit ?? 'Luo ilmainen tili';
...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__title">Jo rekisteröitynyt</p>
    <p class="form-already-registered__text">
      Pyyntösi palvelussa <?= e(SITE_NAME) ?> on vastaanotettu. Odota puhelua neuvonantajaltamme.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <div class="form-grid">
      <label class="field" data-field="fname">
        ...
        <input class="input" type="text" name="fname" placeholder="Etunimi" required pattern="[^\d]+" autocomplete="given-name">
      </label>
      <label class="field" data-field="lname">
        <span class="field-label">Sukunimi</span>
        <input class="input" type="text" name="lname" placeholder="Sukunimi" required pattern="[^\d]+" autocomplete="family-name">
      </label>
      <label class="field field-full" data-field="email">
        <span class="field-label">Sähköposti</span>
      ...
      <label class="field field-full" data-field="phone">
        <span class="field-label">Puhelin</span>
        <input class="input" type="tel" name="fullphone" placeholder="040 1234567" autocomplete="tel" inputmode="tel">
    ...
    <div class="pay-row" aria-label="Hyväksytyt maksutavat">
      ...
      <svg class="fai" role="img" aria-label="Pankkisiirto" viewBox="0 0 512 512"><use href="#i-building-columns"/></svg>
      <svg class="fai pay-ok" role="img" aria-label="Turvallinen" viewBox="0 0 512 512"><use href="#i-shield-halved"/></svg>
    </div>
    ...
    <p class="lead-consent form-legal">
      Jatkamalla hyväksyt ehdot ja tietosuojakäytännön.
