...
$methods = [
    ...
    ['file' => 'banktransfer.svg','alt' => 'Bankinis pavedimas e SEPA — aceites em ' . SITE_NAME],
];
?>
<div class="payment-icons<?= $payment_compact ? ' payment-icons--compact' : '' ?>" role="group" aria-label="Priimami mokėjimo būdai para <?= e($payment_context) ?>">
