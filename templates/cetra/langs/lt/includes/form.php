...
$form_submit = $form_submit ?? 'Sukurkite nemokamą paskyrą';
...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__title">Jau registruotas</p>
    <p class="form-already-registered__text">
      Jūsų prašymas su <?= e(SITE_NAME) ?> buvo gauta. Palaukite skambučio iš mūsų vadybininko.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <div class="form-grid">
      <label class="field" data-field="fname">
        <span class="field-label">Vardas</span>
        <input class="input" type="text" name="fname" placeholder="Vardas" required pattern="[^\d]+" autocomplete="given-name">
      </label>
      <label class="field" data-field="lname">
        <span class="field-label">Pavardė</span>
        <input class="input" type="text" name="lname" placeholder="Pavardė" required pattern="[^\d]+" autocomplete="family-name">
      </label>
      <label class="field field-full" data-field="email">
        <span class="field-label">paštas</span>
        <input class="input" type="email" name="email" placeholder="El. pašto adresas" required autocomplete="email" inputmode="email">
      </label>
      <label class="field field-full" data-field="phone">
        <span class="field-label">Telefonas</span>
        <input class="input" type="tel" name="fullphone" placeholder="612 34567" autocomplete="tel" inputmode="tel">
    ...
    <div class="pay-row" aria-label="Priimami mokėjimo būdai">
      ...
      <svg class="fai" role="img" aria-label="Bankinis pavedimas" viewBox="0 0 512 512"><use href="#i-building-columns"/></svg>
    ...
    <p class="lead-consent form-legal">
      Tęsdami sutinkate su mūsų sąlygomis ir privatumo politika.
