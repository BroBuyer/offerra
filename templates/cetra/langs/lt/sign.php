...
$page_description = "Registruotis" . ' — ' . SITE_NAME;
  ...
  <section class="sec">
    <div class="shell" style="max-width:760px">
      ...
      <div class="lede" style="margin-top:18px">
        <?php $form_id="sign-form"; $form_heading="Pradėkite po kelių minučių"; $form_submit="Noriu pradėti"; require __DIR__."/includes/form.php"; ?>
      </div>
