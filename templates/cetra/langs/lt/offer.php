...
$page_description = "Kainodara" . ' — ' . SITE_NAME;
...
<main>
  <section class="sec">
    <div class="shell" style="max-width:760px">
      <h1>Pradėkite nuo <?= e(MIN_DEPOSIT) ?> <?= e(CURRENCY) ?></h1>
      <div class="lede" style="margin-top:18px">
        <p>Visa prieiga prie platformos sumokėjus minimalų įnašą. Jokių paslėptų mokesčių – išlaidos parodomos skaidriai.</p>
      </div>
