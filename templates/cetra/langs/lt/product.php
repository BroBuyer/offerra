...
$page_title = page_title_lead("Produktas");
$page_description = "Produktas" . ' — ' . SITE_NAME;
  ...
  <section class="sec">
    <div class="shell" style="max-width:760px">
      ...
      <div class="lede" style="margin-top:18px">
        <p>AI variklis su realaus laiko žmogaus analize. Prekiaukite kriptovaliutais, Forex ir akcijomis tame pačiame prietaisų skydelyje su greitu vykdymu ir atskirtu kapitalu.</p>
      </div>
