...
$form_submit = $form_submit ?? 'Buat akun gratis';
...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__title">Sudah terdaftar</p>
...
<?php endif; ?>
    ...
    <div class="form-grid">
      <label class="field" data-field="fname">
        ...
        <input class="input" type="text" name="fname" placeholder="Nama depan" required pattern="[^\d]+" autocomplete="given-name">
      </label>
      <label class="field" data-field="lname">
        <span class="field-label">Nama belakang</span>
        <input class="input" type="text" name="lname" placeholder="Nama belakang" required pattern="[^\d]+" autocomplete="family-name">
      </label>
      ...
      <label class="field field-full" data-field="phone">
        ...
        <input class="input" type="tel" name="fullphone" placeholder="812 3456 7890" autocomplete="tel" inputmode="tel">
    ...
    <div class="pay-row" aria-label="Kaedah pembayaran yang diterima">
      ...
      <svg class="fai" role="img" aria-label="Transfer bank" viewBox="0 0 512 512"><use href="#i-building-columns"/></svg>
      <svg class="fai pay-ok" role="img" aria-label="Selamat" viewBox="0 0 512 512"><use href="#i-shield-halved"/></svg>
    </div>
    ...
    <p class="lead-consent form-legal">
      Dengan meneruskan, anda menerima Terma dan Kebijakan Privasi kami.
      <a href="<?= page_url('privacy.php') ?>">Privasi</a>
      &amp;
      <a href="<?= page_url('conditions.php') ?>">Ketentuan Penggunaan</a>.
    </p>
  </div>
</form>
<?php
