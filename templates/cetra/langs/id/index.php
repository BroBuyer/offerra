...
$page_description = SITE_NAME . ' — teknologi AI yang menganalisis pasar dan melaksanakan pesanan secara masa nyata, dengan penganalisis pribadi di sisi anda untuk membina sumber pendapatan baharu.';
$page_canonical = page_url();
$active_page = 'home';
require __DIR__ . '/includes/head.php';
?>
<a class="skip-link" href="#top">Lewati ke konten</a><style>.skip-link{position:absolute;left:-9999px;top:0;z-index:1000;background:#111;color:#fff;padding:.6rem 1rem;border-radius:0 0 .4rem 0}.skip-link:focus{left:0}</style>
...
<header class="site-head">
 ...
 <a href="#how">Cara kerjanya.</a>
 <a href="#markets">Pasar masa nyata</a>
 <a href="#faq">FAQ</a>
 </nav>
 <div class="nav-cta">
 <a class="btn btn-primary" href="#signup">Buka akun anda</a>
...
<section class="hero" id="hero" aria-labelledby="hero-title">
 ...
 <span class="chip"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 6L9 17l-5-5"/></svg>Dukungan 24/7</span>
 <span class="chip"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 6L9 17l-5-5"/></svg>Pelaksanaan cepat</span>
 </div>
 <div class="hero-cta">
 <a class="btn btn-primary" href="#hero-form">Mulai sekarang — <?= e(MIN_DEPOSIT) ?> <?= e(CURRENCY) ?> min.</a>
 </div>
 </div>
 <div class="lead" id="hero-form">
 <h2 id="hero-title">Buka akun anda</h2>
 <p class="sub">Mulakan dalam beberapa menit.</p>
 <?php
  $form_id = 'hero-form';
  $form_heading = null;
  $form_subtitle = null;
  $form_submit = 'Saya ingin mulai';
...
<section class="sec-sm" aria-label="Penunjuk utama">
 ...
 <div class="stat"><b>24/7</b><span>Dukungan</span></div>
 </div>
</section>
...
<section class="sec" id="platform" aria-labelledby="platform-title">
 ...
 <h2 id="platform-title">Ikuti akun Anda secara masa nyata</h2>
 ...
 <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 6L9 17l-5-5"/></svg><span>Pengkiriman pesanan dengan satu ketikan dan verifikasi serta-merta</span></li>
 ...
 <a class="btn btn-primary" href="#hero-form" style="margin-top:26px">Mulai sekarang</a>
 </div>
 ...
 <figcaption class="phone-cap"><?= e(SITE_NAME) ?> — dagangan seluler dengan carta kripto masa nyata</figcaption>
 </figure>
 </div>
</section>
...
<section class="sec" id="features" aria-labelledby="features-title">
 <div class="shell">
 <div class="sec-head"><span class="eyebrow">Platform</span><h2 id="features-title">Semua yang anda perlukan, dalam satu platform yang cepat.</h2><p class="lede">Tiada carta untuk dipantau, tiada pesanan untuk dilitar masa. Enjin <?= e(SITE_NAME) ?> memantau buku pesanan masa nyata di bursa kripto, API ekuiti global dan pasangan forex utama — dan mengkirim pesanan pada saat model menemui tetapan yang menguntungkan.</p></div>
 ...
 <h3>Pelaksanaan dalam pecahan saat di setiap venue yang disambungkan</h3><p><?= e(SITE_NAME) ?> mengekalkan sambungan API berkelewatan rendah dengan setiap bursa yang disokong. Apabila model mengkirim isyarat, pesanan dihala, dilaksanakan dan direkodkan pada papan pemuka anda sebelum tick seterusnya.</p>
 </div>
 <div class="card feat">
 <div class="ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="9"/><path d="M12 8v4l3 2"/></svg></div>
 <h3>Aktif 24 jam sehari, merentasi semua sesi</h3><p>Pasar kripto tidak pernah tidur, dan enjin <?= e(SITE_NAME) ?> juga tidak. Ia terus mengimbas pasangan sepanjang hujung minggu dan cuti supaya anda tidak terlepas sebarang peluang.</p>
 </div>
 <div class="card feat">
 <div class="ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="9"/><path d="M12 8v4l3 2"/></svg></div>
 ...
 <div class="card feat">
 <div class="ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="9"/><path d="M12 8v4l3 2"/></svg></div>
 <h3>Modal terasing</h3><p>Dana anda kekal dalam akun Anda sendiri. <?= e(SITE_NAME) ?> tidak pernah mengambil jagaan — enjin hanya mempunyai kebenaran untuk menghala pesanan.</p>
 </div>
 <div class="card feat">
 <div class="ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="9"/><path d="M12 8v4l3 2"/></svg></div>
 <h3>Keamanan tahap bank</h3><p>Penyulitan TLS merentasi platform, verifikasi dua faktor secara lalai dan audit infrastruktur pihak ketiga setiap suku tahun. Resit dagangan direkodkan di blockchain.</p>
 </div>
 <div class="card feat">
 <div class="ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="9"/><path d="M12 8v4l3 2"/></svg></div>
 <h3>Tiga kelas aset, satu platform</h3><p>Kebanyakan platform runcit terhad kepada satu pasar. <?= e(SITE_NAME) ?> mengendalikan kripto, ekuiti tersenarai dan pasangan forex utama dalam papan pemuka yang sama.</p>
 </div>
 <div class="card feat">
 <div class="ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="9"/><path d="M12 8v4l3 2"/></svg></div>
 <h3>Had risiko praset pada setiap kedudukan</h3><p>Stop-loss, drawdown maksimum dan had peruntukan modal dikonfigurasi mengikut kelas aset. Enjin secara otomatis keluar dari sebarang dagangan yang melepasi had, dan peristiwa itu direkodkan dalam sejarah audit anda.</p>
 </div>
 </div>
 </div>
</section>
...
<section class="sec" id="markets" aria-labelledby="markets-title">
 ...
 <div>
 <span class="eyebrow">Pasar masa nyata</span>
 <h2 id="markets-title">Dagangkan Bitcoin, Ethereum dan banyak lagi</h2>
 <p class="lede">Harga masa nyata, penunjuk lanjutan dan pandangan profesional tentang pasar yang penting kepada anda.</p>
 <a class="btn btn-primary" href="#hero-form" style="margin-top:26px">Saya ingin akses pasar</a>
 </div>
 <div class="mkt-card">
 <div class="mkt-head"><span>Pasar</span><span class="mkt-live"><i></i>Langsung</span></div>
 <div class="mkt-list">
...
<section class="sec" id="how" aria-labelledby="how-title">
 <div class="shell">
 <div class="sec-head"><span class="eyebrow">Cara kerjanya</span><h2 id="how-title">Cara kerjanya.</h2><p class="lede">Teknologi termaju dan penganalisis manusia sebenar, bekerjasama secara masa nyata, untuk membantu anda membina sumber pendapatan baharu — dengan bimbingan di setiap langkah.</p></div>
 <div class="steps" style="margin-top:36px">
 <div class="step"><div class="n">1</div><h3>Buat akun Anda</h3><p>Daftar dalam beberapa menit menggunakan email anda sahaja.</p></div>
 <div class="step"><div class="n">2</div><h3>Sahkan email anda</h3><p>Sahkan alamat anda untuk melindungi akun Anda.</p></div>
 <div class="step"><div class="n">3</div><h3>Deposit ke dalam akun Anda</h3><p>Tambah dana dari <?= e(MIN_DEPOSIT) ?> <?= e(CURRENCY) ?> mengikut cara anda.</p></div>
 <div class="step"><div class="n">4</div><h3>Tetapkan strategi anda</h3><p>Pilih matlamat anda; penganalisis anda mempribadikan rancangan itu.</p></div>
 <div class="step"><div class="n">5</div><h3>Mulai trading</h3><p>Ikuti isyarat berpandu dan berkembang pada kadar anda sendiri.</p></div>
 </div>
 </div>
</section>
...
<section class="sec-sm" id="payment" aria-labelledby="payment-title">
 ...
 <div class="pay"><svg class="fai" aria-hidden="true" viewBox="0 0 512 512"><use href="#i-building-columns"/></svg>Transfer bank</div>
...
<section class="sec" id="reviews" aria-labelledby="reviews-title">
 ...
 <div class="card"><p>“Penganalisis saya menjelaskan semuanya dengan jelas. Saya menetapkan matlamat sekali sahaja, dan kini saya dapat melihat dengan tepat bagaimana modal saya berkembang — tanpa risau tentang setiap pergerakan.”</p><div class="who"><div class="ini">C</div><div><b>Siti Aminah</b><span>Jakarta</span></div></div></div>
 <div class="card"><p>“Saya tidak pernah melabur sebelum ini — penganalisis saya menguruskan strategi dan menjelaskan setiap langkah. Tiada janji kosong, tiada tekanan, dan pengeluaran tiba ketika dijangka.”</p><div class="who"><div class="ini">F</div><div><b>Budi Santoso</b><span>Surabaya</span></div></div></div>
 <div class="card"><p>“Saya bermula dengan jumlah kecil untuk mencoba. Ketelusan dan dukungan memberi saya keyakinan untuk terus membina dari situ.”</p><div class="who"><div class="ini">B</div><div><b>Dewi Lestari</b><span>Bandung</span></div></div></div>
 <div class="card"><p>“Analisis sampai kepada saya — saya luluskan atau laraskan dalam beberapa menit. Ia sesuai sepenuhnya dengan rutin saya tanpa mengganggu kerja.”</p><div class="who"><div class="ini">L</div><div><b>Andi Wijaya</b><span>Medan</span></div></div></div>
 <div class="card"><p>“Apa yang meyakinkan saya ialah ketelusan: setiap keputusan dijelaskan, dan saya melihat rasionalnya sebelum apa-apa berlaku.”</p><div class="who"><div class="ini">G</div><div><b>Maya Putri</b><span>Semarang</span></div></div></div>
 <div class="card"><p>“Dukungan adalah tulus dan sentiasa tersedia. Analisis pertama saya dilakukan secara praktikal, dan platform ini kekal kukuh dan bisa dijangka sejak itu.”</p><div class="who"><div class="ini">R</div><div><b>Rudi Hartono</b><span>Yogyakarta</span></div></div></div>
 </div>
 </div>
</section>
...
<section class="sec" id="capabilities" aria-labelledby="capabilities-title">
 <div class="shell">
 <div class="sec-head"><span class="eyebrow">Platform</span><h2 id="capabilities-title">Fitur utama, secara singkat</h2></div>
 <div class="spec">
 <div class="spec-row">
 <div class="spec-k">Enjin AI</div>
 <div class="spec-v">Analisis pasar lanjutan dengan pembelajaran mesin</div>
 </div>
 <div class="spec-row">
 <div class="spec-k">Kaedah deposit</div>
 <div class="spec-v">Kad kredit, transfer bank, PayPal, dompet digital</div>
 </div>
 <div class="spec-row">
 <div class="spec-k">Akses berbilang platform</div>
 <div class="spec-v">Web, tablet dan seluler — sepenuhnya responsif</div>
 </div>
 <div class="spec-row">
 ...
 <div class="spec-row">
 <div class="spec-k">Pasar</div>
 <div class="spec-v">Mata wang kripto, forex, saham dan komoditi</div>
 </div>
 <div class="spec-row">
 <div class="spec-k">Pendaftaran</div>
 <div class="spec-v">Pembukaan akun cepat dengan verifikasi berpandu</div>
 </div>
 <div class="spec-row spec-row--hl">
 <div class="spec-k">Dukungan</div>
 <div class="spec-v">Dukungan profesional sepanjang masa — <a href="<?= page_url('contacts.php') ?>">Kirim mesej</a></div>
 </div>
 </div>
 </div>
</section>
...
<section class="sec" id="faq" aria-labelledby="faq-title">
 <div class="shell">
 <div class="sec-head" style="text-align:center;margin:0 auto"><span class="eyebrow">Soalan</span><h2 id="faq-title">Pertanyaan umum.</h2></div>
 <div class="faq" style="margin-top:34px">
 <details open><summary>Berapakah deposit minimum?</summary><p>Buka dan biayai akun Anda dari deposit minimum. Anda bisa menambah baki dari saat ke saat mengikut kemajuan rancangan anda.</p></details>
 <details><summary>Bagaimana pengeluaran berfungsi?</summary><p>Minta pengeluaran pada kapan saja dari papan pemuka. Dana dikembalikan kepada kaedah pembayaran yang anda pilih, tertakluk kepada masa pemprosesan standard.</p></details>
 <details><summary>Adakah wang saya selamat?</summary><p>Akun dilindungi dengan keamanan piawaian industri dan verifikasi yang teliti. Seperti mana-mana pelaburan, modal anda berisiko dan nilai bisa jatuh serta naik.</p></details>
 <details><summary>Berapa cepat saya bisa mula?</summary><p>Kebanyakan ahli menyelesaikan pendaftaran dalam beberapa menit. Setelah deposit pertama anda disahkan, rancangan diaktifkan dengan segera.</p></details>
 ...
 <details><summary>Berapakah umur minimum untuk mendaftar?</summary><p>Anda mestilah sekurang-kurangnya 18 tahun untuk membuka akun dan melabur. Pengesahan mungkin diperlukan untuk mengesahkan umur dan identiti anda.</p></details>
 <details><summary>Kaedah pembayaran manakah yang disokong?</summary><p>Kaedah biasa seperti kad debit dan kredit, transfer bank, e-wallet terpilih dan mata wang kripto disokong. Pilihan tepat dipaparkan pada langkah deposit.</p></details>
 <details><summary>Bila dukungan pelanggan tersedia?</summary><p>Pasukan dukungan kami beroperasi Isnin hingga Jumaat, 9 pagi hingga 6 petang, dan komited untuk menjawab setiap permintaan dalam satu hari bekerja.</p></details>
 ...
 <details><summary>Apakah KYC dan mengapa ia diperlukan?</summary><p>KYC (Kenali Pelanggan Anda) ialah semakan identiti piawai. Ia mengekalkan akun selamat dan merupakan sebahagian dari pembukaan mana-mana akun pelaburan.</p></details>
 <details><summary>Adakah saya perlukan pengalaman?</summary><p>Tidak. Setiap ahli mendapat penganalisis kewangan pribadi yang membimbing mereka di setiap langkah, jadi pengetahuan pasar terdahulu tidak diperlukan.</p></details>
 ...
 <details><summary>Adakah platform ini dikawal selia?</summary><p>Ya — ia memenuhi piawaian kewangan dan keamanan siber kebangsaan, dengan perlindungan akun dan verifikasi teliti terbina dalam.</p></details>
 <details><summary>Bisakah saya menambah dana kemudian?</summary><p>Ya. Anda bisa membiayai akun Anda pada kapan saja dan menyesuaikan rancangan anda dengan penganalisis anda mengikut perkembangan matlamat anda.</p></details>
 </div>
 </div>
</section>
...
<!--reviews-block--><section aria-label="Client ratings" style="padding:3rem 1.25rem;background:var(--bg,#0b0f19)"><div style="max-width:68rem;margin:0 auto;background:var(--surface,#12182a);border:1px solid var(--border,rgba(255,255,255,.08));border-radius:18px;padding:24px 34px;display:flex;flex-wrap:wrap;align-items:center;justify-content:center;gap:18px 42px"><div style="text-align:center"><span style="display:inline-block;background:var(--accent,#e8b84b);color:var(--on-accent,#0b0d14);font:700 11px/1 Sora,system-ui,sans-serif;letter-spacing:.14em;padding:7px 12px;border-radius:6px;margin-bottom:10px">DIPERCAYAI</span><div style="font:700 1.2rem Sora,system-ui,sans-serif;color:var(--text,#fff)"><?= e(SITE_NAME) ?> Ulasan</div></div><div style="font:800 2.7rem Sora,system-ui,sans-serif;color:var(--accent,#e8b84b);line-height:1;font-variant-numeric:tabular-nums">4.8</div><span style="position:relative;display:inline-block;font-size:1.55rem;line-height:1;letter-spacing:.1em" aria-hidden="true"><span style="color:var(--gold,#efb567);opacity:.25">★★★★★</span><span style="position:absolute;inset:0;overflow:hidden;white-space:nowrap;width:96.0%;color:var(--gold,#efb567)">★★★★★</span></span><div style="color:var(--muted,#9aa3b2);font-size:.95rem;font-variant-numeric:tabular-nums"><b style="color:var(--text,#fff)">389</b> ulasan · Berdasarkan <b style="color:var(--text,#fff)">2.334</b> penilaian</div></div></section><section class="sec" id="signup" aria-labelledby="signup-title">
 ...
 <h2 id="signup-title" class="cta-h">Buka akun anda.</h2>
...
<footer class="foot">
 ...
 <a href="#platform">Ikuti akun Anda secara masa nyata</a><a href="#markets">Pasar masa nyata</a><a href="#how">Cara kerjanya.</a><a href="#faq">FAQ</a>
 </div></div>
 <div><h4>Perusahaan</h4><div class="foot-links">
 <a href="<?= page_url('product.php') ?>">Tentang</a><a href="<?= page_url('offer.php') ?>">Harga</a><a href="<?= page_url('contacts.php') ?>">Hubungi</a>
 </div></div>
 <div><h4>Hukum</h4><div class="foot-links">
 <a href="<?= page_url('privacy.php') ?>">Privasi</a><a href="<?= page_url('conditions.php') ?>">Terma</a><a href="<?= page_url('conditions.php') ?>">Pengungkapan risiko</a><a href="<?= page_url('contacts.php') ?>">Laporkan penyalahgunaan</a>
 </div></div>
 </div>
 <div class="foot-bottom">© <span id="yr"></span> <?= e(SITE_NAME) ?>. Hak cipta dilindungi. Pelaburan melibatkan risiko, termasuk kemungkinan kehilangan modal. · Pelaburan melibatkan risiko, termasuk kemungkinan kehilangan sebahagian atau semua modal yang dilaburkan. Nilai pelaburan bisa naik atau turun, dan anda mungkin menerima kembali kurang dari yang anda masukkan pada asalnya. Jangan laburkan wang yang anda tidak mampu rugi.</div>
 </div>
</footer>
<script>document.getElementById('yr').textContent=new Date().getFullYear();</script>
<script>/*rates*/(function(){
function money(n){n=+n;return n.toLocaleString('id-ID',{maximumFractionDigits:n>=1000?0:(n>=1?2:4)})+'';}
...
<script>
(function () {
 var MSG_WAIT = "Silakan tunggu\u2026";
 var MSG_ERR = "Kami tidak dapat mengirim detail anda sekarang. Silakan coba lagi.";
 var THANKS = "/thanks/";
...
(function () {
 ...
 initialCountry: (hid && hid.value) || 'id',
...
<span style="flex:1;min-width:200px">Kami menggunakan cookie untuk meningkatkan pengalaman anda.</span>
<button type="button" id="ck-yes" style="cursor:pointer;background:var(--accent,#7c5cff);color:#fff;border:0;border-radius:999px;padding:9px 20px;font:inherit;font-weight:600;flex-shrink:0">Mengerti</button>
