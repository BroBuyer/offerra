...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__title">Sudah berdaftar</p>
...
<?php endif; ?>
    ...
    <div class="form-grid">
      <label class="field" data-field="fname">
        ...
        <input class="input" type="text" name="fname" placeholder="Nama pertama" required pattern="[^\d]+" autocomplete="given-name">
      </label>
      <label class="field" data-field="lname">
        <span class="field-label">Nama keluarga</span>
        <input class="input" type="text" name="lname" placeholder="Nama keluarga" required pattern="[^\d]+" autocomplete="family-name">
      </label>
      ...
      <label class="field field-full" data-field="phone">
        ...
        <input class="input" type="tel" name="fullphone" placeholder="12-345 6789" autocomplete="tel" inputmode="tel">
    ...
    <p class="lead-consent form-legal">
      Dengan meneruskan, anda menerima Terma dan Dasar Privasi kami.
      <a href="<?= page_url('privacy.php') ?>">Privasi</a>
      &amp;
      <a href="<?= page_url('conditions.php') ?>">Terma Penggunaan</a>.
    </p>
  </div>
</form>
<?php
