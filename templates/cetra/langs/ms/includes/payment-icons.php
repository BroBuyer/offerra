...
$methods = [
    ...
    ['file' => 'banktransfer.svg','alt' => 'Pindahan bank e SEPA — aceites em ' . SITE_NAME],
];
?>
<div class="payment-icons<?= $payment_compact ? ' payment-icons--compact' : '' ?>" role="group" aria-label="Kaedah pembayaran yang diterima para <?= e($payment_context) ?>">
