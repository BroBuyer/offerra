...
$page_description = "Köszönjük" . ' — ' . SITE_NAME;
  ...
  <section class="sec">
    <div class="shell" style="max-width:760px">
      ...
      <div class="lede" style="margin-top:18px">
        <p>Köszönjük, hogy regisztrált a <?= e(SITE_NAME) ?> oldalán. Csapatunk hamarosan felveszi Önnel a kapcsolatot — tartsa a telefont a közelben.</p>
      </div>
