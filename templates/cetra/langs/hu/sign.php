...
$page_description = "Regisztráció" . ' — ' . SITE_NAME;
...
<main>
  <section class="sec">
    <div class="shell" style="max-width:760px">
      <h1>Nyissa meg fiókját</h1>
      <div class="lede" style="margin-top:18px">
        <?php $form_id="sign-form"; $form_heading="Kezdjen néhány perc alatt"; $form_submit="Szeretnék kezdeni"; require __DIR__."/includes/form.php"; ?>
      </div>
