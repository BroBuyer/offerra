...
$page_description = "Árak" . ' — ' . SITE_NAME;
...
<main>
  <section class="sec">
    <div class="shell" style="max-width:760px">
      <h1>Kezdje innen: <?= e(MIN_DEPOSIT) ?> <?= e(CURRENCY) ?></h1>
      <div class="lede" style="margin-top:18px">
        <p>Teljes platformhozzáférés a minimális befizetés után. Nincsenek rejtett díjak — a költségek átláthatóan jelennek meg.</p>
      </div>
