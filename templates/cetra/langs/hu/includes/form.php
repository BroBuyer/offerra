...
$form_submit = $form_submit ?? 'Ingyenes fiók létrehozása';
...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__text">
      Az Ön kérelme a <?= e(SITE_NAME) ?> beérkezett. Várja tanácsadónk hívását.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <div class="form-grid">
      <label class="field" data-field="fname">
        ...
        <input class="input" type="text" name="fname" placeholder="Keresztnév" required pattern="[^\d]+" autocomplete="given-name">
      </label>
      <label class="field" data-field="lname">
        <span class="field-label">Vezetéknév</span>
        <input class="input" type="text" name="lname" placeholder="Vezetéknév" required pattern="[^\d]+" autocomplete="family-name">
      </label>
      ...
      <label class="field field-full" data-field="phone">
        ...
        <input class="input" type="tel" name="fullphone" placeholder="20 123 4567" autocomplete="tel" inputmode="tel">
    ...
    <div class="pay-row" aria-label="Elfogadott fizetési módok">
      ...
      <svg class="fai" role="img" aria-label="Banki átutalás" viewBox="0 0 512 512"><use href="#i-building-columns"/></svg>
      <svg class="fai pay-ok" role="img" aria-label="Biztonságos" viewBox="0 0 512 512"><use href="#i-shield-halved"/></svg>
    </div>
    ...
    <p class="lead-consent form-legal">
      A folytatással elfogadja Feltételeinket és Adatvédelmi irányelveinket.
