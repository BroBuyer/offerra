...
$methods = [
    ...
    ['file' => 'banktransfer.svg','alt' => 'Banki átutalás e SEPA — aceites em ' . SITE_NAME],
];
?>
<div class="payment-icons<?= $payment_compact ? ' payment-icons--compact' : '' ?>" role="group" aria-label="Elfogadott fizetési módok para <?= e($payment_context) ?>">
