...
$page_title = $page_title ?? page_title('MI és valós idejű végrehajtás');
$page_description = $page_description ?? (SITE_NAME . ' — MI-technológia, amely elemzi a piacokat és valós időben hajt végre megbízásokat, személyes elemzővel az Ön oldalán.');
