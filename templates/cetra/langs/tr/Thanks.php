...
$page_description = "Teşekkürler" . ' — ' . SITE_NAME;
  ...
  <section class="sec">
    <div class="shell" style="max-width:760px">
      ...
      <div class="lede" style="margin-top:18px">
        <p><?= e(SITE_NAME) ?> kaydınız için teşekkürler. Ekibimiz kısa süre içinde sizinle iletişime geçecek — telefonunuzu yakın tutun.</p>
      </div>
