...
$page_description = "Kayıt" . ' — ' . SITE_NAME;
  ...
  <section class="sec">
    <div class="shell" style="max-width:760px">
      ...
      <div class="lede" style="margin-top:18px">
        <?php $form_id="sign-form"; $form_heading="Birkaç dakikada başlayın"; $form_submit="Başlamak istiyorum"; require __DIR__."/includes/form.php"; ?>
      </div>
