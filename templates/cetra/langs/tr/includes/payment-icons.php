...
$methods = [
    ...
    ['file' => 'banktransfer.svg','alt' => 'Banka havalesi e SEPA — aceites em ' . SITE_NAME],
];
?>
<div class="payment-icons<?= $payment_compact ? ' payment-icons--compact' : '' ?>" role="group" aria-label="Kabul edilen ödeme yöntemleri para <?= e($payment_context) ?>">
