...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__title">Zaten kayıtlı</p>
    <p class="form-already-registered__text">
      Talebiniz <?= e(SITE_NAME) ?> alındı. Danışmanımızın aramasını bekleyin.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <div class="form-grid">
      <label class="field" data-field="fname">
        ...
        <input class="input" type="text" name="fname" placeholder="Ad" required pattern="[^\d]+" autocomplete="given-name">
      </label>
      <label class="field" data-field="lname">
        <span class="field-label">Soyad</span>
        <input class="input" type="text" name="lname" placeholder="Soyad" required pattern="[^\d]+" autocomplete="family-name">
      </label>
      ...
      <label class="field field-full" data-field="phone">
        ...
        <input class="input" type="tel" name="fullphone" placeholder="532 123 4567" autocomplete="tel" inputmode="tel">
    ...
    <div class="pay-row" aria-label="Kabul edilen ödeme yöntemleri">
    ...
    <p class="lead-consent form-legal">
      ...
      &amp;
      <a href="<?= page_url('conditions.php') ?>">Kullanım Şartları</a>.
    </p>
  </div>
</form>
<?php
