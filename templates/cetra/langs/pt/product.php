...
$page_description = "Produto" . ' — ' . SITE_NAME;
...
<main>
  <section class="sec">
    <div class="shell" style="max-width:760px">
      <h1><?= e(SITE_NAME) ?> — a plataforma</h1>
      <div class="lede" style="margin-top:18px">
        <p>Motor de IA com análise humana em tempo real. Opere cripto, forex e ações no mesmo painel, com execução rápida e capital segregado.</p>
      </div>
