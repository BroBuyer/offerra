...
$page_title = page_title_lead("Privacidade");
$page_description = "Privacidade" . ' — ' . SITE_NAME;
  ...
  <section class="sec">
    <div class="shell" style="max-width:760px">
      ...
      <div class="lede" style="margin-top:18px">
        <p>Esta política descreve como <?= e(SITE_NAME) ?> coleta e protege seus dados pessoais (nome, e-mail, telefone) para criar e gerenciar sua conta.</p>
      </div>
