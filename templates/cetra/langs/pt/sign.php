...
$page_title = page_title_lead("Cadastro");
$page_description = "Cadastro" . ' — ' . SITE_NAME;
  ...
  <section class="sec">
    <div class="shell" style="max-width:760px">
      ...
      <div class="lede" style="margin-top:18px">
        <?php $form_id="sign-form"; $form_heading="Comece em poucos minutos"; $form_submit="Quero começar"; require __DIR__."/includes/form.php"; ?>
      </div>
