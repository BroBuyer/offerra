...
$page_description = "Contacto" . ' — ' . SITE_NAME;
  ...
  <section class="sec">
    <div class="shell" style="max-width:760px">
      ...
      <div class="lede" style="margin-top:18px">
        <p>Email: <a href="mailto:<?= e(SUPPORT_EMAIL) ?>"><?= e(SUPPORT_EMAIL) ?></a></p><?php $form_id="contact-form"; $form_heading="Deixe seus dados"; $form_submit="Enviar"; require __DIR__."/includes/form.php"; ?>
      </div>
