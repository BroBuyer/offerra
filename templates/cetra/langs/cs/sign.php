...
$page_description = "Registrace" . ' — ' . SITE_NAME;
...
<main>
  <section class="sec">
    <div class="shell" style="max-width:760px">
      <h1>Otevřete svůj účet</h1>
      <div class="lede" style="margin-top:18px">
        <?php $form_id="sign-form"; $form_heading="Začněte během několika minut"; $form_submit="Chci začít"; require __DIR__."/includes/form.php"; ?>
      </div>
