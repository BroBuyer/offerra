...
$page_title = $page_title ?? page_title('AI a provádění v reálném čase');
$page_description = $page_description ?? (SITE_NAME . ' — AI technologie, která analyzuje trhy a provádí příkazy v reálném čase, s osobním analytikem po vašem boku.');
