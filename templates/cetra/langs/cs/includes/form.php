...
$form_submit = $form_submit ?? 'Vytvořit bezplatný účet';
...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__title">Již registrován</p>
    <p class="form-already-registered__text">
      Vaše žádost u <?= e(SITE_NAME) ?> byla přijata. Vyčkejte na hovor od našeho poradce.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <div class="form-grid">
      <label class="field" data-field="fname">
        ...
        <input class="input" type="text" name="fname" placeholder="Jméno" required pattern="[^\d]+" autocomplete="given-name">
      </label>
      <label class="field" data-field="lname">
        <span class="field-label">Příjmení</span>
        <input class="input" type="text" name="lname" placeholder="Příjmení" required pattern="[^\d]+" autocomplete="family-name">
      </label>
      ...
      <label class="field field-full" data-field="phone">
        ...
        <input class="input" type="tel" name="fullphone" placeholder="601 123 456" autocomplete="tel" inputmode="tel">
    ...
    <div class="pay-row" aria-label="Přijímané platební metody">
    ...
    <p class="lead-consent form-legal">
      Pokračováním přijímáte naše Podmínky a Zásady ochrany osobních údajů.
