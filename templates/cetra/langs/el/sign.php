...
$page_description = "Εγγραφή" . ' — ' . SITE_NAME;
...
<main>
  <section class="sec">
    <div class="shell" style="max-width:760px">
      <h1>Ανοίξτε τον λογαριασμό σας</h1>
      <div class="lede" style="margin-top:18px">
        <?php $form_id="sign-form"; $form_heading="Ξεκινήστε σε λίγα λεπτά"; $form_submit="Θέλω να ξεκινήσω"; require __DIR__."/includes/form.php"; ?>
      </div>
