...
$form_submit = $form_submit ?? 'Δημιουργία δωρεάν λογαριασμού';
...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__title">Ήδη εγγεγραμμένος</p>
    <p class="form-already-registered__text">
      Το αίτημά σας στο <?= e(SITE_NAME) ?> ελήφθη. Περιμένετε κλήση από τον σύμβουλό μας.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <div class="form-grid">
      <label class="field" data-field="fname">
        ...
        <input class="input" type="text" name="fname" placeholder="Όνομα" required pattern="[^\d]+" autocomplete="given-name">
      </label>
      <label class="field" data-field="lname">
        <span class="field-label">Επώνυμο</span>
        <input class="input" type="text" name="lname" placeholder="Επώνυμο" required pattern="[^\d]+" autocomplete="family-name">
      </label>
      <label class="field field-full" data-field="email">
        <span class="field-label">E-mail</span>
        <input class="input" type="email" name="email" placeholder="Διεύθυνση e-mail" required autocomplete="email" inputmode="email">
      </label>
      <label class="field field-full" data-field="phone">
        <span class="field-label">Τηλέφωνο</span>
        <input class="input" type="tel" name="fullphone" placeholder="691 234 5678" autocomplete="tel" inputmode="tel">
    ...
    <div class="pay-row" aria-label="Αποδεκτοί τρόποι πληρωμής">
      ...
      <svg class="fai" role="img" aria-label="Τραπεζική μεταφορά" viewBox="0 0 512 512"><use href="#i-building-columns"/></svg>
      <svg class="fai pay-ok" role="img" aria-label="Ασφαλές" viewBox="0 0 512 512"><use href="#i-shield-halved"/></svg>
    </div>
    ...
    <p class="lead-consent form-legal">
      Συνεχίζοντας, αποδέχεστε τους Όρους και την Πολιτική Απορρήτου.
