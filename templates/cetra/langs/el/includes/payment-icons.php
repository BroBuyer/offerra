...
$methods = [
    ...
    ['file' => 'banktransfer.svg','alt' => 'Τραπεζική μεταφορά e SEPA — aceites em ' . SITE_NAME],
];
?>
<div class="payment-icons<?= $payment_compact ? ' payment-icons--compact' : '' ?>" role="group" aria-label="Αποδεκτοί τρόποι πληρωμής para <?= e($payment_context) ?>">
