...
$page_title = $page_title ?? page_title('ΤΝ και εκτέλεση σε πραγματικό χρόνο');
$page_description = $page_description ?? (SITE_NAME . ' — τεχνολογία ΤΝ που αναλύει αγορές και εκτελεί εντολές σε πραγματικό χρόνο, με προσωπικό αναλυτή δίπλα σας.');
