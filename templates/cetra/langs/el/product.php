...
$page_description = "Προϊόν" . ' — ' . SITE_NAME;
...
<main>
  <section class="sec">
    <div class="shell" style="max-width:760px">
      <h1><?= e(SITE_NAME) ?> — η πλατφόρμα</h1>
      <div class="lede" style="margin-top:18px">
        <p>Μηχανή ΤΝ με ανθρώπινη ανάλυση σε πραγματικό χρόνο. Συναλλαγές crypto, forex και μετοχών στον ίδιο πίνακα ελέγχου, με γρήγορη εκτέλεση και διαχωρισμένο κεφάλαιο.</p>
      </div>
