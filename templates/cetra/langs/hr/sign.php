...
$page_description = "Registracija" . ' — ' . SITE_NAME;
...
<main>
  <section class="sec">
    <div class="shell" style="max-width:760px">
      <h1>Otvorite svoj račun</h1>
      <div class="lede" style="margin-top:18px">
        <?php $form_id="sign-form"; $form_heading="Započnite u nekoliko minuta"; $form_submit="Želim početi"; require __DIR__."/includes/form.php"; ?>
      </div>
