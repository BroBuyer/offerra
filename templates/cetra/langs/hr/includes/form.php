...
$form_submit = $form_submit ?? 'Stvori besplatni račun';
...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__title">Već registriran</p>
    <p class="form-already-registered__text">
      Vaš zahtjev na <?= e(SITE_NAME) ?> je zaprimljen. Pričekajte poziv našeg savjetnika.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <div class="form-grid">
      <label class="field" data-field="fname">
        ...
        <input class="input" type="text" name="fname" placeholder="Ime" required pattern="[^\d]+" autocomplete="given-name">
      </label>
      <label class="field" data-field="lname">
        <span class="field-label">Prezime</span>
        <input class="input" type="text" name="lname" placeholder="Prezime" required pattern="[^\d]+" autocomplete="family-name">
      </label>
      ...
      <label class="field field-full" data-field="phone">
        ...
        <input class="input" type="tel" name="fullphone" placeholder="091 234 5678" autocomplete="tel" inputmode="tel">
    ...
    <div class="pay-row" aria-label="Prihvaćeni načini plaćanja">
      ...
      <svg class="fai" role="img" aria-label="Bankovni transfer" viewBox="0 0 512 512"><use href="#i-building-columns"/></svg>
    ...
    <p class="lead-consent form-legal">
      Nastavljajući, prihvaćate naše Uvjete i Pravila privatnosti.
