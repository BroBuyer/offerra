...
$page_title = $page_title ?? page_title('UI i izvršenje u stvarnom vremenu');
$page_description = $page_description ?? (SITE_NAME . ' — UI tehnologija koja analizira tržišta i izvršava naloge u stvarnom vremenu, uz osobnog analitičara uz vas.');
