...
$methods = [
    ...
    ['file' => 'banktransfer.svg','alt' => 'Bankovni transfer e SEPA — aceites em ' . SITE_NAME],
];
?>
<div class="payment-icons<?= $payment_compact ? ' payment-icons--compact' : '' ?>" role="group" aria-label="Prihvaćeni načini plaćanja para <?= e($payment_context) ?>">
