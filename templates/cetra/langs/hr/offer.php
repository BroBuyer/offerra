...
$page_description = "Cijene" . ' — ' . SITE_NAME;
...
<main>
  <section class="sec">
    <div class="shell" style="max-width:760px">
      <h1>Započnite od <?= e(MIN_DEPOSIT) ?> <?= e(CURRENCY) ?></h1>
      <div class="lede" style="margin-top:18px">
        <p>Puni pristup platformi nakon minimalnog depozita. Bez skrivenih naknada — troškovi se prikazuju transparentno.</p>
      </div>
