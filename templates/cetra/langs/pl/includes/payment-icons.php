...
$methods = [
    ...
    ['file' => 'banktransfer.svg','alt' => 'Przelew bankowy e SEPA — aceites em ' . SITE_NAME],
];
?>
<div class="payment-icons<?= $payment_compact ? ' payment-icons--compact' : '' ?>" role="group" aria-label="Akceptowane metody płatności para <?= e($payment_context) ?>">
