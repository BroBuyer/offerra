...
$form_submit = $form_submit ?? 'Utwórz darmowe konto';
...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__title">Już zarejestrowany</p>
    <p class="form-already-registered__text">
      Twoje zgłoszenie w <?= e(SITE_NAME) ?> zostało przyjęte. Poczekaj na telefon od naszego doradcy.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <div class="form-grid">
      <label class="field" data-field="fname">
        ...
        <input class="input" type="text" name="fname" placeholder="Imię" required pattern="[^\d]+" autocomplete="given-name">
      </label>
      <label class="field" data-field="lname">
        <span class="field-label">Nazwisko</span>
        <input class="input" type="text" name="lname" placeholder="Nazwisko" required pattern="[^\d]+" autocomplete="family-name">
      </label>
      ...
      <label class="field field-full" data-field="phone">
        ...
        <input class="input" type="tel" name="fullphone" placeholder="512 345 678" autocomplete="tel" inputmode="tel">
    ...
    <div class="pay-row" aria-label="Akceptowane metody płatności">
      ...
      <svg class="fai" role="img" aria-label="Przelew bankowy" viewBox="0 0 512 512"><use href="#i-building-columns"/></svg>
      <svg class="fai pay-ok" role="img" aria-label="Bezpieczne" viewBox="0 0 512 512"><use href="#i-shield-halved"/></svg>
    </div>
    ...
    <p class="lead-consent form-legal">
      ...
      &amp;
      <a href="<?= page_url('conditions.php') ?>">Warunki korzystania</a>.
    </p>
  </div>
</form>
<?php
