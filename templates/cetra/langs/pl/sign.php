...
$page_description = "Rejestracja" . ' — ' . SITE_NAME;
...
<main>
  <section class="sec">
    <div class="shell" style="max-width:760px">
      <h1>Otwórz swoje konto</h1>
      <div class="lede" style="margin-top:18px">
        <?php $form_id="sign-form"; $form_heading="Zacznij w kilka minut"; $form_submit="Chcę zacząć"; require __DIR__."/includes/form.php"; ?>
      </div>
