...
$page_description = "Cennik" . ' — ' . SITE_NAME;
...
<main>
  <section class="sec">
    <div class="shell" style="max-width:760px">
      <h1>Zacznij od <?= e(MIN_DEPOSIT) ?> <?= e(CURRENCY) ?></h1>
      <div class="lede" style="margin-top:18px">
        <p>Pełny dostęp do platformy po minimalnej wpłacie. Bez ukrytych opłat — koszty pokazywane przejrzyście.</p>
      </div>
