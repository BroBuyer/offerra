...
$methods = [
    ...
    ['file' => 'banktransfer.svg','alt' => 'Banköverföring e SEPA — aceites em ' . SITE_NAME],
];
?>
<div class="payment-icons<?= $payment_compact ? ' payment-icons--compact' : '' ?>" role="group" aria-label="Accepterade betalningsmetoder para <?= e($payment_context) ?>">
