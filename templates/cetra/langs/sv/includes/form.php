...
$form_submit = $form_submit ?? 'Skapa ett gratis konto';
...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__title">Redan registrerad</p>
    <p class="form-already-registered__text">
      Din förfrågan hos <?= e(SITE_NAME) ?> har mottagits. Vänta på ett samtal från vår rådgivare.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <div class="form-grid">
      <label class="field" data-field="fname">
        ...
        <input class="input" type="text" name="fname" placeholder="Förnamn" required pattern="[^\d]+" autocomplete="given-name">
      </label>
      <label class="field" data-field="lname">
        <span class="field-label">Efternamn</span>
        <input class="input" type="text" name="lname" placeholder="Efternamn" required pattern="[^\d]+" autocomplete="family-name">
      </label>
      <label class="field field-full" data-field="email">
        <span class="field-label">E-mail</span>
        <input class="input" type="email" name="email" placeholder="E-postadress" required autocomplete="email" inputmode="email">
      </label>
      <label class="field field-full" data-field="phone">
        <span class="field-label">Telefon</span>
        <input class="input" type="tel" name="fullphone" placeholder="70 123 45 67" autocomplete="tel" inputmode="tel">
    ...
    <div class="pay-row" aria-label="Accepterade betalningsmetoder">
