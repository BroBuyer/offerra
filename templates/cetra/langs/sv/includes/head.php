...
$page_title = $page_title ?? page_title('AI och exekvering i realtid');
$page_description = $page_description ?? (SITE_NAME . ' — AI-teknik som analyserar marknader och utför ordrar i realtid, med en personlig analytiker vid din sida.');
