...
$page_title = page_title('AI och exekvering i realtid | Officiell webbplats');
$page_description = SITE_NAME . ' — AI-teknik som analyserar marknader och utför ordrar i realtid, med en personlig analytiker vid din sida för att bygga en ny inkomstkälla.';
$page_canonical = page_url();
$active_page = 'home';
require __DIR__ . '/includes/head.php';
?>
<a class="skip-link" href="#top">Hoppa till innehåll</a><style>.skip-link{position:absolute;left:-9999px;top:0;z-index:1000;background:#111;color:#fff;padding:.6rem 1rem;border-radius:0 0 .4rem 0}.skip-link:focus{left:0}</style>
...
<header class="site-head">
 ...
 <a href="#markets">Marknader i realtid</a>
 <a href="#faq">FAQ</a>
 </nav>
 <div class="nav-cta">
 <a class="btn btn-primary" href="#signup">Öppna ditt konto</a>
 <button class="nav-toggle" aria-label="Öppna meny" aria-expanded="false" aria-controls="navLinks" type="button">
...
<section class="hero" id="hero" aria-labelledby="hero-title">
 ...
 <div class="hero-cta">
 <a class="btn btn-primary" href="#hero-form">Börja nu — <?= e(MIN_DEPOSIT) ?> <?= e(CURRENCY) ?> min.</a>
 </div>
 </div>
 <div class="lead" id="hero-form">
 <h2 id="hero-title">Öppna ditt konto</h2>
 <p class="sub">Kom igång på några minuter.</p>
 <?php
  $form_id = 'hero-form';
  $form_heading = null;
  $form_subtitle = null;
  $form_submit = 'Jag vill börja';
...
<section class="sec" id="platform" aria-labelledby="platform-title">
 ...
 <a class="btn btn-primary" href="#hero-form" style="margin-top:26px">Börja nu</a>
 </div>
...
<section class="sec" id="markets" aria-labelledby="markets-title">
 ...
 <div>
 <span class="eyebrow">Marknader i realtid</span>
...
<section class="sec" id="how" aria-labelledby="how-title">
 <div class="shell">
 <div class="sec-head"><span class="eyebrow">Så fungerar det</span><h2 id="how-title">Så fungerar det.</h2><p class="lede">Avanceret teknologi og en ægte menneskelig analytiker, der arbejder sammen i realtid for at hjælpe dig med at bygge en ny indtægtskilde — med vejledning ved hvert trin.</p></div>
...
<section class="sec-sm" id="payment" aria-labelledby="payment-title">
 ...
 <div class="pay"><svg class="fai" aria-hidden="true" viewBox="0 0 512 512"><use href="#i-building-columns"/></svg>Banköverföring</div>
...
<section class="sec" id="reviews" aria-labelledby="reviews-title">
 ...
 <div class="card"><p>„Min analytiker forklarede alt klart. Jeg satte mine mål én gang, og nu følger jeg præcis hvordan min kapital vokser — uden at blive nervøs ved hver bevægelse.“</p><div class="who"><div class="ini">A</div><div><b>Anna Andersson</b><span>Stockholm</span></div></div></div>
 <div class="card"><p>„Jeg havde aldrig investeret før — min analytiker klarede strategien og forklarede hvert trin. Ingen tomme løfter, intet pres, og udbetalingerne kommer som forventet.“</p><div class="who"><div class="ini">E</div><div><b>Erik Johansson</b><span>Göteborg</span></div></div></div>
 <div class="card"><p>„Jeg startede småt for at teste. Gennemsigtigheden og supporten gav mig tryghed til at bygge videre.“</p><div class="who"><div class="ini">S</div><div><b>Sofia Nilsson</b><span>Malmö</span></div></div></div>
 <div class="card"><p>„Analyserne kommer til mig — jeg godkender eller justerer på få minutter. Det passer perfekt ind i min hverdag uden at forstyrre arbejdet.“</p><div class="who"><div class="ini">L</div><div><b>Lars Eriksson</b><span>Uppsala</span></div></div></div>
 <div class="card"><p>„Det der overbeviste mig var gennemsigtigheden: hver beslutning forklares, og jeg ser ræsonnementet før noget sker.“</p><div class="who"><div class="ini">E</div><div><b>Emma Larsson</b><span>Västerås</span></div></div></div>
 <div class="card"><p>„Supporten er ægte og altid tilgængelig. Min første analyse var hands-on, og platformen har været stabil og forudsigelig siden.“</p><div class="who"><div class="ini">M</div><div><b>Mikael Olsson</b><span>Örebro</span></div></div></div>
 </div>
 </div>
</section>
...
<section class="sec" id="capabilities" aria-labelledby="capabilities-title">
 <div class="shell">
 <div class="sec-head"><span class="eyebrow">Rapportera missbruk</span><h2 id="capabilities-title">Vigtigste funktioner i korthed</h2></div>
 <div class="spec">
 <div class="spec-row">
...
<section class="sec" id="faq" aria-labelledby="faq-title">
 <div class="shell">
 <div class="sec-head" style="text-align:center;margin:0 auto"><span class="eyebrow">Spørgsmål</span><h2 id="faq-title">Vanliga frågor</h2></div>
...
<footer class="foot">
 ...
 <a href="#platform">Følg din konto i realtid</a><a href="#markets">Marknader i realtid</a><a href="#how">Så fungerar det.</a><a href="#faq">FAQ</a>
 </div></div>
 <div><h4>Företag</h4><div class="foot-links">
 ...
 <a href="<?= page_url('privacy.php') ?>">Integritet</a><a href="<?= page_url('conditions.php') ?>">Villkor</a><a href="<?= page_url('conditions.php') ?>">Risikooplysning</a><a href="<?= page_url('contacts.php') ?>">Riskinformation</a>
 </div></div>
 </div>
...
function money(n){n=+n;return n.toLocaleString('sv-SE',{maximumFractionDigits:n>=1000?0:(n>=1?2:4)})+' kr';}
...
<script>
(function () {
 var MSG_WAIT = "Vänta vänligen\u2026";
 var MSG_ERR = "Vi kunde inte skicka dina uppgifter just nu. F\u00f6rs\u00f6k igen.";
 var THANKS = "/thanks/";
...
(function () {
 ...
 initialCountry: (hid && hid.value) || 'se',
...
<span style="flex:1;min-width:200px">Vi använder cookies för att förbättra din upplevelse.</span>
<button type="button" id="ck-yes" style="cursor:pointer;background:var(--accent,#7c5cff);color:#fff;border:0;border-radius:999px;padding:9px 20px;font:inherit;font-weight:600;flex-shrink:0">Förstått</button>
