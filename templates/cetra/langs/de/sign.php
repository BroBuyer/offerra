...
$page_description = "Registrierung" . ' — ' . SITE_NAME;
...
<main>
  <section class="sec">
    <div class="shell" style="max-width:760px">
      <h1>Eröffnen Sie Ihr Konto</h1>
      <div class="lede" style="margin-top:18px">
        <?php $form_id="sign-form"; $form_heading="Starten Sie in wenigen Minuten"; $form_submit="Ich möchte starten"; require __DIR__."/includes/form.php"; ?>
      </div>
