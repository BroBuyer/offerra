...
$page_title = $page_title ?? page_title('KI und Echtzeit-Ausführung');
$page_description = $page_description ?? (SITE_NAME . ' — KI-Technologie, die Märkte analysiert und Orders in Echtzeit ausführt, mit einem persönlichen Analysten an Ihrer Seite.');
