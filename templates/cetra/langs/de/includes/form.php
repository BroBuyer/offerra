...
$form_submit = $form_submit ?? 'Kostenloses Konto erstellen';
...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__title">Bereits registriert</p>
    <p class="form-already-registered__text">
      Ihre Anfrage bei <?= e(SITE_NAME) ?> wurde empfangen. Bitte warten Sie auf den Anruf unseres Beraters.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <div class="form-grid">
      <label class="field" data-field="fname">
        ...
        <input class="input" type="text" name="fname" placeholder="Vorname" required pattern="[^\d]+" autocomplete="given-name">
      </label>
      <label class="field" data-field="lname">
        <span class="field-label">Nachname</span>
        <input class="input" type="text" name="lname" placeholder="Nachname" required pattern="[^\d]+" autocomplete="family-name">
      </label>
      <label class="field field-full" data-field="email">
        <span class="field-label">E-Mail</span>
        <input class="input" type="email" name="email" placeholder="E-Mail-Adresse" required autocomplete="email" inputmode="email">
      </label>
      <label class="field field-full" data-field="phone">
        <span class="field-label">Telefon</span>
        <input class="input" type="tel" name="fullphone" placeholder="1512 3456789" autocomplete="tel" inputmode="tel">
    ...
    <div class="pay-row" aria-label="Akzeptierte Zahlungsmethoden">
      ...
      <svg class="fai" role="img" aria-label="Banküberweisung" viewBox="0 0 512 512"><use href="#i-building-columns"/></svg>
      <svg class="fai pay-ok" role="img" aria-label="Sicher" viewBox="0 0 512 512"><use href="#i-shield-halved"/></svg>
    </div>
    ...
    <p class="lead-consent form-legal">
      Indem Sie fortfahren, akzeptieren Sie unsere Bedingungen und Datenschutzrichtlinie.
