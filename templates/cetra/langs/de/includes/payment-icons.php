...
$methods = [
    ...
    ['file' => 'banktransfer.svg','alt' => 'Banküberweisung e SEPA — aceites em ' . SITE_NAME],
];
?>
<div class="payment-icons<?= $payment_compact ? ' payment-icons--compact' : '' ?>" role="group" aria-label="Akzeptierte Zahlungsmethoden para <?= e($payment_context) ?>">
