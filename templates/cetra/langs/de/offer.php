...
$page_description = "Preise" . ' — ' . SITE_NAME;
...
<main>
  <section class="sec">
    <div class="shell" style="max-width:760px">
      <h1>Starten ab <?= e(MIN_DEPOSIT) ?> <?= e(CURRENCY) ?></h1>
      <div class="lede" style="margin-top:18px">
        <p>Voller Plattformzugang nach der Mindesteinzahlung. Keine versteckten Gebühren — Kosten werden transparent angezeigt.</p>
      </div>
