...
$page_description = "Registratie" . ' — ' . SITE_NAME;
  ...
  <section class="sec">
    <div class="shell" style="max-width:760px">
      ...
      <div class="lede" style="margin-top:18px">
        <?php $form_id="sign-form"; $form_heading="Begin in enkele minuten"; $form_submit="Ik wil beginnen"; require __DIR__."/includes/form.php"; ?>
      </div>
