...
$methods = [
    ...
    ['file' => 'banktransfer.svg','alt' => 'Bankoverschrijving e SEPA — aceites em ' . SITE_NAME],
];
?>
<div class="payment-icons<?= $payment_compact ? ' payment-icons--compact' : '' ?>" role="group" aria-label="Geaccepteerde betaalmethoden para <?= e($payment_context) ?>">
