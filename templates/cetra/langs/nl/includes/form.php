...
$form_submit = $form_submit ?? 'Gratis account aanmaken';
...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__title">Al geregistreerd</p>
    <p class="form-already-registered__text">
      Uw aanvraag bij <?= e(SITE_NAME) ?> is ontvangen. Wacht op een belletje van onze adviseur.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <div class="form-grid">
      <label class="field" data-field="fname">
        ...
        <input class="input" type="text" name="fname" placeholder="Voornaam" required pattern="[^\d]+" autocomplete="given-name">
      </label>
      <label class="field" data-field="lname">
        <span class="field-label">Achternaam</span>
        <input class="input" type="text" name="lname" placeholder="Achternaam" required pattern="[^\d]+" autocomplete="family-name">
      </label>
      ...
      <label class="field field-full" data-field="phone">
        ...
        <input class="input" type="tel" name="fullphone" placeholder="06 12345678" autocomplete="tel" inputmode="tel">
    ...
    <div class="pay-row" aria-label="Geaccepteerde betaalmethoden">
    ...
    <p class="lead-consent form-legal">
      Door verder te gaan accepteert u onze Voorwaarden en het Privacybeleid.
