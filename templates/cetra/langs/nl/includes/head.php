...
$page_title = $page_title ?? page_title('AI en uitvoering in realtime');
$page_description = $page_description ?? (SITE_NAME . ' — AI-technologie die markten analyseert en orders in realtime uitvoert, met een persoonlijke analist aan uw zijde.');
