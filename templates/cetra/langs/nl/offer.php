...
$page_description = "Prijzen" . ' — ' . SITE_NAME;
...
<main>
  <section class="sec">
    <div class="shell" style="max-width:760px">
      <h1>Begin vanaf <?= e(MIN_DEPOSIT) ?> <?= e(CURRENCY) ?></h1>
      <div class="lede" style="margin-top:18px">
        <p>Volledige platformtoegang na de minimale storting. Geen verborgen kosten — kosten worden transparant getoond.</p>
      </div>
