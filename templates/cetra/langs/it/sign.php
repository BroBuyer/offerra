...
$page_description = "Registrazione" . ' — ' . SITE_NAME;
...
<main>
  <section class="sec">
    <div class="shell" style="max-width:760px">
      <h1>Apri il tuo account</h1>
      <div class="lede" style="margin-top:18px">
        <?php $form_id="sign-form"; $form_heading="Inizia in pochi minuti"; $form_submit="Voglio iniziare"; require __DIR__."/includes/form.php"; ?>
      </div>
