...
$methods = [
    ...
    ['file' => 'banktransfer.svg','alt' => 'Bonifico bancario e SEPA — aceites em ' . SITE_NAME],
];
?>
<div class="payment-icons<?= $payment_compact ? ' payment-icons--compact' : '' ?>" role="group" aria-label="Metodi di pagamento accettati para <?= e($payment_context) ?>">
