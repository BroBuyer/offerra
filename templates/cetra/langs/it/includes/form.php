...
$form_submit = $form_submit ?? 'Crea un account gratuito';
...
<?php endif; ?>
    ...
    <div class="form-grid">
      ...
      <label class="field" data-field="lname">
        ...
        <input class="input" type="text" name="lname" placeholder="Cognome" required pattern="[^\d]+" autocomplete="family-name">
      </label>
      <label class="field field-full" data-field="email">
        <span class="field-label">E-mail</span>
        <input class="input" type="email" name="email" placeholder="Indirizzo e-mail" required autocomplete="email" inputmode="email">
      </label>
      <label class="field field-full" data-field="phone">
        <span class="field-label">Telefono</span>
        <input class="input" type="tel" name="fullphone" placeholder="312 345 6789" autocomplete="tel" inputmode="tel">
    ...
    <div class="pay-row" aria-label="Metodi di pagamento accettati">
