...
$page_description = "Prezzi" . ' — ' . SITE_NAME;
...
<main>
  <section class="sec">
    <div class="shell" style="max-width:760px">
      <h1>Inizia a partire da <?= e(MIN_DEPOSIT) ?> <?= e(CURRENCY) ?></h1>
      <div class="lede" style="margin-top:18px">
        <p>Accesso completo alla piattaforma dopo il deposito minimo. Senza costi nascosti — i costi sono mostrati con trasparenza.</p>
      </div>
