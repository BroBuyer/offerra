...
$page_description = "Prodotto" . ' — ' . SITE_NAME;
...
<main>
  <section class="sec">
    <div class="shell" style="max-width:760px">
      <h1><?= e(SITE_NAME) ?> — la piattaforma</h1>
      <div class="lede" style="margin-top:18px">
        <p>Motore di IA con analisi umana in tempo reale. Opera crypto, forex e azioni nello stesso pannello, con esecuzione rapida e capitale segregato.</p>
      </div>
