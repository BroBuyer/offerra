...
$page_title = $page_title ?? page_title('AI og udførelse i realtid');
$page_description = $page_description ?? (SITE_NAME . ' — AI-teknologi, der analyserer markeder og udfører ordrer i realtid, med en personlig analytiker ved din side.');
