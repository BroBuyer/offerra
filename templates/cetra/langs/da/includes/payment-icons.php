...
$methods = [
    ...
    ['file' => 'banktransfer.svg','alt' => 'Bankoverførsel e SEPA — aceites em ' . SITE_NAME],
];
?>
<div class="payment-icons<?= $payment_compact ? ' payment-icons--compact' : '' ?>" role="group" aria-label="Accepterede betalingsmetoder para <?= e($payment_context) ?>">
