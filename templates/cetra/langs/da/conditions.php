...
$page_title = page_title('Vilkår for brug');
$page_description = 'Reglerne der gælder, når du tilgår eller bruger ' . SITE_NAME . '.';
...
<main id="main">
  <section class="legal-hero">
    <div class="shell">
      ...
      <p class="lede">Reglerne der gælder, når du tilgår eller bruger <?= e(SITE_NAME) ?>.</p>
    </div>
  </section>
