...
$page_title = page_title('AI og udførelse i realtid | Officiel side');
$page_description = SITE_NAME . ' — AI-teknologi, der analyserer markeder og udfører ordrer i realtid, med en personlig analytiker ved din side for at opbygge en ny indtægtskilde.';
$page_canonical = page_url();
$active_page = 'home';
require __DIR__ . '/includes/head.php';
?>
<a class="skip-link" href="#top">Spring til indhold</a><style>.skip-link{position:absolute;left:-9999px;top:0;z-index:1000;background:#111;color:#fff;padding:.6rem 1rem;border-radius:0 0 .4rem 0}.skip-link:focus{left:0}</style>
...
<header class="site-head">
 ...
 <a href="#markets">Markeder i realtid</a>
 <a href="#faq">FAQ</a>
 </nav>
 <div class="nav-cta">
 <a class="btn btn-primary" href="#signup">Åbn din konto</a>
 <button class="nav-toggle" aria-label="Åbn menu" aria-expanded="false" aria-controls="navLinks" type="button">
...
<section class="hero" id="hero" aria-labelledby="hero-title">
 ...
 <div class="hero-cta">
 <a class="btn btn-primary" href="#hero-form">Start nu — <?= e(MIN_DEPOSIT) ?> <?= e(CURRENCY) ?> min.</a>
 </div>
 </div>
 <div class="lead" id="hero-form">
 <h2 id="hero-title">Åbn din konto</h2>
 <p class="sub">Kom i gang på få minutter.</p>
 <?php
  $form_id = 'hero-form';
  $form_heading = null;
  $form_subtitle = null;
  $form_submit = 'Jeg vil gerne starte';
...
<section class="sec" id="platform" aria-labelledby="platform-title">
 ...
 <h2 id="platform-title">Følg din konto i realtid</h2>
 ...
 <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 6L9 17l-5-5"/></svg><span>Candlestick-grafer og dybde i realtid på enhver enhed</span></li>
 ...
 <a class="btn btn-primary" href="#hero-form" style="margin-top:26px">Start nu</a>
 </div>
 ...
 <figcaption class="phone-cap"><?= e(SITE_NAME) ?> — mobil handel med kryptografer i realtid</figcaption>
 </figure>
 </div>
</section>
...
<section class="sec" id="features" aria-labelledby="features-title">
 <div class="shell">
 <div class="sec-head"><span class="eyebrow">Platformen</span><h2 id="features-title">Alt du behøver på én hurtig platform.</h2><p class="lede">Ingen grafer at overvåge, ingen ordrer at time. Motoren i <?= e(SITE_NAME) ?> overvåger ordrebøger i realtid på kryptobørser, globale aktie-API'er og de vigtigste forex-par — og afgiver ordrer i det øjeblik modellerne finder et gunstigt setup.</p></div>
...
<section class="sec" id="markets" aria-labelledby="markets-title">
 ...
 <div>
 <span class="eyebrow">Markeder i realtid</span>
 <h2 id="markets-title">Handl Bitcoin, Ethereum og mere</h2>
 <p class="lede">Priser i realtid, avancerede indikatorer og et professionelt overblik over de markeder der betyder noget for dig.</p>
...
<section class="sec" id="how" aria-labelledby="how-title">
 <div class="shell">
 <div class="sec-head"><span class="eyebrow">Sådan virker det</span><h2 id="how-title">Sådan virker det.</h2><p class="lede">Avanceret teknologi og en ægte menneskelig analytiker, der arbejder sammen i realtid for at hjælpe dig med at bygge en ny indtægtskilde — med vejledning ved hvert trin.</p></div>
 <div class="steps" style="margin-top:36px">
 <div class="step"><div class="n">1</div><h3>Opret din konto</h3><p>Tilmeld dig på få minutter med kun din e-mail.</p></div>
 <div class="step"><div class="n">2</div><h3>Bekræft din e-mail</h3><p>Bekræft din adresse for at beskytte din konto.</p></div>
 <div class="step"><div class="n">3</div><h3>Indbetal på din konto</h3><p>Tilføj midler fra <?= e(MIN_DEPOSIT) ?> <?= e(CURRENCY) ?> på din måde.</p></div>
...
<section class="sec-sm" id="payment" aria-labelledby="payment-title">
 <div class="shell">
 <div class="sec-head"><span class="eyebrow">Indbetalinger</span><h2 id="payment-title">Indbetal med metoder du allerede kender</h2><p class="lede">Indbetal og hæv via sikre, velkendte kanaler — uden skjulte gebyrer.</p></div>
 <div class="pay-list">
 ...
 <div class="pay"><svg class="fai" aria-hidden="true" viewBox="0 0 512 512"><use href="#i-building-columns"/></svg>Bankoverførsel</div>
...
<section class="sec" id="reviews" aria-labelledby="reviews-title">
 <div class="shell">
 <div class="sec-head"><span class="eyebrow">Hvad medlemmerne siger</span><h2 id="reviews-title">Hvad vores investorer siger</h2></div>
 <div class="grid testi" style="margin-top:36px">
 <div class="card"><p>„Min analytiker forklarede alt klart. Jeg satte mine mål én gang, og nu følger jeg præcis hvordan min kapital vokser — uden at blive nervøs ved hver bevægelse.“</p><div class="who"><div class="ini">A</div><div><b>Anna Nielsen</b><span>København</span></div></div></div>
 <div class="card"><p>„Jeg havde aldrig investeret før — min analytiker klarede strategien og forklarede hvert trin. Ingen tomme løfter, intet pres, og udbetalingerne kommer som forventet.“</p><div class="who"><div class="ini">T</div><div><b>Thomas Jensen</b><span>Aarhus</span></div></div></div>
 <div class="card"><p>„Jeg startede småt for at teste. Gennemsigtigheden og supporten gav mig tryghed til at bygge videre.“</p><div class="who"><div class="ini">S</div><div><b>Sofie Hansen</b><span>Odense</span></div></div></div>
 <div class="card"><p>„Analyserne kommer til mig — jeg godkender eller justerer på få minutter. Det passer perfekt ind i min hverdag uden at forstyrre arbejdet.“</p><div class="who"><div class="ini">L</div><div><b>Lars Pedersen</b><span>Aalborg</span></div></div></div>
 <div class="card"><p>„Det der overbeviste mig var gennemsigtigheden: hver beslutning forklares, og jeg ser ræsonnementet før noget sker.“</p><div class="who"><div class="ini">E</div><div><b>Emma Andersen</b><span>Esbjerg</span></div></div></div>
 <div class="card"><p>„Supporten er ægte og altid tilgængelig. Min første analyse var hands-on, og platformen har været stabil og forudsigelig siden.“</p><div class="who"><div class="ini">M</div><div><b>Mikkel Christensen</b><span>Randers</span></div></div></div>
 </div>
 </div>
</section>
...
<section class="sec" id="capabilities" aria-labelledby="capabilities-title">
 <div class="shell">
 <div class="sec-head"><span class="eyebrow">Platform</span><h2 id="capabilities-title">Vigtigste funktioner i korthed</h2></div>
 <div class="spec">
 <div class="spec-row">
 ...
 <div class="spec-row">
 <div class="spec-k">Indbetalingsmetoder</div>
...
<section class="sec" id="faq" aria-labelledby="faq-title">
 <div class="shell">
 <div class="sec-head" style="text-align:center;margin:0 auto"><span class="eyebrow">Spørgsmål</span><h2 id="faq-title">Ofte stillede spørgsmål.</h2></div>
 <div class="faq" style="margin-top:34px">
 <details open><summary>Hvad er minimumsindbetalingen?</summary><p>Åbn og finansier din konto fra minimumsindbetalingen. Du kan tilføje saldo undervejs i takt med at din plan skrider frem.</p></details>
 ...
 <details><summary>Er mine penge sikre?</summary><p>Konti er beskyttet med branchesikkerhed og grundig verifikation. Som ved enhver investering er din kapital i risiko, og værdier kan falde såvel som stige.</p></details>
 <details><summary>Hvor hurtigt kan jeg starte?</summary><p>De fleste medlemmer afslutter registreringen på få minutter. Når din første indbetaling er bekræftet, aktiveres en plan med det samme.</p></details>
 ...
 <details><summary>Hvilke betalingsmetoder understøttes?</summary><p>Almindelige metoder som debit- og kreditkort, bankoverførsel, udvalgte e-wallets og kryptovalutaer understøttes. De præcise muligheder vises ved indbetalingstrinnet.</p></details>
 ...
 <details><summary>Er platformen reguleret?</summary><p>Ja — den opfylder nationale finansielle og cybersikkerhedsstandarder med kontobeskyttelse og grundig verifikation indbygget.</p></details>
...
<footer class="foot">
 ...
 <a href="#platform">Følg din konto i realtid</a><a href="#markets">Markeder i realtid</a><a href="#how">Sådan virker det.</a><a href="#faq">FAQ</a>
 </div></div>
 <div><h4>Virksomhed</h4><div class="foot-links">
 <a href="<?= page_url('product.php') ?>">Om os</a><a href="<?= page_url('offer.php') ?>">Priser</a><a href="<?= page_url('contacts.php') ?>">Kontakt</a>
 </div></div>
 <div><h4>Legal</h4><div class="foot-links">
 <a href="<?= page_url('privacy.php') ?>">Privatliv</a><a href="<?= page_url('conditions.php') ?>">Vilkår</a><a href="<?= page_url('conditions.php') ?>">Risikooplysning</a><a href="<?= page_url('contacts.php') ?>">Anmeld misbrug</a>
 </div></div>
 </div>
...
function money(n){n=+n;return n.toLocaleString('da-DK',{maximumFractionDigits:n>=1000?0:(n>=1?2:4)})+' kr';}
...
<script>
(function () {
 var MSG_WAIT = "Vent venligst\u2026";
 var MSG_ERR = "Vi kunne ikke sende dine oplysninger lige nu. Pr\u00f8v igen.";
 var THANKS = "/thanks/";
...
(function () {
 ...
 initialCountry: (hid && hid.value) || 'dk',
...
<span style="flex:1;min-width:200px">Vi bruger cookies for at forbedre din oplevelse.</span>
