...
$methods = [
    ...
    ['file' => 'banktransfer.svg','alt' => '銀行振込 e SEPA — aceites em ' . SITE_NAME],
];
?>
<div class="payment-icons<?= $payment_compact ? ' payment-icons--compact' : '' ?>" role="group" aria-label="ご利用いただける支払い方法 para <?= e($payment_context) ?>">
