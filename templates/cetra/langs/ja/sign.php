...
$page_title = page_title_lead("登録");
$page_description = "登録" . ' — ' . SITE_NAME;
  ...
  <section class="sec">
    <div class="shell" style="max-width:760px">
      ...
      <div class="lede" style="margin-top:18px">
        <?php $form_id="sign-form"; $form_heading="数分で始められます"; $form_submit="今すぐ始める"; require __DIR__."/includes/form.php"; ?>
      </div>
