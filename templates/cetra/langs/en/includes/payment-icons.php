...
$methods = [
    ...
    ['file' => 'banktransfer.svg','alt' => 'Bank transfer e SEPA — aceites em ' . SITE_NAME],
];
?>
<div class="payment-icons<?= $payment_compact ? ' payment-icons--compact' : '' ?>" role="group" aria-label="Accepted payment methods para <?= e($payment_context) ?>">
