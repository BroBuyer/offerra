...
$form_submit = $form_submit ?? 'Create a free account';
...
<?php endif; ?>
    ...
    <div class="form-grid">
      <label class="field" data-field="fname">
        ...
        <input class="input" type="text" name="fname" placeholder="First name" required pattern="[^\d]+" autocomplete="given-name">
      </label>
      <label class="field" data-field="lname">
        <span class="field-label">Last name</span>
        <input class="input" type="text" name="lname" placeholder="Last name" required pattern="[^\d]+" autocomplete="family-name">
      </label>
