...
$page_title = $page_title ?? page_title('AI and real-time execution');
$page_description = $page_description ?? (SITE_NAME . ' — AI technology that analyses markets and executes orders in real time, with a personal analyst by your side.');
