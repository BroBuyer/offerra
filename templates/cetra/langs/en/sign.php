...
$page_description = "Sign-up" . ' — ' . SITE_NAME;
  ...
  <section class="sec">
    <div class="shell" style="max-width:760px">
      ...
      <div class="lede" style="margin-top:18px">
        <?php $form_id="sign-form"; $form_heading="Get started in a few minutes"; $form_submit="I want to start"; require __DIR__."/includes/form.php"; ?>
      </div>
