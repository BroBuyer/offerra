...
<main>
  <section class="sec">
    <div class="shell" style="max-width:760px">
      <h1><?= e(SITE_NAME) ?> — the platform</h1>
      <div class="lede" style="margin-top:18px">
        <p>AI engine with real-time human analysis. Trade crypto, forex and stocks in the same dashboard, with fast execution and segregated capital.</p>
      </div>
