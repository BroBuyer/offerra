...
$page_description = "Tarifs" . ' — ' . SITE_NAME;
...
<main>
  <section class="sec">
    <div class="shell" style="max-width:760px">
      <h1>Commencez à partir de <?= e(MIN_DEPOSIT) ?> <?= e(CURRENCY) ?></h1>
      <div class="lede" style="margin-top:18px">
        <p>Accès complet à la plateforme après le dépôt minimum. Sans frais cachés — les coûts sont affichés en toute transparence.</p>
      </div>
