...
$page_description = "Merci" . ' — ' . SITE_NAME;
  ...
  <section class="sec">
    <div class="shell" style="max-width:760px">
      ...
      <div class="lede" style="margin-top:18px">
        <p>Merci de vous être inscrit(e) sur <?= e(SITE_NAME) ?>. Notre équipe vous contactera bientôt — gardez votre téléphone à proximité.</p>
      </div>
