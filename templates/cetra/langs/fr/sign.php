...
$page_description = "Inscription" . ' — ' . SITE_NAME;
...
<main>
  <section class="sec">
    <div class="shell" style="max-width:760px">
      <h1>Ouvrez votre compte</h1>
      <div class="lede" style="margin-top:18px">
        <?php $form_id="sign-form"; $form_heading="Commencez en quelques minutes"; $form_submit="Je veux commencer"; require __DIR__."/includes/form.php"; ?>
      </div>
