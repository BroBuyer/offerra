...
$page_title = $page_title ?? page_title('IA et exécution en temps réel');
$page_description = $page_description ?? (SITE_NAME . ' — une technologie d’IA qui analyse les marchés et exécute des ordres en temps réel, avec un analyste personnel à vos côtés.');
