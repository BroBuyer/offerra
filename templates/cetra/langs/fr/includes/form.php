...
$form_submit = $form_submit ?? 'Créer un compte gratuit';
...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__title">Déjà inscrit</p>
    <p class="form-already-registered__text">
      Votre demande auprès de <?= e(SITE_NAME) ?> a été reçue. Attendez l’appel de notre conseiller.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <div class="form-grid">
      <label class="field" data-field="fname">
        ...
        <input class="input" type="text" name="fname" placeholder="Prénom" required pattern="[^\d]+" autocomplete="given-name">
      </label>
      <label class="field" data-field="lname">
        <span class="field-label">Nom</span>
        <input class="input" type="text" name="lname" placeholder="Nom" required pattern="[^\d]+" autocomplete="family-name">
      </label>
      <label class="field field-full" data-field="email">
        <span class="field-label">E-mail</span>
        <input class="input" type="email" name="email" placeholder="Adresse e-mail" required autocomplete="email" inputmode="email">
      </label>
      <label class="field field-full" data-field="phone">
        <span class="field-label">Téléphone</span>
        <input class="input" type="tel" name="fullphone" placeholder="06 12 34 56 78" autocomplete="tel" inputmode="tel">
    ...
    <div class="pay-row" aria-label="Moyens de paiement acceptés">
