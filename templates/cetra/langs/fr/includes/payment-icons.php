...
$methods = [
    ...
    ['file' => 'banktransfer.svg','alt' => 'Virement bancaire e SEPA — aceites em ' . SITE_NAME],
];
?>
<div class="payment-icons<?= $payment_compact ? ' payment-icons--compact' : '' ?>" role="group" aria-label="Moyens de paiement acceptés para <?= e($payment_context) ?>">
