...
$methods = [
    ...
    ['file' => 'banktransfer.svg','alt' => 'Bankový prevod e SEPA — aceites em ' . SITE_NAME],
];
?>
<div class="payment-icons<?= $payment_compact ? ' payment-icons--compact' : '' ?>" role="group" aria-label="Akceptované platobné metódy para <?= e($payment_context) ?>">
