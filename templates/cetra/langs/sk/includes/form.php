...
$form_submit = $form_submit ?? 'Vytvoriť bezplatný účet';
...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__title">Už registrovaný</p>
    <p class="form-already-registered__text">
      Vaša žiadosť u <?= e(SITE_NAME) ?> bola prijatá. Počkajte na hovor od nášho poradcu.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <div class="form-grid">
      <label class="field" data-field="fname">
        ...
        <input class="input" type="text" name="fname" placeholder="Meno" required pattern="[^\d]+" autocomplete="given-name">
      </label>
      <label class="field" data-field="lname">
        <span class="field-label">Priezvisko</span>
        <input class="input" type="text" name="lname" placeholder="Priezvisko" required pattern="[^\d]+" autocomplete="family-name">
      </label>
      ...
      <label class="field field-full" data-field="phone">
        ...
        <input class="input" type="tel" name="fullphone" placeholder="912 123 456" autocomplete="tel" inputmode="tel">
    ...
    <div class="pay-row" aria-label="Akceptované platobné metódy">
      ...
      <svg class="fai" role="img" aria-label="Bankový prevod" viewBox="0 0 512 512"><use href="#i-building-columns"/></svg>
      <svg class="fai pay-ok" role="img" aria-label="Bezpečné" viewBox="0 0 512 512"><use href="#i-shield-halved"/></svg>
    </div>
    ...
    <p class="lead-consent form-legal">
      Pokračovaním prijímate naše Podmienky a Zásady ochrany súkromia.
