...
$page_title = $page_title ?? page_title('AI a vykonávanie v reálnom čase');
$page_description = $page_description ?? (SITE_NAME . ' — AI technológia, ktorá analyzuje trhy a vykonáva príkazy v reálnom čase, s osobným analytikom po vašom boku.');
