...
$page_description = "Registrácia" . ' — ' . SITE_NAME;
...
<main>
  <section class="sec">
    <div class="shell" style="max-width:760px">
      <h1>Otvorte si účet</h1>
      <div class="lede" style="margin-top:18px">
        <?php $form_id="sign-form"; $form_heading="Začnite v priebehu niekoľkých minút"; $form_submit="Chcem začať"; require __DIR__."/includes/form.php"; ?>
      </div>
