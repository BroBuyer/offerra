...
$page_title = $page_title ?? page_title('IA y ejecución en tiempo real');
$page_description = $page_description ?? (SITE_NAME . ' — tecnología de IA que analiza mercados y ejecuta órdenes en tiempo real, con un analista personal a tu lado.');
