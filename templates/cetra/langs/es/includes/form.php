...
$form_submit = $form_submit ?? 'Crear una cuenta gratis';
...
<?php endif; ?>
    ...
    <div class="form-grid">
      <label class="field" data-field="fname">
        ...
        <input class="input" type="text" name="fname" placeholder="Nombre" required pattern="[^\d]+" autocomplete="given-name">
      </label>
      <label class="field" data-field="lname">
        <span class="field-label">Apellido</span>
        <input class="input" type="text" name="lname" placeholder="Apellido" required pattern="[^\d]+" autocomplete="family-name">
      </label>
      <label class="field field-full" data-field="email">
        <span class="field-label">Correo electrónico</span>
        <input class="input" type="email" name="email" placeholder="Correo electrónico" required autocomplete="email" inputmode="email">
      </label>
      <label class="field field-full" data-field="phone">
        <span class="field-label">Teléfono</span>
        <input class="input" type="tel" name="fullphone" placeholder="612 34 56 78" autocomplete="tel" inputmode="tel">
    ...
    <div class="pay-row" aria-label="Métodos de pago aceptados">
    ...
    <p class="lead-consent form-legal">
      ...
      &amp;
      <a href="<?= page_url('conditions.php') ?>">Términos de uso</a>.
    </p>
  </div>
</form>
<?php
