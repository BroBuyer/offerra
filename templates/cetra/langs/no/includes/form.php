...
$form_submit = $form_submit ?? 'Opprett en gratis konto';
...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__title">Allerede registrert</p>
    <p class="form-already-registered__text">
      Din forespørsel hos <?= e(SITE_NAME) ?> er mottatt. Vent på en samtale fra vår rådgiver.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <div class="form-grid">
      ...
      <label class="field" data-field="lname">
        ...
        <input class="input" type="text" name="lname" placeholder="Etternavn" required pattern="[^\d]+" autocomplete="family-name">
      </label>
      ...
      <label class="field field-full" data-field="phone">
        ...
        <input class="input" type="tel" name="fullphone" placeholder="406 12 345" autocomplete="tel" inputmode="tel">
    ...
    <div class="pay-row" aria-label="Aksepterte betalingsmetoder">
      ...
      <svg class="fai" role="img" aria-label="Bankoverføring" viewBox="0 0 512 512"><use href="#i-building-columns"/></svg>
    ...
    <p class="lead-consent form-legal">
      Ved å fortsette godtar du våre vilkår og personvernpolicy.
      <a href="<?= page_url('privacy.php') ?>">Personvern</a>
      &amp;
      <a href="<?= page_url('conditions.php') ?>">Vilkår for bruk</a>.
    </p>
  </div>
</form>
<?php
