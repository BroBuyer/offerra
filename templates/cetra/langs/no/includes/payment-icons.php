...
$methods = [
    ...
    ['file' => 'banktransfer.svg','alt' => 'Bankoverføring e SEPA — aceites em ' . SITE_NAME],
];
?>
<div class="payment-icons<?= $payment_compact ? ' payment-icons--compact' : '' ?>" role="group" aria-label="Aksepterte betalingsmetoder para <?= e($payment_context) ?>">
