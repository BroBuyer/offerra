...
$page_title = $page_title ?? page_title('AI og utførelse i sanntid');
$page_description = $page_description ?? (SITE_NAME . ' — AI-teknologi som analyserer markeder og utfører ordrer i sanntid, med en personlig analytiker ved din side.');
