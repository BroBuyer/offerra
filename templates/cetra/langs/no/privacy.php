...
$page_title = page_title('Personvernpolicy');
$page_description = 'Hvordan ' . SITE_NAME . ' samler inn, bruker og beskytter personopplysningene dine.';
...
<header class="site-head">
  <div class="shell nav">
    ...
    <nav class="nav-links" aria-label="Hoved">
      <a href="<?= page_url() ?>#platform">Rapporter misbruk</a>
      <a href="<?= page_url() ?>#how">Sådan virker det</a>
      <a href="<?= page_url() ?>#markets">Markeder</a>
      <a href="<?= page_url() ?>#faq">Ofte stillede spørgsmål</a>
    </nav>
    <div class="nav-cta">
      <a class="btn btn-primary" href="<?= page_url() ?>#signup">Kom i gang</a>
    </div>
  </div>
</header>
...
<main id="main">
  <section class="legal-hero">
    <div class="shell">
      ...
      <p class="lede">Hvordan <?= e(SITE_NAME) ?> samler inn, bruker og beskytter personopplysningene dine.</p>
    </div>
  </section>
  ...
  <section class="legal-body">
    <div class="shell">
      ...
      <p><?= e(SITE_NAME) ?> („vi“, „vores“) er forpligtet til at beskytte privatlivet for besøgende og kunder. Denne privatlivspolitik forklarer hvilke personoplysninger vi indsamler, hvorfor og hvordan vi behandler dem, når du bruger vår website og tjenester.</p>
      ...
      <ul>
        ...
        <li>Til at levere, vedligeholde og forbedre vår platform og tjenester.</li>
        <li>Til at behandle betalinger og opdage svigagtig aktivitet.</li>
        <li>Til at kommunikere med deg om din konto, opdateringer og supportanmodninger.</li>
        <li>Til at sende markedsføringskommunikation når du har givet samtykke (du kan framelde deg når som helst).</li>
      </ul>

      <h2>4. Retsgrundlag</h2>
      <p>Vi behandler personoplysninger på grundlag af et eller flere af følgende lovlige grundlag: opfyldelse af en kontrakt, overholdelse af en retlig forpligtelse, vår legitime interesser eller dit samtykke.</p>
      ...
      <h2>12. Kontakt</h2>
      <p>Ved privatlivsspørgsmål eller for at udøve dine rettigheder skal du kontakte <?= e(SITE_NAME) ?>'s databeskyttelsesteam via vår <a href="<?= page_url('contacts.php') ?>">kontaktside</a>.</p>
...
<footer class="foot">
  <div class="shell">
    <div class="foot-bottom" style="margin-top:0;border-top:none;padding-top:0">
      © <?= date('Y') ?> <?= e(SITE_NAME) ?>. Ofte stilte spørsmål. ·
      <a href="<?= page_url('privacy.php') ?>">Personvern</a> ·
      <a href="<?= page_url('conditions.php') ?>">Vilkår</a>
    </div>
  </div>
</footer>
