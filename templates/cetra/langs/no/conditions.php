...
$page_title = page_title('Vilkår for bruk');
$page_description = 'Reglene som gjelder når du åpner eller bruker ' . SITE_NAME . '.';
...
<main id="main">
  <section class="legal-hero">
    <div class="shell">
      ...
      <p class="lede">Reglene som gjelder når du åpner eller bruker <?= e(SITE_NAME) ?>.</p>
    </div>
  </section>
  ...
  <section class="legal-body">
    <div class="shell">
      ...
      <h2>15. Kontakt</h2>
      <p>Spørgsmål om disse vilkår kan sendes via vår <a href="<?= page_url('contacts.php') ?>">kontaktside</a>.</p>
