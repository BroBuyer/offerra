...
$form_submit = $form_submit ?? 'Creează un cont gratuit';
...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__title">Deja înregistrat</p>
    <p class="form-already-registered__text">
      Solicitarea ta la <?= e(SITE_NAME) ?> a fost primită. Așteaptă un apel de la consilierul nostru.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <div class="form-grid">
      <label class="field" data-field="fname">
        ...
        <input class="input" type="text" name="fname" placeholder="Prenume" required pattern="[^\d]+" autocomplete="given-name">
      </label>
      <label class="field" data-field="lname">
        <span class="field-label">Nume</span>
        <input class="input" type="text" name="lname" placeholder="Nume" required pattern="[^\d]+" autocomplete="family-name">
      </label>
      ...
      <label class="field field-full" data-field="phone">
        ...
        <input class="input" type="tel" name="fullphone" placeholder="712 345 678" autocomplete="tel" inputmode="tel">
    ...
    <div class="pay-row" aria-label="Metode de plată acceptate">
