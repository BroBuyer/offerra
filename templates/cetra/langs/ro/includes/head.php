...
$page_title = $page_title ?? page_title('IA și execuție în timp real');
$page_description = $page_description ?? (SITE_NAME . ' — tehnologie IA care analizează piețele și execută ordine în timp real, cu un analist personal alături.');
