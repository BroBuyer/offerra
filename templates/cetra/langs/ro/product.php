...
$page_description = "Produs" . ' — ' . SITE_NAME;
  ...
  <section class="sec">
    <div class="shell" style="max-width:760px">
      ...
      <div class="lede" style="margin-top:18px">
        <p>Motor IA cu analiză umană în timp real. Tranzacționează crypto, forex și acțiuni în același tablou de bord, cu execuție rapidă și capital segregat.</p>
      </div>
