...
$page_description = "Înregistrare" . ' — ' . SITE_NAME;
...
<main>
  <section class="sec">
    <div class="shell" style="max-width:760px">
      <h1>Deschide-ți contul</h1>
      <div class="lede" style="margin-top:18px">
        <?php $form_id="sign-form"; $form_heading="Începe în câteva minute"; $form_submit="Vreau să încep"; require __DIR__."/includes/form.php"; ?>
      </div>
