...
$page_description = "Cenas" . ' — ' . SITE_NAME;
...
<main>
  <section class="sec">
    <div class="shell" style="max-width:760px">
      <h1>Sāciet no <?= e(MIN_DEPOSIT) ?> <?= e(CURRENCY) ?></h1>
      <div class="lede" style="margin-top:18px">
        <p>Pilna platformas piekļuve pēc minimālās iemaksas. Bez slēptām komisijām — izmaksas tiek rādītas caurspīdīgi.</p>
      </div>
