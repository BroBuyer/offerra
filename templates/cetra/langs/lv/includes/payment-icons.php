...
$methods = [
    ...
    ['file' => 'banktransfer.svg','alt' => 'Bankas pārskaitījums e SEPA — aceites em ' . SITE_NAME],
];
?>
<div class="payment-icons<?= $payment_compact ? ' payment-icons--compact' : '' ?>" role="group" aria-label="Pieņemtie maksājumu veidi para <?= e($payment_context) ?>">
