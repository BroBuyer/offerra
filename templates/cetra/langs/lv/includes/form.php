...
$form_submit = $form_submit ?? 'Izveidot bezmaksas kontu';
...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__title">Jau reģistrēts</p>
    <p class="form-already-registered__text">
      Jūsu pieprasījums ar <?= e(SITE_NAME) ?> ir saņemts. Lūdzu, gaidiet zvanu no mūsu pārvaldnieka.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <div class="form-grid">
      <label class="field" data-field="fname">
        <span class="field-label">Vārds</span>
        <input class="input" type="text" name="fname" placeholder="Vārds" required pattern="[^\d]+" autocomplete="given-name">
      </label>
      <label class="field" data-field="lname">
        <span class="field-label">Uzvārds</span>
        <input class="input" type="text" name="lname" placeholder="Uzvārds" required pattern="[^\d]+" autocomplete="family-name">
      </label>
      <label class="field field-full" data-field="email">
        <span class="field-label">E-pasts</span>
        <input class="input" type="email" name="email" placeholder="E-pasta adrese" required autocomplete="email" inputmode="email">
      </label>
      <label class="field field-full" data-field="phone">
        <span class="field-label">Tālrunis</span>
        <input class="input" type="tel" name="fullphone" placeholder="21 234 567" autocomplete="tel" inputmode="tel">
    ...
    <div class="pay-row" aria-label="Pieņemtie maksājumu veidi">
    ...
    <p class="lead-consent form-legal">
      Turpinot, jūs piekrītat mūsu Lietošanas noteikumiem un Privātuma politikai.
