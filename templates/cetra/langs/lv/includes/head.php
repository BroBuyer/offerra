...
$page_title = $page_title ?? page_title('MI un izpilde reāllaikā');
$page_description = $page_description ?? (SITE_NAME . ' — MI tehnoloģija, kas analizē tirgus un izpilda rīkojumus reāllaikā, ar personīgo analītiķi jūsu pusē.');
