...
$page_title = page_title_lead("Produkts");
$page_description = "Produkts" . ' — ' . SITE_NAME;
  ...
  <section class="sec">
    <div class="shell" style="max-width:760px">
      ...
      <div class="lede" style="margin-top:18px">
        <p>MI dzinējs ar cilvēka analīzi reāllaikā. Tirgojiet kriptovalūtas, forex un akcijas vienā panelī ar ātru izpildi un segregētu kapitālu.</p>
      </div>
