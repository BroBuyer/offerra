...
$page_description = "Reģistrācija" . ' — ' . SITE_NAME;
...
<main>
  <section class="sec">
    <div class="shell" style="max-width:760px">
      <h1>Atveriet savu kontu</h1>
      <div class="lede" style="margin-top:18px">
        <?php $form_id="sign-form"; $form_heading="Sāciet dažu minūšu laikā"; $form_submit="Sākt tagad"; require __DIR__."/includes/form.php"; ?>
      </div>
