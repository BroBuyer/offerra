...
$page_title = $page_title ?? SITE_NAME . ' | Markkinaterminaali';
$page_description = $page_description ?? 'Käy kauppaa kryptolla, valuutoilla ja muilla markkinoilla ' . SITE_NAME . '-palvelussa — live-terminaalinäkymä, tekoälyä hyödyntävät signaalit ja selkeä rahoitus.';
