...
<footer class="site-footer">
  <div class="container">
    ...
    <div class="footer-risk">
      <p>
        <?= e(SITE_NAME) ?> ei ole vastuussa mistään tappioista tai vahingoista, jotka aiheutuvat tämän sivuston tietojen käytöstä.
        Kaupankäynti rahoitusmarkkinoilla sisältää riskin. Sijoita vain varoja, joiden menettämisen voit kestää. Valuutat, CFD:t ja kryptovaluutat
        eivät välttämättä sovi kaikille sijoittajille. Harkitse pätevän ammattilaisen neuvontaa ennen kaupankäyntiä.
      </p>
    </div>
