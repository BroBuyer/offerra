...
$page_description = 'Luo ' . SITE_NAME . '-tilisi ja aloita kaupankäynti kryptolla, valuutoilla ja muilla markkinoilla.';
...
<main>
  <section class="page-hero">
    <div class="container">
      ...
      <p class="lead">Vähimmäistalletus <?= MIN_DEPOSIT ?> <?= CURRENCY ?>. Live-markkinat vahvistuksen jälkeen.</p>
    </div>
  </section>
