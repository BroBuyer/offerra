...
{
    return SITE_NAME . ' obchodní platforma v mobilu — živý graf BTC/USDT, kniha příkazů a rozhraní nákup/prodej';
}

function platform_image_caption(): string
{
    return SITE_NAME . ' — mobilní obchodování s kryptografy v reálném čase';
}
