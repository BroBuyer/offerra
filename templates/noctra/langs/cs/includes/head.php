...
$page_title = $page_title ?? SITE_NAME . ' | AI obchodní terminál';
$page_description = $page_description ?? 'Obchodujte kryptoměny, forex a další trhy na ' . SITE_NAME . ' — přehledné ceny, AI nástroje a bezpečný účet.';
