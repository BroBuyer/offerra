...
<footer class="site-footer">
  <div class="container">
    ...
    <div class="footer-risk">
      <p>
        <?= e(SITE_NAME) ?> bu sitedeki bilgilerin kullanımından doğan kayıp veya zararlardan sorumlu değildir.
        Finansal piyasalarda işlem yapmak risk içerir. Yalnızca kaybetmeyi göze alabileceğiniz fonları yatırın. Döviz, CFD'ler ve kripto paralar
        her yatırımcı için uygun olmayabilir. İşlem yapmadan önce nitelikli bir uzmana danışmayı düşünün.
      </p>
    </div>
