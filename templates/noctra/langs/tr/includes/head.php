...
$page_title = $page_title ?? SITE_NAME . ' | AI piyasa terminali';
$page_description = $page_description ?? '' . SITE_NAME . ' üzerinde kripto, forex ve diğer piyasalarda işlem yapın — net fiyatlar, AI araçları ve güvenli hesap.';
