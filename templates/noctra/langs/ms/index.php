...
$page_title = page_title('AI Platform dagangan');
...
<main>
  ...
  <section class="hero-terminal">
    <div class="container hero-terminal-grid">
      <div>
        <div class="hero-kicker"><span class="dot" aria-hidden="true"></span> AI-powered platform dagangan</div>
  ...
  <section class="section" id="features">
    <div class="container">
      <div class="section-header">
        <p class="eyebrow">Ciri</p>
        <h2>What you get with <?= e(SITE_NAME) ?></h2>
        <p class="lead">Keselamatan, speed, and clear tools — without a crowded screen.</p>
      </div>
    ...
    <div class="container">
      ...
      <div class="timeline">
        <article class="timeline-step">
          ...
          <div>
            <h3>Buka akaun</h3>
            <p>Hantar your details and get secure access to the platform.</p>
          </div>
        </article>
        <article class="timeline-step">
        ...
        <article class="timeline-step">
          ...
          <div>
            <h3>Trade live</h3>
            <p>Use charts, tools, and Sokongan 24/7 whenever you need help.</p>
          </div>
        </article>
      </div>

      <div style="text-align: center; margin-top: 2rem;">
        <a href="sign.php" class="btn btn-primary">Mula sekarang</a>
      </div>
    </div>
  </section>
    ...
    <div class="container" style="max-width: 800px; margin-inline: auto;">
      ...
      <div class="faq-list" data-faq>
        ...
        <div class="faq-item">
          ...
          <div class="faq-content">
            <div class="faq-content-inner">
              No. Guided steps and AI-assisted tools help you learn at your pace, with Sokongan 24/7 available.
            </div>
          </div>
        </div>
        <div class="faq-item">
    ...
    <div class="container">
      ...
      <div class="specs-table">
        ...
        <div class="specs-row specs-row-highlight">
          ...
          <div class="specs-value">Sokongan 24/7 — <a href="contacts.php" style="color: var(--accent); font-weight: 600;">Hubungi kami</a></div>
        </div>
      </div>
    </div>
  </section>
