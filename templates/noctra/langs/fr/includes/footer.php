...
<footer class="site-footer">
  <div class="container">
    ...
    <div class="footer-risk">
      <p>
        <?= e(SITE_NAME) ?> n'est pas responsable des pertes ou dommages résultant de l'utilisation des informations sur ce site.
        Trader sur les marchés financiers comporte des risques. N'investissez que des fonds que vous pouvez vous permettre de perdre. Le forex, les CFD et les cryptomonnaies
