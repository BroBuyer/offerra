  ...
  <div class="container">
    <div class="footer-top">
      ...
      <nav class="footer-nav" aria-label="Nawigacja stopki">
        ...
        <a href="conditions.php">Warunki</a>
      </nav>
    </div>
    ...
    <div class="footer-risk">
      <p>
        ...
        Handel na rynkach finansowych wiąże się z ryzykiem. Inwestuj tylko środki, na których utratę możesz sobie pozwolić. Forex, CFD i kryptowaluty
        mogą nie być odpowiednie dla wszystkich inwestorów. Przed handlem rozważ konsultację z wykwalifikowanym specjalistą.
      </p>
    </div>
