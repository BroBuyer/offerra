...
<footer class="site-footer">
  <div class="container">
    <div class="footer-top">
      ...
      <nav class="footer-nav" aria-label="Navigazione del piè di pagina">
    ...
    <div class="footer-risk">
      <p>
        <?= e(SITE_NAME) ?> non è responsabile di perdite o danni derivanti dall'uso delle informazioni presenti su questo sito.
        Operare sui mercati finanziari comporta dei rischi. Investi solo fondi che puoi permetterti di perdere. Forex, CFD e criptovalute
        potrebbero non essere adatti a tutti gli investitori. Valuta di rivolgerti a un professionista qualificato prima di operare.
      </p>
    </div>
