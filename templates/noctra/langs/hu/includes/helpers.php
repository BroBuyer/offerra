...
{
    return SITE_NAME . ' kereskedési platform mobilon — élő BTC/USDT chart, order book és vétel/eladás felület';
}

function platform_image_caption(): string
{
    return SITE_NAME . ' — mobil kereskedés valós idejű kriptovaluta chartokkal';
}
...
/**
 * Apex https canonical — strips www / index.php and normalizes trailing slash for — kezdőlap.
 */
