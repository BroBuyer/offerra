...
$page_title = $page_title ?? SITE_NAME . ' | AI piaci terminál';
$page_description = $page_description ?? 'Kereskedjen kriptóval, forexszel és más piacokkal a ' . SITE_NAME . ' platformon — átlátható árak, AI eszközök és biztonságos számla.';
