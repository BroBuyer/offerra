...
{
    return SITE_NAME . ' handelsplattform på mobil — live BTC/USDT-diagram, ordrebok og kjøp/salg-grensesnitt';
}

function platform_image_caption(): string
{
    return SITE_NAME . ' — mobilhandel med kryptodiagrammer i sanntid';
}
...
/**
 * Apex https canonical — strips www / index.php and normalizes trailing slash for — forsiden.
 */
