...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__text">
      Forespørselen din hos <?= e(SITE_NAME) ?> er mottatt. Vent på en telefon fra rådgiveren vår.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <div class="form-grid">
      ...
      <label class="field field-full" data-field="email">
        ...
        <input class="input" type="email" name="email" placeholder="deg@email.com" required autocomplete="email" inputmode="email">
      </label>
    ...
    <button type="submit" class="btn btn-primary btn-block submit">Opprett gratis konto</button>
    ...
    <p class="form-legal">
      Ved å sende inn opplysningene dine godtar du vår
      <a href="privacy.php">Personvernerklæring</a> and
      <a href="conditions.php">Bruksvilkår</a>.
    </p>
  </div>
</form>
