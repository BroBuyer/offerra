...
<header class="site-header" data-header>
  <div class="container header-inner">
    ...
    <nav class="nav-desktop" aria-label="Hoofdnavigatie">
      ...
      <a href="offer.php" class="<?= $active_page === 'offer' ? 'is-active' : '' ?>">Aanbod</a>
    ...
    <div class="header-actions">
      <a href="sign.php" class="btn btn-primary btn-sm">Starten</a>
  ...
  <nav class="nav-mobile" data-mobile-nav aria-label="Mobiele navigatie" hidden>
    ...
    <a href="sign.php" class="btn btn-primary">Starten</a>
  </nav>
</header>
