...
<footer class="site-footer">
  <div class="container">
    ...
    <div class="footer-risk">
      <p>
        <?= e(SITE_NAME) ?> is niet verantwoordelijk voor verlies of schade door het gebruik van informatie op deze site.
        Handelen op financiële markten brengt risico's met zich mee. Investeer alleen geld dat u kunt missen. Forex, CFD's en cryptovaluta
        zijn mogelijk niet geschikt voor alle beleggers. Overweeg advies van een gekwalificeerde professional voordat u handelt.
      </p>
    </div>
