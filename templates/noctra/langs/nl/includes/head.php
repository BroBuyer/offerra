...
$page_title = $page_title ?? SITE_NAME . ' | AI-marktterminal';
$page_description = $page_description ?? 'Handel in crypto, forex en andere markten op ' . SITE_NAME . ' — duidelijke prijzen, AI-tools en een veilig account.';
