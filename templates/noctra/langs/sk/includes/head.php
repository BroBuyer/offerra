...
$page_title = $page_title ?? SITE_NAME . ' | AI obchodný terminál';
$page_description = $page_description ?? 'Obchodujte kryptomeny, forex a ďalšie trhy na ' . SITE_NAME . ' — prehľadné ceny, AI nástroje a bezpečný účet.';
