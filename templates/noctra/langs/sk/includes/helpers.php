...
{
    return SITE_NAME . ' obchodná platforma v mobile — živý graf BTC/USDT, kniha príkazov a rozhranie nákup/predaj';
}

function platform_image_caption(): string
{
    return SITE_NAME . ' — mobilné obchodovanie s kryptografmi v reálnom čase';
}
