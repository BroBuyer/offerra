...
$page_title = page_title('AI Prekybos platforma');
...
<main>
  ...
  <div class="market-tape" aria-hidden="true">
    <div class="container market-tape-inner">
      ...
      <span class="tape-item"><strong>Rinkos</strong> 24/7</span>
    </div>
  </div>
  ...
  <section class="hero-terminal">
    <div class="container hero-terminal-grid">
      <div>
        <div class="hero-kicker"><span class="dot" aria-hidden="true"></span> AI-poweredprekybos platforma</div>
        ...
        <div class="hero-badges" aria-label="Platforma highlights">
          <span class="hero-badge">
            ...
            Saugus encrypted connection (SSL)
          </span>
          <span class="hero-badge">
      ...
      <div class="board-card">
        <div class="board-card-head">
          ...
          <span class="live-pill">Saugus</span>
        </div>
        <div class="board-card-body">
          <?php
          $form_id = 'hero-form';
          $form_heading = 'Užsiregistruoti in under 2 minutes';
    ...
    <div class="container platform-layout">
      <div class="platform-copy">
        ...
        <ul class="platform-points">
          ...
          <li>Saugus account panel with 2FA</li>
        </ul>
  ...
  <section class="section" id="features">
    <div class="container">
      <div class="section-header">
        <p class="eyebrow">Savybės</p>
        <h2>What you get with <?= e(SITE_NAME) ?></h2>
        <p class="lead">Saugumas, speed, and clear tools — without a crowded screen.</p>
      </div>
      ...
      <div class="timeline">
        <article class="timeline-step">
          ...
          <div>
            ...
            <p>Pateikti your details and get secure access to the platform.</p>
          </div>
        </article>
        <article class="timeline-step">
        ...
        <article class="timeline-step">
          ...
          <div>
            <h3>Trade live</h3>
            <p>Use charts, tools, and 24/7 palaikymas whenever you need help.</p>
          </div>
        </article>
      </div>

      <div style="text-align: center; margin-top: 2rem;">
        <a href="sign.php" class="btn btn-primary">Pradėkite dabar</a>
      </div>
    </div>
  </section>
    ...
    <div class="container" style="max-width: 800px; margin-inline: auto;">
      ...
      <div class="faq-list" data-faq>
        ...
        <div class="faq-item">
          ...
          <div class="faq-content">
            <div class="faq-content-inner">
              No. Guided steps and AI-assisted tools help you learn at your pace, with 24/7 palaikymas available.
            </div>
          </div>
        </div>
        <div class="faq-item">
    ...
    <div class="container">
      ...
      <div class="specs-table">
        ...
        <div class="specs-row specs-row-highlight">
          ...
          <div class="specs-value">24/7 palaikymas — <a href="contacts.php" style="color: var(--accent); font-weight: 600;">Susisiekite su mumis</a></div>
        </div>
      </div>
    </div>
  </section>
