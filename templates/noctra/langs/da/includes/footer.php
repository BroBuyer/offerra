...
<footer class="site-footer">
  <div class="container">
    ...
    <div class="footer-risk">
      <p>
        <?= e(SITE_NAME) ?> er ikke ansvarlig for tab eller skade som følge af brugen af oplysninger på dette site.
        Handel på finansielle markeder indebærer risiko. Investér kun midler, du har råd til at tabe. FX, CFD'er og kryptovalutaer
        er muligvis ikke egnede for alle investorer. Overvej at søge rådgivning hos en kvalificeret professionel før handel.
      </p>
    </div>
