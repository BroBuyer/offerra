...
{
    return SITE_NAME . ' handelsplatform på mobil — live BTC/USDT-diagram, ordrebog og køb/salg-grænseflade';
}

function platform_image_caption(): string
{
    return SITE_NAME . ' — mobil handel med kryptodiagrammer i realtid';
}
