...
$page_description = SITE_NAME . ' のプラットフォーム — ライブチャート、AIインサイト、マルチマーケット対応、自動化コントロール。';
...
<main>
  <section class="page-hero">
    <div class="container">
      ...
      <h1>明快な取引のためのツール</h1>
      <p class="lead">すべてのセッション向けのひとつのプラットフォーム — チャート、シグナル、リスク管理、自動化。余計なものはありません。</p>
    </div>
  </section>
    ...
    <div class="container">
      <div class="features-grid">
        ...
        <article class="feature-card">
          ...
          <h3>AIインサイト</h3>
          <p>モデルがタイミングとトレンドを示し、速い市場でもエントリーが明確になります。</p>
        </article>
        <article class="feature-card">
          <div class="feature-icon">
          ...
          <h3>自動化ツール</h3>
          <p>リスク上限付きのルールベースボット — 無人稼働も、手動オーバーライドも可能です。</p>
        </article>
        <article class="feature-card">
          <div class="feature-icon">
          ...
          <h3>リスク管理</h3>
          <p>損切り、利確、ポジションサイズがワークフローに組み込まれています。後付けではありません。</p>
        </article>
        <article class="feature-card">
          <div class="feature-icon">
        ...
        <article class="feature-card">
          ...
          <h3>学習サポート</h3>
          <p>まだ取引に慣れていない方向けの短い解説と案内付きフロー。</p>
        </article>
      </div>

      <div style="text-align: center; margin-top: 3rem;">
        <a href="sign.php" class="btn btn-primary"><?= e(SITE_NAME) ?> を試す</a>
      </div>
    </div>
  </section>
</main>
