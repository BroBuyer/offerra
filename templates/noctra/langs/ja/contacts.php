...
$page_description = 'お問い合わせ ' . SITE_NAME . ' support — account, trading, and technical help available 24/7.';
    ...
    <div class="container" style="max-width: 640px; margin-inline: auto;">
      <div class="features-grid" style="grid-template-columns: 1fr;">
        ...
        <article class="feature-card">
          ...
          <p style="margin-bottom: 1rem;">口座を開設 in minutes — no call required.</p>
