...
{
    return SITE_NAME . ' πλατφόρμα συναλλαγών σε κινητό — ζωντανό γράφημα BTC/USDT, βιβλίο εντολών και διεπαφή αγοράς/πώλησης';
}

function platform_image_caption(): string
{
    return SITE_NAME . ' — συναλλαγές από κινητό με γραφήματα κρυπτονομισμάτων σε πραγματικό χρόνο';
}
...
/**
 * Apex https canonical — strips www / index.php and normalizes trailing slash for — αρχική.
 */
