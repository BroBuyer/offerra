...
$page_title = $page_title ?? SITE_NAME . ' | Τερματικό αγοράς AI';
$page_description = $page_description ?? 'Συναλλάξτε crypto, forex και άλλες αγορές στο ' . SITE_NAME . ' — καθαρές τιμές, εργαλεία AI και ασφαλής λογαριασμός.';
