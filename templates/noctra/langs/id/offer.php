...
$page_description = 'Open ' . SITE_NAME . ' with a ' . MIN_DEPOSIT . ' ' . CURRENCY . ' minimum — full platform access, AI insights, and Dukungan 24/7.';
    ...
    <div class="container" style="max-width: 900px; margin-inline: auto;">
      <div class="specs-table" style="margin-bottom: 2rem;">
        <div class="specs-row specs-row-highlight">
          ...
          <div class="specs-value"><strong><?= MIN_DEPOSIT ?> <?= CURRENCY ?></strong> minimum · Full platform · AI insights · Dukungan 24/7</div>
        </div>
        <div class="specs-row">
