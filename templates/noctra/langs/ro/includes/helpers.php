...
{
    return SITE_NAME . ' platformă de trading pe mobil — grafic BTC/USDT live, order book și interfață cumpărare/vânzare';
}

function platform_image_caption(): string
{
    return SITE_NAME . ' — trading mobil cu grafice crypto în timp real';
}
...
/**
 * Apex https canonical — strips www / index.php and normalizes trailing slash for — pagina principală.
 */
