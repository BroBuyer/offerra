...
<?php endif; ?>
    ...
    <button type="submit" class="btn btn-primary btn-block submit">Skapa gratis konto</button>
    ...
    <p class="form-legal">
      Genom att skicka dina uppgifter godkänner du vår
      <a href="privacy.php">Integritetspolicy</a> and
