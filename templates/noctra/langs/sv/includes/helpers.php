...
{
    return SITE_NAME . ' handelsplattform på mobil — live BTC/USDT-diagram, orderbok och köp/sälj-gränssnitt';
}

function platform_image_caption(): string
{
    return SITE_NAME . ' — mobil handel med kryptodiagram i realtid';
}
...
/**
 * Apex https canonical — strips www / index.php and normalizes trailing slash for — startsidan.
 */
