...
<header class="site-header" data-header>
  <div class="container header-inner">
    <a href="<?= page_url() ?>" class="logo" aria-label="<?= e(SITE_NAME) ?> — startsidan">
    ...
    <nav class="nav-desktop" aria-label="Huvudnavigation">
      <a href="<?= page_url() ?>" class="<?= $active_page === 'home' ? 'is-active' : '' ?>">Hem</a>
      <a href="product.php" class="<?= $active_page === 'product' ? 'is-active' : '' ?>">Produkt</a>
      <a href="offer.php" class="<?= $active_page === 'offer' ? 'is-active' : '' ?>">Erbjudande</a>
    ...
    <div class="header-actions">
      <a href="sign.php" class="btn btn-primary btn-sm">Kom igång</a>
      <button class="menu-toggle" type="button" data-menu-toggle aria-label="Öppna menyn" aria-expanded="false">
        <span></span><span></span>
      </button>
    </div>
  </div>

  <nav class="nav-mobile" data-mobile-nav aria-label="Mobilnavigation" hidden>
    <a href="<?= page_url() ?>">Hem</a>
    <a href="product.php">Produkt</a>
    <a href="offer.php">Erbjudande</a>
    <a href="contacts.php">Kontakt</a>
    <a href="faq.php">FAQ</a>
    <a href="sign.php" class="btn btn-primary">Kom igång</a>
  </nav>
</header>
