...
<footer class="site-footer">
  <div class="container">
    ...
    <div class="footer-risk">
      <p>
        <?= e(SITE_NAME) ?> haftet nicht für Verluste oder Schäden, die aus der Nutzung von Informationen auf dieser Website entstehen.
        Der Handel an den Finanzmärkten ist mit Risiken verbunden. Investieren Sie nur Geld, dessen Verlust Sie verkraften können. Devisen, CFDs und Kryptowährungen
        eignen sich möglicherweise nicht für alle Anleger. Ziehen Sie vor dem Handel eine Beratung durch einen qualifizierten Fachmann in Betracht.
      </p>
    </div>
