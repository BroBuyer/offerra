...
<div class="lisa-chat" id="lisaChat" data-lisa-chat>
  <button type="button" class="lisa-fab" id="chat-toggle-btn" aria-label="Otevřít chat s Lisou" aria-expanded="false">
  ...
  <div class="lisa-panel" id="chat-window" hidden>
    <div class="lisa-panel__head">
      ...
      <button type="button" class="lisa-panel__close" id="chat-close-btn" aria-label="Zavřít chat">
    ...
    <div class="lisa-form-wrap" id="chat-form-wrap" hidden>
      ...
      >
        <div class="form-already-registered hidden" data-already-registered>
          ...
          <p class="form-already-registered__text">Počkejte prosím na hovor od našeho manažera.</p>
        </div>
...
<?php endif; ?>
          ...
          <button type="submit" class="btn btn-primary btn-block submit" id="cq-custom-submit-btn">Vytvořit bezplatný účet</button>
          ...
          <p class="form-legal">Odesláním souhlasíte s našimi <a href="conditions.php">Podmínkami</a>.</p>
        </div>
      </form>
    </div>
    </div>
