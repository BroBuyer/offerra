...
{
    return SITE_NAME . ' obchodní platforma na mobilu — živý graf BTC/USDT, order book a rozhraní nákup/prodej';
}

function platform_image_caption(): string
{
    return SITE_NAME . ' — mobilní obchodování s krypto grafy v reálném čase';
}
...
/**
 * Apex https canonical — strips www / index.php and normalizes trailing slash for domů.
 */
