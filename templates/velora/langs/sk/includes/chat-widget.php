...
<div class="lisa-chat" id="lisaChat" data-lisa-chat>
  <button type="button" class="lisa-fab" id="chat-toggle-btn" aria-label="Otvoriť chat s Lisou" aria-expanded="false">
  ...
  <div class="lisa-panel" id="chat-window" hidden>
    <div class="lisa-panel__head">
      <div class="lisa-panel__identity">
        ...
        <div>
          <h4>Lisa</h4>
          <p>Asistentka onboardingu</p>
        </div>
      </div>
      <button type="button" class="lisa-panel__close" id="chat-close-btn" aria-label="Zavrieť chat">
    ...
    <div class="lisa-typing" id="typing-indicator" hidden>Lisa píše…</div>
    ...
    <div class="lisa-form-wrap" id="chat-form-wrap" hidden>
      ...
      >
        <div class="form-already-registered hidden" data-already-registered>
          <p class="form-already-registered__title">Už ste registrovaní</p>
          <p class="form-already-registered__text">Počkajte prosím na hovor od nášho manažéra.</p>
        </div>
...
<?php endif; ?>
          ...
          <button type="submit" class="btn btn-primary btn-block submit" id="cq-custom-submit-btn">Vytvoriť bezplatný účet</button>
          ...
          <p class="form-legal">Odoslaním súhlasíte s našimi <a href="conditions.php">Podmienkami</a>.</p>
        </div>
      </form>
    </div>
    </div>
