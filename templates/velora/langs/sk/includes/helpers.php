...
{
    return SITE_NAME . ' obchodná platforma na mobile — živý graf BTC/USDT, order book a rozhranie nákup/predaj';
}

function platform_image_caption(): string
{
    return SITE_NAME . ' — mobilné obchodovanie s krypto grafmi v reálnom čase';
}
...
/**
 * Apex https canonical — strips www / index.php and normalizes trailing slash for domov.
 */
