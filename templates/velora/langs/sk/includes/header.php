...
<header class="header site-header" data-header>
  <div class="container" style="display:flex;align-items:center;justify-content:space-between;gap:20px;min-height:94px;">
    ...
    <nav class="nav nav-desktop" id="mainNav" aria-label="Hlavná navigácia">
      <a href="<?= e($sec('#security')) ?>" class="nav-link">Zabezpečenie</a>
      <a href="<?= e($sec('#reviews')) ?>" class="nav-link">Recenzie</a>
    ...
    <div style="display:flex;gap:14px;align-items:center;">
      <button class="theme-toggle" id="themeToggle" type="button" aria-label="Prepnúť na svetlý režim">☀️ Svetlý</button>
      <a href="<?= e($sec('#signup')) ?>" class="btn btn-primary header-cta-btn">Začať obchodovať</a>
      <button class="burger menu-toggle" id="burgerBtn" type="button" data-menu-toggle aria-label="Otvoriť menu" aria-expanded="false">
  ...
  <nav class="nav-mobile" data-mobile-nav aria-label="Mobilná navigácia" hidden>
    <a href="<?= e($sec('#security')) ?>">Zabezpečenie</a>
    <a href="<?= e($sec('#reviews')) ?>">Recenzie</a>
    <a href="<?= e($sec('#faq')) ?>">FAQ</a>
    <a href="product.php">O nás</a>
    <a href="contacts.php">Kontakt</a>
    <a href="<?= e($sec('#signup')) ?>" class="btn btn-primary">Začať obchodovať</a>
  </nav>
</header>
