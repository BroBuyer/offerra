...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__text">
      Vaša žiadosť u <?= e(SITE_NAME) ?> bola prijatá. Počkajte prosím na hovor od nášho manažéra.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <div class="form-grid">
      <label class="field" data-field="fname">
        ...
        <input class="input" type="text" name="fname" placeholder="Ján" required pattern="[^\d]+" autocomplete="given-name">
      </label>
      <label class="field" data-field="lname">
        <span class="field-label">Priezvisko</span>
        <input class="input" type="text" name="lname" placeholder="Novák" required pattern="[^\d]+" autocomplete="family-name">
      </label>
      <label class="field field-full" data-field="email">
        <span class="field-label">E-mail</span>
        <input class="input" type="email" name="email" placeholder="vy@email.com" required autocomplete="email" inputmode="email">
      </label>
    ...
    <?php
    $payment_context = 'registráciu účtu';
    ...
    <p class="form-legal">
      Odoslaním údajov súhlasíte s našimi
      <a href="conditions.php">Podmienky používania</a>.
    </p>
  </div>
</form>
<?php
