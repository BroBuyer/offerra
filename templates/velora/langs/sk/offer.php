...
<main>
  <section class="page-hero">
    <div class="container">
      ...
      <p class="lead">Jeden jednoduchý vstupný bod. Plný prístup k platforme po financovaní — vrátane AI insightov a živých trhov.</p>
    </div>
  </section>
    ...
    <div class="container" style="max-width: 520px;">
      <div class="page-panel">
        ...
        <p class="prose" style="margin-bottom:18px">
          ...
          Grafy, nástroje a AI vedenie sa odomknú, akonáhle bude váš účet financovaný.
        </p>
        <?php
        $form_id = 'offer-form';
