...
<?php endif; ?>
    ...
    <div class="form-grid">
      <label class="field" data-field="fname">
        ...
        <input class="input" type="text" name="fname" placeholder="Jānis" required pattern="[^\d]+" autocomplete="given-name">
      </label>
      <label class="field" data-field="lname">
        <span class="field-label">Uzvārds</span>
        <input class="input" type="text" name="lname" placeholder="Bērziņš" required pattern="[^\d]+" autocomplete="family-name">
      </label>
      <label class="field field-full" data-field="email">
        <span class="field-label">E-pasts</span>
        <input class="input" type="email" name="email" placeholder="jus@epasts.com" required autocomplete="email" inputmode="email">
      </label>
    ...
    <?php
    $payment_context = 'konta reģistrācija';
    ...
    <p class="form-legal">
      Iesniedzot savus datus, jūs piekrītat mūsu
      <a href="conditions.php">Lietošanas noteikumi</a>.
    </p>
  </div>
</form>
<?php
