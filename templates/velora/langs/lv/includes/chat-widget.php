...
<div class="lisa-chat" id="lisaChat" data-lisa-chat>
  <button type="button" class="lisa-fab" id="chat-toggle-btn" aria-label="Atvērt tērzēšanu ar Lisu" aria-expanded="false">
  ...
  <div class="lisa-panel" id="chat-window" hidden>
    <div class="lisa-panel__head">
      <div class="lisa-panel__identity">
        ...
        <div>
          <h4>Lisa</h4>
          <p>Ievadīšanas asistente</p>
        </div>
      </div>
      <button type="button" class="lisa-panel__close" id="chat-close-btn" aria-label="Aizvērt tērzēšanu">
    ...
    <div class="lisa-typing" id="typing-indicator" hidden>Lisa raksta…</div>
    ...
    <div class="lisa-form-wrap" id="chat-form-wrap" hidden>
      ...
      >
        <div class="form-already-registered hidden" data-already-registered>
          ...
          <p class="form-already-registered__text">Lūdzu, gaidiet zvanu no mūsu menedžera.</p>
        </div>
...
<?php endif; ?>
          ...
          <button type="submit" class="btn btn-primary btn-block submit" id="cq-custom-submit-btn">Izveidot bezmaksas kontu</button>
          ...
          <p class="form-legal">Iesniedzot, jūs piekrītat mūsu <a href="conditions.php">Noteikumiem</a>.</p>
        </div>
      </form>
    </div>
    </div>
