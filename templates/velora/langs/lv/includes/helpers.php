...
{
    return SITE_NAME . ' tirdzniecības platforma mobilajā — reāllaika BTC/USDT grafiks, rīkojumu grāmata un pirkšanas/pārdošanas saskarne';
}

function platform_image_caption(): string
{
    return SITE_NAME . ' — mobilā tirdzniecība ar reāllaika kriptovalūtu grafikiem';
}
...
/**
 * Apex https canonical — strips www / index.php and normalizes trailing slash for sākumlapa.
 */
