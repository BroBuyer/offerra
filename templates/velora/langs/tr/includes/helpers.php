...
{
    return SITE_NAME . ' mobilde işlem platformu — canlı BTC/USDT grafiği, emir defteri ve al/sat arayüzü';
}

function platform_image_caption(): string
{
    return SITE_NAME . ' — gerçek zamanlı kripto grafikleriyle mobil işlem';
}
...
/**
 * Apex https canonical — strips www / index.php and normalizes trailing slash for ana sayfa.
 */
