...
<div class="lisa-chat" id="lisaChat" data-lisa-chat>
  <button type="button" class="lisa-fab" id="chat-toggle-btn" aria-label="Lisa ile sohbeti aç" aria-expanded="false">
  ...
  <div class="lisa-panel" id="chat-window" hidden>
    <div class="lisa-panel__head">
      <div class="lisa-panel__identity">
        ...
        <div>
          <h4>Lisa</h4>
          <p>Katılım asistanı</p>
        </div>
      </div>
      <button type="button" class="lisa-panel__close" id="chat-close-btn" aria-label="Sohbeti kapat">
    ...
    <div class="lisa-typing" id="typing-indicator" hidden>Lisa yazıyor…</div>
    ...
    <div class="lisa-form-wrap" id="chat-form-wrap" hidden>
      ...
      >
        <div class="form-already-registered hidden" data-already-registered>
          ...
          <p class="form-already-registered__text">Lütfen yöneticimizden gelecek aramayı bekleyin.</p>
        </div>
...
<?php endif; ?>
          ...
          <button type="submit" class="btn btn-primary btn-block submit" id="cq-custom-submit-btn">Ücretsiz hesap oluştur</button>
          ...
          <p class="form-legal">Göndererek <a href="conditions.php">Koşullarımızı</a>.</p>
        </div>
      </form>
    </div>
    </div>
