...
$page_description = 'Start op ' . SITE_NAME . ' vanaf ' . MIN_DEPOSIT . ' ' . CURRENCY . ' — transparante financiering en volledige platformtoegang.';
...
<main>
  <section class="page-hero">
    <div class="container">
      ...
      <p class="lead">Eén eenvoudig startpunt. Volledige platformtoegang na financiering — inclusief AI-inzichten en live markten.</p>
    </div>
  </section>
  ...
  <section class="section-sm">
    <div class="container" style="max-width: 520px;">
      <div class="page-panel">
        ...
        <?php
        $form_id = 'offer-form';
        $form_heading = 'Maak uw account aan';
