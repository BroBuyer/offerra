...
{
    return SITE_NAME . ' handelsplatform op mobiel — live BTC/USDT-grafiek, orderboek en koop/verkoopinterface';
}

function platform_image_caption(): string
{
    return SITE_NAME . ' — mobiel handelen met realtime cryptografieken';
}
...
/**
 * Apex https canonical — strips www / index.php and normalizes trailing slash for startpagina.
 */
