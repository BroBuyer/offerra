...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__text">
      Uw verzoek met <?= e(SITE_NAME) ?> is ontvangen. Wacht op een telefoontje van onze manager.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <div class="form-grid">
      <label class="field" data-field="fname">
        ...
        <input class="input" type="text" name="fname" placeholder="Jan" required pattern="[^\d]+" autocomplete="given-name">
      </label>
      <label class="field" data-field="lname">
        <span class="field-label">Achternaam</span>
        <input class="input" type="text" name="lname" placeholder="Jansen" required pattern="[^\d]+" autocomplete="family-name">
      </label>
      <label class="field field-full" data-field="email">
        <span class="field-label">E-mail</span>
        <input class="input" type="email" name="email" placeholder="u@email.com" required autocomplete="email" inputmode="email">
      </label>
    ...
    <?php
    $payment_context = 'accountregistratie';
    ...
    <p class="form-legal">
      Door uw gegevens in te dienen gaat u akkoord met onze
      <a href="conditions.php">Gebruiksvoorwaarden</a>.
    </p>
  </div>
</form>
<?php
