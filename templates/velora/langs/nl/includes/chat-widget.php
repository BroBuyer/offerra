...
<div class="lisa-chat" id="lisaChat" data-lisa-chat>
  <button type="button" class="lisa-fab" id="chat-toggle-btn" aria-label="Chat openen met Lisa" aria-expanded="false">
  ...
  <div class="lisa-panel" id="chat-window" hidden>
    <div class="lisa-panel__head">
      <div class="lisa-panel__identity">
        ...
        <div>
          <h4>Lisa</h4>
          <p>Onboardingassistent</p>
        </div>
      </div>
      <button type="button" class="lisa-panel__close" id="chat-close-btn" aria-label="Chat sluiten">
    ...
    <div class="lisa-typing" id="typing-indicator" hidden>Lisa is aan het typen…</div>
    ...
    <div class="lisa-form-wrap" id="chat-form-wrap" hidden>
      ...
      >
        <div class="form-already-registered hidden" data-already-registered>
          ...
          <p class="form-already-registered__text">Wacht op een telefoontje van onze manager.</p>
        </div>
...
<?php endif; ?>
          ...
          <button type="submit" class="btn btn-primary btn-block submit" id="cq-custom-submit-btn">Gratis account aanmaken</button>
          ...
          <p class="form-legal">Door in te dienen gaat u akkoord met onze <a href="conditions.php">Voorwaarden</a>.</p>
        </div>
      </form>
    </div>
    </div>
