...
{
    return SITE_NAME . ' plataforma de trading en el móvil — gráfico BTC/USDT en vivo, libro de órdenes e interfaz comprar/vender';
}

function platform_image_caption(): string
{
    return SITE_NAME . ' — trading móvil con gráficos de criptomonedas en tiempo real';
}
