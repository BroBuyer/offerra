...
$form_submit = $form_submit ?? 'Crea una cuenta gratuita';
...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__text">
      Hemos recibido tu solicitud con <?= e(SITE_NAME) ?>. Por favor, espera una llamada de nuestro responsable.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <div class="form-grid">
      <label class="field" data-field="fname">
        ...
        <input class="input" type="text" name="fname" placeholder="Juan" required pattern="[^\d]+" autocomplete="given-name">
      </label>
      <label class="field" data-field="lname">
        <span class="field-label">Apellido</span>
        <input class="input" type="text" name="lname" placeholder="Pérez" required pattern="[^\d]+" autocomplete="family-name">
      </label>
    ...
    <p class="form-legal">
      ...
      <a href="conditions.php">Términos de uso</a>.
    </p>
  </div>
</form>
<?php
