...
<header class="header site-header" data-header>
  <div class="container" style="display:flex;align-items:center;justify-content:space-between;gap:20px;min-height:94px;">
    ...
    <nav class="nav nav-desktop" id="mainNav" aria-label="Navegación principal">
      <a href="<?= e($sec('#security')) ?>" class="nav-link">Seguridad</a>
      <a href="<?= e($sec('#reviews')) ?>" class="nav-link">Reseñas</a>
      <a href="<?= e($sec('#faq')) ?>" class="nav-link">FAQ</a>
      <a href="product.php" class="nav-link<?= ($active_page ?? '') === 'product' ? ' is-active' : '' ?>">Acerca de</a>
  ...
  <nav class="nav-mobile" data-mobile-nav aria-label="Navegación móvil" hidden>
    <a href="<?= e($sec('#security')) ?>">Seguridad</a>
    <a href="<?= e($sec('#reviews')) ?>">Reseñas</a>
    <a href="<?= e($sec('#faq')) ?>">FAQ</a>
    <a href="product.php">Acerca de</a>
    <a href="contacts.php">Contacto</a>
    <a href="<?= e($sec('#signup')) ?>" class="btn btn-primary">Empezar a operar</a>
  </nav>
</header>
