...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__text">
      Votre demande auprès de <?= e(SITE_NAME) ?> a bien été reçue. Veuillez patienter pour un appel de notre responsable.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <div class="form-grid">
      <label class="field" data-field="fname">
        ...
        <input class="input" type="text" name="fname" placeholder="Jean" required pattern="[^\d]+" autocomplete="given-name">
      </label>
      <label class="field" data-field="lname">
        <span class="field-label">Nom</span>
        <input class="input" type="text" name="lname" placeholder="Dupont" required pattern="[^\d]+" autocomplete="family-name">
      </label>
    ...
    <?php
    $payment_context = 'création de compte';
    ...
    <p class="form-legal">
      En envoyant vos informations, vous acceptez nos
