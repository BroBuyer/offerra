...
<div class="lisa-chat" id="lisaChat" data-lisa-chat>
  <button type="button" class="lisa-fab" id="chat-toggle-btn" aria-label="Ouvrir le chat avec Lisa" aria-expanded="false">
  ...
  <div class="lisa-panel" id="chat-window" hidden>
    <div class="lisa-panel__head">
      <div class="lisa-panel__identity">
        ...
        <div>
          <h4>Lisa</h4>
          <p>Assistante d’onboarding</p>
        </div>
      </div>
      <button type="button" class="lisa-panel__close" id="chat-close-btn" aria-label="Fermer le chat">
    ...
    <div class="lisa-typing" id="typing-indicator" hidden>Lisa est en train d’écrire…</div>
    ...
    <div class="lisa-form-wrap" id="chat-form-wrap" hidden>
      ...
      >
        <div class="form-already-registered hidden" data-already-registered>
          <p class="form-already-registered__title">Vous êtes déjà inscrit(e)</p>
          <p class="form-already-registered__text">Veuillez patienter pendant l’appel de notre responsable.</p>
        </div>
...
<?php endif; ?>
          ...
          <button type="submit" class="btn btn-primary btn-block submit" id="cq-custom-submit-btn">Créer un compte gratuit</button>
          ...
          <p class="form-legal">En envoyant, vous acceptez nos <a href="conditions.php">Conditions</a>.</p>
        </div>
      </form>
    </div>
    </div>
