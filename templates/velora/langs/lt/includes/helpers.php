...
{
    return SITE_NAME . 'prekybos platforma mobiliajame telefone – tiesioginė BTC/USDT diagrama, užsakymų knyga ir pirkimo/pardavimo sąsaja';
}

function platform_image_caption(): string
{
    return SITE_NAME . '- mobilioji prekyba su kriptovaliutų diagramomis realiuoju laiku';
}
...
/**
 * Apex https canonical — strips www / index.php and normalizes trailing slash fornamo.
 */
