...
$form_submit = $form_submit ?? 'Sukurti nemokamą paskyrą';
...
<?php endif; ?>
    ...
    <div class="form-grid">
      <label class="field" data-field="fname">
        ...
        <input class="input" type="text" name="fname" placeholder="Jonas" required pattern="[^\d]+" autocomplete="given-name">
      </label>
      <label class="field" data-field="lname">
        <span class="field-label">Pavardė</span>
        <input class="input" type="text" name="lname" placeholder="Smithas" required pattern="[^\d]+" autocomplete="family-name">
      </label>
      <label class="field field-full" data-field="email">
        <span class="field-label">El. paštas</span>
        <input class="input" type="email" name="email" placeholder="tu@email.com" required autocomplete="email" inputmode="email">
      </label>
    ...
    <?php
    $payment_context = 'paskyros registracija';
    ...
    <p class="form-legal">
      Pateikdami savo duomenis sutinkate su mūsų
      <a href="conditions.php">Naudojimo sąlygos</a>.
    </p>
  </div>
</form>
<?php
