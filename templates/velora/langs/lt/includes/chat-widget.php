...
<div class="lisa-chat" id="lisaChat" data-lisa-chat>
  <button type="button" class="lisa-fab" id="chat-toggle-btn" aria-label="Atidarykite pokalbį su Lisa" aria-expanded="false">
  ...
  <div class="lisa-panel" id="chat-window" hidden>
    <div class="lisa-panel__head">
      <div class="lisa-panel__identity">
        ...
        <div>
          <h4>Lisa</h4>
          <p>Priėmimo asistentas</p>
        </div>
      </div>
      <button type="button" class="lisa-panel__close" id="chat-close-btn" aria-label="Uždaryti pokalbį">
    ...
    <div class="lisa-typing" id="typing-indicator" hidden>Lisa rašo…</div>
    ...
    <div class="lisa-form-wrap" id="chat-form-wrap" hidden>
      ...
      >
        <div class="form-already-registered hidden" data-already-registered>
          ...
          <p class="form-already-registered__text">Palaukite skambučio iš mūsų vadybininko.</p>
        </div>
...
<?php endif; ?>
          ...
          <label class="field" data-field="email">
            <span class="field-label">El. paštas</span>
          ...
          <button type="submit" class="btn btn-primary btn-block submit" id="cq-custom-submit-btn">Sukurti nemokamą paskyrą</button>
          ...
          <p class="form-legal">Pateikdami sutinkate su mūsų<a href="conditions.php">Sąlygos</a>.</p>
        </div>
      </form>
    </div>
    </div>
