...
$form_submit = $form_submit ?? 'Skapa gratis konto';
...
<?php endif; ?>
    ...
    <div class="form-grid">
      <label class="field" data-field="fname">
        ...
        <input class="input" type="text" name="fname" placeholder="Erik" required pattern="[^\d]+" autocomplete="given-name">
      </label>
      <label class="field" data-field="lname">
        <span class="field-label">Efternamn</span>
        <input class="input" type="text" name="lname" placeholder="Andersson" required pattern="[^\d]+" autocomplete="family-name">
      </label>
      <label class="field field-full" data-field="email">
        <span class="field-label">E-post</span>
        <input class="input" type="email" name="email" placeholder="du@email.com" required autocomplete="email" inputmode="email">
      </label>
    ...
    <p class="form-legal">
      Genom att skicka in dina uppgifter godkänner du våra
