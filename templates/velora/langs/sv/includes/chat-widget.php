...
<div class="lisa-chat" id="lisaChat" data-lisa-chat>
  <button type="button" class="lisa-fab" id="chat-toggle-btn" aria-label="Öppna chatt med Lisa" aria-expanded="false">
  ...
  <div class="lisa-panel" id="chat-window" hidden>
    <div class="lisa-panel__head">
      ...
      <button type="button" class="lisa-panel__close" id="chat-close-btn" aria-label="Stäng chatt">
    ...
    <div class="lisa-typing" id="typing-indicator" hidden>Lisa skriver…</div>
    ...
    <div class="lisa-form-wrap" id="chat-form-wrap" hidden>
      ...
      >
        <div class="form-already-registered hidden" data-already-registered>
          ...
          <p class="form-already-registered__text">Vänta på ett samtal från vår manager.</p>
        </div>
...
<?php endif; ?>
          ...
          <button type="submit" class="btn btn-primary btn-block submit" id="cq-custom-submit-btn">Skapa gratis konto</button>
          ...
          <p class="form-legal">Genom att skicka in godkänner du våra <a href="conditions.php">Villkor</a>.</p>
        </div>
      </form>
    </div>
    </div>
