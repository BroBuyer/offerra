...
{
    return SITE_NAME . ' platformă de tranzacționare pe mobil — grafic BTC/USDT live, order book și interfață cumpără/vinde';
}

function platform_image_caption(): string
{
    return SITE_NAME . ' — tranzacționare mobilă cu grafice cripto în timp real';
}
...
/**
 * Apex https canonical — strips www / index.php and normalizes trailing slash for acasă.
 */
