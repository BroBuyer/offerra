...
<div class="lisa-chat" id="lisaChat" data-lisa-chat>
  <button type="button" class="lisa-fab" id="chat-toggle-btn" aria-label="Deschide chat cu Lisa" aria-expanded="false">
  ...
  <div class="lisa-panel" id="chat-window" hidden>
    <div class="lisa-panel__head">
      <div class="lisa-panel__identity">
        ...
        <div>
          <h4>Lisa</h4>
          <p>Asistent onboarding</p>
        </div>
      </div>
      <button type="button" class="lisa-panel__close" id="chat-close-btn" aria-label="Închide chat">
    ...
    <div class="lisa-typing" id="typing-indicator" hidden>Lisa scrie…</div>
    ...
    <div class="lisa-form-wrap" id="chat-form-wrap" hidden>
      ...
      >
        <div class="form-already-registered hidden" data-already-registered>
          ...
          <p class="form-already-registered__text">Vă rugăm să așteptați un apel de la managerul nostru.</p>
        </div>
...
<?php endif; ?>
          ...
          <button type="submit" class="btn btn-primary btn-block submit" id="cq-custom-submit-btn">Creează cont gratuit</button>
          ...
          <p class="form-legal">Prin trimitere sunteți de acord cu <a href="conditions.php">Termenii</a>.</p>
        </div>
      </form>
    </div>
    </div>
