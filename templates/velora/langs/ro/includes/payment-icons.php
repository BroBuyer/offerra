...
$payment_context = $payment_context ?? 'checkout securizat';
...
$methods = [
    ...
    ['file' => 'banktransfer.svg','alt' => 'Transfer bancar și SEPA — acceptat pe ' . SITE_NAME],
];
?>
  ...
  <ul class="payment-icons-list">
    ...
    <li>
      <img
        ...
        alt="Criptare SSL pe 256 de biți — transfer securizat de date pe <?= e(SITE_NAME) ?>"
        title="Securizat SSL"
        width="32"
        height="32"
        loading="lazy"
