...
$form_submit = $form_submit ?? 'Creează cont gratuit';
...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__text">
      Cererea dvs. la <?= e(SITE_NAME) ?> a fost primită. Vă rugăm să așteptați un apel de la managerul nostru.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <div class="form-grid">
      <label class="field" data-field="fname">
        ...
        <input class="input" type="text" name="fname" placeholder="Ion" required pattern="[^\d]+" autocomplete="given-name">
      </label>
      <label class="field" data-field="lname">
        <span class="field-label">Nume</span>
        <input class="input" type="text" name="lname" placeholder="Popescu" required pattern="[^\d]+" autocomplete="family-name">
      </label>
    ...
    <p class="form-legal">
      Prin trimiterea datelor dvs. sunteți de acord cu
      <a href="conditions.php">Termeni de utilizare</a>.
    </p>
  </div>
</form>
<?php
