...
{
    return SITE_NAME . ' plataforma de trading no telemóvel — gráfico BTC/USDT em direto, livro de ordens e interface comprar/vender';
}

function platform_image_caption(): string
{
    return SITE_NAME . ' — trading móvel com gráficos de criptomoedas em tempo real';
}
...
/**
 * Apex https canonical — strips www / index.php and normalizes trailing slash for início.
 */
