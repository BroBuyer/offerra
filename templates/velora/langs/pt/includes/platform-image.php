<?php
/**
 * Plataforma showcase image — optimized for Google Images indexing.
 */
...
<figure class="platform-figure<?= $as_phone ? ' app-phone-wrap' : '' ?>" itemscope itemtype="https://schema.org/ImageObject">
  <meta itemprop="name" content="<?= e(SITE_NAME) ?> Plataforma de Trading com IA">
  ...
  <div class="platform-figure-media">
    <img
      src="<?= e($platform_img) ?>"
      alt="<?= e($platform_alt) ?>"
      title="<?= e(page_title('Plataforma de Trading com IA')) ?>"
      width="320"
      height="640"
