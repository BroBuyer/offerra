...
<main>
  <section class="page-hero">
    <div class="container">
      ...
      <p class="lead">Questões sobre a sua conta, depósitos ou ferramentas de IA — contacte-nos a qualquer momento.</p>
    </div>
  </section>
  ...
  <section class="section-sm">
    <div class="container" style="max-width: 560px;">
      <div class="page-panel">
        <h2 style="font-size: 1.3rem; margin-bottom: 10px;">Suporte</h2>
        ...
        <div style="margin-top: 18px;">
          ...
          $form_heading = 'Ou deixe os seus dados';
