...
{
    return SITE_NAME . ' のモバイル取引プラットフォーム — ライブBTC/USDTチャート、オーダーブック、売買インターフェース';
}

function platform_image_caption(): string
{
    return SITE_NAME . ' — リアルタイム暗号資産チャートによるモバイル取引';
}
...
/**
 * Apex https canonical — strips www / index.php and normalizes trailing slash for ホーム.
 */
