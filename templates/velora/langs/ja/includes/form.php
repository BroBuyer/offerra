...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__text">
      ご依頼（ <?= e(SITE_NAME) ?> ）を受け付けました。担当マネージャーからのお電話をお待ちください。
    </p>
  </div>
...
<?php endif; ?>
    ...
    <div class="form-grid">
      <label class="field" data-field="fname">
        ...
        <input class="input" type="text" name="fname" placeholder="太郎" required pattern="[^\d]+" autocomplete="given-name">
      </label>
      <label class="field" data-field="lname">
        <span class="field-label">姓</span>
        <input class="input" type="text" name="lname" placeholder="佐藤" required pattern="[^\d]+" autocomplete="family-name">
      </label>
