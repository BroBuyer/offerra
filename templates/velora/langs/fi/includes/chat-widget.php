...
<div class="lisa-chat" id="lisaChat" data-lisa-chat>
  <button type="button" class="lisa-fab" id="chat-toggle-btn" aria-label="Avaa chat Lisan kanssa" aria-expanded="false">
  ...
  <div class="lisa-panel" id="chat-window" hidden>
    <div class="lisa-panel__head">
      <div class="lisa-panel__identity">
        ...
        <div>
          <h4>Lisa</h4>
          <p>Käyttöönottoavustaja</p>
        </div>
      </div>
      <button type="button" class="lisa-panel__close" id="chat-close-btn" aria-label="Sulje chat">
    ...
    <div class="lisa-typing" id="typing-indicator" hidden>Lisa kirjoittaa…</div>
    ...
    <div class="lisa-form-wrap" id="chat-form-wrap" hidden>
      ...
      >
        <div class="form-already-registered hidden" data-already-registered>
          ...
          <p class="form-already-registered__text">Odota puhelua manageriltamme.</p>
        </div>
...
<?php endif; ?>
          ...
          <button type="submit" class="btn btn-primary btn-block submit" id="cq-custom-submit-btn">Luo ilmainen tili</button>
          ...
          <p class="form-legal">Lähettämällä hyväksyt <a href="conditions.php">Ehdot</a>.</p>
        </div>
      </form>
    </div>
    </div>
