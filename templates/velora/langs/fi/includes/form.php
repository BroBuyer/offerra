...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__text">
      Pyyntösi palveluun <?= e(SITE_NAME) ?> on vastaanotettu. Odota puhelua manageriltamme.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <div class="form-grid">
      <label class="field" data-field="fname">
        ...
        <input class="input" type="text" name="fname" placeholder="Matti" required pattern="[^\d]+" autocomplete="given-name">
      </label>
      <label class="field" data-field="lname">
        <span class="field-label">Sukunimi</span>
        <input class="input" type="text" name="lname" placeholder="Meikäläinen" required pattern="[^\d]+" autocomplete="family-name">
      </label>
      <label class="field field-full" data-field="email">
        <span class="field-label">Sähköposti</span>
        <input class="input" type="email" name="email" placeholder="sinä@email.com" required autocomplete="email" inputmode="email">
      </label>
    ...
    <p class="form-legal">
      Lähettämällä tietosi hyväksyt
      <a href="conditions.php">Käyttöehdot</a>.
    </p>
  </div>
</form>
<?php
