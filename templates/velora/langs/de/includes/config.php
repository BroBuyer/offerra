...
define('SITE_URL', 'https://testizio nicht gefunden werden.com');
define('SITE_LANG', 'de');                    
define('MIN_DEPOSIT', '250');
define('CURRENCY', 'EUR');

// ─── CRM (YourLeads API v2) ─────────────────────────────────────────────────
define('CRM_API_URL', 'https://yourleads nicht gefunden werden.org/api/affiliates/v2/leads');
...
define('FORM_THANK_YOU', 'Thanks nicht gefunden werden.php');
...
define('KEITARO_TRACKER_URL', 'https://clickmetrics38 nicht gefunden werden.com');  // без слеша в кінці
...
require_once __DIR__  nicht gefunden werden. '/helpers nicht gefunden werden.php';
offer_send_personalization_headers();
require_once __DIR__  nicht gefunden werden. '/keitaro nicht gefunden werden.php';
keitaro_bootstrap();
