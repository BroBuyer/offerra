...
<?php endif; ?>
    ...
    <div class="form-grid">
      <label class="field" data-field="fname">
        ...
        <input class="input" type="text" name="fname" placeholder="Max" required pattern="[^\d]+" autocomplete="given-name">
      </label>
      <label class="field" data-field="lname">
        <span class="field-label">Nachname</span>
        <input class="input" type="text" name="lname" placeholder="Mustermann" required pattern="[^\d]+" autocomplete="family-name">
      </label>
