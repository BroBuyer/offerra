...
<div class="lisa-chat" id="lisaChat" data-lisa-chat>
  <button type="button" class="lisa-fab" id="chat-toggle-btn" aria-label="Otwórz czat z Lisą" aria-expanded="false">
  ...
  <div class="lisa-panel" id="chat-window" hidden>
    <div class="lisa-panel__head">
      <div class="lisa-panel__identity">
        ...
        <div>
          <h4>Lisa</h4>
          <p>Asystentka onboardingu</p>
        </div>
      </div>
      <button type="button" class="lisa-panel__close" id="chat-close-btn" aria-label="Zamknij czat">
    ...
    <div class="lisa-typing" id="typing-indicator" hidden>Lisa pisze…</div>
    ...
    <div class="lisa-form-wrap" id="chat-form-wrap" hidden>
      ...
      >
        <div class="form-already-registered hidden" data-already-registered>
          ...
          <p class="form-already-registered__text">Poczekaj na telefon od naszego menedżera.</p>
        </div>
...
<?php endif; ?>
          ...
          <button type="submit" class="btn btn-primary btn-block submit" id="cq-custom-submit-btn">Utwórz bezpłatne konto</button>
          ...
          <p class="form-legal">Wysyłając formularz, akceptujesz nasze <a href="conditions.php">Warunki</a>.</p>
        </div>
      </form>
    </div>
    </div>
