  ...
  const steps = [
    {
      bot:
        L.chatStep1Bot ||
        "Szia! Lisa vagyok, a belépési asszisens. Készen állsz néhány gyors lépésben kereskedési fiókot nyitni?",
      choices: [
        { label: L.chatStep1Yes || "Igen, kezdjük", value: 'start' },
        { label: L.chatStep1More || 'Előbb mesélj többet', value: 'more' },
      ],
    },
    {
      bot: L.chatStep2Bot || 'Remek. Kereskedtél már kriptóval vagy forexszel?',
      choices: [
        { label: L.chatStep2New || "Új vagyok", value: 'beginner' },
        { label: L.chatStep2Mid || 'Van tapasztalatom', value: 'mid' },
        { label: L.chatStep2Pro || "Tapasztalt vagyok", value: 'pro' },
      ],
    },
    {
      bot: L.chatStep3Bot || 'Mi érdekel most leginkább?',
      choices: [
        { label: L.chatStep3Crypto || 'Kriptó', value: 'crypto' },
        { label: L.chatStep3Forex || 'Forex', value: 'forex' },
        { label: L.chatStep3Stocks || 'Részvények / indexek', value: 'stocks' },
        { label: L.chatStep3All || 'Mindegyik', value: 'all' },
      ],
    },
    {
      bot:
        L.chatStep4Bot ||
        "Tökéletes. Előkészítem az ingyenes fiók űrlapot — kevesebb mint 3 perc, és csapatunk felhív a beállítás befejezéséhez.",
      choices: [{ label: L.chatStep4Form || 'Űrlap megnyitása', value: 'form' }],
    },
  ];

  const moreReply =
    L.chatMoreReply ||
    'Kezdőket tiszta irányítópulttal, érthető AI piaci tippekkel és biztonságos feltöltéssel vezetünk a minimális befizetéstől. Folytassuk?';

  const continueLabel = L.chatContinue || "Igen, folytassuk";
  const formPrompt =
    L.chatFormPrompt ||
    "Kérjük, adja meg az adatait alább, és küldje el — itt maradok, ha segítségre van szüksége.";
