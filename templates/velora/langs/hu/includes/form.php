...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__text">
      A <?= e(SITE_NAME) ?> felé benyújtott kérelmét megkaptuk. Kérjük, várja menedzserünk hívását.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <div class="form-grid">
      <label class="field" data-field="fname">
        ...
        <input class="input" type="text" name="fname" placeholder="János" required pattern="[^\d]+" autocomplete="given-name">
      </label>
      <label class="field" data-field="lname">
        <span class="field-label">Vezetéknév</span>
        <input class="input" type="text" name="lname" placeholder="Kovács" required pattern="[^\d]+" autocomplete="family-name">
      </label>
      <label class="field field-full" data-field="email">
        <span class="field-label">E-mail</span>
        <input class="input" type="email" name="email" placeholder="te@email.com" required autocomplete="email" inputmode="email">
      </label>
    ...
    <?php
    $payment_context = 'fiókregisztráció';
    ...
    <p class="form-legal">
      Az adatok elküldésével elfogadja
      <a href="conditions.php">Felhasználási feltételek</a>.
    </p>
  </div>
</form>
<?php
