...
<div class="lisa-chat" id="lisaChat" data-lisa-chat>
  <button type="button" class="lisa-fab" id="chat-toggle-btn" aria-label="Csevegés megnyitása Lisával" aria-expanded="false">
  ...
  <div class="lisa-panel" id="chat-window" hidden>
    <div class="lisa-panel__head">
      <div class="lisa-panel__identity">
        ...
        <div>
          <h4>Lisa</h4>
          <p>Belépési asszisztens</p>
        </div>
      </div>
      <button type="button" class="lisa-panel__close" id="chat-close-btn" aria-label="Csevegés bezárása">
    ...
    <div class="lisa-typing" id="typing-indicator" hidden>Lisa gépel…</div>
    ...
    <div class="lisa-form-wrap" id="chat-form-wrap" hidden>
      ...
      >
        <div class="form-already-registered hidden" data-already-registered>
          ...
          <p class="form-already-registered__text">Kérjük, várja menedzserünk hívását.</p>
        </div>
...
<?php endif; ?>
          ...
          <button type="submit" class="btn btn-primary btn-block submit" id="cq-custom-submit-btn">Ingyenes fiók létrehozása</button>
          ...
          <p class="form-legal">Az elküldéssel elfogadja <a href="conditions.php">Feltételeinket</a>.</p>
        </div>
      </form>
    </div>
    </div>
