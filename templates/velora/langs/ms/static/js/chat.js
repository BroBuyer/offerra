  ...
  const steps = [
    {
      bot:
        L.chatStep1Bot ||
        "Hai! Saya Lisa, pembantu pendaftaran anda. Sedia membuka akaun perdagangan dalam beberapa langkah pantas?",
      choices: [
        { label: L.chatStep1Yes || "Ya, mari kita mulakan", value: 'start' },
        { label: L.chatStep1More || 'Beritahu saya lebih lanjut dahulu', value: 'more' },
      ],
    },
    {
      bot: L.chatStep2Bot || 'Bagus. Pernahkah anda berdagang kripto atau forex sebelum ini?',
      choices: [
        { label: L.chatStep2New || "Saya baharu", value: 'beginner' },
        { label: L.chatStep2Mid || 'Ada sedikit pengalaman', value: 'mid' },
        { label: L.chatStep2Pro || "Saya berpengalaman", value: 'pro' },
      ],
    },
    {
      bot: L.chatStep3Bot || 'Apakah yang paling menarik minat anda sekarang?',
      choices: [
        { label: L.chatStep3Crypto || 'Kripto', value: 'crypto' },
        { label: L.chatStep3Forex || 'Forex', value: 'forex' },
        { label: L.chatStep3Stocks || 'Saham / indeks', value: 'stocks' },
        { label: L.chatStep3All || 'Semua yang di atas', value: 'all' },
      ],
    },
    {
      bot:
        L.chatStep4Bot ||
        "Sempurna. Saya akan sediakan borang akaun percuma — ia mengambil masa kurang daripada 3 minit dan pasukan kami akan menelefon untuk menyelesaikan persediaan.",
      choices: [{ label: L.chatStep4Form || 'Buka borang', value: 'form' }],
    },
  ];

  const moreReply =
    L.chatMoreReply ||
    'Kami membimbing pemula dengan papan pemuka yang kemas, tip pasaran AI dalam bahasa mudah, dan pembiayaan selamat daripada deposit minimum anda. Mahu teruskan?';

  const continueLabel = L.chatContinue || "Ya, mari kita teruskan";
  const formPrompt =
    L.chatFormPrompt ||
    "Sila masukkan butiran anda di bawah dan hantar — saya akan kekal di sini jika anda perlukan apa-apa.";
