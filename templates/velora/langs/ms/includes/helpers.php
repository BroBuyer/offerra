...
{
    return SITE_NAME . ' platform perdagangan pada mudah alih — carta BTC/USDT secara langsung, buku pesanan dan antara muka beli/jual';
}

function platform_image_caption(): string
{
    return SITE_NAME . ' — perdagangan mudah alih dengan carta mata wang kripto masa nyata';
}
...
/**
 * Apex https canonical — strips www / index.php and normalizes trailing slash for laman utama.
 */
