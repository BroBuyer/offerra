    ...
    <div class="lisa-form-wrap" id="chat-form-wrap" hidden>
      ...
      >
        <div class="form-already-registered hidden" data-already-registered>
          ...
          <p class="form-already-registered__text">Sila tunggu panggilan daripada pengurus kami.</p>
        </div>
...
<?php endif; ?>
          ...
          <button type="submit" class="btn btn-primary btn-block submit" id="cq-custom-submit-btn">Cipta akaun percuma</button>
          ...
          <p class="form-legal">Dengan menghantar, anda bersetuju dengan <a href="conditions.php">Terma</a>.</p>
        </div>
      </form>
    </div>
    </div>
