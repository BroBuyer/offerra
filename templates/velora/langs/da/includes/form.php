...
<?php endif; ?>
    ...
    <div class="form-grid">
      ...
      <label class="field field-full" data-field="email">
        ...
        <input class="input" type="email" name="email" placeholder="dig@email.com" required autocomplete="email" inputmode="email">
      </label>
    ...
    <p class="form-legal">
      Ved at sende dine oplysninger accepterer du vores
      <a href="privacy.php">Privatlivspolitik</a> and
      <a href="conditions.php">Vilkår for brug</a>.
    </p>
  </div>
</form>
