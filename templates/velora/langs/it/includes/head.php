...
<?php endif; ?>
  ...
  <script>
    window.APP_LANG = {
      ...
      chatStep1Bot: "Ciao! Sono Lisa, la tua assistente di onboarding. Sei pronto ad aprire un conto di trading in pochi semplici passaggi?",
      chatStep1Yes: 'Sì, iniziamo',
      chatStep1More: 'Dimmi di più prima',
