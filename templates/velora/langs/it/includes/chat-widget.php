...
<div class="lisa-chat" id="lisaChat" data-lisa-chat>
  <button type="button" class="lisa-fab" id="chat-toggle-btn" aria-label="Apri la chat con Lisa" aria-expanded="false">
  ...
  <div class="lisa-panel" id="chat-window" hidden>
    <div class="lisa-panel__head">
      <div class="lisa-panel__identity">
        ...
        <div>
          <h4>Lisa</h4>
          <p>Assistente di onboarding</p>
        </div>
      </div>
      <button type="button" class="lisa-panel__close" id="chat-close-btn" aria-label="Chiudi la chat">
    ...
    <div class="lisa-typing" id="typing-indicator" hidden>Lisa sta scrivendo…</div>
    ...
    <div class="lisa-form-wrap" id="chat-form-wrap" hidden>
      ...
      >
        <div class="form-already-registered hidden" data-already-registered>
          ...
          <p class="form-already-registered__text">Attendi la chiamata del nostro responsabile.</p>
        </div>
...
<?php endif; ?>
          ...
          <button type="submit" class="btn btn-primary btn-block submit" id="cq-custom-submit-btn">Crea un account gratuito</button>
          ...
          <p class="form-legal">Inviando i tuoi dati accetti i nostri <a href="conditions.php">Termini</a>.</p>
        </div>
      </form>
    </div>
    </div>
