...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__text">
      La tua richiesta con <?= e(SITE_NAME) ?> è stata ricevuta. Attendi la chiamata del nostro responsabile.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <div class="form-grid">
      <label class="field" data-field="fname">
        ...
        <input class="input" type="text" name="fname" placeholder="Mario" required pattern="[^\d]+" autocomplete="given-name">
      </label>
      <label class="field" data-field="lname">
        <span class="field-label">Cognome</span>
        <input class="input" type="text" name="lname" placeholder="Rossi" required pattern="[^\d]+" autocomplete="family-name">
      </label>
    ...
    <p class="form-legal">
      Inviando i tuoi dati accetti i nostri
