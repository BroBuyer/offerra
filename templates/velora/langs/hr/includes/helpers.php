...
{
    return SITE_NAME . ' trgovačka platforma na mobitelu — živi BTC/USDT grafikon, knjiga naloga i sučelje kupi/prodaj';
}

function platform_image_caption(): string
{
    return SITE_NAME . ' — mobilno trgovanje s kriptovalutnim grafikonima u stvarnom vremenu';
}
...
/**
 * Apex https canonical — strips www / index.php and normalizes trailing slash for — početna.
 */
