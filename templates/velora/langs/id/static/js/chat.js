  ...
  const steps = [
    {
      bot:
        L.chatStep1Bot ||
        "Hai! Saya Lisa, pembantu pendaftaran anda. Sedia membuka akun perdagangan dalam beberapa langkah cepat?",
      choices: [
    ...
    },
    {
      bot:
        L.chatStep4Bot ||
        "Sempurna. Saya akan sediakan formulir akun gratis — ia mengambil masa kurang dari 3 menit dan pasukan kami akan menelefon untuk menyelesaikan persediaan.",
      choices: [{ label: L.chatStep4Form || 'Buka formulir', value: 'form' }],
    },
  ];

  const moreReply =
    L.chatMoreReply ||
    'Kami membimbing pemula dengan papan pemuka yang kemas, tip pasar AI dalam bahasa mudah, dan pembiayaan selamat dari deposit minimum anda. Ingin teruskan?';

  const continueLabel = L.chatContinue || "Ya, mari kita teruskan";
  const formPrompt =
    L.chatFormPrompt ||
    "Silakan masukkan detail Anda di bawah dan kirim — saya akan kekal di sini jika anda perlukan apa-apa.";
