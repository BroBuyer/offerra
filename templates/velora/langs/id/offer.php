...
<main>
  <section class="page-hero">
    <div class="container">
      ...
      <p class="lead">Satu titik masuk yang mudah. Akses platform penuh selepas pembiayaan — termasuk cerapan AI dan pasar langsung.</p>
    </div>
  </section>
    ...
    <div class="container" style="max-width: 520px;">
      <div class="page-panel">
        ...
        <p class="prose" style="margin-bottom:18px">
          ...
          Carta, alat dan panduan AI dibuka setelah akun Anda dibiayai.
        </p>
        <?php
        $form_id = 'offer-form';
