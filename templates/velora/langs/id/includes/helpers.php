...
{
    return SITE_NAME . ' platform perdagangan pada seluler — carta BTC/USDT secara langsung, buku pesanan dan antarmuka beli/jual';
}

function platform_image_caption(): string
{
    return SITE_NAME . ' — perdagangan seluler dengan carta mata wang kripto masa nyata';
}
...
/**
 * Apex https canonical — strips www / index.php and normalizes trailing slash for beranda.
 */
