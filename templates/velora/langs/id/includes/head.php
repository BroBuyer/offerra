...
$page_title = $page_title ?? SITE_NAME . ' | Enjin Perdagangan AI Premium untuk Pasar Global';
$page_description = $page_description ?? 'Cara yang lebih pintar dan kemas untuk mengakses pasar global dengan ' . SITE_NAME . ' — alat AI berstruktur untuk kripto, forex dan ekuiti.';
...
<?php endif; ?>
  ...
  <script>
    window.APP_LANG = {
      ...
      chatStep1Bot: "Hai! Saya Lisa, pembantu pendaftaran anda. Sedia membuka akun perdagangan dalam beberapa langkah cepat?",
      ...
      chatStep4Bot: "Sempurna. Saya akan sediakan formulir akun gratis — ia mengambil masa kurang dari 3 menit dan pasukan kami akan menelefon untuk menyelesaikan persediaan.",
      chatStep4Form: 'Buka formulir',
      chatMoreReply: 'Kami membimbing pemula dengan papan pemuka yang kemas, tip pasar AI dalam bahasa mudah, dan pembiayaan selamat dari deposit minimum anda. Ingin teruskan?',
      chatContinue: "Ya, mari kita teruskan",
      chatFormPrompt: "Silakan masukkan detail Anda di bawah dan kirim — saya akan kekal di sini jika anda perlukan apa-apa.",
      valTeleponRequired: 'Masukkan nomor telepon Anda',
      valTeleponInvalid: 'Masukkan nomor telepon yang valid',
      valTeleponCountry: 'Kode negara tidak valid',
      valTeleponShort: 'Nomor telepon terlalu pendek',
      valTeleponLong: 'Nomor telepon terlalu panjang',
      valSessionExpired: 'Sesi berakhir. Muat ulang halaman dan coba lagi.',
      valGenericError: 'Terjadi kesalahan. Silakan coba lagi nanti.',
      valConnectionError: 'Kesalahan koneksi. Periksa koneksi internet anda dan coba lagi.'
    };
  </script>
  <script>
    (function () {
