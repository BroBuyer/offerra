  ...
  <div class="container">
    <div class="footer-top">
      <div class="footer-grid">
        ...
        <div class="footer-links-col">
          <h4>Platform</h4>
          <ul>
            <li><a href="<?= e(page_url()) ?>#platform">Antarmuka</a></li>
            <li><a href="<?= e(page_url()) ?>#features">Fitur</a></li>
            <li><a href="<?= e(page_url()) ?>#markets">Gambaran pasar</a></li>
          </ul>
        </div>
        ...
        <div class="footer-links-col">
          <h4>Hukum</h4>
          <ul>
            <li><a href="conditions.php">Ketentuan Penggunaan</a></li>
    ...
    <div class="footer-bottom">
      <p class="disclaimer">
        ...
        Perdagangan aset digital dan instrumen global melibatkan volatiliti pasar yang tinggi.
        Kekalkan kontrol penuh ke atas tetapan strategi anda. Metrik otomatis pada <?= e(SITE_NAME) ?>
        berfungsi semata-mata sebagai bantuan analitik.
      </p>
      <div class="footer-meta-links">
        <span>&copy; <?= date('Y') ?> <?= e(SITE_NAME) ?>. Hak cipta dilindungi.</span>
      </div>
    </div>
  </div>
</footer>
