...
<div class="lisa-chat" id="lisaChat" data-lisa-chat>
  <button type="button" class="lisa-fab" id="chat-toggle-btn" aria-label="Buka sembang dengan Lisa" aria-expanded="false">
  ...
  <div class="lisa-panel" id="chat-window" hidden>
    <div class="lisa-panel__head">
      <div class="lisa-panel__identity">
        ...
        <div>
          <h4>Lisa</h4>
          <p>Pembantu pendaftaran</p>
        </div>
      </div>
      <button type="button" class="lisa-panel__close" id="chat-close-btn" aria-label="Tutup sembang">
    ...
    <div class="lisa-typing" id="typing-indicator" hidden>Lisa sedang menaip…</div>
    ...
    <div class="lisa-form-wrap" id="chat-form-wrap" hidden>
      ...
      >
        <div class="form-already-registered hidden" data-already-registered>
          ...
          <p class="form-already-registered__text">Silakan tunggu panggilan dari manajer kami.</p>
        </div>
...
<?php endif; ?>
          ...
          <button type="submit" class="btn btn-primary btn-block submit" id="cq-custom-submit-btn">Buat akun gratis</button>
          ...
          <p class="form-legal">Dengan mengkirim, anda setuju dengan <a href="conditions.php">Terma</a>.</p>
        </div>
      </form>
    </div>
    </div>
