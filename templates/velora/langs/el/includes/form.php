...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__text">
      Το αίτημά σας με <?= e(SITE_NAME) ?> ελήφθη. Περιμένετε κλήση από τον διαχειριστή μας.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <div class="form-grid">
      <label class="field" data-field="fname">
        ...
        <input class="input" type="text" name="fname" placeholder="Γιάννης" required pattern="[^\d]+" autocomplete="given-name">
      </label>
      <label class="field" data-field="lname">
        <span class="field-label">Επώνυμο</span>
        <input class="input" type="text" name="lname" placeholder="Παπαδόπουλος" required pattern="[^\d]+" autocomplete="family-name">
      </label>
    ...
    <?php
    $payment_context = 'εγγραφή λογαριασμού';
    ...
    <p class="form-legal">
      Υποβάλλοντας τα στοιχεία σας συμφωνείτε με τους
      <a href="conditions.php">Όροι χρήσης</a>.
    </p>
  </div>
</form>
<?php
