...
{
    return SITE_NAME . ' πλατφόρμα συναλλαγών σε κινητό — ζωντανό γράφημα BTC/USDT, order book και διεπαφή αγοράς/πώλησης';
}

function platform_image_caption(): string
{
    return SITE_NAME . ' — κινητό trading με crypto γραφήματα σε πραγματικό χρόνο';
}
