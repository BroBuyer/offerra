<?php
/**
 * Πλατφόρμα showcase image — optimized for Google Images indexing.
 */
...
<figure class="platform-figure<?= $as_phone ? ' app-phone-wrap' : '' ?>" itemscope itemtype="https://schema.org/ImageObject">
  <meta itemprop="name" content="<?= e(SITE_NAME) ?> AI πλατφόρμα συναλλαγών">
  ...
  <div class="platform-figure-media">
    <img
      src="<?= e($platform_img) ?>"
      alt="<?= e($platform_alt) ?>"
      title="<?= e(page_title('AI πλατφόρμα συναλλαγών')) ?>"
      width="320"
      height="640"
