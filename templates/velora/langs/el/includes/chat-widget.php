...
<div class="lisa-chat" id="lisaChat" data-lisa-chat>
  <button type="button" class="lisa-fab" id="chat-toggle-btn" aria-label="Άνοιγμα chat με την Lisa" aria-expanded="false">
  ...
  <div class="lisa-panel" id="chat-window" hidden>
    <div class="lisa-panel__head">
      <div class="lisa-panel__identity">
        ...
        <div>
          <h4>Lisa</h4>
          <p>Βοηθός onboarding</p>
        </div>
      </div>
      <button type="button" class="lisa-panel__close" id="chat-close-btn" aria-label="Κλείσιμο chat">
    ...
    <div class="lisa-typing" id="typing-indicator" hidden>Η Lisa πληκτρολογεί…</div>
    ...
    <div class="lisa-form-wrap" id="chat-form-wrap" hidden>
      ...
      >
        <div class="form-already-registered hidden" data-already-registered>
          <p class="form-already-registered__title">Έχετε ήδη εγγραφεί</p>
          <p class="form-already-registered__text">Περιμένετε κλήση από τον διαχειριστή μας.</p>
        </div>
...
<?php endif; ?>
          ...
          <button type="submit" class="btn btn-primary btn-block submit" id="cq-custom-submit-btn">Δημιουργία δωρεάν λογαριασμού</button>
          ...
          <p class="form-legal">Με την υποβολή συμφωνείτε με τους <a href="conditions.php">Όρους</a>.</p>
        </div>
      </form>
    </div>
    </div>
