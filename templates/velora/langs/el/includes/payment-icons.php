...
$payment_context = $payment_context ?? 'ασφαλή checkout';
...
$methods = [
    ...
    ['file' => 'banktransfer.svg','alt' => 'Τραπεζική μεταφορά και SEPA — αποδεκτές στο ' . SITE_NAME],
];
?>
  ...
  <ul class="payment-icons-list">
    ...
    <li>
      <img
        ...
        alt="256-bit κρυπτογράφηση SSL — ασφαλής μεταφορά δεδομένων στο <?= e(SITE_NAME) ?>"
        title="Προστασία SSL"
        width="32"
        height="32"
        loading="lazy"
