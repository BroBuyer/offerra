...
<span class="breadcrumb-item">Details of Offer</span>
          </nav>
        </div>
      </div>
      <!-- tracker -->
      <div class="py-8 md:py-10">
        <div class="container-base grid gap-6 lg:grid-cols-2">
          ...
          >
 <h1 class="relative z-20">Start your journey with <?= e(SITE_NAME) ?>: market monitoring, analysis & support</h1>
<p class="relative z-20">
  Sign up, verify your identity, and add funds swiftly. Benefit from portfolio tracking, AI trading assistance, and a guided experience that leads you clearly from your first login to your dashboard.</p>
          </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-8">
    <p class="text-lg max-w-4xl">Our service offers guided onboarding, full access to market tools, and ongoing assistance. We provide a straightforward and transparent path from registration to everyday trading without shortcuts.</p>    <p class="max-w-4xl">A minimum deposit unlocks all platform features. Explore AI-driven strategies, manage risk controls, and track your portfolio's progress.</p>    <p class="max-w-4xl">Always check fees, withdrawal times, and verification steps as shown on the platform. We aim to give you operational control: limits, position sizing, and manual options remain accessible even when automated alerts are active.</p>    <p class="max-w-4xl">Support explains how <?= e(SITE_NAME) ?> operates and transaction status; it does not give personalised advice. Markets carry risk: consider your exposure carefully and trade only with money you can afford to lose.</p>    <div class="grid gap-4 md:grid-cols-3">
            <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-2">Effortless Onboarding</h2>
        <p>Effortless account creation, identity confirmation, and transparent dashboard access.</p>
      </div>
            <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-2">AI Support & Markets</h2>
        <p>Built-in analytics, automated signals, and multi-market availability in one platform.</p>
      </div>
            <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-2">Clear Customer Support</h2>
        <p>Clear fee structures and withdrawal policies; dedicated support for accounts and transactions.</p>
      </div>
          </div>
  </div>
</div>
...
<div class="relative z-40 py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10">
    ...
    <div class="border-primary h3 rounded-custom relative z-10 flex items-center justify-center border bg-white p-4 text-center md:p-6">
      Add funds to your account    </div>
    <div class="border-primary h3 rounded-custom relative z-10 flex items-center justify-center border bg-white p-4 text-center md:p-6">
      Start trading with confidence    </div>
        </div>
      </div>
    </div>
      <!-- registration-1 -->
...
<h2>The Official <?= e(SITE_NAME) ?> Platform for Methodical Trading</h2>
<p>
  <?= e(SITE_NAME) ?> is designed for individuals and teams managing digital currencies and assets, offering clear tools, SSL encryption, and rapid assistance. A single platform for analysis, trading, and portfolio management.</p>
          </div>
