...
$page_title = 'サポート｜ ' . SITE_NAME . ' チーム';
$page_description = 'お問い合わせは ' . SITE_NAME . ' サポートチームへ。口座、入金、出金、プラットフォームに関するご質問に対応します。';
$page_canonical = page_url("contacts.php");
$active_page = "contacts";
$schema_extra = ['breadcrumb' => schema_breadcrumb('お問い合わせ', 'contacts.php')];
...
<h1>お問い合わせ</h1>
  <p class="lead max-w-3xl justify-self-center text-center md:text-left"><?= e(SITE_NAME) ?>チームは、口座、入金、出金、チャート、AIツールに関するお問い合わせに対応します。サポートは公式チャネル経由です。個別の投資推奨や利益保証はありません。</p>
<div class="grid gap-4 text-center md:gap-6 md:text-left max-w-3xl justify-self-center">
  <h3>追加のサポートはメールで</h3>  <p>ご連絡の前に、口座のメールアドレス、お問い合わせ内容（登録、支払い、技術）、関連するスクリーンショットをご用意ください。詳しい情報があると、より早く解決でき、やり取りも減ります。</p>  <p>進行中の取引や出金待ちに関するご依頼は、可能な限り優先します。セキュリティのため、無断のメールでパスワード全体や2FAコードをお尋ねすることはありません。</p>  <p>まだご登録でない場合は、登録ページで数分以内に口座を開設し、ご質問があればこちらへお戻りください。手数料、セキュリティ、取扱市場については、よくあるご質問もご参照ください。</p>  <p>件名はわかりやすくご記入ください（例：「出金待ち」「2FAの問題」「手数料について」）。ほとんどのお問い合わせには数時間以内に初回返信があります。件数が多い場合や支払い確認では遅れることがありますが、状況はご案内します。</p></div>
