...
$page_title = $page_title ?? (SITE_NAME . ' | AI搭載の先進取引プラットフォーム');
$page_description = $page_description ?? ('暗号資産、外国為替、世界の資産に、ひとつのプラットフォームからアクセスできます。 ' . SITE_NAME . ' はライブ分析、アシスト自動化、専門家サポートを組み合わせています。');
