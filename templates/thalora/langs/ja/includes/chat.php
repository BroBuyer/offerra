        ...
        <div style="background-color: #1a1a1e !important; border-bottom: 1px solid #27272a !important; padding: 14px 18px !important; display: flex !important; align-items: center !important; justify-content: space-between !important; flex-direction: row !important;">
            <div style="display: flex !important; align-items: center !important; gap: 12px !important; flex-direction: row !important;">
                ...
                <div style="text-align: left !important;">
                    ...
                    <p style="color: #a1a1aa !important; font-size: 11px !important; margin: 0 !important; padding: 0 !important; opacity: 0.85;">導入ガイド</p>
                </div>
            </div>
            <button id="chat-close-btn" type="button" aria-label="チャットを閉じる" style="color: #a1a1aa !important; background: transparent !important; border: none !important; cursor: pointer !important; padding: 6px !important; display: flex !important; align-items: center !important; transition: color 0.2s;">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const quizLang = {
        welcome: `こんにちは。Oliviaです。 <?= e(SITE_NAME) ?> のオンボーディングガイドです。アクセスは事前承認済みです。それではプロフィールの作成を始めましょう。`,
        q1: `法令を完全に遵守するため、 <?= e(geo_country_in()) ?> の居住者であることをご確認ください。`,
        a1_yes: `はい、現在ここに住んでいます`,
        a1_no: `いいえ`,
        q2: `ありがとうございます。適切な金融商品をご案内するため、年齢層をお選びください：`,
        q3: `日々の配当を受け取るための、有効な銀行口座またはクレジットカードはお持ちですか？`,
        a3_yes: `はい、口座は有効です`,
        a3_no: `現在はありません`,
        q4: `主な収入源は何ですか？プラットフォームのリスク設定をお客様に合わせるために伺います。`,
        a4_1: `給与所得またはフリーランス`,
        a4_2: `貯蓄または不労所得`,
        a4_3: `その他の所得`,
        q5: `もう少しです。担当者より11:00〜20:00の間に短い確認のお電話をいたします。お電話に出ていただけますか？`,
        a5_yes: `はい、その時間で問題ありません`,
        a5_no: `できるだけ早くご連絡ください`,
        loaderText: `ご回答を確認し、セキュアなアカウントを準備しています...`,
        finalTitle: `確認が完了しました！🎉 セキュアなアカウントの準備ができました。毎日の支払いを有効にするには、以下の手順に従ってください：`,
    ...
    function appendAgentMessage(text) {
        ...
        msg.innerHTML = `
            <div style="width: 28px; height: 28px; border-radius: 50%; border: 1px solid var(--color-primary); background-color: #27272a; display: flex; align-items: center; justify-content: center; overflow: hidden; flex-shrink: 0; margin-top: 2px;">
                <img alt="取引プラットフォームの画像" src="<?= asset('static/img/consultant.webp') ?>" width="28" height="28" decoding="async" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';" style="width:100%; height:100%; object-fit:cover;" class="cq-consultant-img">
