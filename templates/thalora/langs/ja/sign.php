...
$page_title = '口座開設｜取引を始める — ' . SITE_NAME;
$page_description = '高度なAI取引機能を利用するため、 ' . SITE_NAME . ' の口座をすばやく開設できます。';
$page_canonical = page_url("sign.php");
$active_page = "sign";
$schema_extra = ['breadcrumb' => schema_breadcrumb('ログイン / 登録', 'sign.php')];
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      ...
      <span class="breadcrumb-item">ログイン / 登録</span>
    </nav>
  </div>
</div>
      <!-- registration-1 -->
...
<h1>本日、 <?= e(SITE_NAME) ?> の口座を開設</h1>
<h2>規制対象プラットフォーム™でお取引</h2>
<p>
  個人トレーダーと企業から、安全な暗号資産の購入・売却・管理のために信頼されています。</p>
          </div>
