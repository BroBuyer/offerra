...
$page_title = 'Obchodní nástroje | Funkce posílené AI — ' . SITE_NAME;
$page_description = 'Používejte grafy naživo, poznatky AI a obchodní nástroje ' . SITE_NAME . ' při bezpečnosti, které můžete důvěřovat.';
$page_canonical = page_url("product.php");
$active_page = "product";
$schema_extra = ['breadcrumb' => schema_breadcrumb('Funkce platformy', 'product.php')];
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      ...
      <span class="breadcrumb-item">Funkce platformy</span>
    </nav>
  </div>
</div>
      <!-- analytics -->
  ...
  <div class="container-base grid gap-6 lg:grid-cols-2">
    ...
    >
      <h1 class="relative z-20">Obchodování a analytika posílené AI</h1>
      <p class="relative z-20">
        Získejte široké poznatky o trhu a portfoliu z analytiky <?= e(SITE_NAME) ?>. Grafy v reálném čase, integrované indikátory a analýza AI pro informované volby.      </p>
    </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-8 max-w-4xl">
    <p class="text-lg"><?= e(SITE_NAME) ?> nabízí integrovanou platformu: obchodní nástroje, široké sledování trhu a podporovanou automatizaci. Funkce a denní výhody najdete níže.</p>    <p>Platforma otevírá více trhů — kryptoměny, forex, akcie a komodity — s cenami naživo. Spravujte příkazy a riziko z jednoho panelu, bez přepínání aplikací.</p>    <p>Analytické nástroje spojují data v reálném čase a poznatky AI, aby zachytily trendy a podstatné pohyby. Podporují rozhodnutí; vy kontrolujete strategii, objem a limity. Rozhraní staví na jednoduchost a efektivní provedení.</p>    <p>Bezpečnost a spolehlivost jsou základ: šifrovaná spojení, silná ochrana účtu a jasné vklady. Vyhovuje začátečníkům i expertům, škáluje se od základního použití po pokročilé obchodování bez změny platformy.</p>    <div class="grid gap-6 md:grid-cols-2">
            <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-3">Trhy a obchodní nástroje</h2>
        <p>Sledujte digitální měny, forex, akcie a komodity integrovanými nástroji, seznamy sledování a upozorněními. <?= e(SITE_NAME) ?> spojuje analýzu se správou příkazů a portfolia.</p>
      </div>
                  <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-3">Transparentnost, bezpečnost a kontrola</h2>
        <p>Bezpečná spojení, ověřené postupy, transparentní vklady a výběry. Poplatky jsou viditelné před potvrzením.</p>
      </div>
          </div>
  </div>
</div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>Obchodní platforma v prohlížeči</h2>
      <div class="grid grid-cols-2 gap-x-8 gap-y-6">
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Finanční trhy</p>
            <p>Okamžitý přístup ke všem funkcím</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Tržní poznatky</p>
            <p>Rychlý přístup ke kompletní historii dat</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Optimalizováno pro mobil</p>
            <p>Plynulý mobilní zážitek, kdekoli jste</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Správa kryptoměn</p>
            <p>Jednoduše spravujte celé portfolio</p>
          </div>
        </div>
      </div>
    </div>
    <div class="flex items-center justify-center">
        ...
        <img
          ...
          alt="<?= e(SITE_NAME) ?> — obchodní platforma na mobilu"
...
<div class="py-8 md:py-10">
  ...
  >
    ...
    >
      ...
      <p class="h3">Objem transakcí</p>
    </div>
    <div
      class="rounded-custom grid content-start gap-5 border p-4 md:p-6"
    >
      <p class="h2 lowercase">100+</p>
      <p class="h3">Podporované státy</p>
    </div>
  </div>
</div>
      <!-- capabilities -->
    ...
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Klíčové investiční funkce</p>
          <p>Zkušenost ukázaná na konkrétních projektech a kreativních přístupech.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          ...
          <p>Bezpečné, jednoduché prostředí na nákup kryptoměn. Rychlé zpracování, nízké poplatky. Začněte obchodovat hned.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          ...
          <p>Pochopte ceny a trendy pro informovaná investiční rozhodnutí.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Obchodování s digitálními aktivy</p>
          <p>Obchodujte krypto futures. Objevujte, investujte a rozšiřujte portfolio.</p>
        </div>
      </div>
    </div>
  </div>
...
<p class="h2">Začněte nyní</p>
<p>
  Objevte krypto obchodování s <?= e(SITE_NAME) ?>. Tradeři z <?= e(geo_country_name()) ?> najdou platformu spojující pokročilou technologii, efektivitu a jednoduché nástroje.</p>
          </div>
