...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    <li>
      <a class="data-active:text-primary" href="<?= page_url() ?>"<?= $active_page === 'home' ? ' data-active aria-current="page"' : '' ?>>Domů</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="<?= page_url('product.php') ?>"<?= $active_page === 'product' ? ' data-active aria-current="page"' : '' ?>>Přehled platformy</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="<?= page_url('offer.php') ?>"<?= $active_page === 'offer' ? ' data-active aria-current="page"' : '' ?>>Promoce</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="<?= page_url('contacts.php') ?>"<?= $active_page === 'contacts' ? ' data-active aria-current="page"' : '' ?>>Kontakt</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="<?= page_url('faq.php') ?>"<?= $active_page === 'faq' ? ' data-active aria-current="page"' : '' ?>>Centrum podpory</a>
    </li>
  </ul>
</nav>
        <div class="flex items-center gap-4 max-md:hidden mobmenu">
          <a class="group inline-flex h-[50px] items-center justify-between rounded-full border-2" href="<?= page_url('sign.php') ?>">
            <span class="inline-block p-3.5 text-sm">Registrace</span>
          ...
          <a class="inline-flex h-[50px] w-[50px] shrink-0 items-center justify-center rounded-full border-2" href="<?= page_url('sign.php') ?>" aria-label="Přihlášení">
        ...
        <button class="menu-icon" data-menu-icon aria-label="otevřít menu">
    ...
    <nav class="mobile-menu" data-mobile-menu>
      <ul class="flex flex-col flex-wrap items-center justify-center gap-y-8">
        <li><a href="<?= page_url() ?>">Domů</a></li>
        <li><a href="<?= page_url('product.php') ?>">Přehled platformy</a></li>
        <li><a href="<?= page_url('offer.php') ?>">Promoce</a></li>
        <li><a href="<?= page_url('contacts.php') ?>">Kontakt</a></li>
        <li><a href="<?= page_url('faq.php') ?>">Centrum podpory</a></li>
      </ul>
