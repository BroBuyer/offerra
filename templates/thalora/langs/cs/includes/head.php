...
$page_title = $page_title ?? (SITE_NAME . ' | Vedoucí obchodní platforma poháněná AI');
$page_description = $page_description ?? ('Přistupte ke kryptoměnám, forexu a globálním aktivům z jedné platformy. ' . SITE_NAME . ' spojuje analytiku naživo, podporovanou automatizaci a odbornou podporu.');
...
<?php endif; ?>
  ...
  window.APP_LANG = {
    ...
    valPhoneEmpty: 'Zadejte telefonní číslo',
    valSessionExpired: 'Relace vypršela. Obnovte stránku a zkuste to znovu.',
    valGenericError: 'Něco se pokazilo. Zkuste to později znovu.',
    valConnectionError: 'Chyba připojení. Zkontrolujte internet a zkuste to znovu.'
  };
