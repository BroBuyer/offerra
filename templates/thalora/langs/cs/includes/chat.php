        ...
        <div style="background-color: #1a1a1e !important; border-bottom: 1px solid #27272a !important; padding: 14px 18px !important; display: flex !important; align-items: center !important; justify-content: space-between !important; flex-direction: row !important;">
            <div style="display: flex !important; align-items: center !important; gap: 12px !important; flex-direction: row !important;">
                ...
                <div style="text-align: left !important;">
                    ...
                    <p style="color: #a1a1aa !important; font-size: 11px !important; margin: 0 !important; padding: 0 !important; opacity: 0.85;">Průvodce onboardingem</p>
                </div>
            </div>
            <button id="chat-close-btn" type="button" aria-label="Zavřít chat" style="color: #a1a1aa !important; background: transparent !important; border: none !important; cursor: pointer !important; padding: 6px !important; display: flex !important; align-items: center !important; transition: color 0.2s;">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const quizLang = {
        welcome: `Ahoj! Jsem Olivia, vaše průvodkyně onboardingem v <?= e(SITE_NAME) ?>. Váš přístup je předem schválený. Pojďme vytvořit váš profil.`,
        q1: `Potvrďte, že žijete <?= e(geo_country_in()) ?>, abyste plně splnili zákonné požadavky.`,
        a1_yes: `Yes, I live here now`,
        a1_no: `Ne`,
        q2: `Výborně. Vyberte věkovou skupinu, abychom mohli doporučit vhodné produkty:`,
        q3: `Máte momentálně aktivní bankovní nebo kreditní účet na denní výplaty?`,
        a3_yes: `Ano, můj účet je aktivní`,
        a3_no: `Momentálně ne`,
        q4: `Jaký je váš hlavní zdroj příjmu? Pomáhá nám to přizpůsobit nastavení rizika.`,
        a4_1: `Zaměstnaný nebo freelancer`,
        a4_2: `Úspory nebo pasivní příjem`,
        a4_3: `Jiné typy příjmu`,
        q5: `Ještě chvíli! Někdo z týmu vám zavolá mezi 11:00 a 20:00 kvůli krátkému ověření. Můžete hovor přijmout?`,
        a5_yes: `Ano, ten čas mi vyhovuje`,
        a5_no: `Kontaktujte mě brzy`,
        loaderText: `Kontrolujeme odpovědi a vytváříme váš bezpečný účet...`,
        finalTitle: `Ověření dokončeno! 🎉 Váš bezpečný účet je připraven. Postupujte podle pokynů níže, abyste povolili denní platby:`,
        processing: `Zpracováváme vaši žádost...`
    };
    ...
    function appendAgentMessage(text) {
        ...
        msg.innerHTML = `
            <div style="width: 28px; height: 28px; border-radius: 50%; border: 1px solid var(--color-primary); background-color: #27272a; display: flex; align-items: center; justify-content: center; overflow: hidden; flex-shrink: 0; margin-top: 2px;">
                <img alt="Obrázek obchodní platformy" src="<?= asset('static/img/consultant.webp') ?>" width="28" height="28" decoding="async" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';" style="width:100%; height:100%; object-fit:cover;" class="cq-consultant-img">
