...
$page_title = 'Podpora | Pomoc týmu ' . SITE_NAME;
$page_description = 'Kontaktujte tým ' . SITE_NAME . ' při účtech, vkladech, výběrech a otázkách o platformě.';
...
<h1>Kontakt</h1>
  <p class="lead max-w-3xl justify-self-center text-center md:text-left">Tým <?= e(SITE_NAME) ?> odpovídá na otázky o účtech, vkladech, výběrech, grafech a nástrojích AI. Pomoc jde oficiálními kanály — bez osobních investičních doporučení či záruk zisku.</p>
<div class="grid gap-4 text-center md:gap-6 md:text-left max-w-3xl justify-self-center">
  <h3>Napište nám pro další pomoc</h3>  <p>Před kontaktem mějte po ruce e-mail účtu, téma (registrace, platba, technické) a snímky obrazovky, pokud je třeba. Čím jasnější detaily, tím rychlejší řešení.</p>  <p>Žádosti o aktivní obchody nebo čekající výběry mají prioritu, když je to možné. Pro bezpečnost nikdy nepožádáme o celé heslo ani kódy 2FA v nevyžádaných e-mailech.</p>  <p>Pokud jste se ještě neregistrovali, otevřete účet v několika minutách na stránce registrace a vraťte se sem. Podívejte se i na FAQ o poplatcích, bezpečnosti a dostupných trzích.</p>  <p>Uveďte jasný předmět (např. «Výběr čeká», «Problém 2FA», «Otázka o poplatku»). Většina dotazů dostane první odpověď do několika hodin; velký objem nebo kontroly plateb mohou prodloužit čas.</p></div>
