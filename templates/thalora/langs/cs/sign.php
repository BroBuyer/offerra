...
$page_title = 'Otevřete účet | Začněte obchodovat s ' . SITE_NAME;
$page_description = 'Rychle si otevřete účet ' . SITE_NAME . ', abyste odemkli pokročilé funkce obchodování s AI.';
$page_canonical = page_url("sign.php");
$active_page = "sign";
$schema_extra = ['breadcrumb' => schema_breadcrumb('Přihlášení / Registrace', 'sign.php')];
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      ...
      <span class="breadcrumb-item">Přihlášení / Registrace</span>
    </nav>
  </div>
</div>
      <!-- registration-1 -->
...
<h1>Otevřete účet <?= e(SITE_NAME) ?> už dnes</h1>
