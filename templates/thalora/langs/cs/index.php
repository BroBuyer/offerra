...
$page_title = SITE_NAME . ' | Vedoucí obchodní platforma poháněná AI';
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h1 id="heading-style-h1">Obchodujte transparentně. Zachovejte kontrolu nad každým rozhodnutím.</h1>
            <p>Přistupte ke kryptoměnám, forexu a globálním aktivům z jedné platformy. <?= e(SITE_NAME) ?> spojuje analytiku naživo, podporovanou automatizaci a odbornou podporu, abyste trhy ovládali jasnými nástroji a konzistentními procesy.</p>
        </div>
...
<div class="py-8 md:py-10">
  <div class="stats-cards container-base grid gap-3 md:grid-cols-2 md:gap-6 xl:grid-cols-4">
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      ...
      <p class="h3">Podporované měny</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase">42m</p>
      <p class="h3">Ověření uživatelé</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase"><?= e(currency_symbol()) ?>440m</p>
      <p class="h3">Obrat transakcí</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase">100+</p>
      <p class="h3">Obsluhované země</p>
    </div>
  </div>
</div>
    <!-- features -->
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 max-lg:order-2 md:gap-10">
      <h2>Proč si vybrat <?= e(SITE_NAME) ?></h2>
      <p class="md:text-lg">
        Preferovaná dnešními kryptotradery, tato platforma nastavuje nový standard. Spojujeme silné zabezpečení, plnou transparentnost, pokročilou AI a intuitivní rozhraní pro sebevědomé obchodování.      </p>
        ...
        <div class="grid grid-cols-2 gap-x-8 gap-y-6 max-sm:flex">
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Spolehlivé zabezpečení</p>
              <p>Silné ochrany nepřetržitě chrání vaše osobní údaje a investice.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Personalizované obchodování</p>
              <p>Přizpůsobte metody obchodování svým cílům a preferencím.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Inteligentní řešení AI</p>
              <p>Přesné obchodní poznatky pro informovaná rozhodnutí.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Automatizovaná obchodní řešení</p>
              <p>Boty poháněné AI běží nonstop a umožňují strukturovanější, signálový přístup k obchodování.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Intuitivní rozhraní</p>
              <p>Jednoduché rozhraní navržené na přehledné obchodování od prvního použití.</p>
            </div>
          </div>
        </div>
      </div>
      <p class="h3">
        Posilněte svou finanční cestu s <?= e(SITE_NAME) ?>.
      </p>
      <a class="btn btn-black" href="<?= page_url('sign.php') ?>">Zaregistrujte se nyní</a>
    </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>Obchodování bez námahy!</h2>
      <p class="text-lg">
        Obchodujte přední kryptoměny jako Bitcoin, Ethereum a Dogecoin — jednoduše a sebevědomě.      </p>
      <a class="btn btn-black max-md:hidden" href="<?= page_url('sign.php') ?>">Začněte nyní</a>
    </div>
    <div class="grid gap-3 md:gap-6" data-trading></div>
    <a class="btn btn-black md:hidden" href="<?= page_url('sign.php') ?>">Začněte nyní</a>
  </div>
</div>
<section class="feature-section">
  <div class="container">
    <div class="feature-header">
      <h2>
        Globální obchodní platforma <span>postavená na růst</span>      </h2>
      <p>
        Přistupte k více finančním trhům přes jeden systém navržený na rychlost, přesnost a spolehlivý globální výkon.      </p>
    </div>
    <div class="feature-grid">
      <div class="feature-card">
        <div class="accent"></div>
        <h3>Přístup k více trhům</h3>
        <p>
          Obchodujte kryptoměny, forex, akcie a komodity na jedné platformě, bez přepínání aplikací.        </p>
      </div>
      <div class="feature-card featured">
        <div class="accent"></div>
        <h3>Rychlé provedení příkazů</h3>
        <p>
          Optimalizovaná platforma na rychlé a spolehlivé provedení příkazů na globálních trzích.        </p>
      </div>
      <div class="feature-card">
        <div class="accent"></div>
        <h3>Analytika v reálném čase</h3>
        <p>
          Data naživo, pokročilé indikátory a poznatky pro rychlá, informovaná rozhodnutí.        </p>
      </div>
    </div>
  </div>
</section>
...
<div class="py-8 md:py-10" id="how-it-works">
  <div class="container-base grid gap-6 md:gap-10">
    <div class="grid items-center gap-6 lg:grid-cols-2">
      <h2>Jak funguje <?= e(SITE_NAME) ?>: od registrace po obchodování</h2>
      <p class="rounded-custom sm:border sm:p-8">
        Jednoduchý proces v šesti krocích: registrace, ověření, vklad, konfigurace strategie a použití tržních nástrojů. Panel jasně ukazuje termíny, možnosti a ovládání.      </p>
    </div>
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Vytvořte si účet</p>
          <p>Zaregistrujte se základními údaji pro bezpečný přístup na oficiální <?= e(SITE_NAME) ?> platformu. Tento rychlý krok otevírá hlavní panel.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          ...
          <p>Potvrďte e-mail, abyste odemkli všechny funkce: grafy naživo, analytické nástroje a materiály pro strukturovaný začátek.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Přejděte na obchodní platformu</p>
          <p>Vložte na účet alespoň <?= e(money_min()) ?>. Můžete zvolit vyšší částku podle cílů; všechny platební možnosti a poplatky jsou viditelné před potvrzením.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Přidat prostředky</p>
          <p>Vyberte převod, e-peněženku nebo kartu. Časy a poplatky jsou transparentní — vklad máte pod kontrolou.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Určete strategii</p>
          <p>Upravte riziko, preferované trhy a přístup k obchodování. <?= e(SITE_NAME) ?>: podpora AI vybírá signály a sledování trhu, bez nahrazení vašich rozhodnutí.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Prozkoumejte dostupné trhy</p>
          <p>Když je účet aktivní a nastavený, sledujte ceny naživo, plánujte obchody a používejte integrovanou platformu na krypto a další aktiva.</p>
        </div>
      </div>
    </div>
    <div class="grid gap-6 md:grid-cols-2">
      <a class="btn btn-black" href="<?= page_url('sign.php') ?>">Začít obchodovat</a>
    </div>
  </div>
</div>
    <!-- payments -->
    <div class="py-8 md:py-10">
      <div class="container-base grid items-center gap-6 lg:grid-cols-2">
        <p class="text-lg">
          <?= e(SITE_NAME) ?> podporuje různé platební metody pro klienty po celém světě.        </p>
        ...
        <div class="grid items-end gap-6 md:grid-cols-2">
          ...
          <div class="inline-flex justify-end gap-8 max-md:hidden">
            <button class="text-primary hover:text-primary-dark -scale-x-100 cursor-pointer transition-colors"
              data-prev="reviews" aria-label="předchozí snímek">
          ...
          <div class="-ml-6">
            <div class="basis-full pl-6 md:basis-1/2">
              <div
                ...
                <p>
                  A fantastic obchodní platformy is <?= e(SITE_NAME) ?>! The
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10" style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
    <div class="flex items-center justify-between gap-6 mb-6 reviews-flex-block">
      <h2 class="text-2xl font-bold">Recenze uživatelů</h2>
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
            <p>
              <?= e(SITE_NAME) ?> předčila má očekávání. Registrace byla jednoduchá, poplatky jasné, podpora rychlá. Celkově spolehlivá, plynulá platforma, kterou rád používám.            </p>
            <div class="flex items-center gap-4">
              <div class="initials">FE</div>
              <p class="font-bold">Specialista na měny</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Vybral jsem <?= e(SITE_NAME) ?> na krypto obchodování a jsem spokojený. Začátek byl jasný a transparentní. Důvěryhodná volba, zejména pro začátečníky.                </p>
            <div class="flex items-center gap-4">
              <div class="initials">IM</div>
              <p class="font-bold">Analytik investičních trhů</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Považuji <?= e(SITE_NAME) ?> jako spolehlivou, konzistentní platformu. Otevření účtu bylo jednoduché, podmínky transparentní, podpora kompetentní. Obchodování tu je pohodlné.                </p>
            <div class="flex items-center gap-4">
        ...
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Obchodování s kryptoměnami s <?= e(SITE_NAME) ?> za přístupnou. Registrace byla snadná, poplatky srozumitelné, pomoc dostupná, když je třeba. Jako nový trader cítím skutečný rozdíl.                </p>
            <div class="flex items-center gap-4">
              <div class="initials">FA</div>
              <p class="font-bold">Finanční analytik</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="grid gap-3 md:gap-6" data-accordion>
      <div id="accordion-1" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Jaké kroky jsou potřeba k zahájení obchodování?</span>
        ...
        <div id="content-1" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Začátek je jednoduchý. Zaregistrujte se klíčovými údaji, potvrďte e-mail a vložte alespoň <?= e(money_min()) ?>. Odemknete všechny funkce: grafy naživo, obchodní nástroje, analýzu trhu a podporu. Zkušenost není potřeba — kompletní tutoriály vás vedou krok za krokem.</p>
          </div>
        </div>
      </div>
      <div id="accordion-2" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Je <?= e(SITE_NAME) ?> spolehlivá při správě mých peněz a údajů?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-2" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>V <?= e(SITE_NAME) ?> je ochrana údajů a prostředků prioritou. Relace jsou šifrované SSL, k dispozici je dvoufaktorová autentizace a praktiky soukromí jsou jasně popsané. Finanční transakce jdou přes důvěryhodné partnery a interní protokoly. Usilujeme o spolehlivost, ale výnosy nelze zaručit.</p>
          </div>
        </div>
      </div>
      <div id="accordion-3" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Jak rychle mohu vybrat prostředky?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-3" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Výběry můžete požádat kdykoli z portálu účtu. Zpracování obvykle trvá 1–3 pracovní dny podle metody. Poplatky a odhadované termíny jsou viditelné před potvrzením. Pokud potřebujete sledovat výběr, tým podpory je k dispozici.</p>
          </div>
        </div>
      </div>
      <div id="accordion-4" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Jak zjistím, zda platforma vyhovuje mým obchodním potřebám?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-4" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Doporučujeme začít minimálním vkladem, abyste poznali funkce. <?= e(SITE_NAME) ?> vyhovuje začátečníkům i zkušeným traderům: jednoduché rozhraní, volitelné nástroje AI a podpora 24/7. Zachováváte plnou kontrolu nad příkazy, limity a rizikem.</p>
          </div>
        </div>
      </div>
      <div id="accordion-5" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Jsou před začátkem potřeba obchodní zkušenosti?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-5" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Předchozí zkušenost není potřeba. Platforma je jednoduchá od začátku: onboarding, tutoriály a nástroje posílené AI. Učíte se vlastním tempem — od základních trhů po pokročilou analýzu a automatizaci.</p>
          </div>
        </div>
      </div>
      <div id="accordion-7" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Které trhy mohu sledovat s <?= e(SITE_NAME) ?>?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-7" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>V jednom rozhraní sledujete přední kryptoměny, forex v reálném čase, globální akcie a komodity. Bez přepínání aplikací se soustředíte na analýzu a rozhodnutí.</p>
          </div>
        </div>
      </div>
      <div id="accordion-8" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Jak funguje analytika AI?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-8" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p><?= e(SITE_NAME) ?> nabízí nástroje AI, které organizují signály, označují výrazné pohyby ceny a pomáhají při sledování trhu. Podporují váš výběr, bez nahrazení strategie či záruky výsledku. Vy rozhodujete, kdy jednat a kolik alokovat.</p>
          </div>
        </div>
      </div>
      <div id="accordion-9" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Kolik obvykle trvá od registrace po první obchod?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-9" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Otevření účtu a ověření obvykle trvají několik minut. Čas do prvního obchodu závisí na vkladu a platební metodě. Úvodní stránka ukazuje jasného průvodce krok za krokem, bez skrytých fází.</p>
          </div>
        </div>
      </div>
      <div id="accordion-10" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Je k dispozici podpora při otázkách o účtu?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-10" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Tým je dostupný přes Kontakt nebo FAQ při přístupu k účtu, vkladech, výběrech nebo funkcích. Pomoc je provozní, ne investiční poradenství.</p>
          </div>
        </div>
      </div>
      <div id="accordion-6" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">O platformě</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-6" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p style="margin-bottom:16px;"><?= e(SITE_NAME) ?> je mezinárodní obchodní platforma pro uživatele, kteří chtějí konzistentní výkon, rychlé provedení a plnou kontrolu prostředí. Místo oddělených služeb spojuje klíčové funkce do jednoho toku.</p>
            <p style="margin-bottom:16px;">Od přístupu na trh po provedení a analýzu každý prvek funguje bez tření. Soustředíte se na rozhodnutí, ne na výměnu nástroje.</p>
            <p style="margin-bottom:10px; font-weight:500;">Obchodujte na více finančních trzích z jedné platformy:</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Přední a rostoucí kryptoměny</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Forexové trhy s cenami naživo</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Globální akcie a opce na akcie</li>
              <li><span style="color:var(--color-primary);">•</span> Komodity na rozšíření možností</li>
            </ul>
            <p style="margin-bottom:16px;">Výkon je priorita. Systém je optimalizovaný na nízkou latenci a spolehlivý provoz ve špičce, abyste reagovali na ceny bez technických zpoždění.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Rychlé, spolehlivé zpracování příkazů na trzích</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Neustálý tok tržních dat</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Předinstalovaná analytika a tržní indikátory</li>
              <li><span style="color:var(--color-primary);">•</span> Manuální i automatizované obchodování</li>
            </ul>
            <p style="margin-bottom:16px;">Bezpečnost a provozní spolehlivost jsou priorita na všech úrovních. Platforma drží odvětvové standardy a chrání informace a finanční aktivity nepřetržitě.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Plně šifrovaná datová komunikace</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Ověření identity a vícevrstvé bezpečnostní protokoly</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Monitorované a validované procesy transakcí</li>
              <li><span style="color:var(--color-primary);">•</span> Infrastruktura navržená na spolehlivé globální připojení</li>
            </ul>
            <p style="margin-bottom:16px;">Uživatelský zážitek má stejnou váhu. Design je záměrně jednoduchý a intuitivní, aby se trader soustředil na strategii.</p>
            <p style="margin-bottom:16px;">Tato směs solidních funkcí a jednoduchosti dělá <?= e(SITE_NAME) ?> ideální pro začátečníky i zkušené tradery. Kdo začíná, rychle nabere tempo bez strmé křivky učení; pokročilí uživatelé si zachovají svobodu pro složité taktiky.</p>
            <p><?= e(SITE_NAME) ?> přináší škálovatelnost, spolehlivost a vysoký výkon na jedné platformě — pro bezpečný, uspořádaný přístup k mezinárodním finančním trhům.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h2>Obchodujte na regulované platformě™</h2>
          <p>
            Důvěra individuálních traderů a firem při bezpečném nákupu, prodeji a správě kryptoměn.          </p>
        </div>
  ...
  <section style="padding:60px 0;" class="md:!py-[100px]">
    ...
    ">
      ...
      ">
        ...
        ">
          Klíčové funkce <span style='color:var(--color-primary);'><?= e(SITE_NAME) ?> obchodní platformy</span>        </h2>
      <p style="margin-top:14px;color:#6b7280;font-size:17px;">
        Funkce, které zvyšují rychlost, přesnost a jistotu obchodování.      </p>
    </div>
    <div style="
      border-radius:16px;
      overflow:hidden;
    ...
    ">
      ...
      " onmouseover="this.style.background='#f9f9fb'" class="row-block" onmouseout="this.style.background='transparent'">
        ...
        <div class="row-text" style="color:#6b7280;">
          Pokročilá obchodní technologie založená na AI        </div>
      </div>
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          ...
          Způsoby vkladu        </div>
        <div class="row-text" style="color:#6b7280;">
          Karty, převody, možnosti PayPal        </div>
      </div>
      <div class="row-block" style="
        display:grid;
        grid-template-columns: 1fr 2fr;
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          <span style="color:var(--color-primary);">📱</span>
          Dostupnost platformy        </div>
        <div class="row-text" style="color:#6b7280;">
          Funguje na více zařízeních        </div>
      </div>
      <div class="row-block" style="
        display:grid;
        grid-template-columns: 1fr 2fr;
      ...
      ">
        ...
        <div class="row-text" style="color:#6b7280;">
          Forex, akcie, kryptoměny, komodity a další        </div>
      </div>
      <div class="row-block" style="
        display:grid;
        grid-template-columns: 1fr 2fr;
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          ...
          Průvodce otevřením účtu        </div>
        <div class="row-text" style="color:#6b7280;">
          Rychlý, plynulý onboarding        </div>
      </div>
      <div class="row-block" style="
        display:grid;
      ...
      ">
        <div class="customer-block" style="display:flex;gap:10px;font-weight:600;">
          <span style="color:var(--color-primary);">📞</span>
          Zákaznická podpora          <span style="font-weight:400;color:#6b7280;margin-left:10px;">
            Profesionální podpora 24/7          </span>
        </div>
...
<div class="md:border-primary-light md:rounded-[20px] md:border md:px-20 md:py-8">
  <div class="border-primary-light grid justify-items-center gap-6 rounded-[20px] border px-4 py-5 md:gap-4 md:px-8 md:py-6 text-center md:text-left">
    <h2 class="h3 flex flex-wrap items-center justify-center md:justify-start gap-x-4 gap-y-3">
      Co říkají uživatelé <?= e(SITE_NAME) ?>      <span class="inline-flex items-center justify-center rounded-full bg-emerald-600 px-2 py-1 text-sm leading-none text-white uppercase">
        Důvěryhodná      </span>
    </h2>
    <div class="flex flex-wrap items-center justify-center md:justify-start gap-2.5 text-center md:text-left">
      ...
      <span class="leading-none text-amber-500" role="img"
        aria-label="4.7 Hodnocení (z 5)">
        ★★★★★      </span>
      <span class="flex flex-wrap justify-center md:justify-start gap-1 text-sm text-gray-400">
        <span>
          <strong>124</strong> recenzí klientů ·
        </span>
        <span>
          Na základě <strong>337</strong> hodnocení ·
        </span>
        <span>
          Hodnocení (z 5)        </span>
      </span>
    ...
    <p class="text-center md:text-left">
      Intuitivní platforma s pokročilými nástroji automatizace a bohatými vzdělávacími materiály.    </p>
  </div>
</div>
      </div>
    </section>
