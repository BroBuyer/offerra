...
$page_title = $page_title ?? (SITE_NAME . ' | Platform dagangan berkuasa AI terkemuka');
$page_description = $page_description ?? ('Akses mata wang kripto, forex dan aset global melalui satu platform. ' . SITE_NAME . ' menggabungkan analitik langsung, automasi berbantu dan sokongan pakar.');
...
<?php endif; ?>
  ...
  window.APP_LANG = {
    ...
    valPhoneShort: 'Nombor terlalu pendek',
    valPhoneLong: 'Nombor terlalu panjang',
    valPhoneEmpty: 'Masukkan nombor telefon anda',
    valSessionExpired: 'Sesi tamat. Muat semula halaman dan cuba lagi.',
    valGenericError: 'Sesuatu tidak kena. Sila cuba lagi kemudian.',
    valConnectionError: 'Ralat sambungan. Semak sambungan internet anda dan cuba lagi.'
  };
