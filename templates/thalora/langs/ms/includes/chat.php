...
<div id="chat-quiz-root" style="position: fixed !important; bottom: 20px !important; right: 20px !important; z-index: 999999 !important; font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, sans-serif !important; box-sizing: border-box !important;">
    ...
    <div id="chat-window" style="display: none; position: absolute !important; bottom: 0 !important; right: 0 !important; background-color: #121214 !important; border: 1px solid #27272a !important; border-radius: 20px !important; box-shadow: 0 25px 60px -10px rgba(0, 0, 0, 0.8) !important; flex-direction: column !important; overflow: hidden !important; transition: all 0.35s cubic-bezier(0.165, 0.84, 0.44, 1) !important; opacity: 0 !important; transform: translateY(20px) !important;">
        ...
        <div style="background-color: #1a1a1e !important; border-bottom: 1px solid #27272a !important; padding: 14px 18px !important; display: flex !important; align-items: center !important; justify-content: space-between !important; flex-direction: row !important;">
            <div style="display: flex !important; align-items: center !important; gap: 12px !important; flex-direction: row !important;">
                ...
                <div style="text-align: left !important;">
                    ...
                    <p style="color: #a1a1aa !important; font-size: 11px !important; margin: 0 !important; padding: 0 !important; opacity: 0.85;">Panduan onboarding</p>
                </div>
            </div>
            <button id="chat-close-btn" type="button" aria-label="Tutup sembang" style="color: #a1a1aa !important; background: transparent !important; border: none !important; cursor: pointer !important; padding: 6px !important; display: flex !important; align-items: center !important; transition: color 0.2s;">
        ...
        <div id="typing-indicator" style="display: none; padding: 10px 18px !important; font-size: 12px !important; color: #71717a !important; font-style: italic !important; background-color: #121214 !important; text-align: left !important;">
            Olivia sedang menaip mesej...        </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const quizLang = {
        welcome: `Helo! Saya Olivia, panduan onboarding <?= e(SITE_NAME) ?>. Akses anda telah diluluskan terlebih dahulu. Mari kita mula membina profil anda.`,
        q1: `Sahkan bahawa anda menetap <?= e(geo_country_in()) ?> untuk mematuhi sepenuhnya keperluan undang-undang.`,
        a1_yes: `Ya, saya tinggal di sini sekarang`,
        a1_no: `Tidak`,
        q2: `Bagus. Pilih kumpulan umur anda supaya kami boleh mengesyorkan produk kewangan yang sesuai:`,
        q3: `Adakah anda kini mempunyai akaun bank atau kad kredit yang aktif untuk menerima pembayaran dividen harian?`,
        a3_yes: `Ya, akaun saya aktif`,
        a3_no: `Tidak buat masa ini`,
        q4: `Apakah sumber pendapatan utama anda? Ini membantu kami menyesuaikan tetapan risiko platform untuk anda.`,
        a4_1: `Bekerja atau freelance`,
        a4_2: `Simpanan atau pendapatan pasif`,
        a4_3: `Jenis pendapatan lain`,
        q5: `Sedikit lagi! Seseorang daripada pasukan kami akan menghubungi anda antara 11:00 dan 20:00 untuk pengesahan ringkas. Bolehkah anda menerima panggilan itu?`,
        a5_yes: `Ya, masa itu sesuai`,
        a5_no: `Sila hubungi saya segera`,
        loaderText: `Menyemak jawapan anda dan menyediakan akaun selamat anda...`,
        finalTitle: `Pengesahan selesai! 🎉 Akaun selamat anda sudah sedia. Sila ikut arahan di bawah untuk mengaktifkan pembayaran harian:`,
    ...
    function appendAgentMessage(text) {
        ...
        msg.innerHTML = `
            <div style="width: 28px; height: 28px; border-radius: 50%; border: 1px solid var(--color-primary); background-color: #27272a; display: flex; align-items: center; justify-content: center; overflow: hidden; flex-shrink: 0; margin-top: 2px;">
                <img alt="Imej platform dagangan" src="<?= asset('static/img/consultant.webp') ?>" width="28" height="28" decoding="async" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';" style="width:100%; height:100%; object-fit:cover;" class="cq-consultant-img">
