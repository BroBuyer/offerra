...
$page_title = 'Sokongan | Bantuan pasukan ' . SITE_NAME;
$page_description = 'Hubungi pasukan ' . SITE_NAME . ' untuk akaun, deposit, pengeluaran dan pertanyaan platform.';
$page_canonical = page_url("contacts.php");
$active_page = "contacts";
$schema_extra = ['breadcrumb' => schema_breadcrumb('Hubungi kami', 'contacts.php')];
...
<h1>Hubungi kami</h1>
  <p class="lead max-w-3xl justify-self-center text-center md:text-left">Pasukan <?= e(SITE_NAME) ?> menyokong pertanyaan tentang akaun, pembiayaan, pengeluaran, carta dan alat AI. Sokongan ditawarkan melalui saluran rasmi — tiada cadangan pelaburan peribadi atau jaminan keuntungan.</p>
<div class="grid gap-4 text-center md:gap-6 md:text-left max-w-3xl justify-self-center">
  <h3>E-mel kami untuk bantuan lanjut</h3>  <p>Sebelum menghubungi kami, sediakan e-mel akaun anda, topik pertanyaan (pendaftaran, pembayaran, teknikal) dan sebarang tangkapan skrin yang berkaitan. Maklumat terperinci membantu kami menyelesaikan isu anda dengan lebih pantas dan mengurangkan bolak-balik.</p>  <p>Permintaan tentang dagangan aktif atau pengeluaran tertunda diutamakan jika boleh. Demi keselamatan anda, kami tidak akan meminta kata laluan penuh atau kod 2FA melalui e-mel yang tidak diminta.</p>  <p>Jika anda belum mendaftar, anda boleh membuka akaun dalam beberapa minit di halaman pendaftaran, kemudian kembali ke sini dengan sebarang soalan. Rujuk juga Soalan lazim untuk maklumat tentang yuran, keselamatan dan pasaran tersedia.</p>  <p>Sila sertakan baris subjek yang jelas (cth. “Pengeluaran Tertunda”, “Isu 2FA”, “Soalan Yuran”). Kebanyakan pertanyaan menerima balasan pertama dalam beberapa jam; jumlah tinggi atau semakan pembayaran mungkin melambatkan respons, tetapi kemas kini akan diberikan.</p></div>
