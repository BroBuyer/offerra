...
$page_title = SITE_NAME . ' | Platform dagangan berkuasa AI terkemuka';
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h1 id="heading-style-h1">Berdagang secara telus. Kekalkan kawalan ke atas setiap keputusan.</h1>
            <p>Akses mata wang kripto, forex dan aset global melalui satu platform. <?= e(SITE_NAME) ?> menggabungkan analitik langsung, automasi berbantu dan sokongan pakar untuk membantu anda menavigasi pasaran dengan alat yang jelas dan proses yang konsisten.</p>
        </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 max-lg:order-2 md:gap-10">
      ...
      <p class="md:text-lg">
        Dipilih oleh trader kripto masa kini, platform ini menetapkan piawaian baharu. Kami menggabungkan keselamatan kukuh, ketelusan penuh, AI termaju dan antara muka intuitif untuk dagangan yang yakin.      </p>
        ...
        <div class="grid grid-cols-2 gap-x-8 gap-y-6 max-sm:flex">
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Keselamatan yang boleh diharap</p>
              <p>Perlindungan kukuh sentiasa menjaga maklumat peribadi dan pelaburan anda.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Dagangan diperibadikan</p>
          ...
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Penyelesaian dagangan automatik</p>
              <p>Bot berkuasa AI beroperasi secara berterusan untuk pendekatan dagangan yang lebih berstruktur, berasaskan isyarat.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Antara muka intuitif</p>
              <p>Antara muka mudah digunakan, direka untuk dagangan yang jelas dari awal.</p>
            </div>
          </div>
        </div>
      </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      ...
      <a class="btn btn-black max-md:hidden" href="<?= page_url('sign.php') ?>">Mula sekarang</a>
    </div>
    <div class="grid gap-3 md:gap-6" data-trading></div>
    <a class="btn btn-black md:hidden" href="<?= page_url('sign.php') ?>">Mula sekarang</a>
  </div>
</div>
<section class="feature-section">
  <div class="container">
    <div class="feature-header">
      <h2>
        Platform dagangan global <span>direka untuk berkembang</span>      </h2>
      <p>
        Akses pelbagai pasaran kewangan melalui satu sistem yang direka untuk kelajuan, ketepatan dan prestasi global yang boleh diharap.      </p>
    </div>
    <div class="feature-grid">
      <div class="feature-card">
        <div class="accent"></div>
        <h3>Akses berbilang pasaran</h3>
        <p>
          Berdagang mata wang kripto, forex, saham dan komoditi dalam satu platform tanpa menukar aplikasi.        </p>
      </div>
      <div class="feature-card featured">
        <div class="accent"></div>
        <h3>Pelaksanaan pesanan pantas</h3>
        <p>
          Platform dioptimumkan untuk pelaksanaan pesanan yang pantas dan boleh diharap merentas pasaran global.        </p>
      </div>
      <div class="feature-card">
        <div class="accent"></div>
        <h3>Analitik masa nyata</h3>
        <p>
          Data pasaran langsung, penunjuk termaju dan insight untuk membantu anda membuat keputusan pantas dan termaklum.        </p>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container-base grid gap-6 md:gap-10">
    <div class="grid items-center gap-6 lg:grid-cols-2">
      ...
      <p class="rounded-custom sm:border sm:p-8">
        Proses enam langkah yang mudah: pendaftaran, pengesahan, pembiayaan, konfigurasi strategi dan penggunaan alat pasaran. Papan pemuka memaparkan masa, pilihan dan kawalan dengan jelas.      </p>
    </div>
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Cipta akaun anda</p>
          <p>Daftar dengan butiran asas anda untuk mengakses platform rasmi <?= e(SITE_NAME) ?>. Langkah pantas ini membuka papan pemuka utama anda.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          ...
          <p>Sahkan e-mel anda untuk membuka semua fungsi: carta langsung, alat analisis dan sumber untuk permulaan yang teratur.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Akses platform dagangan anda</p>
          <p>Biayai akaun anda sekurang-kurangnya <?= e(money_min()) ?>. Anda boleh pilih jumlah lebih tinggi mengikut matlamat anda; semua pilihan pembayaran dan caj dipaparkan dengan jelas sebelum pengesahan.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          ...
          <p>Pilih pindahan bank, e-wallet atau pembayaran kad. Tempoh pemprosesan dan yuran adalah telus, supaya anda mengawal pembiayaan sepenuhnya.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          ...
          <p>Laraskan tetapan risiko, pasaran pilihan dan pendekatan dagangan anda. <?= e(SITE_NAME) ?>: bantuan AI memilih isyarat dan pemantauan pasaran tanpa mengatasi pilihan anda.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Terokai pasaran yang tersedia</p>
          <p>Apabila akaun anda aktif dan dikonfigurasi, pantau harga langsung, rancang dagangan dan gunakan platform bersepadu untuk mata wang kripto dan aset lain.</p>
        </div>
      </div>
    </div>
    <div class="grid gap-6 md:grid-cols-2">
      <a class="btn btn-black" href="<?= page_url('sign.php') ?>">Mula berdagang</a>
    </div>
  </div>
</div>
    <!-- payments -->
          ...
          <div class="-ml-6">
            <div class="basis-full pl-6 md:basis-1/2">
              <div
                ...
                <p>
                  A fantastic platform dagangan is <?= e(SITE_NAME) ?>! The
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
            <p>
              <?= e(SITE_NAME) ?> melebihi jangkaan saya. Pendaftaran mudah, yuran jelas dan sokongan pantas. Secara keseluruhan, platform yang boleh dipercayai dan lancar yang saya gembira gunakan.            </p>
        ...
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Saya pilih <?= e(SITE_NAME) ?> untuk dagangan kripto dan saya berpuas hati. Proses penyediaan mudah dan telus. Ia terasa seperti pilihan yang boleh dipercayai, terutamanya untuk pendatang baharu.                </p>
            <div class="flex items-center gap-4">
              <div class="initials">IM</div>
              <p class="font-bold">Penganalisis pasaran pelaburan</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Saya dapati <?= e(SITE_NAME) ?> sebagai platform yang boleh diharap dan konsisten. Pembukaan akaun mudah, terma telus dan sokongan berpengetahuan. Berdagang di sini selesa.                </p>
            <div class="flex items-center gap-4">
        ...
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Berdagang mata wang kripto dengan <?= e(SITE_NAME) ?> mudah didekati. Pendaftaran mudah, yuran mudah difahami dan bantuan tersedia apabila diperlukan. Sebagai trader baharu, ini benar-benar membuat perbezaan.                </p>
            <div class="flex items-center gap-4">
    ...
    <div class="grid gap-3 md:gap-6" data-accordion>
      ...
      <div id="accordion-6" class="group border-primary rounded-custom border transition-all">
        ...
        <div id="content-6" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p style="margin-bottom:16px;"><?= e(SITE_NAME) ?> ialah platform dagangan antarabangsa yang dibina untuk pengguna yang mencari prestasi konsisten, pelaksanaan pantas dan kawalan penuh persekitaran dagangan mereka. Daripada mengurus perkhidmatan berasingan atau platform tempatan, ia menawarkan sistem bersatu yang menyepadukan semua fungsi utama dalam satu aliran kerja.</p>
            <p style="margin-bottom:16px;">Dari akses pasaran hingga pelaksanaan pesanan dan analisis, setiap elemen direka untuk berfungsi lancar, meminimumkan gangguan. Ini membolehkan pengguna fokus pada keputusan dagangan, bukan penukaran platform atau navigasi.</p>
            <p style="margin-bottom:10px; font-weight:500;">Berdagang merentas pelbagai pasaran kewangan pada satu platform:</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              ...
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Pasaran forex dengan suapan harga langsung</li>
            ...
            <p style="margin-bottom:16px;">Prestasi adalah keutamaan. Sistem dioptimumkan untuk pelaksanaan pesanan berkelewatan rendah dan operasi yang boleh diharap semasa aktiviti pasaran rancak, memastikan reaksi tepat pada masanya terhadap perubahan harga tanpa kelewatan teknikal.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Pemprosesan pesanan pantas dan boleh diharap merentas pasaran</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Penstriman data pasaran berterusan</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Analitik dan penunjuk pasaran prapasang</li>
              <li><span style="color:var(--color-primary);">•</span> Sokongan untuk dagangan manual dan automatik</li>
            </ul>
            <p style="margin-bottom:16px;">Keselamatan dan kebolehpercayaan operasi adalah keutamaan di semua peringkat. Platform mematuhi piawaian industri dan menggunakan perlindungan dalaman untuk menjaga maklumat pengguna dan aktiviti kewangan pada setiap masa.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Komunikasi data disulitkan sepenuhnya</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Pengesahan identiti menyeluruh dan protokol keselamatan berlapis</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Proses transaksi dipantau dan disahkan</li>
              <li><span style="color:var(--color-primary);">•</span> Infrastruktur direka untuk ketersambungan global yang boleh diharap</li>
            </ul>
            <p style="margin-bottom:16px;">Kami memberi kepentingan yang sama kepada pengalaman pengguna. Reka bentuk sengaja ringkas dan intuitif, meminimumkan kerumitan supaya trader boleh fokus sepenuhnya pada strategi mereka.</p>
            <p style="margin-bottom:16px;">Gabungan fungsi kukuh dan kesederhanaan ini menjadikan <?= e(SITE_NAME) ?> sesuai untuk pemula dan trader berpengalaman. Pemula boleh menguasai dengan pantas tanpa lengkung pembelajaran yang mencabar, manakala pengguna mahir mengekalkan fleksibiliti untuk melaksanakan taktik kompleks.</p>
            <p><?= e(SITE_NAME) ?> menawarkan skalabiliti, kebolehpercayaan dan prestasi tinggi pada satu platform, membolehkan akses selamat dan teratur ke pasaran kewangan antarabangsa dengan yakin.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <section style="padding:60px 0;" class="md:!py-[100px]">
    ...
    ">
      ...
      ">
        ...
        ">
          Fungsi utama <span style='color:var(--color-primary);'><?= e(SITE_NAME) ?> platform dagangan</span>        </h2>
    ...
    ">
      ...
      " onmouseover="this.style.background='#f9f9fb'" class="row-block" onmouseout="this.style.background='transparent'">
        ...
        <div class="row-text" style="color:#6b7280;">
          Teknologi dagangan termaju berasaskan AI        </div>
      </div>
      ...
      ">
        ...
        <div class="row-text" style="color:#6b7280;">
          Kad debit, pindahan bank, pilihan PayPal        </div>
      </div>
      <div class="row-block" style="
        display:grid;
        grid-template-columns: 1fr 2fr;
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          ...
          Panduan penyediaan akaun        </div>
        <div class="row-text" style="color:#6b7280;">
          Onboarding pantas dan lancar        </div>
      </div>
      <div class="row-block" style="
        display:grid;
      ...
      ">
        <div class="customer-block" style="display:flex;gap:10px;font-weight:600;">
          <span style="color:var(--color-primary);">📞</span>
          Sokongan pelanggan          <span style="font-weight:400;color:#6b7280;margin-left:10px;">
            Sokongan profesional tersedia 24/7          </span>
        </div>
  ...
  <div class="border-primary-light grid justify-items-center gap-6 rounded-[20px] border px-4 py-5 md:gap-4 md:px-8 md:py-6 text-center md:text-left">
    ...
    <div class="flex flex-wrap items-center justify-center md:justify-start gap-2.5 text-center md:text-left">
      ...
      <span class="leading-none text-amber-500" role="img"
        aria-label="4.7 Markah (daripada 5)">
        ★★★★★      </span>
      <span class="flex flex-wrap justify-center md:justify-start gap-1 text-sm text-gray-400">
        ...
        <span>
          Markah (daripada 5)        </span>
      </span>
    </div>
    <p class="text-center md:text-left">
      Platform dagangan intuitif yang merangkumi alat automasi termaju dan sumber pendidikan yang luas.    </p>
  </div>
</div>
      </div>
    </section>
