...
$page_title = 'Buka akaun anda | Mula berdagang dengan ' . SITE_NAME;
$page_description = 'Sediakan dengan pantas akaun ' . SITE_NAME . ' anda untuk membuka keupayaan dagangan AI termaju.';
$page_canonical = page_url("sign.php");
$active_page = "sign";
$schema_extra = ['breadcrumb' => schema_breadcrumb('Log masuk / Daftar', 'sign.php')];
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      ...
      <span class="breadcrumb-item">Log masuk / Daftar</span>
    </nav>
  </div>
</div>
      <!-- registration-1 -->
...
<h1>Buka akaun <?= e(SITE_NAME) ?> anda hari ini</h1>
<h2>Beroperasi pada Platform Terkawal™</h2>
<p>
  Dipercayai oleh trader individu dan perniagaan untuk pembelian, penjualan dan pengurusan mata wang kripto yang selamat.</p>
          </div>
