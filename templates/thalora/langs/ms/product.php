...
$page_title = 'Instrumen dagangan | Fungsi dipertingkat AI — ' . SITE_NAME;
$page_description = 'Gunakan carta pasaran langsung, insight AI dan pelbagai alat dagangan ' . SITE_NAME . ', dengan keselamatan yang dipercayai.';
$page_canonical = page_url("product.php");
$active_page = "product";
$schema_extra = ['breadcrumb' => schema_breadcrumb('Fungsi platform', 'product.php')];
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      ...
      <span class="breadcrumb-item">Fungsi platform</span>
    </nav>
  </div>
</div>
      <!-- analytics -->
  ...
  <div class="container-base grid gap-6 lg:grid-cols-2">
    ...
    >
      <h1 class="relative z-20">Dagangan dan analitik dipertingkat AI</h1>
      <p class="relative z-20">
        Akses insight pasaran dan portfolio yang luas dengan analitik <?= e(SITE_NAME) ?>. Carta masa nyata, penunjuk bersepadu dan analisis berkuasa AI membantu anda membuat pilihan termaklum.      </p>
    </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-8 max-w-4xl">
    <p class="text-lg"><?= e(SITE_NAME) ?> menawarkan platform bersepadu dengan alat dagangan, pemantauan pasaran yang luas dan automasi berbantu. Terokai fungsi terperinci dan manfaat harian di bawah.</p>    <p>Platform kami menawarkan akses kepada pelbagai pasaran termasuk mata wang kripto, forex, ekuiti dan komoditi dengan kemas kini harga langsung. Urus pesanan dan kawalan risiko dengan lancar dari satu papan pemuka disatukan, tanpa mengurus pelbagai aplikasi.</p>    <p>Alat analisis menggabungkan data masa nyata dengan insight berkuasa AI untuk mengenal pasti tren dan pergerakan ketara. Ini menyokong pembuatan keputusan anda; anda mengawal strategi, jumlah dagangan dan had. Antara muka menumpukan pada kesederhanaan dan pelaksanaan cekap.</p>    <p>Keselamatan dan kebolehpercayaan adalah asas: sambungan disulitkan, perlindungan akaun kukuh dan proses pembiayaan yang jelas. Sesuai untuk pemula dan pakar, ia berkembang lancar dari penggunaan asas ke dagangan termaju tanpa perlu menukar platform.</p>    <div class="grid gap-6 md:grid-cols-2">
            <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-3">Pasaran dan instrumen dagangan</h2>
        <p>Pantau mata wang digital, forex, saham dan komoditi dengan alat bersepadu, senarai pantau dan amaran. <?= e(SITE_NAME) ?> menghubungkan analisis dengan pengurusan pesanan dan portfolio.</p>
      </div>
                  <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-3">Ketelusan, keselamatan dan kawalan</h2>
        <p>Sambungan selamat, prosedur disahkan, serta langkah deposit/pengeluaran yang telus. Yuran dipaparkan sebelum pengesahan.</p>
      </div>
          </div>
  </div>
</div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>Platform dagangan berasaskan pelayar</h2>
      <div class="grid grid-cols-2 gap-x-8 gap-y-6">
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Pasaran kewangan</p>
            <p>Akses segera kepada semua fungsi</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Insight pasaran</p>
            <p>Capaian pantas kepada rekod data yang lengkap</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Dioptimumkan untuk mudah alih</p>
            <p>Pengalaman mudah alih yang dioptimumkan di mana-mana</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Pengurusan mata wang kripto</p>
            <p>Urus seluruh portfolio aset anda dengan mudah</p>
          </div>
        </div>
      </div>
    </div>
    <div class="flex items-center justify-center">
        ...
        <img
          ...
          alt="<?= e(SITE_NAME) ?> — platform dagangan pada mudah alih"
...
<div class="py-8 md:py-10">
  ...
  >
    ...
    >
      ...
      <p class="h3">Jumlah transaksi</p>
    </div>
    <div
      class="rounded-custom grid content-start gap-5 border p-4 md:p-6"
    >
      <p class="h2 lowercase">100+</p>
      <p class="h3">Negara disokong</p>
    </div>
  </div>
</div>
      <!-- capabilities -->
    ...
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Fungsi pelaburan utama</p>
          <p>Mempamerkan kepakaran melalui projek penting dan pendekatan kreatif.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Pemerolehan kripto</p>
          <p>Persekitaran selamat dan mesra pengguna untuk membeli mata wang kripto. Pemprosesan pantas dengan yuran minimum. Mula berdagang segera.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Analitik pasaran</p>
          <p>Dapatkan insight tentang harga dan tren pasaran untuk keputusan pelaburan yang termaklum.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Dagangan aset digital</p>
          <p>Berdagang niaga hadapan mata wang kripto. Terokai, labur dan kembangkan portfolio aset anda.</p>
        </div>
      </div>
    </div>
  </div>
...
<p class="h2">Mulakan perjalanan anda sekarang</p>
<p>
  Terokai dagangan kripto dengan <?= e(SITE_NAME) ?>. Pedagang di <?= e(geo_country_name()) ?> mendapat manfaat daripada platform yang menggabungkan teknologi termaju, kecekapan dan alat mesra pengguna.</p>
          </div>
