...
$page_title = 'Strumenti di trading | Funzionalità potenziate dall’IA — ' . SITE_NAME;
$page_description = 'Usa i grafici in diretta, gli insight IA e gli strumenti di trading di ' . SITE_NAME . ', con una sicurezza di fiducia.';
$page_canonical = page_url("product.php");
$active_page = "product";
$schema_extra = ['breadcrumb' => schema_breadcrumb('Funzionalità della piattaforma', 'product.php')];
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      <a href="<?= page_url() ?>" class="breadcrumb-item">Pagina iniziale</a>
      <span class="breadcrumb-item">Funzionalità della piattaforma</span>
    </nav>
  </div>
</div>
      <!-- analytics -->
  ...
  <div class="container-base grid gap-6 lg:grid-cols-2">
    ...
    >
      <h1 class="relative z-20">Trading e analisi potenziati dall’IA</h1>
      <p class="relative z-20">
        Accedi a insight di mercato e di portafoglio estesi con le analisi <?= e(SITE_NAME) ?>. Grafici in tempo reale, indicatori integrati e analisi IA per scelte informate.      </p>
    </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-8 max-w-4xl">
    <p class="text-lg"><?= e(SITE_NAME) ?> propone una piattaforma integrata: strumenti di trading, monitoraggio di mercato esteso e automazione assistita. Scopri le funzionalità e i vantaggi quotidiani qui sotto.</p>    <p>La piattaforma dà accesso a più mercati — criptovalute, forex, azioni e materie prime — con prezzi in diretta. Gestisci ordini e rischi da un’unica dashboard, senza passare da un’app all’altra.</p>    <p>Gli strumenti di analisi uniscono dati in tempo reale e insight IA per individuare trend e movimenti rilevanti. Supportano le decisioni; tu controlli strategia, volumi e limiti. L’interfaccia punta a semplicità ed esecuzione efficiente.</p>    <p>Sicurezza e affidabilità sono alla base: connessioni cifrate, protezioni del conto solide e processi di finanziamento chiari. Adatta a principianti ed esperti, scala dall’uso di base al trading avanzato senza cambiare piattaforma.</p>    <div class="grid gap-6 md:grid-cols-2">
            <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-3">Mercati e strumenti di trading</h2>
        <p>Segui valute digitali, forex, azioni e materie prime con strumenti integrati, watchlist e avvisi. <?= e(SITE_NAME) ?> collega l’analisi alla gestione di ordini e portafoglio.</p>
      </div>
                  <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-3">Trasparenza, sicurezza e controllo</h2>
        <p>Connessioni sicure, procedure verificate, depositi e prelievi trasparenti. Le commissioni si vedono prima della conferma.</p>
      </div>
          </div>
  </div>
</div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>Piattaforma di trading nel browser</h2>
      <div class="grid grid-cols-2 gap-x-8 gap-y-6">
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Mercati finanziari</p>
            <p>Accesso immediato a tutte le funzioni</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Insight di mercato</p>
            <p>Accesso rapido a storici di dati completi</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Ottimizzata per mobile</p>
            <p>Un’esperienza mobile fluida, ovunque</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Gestione delle criptovalute</p>
            <p>Gestisci l’intero portafoglio in modo semplice</p>
          </div>
        </div>
      </div>
    </div>
    <div class="flex items-center justify-center">
        ...
        <img
          ...
          alt="<?= e(SITE_NAME) ?> — piattaforma di trading su mobile"
...
<div class="py-8 md:py-10">
  ...
  >
    ...
    >
      ...
      <p class="h3">Valute supportate</p>
    </div>
    <div
      class="rounded-custom grid content-start gap-5 border p-4 md:p-6"
    >
      <p class="h2 lowercase">42m</p>
      <p class="h3">Utenti verificati</p>
    </div>
    <div
      class="rounded-custom grid content-start gap-5 border p-4 md:p-6"
    >
      <p class="h2 lowercase"><?= e(currency_symbol()) ?>440m</p>
      <p class="h3">Volume delle transazioni</p>
    </div>
    <div
      class="rounded-custom grid content-start gap-5 border p-4 md:p-6"
    >
      <p class="h2 lowercase">100+</p>
      <p class="h3">Nazioni supportate</p>
    </div>
  </div>
</div>
      <!-- capabilities -->
    ...
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Funzionalità di investimento chiave</p>
          <p>Competenza messa in pratica con progetti concreti e approcci creativi.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Acquisto di crypto</p>
          <p>Un ambiente sicuro e semplice per acquistare criptovalute. Elaborazione rapida, commissioni ridotte. Inizia a fare trading subito.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Analisi di mercato</p>
          <p>Comprendi prezzi e trend per decisioni di investimento informate.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Trading di asset digitali</p>
          <p>Fai trading di futures crypto. Esplora, investi e sviluppa il portafoglio.</p>
        </div>
      </div>
    </div>
  </div>
...
<p class="h2">Inizia ora</p>
<p>
  Esplora il trading crypto con <?= e(SITE_NAME) ?>. I trader in <?= e(geo_country_name()) ?> trovano una piattaforma che unisce tecnologia avanzata, efficienza e strumenti semplici da usare.</p>
          </div>
