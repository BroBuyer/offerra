...
$page_title = 'Supporto | Assistenza del team ' . SITE_NAME;
$page_description = 'Contatta il team ' . SITE_NAME . ' per conti, depositi, prelievi e domande sulla piattaforma.';
$page_canonical = page_url("contacts.php");
$active_page = "contacts";
$schema_extra = ['breadcrumb' => schema_breadcrumb('Contattaci', 'contacts.php')];
      ...
      <div class="pt-5">
        <div class="container-base">
          ...
          >
            ...
            <span class="breadcrumb-item">Contattaci</span>
          </nav>
        </div>
      </div>
      <!-- contact -->
...
<h1>Contattaci</h1>
  <p class="lead max-w-3xl justify-self-center text-center md:text-left">Il team <?= e(SITE_NAME) ?> risponde a domande su conti, depositi, prelievi, grafici e strumenti IA. L’assistenza passa dai canali ufficiali — nessuna raccomandazione di investimento personalizzata né garanzia di profitto.</p>
<div class="grid gap-4 text-center md:gap-6 md:text-left max-w-3xl justify-self-center">
  <h3>Scrivici per ulteriore assistenza</h3>  <p>Prima di scriverci, prepara l’email del conto, l’argomento (registrazione, pagamento, tecnico) e eventuali screenshot. Più i dettagli sono chiari, più rapida è la risoluzione.</p>  <p>Le richieste su trade attivi o prelievi in corso sono prioritarie quando possibile. Per la tua sicurezza non chiederemo mai la password completa né i codici 2FA via email non sollecitata.</p>  <p>Se non sei ancora registrato, apri un conto in pochi minuti dalla pagina di iscrizione e poi torna qui. Consulta anche le FAQ per commissioni, sicurezza e mercati disponibili.</p>  <p>Indica un oggetto chiaro (es. «Prelievo in corso», «Problema 2FA», «Domanda sulle commissioni»). La maggior parte delle richieste riceve una prima risposta in poche ore; un volume elevato o controlli di pagamento possono allungare i tempi.</p></div>
