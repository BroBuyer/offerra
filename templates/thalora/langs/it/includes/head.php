...
$page_title = $page_title ?? (SITE_NAME . ' | Piattaforma di trading IA di primo livello');
$page_description = $page_description ?? ('Accedi a criptovalute, forex e asset globali da un’unica piattaforma. ' . SITE_NAME . ' combina analisi in tempo reale, automazione assistita e supporto esperto.');
...
<?php endif; ?>
  ...
  window.APP_LANG = {
    ...
    valPhoneCountry: 'Prefisso paese non valido',
    valPhoneShort: 'Il numero è troppo corto',
    valPhoneLong: 'Il numero è troppo lungo',
    valPhoneEmpty: 'Inserisci il tuo numero di telefono',
    valSessionExpired: 'Sessione scaduta. Ricarica la pagina e riprova.',
    valGenericError: 'Si è verificato un errore. Riprova più tardi.',
    valConnectionError: 'Errore di connessione. Controlla la connessione internet e riprova.'
  };
