        ...
        <div style="background-color: #1a1a1e !important; border-bottom: 1px solid #27272a !important; padding: 14px 18px !important; display: flex !important; align-items: center !important; justify-content: space-between !important; flex-direction: row !important;">
            <div style="display: flex !important; align-items: center !important; gap: 12px !important; flex-direction: row !important;">
                ...
                <div style="text-align: left !important;">
                    ...
                    <p style="color: #a1a1aa !important; font-size: 11px !important; margin: 0 !important; padding: 0 !important; opacity: 0.85;">Guida all’onboarding</p>
                </div>
            </div>
            <button id="chat-close-btn" type="button" aria-label="Chiudi la chat" style="color: #a1a1aa !important; background: transparent !important; border: none !important; cursor: pointer !important; padding: 6px !important; display: flex !important; align-items: center !important; transition: color 0.2s;">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const quizLang = {
        welcome: `Ciao! Sono Olivia, la tua guida all’onboarding <?= e(SITE_NAME) ?>. Il tuo accesso è preapprovato. Iniziamo a costruire il tuo profilo.`,
        q1: `Conferma di risiedere <?= e(geo_country_in()) ?> per rispettare pienamente i requisiti di legge.`,
        a1_yes: `Sì, ci vivo attualmente`,
        a1_no: `No`,
        q2: `Perfetto. Seleziona la fascia di età così da consigliarti prodotti adatti:`,
        q3: `Hai attualmente un conto bancario o una carta di credito attivi per ricevere versamenti quotidiani?`,
        a3_yes: `Sì, il mio conto è attivo`,
        a3_no: `Non al momento`,
        q4: `Qual è la tua principale fonte di reddito? Ci aiuta ad adattare i parametri di rischio.`,
        a4_1: `Dipendente o freelance`,
        a4_2: `Risparmi o redditi passivi`,
        a4_3: `Altri tipi di reddito`,
        q5: `Ancora un attimo! Qualcuno del team ti chiamerà tra le 11:00 e le 20:00 per una breve verifica. Potrai rispondere?`,
        a5_yes: `Sì, quell’orario va bene`,
        a5_no: `Contattatemi presto`,
        loaderText: `Verifica delle risposte e creazione del tuo conto sicuro...`,
        finalTitle: `Verifica completata! 🎉 Il tuo conto sicuro è pronto. Segui le istruzioni qui sotto per attivare i versamenti quotidiani:`,
    ...
    function appendAgentMessage(text) {
        ...
        msg.innerHTML = `
            <div style="width: 28px; height: 28px; border-radius: 50%; border: 1px solid var(--color-primary); background-color: #27272a; display: flex; align-items: center; justify-content: center; overflow: hidden; flex-shrink: 0; margin-top: 2px;">
                <img alt="Immagine della piattaforma di trading" src="<?= asset('static/img/consultant.webp') ?>" width="28" height="28" decoding="async" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';" style="width:100%; height:100%; object-fit:cover;" class="cq-consultant-img">
