...
$page_title = 'Apri il tuo conto | Inizia a fare trading con ' . SITE_NAME;
$page_description = 'Apri rapidamente il tuo conto ' . SITE_NAME . ' per sbloccare funzionalità di trading IA avanzate.';
$page_canonical = page_url("sign.php");
$active_page = "sign";
$schema_extra = ['breadcrumb' => schema_breadcrumb('Accedi / Registrati', 'sign.php')];
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      ...
      <span class="breadcrumb-item">Accedi / Registrati</span>
    </nav>
  </div>
</div>
      <!-- registration-1 -->
...
<h1>Apri il tuo conto <?= e(SITE_NAME) ?> oggi</h1>
<h2>Opera su una piattaforma regolamentata™</h2>
<p>
  La fiducia di trader privati e aziende per l’acquisto, la vendita e la gestione sicura delle criptovalute.</p>
          </div>
