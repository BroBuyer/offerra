...
$page_title = 'Υποστήριξη | Βοήθεια από την ομάδα ' . SITE_NAME;
$page_description = 'Επικοινωνήστε με την ομάδα υποστήριξης του ' . SITE_NAME . ' για βοήθεια με λογαριασμούς, καταθέσεις, αναλήψεις και ερωτήματα πλατφόρμας.';
$page_canonical = page_url("contacts.php");
$active_page = "contacts";
$schema_extra = ['breadcrumb' => schema_breadcrumb('Επικοινωνία', 'contacts.php')];
      ...
      <div class="pt-5">
        <div class="container-base">
          ...
          >
            ...
            <span class="breadcrumb-item">Επικοινωνία</span>
          </nav>
        </div>
      </div>
      <!-- contact -->
...
<h1>Επικοινωνία</h1>
  <p class="lead max-w-3xl justify-self-center text-center md:text-left">Η ομάδα του <?= e(SITE_NAME) ?> απαντά σε ερωτήματα για λογαριασμούς, χρηματοδότηση, αναλήψεις, γραφήματα και εργαλεία τεχνητής νοημοσύνης. Η υποστήριξη παρέχεται μέσω επίσημων καναλιών — χωρίς εξατομικευμένες επενδυτικές συστάσεις ή εγγυήσεις κέρδους.</p>
<div class="grid gap-4 text-center md:gap-6 md:text-left max-w-3xl justify-self-center">
  <h3>Στείλτε μας email για περαιτέρω βοήθεια</h3>  <p>Πριν επικοινωνήσετε, έχετε έτοιμα το email του λογαριασμού, το θέμα (εγγραφή, πληρωμή, τεχνικό) και σχετικά στιγμιότυπα οθόνης. Όσο πιο σαφείς είναι οι πληροφορίες, τόσο ταχύτερη η επίλυση.</p>  <p>Τα αιτήματα για ενεργές συναλλαγές ή εκκρεμείς αναλήψεις προτεραιοποιούνται όπου είναι δυνατόν. Για την ασφάλειά σας, δεν θα ζητήσουμε ποτέ τον πλήρη κωδικό ή κωδικούς 2FA μέσω ανεπιθύμητων email.</p>  <p>Αν δεν έχετε ακόμη εγγραφεί, μπορείτε να ανοίξετε λογαριασμό σε λίγα λεπτά στη σελίδα εγγραφής και να επιστρέψετε εδώ. Συμβουλευτείτε επίσης τις Συχνές ερωτήσεις για τέλη, ασφάλεια και διαθέσιμες αγορές.</p>  <p>Συμπεριλάβετε σαφές θέμα (π.χ. «Εκκρεμής ανάληψη», «Πρόβλημα 2FA», «Ερώτηση για τέλη»). Τα περισσότερα αιτήματα λαμβάνουν πρώτη απάντηση εντός λίγων ωρών· μεγάλος όγκος ή έλεγχοι πληρωμών μπορεί να καθυστερήσουν, αλλά θα υπάρξει ενημέρωση.</p></div>
