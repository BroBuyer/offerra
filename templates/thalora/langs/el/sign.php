...
$page_title = 'Ανοίξτε τον λογαριασμό σας | Ξεκινήστε συναλλαγές στο ' . SITE_NAME;
$page_description = 'Δημιουργήστε γρήγορα τον λογαριασμό σας στο ' . SITE_NAME . ' για να ξεκλειδώσετε προηγμένες δυνατότητες συναλλαγών με τεχνητή νοημοσύνη.';
$page_canonical = page_url("sign.php");
$active_page = "sign";
$schema_extra = ['breadcrumb' => schema_breadcrumb('Σύνδεση / Εγγραφή', 'sign.php')];
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      ...
      <span class="breadcrumb-item">Σύνδεση / Εγγραφή</span>
    </nav>
  </div>
</div>
      <!-- registration-1 -->
...
<h1>Ανοίξτε τον λογαριασμό σας στο <?= e(SITE_NAME) ?> σήμερα</h1>
