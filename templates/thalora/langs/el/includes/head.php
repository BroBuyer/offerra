...
$page_title = $page_title ?? (SITE_NAME . ' | Κορυφαία πλατφόρμα συναλλαγών με τεχνητή νοημοσύνη');
$page_description = $page_description ?? ('Αποκτήστε πρόσβαση σε κρυπτονομίσματα, forex και παγκόσμια περιουσιακά στοιχεία από μία πλατφόρμα. ' . SITE_NAME . ' συνδυάζει ζωντανά αναλυτικά στοιχεία, υποστηριζόμενη αυτοματοποίηση και εξειδικευμένη υποστήριξη.');
...
<?php endif; ?>
  ...
  window.APP_LANG = {
    ...
    valPhoneShort: 'Ο αριθμός είναι πολύ σύντομος',
    valPhoneLong: 'Ο αριθμός είναι πολύ μακρύς',
    valPhoneEmpty: 'Εισαγάγετε τον αριθμό τηλεφώνου σας',
    ...
    valConnectionError: 'Σφάλμα σύνδεσης. Ελέγξτε τη σύνδεσή σας στο διαδίκτυο και δοκιμάστε ξανά.'
  };
