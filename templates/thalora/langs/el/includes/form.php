...
$form_submit = $form_submit ?? 'Δημιουργία λογαριασμού';
...
<?php endif; ?>
    ...
    <div class="apx-lead-row lead-form-row">
      <label class="apx-lead-field field" data-field="fname">
        ...
        <input class="input" type="text" name="fname" placeholder="Όνομα" required pattern="[^\d]+" autocomplete="given-name" minlength="2" maxlength="50" inputmode="text" autocapitalize="words" spellcheck="false" title="Χρησιμοποιήστε μόνο γράμματα (χωρίς αριθμούς ή σύμβολα)">
        <span class="field-error hide" role="alert" aria-live="polite"></span>
      </label>
    </div>
    <div class="apx-lead-row lead-form-row">
      <label class="apx-lead-field field" data-field="lname">
        <span class="field-label">Επώνυμο</span>
        <input class="input" type="text" name="lname" placeholder="Επώνυμο" required pattern="[^\d]+" autocomplete="family-name" minlength="2" maxlength="50" inputmode="text" autocapitalize="words" spellcheck="false" title="Χρησιμοποιήστε μόνο γράμματα (χωρίς αριθμούς ή σύμβολα)">
        <span class="field-error hide" role="alert" aria-live="polite"></span>
      </label>
    </div>
    <label class="apx-lead-field field" data-field="email">
      <span class="field-label">Διεύθυνση email</span>
      <input class="input" type="email" name="email" placeholder="Διεύθυνση email" required autocomplete="email" inputmode="email">
      <span class="field-error hide" role="alert" aria-live="polite"></span>
    </label>
    <label class="apx-lead-field apx-lead-field--phone lead-form-field lead-form-field--phone field" data-field="phone">
      <span class="field-label">Αριθμός τηλεφώνου</span>
    ...
    <div class="apx-lead-badges" aria-hidden="true">
      ...
      <img src="<?= asset('static/img/svg/payment-4.svg') ?>" alt="Ασφαλής πληρωμή">
    </div>
  </div>
</form>
</div>
