    ...
    <div class="container-base">
      <div class="relative grid gap-7 md:gap-10">
        <div class="grid gap-5">
          <nav class="flex flex-col flex-wrap justify-between gap-x-10 gap-y-5 text-white md:flex-row">
            ...
            <ul class="flex flex-col gap-x-5 gap-y-4 md:flex-row md:gap-x-7 lg:gap-x-12">
              ...
              <li><a href="<?= page_url('product.php') ?>">Πλατφόρμα συναλλαγών</a></li>
              ...
              <li><a href="<?= page_url('about.php') ?>">Σχετικά με εμάς</a></li>
            </ul>
            <ul class="flex flex-col gap-x-5 gap-y-4 md:flex-row">
              <li><a href="<?= page_url('privacy.php') ?>">Δήλωση απορρήτου</a></li>
              <li><a href="<?= page_url('conditions.php') ?>">Όροι και προϋποθέσεις</a></li>
            </ul>
          </nav>
          <div class="flex justify-between gap-5">
            <div class="grid gap-5 text-white">
              <p style="color:var(--color-primary);">Ο αξιόπιστος συνεργάτης σας στις συναλλαγές</p>
        ...
        <div class="text-center text-white">
          © <?= date('Y') ?> <?= e(SITE_NAME) ?>. Με επιφύλαξη παντός δικαιώματος.
        </div>
      </div>
    </div>
  </footer>
