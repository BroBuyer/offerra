...
$page_title = SITE_NAME . ' | Platform trading berkuasa AI terkemuka';
$page_description = 'Berdagang kripto, forex dan pasar global dengan ' . SITE_NAME . ': analitik berkuasa AI dan platform intuitif yang disesuaikan untuk pelanggan di ' . geo_country_name() . '.';
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h1 id="heading-style-h1">Berdagang secara telus. Kekalkan kontrol ke atas setiap keputusan.</h1>
            <p>Akses mata wang kripto, forex dan aset global melalui satu platform. <?= e(SITE_NAME) ?> menggabungkan analitik langsung, automasi berbantu dan dukungan pakar untuk membantu anda menavigasi pasar dengan alat yang jelas dan proses yang konsisten.</p>
        </div>
...
<div class="py-8 md:py-10">
  <div class="stats-cards container-base grid gap-3 md:grid-cols-2 md:gap-6 xl:grid-cols-4">
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      ...
      <p class="h3">Mata wang disokong</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase">42m</p>
      <p class="h3">Pengguna disahkan</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase"><?= e(currency_symbol()) ?>440m</p>
      <p class="h3">Pusing ganti transaksi</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase">100+</p>
      <p class="h3">Negara dilayan</p>
    </div>
  </div>
</div>
    <!-- features -->
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 max-lg:order-2 md:gap-10">
      <h2>Mengapa pilih <?= e(SITE_NAME) ?></h2>
      <p class="md:text-lg">
        Dipilih oleh trader kripto masa kini, platform ini menetapkan piawaian baharu. Kami menggabungkan keamanan kukuh, ketelusan penuh, AI termaju dan antarmuka intuitif untuk dagangan yang yakin.      </p>
        ...
        <div class="grid grid-cols-2 gap-x-8 gap-y-6 max-sm:flex">
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Keamanan yang bisa diharap</p>
              <p>Perlindungan kukuh sentiasa menjaga informasi pribadi dan pelaburan anda.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Dagangan dipribadikan</p>
              <p>Sesuaikan kaedah dagangan anda dengan matlamat dan keutamaan anda.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Penyelesaian AI pintar</p>
              <p>Insight dagangan yang tepat untuk membimbing keputusan termaklum.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Penyelesaian dagangan otomatis</p>
              <p>Bot berkuasa AI beroperasi secara berterusan untuk pendekatan dagangan yang lebih berstruktur, berdasarkan isyarat.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Antarmuka intuitif</p>
              <p>Antarmuka mudah digunakan, direka untuk dagangan yang jelas dari awal.</p>
            </div>
          </div>
        </div>
      </div>
      <p class="h3">
        Tingkatkan perjalanan kewangan anda dengan <?= e(SITE_NAME) ?>.
      </p>
      <a class="btn btn-black" href="<?= page_url('sign.php') ?>">Daftar sekarang</a>
    </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>Dagangan tanpa usaha!</h2>
      <p class="text-lg">
        Berdagang mata wang kripto utama seperti Bitcoin, Ethereum dan Dogecoin dengan mudah dan yakin.      </p>
      <a class="btn btn-black max-md:hidden" href="<?= page_url('sign.php') ?>">Mulai sekarang</a>
    </div>
    <div class="grid gap-3 md:gap-6" data-trading></div>
    <a class="btn btn-black md:hidden" href="<?= page_url('sign.php') ?>">Mulai sekarang</a>
  </div>
</div>
<section class="feature-section">
  <div class="container">
    <div class="feature-header">
      <h2>
        Platform trading global <span>direka untuk berkembang</span>      </h2>
      <p>
        Akses pelbagai pasar kewangan melalui satu sistem yang direka untuk kelajuan, ketepatan dan performa global yang bisa diharap.      </p>
    </div>
    <div class="feature-grid">
      <div class="feature-card">
        <div class="accent"></div>
        <h3>Akses berbilang pasar</h3>
        <p>
          Berdagang mata wang kripto, forex, saham dan komoditi dalam satu platform tanpa menukar aplikasi.        </p>
      </div>
      <div class="feature-card featured">
        <div class="accent"></div>
        <h3>Pelaksanaan pesanan cepat</h3>
        <p>
          Platform dioptimumkan untuk pelaksanaan pesanan yang cepat dan bisa diharap merentas pasar global.        </p>
      </div>
      <div class="feature-card">
        <div class="accent"></div>
        <h3>Analitik masa nyata</h3>
        <p>
          Data pasar langsung, penunjuk termaju dan insight untuk membantu anda membuat keputusan cepat dan termaklum.        </p>
      </div>
    </div>
  </div>
</section>
...
<div class="py-8 md:py-10" id="how-it-works">
  <div class="container-base grid gap-6 md:gap-10">
    <div class="grid items-center gap-6 lg:grid-cols-2">
      <h2>Cara <?= e(SITE_NAME) ?> berfungsi: dari daftar hingga dagangan</h2>
      <p class="rounded-custom sm:border sm:p-8">
        Proses enam langkah yang mudah: pendaftaran, verifikasi, pembiayaan, konfigurasi strategi dan penggunaan alat pasar. Papan pemuka memaparkan masa, pilihan dan kontrol dengan jelas.      </p>
    </div>
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Buat akun Anda</p>
          <p>Daftar dengan detail dasar anda untuk mengakses platform rasmi <?= e(SITE_NAME) ?>. Langkah cepat ini membuka papan pemuka utama anda.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Sahkan identiti anda</p>
          <p>Sahkan email anda untuk membuka semua fungsi: carta langsung, alat analisis dan sumber untuk permulaan yang teratur.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Akses platform trading anda</p>
          <p>Biayai akun Anda sekurang-kurangnya <?= e(money_min()) ?>. Anda bisa pilih jumlah lebih tinggi mengikut matlamat anda; semua pilihan pembayaran dan caj dipaparkan dengan jelas sebelum verifikasi.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Tambah dana</p>
          <p>Pilih transfer bank, e-wallet atau pembayaran kad. Tempoh pemprosesan dan yuran adalah telus, supaya anda mengawal pembiayaan sepenuhnya.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Tentukan strategi anda</p>
          <p>Laraskan tetapan risiko, pasar pilihan dan pendekatan dagangan anda. <?= e(SITE_NAME) ?>: bantuan AI memilih isyarat dan pemantauan pasar tanpa mengatasi pilihan anda.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Terokai pasar yang tersedia</p>
          <p>Apabila akun Anda aktif dan dikonfigurasi, pantau harga langsung, rancang dagangan dan gunakan platform bersepadu untuk mata wang kripto dan aset lain.</p>
        </div>
      </div>
    </div>
    <div class="grid gap-6 md:grid-cols-2">
      <a class="btn btn-black" href="<?= page_url('sign.php') ?>">Mulai trading</a>
    </div>
  </div>
</div>
    <!-- payments -->
    <div class="py-8 md:py-10">
      <div class="container-base grid items-center gap-6 lg:grid-cols-2">
        <p class="text-lg">
          <?= e(SITE_NAME) ?> menyokong pelbagai kaedah pembayaran untuk pelanggan di seluruh dunia.        </p>
        ...
        <div class="grid items-end gap-6 md:grid-cols-2">
          ...
          <div class="inline-flex justify-end gap-8 max-md:hidden">
            <button class="text-primary hover:text-primary-dark -scale-x-100 cursor-pointer transition-colors"
              data-prev="reviews" aria-label="slaid sebelumnya">
          ...
          <div class="-ml-6">
            <div class="basis-full pl-6 md:basis-1/2">
              <div
                ...
                <p>
                  A fantastic platform trading is <?= e(SITE_NAME) ?>! The
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
            <p>
              <?= e(SITE_NAME) ?> melebihi jangkaan saya. Pendaftaran mudah, yuran jelas dan dukungan cepat. Secara keseluruhan, platform yang bisa dipercayai dan lancar yang saya gembira gunakan.            </p>
            <div class="flex items-center gap-4">
              <div class="initials">FE</div>
              <p class="font-bold">Pakar pertukaran asing</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Saya pilih <?= e(SITE_NAME) ?> untuk dagangan kripto dan saya berpuas hati. Proses penyediaan mudah dan telus. Ia terasa seperti pilihan yang bisa dipercayai, terutamanya untuk pendatang baharu.                </p>
            <div class="flex items-center gap-4">
              <div class="initials">IM</div>
              <p class="font-bold">Penganalisis pasar pelaburan</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Saya dapati <?= e(SITE_NAME) ?> sebagai platform yang bisa diharap dan konsisten. Pembukaan akun mudah, terma telus dan dukungan berpengetahuan. Berdagang di sini selesa.                </p>
            <div class="flex items-center gap-4">
              <div class="initials">OT</div>
              <p class="font-bold">Trader dalam talian</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Berdagang mata wang kripto dengan <?= e(SITE_NAME) ?> mudah didekati. Pendaftaran mudah, yuran mudah difahami dan bantuan tersedia ketika diperlukan. Sebagai trader baharu, ini benar-benar membuat perbezaan.                </p>
            <div class="flex items-center gap-4">
              <div class="initials">FA</div>
              <p class="font-bold">Penganalisis kewangan</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="grid gap-3 md:gap-6" data-accordion>
      <div id="accordion-1" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Apakah langkah untuk mulai trading?</span>
        ...
        <div id="content-1" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Memulakan adalah mudah. Daftar dengan detail penting anda, sahkan email dan biayai akun Anda dengan minimum <?= e(money_min()) ?>. Ini membuka suite penuh fungsi platform termasuk carta langsung, alat dagangan, analisis pasar dan dukungan berdedikasi. Tiada latar belakang dagangan diperlukan — tutorial lengkap akan membimbing anda setiap langkah.</p>
          </div>
        </div>
      </div>
      <div id="accordion-2" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Adakah <?= e(SITE_NAME) ?> bisa dipercayai untuk menguruskan wang dan informasi saya?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-2" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Di <?= e(SITE_NAME) ?>, melindungi data pribadi dan dana anda adalah keutamaan kami. Sesi dilindungi dengan penyulitan SSL, verifikasi dua faktor tersedia, dan amalan privasi dijelaskan dengan jelas. Transaksi kewangan dikendalikan melalui rakan kongsi dipercayai dan dilindungi oleh protokol dalaman. Walaupun kami berusaha untuk kebisapercayaan, pulangan pelaburan tidak dapat dijamin.</p>
          </div>
        </div>
      </div>
      <div id="accordion-3" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Berapa cepat saya bisa mengeluarkan dana?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-3" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Pengeluaran bisa diminta terus dari portal akun Anda pada kapan saja. Pemprosesan biasanya mengambil masa 1 hingga 3 hari perniagaan, bergantung pada kaedah pengeluaran yang dipilih. Yuran dan anggaran masa dipaparkan secara telus sebelum anda sahkan transaksi. Jika anda perlukan bantuan menjejak pengeluaran, pasukan dukungan kami siap membantu.</p>
          </div>
        </div>
      </div>
      <div id="accordion-4" class="group border-primary rounded-custom border transition-all">
        ...
        <div id="content-4" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Kami cadangkan bermula dengan deposit minimum untuk mengenali fungsi platform. <?= e(SITE_NAME) ?> sesuai untuk pemula dan trader berpengalaman, dengan antarmuka mesra pengguna, alat berkuasa AI pilihan dan dukungan pelanggan 24/7. Anda mengekalkan kontrol penuh ke atas pesanan, had dan tetapan risiko.</p>
          </div>
        </div>
      </div>
      <div id="accordion-5" class="group border-primary rounded-custom border transition-all">
        ...
        <div id="content-5" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Tiada pengalaman dagangan terdahulu diperlukan. Platform ini direka mesra pengguna dari awal, dengan dukungan onboarding, tutorial dan alat dipertingkat AI. Anda bisa belajar mengikut rentak sendiri — bermula dengan pasar teras dan maju secara beransur ke analisis dan automasi yang lebih canggih.</p>
          </div>
        </div>
      </div>
      <div id="accordion-7" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Pasar manakah yang bisa saya akses menggunakan <?= e(SITE_NAME) ?>?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-7" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Dalam satu antarmuka, anda bisa mengikuti mata wang kripto utama, forex dengan harga masa nyata, saham global dan komoditi. Ini menghapuskan kesusahan mengurus pelbagai aplikasi, supaya anda fokus pada analisis dan keputusan dagangan.</p>
          </div>
        </div>
      </div>
      ...
      <div id="accordion-9" class="group border-primary rounded-custom border transition-all">
        ...
        <div id="content-9" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Penyediaan akun dan verifikasi biasanya hanya mengambil beberapa menit. Masa sebelum anda bisa mulai trading bergantung pada pemprosesan deposit dan kaedah pembayaran yang dipilih. Beranda kami menampilkan panduan langkah demi langkah yang jelas tanpa proses tersembunyi.</p>
          </div>
        </div>
      </div>
      <div id="accordion-10" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Adakah dukungan tersedia untuk pertanyaan berkaitan akun?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-10" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Pasukan dukungan kami bisa dihubungi melalui halaman Hubungi atau Pertanyaan umum untuk soalan tentang akses akun, deposit, pengeluaran atau fungsi platform. Bantuan tertumpu pada operasi, bukan nasihat pelaburan.</p>
          </div>
        </div>
      </div>
      <div id="accordion-6" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Tentang platform</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-6" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p style="margin-bottom:16px;"><?= e(SITE_NAME) ?> ialah platform trading antarabangsa yang dibina untuk pengguna yang mencari performa konsisten, eksekusi cepat dan kontrol penuh lingkungan dagangan mereka. Dari mengurus layanan berasingan atau platform tempatan, ia menawarkan sistem bersatu yang menyepadukan semua fungsi utama dalam satu aliran kerja.</p>
            <p style="margin-bottom:16px;">Dari akses pasar hingga pelaksanaan pesanan dan analisis, setiap elemen direka untuk berfungsi lancar, meminimumkan gangguan. Ini membisakan pengguna fokus pada keputusan dagangan, bukan penukaran platform atau navigasi.</p>
            <p style="margin-bottom:10px; font-weight:500;">Berdagang merentas pelbagai pasar kewangan pada satu platform:</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Mata wang kripto utama dan baharu muncul</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Pasar forex dengan suapan harga langsung</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Saham global dan opsyen ekuiti</li>
              <li><span style="color:var(--color-primary);">•</span> Komoditi untuk meluaskan peluang pelaburan</li>
            </ul>
            <p style="margin-bottom:16px;">Prestasi adalah keutamaan. Sistem dioptimumkan untuk pelaksanaan pesanan berkelewatan rendah dan operasi yang bisa diharap saat aktiviti pasar rancak, memastikan reaksi tepat pada masanya terhadap perubahan harga tanpa kelewatan teknikal.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Pemprosesan pesanan cepat dan bisa diharap merentas pasar</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Penstriman data pasar berterusan</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Analitik dan penunjuk pasar prapasang</li>
              <li><span style="color:var(--color-primary);">•</span> Dukungan untuk dagangan manual dan otomatis</li>
            </ul>
            <p style="margin-bottom:16px;">Keamanan dan kebisapercayaan operasi adalah keutamaan di semua peringkat. Platform mematuhi piawaian industri dan menggunakan perlindungan dalaman untuk menjaga informasi pengguna dan aktiviti kewangan pada setiap masa.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Komunikasi data disulitkan sepenuhnya</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Pengesahan identiti menyeluruh dan protokol keamanan berlapis</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Proses transaksi dipantau dan disahkan</li>
              <li><span style="color:var(--color-primary);">•</span> Infrastruktur direka untuk ketersambungan global yang bisa diharap</li>
            </ul>
            <p style="margin-bottom:16px;">Kami memberi kepentingan yang sama kepada pengalaman pengguna. Reka bentuk sengaja singkat dan intuitif, meminimumkan kerumitan supaya trader bisa fokus sepenuhnya pada strategi mereka.</p>
            <p style="margin-bottom:16px;">Gabungan fungsi kukuh dan kesederhanaan ini menjadikan <?= e(SITE_NAME) ?> sesuai untuk pemula dan trader berpengalaman. Pemula bisa menguasai dengan cepat tanpa lengkung pembelajaran yang mencabar, manakala pengguna mahir mengekalkan fleksibiliti untuk melaksanakan taktik kompleks.</p>
            <p><?= e(SITE_NAME) ?> menawarkan skalabiliti, kebisapercayaan dan performa tinggi pada satu platform, membisakan akses aman dan teratur ke pasar kewangan antarabangsa dengan yakin.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h2>Beroperasi pada Platform Terkawal™</h2>
          <p>
            Dipercayai oleh trader individu dan perniagaan untuk pembelian, penjualan dan manajeran mata wang kripto yang selamat.          </p>
        </div>
  ...
  <section style="padding:60px 0;" class="md:!py-[100px]">
    ...
    ">
      ...
      ">
        ...
        ">
          Fungsi utama <span style='color:var(--color-primary);'><?= e(SITE_NAME) ?> platform trading</span>        </h2>
      <p style="margin-top:14px;color:#6b7280;font-size:17px;">
        Fungsi utama yang direka untuk meningkatkan kelajuan, ketepatan dan keyakinan dagangan anda.      </p>
    </div>
    <div style="
      border-radius:16px;
      overflow:hidden;
    ...
    ">
      ...
      " onmouseover="this.style.background='#f9f9fb'" class="row-block" onmouseout="this.style.background='transparent'">
        <div style="display:flex;align-items:center;gap:10px;font-weight:600;">
          ...
          Rangka kerja teknikal        </div>
        <div class="row-text" style="color:#6b7280;">
          Teknologi dagangan termaju berdasarkan AI        </div>
      </div>
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          <span style="color:var(--color-primary);">💳</span>
          Kaedah pembiayaan        </div>
        <div class="row-text" style="color:#6b7280;">
          Kad debit, transfer bank, pilihan PayPal        </div>
      </div>
      <div class="row-block" style="
        display:grid;
        grid-template-columns: 1fr 2fr;
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          <span style="color:var(--color-primary);">📱</span>
          Kebisacapaian platform        </div>
        <div class="row-text" style="color:#6b7280;">
          Berfungsi merentas pelbagai peranti        </div>
      </div>
      <div class="row-block" style="
        display:grid;
        grid-template-columns: 1fr 2fr;
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          <span style="color:var(--color-primary);">📊</span>
          Instrumen tersedia        </div>
        <div class="row-text" style="color:#6b7280;">
          Forex, ekuiti, mata wang kripto, komoditi dan banyak lagi        </div>
      </div>
      <div class="row-block" style="
        display:grid;
        grid-template-columns: 1fr 2fr;
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          ...
          Panduan penyediaan akun        </div>
        <div class="row-text" style="color:#6b7280;">
          Onboarding cepat dan lancar        </div>
      </div>
      <div class="row-block" style="
        display:grid;
      ...
      ">
        <div class="customer-block" style="display:flex;gap:10px;font-weight:600;">
          <span style="color:var(--color-primary);">📞</span>
          Dukungan pelanggan          <span style="font-weight:400;color:#6b7280;margin-left:10px;">
            Dukungan profesional tersedia 24/7          </span>
        </div>
...
<div class="md:border-primary-light md:rounded-[20px] md:border md:px-20 md:py-8">
  <div class="border-primary-light grid justify-items-center gap-6 rounded-[20px] border px-4 py-5 md:gap-4 md:px-8 md:py-6 text-center md:text-left">
    <h2 class="h3 flex flex-wrap items-center justify-center md:justify-start gap-x-4 gap-y-3">
      Apa kata pengguna <?= e(SITE_NAME) ?>      <span class="inline-flex items-center justify-center rounded-full bg-emerald-600 px-2 py-1 text-sm leading-none text-white uppercase">
        Dipercayai      </span>
    </h2>
    <div class="flex flex-wrap items-center justify-center md:justify-start gap-2.5 text-center md:text-left">
      ...
      <span class="leading-none text-amber-500" role="img"
        aria-label="4.7 Markah (dari 5)">
        ★★★★★      </span>
      <span class="flex flex-wrap justify-center md:justify-start gap-1 text-sm text-gray-400">
        <span>
          <strong>124</strong> ulasan pelanggan ·
        </span>
        <span>
          Berdasarkan <strong>337</strong> penilaian ·
        </span>
        <span>
          Markah (dari 5)        </span>
      </span>
    ...
    <p class="text-center md:text-left">
      Platform trading intuitif yang merangkumi alat automasi termaju dan sumber pendidikan yang luas.    </p>
  </div>
</div>
      </div>
    </section>
