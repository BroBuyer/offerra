...
$form_submit = $form_submit ?? 'Buat akun';
...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__text">
      Permintaan anda dengan <?= e(SITE_NAME) ?> telah diterima. Silakan tunggu panggilan dari manajer kami.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <div class="apx-lead-row lead-form-row">
      <label class="apx-lead-field field" data-field="fname">
        ...
        <input class="input" type="text" name="fname" placeholder="Nama depan" required pattern="[^\d]+" autocomplete="given-name" minlength="2" maxlength="50" inputmode="text" autocapitalize="words" spellcheck="false" title="Gunakan huruf sahaja (tiada nomor atau simbol)">
    ...
    <div class="apx-lead-row lead-form-row">
      <label class="apx-lead-field field" data-field="lname">
        ...
        <input class="input" type="text" name="lname" placeholder="Nama belakang" required pattern="[^\d]+" autocomplete="family-name" minlength="2" maxlength="50" inputmode="text" autocapitalize="words" spellcheck="false" title="Gunakan huruf sahaja (tiada nomor atau simbol)">
        <span class="field-error hide" role="alert" aria-live="polite"></span>
      </label>
    </div>
    <label class="apx-lead-field field" data-field="email">
      <span class="field-label">Alamat email</span>
      <input class="input" type="email" name="email" placeholder="Alamat email" required autocomplete="email" inputmode="email">
      <span class="field-error hide" role="alert" aria-live="polite"></span>
    </label>
    ...
    <p class="apx-lead-consent">
      Dengan mengirim detail Anda, Anda setuju dengan <a href="<?= page_url('privacy.php') ?>">Kebijakan Privasi</a> dan <a href="<?= page_url('conditions.php') ?>">Ketentuan Penggunaan</a>.
    </p>
    <div class="apx-lead-badges" aria-hidden="true">
      ...
      <img src="<?= asset('static/img/svg/payment-4.svg') ?>" alt="Pembayaran selamat">
    </div>
  </div>
</form>
</div>
