...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const quizLang = {
        ...
        a1_no: `Tidak`,
        q2: `Bagus. Pilih kumpulan umur anda supaya kami bisa mengesyorkan produk kewangan yang sesuai:`,
        q3: `Adakah anda kini mempunyai akun bank atau kad kredit yang aktif untuk menerima pembayaran dividen harian?`,
        a3_yes: `Ya, akun saya aktif`,
        ...
        q5: `Sedikit lagi! Seseorang dari pasukan kami akan menghubungi anda antara 11:00 dan 20:00 untuk verifikasi singkat. Bisakah anda menerima panggilan itu?`,
        a5_yes: `Ya, masa itu sesuai`,
        a5_no: `Silakan hubungi saya segera`,
        loaderText: `Menyemak jawapan anda dan menyediakan akun selamat anda...`,
        finalTitle: `Pengesahan selesai! 🎉 Akun selamat anda sudah sedia. Silakan ikut arahan di bawah untuk mengaktifkan pembayaran harian:`,
    ...
    function appendAgentMessage(text) {
        ...
        msg.innerHTML = `
            <div style="width: 28px; height: 28px; border-radius: 50%; border: 1px solid var(--color-primary); background-color: #27272a; display: flex; align-items: center; justify-content: center; overflow: hidden; flex-shrink: 0; margin-top: 2px;">
                <img alt="Imej platform trading" src="<?= asset('static/img/consultant.webp') ?>" width="28" height="28" decoding="async" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';" style="width:100%; height:100%; object-fit:cover;" class="cq-consultant-img">
