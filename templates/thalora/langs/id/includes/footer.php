    ...
    <div class="container-base">
      <div class="relative grid gap-7 md:gap-10">
        <div class="grid gap-5">
          <nav class="flex flex-col flex-wrap justify-between gap-x-10 gap-y-5 text-white md:flex-row">
            ...
            <ul class="flex flex-col gap-x-5 gap-y-4 md:flex-row md:gap-x-7 lg:gap-x-12">
              ...
              <li><a href="<?= page_url('product.php') ?>">Platform trading</a></li>
            ...
            <ul class="flex flex-col gap-x-5 gap-y-4 md:flex-row">
              ...
              <li><a href="<?= page_url('conditions.php') ?>">Syarat dan ketentuan</a></li>
            </ul>
          </nav>
          <div class="flex justify-between gap-5">
            <div class="grid gap-5 text-white">
              <p style="color:var(--color-primary);">Rakan dagangan anda yang bisa diharap</p>
        ...
        <div class="grid gap-2.5 text-sm text-gray-500">
            <p>
                <?= e(SITE_NAME) ?> tidak menerima sebarang tanggungjawab atas kerugian atau kerosakan yang timbul dari penggunaan informasi laman ini, termasuk kandungan pendidikan, harga, carta atau analisis pasar. Dagangan instrumen kewangan melibatkan risiko yang ketara; silakan nilai keadaan pribadi anda dengan teliti. Dapatkan nasihat penasihat profesional sebelum berdagang. Laburkan hanya modal yang anda mampu rugi, karena produk seperti forex, CFD dan mata wang kripto mungkin tidak sesuai untuk semua pelabur.
            </p>
        </div>
