...
$page_title = $page_title ?? (SITE_NAME . ' | Platform trading berkuasa AI terkemuka');
$page_description = $page_description ?? ('Akses mata wang kripto, forex dan aset global melalui satu platform. ' . SITE_NAME . ' menggabungkan analitik langsung, automasi berbantu dan dukungan pakar.');
...
<?php endif; ?>
  ...
  window.APP_LANG = {
    ...
    valTeleponShort: 'Nomor terlalu pendek',
    valTeleponLong: 'Nomor terlalu panjang',
    valTeleponEmpty: 'Masukkan nomor telepon Anda',
