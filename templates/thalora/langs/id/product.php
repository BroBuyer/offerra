...
$page_description = 'Gunakan carta pasar langsung, insight AI dan pelbagai alat dagangan ' . SITE_NAME . ', dengan keamanan yang dipercayai.';
  ...
  <div class="container-base grid gap-6 lg:grid-cols-2">
    ...
    >
      ...
      <p class="relative z-20">
        Akses insight pasar dan portfolio yang luas dengan analitik <?= e(SITE_NAME) ?>. Carta masa nyata, penunjuk bersepadu dan analisis berkuasa AI membantu anda membuat pilihan termaklum.      </p>
    </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-8 max-w-4xl">
    <p class="text-lg"><?= e(SITE_NAME) ?> menawarkan platform bersepadu dengan alat dagangan, pemantauan pasar yang luas dan automasi berbantu. Terokai fungsi terperinci dan manfaat harian di bawah.</p>    <p>Platform kami menawarkan akses kepada pelbagai pasar termasuk mata wang kripto, forex, ekuiti dan komoditi dengan pembaruan harga langsung. Urus pesanan dan kontrol risiko dengan lancar dari satu papan pemuka disatukan, tanpa mengurus pelbagai aplikasi.</p>    <p>Alat analisis menggabungkan data masa nyata dengan insight berkuasa AI untuk mengenal pasti tren dan pergerakan ketara. Ini menyokong pembuatan keputusan anda; anda mengawal strategi, jumlah dagangan dan had. Antarmuka menumpukan pada kesederhanaan dan pelaksanaan cekap.</p>    <p>Keamanan dan kebisapercayaan adalah dasar: sambungan disulitkan, perlindungan akun kukuh dan proses pembiayaan yang jelas. Sesuai untuk pemula dan pakar, ia berkembang lancar dari penggunaan dasar ke dagangan termaju tanpa perlu menukar platform.</p>    <div class="grid gap-6 md:grid-cols-2">
            <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-3">Pasar dan instrumen dagangan</h2>
        <p>Pantau mata wang digital, forex, saham dan komoditi dengan alat bersepadu, senarai pantau dan amaran. <?= e(SITE_NAME) ?> menghubungkan analisis dengan manajeran pesanan dan portfolio.</p>
      </div>
                  <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-3">Ketelusan, keamanan dan kontrol</h2>
        <p>Sambungan selamat, prosedur disahkan, serta langkah deposit/pengeluaran yang telus. Yuran dipaparkan sebelum verifikasi.</p>
      </div>
          </div>
  </div>
</div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>Platform trading berdasarkan pelayar</h2>
      <div class="grid grid-cols-2 gap-x-8 gap-y-6">
        ...
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Insight pasar</p>
            <p>Capaian cepat kepada rekod data yang lengkap</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Dioptimumkan untuk seluler</p>
            <p>Pengalaman seluler yang dioptimumkan di mana-mana</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
    ...
    <div class="flex items-center justify-center">
        ...
        <img
          ...
          alt="<?= e(SITE_NAME) ?> — platform trading pada seluler"
    ...
    <div class="grid gap-6 lg:grid-cols-2">
      ...
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          ...
          <p>Persekitaran selamat dan mesra pengguna untuk membeli mata wang kripto. Pemprosesan cepat dengan yuran minimum. Mulai trading segera.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Analitik pasar</p>
          <p>Dapatkan insight tentang harga dan tren pasar untuk keputusan pelaburan yang termaklum.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
...
<p>
  Terokai dagangan kripto dengan <?= e(SITE_NAME) ?>. Pedagang di <?= e(geo_country_name()) ?> mendapat manfaat dari platform yang menggabungkan teknologi termaju, kecekapan dan alat mesra pengguna.</p>
          </div>
