...
$page_description = 'Manfaat dari onboarding tersuai, pengawasan portfolio, keamanan disulitkan dan bantuan pasar pakar ' . SITE_NAME . '.';
...
<span class="breadcrumb-item">Butiran penawaran</span>
          </nav>
        </div>
      </div>
      <!-- tracker -->
      <div class="py-8 md:py-10">
        <div class="container-base grid gap-6 lg:grid-cols-2">
          ...
          >
 <h1 class="relative z-20">Mulakan perjalanan anda dengan <?= e(SITE_NAME) ?>: pemantauan pasar, analisis dan dukungan</h1>
<p class="relative z-20">
  Daftar, sahkan identiti anda dan tambah dana dengan cepat. Nikmati penjejakan portfolio, bantuan dagangan AI dan pengalaman berpandu yang membawa anda dengan jelas dari log masuk pertama ke papan pemuka.</p>
          </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-8">
    <p class="text-lg max-w-4xl">Perkhidmatan kami menawarkan onboarding berpandu, akses penuh kepada alat pasar dan bantuan berterusan. Kami menyediakan laluan yang mudah dan telus dari pendaftaran ke dagangan harian tanpa pintasan.</p>    <p class="max-w-4xl">Deposit minimum membuka semua fungsi platform. Terokai strategi berkuasa AI, urus kontrol risiko dan jejak kemajuan portfolio anda.</p>    <p class="max-w-4xl">Sentiasa semak yuran, masa pengeluaran dan langkah verifikasi seperti yang dipaparkan pada platform. Kami bertujuan memberi anda kontrol operasi: had, saiz posisi dan pilihan manual kekal tersedia walaupun amaran otomatis aktif.</p>    <p class="max-w-4xl">Dukungan menjelaskan cara <?= e(SITE_NAME) ?> beroperasi dan status transaksi; ia tidak memberi nasihat pribadi. Pasar membawa risiko: nilai pendedahan anda dengan teliti dan berdagang hanya dengan wang yang anda mampu rugi.</p>    <div class="grid gap-4 md:grid-cols-3">
            <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-2">Onboarding tanpa usaha</h2>
        <p>Penciptaan akun, verifikasi identiti dan akses papan pemuka yang telus tanpa usaha.</p>
      </div>
            <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-2">AI dan pasar</h2>
        <p>Analitik terbina dalam, isyarat otomatis dan ketersediaan berbilang pasar dalam satu platform.</p>
      </div>
            <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-2">Dukungan pelanggan yang jelas</h2>
        <p>Struktur yuran dan dasar pengeluaran yang jelas; dukungan berdedikasi untuk akun dan transaksi.</p>
      </div>
          </div>
  </div>
</div>
...
<div class="relative z-40 py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10">
    ...
    <div class="border-primary h3 rounded-custom relative z-10 flex items-center justify-center border bg-white p-4 text-center md:p-6">
      Tambah dana ke akun Anda    </div>
    <div class="border-primary h3 rounded-custom relative z-10 flex items-center justify-center border bg-white p-4 text-center md:p-6">
      Mulai trading dengan yakin    </div>
        </div>
      </div>
    </div>
      <!-- registration-1 -->
...
<p>
  <?= e(SITE_NAME) ?> direka untuk individu dan pasukan yang mengurus mata wang digital dan aset, menawarkan alat yang jelas, penyulitan SSL dan bantuan cepat. Satu platform untuk analisis, dagangan dan manajeran portfolio.</p>
          </div>
