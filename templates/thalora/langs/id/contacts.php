...
$page_title = 'Dukungan | Bantuan pasukan ' . SITE_NAME;
$page_description = 'Hubungi pasukan ' . SITE_NAME . ' untuk akun, deposit, pengeluaran dan pertanyaan platform.';
...
<h1>Hubungi kami</h1>
  <p class="lead max-w-3xl justify-self-center text-center md:text-left">Pasukan <?= e(SITE_NAME) ?> menyokong pertanyaan tentang akun, pembiayaan, pengeluaran, carta dan alat AI. Dukungan ditawarkan melalui saluran rasmi — tiada cadangan pelaburan pribadi atau jaminan keuntungan.</p>
<div class="grid gap-4 text-center md:gap-6 md:text-left max-w-3xl justify-self-center">
  <h3>Email kami untuk bantuan lanjut</h3>  <p>Sebelum menghubungi kami, sediakan email akun Anda, topik pertanyaan (pendaftaran, pembayaran, teknikal) dan sebarang tangkapan skrin yang berkaitan. Maklumat terperinci membantu kami menyelesaikan isu anda dengan lebih cepat dan mengurangkan bolak-balik.</p>  <p>Permintaan tentang dagangan aktif atau pengeluaran tertunda diutamakan jika bisa. Demi keamanan anda, kami tidak akan meminta kata laluan penuh atau kod 2FA melalui email yang tidak diminta.</p>  <p>Jika anda belum mendaftar, anda bisa membuka akun dalam beberapa menit di halaman pendaftaran, kemudian kembali ke sini dengan sebarang soalan. Rujuk juga Pertanyaan umum untuk informasi tentang yuran, keamanan dan pasar tersedia.</p>  <p>Silakan sertakan baris subjek yang jelas (cth. “Pengeluaran Tertunda”, “Isu 2FA”, “Soalan Yuran”). Kebanyakan pertanyaan menerima balasan pertama dalam beberapa jam; jumlah tinggi atau semakan pembayaran mungkin melambatkan respons, tetapi pembaruan akan diberikan.</p></div>
