...
$page_title = $page_title ?? (SITE_NAME . ' | Ledende AI-drevet handelsplattform');
$page_description = $page_description ?? ('Få tilgang til kryptovaluta, forex og globale aktiva fra én plattform. ' . SITE_NAME . ' kombinerer live-analyse, assistert automatisering og ekspertstøtte.');
...
<?php endif; ?>
  ...
  window.APP_LANG = {
    ...
    valPhoneEmpty: 'Skriv inn telefonnummeret ditt',
    valSessionExpired: 'Økten er utløpt. Last inn siden på nytt og prøv igjen.',
    valGenericError: 'Noe gikk galt. Prøv igjen senere.',
    valConnectionError: 'Tilkoblingsfeil. Sjekk internettforbindelsen og prøv igjen.'
  };
