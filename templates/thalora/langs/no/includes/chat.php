        ...
        <div style="background-color: #1a1a1e !important; border-bottom: 1px solid #27272a !important; padding: 14px 18px !important; display: flex !important; align-items: center !important; justify-content: space-between !important; flex-direction: row !important;">
            <div style="display: flex !important; align-items: center !important; gap: 12px !important; flex-direction: row !important;">
                ...
                <div style="text-align: left !important;">
                    ...
                    <p style="color: #a1a1aa !important; font-size: 11px !important; margin: 0 !important; padding: 0 !important; opacity: 0.85;">Onboardingveileder</p>
                </div>
            </div>
            <button id="chat-close-btn" type="button" aria-label="Lukk chatten" style="color: #a1a1aa !important; background: transparent !important; border: none !important; cursor: pointer !important; padding: 6px !important; display: flex !important; align-items: center !important; transition: color 0.2s;">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const quizLang = {
        welcome: `Hei! Jeg er Olivia, onboardingveilederen din hos <?= e(SITE_NAME) ?>. Tilgangen din er forhåndsgodkjent. La oss bygge profilen din.`,
        q1: `Bekreft at du er bosatt <?= e(geo_country_in()) ?> for å oppfylle de juridiske kravene.`,
        a1_yes: `Yes, I live here now`,
        a1_no: `Nei`,
        q2: `Flott. Velg aldersgruppe slik at vi kan anbefale egnede produkter:`,
        q3: `Har du nå en aktiv bankkonto eller et kredittkort for å motta daglige utbetalinger?`,
        a3_yes: `Ja, kontoen min er aktiv`,
        a3_no: `Ikke akkurat nå`,
        q4: `Hva er din viktigste inntektskilde? Det hjelper oss å tilpasse risikoinnstillingene.`,
        a4_1: `Ansatt eller frilanser`,
        a4_2: `Sparing eller passiv inntekt`,
        a4_3: `Andre inntektstyper`,
        q5: `Bare litt til! Noen fra teamet ringer mellom 11:00 og 20:00 for en kort verifisering. Kan du ta samtalen?`,
        a5_yes: `Ja, det tidspunktet passer`,
        a5_no: `Kontakt meg snart`,
        loaderText: `Sjekker svarene dine og oppretter den sikre kontoen...`,
        finalTitle: `Verifisering fullført! 🎉 Den sikre kontoen din er klar. Følg instruksjonene under for å aktivere daglige utbetalinger:`,
    ...
    function appendAgentMessage(text) {
        ...
        msg.innerHTML = `
            <div style="width: 28px; height: 28px; border-radius: 50%; border: 1px solid var(--color-primary); background-color: #27272a; display: flex; align-items: center; justify-content: center; overflow: hidden; flex-shrink: 0; margin-top: 2px;">
                <img alt="Bilde av handelsplattformen" src="<?= asset('static/img/consultant.webp') ?>" width="28" height="28" decoding="async" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';" style="width:100%; height:100%; object-fit:cover;" class="cq-consultant-img">
