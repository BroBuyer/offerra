...
$page_title = 'Åpne kontoen | Begynn å handle med ' . SITE_NAME;
$page_description = 'Åpne raskt ' . SITE_NAME . '-kontoen din for å låse opp avanserte AI-handelsfunksjoner.';
$page_canonical = page_url("sign.php");
$active_page = "sign";
$schema_extra = ['breadcrumb' => schema_breadcrumb('Logg inn / Registrer deg', 'sign.php')];
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      ...
      <span class="breadcrumb-item">Logg inn / Registrer deg</span>
    </nav>
  </div>
</div>
      <!-- registration-1 -->
...
<h1>Åpne <?= e(SITE_NAME) ?>-kontoen din i dag</h1>
<h2>Handle på en regulert plattform™</h2>
<p>
  Tilliten til privatpersoner og bedrifter for sikker kjøp, salg og forvaltning av kryptovaluta.</p>
          </div>
