...
$page_title = SITE_NAME . ' | Ledende AI-drevet handelsplattform';
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h1 id="heading-style-h1">Handle med åpenhet. Behold kontrollen over hver beslutning.</h1>
            <p>Få tilgang til kryptovaluta, forex og globale aktiva fra én plattform. <?= e(SITE_NAME) ?> kombinerer live-analyse, assistert automatisering og ekspertstøtte, slik at du navigerer markedene med tydelige verktøy og faste prosesser.</p>
        </div>
...
<div class="py-8 md:py-10">
  <div class="stats-cards container-base grid gap-3 md:grid-cols-2 md:gap-6 xl:grid-cols-4">
    ...
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      ...
      <p class="h3">Transaksjonsomsetning</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase">100+</p>
      <p class="h3">Land vi betjener</p>
    </div>
  </div>
</div>
    <!-- features -->
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 max-lg:order-2 md:gap-10">
      <h2>Hvorfor velge <?= e(SITE_NAME) ?></h2>
      <p class="md:text-lg">
        Foretrukket av dagens kryptotradere setter denne plattformen en ny standard. Vi kombinerer sterk sikkerhet, full åpenhet, avansert AI og et intuitivt grensesnitt for trygg handel.      </p>
        ...
        <div class="grid grid-cols-2 gap-x-8 gap-y-6 max-sm:flex">
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Pålitelig sikkerhet</p>
              <p>Solide sikringer beskytter personopplysningene og investeringene dine hele tiden.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              ...
              <p>Tilpass handelsmetodene dine til dine mål og preferanser.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              ...
              <p>Presise handelsinnsikter som støtter velinformerte beslutninger.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Automatiserte handelsløsninger</p>
              <p>AI-drevne boter kjører kontinuerlig for mer strukturerte, signalbaserte handelsopplegg.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Intuitivt grensesnitt</p>
              <p>Et enkelt grensesnitt laget for tydelig handel fra første stund.</p>
            </div>
          </div>
        </div>
      </div>
      <p class="h3">
        Styrk den økonomiske reisen din med <?= e(SITE_NAME) ?>.
      </p>
      <a class="btn btn-black" href="<?= page_url('sign.php') ?>">Registrer deg nå</a>
    </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>Uanstrengt handel!</h2>
      <p class="text-lg">
        Handle ledende kryptovalutaer som Bitcoin, Ethereum og Dogecoin — enkelt og trygt.      </p>
      <a class="btn btn-black max-md:hidden" href="<?= page_url('sign.php') ?>">Start nå</a>
    </div>
    <div class="grid gap-3 md:gap-6" data-trading></div>
    <a class="btn btn-black md:hidden" href="<?= page_url('sign.php') ?>">Start nå</a>
  </div>
</div>
<section class="feature-section">
  <div class="container">
    <div class="feature-header">
      <h2>
        En global handelsplattform <span>bygget for vekst</span>      </h2>
      <p>
        Få tilgang til flere finansmarkeder gjennom ett system laget for hastighet, nøyaktighet og pålitelig global ytelse.      </p>
    </div>
    <div class="feature-grid">
      <div class="feature-card">
        ...
        <p>
          Handle kryptovaluta, forex, aksjer og råvarer på én plattform, uten å bytte app.        </p>
      </div>
      <div class="feature-card featured">
        <div class="accent"></div>
        <h3>Rask ordreutførelse</h3>
        <p>
          En optimalisert plattform for rask og pålitelig ordreutførelse i globale markeder.        </p>
      </div>
      <div class="feature-card">
        <div class="accent"></div>
        <h3>Sanntidsanalyse</h3>
        <p>
          Livedata, avanserte indikatorer og innsikter som hjelper deg å beslutte raskt og informert.        </p>
      </div>
    </div>
  </div>
</section>
...
<div class="py-8 md:py-10" id="how-it-works">
  <div class="container-base grid gap-6 md:gap-10">
    <div class="grid items-center gap-6 lg:grid-cols-2">
      <h2>Slik fungerer <?= e(SITE_NAME) ?>: fra registrering til handel</h2>
      <p class="rounded-custom sm:border sm:p-8">
        En tydelig prosess i seks steg: registrering, verifisering, innskudd, strategioppsett og bruk av markedsverktøy. Dashbordet viser tider, valg og kontroller klart.      </p>
    </div>
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Opprett kontoen din</p>
          <p>Registrer deg med grunnleggende opplysninger for sikker tilgang til den offisielle <?= e(SITE_NAME) ?>-plattformen. Dette raske steget åpner hoveddashbordet.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Bekreft identiteten din</p>
          <p>Bekreft e-posten for å låse opp alle funksjoner: livediagrammer, analyseverktøy og ressurser for en strukturert start.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Gå til handelsplattformen</p>
          <p>Sett inn minst <?= e(money_min()) ?> på kontoen. Du kan velge et høyere beløp etter målene dine; alle betalingsvalg og gebyrer vises før bekreftelse.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Sett inn midler</p>
          <p>Velg bankoverføring, e-lommebok eller kort. Tider og gebyrer er åpne, slik at du har full kontroll over innskuddet.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Definer strategien din</p>
          <p>Juster risiko, foretrukne markeder og handelsopplegg. <?= e(SITE_NAME) ?>s AI-støtte kuraterer signaler og markedsovervåking uten å overstyre valgene dine.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Utforsk tilgjengelige markeder</p>
          <p>Når kontoen er aktiv og satt opp, følger du livepriser, planlegger handler og bruker den integrerte plattformen for krypto og andre aktiva.</p>
        </div>
      </div>
    </div>
    <div class="grid gap-6 md:grid-cols-2">
      <a class="btn btn-black" href="<?= page_url('sign.php') ?>">Begynn å handle</a>
    </div>
  </div>
</div>
    <!-- payments -->
    <div class="py-8 md:py-10">
      <div class="container-base grid items-center gap-6 lg:grid-cols-2">
        <p class="text-lg">
          <?= e(SITE_NAME) ?> støtter flere betalingsmetoder for kunder over hele verden.        </p>
        ...
        <div class="grid items-end gap-6 md:grid-cols-2">
          ...
          <div class="inline-flex justify-end gap-8 max-md:hidden">
            <button class="text-primary hover:text-primary-dark -scale-x-100 cursor-pointer transition-colors"
              data-prev="reviews" aria-label="forrige lysbilde">
          ...
          <div class="-ml-6">
            <div class="basis-full pl-6 md:basis-1/2">
              <div
                ...
                <p>
                  A fantastic-handelsplattformen is <?= e(SITE_NAME) ?>! The
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10" style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
    <div class="flex items-center justify-between gap-6 mb-6 reviews-flex-block">
      <h2 class="text-2xl font-bold">Brukeranmeldelser</h2>
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
            <p>
              <?= e(SITE_NAME) ?> overgikk forventningene mine. Registreringen var enkel, gebyrene er tydelige og supporten er rask. Alt i alt en pålitelig og smidig plattform jeg gjerne bruker.            </p>
            <div class="flex items-center gap-4">
              <div class="initials">FE</div>
              <p class="font-bold">Valutaspesialist</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Jeg valgte <?= e(SITE_NAME) ?> for kryptotrading og er fornøyd. Oppsettet var enkelt og åpent. Et trygt valg, særlig for nykommere.                </p>
            <div class="flex items-center gap-4">
        ...
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Jeg synes <?= e(SITE_NAME) ?> som en pålitelig og jevn plattform. Kontoåpningen var enkel, vilkårene er åpne og supporten kyndig. Handelen her har vært behagelig.                </p>
            <div class="flex items-center gap-4">
              <div class="initials">OT</div>
              <p class="font-bold">Nett-trader</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Handle kryptovaluta med <?= e(SITE_NAME) ?> er tilgjengelig. Registreringen var lett, gebyrene forståelige og hjelpen der når du trenger den. Som ny trader har det gjort en reell forskjell.                </p>
            <div class="flex items-center gap-4">
    ...
    <div class="grid gap-3 md:gap-6" data-accordion>
      <div id="accordion-1" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Hvilke steg trengs for å starte handel?</span>
        ...
        <div id="content-1" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Det er enkelt. Registrer deg med de viktigste opplysningene, bekreft e-posten og sett inn minst <?= e(money_min()) ?>. Da låser du opp alle funksjoner: livediagrammer, handelsverktøy, markedsanalyse og dedikert support. Ingen erfaring kreves — grundige veiledninger tar deg gjennom hvert steg.</p>
          </div>
        </div>
      </div>
      <div id="accordion-2" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Er <?= e(SITE_NAME) ?> pålitelig til å håndtere pengene og opplysningene mine?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
      ...
      <div id="accordion-3" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Hvor raskt kan jeg ta ut midler?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-3" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Uttak kan forespørres når som helst fra kontoportalen. Behandling tar vanligvis 1 til 3 virkedager, avhengig av metode. Gebyrer og estimerte tider vises før bekreftelse. Trenger du oppfølging, er supportteamet klart.</p>
          </div>
        </div>
      </div>
      <div id="accordion-4" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Hvordan vet jeg om plattformen passer mine handelsbehov?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-4" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Vi anbefaler å starte med minsteinnskuddet for å bli kjent med funksjonene. <?= e(SITE_NAME) ?> passer både nybegynnere og erfarne tradere, med et brukervennlig grensesnitt, valgfrie AI-verktøy og kundesupport 24/7. Du beholder full kontroll over ordrer, grenser og risikoinnstillinger.</p>
          </div>
        </div>
      </div>
      <div id="accordion-5" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Må jeg ha handelserfaring før jeg starter?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-5" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Ingen tidligere erfaring kreves. Plattformen er enkel fra start, med onboarding, veiledninger og AI-forsterkede verktøy. Du lærer i ditt tempo — fra kjernemarkeder til mer avansert analyse og automatisering.</p>
          </div>
        </div>
      </div>
      <div id="accordion-7" class="group border-primary rounded-custom border transition-all">
        ...
        <div id="content-7" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>I ett grensesnitt følger du ledende kryptovalutaer, forex i sanntid, globale aksjer og råvarer. Ingen hopping mellom apper: du kan fokusere på analyse og beslutninger.</p>
          </div>
        </div>
      </div>
      <div id="accordion-8" class="group border-primary rounded-custom border transition-all">
        ...
        <div id="content-8" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p><?= e(SITE_NAME) ?> tilbyr AI-verktøy som organiserer signaler, markerer vesentlige prisbevegelser og hjelper med overvåking. De støtter valgene dine uten å erstatte strategien eller garantere et resultat. Du bestemmer når du handler og hvor mye du allokerer.</p>
          </div>
        </div>
      </div>
      <div id="accordion-9" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Hvor lang tid tar det vanligvis fra registrering til første handel?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-9" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Kontoåpning og verifisering tar vanligvis bare noen minutter. Tiden til første handel avhenger av innskuddsbehandling og betalingsmetode. Forsiden har en tydelig steg-for-steg-guide uten skjulte ledd.</p>
          </div>
        </div>
      </div>
      <div id="accordion-10" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Finnes det support for kontospørsmål?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-10" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Teamet nås via Kontakt eller FAQ for tilgang til konto, innskudd, uttak eller funksjoner. Hjelpen er operativ, ikke investeringsråd.</p>
          </div>
        </div>
      </div>
      <div id="accordion-6" class="group border-primary rounded-custom border transition-all">
        ...
        <div id="content-6" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p style="margin-bottom:16px;"><?= e(SITE_NAME) ?> er en internasjonal handelsplattform for jevn ytelse, rask utførelse og full kontroll over handelsmiljøet. I stedet for flere tjenester samler den nøkkelfunksjoner i én arbeidsflyt.</p>
            <p style="margin-bottom:16px;">Fra markedstilgang til utførelse og analyse er hvert ledd laget for å fungere uten friksjon. Du fokuserer på beslutninger, ikke på å bytte verktøy.</p>
            <p style="margin-bottom:10px; font-weight:500;">Handle i flere finansmarkeder fra én plattform:</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Ledende og fremvoksende kryptovalutaer</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Forexmarkeder med livepriser</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Globale aksjer og aksjeopsjoner</li>
              <li><span style="color:var(--color-primary);">•</span> Råvarer for å bredde mulighetene</li>
            </ul>
            <p style="margin-bottom:16px;">Ytelse er avgjørende. Systemet er optimalisert for lav latens og pålitelig drift i travle perioder, slik at du reagerer på priser uten tekniske forsinkelser.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Rask og pålitelig ordrebehandling på tvers av markeder</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Kontinuerlig strøm av markedsdata</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Forhåndsinstallert analyse og markedsindikatorer</li>
              <li><span style="color:var(--color-primary);">•</span> Manuell og automatisert handel</li>
            </ul>
            <p style="margin-bottom:16px;">Sikkerhet og driftsstabilitet er prioritet på alle nivåer. Plattformen følger bransjestandarder og beskytter informasjon og finansielle aktiviteter kontinuerlig.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Fullt kryptert datakommunikasjon</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Identitetsverifisering og sikkerhetsprotokoller i flere lag</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Overvåkede og validerte transaksjonsprosesser</li>
              <li><span style="color:var(--color-primary);">•</span> Infrastruktur bygget for pålitelig global tilkobling</li>
            </ul>
            <p style="margin-bottom:16px;">Vi vektlegger brukeropplevelsen like høyt. Designet er bevisst enkelt og intuitivt, slik at tradere kan fokusere på strategien.</p>
            <p style="margin-bottom:16px;">Denne blandingen av robust funksjonalitet og enkelhet gjør <?= e(SITE_NAME) ?> ideell for nybegynnere og erfarne tradere. Du kommer raskt i gang uten en bratt læringskurve; avanserte profiler kan fortsatt kjøre komplekse taktikker.</p>
            <p><?= e(SITE_NAME) ?> leverer skalerbarhet, pålitelighet og høy ytelse på én plattform, for sikker og oversiktlig tilgang til internasjonale finansmarkeder.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <section style="padding:60px 0;" class="md:!py-[100px]">
    ...
    ">
      ...
      ">
        ...
        ">
          Nøkkelfunksjoner i <span style='color:var(--color-primary);'><?= e(SITE_NAME) ?>-handelsplattformen</span>        </h2>
      <p style="margin-top:14px;color:#6b7280;font-size:17px;">
        Funksjoner laget for mer fart, nøyaktighet og trygghet i handelen.      </p>
    </div>
    <div style="
      border-radius:16px;
      overflow:hidden;
    ...
    ">
      ...
      " onmouseover="this.style.background='#f9f9fb'" class="row-block" onmouseout="this.style.background='transparent'">
        <div style="display:flex;align-items:center;gap:10px;font-weight:600;">
          ...
          Teknisk rammeverk        </div>
        <div class="row-text" style="color:#6b7280;">
          Avansert AI-basert handelsteknologi        </div>
      </div>
      ...
      ">
        ...
        <div class="row-text" style="color:#6b7280;">
          Kort, bankoverføring, PayPal-valg        </div>
      </div>
      <div class="row-block" style="
        display:grid;
        grid-template-columns: 1fr 2fr;
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          <span style="color:var(--color-primary);">📱</span>
          Plattformtilgjengelighet        </div>
        <div class="row-text" style="color:#6b7280;">
          Fungerer på flere enheter        </div>
      </div>
      <div class="row-block" style="
        display:grid;
        grid-template-columns: 1fr 2fr;
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          <span style="color:var(--color-primary);">📊</span>
          Tilgjengelige instrumenter        </div>
        <div class="row-text" style="color:#6b7280;">
          Forex, aksjer, kryptovaluta, råvarer og mer        </div>
      </div>
      <div class="row-block" style="
        display:grid;
        grid-template-columns: 1fr 2fr;
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          ...
          Veiledning for kontoåpning        </div>
        <div class="row-text" style="color:#6b7280;">
          Rask og sømløs onboarding        </div>
      </div>
      <div class="row-block" style="
        display:grid;
      ...
      ">
        <div class="customer-block" style="display:flex;gap:10px;font-weight:600;">
          ...
          Kundesupport          <span style="font-weight:400;color:#6b7280;margin-left:10px;">
            Profesjonell support 24/7          </span>
        </div>
...
<div class="md:border-primary-light md:rounded-[20px] md:border md:px-20 md:py-8">
  <div class="border-primary-light grid justify-items-center gap-6 rounded-[20px] border px-4 py-5 md:gap-4 md:px-8 md:py-6 text-center md:text-left">
    <h2 class="h3 flex flex-wrap items-center justify-center md:justify-start gap-x-4 gap-y-3">
      Hva brukerne av <?= e(SITE_NAME) ?> sier      <span class="inline-flex items-center justify-center rounded-full bg-emerald-600 px-2 py-1 text-sm leading-none text-white uppercase">
        Pålitelig      </span>
    </h2>
    <div class="flex flex-wrap items-center justify-center md:justify-start gap-2.5 text-center md:text-left">
      ...
      <span class="flex flex-wrap justify-center md:justify-start gap-1 text-sm text-gray-400">
        ...
        <span>
          Basert på <strong>337</strong> vurderinger ·
        </span>
        <span>
          Poengsum (av 5)        </span>
      </span>
    ...
    <p class="text-center md:text-left">
      En intuitiv handelsplattform med avanserte automatiseringsverktøy og mange læringsressurser.    </p>
  </div>
</div>
      </div>
    </section>
