...
$page_title = 'Support | Hjelp fra teamet ' . SITE_NAME;
$page_description = 'Kontakt teamet ' . SITE_NAME . ' for kontoer, innskudd, uttak og plattformspørsmål.';
$page_canonical = page_url("contacts.php");
$active_page = "contacts";
$schema_extra = ['breadcrumb' => schema_breadcrumb('Kontakt oss', 'contacts.php')];
      ...
      <div class="pt-5">
        <div class="container-base">
          ...
          >
            ...
            <span class="breadcrumb-item">Kontakt oss</span>
          </nav>
        </div>
      </div>
      <!-- contact -->
...
<h1>Kontakt oss</h1>
  <p class="lead max-w-3xl justify-self-center text-center md:text-left">Teamet hos <?= e(SITE_NAME) ?> svarer på spørsmål om kontoer, innskudd, uttak, diagrammer og AI-verktøy. Hjelpen går via offisielle kanaler — uten personlige investeringsanbefalinger eller gevinstgaranti.</p>
<div class="grid gap-4 text-center md:gap-6 md:text-left max-w-3xl justify-self-center">
  <h3>Send oss e-post for mer hjelp</h3>  <p>Før du skriver, ha konto-e-post, tema (registrering, betaling, teknisk) og eventuelle skjermbilder klart. Jo tydeligere detaljer, desto raskere løsning.</p>  <p>Forespørsler om aktive handler eller ventende uttak prioriteres når det er mulig. Av sikkerhetshensyn ber vi aldri om fullt passord eller 2FA-koder i uoppfordrede e-poster.</p>  <p>Har du ikke registrert deg ennå, åpner du en konto på minutter fra registreringssiden og kommer tilbake hit. Se også FAQ for gebyrer, sikkerhet og tilgjengelige markeder.</p>  <p>Oppgi et tydelig emne (f.eks. «Uttak venter», «2FA-problem», «Gebyrspørsmål»). De fleste henvendelser får et første svar i løpet av noen timer; høyt volum eller betalingskontroller kan forlenge tiden.</p></div>
