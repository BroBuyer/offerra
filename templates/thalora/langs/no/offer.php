...
<span class="breadcrumb-item">Tilbudsdetaljer</span>
      ...
      <div class="py-8 md:py-10">
        <div class="container-base grid gap-6 lg:grid-cols-2">
          ...
          >
 <h1 class="relative z-20">Start reisen din med <?= e(SITE_NAME) ?>: markedsovervåking, analyse og støtte</h1>
<p class="relative z-20">
  Registrer deg, bekreft identiteten og sett inn midler i få steg. Porteføljeovervåking, AI-støtte og en guidet vei fra første innlogging til dashbordet.</p>
          </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-8">
    <p class="text-lg max-w-4xl">Vi tilbyr guidet onboarding, full tilgang til markedsverktøy og løpende hjelp. En enkel og åpen vei fra registrering til daglig handel, uten snarveier.</p>    <p class="max-w-4xl">Et minsteinnskudd låser opp alle funksjoner. Utforsk AI-strategier, styr risiko og følg porteføljen.</p>    <p class="max-w-4xl">Sjekk alltid gebyrer, uttakstider og verifiseringssteg som vises på plattformen. Du beholder operativ kontroll: grenser, størrelse og manuelle valg er tilgjengelige også med automatiske varsler.</p>    <p class="max-w-4xl">Support forklarer hvordan <?= e(SITE_NAME) ?> fungerer og transaksjonsstatus; den gir ikke personlige råd. Markeder innebærer risiko: vurder eksponeringen og handle bare med penger du tåler å tape.</p>    <div class="grid gap-4 md:grid-cols-3">
            <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-2">Enkel onboarding</h2>
        <p>Enkel kontoopprettelse, identitetsbekreftelse og åpen dashbordtilgang.</p>
      </div>
            <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-2">AI og markeder</h2>
        <p>Innebygd analyse, automatiske signaler og tilgang til flere markeder på én plattform.</p>
      </div>
            <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-2">Tydelig kundesupport</h2>
        <p>Tydelige gebyrer og uttakspolicyer; dedikert hjelp for kontoer og transaksjoner.</p>
      </div>
          </div>
  </div>
</div>
...
<div class="relative z-40 py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10">
    ...
    <div class="border-primary h3 rounded-custom relative z-10 flex items-center justify-center border bg-white p-4 text-center md:p-6">
      Opprett profilen din    </div>
    <div class="border-primary h3 rounded-custom relative z-10 flex items-center justify-center border bg-white p-4 text-center md:p-6">
      Sett inn på kontoen    </div>
    <div class="border-primary h3 rounded-custom relative z-10 flex items-center justify-center border bg-white p-4 text-center md:p-6">
      Handle med selvtillit    </div>
        </div>
      </div>
    </div>
      <!-- registration-1 -->
...
<h2>Den offisielle <?= e(SITE_NAME) ?>-plattformen for metodisk handel</h2>
<p>
  <?= e(SITE_NAME) ?> er laget for privatpersoner og team som forvalter digitale valutaer og aktiva, med tydelige verktøy, SSL-kryptering og rask hjelp. Én plattform for analyse, handel og porteføljeforvaltning.</p>
          </div>
