...
$page_title = $page_title ?? (SITE_NAME . ' | Vedúca obchodná platforma poháňaná AI');
$page_description = $page_description ?? ('Pristúpte ku kryptomenám, forexu a globálnym aktívam z jednej platformy. ' . SITE_NAME . ' spája analytiku naživo, podporovanú automatizáciu a odbornú podporu.');
...
<?php endif; ?>
  ...
  window.APP_LANG = {
    ...
    valPhoneShort: 'Číslo je príliš krátke',
    valPhoneLong: 'Číslo je príliš dlhé',
    valPhoneEmpty: 'Zadajte telefónne číslo',
    valSessionExpired: 'Relácia vypršala. Obnovte stránku a skúste to znova.',
    valGenericError: 'Niečo sa pokazilo. Skúste to neskôr znova.',
    valConnectionError: 'Chyba pripojenia. Skontrolujte internet a skúste to znova.'
  };
