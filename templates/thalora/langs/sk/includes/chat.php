        ...
        <div style="background-color: #1a1a1e !important; border-bottom: 1px solid #27272a !important; padding: 14px 18px !important; display: flex !important; align-items: center !important; justify-content: space-between !important; flex-direction: row !important;">
            <div style="display: flex !important; align-items: center !important; gap: 12px !important; flex-direction: row !important;">
                ...
                <div style="text-align: left !important;">
                    ...
                    <p style="color: #a1a1aa !important; font-size: 11px !important; margin: 0 !important; padding: 0 !important; opacity: 0.85;">Sprievodca onboardingom</p>
                </div>
            </div>
            <button id="chat-close-btn" type="button" aria-label="Zavrieť chat" style="color: #a1a1aa !important; background: transparent !important; border: none !important; cursor: pointer !important; padding: 6px !important; display: flex !important; align-items: center !important; transition: color 0.2s;">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const quizLang = {
        welcome: `Ahoj! Som Olivia, vaša sprievodkyňa onboardingom v <?= e(SITE_NAME) ?>. Váš prístup je vopred schválený. Poďme vytvoriť váš profil.`,
        q1: `Potvrďte, že žijete <?= e(geo_country_in()) ?>, aby ste plne splnili zákonné požiadavky.`,
        a1_yes: `Yes, I live here now`,
        a1_no: `Nie`,
        q2: `Výborne. Vyberte vekovú skupinu, aby sme mohli odporučiť vhodné produkty:`,
        q3: `Máte momentálne aktívny bankový alebo kreditný účet na denné výplaty?`,
        a3_yes: `Áno, môj účet je aktívny`,
        a3_no: `Momentálne nie`,
        q4: `Aký je váš hlavný zdroj príjmu? Pomáha nám to prispôsobiť nastavenia rizika.`,
        a4_1: `Zamestnaný alebo freelancer`,
        a4_2: `Úspory alebo pasívny príjem`,
        a4_3: `Iné typy príjmu`,
        q5: `Ešte chvíľu! Niekto z tímu vám zavolá medzi 11:00 a 20:00 kvôli krátkemu overeniu. Môžete hovor prijať?`,
        a5_yes: `Áno, ten čas mi vyhovuje`,
        a5_no: `Kontaktujte ma čoskoro`,
        loaderText: `Kontrolujeme odpovede a vytvárame váš bezpečný účet...`,
        finalTitle: `Overenie dokončené! 🎉 Váš bezpečný účet je pripravený. Postupujte podľa pokynov nižšie, aby ste povolili denné platby:`,
        processing: `Spracúvame vašu žiadosť...`
    };
    ...
    function appendAgentMessage(text) {
        ...
        msg.innerHTML = `
            <div style="width: 28px; height: 28px; border-radius: 50%; border: 1px solid var(--color-primary); background-color: #27272a; display: flex; align-items: center; justify-content: center; overflow: hidden; flex-shrink: 0; margin-top: 2px;">
                <img alt="Obrázok obchodnej platformy" src="<?= asset('static/img/consultant.webp') ?>" width="28" height="28" decoding="async" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';" style="width:100%; height:100%; object-fit:cover;" class="cq-consultant-img">
