...
$page_title = 'Otvorte účet | Začnite obchodovať s ' . SITE_NAME;
$page_description = 'Rýchlo si otvorte účet ' . SITE_NAME . ', aby ste odomkli pokročilé funkcie obchodovania s AI.';
$page_canonical = page_url("sign.php");
$active_page = "sign";
$schema_extra = ['breadcrumb' => schema_breadcrumb('Prihlásenie / Registrácia', 'sign.php')];
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      ...
      <span class="breadcrumb-item">Prihlásenie / Registrácia</span>
    </nav>
  </div>
</div>
      <!-- registration-1 -->
...
<h1>Otvorte účet <?= e(SITE_NAME) ?> už dnes</h1>
