...
$page_title = 'Obchodné nástroje | Funkcie posilnené AI — ' . SITE_NAME;
$page_description = 'Používajte grafy naživo, poznatky AI a obchodné nástroje ' . SITE_NAME . ' pri bezpečnosti, ktorej môžete dôverovať.';
$page_canonical = page_url("product.php");
$active_page = "product";
$schema_extra = ['breadcrumb' => schema_breadcrumb('Funkcie platformy', 'product.php')];
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      ...
      <span class="breadcrumb-item">Funkcie platformy</span>
    </nav>
  </div>
</div>
      <!-- analytics -->
  ...
  <div class="container-base grid gap-6 lg:grid-cols-2">
    ...
    >
      <h1 class="relative z-20">Obchodovanie a analytika posilnené AI</h1>
      <p class="relative z-20">
        Získajte široké poznatky o trhu a portfóliu z analytiky <?= e(SITE_NAME) ?>. Grafy v reálnom čase, integrované indikátory a analýza AI pre informované voľby.      </p>
    </div>
    <div class="relative grid min-h-[355px] content-end">
      ...
      <div class="bg-before-custom relative z-30 grid grid-cols-2 gap-3 md:gap-6">
        <a class="btn btn-black col-span-full" href="<?= page_url('sign.php') ?>">Registrácia</a>
        <a class="btn btn-black btn-square" href="<?= page_url('sign.php') ?>">
          <img src="<?= asset('static/img/svg/google-play.svg') ?>" alt="Stiahnuť z Google Play" />
        </a>
        <a class="btn btn-black btn-square" href="<?= page_url('sign.php') ?>">
          <img src="<?= asset('static/img/svg/app-store.svg') ?>" alt="Stiahnuť z App Store" />
        </a>
      </div>
    </div>
  </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-8 max-w-4xl">
    <p class="text-lg"><?= e(SITE_NAME) ?> ponúka integrovanú platformu: obchodné nástroje, široké sledovanie trhu a podporovanú automatizáciu. Funkcie a denné výhody nájdete nižšie.</p>    <p>Platforma otvára viacero trhov — kryptomeny, forex, akcie a komodity — s cenami naživo. Spravujte príkazy a riziko z jedného panela, bez prepínania aplikácií.</p>    <p>Analytické nástroje spájajú dáta v reálnom čase a poznatky AI, aby zachytili trendy a podstatné pohyby. Podporujú rozhodnutia; vy kontrolujete stratégiu, objem a limity. Rozhranie stavia na jednoduchosť a efektívne vykonanie.</p>    <p>Bezpečnosť a spoľahlivosť sú základ: šifrované spojenia, silná ochrana účtu a jasné vklady. Vyhovuje začiatočníkom aj expertom, škáluje sa od základného použitia po pokročilé obchodovanie bez zmeny platformy.</p>    <div class="grid gap-6 md:grid-cols-2">
            <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-3">Trhy a obchodné nástroje</h2>
        <p>Sledujte digitálne meny, forex, akcie a komodity integrovanými nástrojmi, zoznamami sledovania a upozorneniami. <?= e(SITE_NAME) ?> spája analýzu so správou príkazov a portfólia.</p>
      </div>
                  <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-3">Transparentnosť, bezpečnosť a kontrola</h2>
        <p>Bezpečné spojenia, overené postupy, transparentné vklady a výbery. Poplatky sú viditeľné pred potvrdením.</p>
      </div>
          </div>
  </div>
</div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>Obchodná platforma v prehliadači</h2>
      <div class="grid grid-cols-2 gap-x-8 gap-y-6">
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Finančné trhy</p>
            <p>Okamžitý prístup ku všetkým funkciám</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Trhové poznatky</p>
            <p>Rýchly prístup k kompletnej histórii dát</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Optimalizované pre mobil</p>
            <p>Plynulý mobilný zážitok, kdekoľvek ste</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Správa kryptomien</p>
            <p>Jednoducho spravujte celé portfólio</p>
          </div>
        </div>
      </div>
    </div>
    <div class="flex items-center justify-center">
        ...
        <img
          ...
          alt="<?= e(SITE_NAME) ?> — obchodná platforma na mobile"
...
<div class="py-8 md:py-10">
  ...
  >
    ...
    >
      ...
      <p class="h3">Objem transakcií</p>
    </div>
    <div
      class="rounded-custom grid content-start gap-5 border p-4 md:p-6"
    >
      <p class="h2 lowercase">100+</p>
      <p class="h3">Podporované štáty</p>
    </div>
  </div>
</div>
      <!-- capabilities -->
    ...
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Kľúčové investičné funkcie</p>
          <p>Skúsenosť ukázaná na konkrétnych projektoch a kreatívnych prístupoch.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Nákup krypta</p>
          <p>Bezpečné, jednoduché prostredie na nákup kryptomien. Rýchle spracovanie, nízke poplatky. Začnite obchodovať hneď.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Analytika trhu</p>
          <p>Pochopte ceny a trendy pre informované investičné rozhodnutia.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Obchodovanie s digitálnymi aktívami</p>
          <p>Obchodujte krypto futures. Objavujte, investujte a rozširujte portfólio.</p>
        </div>
      </div>
    </div>
  </div>
...
<p class="h2">Začnite teraz</p>
<p>
  Objavte krypto obchodovanie s <?= e(SITE_NAME) ?>. Traderi z <?= e(geo_country_name()) ?> nájdu platformu spájajúcu pokročilú technológiu, efektivitu a jednoduché nástroje.</p>
          </div>
