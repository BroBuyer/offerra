...
$page_title = SITE_NAME . ' | Vedúca obchodná platforma poháňaná AI';
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h1 id="heading-style-h1">Obchodujte transparentne. Zachovajte kontrolu nad každým rozhodnutím.</h1>
            <p>Pristúpte ku kryptomenám, forexu a globálnym aktívam z jednej platformy. <?= e(SITE_NAME) ?> spája analytiku naživo, podporovanú automatizáciu a odbornú podporu, aby ste trhy ovládali jasnými nástrojmi a konzistentnými procesmi.</p>
        </div>
...
<div class="py-8 md:py-10">
  <div class="stats-cards container-base grid gap-3 md:grid-cols-2 md:gap-6 xl:grid-cols-4">
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      ...
      <p class="h3">Podporované meny</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase">42m</p>
      <p class="h3">Overení používatelia</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase"><?= e(currency_symbol()) ?>440m</p>
      <p class="h3">Obrat transakcií</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase">100+</p>
      <p class="h3">Obsluhované krajiny</p>
    </div>
  </div>
</div>
    <!-- features -->
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 max-lg:order-2 md:gap-10">
      <h2>Prečo si vybrať <?= e(SITE_NAME) ?></h2>
      <p class="md:text-lg">
        Preferovaná dnešnými kryptotradermi, táto platforma nastavuje nový štandard. Spájame silné zabezpečenie, plnú transparentnosť, pokročilú AI a intuitívne rozhranie pre sebavedomé obchodovanie.      </p>
        ...
        <div class="grid grid-cols-2 gap-x-8 gap-y-6 max-sm:flex">
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Spoľahlivé zabezpečenie</p>
              <p>Silné ochrany nepretržite chránia vaše osobné údaje a investície.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Personalizované obchodovanie</p>
              <p>Prispôsobte metódy obchodovania svojim cieľom a preferenciám.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Inteligentné riešenia AI</p>
              <p>Presné obchodné poznatky pre informované rozhodnutia.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Automatizované obchodné riešenia</p>
              <p>Boty poháňané AI bežia nonstop a umožňujú štruktúrovanejší, signálový prístup k obchodovaniu.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Intuitívne rozhranie</p>
              <p>Jednoduché rozhranie navrhnuté na prehľadné obchodovanie od prvého použitia.</p>
            </div>
          </div>
        </div>
      </div>
      <p class="h3">
        Posilnite svoju finančnú cestu s <?= e(SITE_NAME) ?>.
      </p>
      <a class="btn btn-black" href="<?= page_url('sign.php') ?>">Zaregistrujte sa teraz</a>
    </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>Obchodovanie bez námahy!</h2>
      <p class="text-lg">
        Obchodujte popredné kryptomeny ako Bitcoin, Ethereum a Dogecoin — jednoducho a sebavedomo.      </p>
      <a class="btn btn-black max-md:hidden" href="<?= page_url('sign.php') ?>">Začnite teraz</a>
    </div>
    <div class="grid gap-3 md:gap-6" data-trading></div>
    <a class="btn btn-black md:hidden" href="<?= page_url('sign.php') ?>">Začnite teraz</a>
  </div>
</div>
<section class="feature-section">
  <div class="container">
    <div class="feature-header">
      <h2>
        Globálna obchodná platforma <span>postavená na rast</span>      </h2>
      <p>
        Pristúpte k viacerým finančným trhom cez jeden systém navrhnutý na rýchlosť, presnosť a spoľahlivý globálny výkon.      </p>
    </div>
    <div class="feature-grid">
      <div class="feature-card">
        ...
        <p>
          Obchodujte kryptomeny, forex, akcie a komodity na jednej platforme, bez prepínania aplikácií.        </p>
      </div>
      <div class="feature-card featured">
        <div class="accent"></div>
        <h3>Rýchle vykonanie príkazov</h3>
        <p>
          Optimalizovaná platforma na rýchle a spoľahlivé vykonanie príkazov na globálnych trhoch.        </p>
      </div>
      <div class="feature-card">
        <div class="accent"></div>
        <h3>Analytika v reálnom čase</h3>
        <p>
          Dáta naživo, pokročilé indikátory a poznatky pre rýchle, informované rozhodnutia.        </p>
      </div>
    </div>
  </div>
</section>
...
<div class="py-8 md:py-10" id="how-it-works">
  <div class="container-base grid gap-6 md:gap-10">
    <div class="grid items-center gap-6 lg:grid-cols-2">
      <h2>Ako funguje <?= e(SITE_NAME) ?>: od registrácie po obchodovanie</h2>
      <p class="rounded-custom sm:border sm:p-8">
        Jednoduchý proces v šiestich krokoch: registrácia, overenie, vklad, konfigurácia stratégie a použitie trhových nástrojov. Panel jasne ukazuje termíny, možnosti a ovládanie.      </p>
    </div>
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Vytvorte si účet</p>
          <p>Zaregistrujte sa základnými údajmi pre bezpečný prístup na oficiálnu <?= e(SITE_NAME) ?> platformu. Tento rýchly krok otvára hlavný panel.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Potvrďte identitu</p>
          <p>Potvrďte e-mail, aby ste odomkli všetky funkcie: grafy naživo, analytické nástroje a materiály pre štruktúrovaný začiatok.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Prejdite na obchodnú platformu</p>
          <p>Vložte na účet aspoň <?= e(money_min()) ?>. Môžete zvoliť vyššiu sumu podľa cieľov; všetky platobné možnosti a poplatky sú viditeľné pred potvrdením.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Pridať prostriedky</p>
          <p>Vyberte prevod, e-peňaženku alebo kartu. Časy a poplatky sú transparentné — vklad máte pod kontrolou.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Určite stratégiu</p>
          <p>Upravte riziko, preferované trhy a prístup k obchodovaniu. <?= e(SITE_NAME) ?>: podpora AI vyberá signály a sledovanie trhu, bez nahradenia vašich rozhodnutí.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Preskúmajte dostupné trhy</p>
          <p>Keď je účet aktívny a nastavený, sledujte ceny naživo, plánujte obchody a používajte integrovanú platformu na krypto a ďalšie aktíva.</p>
        </div>
      </div>
    </div>
    <div class="grid gap-6 md:grid-cols-2">
      <a class="btn btn-black" href="<?= page_url('sign.php') ?>">Začať obchodovať</a>
    </div>
  </div>
</div>
    <!-- payments -->
    <div class="py-8 md:py-10">
      <div class="container-base grid items-center gap-6 lg:grid-cols-2">
        <p class="text-lg">
          <?= e(SITE_NAME) ?> podporuje rôzne platobné metódy pre klientov na celom svete.        </p>
        ...
        <div class="grid items-end gap-6 md:grid-cols-2">
          ...
          <div class="inline-flex justify-end gap-8 max-md:hidden">
            <button class="text-primary hover:text-primary-dark -scale-x-100 cursor-pointer transition-colors"
              data-prev="reviews" aria-label="predchádzajúca snímka">
          ...
          <div class="-ml-6">
            <div class="basis-full pl-6 md:basis-1/2">
              <div
                ...
                <p>
                  A fantastic obchodnej platformy is <?= e(SITE_NAME) ?>! The
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10" style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
    <div class="flex items-center justify-between gap-6 mb-6 reviews-flex-block">
      <h2 class="text-2xl font-bold">Recenzie používateľov</h2>
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
            <p>
              <?= e(SITE_NAME) ?> prekonala moje očakávania. Registrácia bola jednoduchá, poplatky jasné, podpora rýchla. Celkovo spoľahlivá, plynulá platforma, ktorú rád používam.            </p>
            <div class="flex items-center gap-4">
              <div class="initials">FE</div>
              <p class="font-bold">Špecialista na meny</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Vybral som <?= e(SITE_NAME) ?> na krypto obchodovanie a som spokojný. Začiatok bol jasný a transparentný. Dôveryhodná voľba, najmä pre začiatočníkov.                </p>
            <div class="flex items-center gap-4">
              <div class="initials">IM</div>
              <p class="font-bold">Analytik investičných trhov</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Považujem <?= e(SITE_NAME) ?> ako spoľahlivú, konzistentnú platformu. Otvorenie účtu bolo jednoduché, podmienky transparentné, podpora kompetentná. Obchodovanie tu je pohodlné.                </p>
            <div class="flex items-center gap-4">
        ...
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Obchodovanie s kryptomenami s <?= e(SITE_NAME) ?> za prístupnú. Registrácia bola ľahká, poplatky zrozumiteľné, pomoc dostupná, keď treba. Ako nový trader cítim skutočný rozdiel.                </p>
            <div class="flex items-center gap-4">
              <div class="initials">FA</div>
              <p class="font-bold">Finančný analytik</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="grid gap-3 md:gap-6" data-accordion>
      <div id="accordion-1" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Aké kroky sú potrebné na začatie obchodovania?</span>
        ...
        <div id="content-1" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Začiatok je jednoduchý. Zaregistrujte sa kľúčovými údajmi, potvrďte e-mail a vložte aspoň <?= e(money_min()) ?>. Odomknete všetky funkcie: grafy naživo, obchodné nástroje, analýzu trhu a podporu. Skúsenosť nie je potrebná — kompletné tutoriály vás vedú krok za krokom.</p>
          </div>
        </div>
      </div>
      <div id="accordion-2" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Je <?= e(SITE_NAME) ?> spoľahlivá pri správe mojich peňazí a údajov?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-2" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>V <?= e(SITE_NAME) ?> je ochrana údajov a prostriedkov prioritou. Relácie sú šifrované SSL, k dispozícii je dvojfaktorová autentifikácia a praktiky súkromia sú jasne popísané. Finančné transakcie idú cez dôveryhodných partnerov a interné protokoly. Usilujeme o spoľahlivosť, ale výnosy nemožno zaručiť.</p>
          </div>
        </div>
      </div>
      <div id="accordion-3" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Ako rýchlo môžem vybrať prostriedky?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-3" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Výbery môžete požiadať kedykoľvek z portálu účtu. Spracovanie zvyčajne trvá 1–3 pracovné dni podľa metódy. Poplatky a odhadované termíny sú viditeľné pred potvrdením. Ak potrebujete sledovať výber, tím podpory je k dispozícii.</p>
          </div>
        </div>
      </div>
      <div id="accordion-4" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Ako zistím, či platforma vyhovuje mojim obchodným potrebám?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-4" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Odporúčame začať minimálnym vkladom, aby ste spoznali funkcie. <?= e(SITE_NAME) ?> vyhovuje začiatočníkom aj skúseným traderom: jednoduché rozhranie, voliteľné nástroje AI a podpora 24/7. Zachovávate plnú kontrolu nad príkazmi, limitmi a rizikom.</p>
          </div>
        </div>
      </div>
      <div id="accordion-5" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Je pred začiatkom potrebné obchodné skúsenosti?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-5" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Predchádzajúca skúsenosť nie je potrebná. Platforma je jednoduchá od začiatku: onboarding, tutoriály a nástroje posilnené AI. Učíte sa vlastným tempom — od základných trhov po pokročilú analýzu a automatizáciu.</p>
          </div>
        </div>
      </div>
      <div id="accordion-7" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Ktoré trhy môžem sledovať s <?= e(SITE_NAME) ?>?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-7" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>V jednom rozhraní sledujete popredné kryptomeny, forex v reálnom čase, globálne akcie a komodity. Bez prepínania aplikácií sa sústredíte na analýzu a rozhodnutia.</p>
          </div>
        </div>
      </div>
      <div id="accordion-8" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Ako funguje analytika AI?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-8" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p><?= e(SITE_NAME) ?> ponúka nástroje AI, ktoré organizujú signály, označujú výrazné pohyby ceny a pomáhajú pri sledovaní trhu. Podporujú váš výber, bez nahradenia stratégie či záruky výsledku. Vy rozhodujete, kedy konať a koľko alokovať.</p>
          </div>
        </div>
      </div>
      <div id="accordion-9" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Koľko zvyčajne trvá od registrácie po prvý obchod?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-9" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Otvorenie účtu a overenie zvyčajne trvajú niekoľko minút. Čas do prvého obchodu závisí od vkladu a platobnej metódy. Úvodná stránka ukazuje jasný sprievodca krok za krokom, bez skrytých fáz.</p>
          </div>
        </div>
      </div>
      <div id="accordion-10" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Je k dispozícii podpora pri otázkach o účte?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-10" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Tím je dostupný cez Kontakt alebo FAQ pri prístupe k účtu, vkladoch, výberoch alebo funkciách. Pomoc je prevádzková, nie investičné poradenstvo.</p>
          </div>
        </div>
      </div>
      <div id="accordion-6" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">O platforme</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-6" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p style="margin-bottom:16px;"><?= e(SITE_NAME) ?> je medzinárodná obchodná platforma pre používateľov, ktorí chcú konzistentný výkon, rýchle vykonanie a plnú kontrolu prostredia. Namiesto oddelených služieb spája kľúčové funkcie do jedného toku.</p>
            <p style="margin-bottom:16px;">Od prístupu na trh po vykonanie a analýzu každý prvok funguje bez trenia. Sústreďujete sa na rozhodnutia, nie na výmenu nástroja.</p>
            <p style="margin-bottom:10px; font-weight:500;">Obchodujte na viacerých finančných trhoch z jednej platformy:</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Popredné a rastúce kryptomeny</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Forexové trhy s cenami naživo</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Globálne akcie a opcie na akcie</li>
              <li><span style="color:var(--color-primary);">•</span> Komodity na rozšírenie možností</li>
            </ul>
            <p style="margin-bottom:16px;">Výkon je priorita. Systém je optimalizovaný na nízku latenciu a spoľahlivú prevádzku v špičke, aby ste reagovali na ceny bez technických oneskorení.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Rýchle, spoľahlivé spracovanie príkazov na trhoch</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Neustály tok trhových dát</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Predinštalovaná analytika a trhové indikátory</li>
              <li><span style="color:var(--color-primary);">•</span> Manuálne aj automatizované obchodovanie</li>
            </ul>
            <p style="margin-bottom:16px;">Bezpečnosť a prevádzková spoľahlivosť sú priorita na všetkých úrovniach. Platforma drží odvetvové štandardy a chráni informácie a finančné aktivity nepretržite.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Plne šifrovaná dátová komunikácia</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Overenie identity a viacvrstvové bezpečnostné protokoly</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Monitorované a validované procesy transakcií</li>
              <li><span style="color:var(--color-primary);">•</span> Infraštruktúra navrhnutá na spoľahlivé globálne pripojenie</li>
            </ul>
            <p style="margin-bottom:16px;">Používateľský zážitok má rovnakú váhu. Dizajn je zámerne jednoduchý a intuitívny, aby sa trader sústredil na stratégiu.</p>
            <p style="margin-bottom:16px;">Táto zmes solídnych funkcií a jednoduchosti robí <?= e(SITE_NAME) ?> ideálnou pre začiatočníkov aj skúsených traderov. Kto začína, rýchlo naberie tempo bez strmej krivky učenia; pokročilí používatelia si zachovajú slobodu pre zložité taktiky.</p>
            <p><?= e(SITE_NAME) ?> prináša škálovateľnosť, spoľahlivosť a vysoký výkon na jednej platforme — pre bezpečný, usporiadaný prístup k medzinárodným finančným trhom.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h2>Obchodujte na regulovanej platforme™</h2>
          <p>
            Dôvera individuálnych traderov a firiem pri bezpečnom nákupe, predaji a správe kryptomien.          </p>
        </div>
  ...
  <section style="padding:60px 0;" class="md:!py-[100px]">
    ...
    ">
      ...
      ">
        ...
        ">
          Kľúčové funkcie <span style='color:var(--color-primary);'><?= e(SITE_NAME) ?> obchodnej platformy</span>        </h2>
      <p style="margin-top:14px;color:#6b7280;font-size:17px;">
        Funkcie, ktoré zvyšujú rýchlosť, presnosť a istotu obchodovania.      </p>
    </div>
    <div style="
      border-radius:16px;
      overflow:hidden;
    ...
    ">
      ...
      " onmouseover="this.style.background='#f9f9fb'" class="row-block" onmouseout="this.style.background='transparent'">
        ...
        <div class="row-text" style="color:#6b7280;">
          Pokročilá obchodná technológia založená na AI        </div>
      </div>
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          ...
          Spôsoby vkladu        </div>
        <div class="row-text" style="color:#6b7280;">
          Karty, prevody, možnosti PayPal        </div>
      </div>
      <div class="row-block" style="
        display:grid;
        grid-template-columns: 1fr 2fr;
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          <span style="color:var(--color-primary);">📱</span>
          Dostupnosť platformy        </div>
        <div class="row-text" style="color:#6b7280;">
          Funguje na viacerých zariadeniach        </div>
      </div>
      <div class="row-block" style="
        display:grid;
        grid-template-columns: 1fr 2fr;
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          <span style="color:var(--color-primary);">📊</span>
          Dostupné nástroje        </div>
        <div class="row-text" style="color:#6b7280;">
          Forex, akcie, kryptomeny, komodity a ďalšie        </div>
      </div>
      <div class="row-block" style="
        display:grid;
        grid-template-columns: 1fr 2fr;
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          ...
          Sprievodca otvorením účtu        </div>
        <div class="row-text" style="color:#6b7280;">
          Rýchly, plynulý onboarding        </div>
      </div>
      <div class="row-block" style="
        display:grid;
      ...
      ">
        <div class="customer-block" style="display:flex;gap:10px;font-weight:600;">
          <span style="color:var(--color-primary);">📞</span>
          Zákaznícka podpora          <span style="font-weight:400;color:#6b7280;margin-left:10px;">
            Profesionálna podpora 24/7          </span>
        </div>
...
<div class="md:border-primary-light md:rounded-[20px] md:border md:px-20 md:py-8">
  <div class="border-primary-light grid justify-items-center gap-6 rounded-[20px] border px-4 py-5 md:gap-4 md:px-8 md:py-6 text-center md:text-left">
    <h2 class="h3 flex flex-wrap items-center justify-center md:justify-start gap-x-4 gap-y-3">
      Čo hovoria používatelia <?= e(SITE_NAME) ?>      <span class="inline-flex items-center justify-center rounded-full bg-emerald-600 px-2 py-1 text-sm leading-none text-white uppercase">
        Dôveryhodná      </span>
    </h2>
    <div class="flex flex-wrap items-center justify-center md:justify-start gap-2.5 text-center md:text-left">
      ...
      <span class="leading-none text-amber-500" role="img"
        aria-label="4.7 Hodnotenie (z 5)">
        ★★★★★      </span>
      <span class="flex flex-wrap justify-center md:justify-start gap-1 text-sm text-gray-400">
        <span>
          <strong>124</strong> recenzií klientov ·
        </span>
        <span>
          Na základe <strong>337</strong> hodnotení ·
        </span>
        <span>
          Hodnotenie (z 5)        </span>
      </span>
    ...
    <p class="text-center md:text-left">
      Intuitívna platforma s pokročilými nástrojmi automatizácie a bohatými vzdelávacími materiálmi.    </p>
  </div>
</div>
      </div>
    </section>
