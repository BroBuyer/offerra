...
$page_title = SITE_NAME . ' | Vadošā ar AI darbināma tirdzniecības platforma';
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h1 id="heading-style-h1">Tirgojiet caurspīdīgi. Saglabājiet kontroli pār katru lēmumu.</h1>
            <p>Piekļūstiet kriptovalūtām, forex un globāliem aktīviem vienā platformā. <?= e(SITE_NAME) ?> apvieno tiešsaistes analītiku, atbalstītu automatizāciju un ekspertu atbalstu, lai jūs varētu orientēties tirgos ar skaidriem rīkiem un konsekventiem procesiem.</p>
        </div>
...
<div class="py-8 md:py-10">
  <div class="stats-cards container-base grid gap-3 md:grid-cols-2 md:gap-6 xl:grid-cols-4">
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      ...
      <p class="h3">Atbalstītās valūtas</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase">42m</p>
      <p class="h3">Pārbaudīti lietotāji</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase"><?= e(currency_symbol()) ?>440m</p>
      <p class="h3">Darījumu apgrozījums</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase">100+</p>
      <p class="h3">Apkalpotās valstis</p>
    </div>
  </div>
</div>
    <!-- features -->
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 max-lg:order-2 md:gap-10">
      <h2>Kāpēc izvēlēties <?= e(SITE_NAME) ?></h2>
      <p class="md:text-lg">
        Mūsdienu kriptovalūtu tirgotāju izvēlēta, šī platforma nosaka jaunu standartu. Mēs apvienojam stingru drošību, pilnīgu caurspīdīgumu, modernu AI un intuitīvu saskarni, lai atbalstītu pārliecinātu tirdzniecību.      </p>
        ...
        <div class="grid grid-cols-2 gap-x-8 gap-y-6 max-sm:flex">
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Uzticama drošība</p>
              <p>Stipri aizsardzības pasākumi pastāvīgi aizsargā jūsu personas datus un ieguldījumus.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Personalizēta tirdzniecība</p>
              <p>Pielāgojiet tirdzniecības metodes saviem unikālajiem mērķiem un vēlmēm.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Viedie AI risinājumi</p>
              <p>Precīzi tirdzniecības ieskati labi informētiem lēmumiem.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Automatizēti tirdzniecības risinājumi</p>
              <p>Ar AI darbināmi boti darbojas nepārtraukti, lai nodrošinātu strukturētākas, uz signāliem balstītas tirdzniecības pieejas.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Intuitīva saskarne</p>
              <p>Viegli lietojama saskarne, kas izstrādāta skaidrai tirdzniecībai jau no sākuma.</p>
            </div>
          </div>
        </div>
      </div>
      <p class="h3">
        Uzlabojiet savu finanšu ceļu ar <?= e(SITE_NAME) ?>.
      </p>
      <a class="btn btn-black" href="<?= page_url('sign.php') ?>">Reģistrēties tagad</a>
    </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>Bezpiepūles tirdzniecība!</h2>
      <p class="text-lg">
        Tirgojiet vadošās kriptovalūtas, piemēram, Bitcoin, Ethereum un Dogecoin, viegli un pārliecināti.      </p>
      <a class="btn btn-black max-md:hidden" href="<?= page_url('sign.php') ?>">Sāciet tagad</a>
    </div>
    <div class="grid gap-3 md:gap-6" data-trading></div>
    <a class="btn btn-black md:hidden" href="<?= page_url('sign.php') ?>">Sāciet tagad</a>
  </div>
</div>
<section class="feature-section">
  <div class="container">
    <div class="feature-header">
      <h2>
        Globāla tirdzniecības platforma <span>izstrādāta izaugsmei</span>      </h2>
      <p>
        Piekļūstiet vairākiem finanšu tirgiem vienā sistēmā, kas izstrādāta ātrumam, precizitātei un uzticamai globālai veiktspējai.      </p>
    </div>
    <div class="feature-grid">
      <div class="feature-card">
        <div class="accent"></div>
        <h3>Piekļuve vairākiem tirgiem</h3>
        <p>
          Tirgojiet kriptovalūtas, forex, akcijas un preces vienā platformā, nepārslēdzoties starp lietotnēm.        </p>
      </div>
      <div class="feature-card featured">
        <div class="accent"></div>
        <h3>Ātra rīkojumu izpilde</h3>
        <p>
          Optimizēta platforma nodrošina ātru un uzticamu rīkojumu izpildi globālajos tirgos.        </p>
      </div>
      <div class="feature-card">
        <div class="accent"></div>
        <h3>Reāllaika analītika</h3>
        <p>
          Tiešsaistes tirgus dati, moderni indikatori un ieskati, lai pieņemtu ātrus, informētus lēmumus.        </p>
      </div>
    </div>
  </div>
</section>
...
<div class="py-8 md:py-10" id="how-it-works">
  <div class="container-base grid gap-6 md:gap-10">
    <div class="grid items-center gap-6 lg:grid-cols-2">
      <h2>Kā <?= e(SITE_NAME) ?> darbojas: no reģistrācijas līdz tirdzniecībai</h2>
      <p class="rounded-custom sm:border sm:p-8">
        Vienkāršs sešu soļu process: reģistrācija, verifikācija, finansēšana, stratēģijas konfigurācija un tirgus rīku izmantošana. Vadības panelī skaidri redzami termiņi, iespējas un vadīklas.      </p>
    </div>
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Izveidojiet savu kontu</p>
          <p>Reģistrējieties ar pamatdatiem, lai droši piekļūtu oficiālajai <?= e(SITE_NAME) ?> platformai. Šis ātrais solis nodrošina piekļuvi galvenajam vadības panelim.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Apstipriniet savu identitāti</p>
          <p>Apstipriniet e-pastu, lai atbloķētu visas funkcijas: tiešsaistes diagrammas, analītiskos rīkus un resursus strukturētam sākumam.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Piekļūstiet savai tirdzniecības platformai</p>
          <p>Iemaksājiet kontā vismaz <?= e(money_min()) ?>. Varat izvēlēties lielākas summas atbilstoši mērķiem; visas maksājumu iespējas un maksas tiek skaidri norādītas pirms apstiprināšanas.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Pievienot līdzekļus</p>
          <p>Izvēlieties bankas pārskaitījumu, e-maku vai kartes maksājumus. Visi apstrādes termiņi un komisijas ir caurspīdīgi, nodrošinot pilnīgu kontroli pār finansēšanu.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Definējiet savu stratēģiju</p>
          <p>Pielāgojiet riska iestatījumus, preferētos tirgus un tirdzniecības pieeju. <?= e(SITE_NAME) ?> AI atbalsts atlasa signālus un tirgus uzraudzību, nepārrakstot jūsu izvēles.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Izpētiet pieejamos tirgus</p>
          <p>Kad konts ir aktīvs un konfigurēts, uzraugiet tiešsaistes cenas, plānojiet darījumus un izmantojiet integrēto platformu kriptovalūtām un citiem aktīviem.</p>
        </div>
      </div>
    </div>
    <div class="grid gap-6 md:grid-cols-2">
      <a class="btn btn-black" href="<?= page_url('sign.php') ?>">Sākt tirdzniecību</a>
    </div>
  </div>
</div>
    <!-- payments -->
    <div class="py-8 md:py-10">
      <div class="container-base grid items-center gap-6 lg:grid-cols-2">
        <p class="text-lg">
          <?= e(SITE_NAME) ?> atbalsta dažādas maksājumu metodes klientiem visā pasaulē.        </p>
        ...
        <div class="grid items-end gap-6 md:grid-cols-2">
          ...
          <div class="inline-flex justify-end gap-8 max-md:hidden">
            <button class="text-primary hover:text-primary-dark -scale-x-100 cursor-pointer transition-colors"
              data-prev="reviews" aria-label="iepriekšējais slaids">
          ...
          <div class="-ml-6">
            <div class="basis-full pl-6 md:basis-1/2">
              <div
                ...
                <p>
                  A fantastic tirdzniecības platformas funkcijas is <?= e(SITE_NAME) ?>! The
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10" style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
    <div class="flex items-center justify-between gap-6 mb-6 reviews-flex-block">
      <h2 class="text-2xl font-bold">Lietotāju atsauksmes</h2>
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
            <p>
              <?= e(SITE_NAME) ?> pārsniedza manas cerības. Reģistrācija bija vienkārša, komisijas skaidras un atbalsts ātrs. Kopumā uzticama un ērta platforma, ko ar prieku izmantoju.            </p>
            <div class="flex items-center gap-4">
              <div class="initials">FE</div>
              <p class="font-bold">Ārvalstu valūtas speciālists</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Es izvēlējos <?= e(SITE_NAME) ?> kriptovalūtu tirdzniecībai un esmu apmierināts. Iestatīšana bija vienkārša un caurspīdīga. Tā šķiet uzticama izvēle, īpaši jaunpienācējiem.                </p>
            <div class="flex items-center gap-4">
              <div class="initials">IM</div>
              <p class="font-bold">Ieguldījumu tirgus analītiķis</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Es uzskatu <?= e(SITE_NAME) ?> kā uzticamu un konsekventu platformu. Konta izveide bija viegla, noteikumi caurspīdīgi un atbalsts zinošs. Tirdzniecība šeit ir ērta.                </p>
            <div class="flex items-center gap-4">
              <div class="initials">OT</div>
              <p class="font-bold">Tiešsaistes tirgotājs</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Kriptovalūtu tirdzniecība ar <?= e(SITE_NAME) ?> kā pieejamu. Reģistrācija bija viegla, komisijas saprotamas un palīdzība pieejama, kad nepieciešams. Kā jaunam tirgotājam tas ir būtiski palīdzējis.                </p>
            <div class="flex items-center gap-4">
              <div class="initials">FA</div>
              <p class="font-bold">Finanšu analītiķis</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="grid gap-3 md:gap-6" data-accordion>
      ...
      <div id="accordion-6" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Par platformu</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-6" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p style="margin-bottom:16px;"><?= e(SITE_NAME) ?> ir starptautiska tirdzniecības platforma lietotājiem, kuri meklē konsekventu veiktspēju, ātru izpildi un pilnīgu kontroli pār tirdzniecības vidi. Tā vietā, lai pārvaldītu atsevišķus pakalpojumus vai vietējās platformas, tā piedāvā vienotu sistēmu, kas integrē visas galvenās funkcijas vienā darba plūsmā.</p>
            <p style="margin-bottom:16px;">No tirgus piekļuves līdz rīkojumu izpildei un analīzei katrs elements ir veidots, lai darbotos raiti, samazinot pārtraukumus. Tas ļauj lietotājiem koncentrēties uz tirdzniecības lēmumiem, nevis platformu maiņu vai navigāciju.</p>
            <p style="margin-bottom:10px; font-weight:500;">Tirgojiet dažādos finanšu tirgos vienā platformā:</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Vadošās un jaunās kriptovalūtas</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Forex tirgi ar tiešsaistes cenu plūsmu</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Globālās akcijas un kapitāla opcijas</li>
              <li><span style="color:var(--color-primary);">•</span> Preces ieguldījumu iespēju paplašināšanai</li>
            </ul>
            <p style="margin-bottom:16px;">Veiktspēja ir prioritāte. Sistēma ir optimizēta zema latentuma rīkojumu izpildei un uzticamai darbībai intensīvas tirgus aktivitātes laikā, nodrošinot savlaicīgu reakciju uz cenu izmaiņām bez tehniskām aizkavēm.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Ātra un uzticama rīkojumu apstrāde dažādos tirgos</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Nepārtraukta tirgus datu straumēšana</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Iepriekš instalēta analītika un tirgus indikatori</li>
              <li><span style="color:var(--color-primary);">•</span> Atbalsts gan manuālai, gan automatizētai tirdzniecībai</li>
            </ul>
            <p style="margin-bottom:16px;">Drošība un operacionālā uzticamība ir prioritātes visos līmeņos. Platforma ievēro nozares standartus un izmanto iekšēju aizsardzību, lai vienmēr aizsargātu lietotāju informāciju un finanšu darbības.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Pilnībā šifrēta datu saziņa</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Visaptveroša identitātes verifikācija un daudzslāņu drošības protokoli</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Uzraudzīti un validēti darījumu procesi</li>
              <li><span style="color:var(--color-primary);">•</span> Infrastruktūra, kas izstrādāta uzticamai globālai savienojamībai</li>
            </ul>
            <p style="margin-bottom:16px;">Mēs piešķiram vienādu nozīmi lietotāja pieredzei. Dizains ir apzināti vienkāršs un intuitīvs, samazinot sarežģītību, lai tirgotāji varētu pilnībā koncentrēties uz stratēģijām.</p>
            <p style="margin-bottom:16px;">Šī robustās funkcionalitātes un vienkāršības kombinācija padara <?= e(SITE_NAME) ?> ideālu gan iesācējiem, gan pieredzējušiem tirgotājiem. Iesācēji var ātri apgūt platformu bez sarežģītas mācīšanās līknes, savukārt pieredzējuši lietotāji saglabā elastību sarežģītu taktiku īstenošanai.</p>
            <p><?= e(SITE_NAME) ?> nodrošina mērogojamību, uzticamību un augstu veiktspēju vienā platformā, ļaujot droši un organizēti piekļūt starptautiskajiem finanšu tirgiem ar pārliecību.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h2>Darbojieties regulētā platformā™</h2>
          <p>
            Uzticama individuāliem tirgotājiem un uzņēmumiem drošai kriptovalūtu iegādei, pārdošanai un pārvaldībai.          </p>
        </div>
  ...
  <section style="padding:60px 0;" class="md:!py-[100px]">
    ...
    ">
      ...
      ">
        ...
        ">
          Galvenās <span style='color:var(--color-primary);'><?= e(SITE_NAME) ?> tirdzniecības platformas funkcijas</span>        </h2>
      <p style="margin-top:14px;color:#6b7280;font-size:17px;">
        Galvenās funkcijas, kas izstrādātas, lai uzlabotu tirdzniecības ātrumu, precizitāti un pārliecību.      </p>
    </div>
    <div style="
      border-radius:16px;
      overflow:hidden;
    ...
    ">
      ...
      " onmouseover="this.style.background='#f9f9fb'" class="row-block" onmouseout="this.style.background='transparent'">
        <div style="display:flex;align-items:center;gap:10px;font-weight:600;">
          ...
          Tehniskais ietvars        </div>
        <div class="row-text" style="color:#6b7280;">
          Modernā uz AI balstīta tirdzniecības tehnoloģija        </div>
      </div>
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          <span style="color:var(--color-primary);">💳</span>
          Finansēšanas metodes        </div>
        <div class="row-text" style="color:#6b7280;">
          Debetkartes, bankas pārskaitījumi, PayPal iespējas        </div>
      </div>
      <div class="row-block" style="
        display:grid;
        grid-template-columns: 1fr 2fr;
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          <span style="color:var(--color-primary);">📱</span>
          Platformas pieejamība        </div>
        <div class="row-text" style="color:#6b7280;">
          Darbojas vairākās ierīcēs        </div>
      </div>
      <div class="row-block" style="
        display:grid;
        grid-template-columns: 1fr 2fr;
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          <span style="color:var(--color-primary);">📊</span>
          Pieejamie instrumenti        </div>
        <div class="row-text" style="color:#6b7280;">
          Forex, akcijas, kriptovalūtas, preces un vairāk        </div>
      </div>
      <div class="row-block" style="
        display:grid;
        grid-template-columns: 1fr 2fr;
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          ...
          Konta iestatīšanas ceļvedis        </div>
        <div class="row-text" style="color:#6b7280;">
          Ātra un raita ieviešana        </div>
      </div>
      <div class="row-block" style="
        display:grid;
      ...
      ">
        <div class="customer-block" style="display:flex;gap:10px;font-weight:600;">
          <span style="color:var(--color-primary);">📞</span>
          Klientu atbalsts          <span style="font-weight:400;color:#6b7280;margin-left:10px;">
            Profesionāls atbalsts pieejams 24/7          </span>
        </div>
...
<div class="md:border-primary-light md:rounded-[20px] md:border md:px-20 md:py-8">
  <div class="border-primary-light grid justify-items-center gap-6 rounded-[20px] border px-4 py-5 md:gap-4 md:px-8 md:py-6 text-center md:text-left">
    <h2 class="h3 flex flex-wrap items-center justify-center md:justify-start gap-x-4 gap-y-3">
      Ko saka <?= e(SITE_NAME) ?> lietotāji      <span class="inline-flex items-center justify-center rounded-full bg-emerald-600 px-2 py-1 text-sm leading-none text-white uppercase">
        Uzticams      </span>
    </h2>
    <div class="flex flex-wrap items-center justify-center md:justify-start gap-2.5 text-center md:text-left">
      ...
      <span class="leading-none text-amber-500" role="img"
        aria-label="4.7 Vērtējums (no 5)">
        ★★★★★      </span>
      <span class="flex flex-wrap justify-center md:justify-start gap-1 text-sm text-gray-400">
        <span>
          <strong>124</strong> klientu atsauksmes ·
        </span>
        <span>
          Pamatojoties uz <strong>337</strong> vērtējumiem ·
        </span>
        <span>
          Vērtējums (no 5)        </span>
      </span>
    ...
    <p class="text-center md:text-left">
      Intuitīva tirdzniecības platforma ar moderniem automatizācijas rīkiem un plašiem izglītojošiem resursiem.    </p>
  </div>
</div>
      </div>
    </section>
