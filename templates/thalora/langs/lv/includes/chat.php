        ...
        <div style="background-color: #1a1a1e !important; border-bottom: 1px solid #27272a !important; padding: 14px 18px !important; display: flex !important; align-items: center !important; justify-content: space-between !important; flex-direction: row !important;">
            <div style="display: flex !important; align-items: center !important; gap: 12px !important; flex-direction: row !important;">
                ...
                <div style="text-align: left !important;">
                    ...
                    <p style="color: #a1a1aa !important; font-size: 11px !important; margin: 0 !important; padding: 0 !important; opacity: 0.85;">Ieviešanas ceļvedis</p>
                </div>
            </div>
            <button id="chat-close-btn" type="button" aria-label="Aizvērt čatu" style="color: #a1a1aa !important; background: transparent !important; border: none !important; cursor: pointer !important; padding: 6px !important; display: flex !important; align-items: center !important; transition: color 0.2s;">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const quizLang = {
        welcome: `Sveiki! Esmu Olivia, jūsu <?= e(SITE_NAME) ?> ieviešanas ceļvedis. Jūsu piekļuve ir iepriekš apstiprināta. Sāksim veidot jūsu profilu.`,
        q1: `Lūdzu, apstipriniet, ka esat rezidents valstī <?= e(geo_country_in()) ?>, lai pilnībā izpildītu juridiskās prasības.`,
        a1_yes: `Jā, es dzīvoju šeit tagad`,
        a1_no: `Nē`,
        q2: `Lieliski. Izvēlieties vecuma grupu, lai mēs varētu ieteikt atbilstošus finanšu produktus:`,
        q3: `Vai jums pašlaik ir aktīvs bankas vai kredītkartes konts ikdienas dividenžu maksājumu saņemšanai?`,
        a3_yes: `Jā, mans konts ir aktīvs`,
        a3_no: `Pašlaik nē`,
        q4: `Kāds ir jūsu galvenais ienākumu avots? Tas palīdz pielāgot platformas riska iestatījumus.`,
        a4_1: `Algots darbs vai ārštata darbs`,
        a4_2: `Uzkrājumi vai pasīvie ienākumi`,
        a4_3: `Cita veida ienākumi`,
        q5: `Vēl nedaudz! Kāds no mūsu komandas jums zvanīs no 11:00 līdz 20:00 īsai verifikācijai. Vai varēsiet atbildēt?`,
        a5_yes: `Jā, šis laiks der`,
        a5_no: `Lūdzu, sazinieties ar mani drīzumā`,
        loaderText: `Pārbaudām jūsu atbildes un iestatām drošo kontu...`,
        finalTitle: `Verifikācija pabeigta! 🎉 Jūsu drošais konts ir gatavs. Lūdzu, izpildiet tālāk norādītās instrukcijas, lai iespējotu ikdienas maksājumus:`,
        processing: `Apstrādājam jūsu pieprasījumu...`
    };
    ...
    function appendAgentMessage(text) {
        ...
        msg.innerHTML = `
            <div style="width: 28px; height: 28px; border-radius: 50%; border: 1px solid var(--color-primary); background-color: #27272a; display: flex; align-items: center; justify-content: center; overflow: hidden; flex-shrink: 0; margin-top: 2px;">
                <img alt="Tirdzniecības platformas attēls" src="<?= asset('static/img/consultant.webp') ?>" width="28" height="28" decoding="async" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';" style="width:100%; height:100%; object-fit:cover;" class="cq-consultant-img">
