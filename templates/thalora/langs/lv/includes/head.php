...
$page_title = $page_title ?? (SITE_NAME . ' | Vadošā ar AI darbināma tirdzniecības platforma');
$page_description = $page_description ?? ('Piekļūstiet kriptovalūtām, forex un globāliem aktīviem vienā platformā. ' . SITE_NAME . ' apvieno tiešsaistes analītiku, atbalstītu automatizāciju un ekspertu atbalstu.');
...
<?php endif; ?>
  ...
  window.APP_LANG = {
    ...
    valPhoneShort: 'Numurs ir pārāk īss',
    valPhoneLong: 'Numurs ir pārāk garš',
    valPhoneEmpty: 'Ievadiet tālruņa numuru',
