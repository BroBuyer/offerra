...
function geo_country_in(): string
{
    ...
    if ($lang === 'ja') {
        $prepared = [
            'gb' => 'イギリスで', 'uk' => 'イギリスで',
            'us' => 'アメリカで', 'nl' => 'オランダで',
            'ae' => 'アラブ首長国連邦で', 'ph' => 'フィリピンで',
            'cz' => 'チェコで', 'jp' => '日本で',
            'my' => 'マレーシアで', 'it' => 'イタリアで',
            'fr' => 'フランスで', 'de' => 'ドイツで',
        ];

        return $prepared[$code] ?? ($name.'で');
    }

    if ($lang === 'lv') {
        $prepared = [
            'gb' => 'Apvienotajā Karalistē', 'uk' => 'Apvienotajā Karalistē',
            'us' => 'Amerikas Savienotajās Valstīs', 'nl' => 'Nīderlandē',
            'ae' => 'Apvienotajos Arābu Emirātos', 'ph' => 'Filipīnās',
            'cz' => 'Čehijā', 'lv' => 'Latvijā',
            'lt' => 'Lietuvā', 'ee' => 'Igaunijā',
            'de' => 'Vācijā', 'pl' => 'Polijā',
        ];

        return $prepared[$code] ?? ($name);
    }
