...
$page_title = 'Atveriet kontu | Sāciet tirdzniecību ar ' . SITE_NAME;
$page_description = 'Ātri iestatiet savu ' . SITE_NAME . ' kontu, lai atbloķētu modernās AI tirdzniecības iespējas.';
$page_canonical = page_url("sign.php");
$active_page = "sign";
$schema_extra = ['breadcrumb' => schema_breadcrumb('Pieteikties / Reģistrēties', 'sign.php')];
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      ...
      <span class="breadcrumb-item">Pieteikties / Reģistrēties</span>
    </nav>
  </div>
</div>
      <!-- registration-1 -->
...
<h1>Atveriet savu <?= e(SITE_NAME) ?> kontu šodien</h1>
