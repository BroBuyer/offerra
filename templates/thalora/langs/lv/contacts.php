...
$page_title = 'Atbalsts | Palīdzība no ' . SITE_NAME . ' komandas';
$page_description = 'Sazinieties ar ' . SITE_NAME . ' atbalsta komandu par kontiem, iemaksām, izņemšanām un platformas jautājumiem.';
$page_canonical = page_url("contacts.php");
$active_page = "contacts";
$schema_extra = ['breadcrumb' => schema_breadcrumb('Sazinieties ar mums', 'contacts.php')];
      ...
      <div class="pt-5">
        <div class="container-base">
          ...
          >
            ...
            <span class="breadcrumb-item">Sazinieties ar mums</span>
          </nav>
        </div>
      </div>
      <!-- contact -->
...
<h1>Sazinieties ar mums</h1>
  <p class="lead max-w-3xl justify-self-center text-center md:text-left"><?= e(SITE_NAME) ?> komanda atbalsta jautājumus par kontiem, finansēšanu, izņemšanām, diagrammām un AI rīkiem. Atbalsts tiek sniegts caur oficiāliem kanāliem — bez personalizētiem ieguldījumu ieteikumiem vai peļņas garantijām.</p>
<div class="grid gap-4 text-center md:gap-6 md:text-left max-w-3xl justify-self-center">
  <h3>Rakstiet mums e-pastu papildu palīdzībai</h3>  <p>Pirms sazināšanās, lūdzu, sagatavojiet konta e-pastu, jautājuma tēmu (reģistrācija, maksājums, tehnisks) un attiecīgos ekrānuzņēmumus. Detalizēta informācija palīdz ātrāk atrisināt jautājumu un samazina turpmāku saraksti.</p>  <p>Pieprasījumi par aktīviem darījumiem vai gaidošām izņemšanām tiek prioritizēti, kur iespējams. Jūsu drošībai mēs nekad neprasīsim pilnu paroli vai 2FA kodus nepieprasītos e-pastos.</p>  <p>Ja vēl neesat reģistrējies, kontu varat atvērt dažu minūšu laikā reģistrācijas lapā un pēc tam atgriezties šeit ar jautājumiem. Skatiet arī BUJ par komisijām, drošību un pieejamajiem tirgiem.</p>  <p>Lūdzu, iekļaujiet skaidru temata rindu (piem., “Gaida izņemšana”, “2FA problēma”, “Jautājums par komisiju”). Lielākā daļa pieprasījumu saņem pirmo atbildi dažu stundu laikā; liels apjoms vai maksājumu pārbaudes var aizkavēt atbildes, taču tiks sniegti atjauninājumi.</p></div>
