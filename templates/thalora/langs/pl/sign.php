...
$page_title = 'Otwórz konto | Zacznij handlować z ' . SITE_NAME;
$page_description = 'Szybko otwórz konto ' . SITE_NAME . ', by odblokować zaawansowane funkcje tradingu z AI.';
$page_canonical = page_url("sign.php");
$active_page = "sign";
$schema_extra = ['breadcrumb' => schema_breadcrumb('Zaloguj / Zarejestruj', 'sign.php')];
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      ...
      <span class="breadcrumb-item">Zaloguj / Zarejestruj</span>
    </nav>
  </div>
</div>
      <!-- registration-1 -->
...
<h1>Otwórz konto <?= e(SITE_NAME) ?> już dziś</h1>
