...
$page_title = $page_title ?? (SITE_NAME . ' | Wiodąca platforma tradingowa z AI');
$page_description = $page_description ?? ('Uzyskaj dostęp do kryptowalut, forex i globalnych aktywów z jednej platformy. ' . SITE_NAME . ' łączy analitykę na żywo, wspomaganą automatyzację i eksperckie wsparcie.');
...
<?php endif; ?>
  ...
  <script>
  window.APP_LANG = {
    valPhoneInvalid: 'Podaj prawidłowy numer telefonu',
    valPhoneCountry: 'Nieprawidłowy kod kraju',
    valPhoneShort: 'Numer jest za krótki',
    valPhoneLong: 'Numer jest za długi',
    valPhoneEmpty: 'Podaj numer telefonu',
    valSessionExpired: 'Sesja wygasła. Odśwież stronę i spróbuj ponownie.',
    valGenericError: 'Coś poszło nie tak. Spróbuj ponownie później.',
    valConnectionError: 'Błąd połączenia. Sprawdź internet i spróbuj ponownie.'
  };
