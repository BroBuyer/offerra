        ...
        <div style="background-color: #1a1a1e !important; border-bottom: 1px solid #27272a !important; padding: 14px 18px !important; display: flex !important; align-items: center !important; justify-content: space-between !important; flex-direction: row !important;">
            <div style="display: flex !important; align-items: center !important; gap: 12px !important; flex-direction: row !important;">
                ...
                <div style="text-align: left !important;">
                    ...
                    <p style="color: #a1a1aa !important; font-size: 11px !important; margin: 0 !important; padding: 0 !important; opacity: 0.85;">Przewodnik onboardingu</p>
                </div>
            </div>
            <button id="chat-close-btn" type="button" aria-label="Zamknij czat" style="color: #a1a1aa !important; background: transparent !important; border: none !important; cursor: pointer !important; padding: 6px !important; display: flex !important; align-items: center !important; transition: color 0.2s;">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const quizLang = {
        welcome: `Cześć! Jestem Olivia, Twoja przewodniczka onboardingu w <?= e(SITE_NAME) ?>. Twój dostęp jest wstępnie zatwierdzony. Zbudujmy Twój profil.`,
        q1: `Potwierdź, że mieszkasz <?= e(geo_country_in()) ?>, by w pełni spełnić wymogi prawne.`,
        a1_yes: `Yes, I live here now`,
        a1_no: `Nie`,
        q2: `Świetnie. Wybierz grupę wiekową, byśmy mogli polecić odpowiednie produkty:`,
        q3: `Czy masz teraz aktywne konto bankowe lub kartę kredytową do codziennych wypłat?`,
        a3_yes: `Tak, moje konto jest aktywne`,
        a3_no: `Teraz nie`,
        q4: `Jakie jest Twoje główne źródło dochodu? Pomaga nam to dopasować ustawienia ryzyka.`,
        a4_1: `Zatrudniony lub freelancer`,
        a4_2: `Oszczędności lub dochód pasywny`,
        a4_3: `Inne rodzaje dochodu`,
        q5: `Jeszcze chwila! Ktoś z zespołu zadzwoni między 11:00 a 20:00 w sprawie krótkiej weryfikacji. Czy odbierzesz?`,
        a5_yes: `Tak, ta pora mi pasuje`,
        a5_no: `Skontaktujcie się wkrótce`,
        loaderText: `Sprawdzamy odpowiedzi i tworzymy Twoje bezpieczne konto...`,
        finalTitle: `Weryfikacja zakończona! 🎉 Twoje bezpieczne konto jest gotowe. Postępuj według instrukcji poniżej, by włączyć codzienne płatności:`,
        processing: `Przetwarzamy Twoje zgłoszenie...`
    };
    ...
    function appendAgentMessage(text) {
        ...
        msg.innerHTML = `
            <div style="width: 28px; height: 28px; border-radius: 50%; border: 1px solid var(--color-primary); background-color: #27272a; display: flex; align-items: center; justify-content: center; overflow: hidden; flex-shrink: 0; margin-top: 2px;">
                <img alt="Obraz platformy tradingowej" src="<?= asset('static/img/consultant.webp') ?>" width="28" height="28" decoding="async" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';" style="width:100%; height:100%; object-fit:cover;" class="cq-consultant-img">
