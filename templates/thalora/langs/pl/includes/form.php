...
$form_submit = $form_submit ?? 'Utwórz konto';
...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__text">
      Twoje zgłoszenie w <?= e(SITE_NAME) ?> zostało przyjęte. Poczekaj na telefon od doradcy.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <div class="apx-lead-row lead-form-row">
      <label class="apx-lead-field field" data-field="fname">
        ...
        <input class="input" type="text" name="fname" placeholder="Imię" required pattern="[^\d]+" autocomplete="given-name" minlength="2" maxlength="50" inputmode="text" autocapitalize="words" spellcheck="false" title="Używaj tylko liter (bez cyfr i symboli)">
    ...
    <div class="apx-lead-row lead-form-row">
      <label class="apx-lead-field field" data-field="lname">
        ...
        <input class="input" type="text" name="lname" placeholder="Nazwisko" required pattern="[^\d]+" autocomplete="family-name" minlength="2" maxlength="50" inputmode="text" autocapitalize="words" spellcheck="false" title="Używaj tylko liter (bez cyfr i symboli)">
        <span class="field-error hide" role="alert" aria-live="polite"></span>
      </label>
    </div>
    <label class="apx-lead-field field" data-field="email">
      <span class="field-label">Adres e-mail</span>
      <input class="input" type="email" name="email" placeholder="Adres e-mail" required autocomplete="email" inputmode="email">
      <span class="field-error hide" role="alert" aria-live="polite"></span>
    </label>
    <label class="apx-lead-field apx-lead-field--phone lead-form-field lead-form-field--phone field" data-field="phone">
      <span class="field-label">Numer telefonu</span>
    ...
    <div class="apx-lead-badges" aria-hidden="true">
      ...
      <img src="<?= asset('static/img/svg/payment-4.svg') ?>" alt="Bezpieczna płatność">
    </div>
  </div>
</form>
</div>
