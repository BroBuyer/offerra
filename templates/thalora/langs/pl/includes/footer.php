    ...
    <div class="container-base">
      <div class="relative grid gap-7 md:gap-10">
        <div class="grid gap-5">
          <nav class="flex flex-col flex-wrap justify-between gap-x-10 gap-y-5 text-white md:flex-row">
            ...
            <ul class="flex flex-col gap-x-5 gap-y-4 md:flex-row md:gap-x-7 lg:gap-x-12">
              ...
              <li><a href="<?= page_url('product.php') ?>">Platforma tradingowa</a></li>
            ...
            <ul class="flex flex-col gap-x-5 gap-y-4 md:flex-row">
              <li><a href="<?= page_url('privacy.php') ?>">Informacja o prywatności</a></li>
              <li><a href="<?= page_url('conditions.php') ?>">Regulamin</a></li>
            </ul>
          </nav>
          <div class="flex justify-between gap-5">
            <div class="grid gap-5 text-white">
              <p style="color:var(--color-primary);">Twój niezawodny partner w tradingu</p>
        ...
        <div class="grid gap-2.5 text-sm text-gray-500">
            <p>
                <?= e(SITE_NAME) ?> nie ponosi odpowiedzialności za straty ani szkody wynikające z korzystania z informacji na tej stronie, w tym treści edukacyjnych, cen, wykresów czy analiz. Handel instrumentami finansowymi wiąże się z istotnym ryzykiem; oceń swoją sytuację. Skonsultuj się z doradcą przed handlem. Inwestuj tylko kapitał, którego utratę możesz zaakceptować: forex, CFD i kryptowaluty nie są odpowiednie dla wszystkich inwestorów.
            </p>
        </div>
