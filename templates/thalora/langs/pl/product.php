...
$page_title = 'Instrumenty tradingowe | Funkcje wzmocnione AI — ' . SITE_NAME;
$page_description = 'Korzystaj z wykresów na żywo, wniosków AI i narzędzi tradingowych ' . SITE_NAME . ', przy bezpieczeństwie, któremu można zaufać.';
$page_canonical = page_url("product.php");
$active_page = "product";
$schema_extra = ['breadcrumb' => schema_breadcrumb('Funkcje platformy', 'product.php')];
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      ...
      <span class="breadcrumb-item">Funkcje platformy</span>
    </nav>
  </div>
</div>
      <!-- analytics -->
  ...
  <div class="container-base grid gap-6 lg:grid-cols-2">
    ...
    >
      <h1 class="relative z-20">Trading i analityka wzmocnione AI</h1>
      <p class="relative z-20">
        Uzyskaj szerokie wnioski o rynku i portfelu z analityki <?= e(SITE_NAME) ?>. Wykresy w czasie rzeczywistym, zintegrowane wskaźniki i analiza AI do świadomych wyborów.      </p>
    </div>
    <div class="relative grid min-h-[355px] content-end">
      ...
      <div class="bg-before-custom relative z-30 grid grid-cols-2 gap-3 md:gap-6">
        <a class="btn btn-black col-span-full" href="<?= page_url('sign.php') ?>">Zarejestruj się</a>
        <a class="btn btn-black btn-square" href="<?= page_url('sign.php') ?>">
          <img src="<?= asset('static/img/svg/google-play.svg') ?>" alt="Pobierz z Google Play" />
        </a>
        <a class="btn btn-black btn-square" href="<?= page_url('sign.php') ?>">
          <img src="<?= asset('static/img/svg/app-store.svg') ?>" alt="Pobierz z App Store" />
        </a>
      </div>
    </div>
  </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-8 max-w-4xl">
    <p class="text-lg"><?= e(SITE_NAME) ?> oferuje zintegrowaną platformę: narzędzia tradingowe, szeroki monitoring rynku i wspomaganą automatyzację. Funkcje i codzienne korzyści znajdziesz poniżej.</p>    <p>Platforma daje dostęp do wielu rynków — kryptowaluty, forex, akcje i surowce — z cenami na żywo. Zarządzaj zleceniami i ryzykiem z jednego panelu, bez skakania między aplikacjami.</p>    <p>Narzędzia analityczne łączą dane w czasie rzeczywistym i wnioski AI, by wychwycić trendy i istotne ruchy. Wspierają decyzje; Ty kontrolujesz strategię, wolumen i limity. Interfejs stawia na prostotę i sprawną realizację.</p>    <p>Bezpieczeństwo i niezawodność to podstawa: szyfrowane połączenia, silna ochrona konta i jasne wpłaty. Pasuje do początkujących i ekspertów, skaluje się od użytku podstawowego po zaawansowany trading bez zmiany platformy.</p>    <div class="grid gap-6 md:grid-cols-2">
            <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-3">Rynki i instrumenty tradingowe</h2>
        <p>Śledź waluty cyfrowe, forex, akcje i surowce zintegrowanymi narzędziami, listami obserwacyjnymi i alertami. <?= e(SITE_NAME) ?> łączy analizę z zarządzaniem zleceniami i portfelem.</p>
      </div>
                  <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-3">Przejrzystość, bezpieczeństwo i kontrola</h2>
        <p>Bezpieczne połączenia, zweryfikowane procedury, przejrzyste wpłaty i wypłaty. Opłaty widać przed potwierdzeniem.</p>
      </div>
          </div>
  </div>
</div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>Platforma tradingowa w przeglądarce</h2>
      <div class="grid grid-cols-2 gap-x-8 gap-y-6">
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Rynki finansowe</p>
            <p>Natychmiastowy dostęp do wszystkich funkcji</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Wnioski rynkowe</p>
            <p>Szybki dostęp do pełnej historii danych</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Zoptymalizowana pod mobile</p>
            <p>Płynne doświadczenie mobilne, gdziekolwiek jesteś</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Zarządzanie kryptowalutami</p>
            <p>Łatwo zarządzaj całym portfelem</p>
          </div>
        </div>
      </div>
    </div>
    <div class="flex items-center justify-center">
        ...
        <img
          ...
          alt="<?= e(SITE_NAME) ?> — platforma tradingowa na mobile"
...
<div class="py-8 md:py-10">
  ...
  >
    ...
    >
      ...
      <p class="h3">Wolumen transakcji</p>
    </div>
    <div
      class="rounded-custom grid content-start gap-5 border p-4 md:p-6"
    >
      <p class="h2 lowercase">100+</p>
      <p class="h3">Obsługiwane państwa</p>
    </div>
  </div>
</div>
      <!-- capabilities -->
    ...
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Kluczowe funkcje inwestycyjne</p>
          <p>Doświadczenie pokazane w konkretnych projektach i kreatywnych podejściach.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Zakup krypto</p>
          <p>Bezpieczne, proste środowisko do kupna kryptowalut. Szybkie przetwarzanie, niskie opłaty. Zacznij handlować od razu.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Analityka rynku</p>
          <p>Zrozum ceny i trendy, by podejmować świadome decyzje inwestycyjne.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Handel aktywami cyfrowymi</p>
          <p>Handluj kontraktami futures na krypto. Odkrywaj, inwestuj i rozwijaj portfel.</p>
        </div>
      </div>
    </div>
  </div>
...
<p class="h2">Zacznij teraz</p>
<p>
  Odkryj trading krypto z <?= e(SITE_NAME) ?>. Traderzy z <?= e(geo_country_name()) ?> znajdują platformę łączącą zaawansowaną technologię, efektywność i wygodne narzędzia.</p>
          </div>
