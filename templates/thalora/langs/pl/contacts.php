...
$page_title = 'Wsparcie | Pomoc zespołu ' . SITE_NAME;
$page_description = 'Skontaktuj się z zespołem ' . SITE_NAME . ' w sprawach kont, wpłat, wypłat i pytań o platformę.';
...
<h1>Kontakt</h1>
  <p class="lead max-w-3xl justify-self-center text-center md:text-left">Zespół <?= e(SITE_NAME) ?> odpowiada na pytania o konta, wpłaty, wypłaty, wykresy i narzędzia AI. Pomoc idzie oficjalnymi kanałami — bez osobistych rekomendacji inwestycyjnych ani gwarancji zysku.</p>
<div class="grid gap-4 text-center md:gap-6 md:text-left max-w-3xl justify-self-center">
  <h3>Napisz do nas po dalszą pomoc</h3>  <p>Zanim napiszesz, miej pod ręką e-mail konta, temat (rejestracja, płatność, techniczne) i zrzuty ekranu, jeśli dotyczy. Im jaśniejsze szczegóły, tym szybsze rozwiązanie.</p>  <p>Zgłoszenia o aktywnych transakcjach lub oczekujących wypłatach mają priorytet, gdy to możliwe. Dla bezpieczeństwa nigdy nie poprosimy o pełne hasło ani kody 2FA w niezamówionych e-mailach.</p>  <p>Jeśli jeszcze się nie zarejestrowałeś, otwórz konto w kilka minut na stronie rejestracji i wróć tutaj. Zobacz też FAQ o opłatach, bezpieczeństwie i dostępnych rynkach.</p>  <p>Podaj jasny temat (np. «Wypłata w toku», «Problem 2FA», «Pytanie o opłaty»). Większość zgłoszeń dostaje pierwszą odpowiedź w kilka godzin; duży wolumen lub kontrole płatności mogą wydłużyć czas.</p></div>
