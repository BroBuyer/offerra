...
$page_title = SITE_NAME . ' | Wiodąca platforma tradingowa z AI';
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h1 id="heading-style-h1">Handluj przejrzyście. Zachowaj kontrolę nad każdą decyzją.</h1>
            <p>Uzyskaj dostęp do kryptowalut, forex i globalnych aktywów z jednej platformy. <?= e(SITE_NAME) ?> łączy analitykę na żywo, wspomaganą automatyzację i eksperckie wsparcie, by nawigować rynki jasnymi narzędziami i stałymi procesami.</p>
        </div>
...
<div class="py-8 md:py-10">
  <div class="stats-cards container-base grid gap-3 md:grid-cols-2 md:gap-6 xl:grid-cols-4">
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      ...
      <p class="h3">Obsługiwane waluty</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase">42m</p>
      <p class="h3">Zweryfikowani użytkownicy</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase"><?= e(currency_symbol()) ?>440m</p>
      <p class="h3">Obrót transakcyjny</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase">100+</p>
      <p class="h3">Obsługiwane kraje</p>
    </div>
  </div>
</div>
    <!-- features -->
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 max-lg:order-2 md:gap-10">
      <h2>Dlaczego wybrać <?= e(SITE_NAME) ?></h2>
      <p class="md:text-lg">
        Preferowana przez dzisiejszych traderów krypto, ta platforma wyznacza nowy standard. Łączymy solidne bezpieczeństwo, pełną przejrzystość, zaawansowane AI i intuicyjny interfejs dla pewnego handlu.      </p>
        ...
        <div class="grid grid-cols-2 gap-x-8 gap-y-6 max-sm:flex">
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Niezawodne bezpieczeństwo</p>
              <p>Solidne zabezpieczenia chronią Twoje dane osobowe i inwestycje w sposób ciągły.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Spersonalizowany trading</p>
              <p>Dostosuj metody tradingu do swoich celów i preferencji.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Inteligentne rozwiązania AI</p>
              <p>Precyzyjne wnioski tradingowe do świadomych decyzji.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Zautomatyzowane rozwiązania tradingowe</p>
              <p>Boty oparte na AI działają non-stop, by wspierać bardziej uporządkowane, sygnałowe podejście do handlu.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Intuicyjny interfejs</p>
              <p>Prosty interfejs, stworzony do czytelnego handlu od pierwszego użycia.</p>
            </div>
          </div>
        </div>
      </div>
      <p class="h3">
        Wzmocnij swoją drogę finansową z <?= e(SITE_NAME) ?>.
      </p>
      <a class="btn btn-black" href="<?= page_url('sign.php') ?>">Zarejestruj się teraz</a>
    </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>Trading bez wysiłku!</h2>
      <p class="text-lg">
        Handluj wiodącymi kryptowalutami, takimi jak Bitcoin, Ethereum i Dogecoin — łatwo i z pewnością.      </p>
      <a class="btn btn-black max-md:hidden" href="<?= page_url('sign.php') ?>">Zacznij teraz</a>
    </div>
    <div class="grid gap-3 md:gap-6" data-trading></div>
    <a class="btn btn-black md:hidden" href="<?= page_url('sign.php') ?>">Zacznij teraz</a>
  </div>
</div>
<section class="feature-section">
  <div class="container">
    <div class="feature-header">
      <h2>
        Globalna platforma tradingowa <span>zbudowana, by rosnąć</span>      </h2>
      <p>
        Uzyskaj dostęp do wielu rynków finansowych w jednym systemie stworzonym pod szybkość, precyzję i niezawodną wydajność globalną.      </p>
    </div>
    <div class="feature-grid">
      <div class="feature-card">
        ...
        <p>
          Handluj kryptowalutami, forex, akcjami i surowcami na jednej platformie, bez zmiany aplikacji.        </p>
      </div>
      <div class="feature-card featured">
        <div class="accent"></div>
        <h3>Szybka realizacja zleceń</h3>
        <p>
          Zoptymalizowana platforma do szybkiej i niezawodnej realizacji zleceń na rynkach globalnych.        </p>
      </div>
      <div class="feature-card">
        <div class="accent"></div>
        <h3>Analityka w czasie rzeczywistym</h3>
        <p>
          Dane rynkowe na żywo, zaawansowane wskaźniki i wnioski, by decydować szybko i świadomie.        </p>
      </div>
    </div>
  </div>
</section>
...
<div class="py-8 md:py-10" id="how-it-works">
  <div class="container-base grid gap-6 md:gap-10">
    <div class="grid items-center gap-6 lg:grid-cols-2">
      <h2>Jak działa <?= e(SITE_NAME) ?>: od rejestracji do tradingu</h2>
      <p class="rounded-custom sm:border sm:p-8">
        Prosty proces w sześciu krokach: rejestracja, weryfikacja, wpłata, konfiguracja strategii i użycie narzędzi rynkowych. Panel jasno pokazuje terminy, opcje i sterowanie.      </p>
    </div>
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Utwórz konto</p>
          <p>Zarejestruj się podstawowymi danymi, by bezpiecznie wejść na oficjalną platformę <?= e(SITE_NAME) ?>. Ten szybki krok otwiera główny panel.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Potwierdź tożsamość</p>
          <p>Potwierdź e-mail, by odblokować wszystkie funkcje: wykresy na żywo, narzędzia analityczne i materiały do uporządkowanego startu.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Wejdź na platformę tradingową</p>
          <p>Wpłać na konto co najmniej <?= e(money_min()) ?>. Możesz wybrać wyższą kwotę zgodnie z celami; wszystkie opcje płatności i opłaty widać przed potwierdzeniem.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Dodaj środki</p>
          <p>Wybierz przelew, e-portfel lub kartę. Czas i opłaty są przejrzyste, więc kontrolujesz wpłatę.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Określ strategię</p>
          <p>Dostosuj ryzyko, preferowane rynki i podejście do tradingu. <?= e(SITE_NAME) ?>: wsparcie AI dobiera sygnały i monitoring rynku, nie zastępując Twoich decyzji.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Przeglądaj dostępne rynki</p>
          <p>Gdy konto jest aktywne i skonfigurowane, śledź ceny na żywo, planuj transakcje i korzystaj ze zintegrowanej platformy do krypto i innych aktywów.</p>
        </div>
      </div>
    </div>
    <div class="grid gap-6 md:grid-cols-2">
      <a class="btn btn-black" href="<?= page_url('sign.php') ?>">Zacznij handlować</a>
    </div>
  </div>
</div>
    <!-- payments -->
    <div class="py-8 md:py-10">
      <div class="container-base grid items-center gap-6 lg:grid-cols-2">
        <p class="text-lg">
          <?= e(SITE_NAME) ?> obsługuje różne metody płatności dla klientów na całym świecie.        </p>
        ...
        <div class="grid items-end gap-6 md:grid-cols-2">
          ...
          <div class="inline-flex justify-end gap-8 max-md:hidden">
            <button class="text-primary hover:text-primary-dark -scale-x-100 cursor-pointer transition-colors"
              data-prev="reviews" aria-label="poprzedni slajd">
          ...
          <div class="-ml-6">
            <div class="basis-full pl-6 md:basis-1/2">
              <div
                ...
                <p>
                  A fantastic platformy tradingowej is <?= e(SITE_NAME) ?>! The
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10" style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
    <div class="flex items-center justify-between gap-6 mb-6 reviews-flex-block">
      <h2 class="text-2xl font-bold">Opinie użytkowników</h2>
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
            <p>
              <?= e(SITE_NAME) ?> przerosło moje oczekiwania. Rejestracja była prosta, opłaty jasne, a wsparcie szybkie. W sumie niezawodna, płynna platforma, z której chętnie korzystam.            </p>
            <div class="flex items-center gap-4">
              <div class="initials">FE</div>
              <p class="font-bold">Specjalista ds. walut</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Wybrałem <?= e(SITE_NAME) ?> do tradingu krypto i jestem zadowolony. Start był prosty i przejrzysty. Godny zaufania wybór, zwłaszcza na początek.                </p>
            <div class="flex items-center gap-4">
              <div class="initials">IM</div>
              <p class="font-bold">Analityk rynków inwestycyjnych</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Uważam <?= e(SITE_NAME) ?> jako niezawodną, spójną platformę. Otwarcie konta było łatwe, warunki przejrzyste, a wsparcie kompetentne. Handel tutaj jest wygodny.                </p>
            <div class="flex items-center gap-4">
        ...
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Handel kryptowalutami z <?= e(SITE_NAME) ?> jest przystępna. Rejestracja była łatwa, opłaty zrozumiałe, a pomoc dostępna, gdy potrzeba. Jako nowy trader odczuwam realną różnicę.                </p>
            <div class="flex items-center gap-4">
              <div class="initials">FA</div>
              <p class="font-bold">Analityk finansowy</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="grid gap-3 md:gap-6" data-accordion>
      <div id="accordion-1" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Jakie kroki są potrzebne, by zacząć handlować?</span>
        ...
        <div id="content-1" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>To proste. Zarejestruj się kluczowymi danymi, potwierdź e-mail i wpłać na konto minimum <?= e(money_min()) ?>. Odblokujesz wszystkie funkcje: wykresy na żywo, narzędzia tradingowe, analizę rynku i dedykowane wsparcie. Doświadczenie nie jest potrzebne — kompletne tutoriale prowadzą Cię krok po kroku.</p>
          </div>
        </div>
      </div>
      <div id="accordion-2" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Czy <?= e(SITE_NAME) ?> jest niezawodna w obsłudze moich pieniędzy i danych?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-2" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>W <?= e(SITE_NAME) ?> ochrona danych i środków to priorytet. Sesje są szyfrowane SSL, dostępne jest uwierzytelnianie dwuskładnikowe, a praktyki prywatności są jasno opisane. Transakcje finansowe idą przez zaufanych partnerów i protokoły wewnętrzne. Dążymy do niezawodności, ale zwrotów nie można gwarantować.</p>
          </div>
        </div>
      </div>
      <div id="accordion-3" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Jak szybko mogę wypłacić środki?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-3" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Wypłaty można zgłaszać w dowolnym momencie z portalu konta. Przetwarzanie zwykle trwa 1–3 dni robocze, w zależności od metody. Opłaty i szacowane terminy widać przed potwierdzeniem. Jeśli potrzebujesz śledzenia, zespół wsparcia jest dostępny.</p>
          </div>
        </div>
      </div>
      <div id="accordion-4" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Jak sprawdzić, czy platforma pasuje do moich potrzeb tradingowych?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-4" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Zalecamy start od minimalnej wpłaty, by poznać funkcje. <?= e(SITE_NAME) ?> pasuje zarówno do początkujących, jak i doświadczonych traderów: prosty interfejs, opcjonalne narzędzia AI i wsparcie 24/7. Zachowujesz pełną kontrolę nad zleceniami, limitami i ustawieniami ryzyka.</p>
          </div>
        </div>
      </div>
      <div id="accordion-5" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Czy potrzebne jest doświadczenie w tradingu, by zacząć?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-5" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Wcześniejsze doświadczenie nie jest potrzebne. Platforma jest prosta od startu: onboarding, tutoriale i narzędzia wzmocnione AI. Uczysz się we własnym tempie — od rynków bazowych po zaawansowaną analizę i automatyzację.</p>
          </div>
        </div>
      </div>
      <div id="accordion-7" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Jakie rynki mogę śledzić z <?= e(SITE_NAME) ?>?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-7" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>W jednym interfejsie śledzisz wiodące kryptowaluty, forex w czasie rzeczywistym, globalne akcje i surowce. Bez skakania między aplikacjami: skupiasz się na analizie i decyzjach.</p>
          </div>
        </div>
      </div>
      <div id="accordion-8" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Jak działa analityka AI?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-8" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p><?= e(SITE_NAME) ?> oferuje narzędzia AI, które organizują sygnały, oznaczają istotne ruchy ceny i pomagają w monitoringu. Wspierają Twoje wybory, bez zastępowania strategii ani gwarancji wyniku. Ty decydujesz, kiedy działać i ile alokować.</p>
          </div>
        </div>
      </div>
      <div id="accordion-9" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Ile zwykle mija od rejestracji do pierwszej transakcji?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-9" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Otwarcie konta i weryfikacja zwykle zajmują kilka minut. Czas do pierwszej transakcji zależy od wpłaty i metody płatności. Strona główna pokazuje jasny przewodnik krok po kroku, bez ukrytych etapów.</p>
          </div>
        </div>
      </div>
      <div id="accordion-10" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Czy jest wsparcie w sprawach konta?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-10" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Zespół jest dostępny w Kontakt lub FAQ w sprawach dostępu do konta, wpłat, wypłat lub funkcji. Pomoc jest operacyjna, nie stanowi porady inwestycyjnej.</p>
          </div>
        </div>
      </div>
      <div id="accordion-6" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">O platformie</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-6" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p style="margin-bottom:16px;"><?= e(SITE_NAME) ?> to międzynarodowa platforma tradingowa pod stałą wydajność, szybką realizację i pełną kontrolę środowiska handlu. Zamiast wielu usług zbiera kluczowe funkcje w jeden przepływ.</p>
            <p style="margin-bottom:16px;">Od dostępu do rynku po realizację i analizę każdy element działa bez tarcia. Skupiasz się na decyzjach, nie na zmianie narzędzia.</p>
            <p style="margin-bottom:10px; font-weight:500;">Handluj na wielu rynkach finansowych z jednej platformy:</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Wiodące i wschodzące kryptowaluty</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Rynki forex z cenami na żywo</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Globalne akcje i opcje na akcje</li>
              <li><span style="color:var(--color-primary);">•</span> Surowce do poszerzenia możliwości</li>
            </ul>
            <p style="margin-bottom:16px;">Wydajność jest priorytetem. System jest zoptymalizowany pod niską latencję i niezawodną pracę w godzinach szczytu, by reagować na ceny bez opóźnień technicznych.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Szybkie, niezawodne przetwarzanie zleceń na rynkach</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Ciągły strumień danych rynkowych</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Wstępnie zainstalowana analityka i wskaźniki rynkowe</li>
              <li><span style="color:var(--color-primary);">•</span> Trading ręczny i zautomatyzowany</li>
            </ul>
            <p style="margin-bottom:16px;">Bezpieczeństwo i niezawodność operacyjna to priorytet na wszystkich poziomach. Platforma trzyma branżowe standardy i chroni informacje oraz operacje finansowe w sposób ciągły.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> W pełni szyfrowana komunikacja danych</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Weryfikacja tożsamości i wielowarstwowe protokoły bezpieczeństwa</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Monitorowane i walidowane procesy transakcji</li>
              <li><span style="color:var(--color-primary);">•</span> Infrastruktura zaprojektowana pod niezawodną łączność globalną</li>
            </ul>
            <p style="margin-bottom:16px;">Doświadczenie użytkownika waży tyle samo. Projekt jest świadomie prosty i intuicyjny, by trader skupił się na strategii.</p>
            <p style="margin-bottom:16px;">Ta mieszanka solidnych funkcji i prostoty sprawia, że <?= e(SITE_NAME) ?> jest idealna dla początkujących i doświadczonych traderów. Kto zaczyna, szybko nabiera tempa bez stromej krzywej nauki; profile zaawansowane nadal mogą realizować złożone taktyki.</p>
            <p><?= e(SITE_NAME) ?> daje skalowalność, niezawodność i wysoką wydajność na jednej platformie, dla bezpiecznego, uporządkowanego dostępu do międzynarodowych rynków finansowych.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h2>Handluj na regulowanej platformie™</h2>
          <p>
            Zaufanie traderów indywidualnych i firm przy bezpiecznym kupnie, sprzedaży i zarządzaniu kryptowalutami.          </p>
        </div>
  ...
  <section style="padding:60px 0;" class="md:!py-[100px]">
    ...
    ">
      ...
      ">
        ...
        ">
          Kluczowe funkcje <span style='color:var(--color-primary);'><?= e(SITE_NAME) ?> platformy tradingowej</span>        </h2>
      <p style="margin-top:14px;color:#6b7280;font-size:17px;">
        Funkcje, które zwiększają szybkość, precyzję i pewność handlu.      </p>
    </div>
    <div style="
      border-radius:16px;
      overflow:hidden;
    ...
    ">
      ...
      " onmouseover="this.style.background='#f9f9fb'" class="row-block" onmouseout="this.style.background='transparent'">
        ...
        <div class="row-text" style="color:#6b7280;">
          Zaawansowana technologia tradingowa oparta na AI        </div>
      </div>
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          ...
          Metody wpłaty        </div>
        <div class="row-text" style="color:#6b7280;">
          Karty, przelewy, opcje PayPal        </div>
      </div>
      <div class="row-block" style="
        display:grid;
        grid-template-columns: 1fr 2fr;
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          <span style="color:var(--color-primary);">📱</span>
          Dostępność platformy        </div>
        <div class="row-text" style="color:#6b7280;">
          Działa na wielu urządzeniach        </div>
      </div>
      <div class="row-block" style="
        display:grid;
        grid-template-columns: 1fr 2fr;
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          <span style="color:var(--color-primary);">📊</span>
          Dostępne instrumenty        </div>
        <div class="row-text" style="color:#6b7280;">
          Forex, akcje, kryptowaluty, surowce i więcej        </div>
      </div>
      <div class="row-block" style="
        display:grid;
        grid-template-columns: 1fr 2fr;
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          ...
          Przewodnik otwarcia konta        </div>
        <div class="row-text" style="color:#6b7280;">
          Szybki, płynny onboarding        </div>
      </div>
      <div class="row-block" style="
        display:grid;
      ...
      ">
        <div class="customer-block" style="display:flex;gap:10px;font-weight:600;">
          <span style="color:var(--color-primary);">📞</span>
          Wsparcie klienta          <span style="font-weight:400;color:#6b7280;margin-left:10px;">
            Profesjonalne wsparcie 24/7          </span>
        </div>
...
<div class="md:border-primary-light md:rounded-[20px] md:border md:px-20 md:py-8">
  <div class="border-primary-light grid justify-items-center gap-6 rounded-[20px] border px-4 py-5 md:gap-4 md:px-8 md:py-6 text-center md:text-left">
    <h2 class="h3 flex flex-wrap items-center justify-center md:justify-start gap-x-4 gap-y-3">
      Co mówią użytkownicy <?= e(SITE_NAME) ?>      <span class="inline-flex items-center justify-center rounded-full bg-emerald-600 px-2 py-1 text-sm leading-none text-white uppercase">
        Zaufana      </span>
    </h2>
    <div class="flex flex-wrap items-center justify-center md:justify-start gap-2.5 text-center md:text-left">
      ...
      <span class="leading-none text-amber-500" role="img"
        aria-label="4.7 Ocena (na 5)">
        ★★★★★      </span>
      <span class="flex flex-wrap justify-center md:justify-start gap-1 text-sm text-gray-400">
        <span>
          <strong>124</strong> opinii klientów ·
        </span>
        <span>
          Na podstawie <strong>337</strong> ocen ·
        </span>
        <span>
          Ocena (na 5)        </span>
      </span>
    ...
    <p class="text-center md:text-left">
      Intuicyjna platforma z zaawansowanymi narzędziami automatyzacji i bogatymi materiałami edukacyjnymi.    </p>
  </div>
</div>
      </div>
    </section>
