...
$page_title = 'Handelsinstrumenter | AI-forstærkede funktioner — ' . SITE_NAME;
$page_description = 'Brug livediagrammer, AI-indsigter og handelsværktøjerne fra ' . SITE_NAME . ', med pålidelig sikkerhed.';
$page_canonical = page_url("product.php");
$active_page = "product";
$schema_extra = ['breadcrumb' => schema_breadcrumb('Platformfunktioner', 'product.php')];
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      <a href="<?= page_url() ?>" class="breadcrumb-item">Startside</a>
      <span class="breadcrumb-item">Platformfunktioner</span>
    </nav>
  </div>
</div>
      <!-- analytics -->
  ...
  <div class="container-base grid gap-6 lg:grid-cols-2">
    ...
    >
      <h1 class="relative z-20">AI-forstærket handel og analyse</h1>
      <p class="relative z-20">
        Få omfattende markeds- og porteføljeindsigt med analysen fra <?= e(SITE_NAME) ?>. Realtidsdiagrammer, integrerede indikatorer og AI-analyse til informerede valg.      </p>
    </div>
    <div class="relative grid min-h-[355px] content-end">
      ...
      <div class="bg-before-custom relative z-30 grid grid-cols-2 gap-3 md:gap-6">
        <a class="btn btn-black col-span-full" href="<?= page_url('sign.php') ?>">Tilmeld dig</a>
        <a class="btn btn-black btn-square" href="<?= page_url('sign.php') ?>">
          <img src="<?= asset('static/img/svg/google-play.svg') ?>" alt="Hent på Google Play" />
        </a>
        <a class="btn btn-black btn-square" href="<?= page_url('sign.php') ?>">
          <img src="<?= asset('static/img/svg/app-store.svg') ?>" alt="Hent i App Store" />
        </a>
      </div>
    </div>
  </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-8 max-w-4xl">
    <p class="text-lg"><?= e(SITE_NAME) ?> tilbyder en integreret platform: handelsværktøjer, bred markedsovervågning og assisteret automatisering. Se funktioner og daglige fordele nedenfor.</p>    <p>Platformen giver adgang til flere markeder — kryptovaluta, forex, aktier og råvarer — med livepriser. Styr ordrer og risiko fra ét dashboard, uden at hoppe mellem apps.</p>    <p>Analyseværktøjerne slår realtidsdata og AI-indsigter sammen for at fange tendenser og væsentlige bevægelser. De understøtter beslutningerne; du styrer strategi, volumen og grænser. Grænsefladen sigter mod enkelhed og effektiv udførelse.</p>    <p>Sikkerhed og pålidelighed er grundlaget: krypterede forbindelser, stærkt kontovern og tydelige indbetalinger. Passer til begyndere og eksperter og skalerer fra grundlæggende brug til avanceret handel uden at skifte platform.</p>    <div class="grid gap-6 md:grid-cols-2">
            <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-3">Markeder og handelsinstrumenter</h2>
        <p>Følg digitale valutaer, forex, aktier og råvarer med integrerede værktøjer, overvågningslister og varsler. <?= e(SITE_NAME) ?> knytter analysen til ordre- og porteføljeforvaltning.</p>
      </div>
                  <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-3">Åbenhed, sikkerhed og kontrol</h2>
        <p>Sikre forbindelser, verificerede procedurer, åbne indbetalinger og udbetalinger. Gebyrerne vises før bekræftelse.</p>
      </div>
          </div>
  </div>
</div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>Browserbaseret handelsplatform</h2>
      <div class="grid grid-cols-2 gap-x-8 gap-y-6">
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          ...
          <div class="grid gap-2 md:gap-3">
            ...
            <p>Øjeblikkelig adgang til alle funktioner</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Markedsindsigt</p>
            <p>Hurtig adgang til komplette datahistorikker</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Optimeret til mobil</p>
            <p>En smidig mobiloplevelse, uanset hvor du er</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
    ...
    <div class="flex items-center justify-center">
        ...
        <img
          ...
          alt="<?= e(SITE_NAME) ?> — handelsplatform på mobil"
...
<div class="py-8 md:py-10">
  ...
  >
    ...
    >
      ...
      <p class="h3">Understøttede lande</p>
    </div>
  </div>
</div>
      <!-- capabilities -->
    ...
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Vigtige investeringsfunktioner</p>
          <p>Kompetence vist gennem konkrete projekter og kreative tilgange.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Kryptokøb</p>
          <p>Et trygt og enkelt miljø til at købe kryptovaluta. Hurtig behandling, lave gebyrer. Begynd at handle med det samme.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          ...
          <p>Forstå priser og tendenser til informerede investeringsbeslutninger.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Handel med digitale aktiver</p>
          <p>Handl krypto-futures. Udforsk, invester og udvikl porteføljen.</p>
        </div>
      </div>
    </div>
  </div>
...
<p>
  Udforsk kryptotrading med <?= e(SITE_NAME) ?>. Tradere i <?= e(geo_country_name()) ?> møder en platform, der forener avanceret teknologi, effektivitet og brugervenlige værktøjer.</p>
          </div>
