...
$page_title = 'Åbn kontoen | Begynd at handle med ' . SITE_NAME;
$page_description = 'Åbn hurtigt din ' . SITE_NAME . '-konto for at låse avancerede AI-handelsfunktioner op.';
$page_canonical = page_url("sign.php");
$active_page = "sign";
$schema_extra = ['breadcrumb' => schema_breadcrumb('Log ind / Tilmeld dig', 'sign.php')];
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      ...
      <span class="breadcrumb-item">Log ind / Tilmeld dig</span>
    </nav>
  </div>
</div>
      <!-- registration-1 -->
...
<h1>Åbn din <?= e(SITE_NAME) ?>-konto i dag</h1>
