    ...
    <div class="container-base">
      <div class="relative grid gap-7 md:gap-10">
        <div class="grid gap-5">
          <nav class="flex flex-col flex-wrap justify-between gap-x-10 gap-y-5 text-white md:flex-row">
            ...
            <ul class="flex flex-col gap-x-5 gap-y-4 md:flex-row">
              <li><a href="<?= page_url('privacy.php') ?>">Privatlivsmeddelelse</a></li>
              <li><a href="<?= page_url('conditions.php') ?>">Vilkår og betingelser</a></li>
            </ul>
          </nav>
          <div class="flex justify-between gap-5">
            <div class="grid gap-5 text-white">
              <p style="color:var(--color-primary);">Din pålidelige handelspartner</p>
        ...
        <div class="grid gap-2.5 text-sm text-gray-500">
            <p>
                <?= e(SITE_NAME) ?> tager ikke ansvar for tab eller skade som følge af brug af oplysninger på dette site, herunder undervisningsindhold, priser, diagrammer eller analyse. Handel med finansielle instrumenter indebærer betydelig risiko; vurder din situation. Rådfør dig med en fagperson, før du handler. Brug kun kapital, du tåler at tabe: forex, CFD’er og kryptovaluta passer ikke til alle investorer.
            </p>
        </div>
        <div class="text-center text-white">
          © <?= date('Y') ?> <?= e(SITE_NAME) ?>. Alle rettigheder forbeholdes.
        </div>
      </div>
    </div>
  </footer>
