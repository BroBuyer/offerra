...
$page_title = $page_title ?? (SITE_NAME . ' | Førende AI-drevet handelsplatform');
$page_description = $page_description ?? ('Få adgang til kryptovaluta, forex og globale aktiver fra én platform. ' . SITE_NAME . ' kombinerer live-analyse, assisteret automatisering og ekspertsupport.');
...
<?php endif; ?>
  ...
  window.APP_LANG = {
    ...
    valPhoneEmpty: 'Indtast dit telefonnummer',
    valSessionExpired: 'Sessionen er udløbet. Indlæs siden igen, og prøv igen.',
    valGenericError: 'Noget gik galt. Prøv igen senere.',
    valConnectionError: 'Forbindelsesfejl. Tjek internetforbindelsen, og prøv igen.'
  };
