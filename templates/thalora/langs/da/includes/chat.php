        ...
        <div style="background-color: #1a1a1e !important; border-bottom: 1px solid #27272a !important; padding: 14px 18px !important; display: flex !important; align-items: center !important; justify-content: space-between !important; flex-direction: row !important;">
            <div style="display: flex !important; align-items: center !important; gap: 12px !important; flex-direction: row !important;">
                ...
                <div style="text-align: left !important;">
                    ...
                    <p style="color: #a1a1aa !important; font-size: 11px !important; margin: 0 !important; padding: 0 !important; opacity: 0.85;">Onboardingvejleder</p>
                </div>
            </div>
            <button id="chat-close-btn" type="button" aria-label="Luk chatten" style="color: #a1a1aa !important; background: transparent !important; border: none !important; cursor: pointer !important; padding: 6px !important; display: flex !important; align-items: center !important; transition: color 0.2s;">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const quizLang = {
        welcome: `Hej! Jeg er Olivia, din onboardingvejleder hos <?= e(SITE_NAME) ?>. Din adgang er forhåndsgodkendt. Lad os bygge din profil.`,
        q1: `Bekræft, at du er bosiddende <?= e(geo_country_in()) ?> for at opfylde de juridiske krav.`,
        a1_yes: `Yes, I live here now`,
        a1_no: `Nej`,
        q2: `Godt. Vælg aldersgruppe, så vi kan anbefale egnede produkter:`,
        q3: `Har du nu en aktiv bankkonto eller et kreditkort til at modtage daglige udbetalinger?`,
        a3_yes: `Ja, min konto er aktiv`,
        a3_no: `Ikke lige nu`,
        q4: `Hvad er din vigtigste indtægtskilde? Det hjælper os med at tilpasse risikoindstillingerne.`,
        a4_1: `Ansat eller freelancer`,
        a4_2: `Opsparing eller passiv indkomst`,
        a4_3: `Andre indkomsttyper`,
        q5: `Bare lidt mere! Nogen fra teamet ringer mellem 11:00 og 20:00 til en kort verifikation. Kan du tage opkaldet?`,
        a5_yes: `Ja, det tidspunkt passer`,
        a5_no: `Kontakt mig snart`,
        loaderText: `Tjekker dine svar og opretter den sikre konto...`,
        finalTitle: `Verifikation fuldført! 🎉 Din sikre konto er klar. Følg instruktionerne nedenfor for at aktivere daglige udbetalinger:`,
    ...
    function appendAgentMessage(text) {
        ...
        msg.innerHTML = `
            <div style="width: 28px; height: 28px; border-radius: 50%; border: 1px solid var(--color-primary); background-color: #27272a; display: flex; align-items: center; justify-content: center; overflow: hidden; flex-shrink: 0; margin-top: 2px;">
                <img alt="Billede af handelsplatformen" src="<?= asset('static/img/consultant.webp') ?>" width="28" height="28" decoding="async" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';" style="width:100%; height:100%; object-fit:cover;" class="cq-consultant-img">
