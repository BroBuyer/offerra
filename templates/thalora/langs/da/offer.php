...
$page_title = 'Handelsløsninger | AI-drevne tjenester — ' . SITE_NAME;
...
$active_page = "offer";
$schema_extra = ['breadcrumb' => schema_breadcrumb('Kampagner', 'offer.php')];
...
<span class="breadcrumb-item">Tilbudsdetaljer</span>
          </nav>
        </div>
      </div>
      <!-- tracker -->
      <div class="py-8 md:py-10">
        <div class="container-base grid gap-6 lg:grid-cols-2">
          ...
          >
 <h1 class="relative z-20">Start din rejse med <?= e(SITE_NAME) ?>: markedsovervågning, analyse og støtte</h1>
<p class="relative z-20">
  Tilmeld dig, bekræft identiteten og indbetal midler i få trin. Porteføljeovervågning, AI-støtte og en guidet vej fra første login til dashboardet.</p>
          </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-8">
    <p class="text-lg max-w-4xl">Vi tilbyder guidet onboarding, fuld adgang til markedsværktøjer og løbende hjælp. En enkel og åben vej fra registrering til daglig handel, uden genveje.</p>    <p class="max-w-4xl">En minimumsindbetaling låser alle funktioner op. Udforsk AI-strategier, styr risiko og følg porteføljen.</p>    <p class="max-w-4xl">Tjek altid gebyrer, udbetalingstider og verifikationstrin, som vises på platformen. Du beholder operativ kontrol: grænser, sizing og manuelle valg er tilgængelige også med automatiske varsler.</p>    <p class="max-w-4xl">Support forklarer, hvordan <?= e(SITE_NAME) ?> fungerer og transaktionsstatus; den giver ikke personlige råd. Markeder indebærer risiko: vurder eksponeringen og handl kun med penge, du tåler at tabe.</p>    <div class="grid gap-4 md:grid-cols-3">
            <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-2">Enkel onboarding</h2>
        <p>Enkel kontooprettelse, identitetsbekræftelse og åben dashboardadgang.</p>
      </div>
            <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-2">AI og markeder</h2>
        <p>Indbygget analyse, automatiske signaler og adgang til flere markeder på én platform.</p>
      </div>
            <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-2">Tydelig kundesupport</h2>
        <p>Tydelige gebyrer og udbetalingspolitikker; dedikeret hjælp til konti og transaktioner.</p>
      </div>
          </div>
  </div>
</div>
...
<div class="relative z-40 py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10">
    ...
    <div class="border-primary h3 rounded-custom relative z-10 flex items-center justify-center border bg-white p-4 text-center md:p-6">
      Opret din profil    </div>
    <div class="border-primary h3 rounded-custom relative z-10 flex items-center justify-center border bg-white p-4 text-center md:p-6">
      Indbetal på kontoen    </div>
    <div class="border-primary h3 rounded-custom relative z-10 flex items-center justify-center border bg-white p-4 text-center md:p-6">
      Handl med selvtillid    </div>
        </div>
      </div>
    </div>
      <!-- registration-1 -->
...
<h2>Den officielle <?= e(SITE_NAME) ?>-platform til metodisk handel</h2>
<p>
  <?= e(SITE_NAME) ?> er lavet til privatpersoner og teams, der forvalter digitale valutaer og aktiver, med tydelige værktøjer, SSL-kryptering og hurtig hjælp. Én platform til analyse, handel og porteføljeforvaltning.</p>
          </div>
