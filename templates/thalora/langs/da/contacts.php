...
$page_title = 'Support | Hjælp fra teamet ' . SITE_NAME;
$page_description = 'Kontakt teamet ' . SITE_NAME . ' for konti, indbetalinger, udbetalinger og platformspørgsmål.';
$page_canonical = page_url("contacts.php");
$active_page = "contacts";
$schema_extra = ['breadcrumb' => schema_breadcrumb('Kontakt os', 'contacts.php')];
      ...
      <div class="pt-5">
        <div class="container-base">
          ...
          >
            ...
            <span class="breadcrumb-item">Kontakt os</span>
          </nav>
        </div>
      </div>
      <!-- contact -->
...
<h1>Kontakt os</h1>
  <p class="lead max-w-3xl justify-self-center text-center md:text-left">Teamet hos <?= e(SITE_NAME) ?> svarer på spørgsmål om konti, indbetalinger, udbetalinger, diagrammer og AI-værktøjer. Hjælpen går via officielle kanaler — uden personlige investeringsanbefalinger eller gevinstgaranti.</p>
<div class="grid gap-4 text-center md:gap-6 md:text-left max-w-3xl justify-self-center">
  <h3>Send os en e-mail for mere hjælp</h3>  <p>Før du skriver, så hav konto-e-mail, emne (registrering, betaling, teknisk) og eventuelle skærmbilleder klar. Jo tydeligere detaljer, desto hurtigere løsning.</p>  <p>Forespørgsler om aktive handler eller ventende udbetalinger prioriteres, når det er muligt. Af sikkerhedshensyn beder vi aldrig om fuld adgangskode eller 2FA-koder i uopfordrede e-mails.</p>  <p>Har du ikke tilmeldt dig endnu, åbner du en konto på minutter fra tilmeldingssiden og kommer tilbage hertil. Se også FAQ for gebyrer, sikkerhed og tilgængelige markeder.</p>  <p>Angiv et tydeligt emne (f.eks. «Udbetaling venter», «2FA-problem», «Gebyrspørgsmål»). De fleste henvendelser får et første svar inden for et par timer; højt volumen eller betalingskontroller kan forlænge tiden.</p></div>
