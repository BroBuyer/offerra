    ...
    <div class="container-base">
      <div class="relative grid gap-7 md:gap-10">
        <div class="grid gap-5">
          <nav class="flex flex-col flex-wrap justify-between gap-x-10 gap-y-5 text-white md:flex-row">
            ...
            <ul class="flex flex-col gap-x-5 gap-y-4 md:flex-row md:gap-x-7 lg:gap-x-12">
              ...
              <li><a href="<?= page_url('product.php') ?>">Kaupankäyntialusta</a></li>
              ...
              <li><a href="<?= page_url('about.php') ?>">Tietoa meistä</a></li>
            </ul>
            <ul class="flex flex-col gap-x-5 gap-y-4 md:flex-row">
              <li><a href="<?= page_url('privacy.php') ?>">Tietosuojailmoitus</a></li>
              <li><a href="<?= page_url('conditions.php') ?>">Ehdot</a></li>
            </ul>
          </nav>
          <div class="flex justify-between gap-5">
            <div class="grid gap-5 text-white">
              <p style="color:var(--color-primary);">Luotettava kumppanisi kaupankäynnissä</p>
        ...
        <div class="grid gap-2.5 text-sm text-gray-500">
            <p>
                <?= e(SITE_NAME) ?> ei vastaa tämän sivuston tietojen käytöstä aiheutuvista tappioista tai vahingoista, mukaan lukien oppimateriaali, hinnat, kaaviot tai analyysit. Rahoitusvälineillä kaupankäyntiin liittyy merkittävä riski; arvioi tilanteesi. Kysy neuvoa ammattilaiselta ennen kaupankäyntiä. Sijoita vain pääomaa, jonka menetyksen voit sietää: forex, CFD:t ja kryptovaluutat eivät sovi kaikille sijoittajille.
            </p>
        </div>
