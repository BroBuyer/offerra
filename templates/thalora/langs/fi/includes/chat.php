        ...
        <div style="background-color: #1a1a1e !important; border-bottom: 1px solid #27272a !important; padding: 14px 18px !important; display: flex !important; align-items: center !important; justify-content: space-between !important; flex-direction: row !important;">
            <div style="display: flex !important; align-items: center !important; gap: 12px !important; flex-direction: row !important;">
                ...
                <div style="text-align: left !important;">
                    ...
                    <p style="color: #a1a1aa !important; font-size: 11px !important; margin: 0 !important; padding: 0 !important; opacity: 0.85;">Käyttöönotto-opas</p>
                </div>
            </div>
            <button id="chat-close-btn" type="button" aria-label="Sulje chat" style="color: #a1a1aa !important; background: transparent !important; border: none !important; cursor: pointer !important; padding: 6px !important; display: flex !important; align-items: center !important; transition: color 0.2s;">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const quizLang = {
        welcome: `Hei! Olen Olivia, käyttöönotto-oppaasi palvelussa <?= e(SITE_NAME) ?>. Pääsysi on ennakkohyväksytty. Rakennetaan profiilisi.`,
        q1: `Vahvista, että asut <?= e(geo_country_in()) ?>, jotta täytät kaikki lakisääteiset vaatimukset.`,
        a1_yes: `Yes, I live here now`,
        a1_no: `Ei`,
        q2: `Hienoa. Valitse ikäryhmäsi, jotta voimme suositella sopivia tuotteita:`,
        q3: `Onko sinulla tällä hetkellä aktiivinen pankki- tai luottokorttitili päivittäisiä osinkoja varten?`,
        a3_yes: `Kyllä, tilini on aktiivinen`,
        a3_no: `Ei tällä hetkellä`,
        q4: `Mikä on ensisijainen tulonlähteesi? Sen avulla räätälöimme riskiasetukset.`,
        a4_1: `Palkkatyö tai freelancer`,
        a4_2: `Säästöt tai passiiviset tulot`,
        a4_3: `Muut tulolähteet`,
        q5: `Vielä hetki! Joku tiimistämme soittaa sinulle klo 11.00–20.00 lyhyttä vahvistusta varten. Voitko vastata puheluun?`,
        a5_yes: `Kyllä, se aika sopii`,
        a5_no: `Ota yhteyttä pian`,
        loaderText: `Tarkistamme vastauksesi ja luomme turvallisen tilisi...`,
        finalTitle: `Vahvistus valmis! 🎉 Turvallinen tilisi on valmis. Seuraa alla olevia ohjeita ottaaksesi päivittäiset maksut käyttöön:`,
        processing: `Käsittelemme pyyntöäsi...`
    };
    ...
    function appendAgentMessage(text) {
        ...
        msg.innerHTML = `
            <div style="width: 28px; height: 28px; border-radius: 50%; border: 1px solid var(--color-primary); background-color: #27272a; display: flex; align-items: center; justify-content: center; overflow: hidden; flex-shrink: 0; margin-top: 2px;">
                <img alt="Kaupankäyntialustan kuva" src="<?= asset('static/img/consultant.webp') ?>" width="28" height="28" decoding="async" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';" style="width:100%; height:100%; object-fit:cover;" class="cq-consultant-img">
