...
$page_title = $page_title ?? (SITE_NAME . ' | Johtava tekoälypohjainen kaupankäyntialusta');
$page_description = $page_description ?? ('Käytä kryptovaluuttoja, forexia ja globaaleja omaisuuseriä yhdestä alustasta. ' . SITE_NAME . ' yhdistää live-analytiikan, avustetun automaation ja asiantuntijatuen.');
...
<?php endif; ?>
  ...
  window.APP_LANG = {
    ...
    valPhoneShort: 'Numero on liian lyhyt',
    valPhoneLong: 'Numero on liian pitkä',
    valPhoneEmpty: 'Syötä puhelinnumero',
    ...
    valConnectionError: 'Yhteysvirhe. Tarkista internetyhteys ja yritä uudelleen.'
  };
