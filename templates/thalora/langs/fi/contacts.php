...
$page_title = 'Tuki | Apua tiimiltä ' . SITE_NAME;
$page_description = 'Ota yhteyttä tiimiin ' . SITE_NAME . ' tileihin, talletuksiin, nostoihin ja alustakysymyksiin.';
$page_canonical = page_url("contacts.php");
$active_page = "contacts";
$schema_extra = ['breadcrumb' => schema_breadcrumb('Yhteystiedot', 'contacts.php')];
      ...
      <div class="pt-5">
        <div class="container-base">
          ...
          >
            ...
            <span class="breadcrumb-item">Yhteystiedot</span>
          </nav>
        </div>
      </div>
      <!-- contact -->
...
<h1>Yhteystiedot</h1>
  <p class="lead max-w-3xl justify-self-center text-center md:text-left"><?= e(SITE_NAME) ?>-tiimi vastaa kysymyksiin tileistä, talletuksista, nostoista, kaavioista ja tekoälytyökaluista. Apu kulkee virallisia kanavia — ilman henkilökohtaisia sijoitussuosituksia tai tuottotakuita.</p>
<div class="grid gap-4 text-center md:gap-6 md:text-left max-w-3xl justify-self-center">
  <h3>Lähetä sähköpostia lisäapua varten</h3>  <p>Ennen yhteydenottoa pidä valmiina tilin sähköposti, aihe (rekisteröinti, maksu, tekninen) ja kuvakaappaukset tarvittaessa. Mitä selkeämmät tiedot, sitä nopeampi ratkaisu.</p>  <p>Pyynnöt aktiivisista kaupoista tai odottavista nostoista priorisoidaan mahdollisuuksien mukaan. Turvallisuutesi vuoksi emme koskaan pyydä koko salasanaa tai 2FA-koodeja pyytämättömissä sähköposteissa.</p>  <p>Jos et ole vielä rekisteröitynyt, avaa tili muutamassa minuutissa rekisteröintisivulla ja palaa tänne. Katso myös UKK kuluista, tietoturvasta ja saatavilla olevista markkinoista.</p>  <p>Lisää selkeä aihe (esim. «Nosto odottaa», «2FA-ongelma», «Kysymys kulusta»). Useimmat kyselyt saavat ensimmäisen vastauksen muutamassa tunnissa; suuri volyymi tai maksutarkistukset voivat pidentää aikaa.</p></div>
