...
$page_title = 'Avaa tilisi | Aloita kaupankäynti palvelussa ' . SITE_NAME;
$page_description = 'Avaa nopeasti tilisi ' . SITE_NAME . ' avataksesi kehittyneet tekoälykaupankäynnin ominaisuudet.';
$page_canonical = page_url("sign.php");
$active_page = "sign";
$schema_extra = ['breadcrumb' => schema_breadcrumb('Kirjaudu / Rekisteröidy', 'sign.php')];
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      ...
      <span class="breadcrumb-item">Kirjaudu / Rekisteröidy</span>
    </nav>
  </div>
</div>
      <!-- registration-1 -->
...
<h1>Avaa tilisi <?= e(SITE_NAME) ?> jo tänään</h1>
