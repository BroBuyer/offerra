...
$page_title = 'Kaupankäynti-instrumentit | Tekoälyllä tehostetut ominaisuudet — ' . SITE_NAME;
$page_description = 'Käytä livekaavioita, tekoälynäkemyksiä ja kaupankäyntityökaluja palvelussa ' . SITE_NAME . ' luotettavalla tietoturvalla.';
$page_canonical = page_url("product.php");
$active_page = "product";
$schema_extra = ['breadcrumb' => schema_breadcrumb('Alustan ominaisuudet', 'product.php')];
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      ...
      <span class="breadcrumb-item">Alustan ominaisuudet</span>
    </nav>
  </div>
</div>
      <!-- analytics -->
  ...
  <div class="container-base grid gap-6 lg:grid-cols-2">
    ...
    >
      <h1 class="relative z-20">Tekoälyllä tehostettu kaupankäynti ja analytiikka</h1>
      <p class="relative z-20">
        Saa laajat markkina- ja salkkunäkemykset analytiikasta <?= e(SITE_NAME) ?>. Reaaliaikaiset kaaviot, integroidut indikaattorit ja tekoälyanalyysi perusteltuihin valintoihin.      </p>
    </div>
    <div class="relative grid min-h-[355px] content-end">
      ...
      <div class="bg-before-custom relative z-30 grid grid-cols-2 gap-3 md:gap-6">
        <a class="btn btn-black col-span-full" href="<?= page_url('sign.php') ?>">Rekisteröidy</a>
        <a class="btn btn-black btn-square" href="<?= page_url('sign.php') ?>">
          <img src="<?= asset('static/img/svg/google-play.svg') ?>" alt="Lataa Google Playstä" />
        </a>
        <a class="btn btn-black btn-square" href="<?= page_url('sign.php') ?>">
          <img src="<?= asset('static/img/svg/app-store.svg') ?>" alt="Lataa App Storesta" />
        </a>
      </div>
    </div>
  </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-8 max-w-4xl">
    <p class="text-lg"><?= e(SITE_NAME) ?> tarjoaa integroidun alustan: kaupankäyntityökalut, laajan markkinaseurannan ja avustetun automaation. Ominaisuudet ja päivittäiset hyödyt alla.</p>    <p>Alusta avaa useita markkinoita — kryptovaluutat, forex, osakkeet ja raaka-aineet — livehinnoilla. Hallitse toimeksiantoja ja riskiä yhdeltä näytöltä ilman sovellusten vaihtoa.</p>    <p>Analytiikkatyökalut yhdistävät reaaliaikaisen datan ja tekoälynäkemykset trendien ja merkittävien liikkeiden tunnistamiseen. Ne tukevat päätöksiä; sinä hallitset strategian, volyymin ja rajat. Käyttöliittymä painottaa yksinkertaisuutta ja tehokasta toteutusta.</p>    <p>Tietoturva ja luotettavuus ovat perusta: salatut yhteydet, vahva tilisuoja ja selkeät talletukset. Sopii aloittelijoille ja asiantuntijoille, skaalautuu peruskäytöstä edistyneeseen kaupankäyntiin ilman alustan vaihtoa.</p>    <div class="grid gap-6 md:grid-cols-2">
            <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-3">Markkinat ja kaupankäynti-instrumentit</h2>
        <p>Seuraa digitaalisia valuuttoja, forexia, osakkeita ja raaka-aineita integroiduilla työkaluilla, seurantalistoilla ja hälytyksillä. <?= e(SITE_NAME) ?> yhdistää analyysin toimeksiantojen ja salkun hallintaan.</p>
      </div>
                  <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-3">Läpinäkyvyys, tietoturva ja kontrolli</h2>
        <p>Turvalliset yhteydet, varmennetut menettelyt, läpinäkyvät talletukset ja nostot. Kulut näkyvät ennen vahvistusta.</p>
      </div>
          </div>
  </div>
</div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>Selainpohjainen kaupankäyntialusta</h2>
      <div class="grid grid-cols-2 gap-x-8 gap-y-6">
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Rahoitusmarkkinat</p>
            <p>Välitön pääsy kaikkiin ominaisuuksiin</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Markkinanäkemykset</p>
            <p>Nopea pääsy kattavaan datahistoriaan</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Optimoitu mobiilille</p>
            <p>Sujuva mobiilikokemus missä tahansa</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Kryptovaluuttojen hallinta</p>
            <p>Hallitse koko salkkua helposti</p>
          </div>
        </div>
      </div>
    </div>
    <div class="flex items-center justify-center">
        ...
        <img
          ...
          alt="<?= e(SITE_NAME) ?> — kaupankäyntialusta mobiilissa"
...
<div class="py-8 md:py-10">
  ...
  >
    ...
    >
      ...
      <p class="h3">Tapahtumavolyymi</p>
    </div>
    <div
      class="rounded-custom grid content-start gap-5 border p-4 md:p-6"
    >
      <p class="h2 lowercase">100+</p>
      <p class="h3">Tuetut maat</p>
    </div>
  </div>
</div>
      <!-- capabilities -->
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10">
    <h2>Digitaaliset ominaisuudet</h2>
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Keskeiset sijoitusominaisuudet</p>
          <p>Osaaminen näkyy konkreettisissa projekteissa ja luovissa lähestymistavoissa.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Krypton osto</p>
          <p>Turvallinen, helppo ympäristö kryptovaluuttojen ostoon. Nopea käsittely, matalat kulut. Aloita kaupankäynti heti.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Markkina-analytiikka</p>
          <p>Ymmärrä hinnat ja trendit perusteltuihin sijoituspäätöksiin.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Kaupankäynti digitaalisilla omaisuuserillä</p>
          <p>Käy kauppaa krypto-futuureilla. Tutki, sijoita ja laajenna salkkua.</p>
        </div>
      </div>
    </div>
  </div>
...
<p class="h2">Aloita nyt</p>
<p>
  Tutustu kryptokauppaan palvelussa <?= e(SITE_NAME) ?>. Kauppiaat maassa <?= e(geo_country_name()) ?> löytävät alustan, joka yhdistää kehittyneen teknologian, tehokkuuden ja helppokäyttöiset työkalut.</p>
          </div>
