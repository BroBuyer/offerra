...
$page_title = 'Trgovački instrumenti | Značajke pojačane AI-jem — ' . SITE_NAME;
$page_description = 'Koristite grafikone uživo, uvide AI-ja i alate za trgovanje ' . SITE_NAME . ', uz sigurnost kojoj možete vjerovati.';
$page_canonical = page_url("product.php");
$active_page = "product";
$schema_extra = ['breadcrumb' => schema_breadcrumb('Značajke platforme', 'product.php')];
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      ...
      <span class="breadcrumb-item">Značajke platforme</span>
    </nav>
  </div>
</div>
      <!-- analytics -->
  ...
  <div class="container-base grid gap-6 lg:grid-cols-2">
    ...
    >
      <h1 class="relative z-20">Trgovanje i analitika pojačani AI-jem</h1>
      <p class="relative z-20">
        Dobijte široke uvide o tržištu i portfelju uz analitiku <?= e(SITE_NAME) ?>. Grafikoni u stvarnom vremenu, integrirani indikatori i AI analiza za informirane izbore.      </p>
    </div>
    <div class="relative grid min-h-[355px] content-end">
      ...
      <div class="bg-before-custom relative z-30 grid grid-cols-2 gap-3 md:gap-6">
        <a class="btn btn-black col-span-full" href="<?= page_url('sign.php') ?>">Registracija</a>
        <a class="btn btn-black btn-square" href="<?= page_url('sign.php') ?>">
          <img src="<?= asset('static/img/svg/google-play.svg') ?>" alt="Preuzmite s Google Playa" />
        </a>
        <a class="btn btn-black btn-square" href="<?= page_url('sign.php') ?>">
          <img src="<?= asset('static/img/svg/app-store.svg') ?>" alt="Preuzmite s App Storea" />
        </a>
      </div>
    </div>
  </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-8 max-w-4xl">
    <p class="text-lg"><?= e(SITE_NAME) ?> nudi integriranu platformu: alate za trgovanje, široko praćenje tržišta i potpomognutu automatizaciju. Značajke i svakodnevne koristi pronađite ispod.</p>    <p>Platforma daje pristup više tržišta — kriptovalute, forex, dionice i robe — s cijenama uživo. Upravljajte nalozima i rizikom s jedne ploče, bez skakanja između aplikacija.</p>    <p>Analitički alati spajaju podatke u stvarnom vremenu i uvide AI-ja kako bi uhvatili trendove i značajne pomake. Podržavaju odluke; vi kontrolirate strategiju, obujam i limite. Sučelje stavlja na jednostavnost i učinkovitu izvršenja.</p>    <p>Sigurnost i pouzdanost su temelj: šifrirane veze, jaka zaštita računa i jasne uplate. Odgovara početnicima i stručnjacima, skalira se od osnovnog korištenja do naprednog trgovanja bez promjene platforme.</p>    <div class="grid gap-6 md:grid-cols-2">
            <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-3">Tržišta i trgovački instrumenti</h2>
        <p>Pratite digitalne valute, forex, dionice i robe integriranim alatima, popisima praćenja i upozorenjima. <?= e(SITE_NAME) ?> spaja analizu s upravljanjem nalozima i portfeljem.</p>
      </div>
                  <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-3">Transparentnost, sigurnost i kontrola</h2>
        <p>Sigurne veze, verificirani postupci, transparentne uplate i isplate. Naknade su vidljive prije potvrde.</p>
      </div>
          </div>
  </div>
</div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>Trgovačka platforma u pregledniku</h2>
      <div class="grid grid-cols-2 gap-x-8 gap-y-6">
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Financijska tržišta</p>
            <p>Trenutačni pristup svim značajkama</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Tržišni uvidi</p>
            <p>Brz pristup cjelovitoj povijesti podataka</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Optimizirano za mobilne uređaje</p>
            <p>Ugodno mobilno iskustvo, gdje god bili</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Upravljanje kriptovalutama</p>
            <p>Jednostavno upravljajte cijelim portfeljem</p>
          </div>
        </div>
      </div>
    </div>
    <div class="flex items-center justify-center">
        ...
        <img
          ...
          alt="<?= e(SITE_NAME) ?> — trgovačka platforma na mobitelu"
...
<div class="py-8 md:py-10">
  ...
  >
    ...
    >
      ...
      <p class="h3">Podržane valute</p>
    </div>
    <div
      class="rounded-custom grid content-start gap-5 border p-4 md:p-6"
    >
      <p class="h2 lowercase">42m</p>
      <p class="h3">Verificirani korisnici</p>
    </div>
    <div
      class="rounded-custom grid content-start gap-5 border p-4 md:p-6"
    >
      <p class="h2 lowercase"><?= e(currency_symbol()) ?>440m</p>
      <p class="h3">Obujam transakcija</p>
    </div>
    <div
      class="rounded-custom grid content-start gap-5 border p-4 md:p-6"
    >
      <p class="h2 lowercase">100+</p>
      <p class="h3">Podržane države</p>
    </div>
  </div>
</div>
      <!-- capabilities -->
    ...
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Ključne investicijske značajke</p>
          <p>Iskustvo pokazano kroz konkretne projekte i kreativne pristupe.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Kupnja kriptovaluta</p>
          <p>Sigurno, jednostavno okruženje za kupnju kriptovaluta. Brza obrada, niske naknade. Započnite trgovati odmah.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Analitika tržišta</p>
          <p>Razumijte cijene i trendove za informirane investicijske odluke.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Trgovanje digitalnom imovinom</p>
          <p>Trgujte kripto futures ugovorima. Istražujte, ulažite i širite portfelj.</p>
        </div>
      </div>
    </div>
  </div>
...
<p class="h2">Započnite sada</p>
<p>
  Otkrijte kripto trgovanje uz <?= e(SITE_NAME) ?>. Traderi iz <?= e(geo_country_name()) ?> nalaze platformu koja spaja naprednu tehnologiju, učinkovitost i jednostavne alate.</p>
          </div>
