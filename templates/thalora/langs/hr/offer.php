...
$page_title = 'Rješenja za trgovanje | Usluge pokretane AI-jem — ' . SITE_NAME;
...
$active_page = "offer";
$schema_extra = ['breadcrumb' => schema_breadcrumb('Promocije', 'offer.php')];
...
<span class="breadcrumb-item">Detalji ponude</span>
          </nav>
        </div>
      </div>
      <!-- tracker -->
      <div class="py-8 md:py-10">
        <div class="container-base grid gap-6 lg:grid-cols-2">
          ...
          >
 <h1 class="relative z-20">Započnite put uz <?= e(SITE_NAME) ?>: praćenje tržišta, analiza i podrška</h1>
<p class="relative z-20">
  Registrirajte se, potvrdite identitet i uplatite sredstva u nekoliko koraka. Praćenje portfelja, AI podrška i vođeni put od prve prijave do nadzorne ploče.</p>
          </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-8">
    <p class="text-lg max-w-4xl">Nudimo vođeni onboarding, puni pristup tržišnim alatima i stalnu pomoć. Jednostavan, transparentan put od registracije do svakodnevnog trgovanja, bez prečaca.</p>    <p class="max-w-4xl">Minimalna uplata otključava sve značajke. Istražujte AI strategije, upravljajte rizikom i pratite portfelj.</p>    <p class="max-w-4xl">Uvijek provjerite naknade, rokove isplata i korake verifikacije na platformi. Zadržavate operativnu kontrolu: limiti, veličina pozicije i ručne opcije ostaju dostupni i uz automatske alarme.</p>    <p class="max-w-4xl">Podrška objašnjava kako radi <?= e(SITE_NAME) ?> i status transakcija; ne daje osobne savjete. Tržišta nose rizik: procijenite izloženost i trgujte samo novcem čiji gubitak možete prihvatiti.</p>    <div class="grid gap-4 md:grid-cols-3">
            <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-2">Jednostavan onboarding</h2>
        <p>Jednostavno stvaranje računa, potvrda identiteta i jasan pristup nadzornoj ploči.</p>
      </div>
            <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-2">AI i tržišta</h2>
        <p>Ugrađena analitika, automatski signali i pristup više tržišta na jednoj platformi.</p>
      </div>
            <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-2">Jasna korisnička podrška</h2>
        <p>Jasne naknade i pravila isplata; posvećena pomoć za račune i transakcije.</p>
      </div>
          </div>
  </div>
</div>
...
<div class="relative z-40 py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10">
    ...
    <div class="border-primary h3 rounded-custom relative z-10 flex items-center justify-center border bg-white p-4 text-center md:p-6">
      Stvorite profil    </div>
    <div class="border-primary h3 rounded-custom relative z-10 flex items-center justify-center border bg-white p-4 text-center md:p-6">
      Uplatite na račun    </div>
    <div class="border-primary h3 rounded-custom relative z-10 flex items-center justify-center border bg-white p-4 text-center md:p-6">
      Trgujte s povjerenjem    </div>
        </div>
      </div>
    </div>
      <!-- registration-1 -->
...
<h2>Službena <?= e(SITE_NAME) ?> platforma za metodično trgovanje</h2>
<p>
  <?= e(SITE_NAME) ?> je osmišljena za osobe i timove koji upravljaju digitalnim valutama i imovinom: jasni alati, SSL šifriranje i brza pomoć. Jedna platforma za analizu, trgovanje i upravljanje portfeljem.</p>
          </div>
