...
$page_title = SITE_NAME . ' | Vodeća trgovačka platforma pokretana AI-jem';
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h1 id="heading-style-h1">Trgujte transparentno. Zadržite kontrolu nad svakom odlukom.</h1>
            <p>Pristupite kriptovalutama, forexu i globalnoj imovini s jedne platforme. <?= e(SITE_NAME) ?> spaja analitiku uživo, potpomognutu automatizaciju i stručnu podršku kako biste tržištima upravljali jasnim alatima i dosljednim procesima.</p>
        </div>
...
<div class="py-8 md:py-10">
  <div class="stats-cards container-base grid gap-3 md:grid-cols-2 md:gap-6 xl:grid-cols-4">
    ...
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      ...
      <p class="h3">Promet transakcija</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase">100+</p>
      <p class="h3">Pokrivene zemlje</p>
    </div>
  </div>
</div>
    <!-- features -->
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 max-lg:order-2 md:gap-10">
      <h2>Zašto odabrati <?= e(SITE_NAME) ?></h2>
      <p class="md:text-lg">
        Preferirana među današnjim kripto traderima, ova platforma postavlja novi standard. Spajamo snažnu sigurnost, potpunu transparentnost, napredni AI i intuitivno sučelje za sigurno trgovanje.      </p>
        ...
        <div class="grid grid-cols-2 gap-x-8 gap-y-6 max-sm:flex">
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Pouzdana sigurnost</p>
              <p>Snažne zaštite neprekidno čuvaju vaše osobne podatke i ulaganja.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Personalizirano trgovanje</p>
              <p>Prilagodite metode trgovanja svojim ciljevima i preferencijama.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Pametna AI rješenja</p>
              <p>Precizni uvidi za informirane odluke.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Automatizirana rješenja za trgovanje</p>
              <p>Botovi pokretani AI-jem rade non-stop i omogućuju strukturiraniji, signalni pristup trgovanju.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Intuitivno sučelje</p>
              <p>Jednostavno sučelje osmišljeno za jasno trgovanje od prvog korištenja.</p>
            </div>
          </div>
        </div>
      </div>
      <p class="h3">
        Ojačajte svoj financijski put uz <?= e(SITE_NAME) ?>.
      </p>
      <a class="btn btn-black" href="<?= page_url('sign.php') ?>">Registrirajte se sada</a>
    </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>Trgovanje bez napora!</h2>
      <p class="text-lg">
        Trgujte vodećim kriptovalutama kao što su Bitcoin, Ethereum i Dogecoin — jednostavno i s povjerenjem.      </p>
      <a class="btn btn-black max-md:hidden" href="<?= page_url('sign.php') ?>">Započnite sada</a>
    </div>
    <div class="grid gap-3 md:gap-6" data-trading></div>
    <a class="btn btn-black md:hidden" href="<?= page_url('sign.php') ?>">Započnite sada</a>
  </div>
</div>
<section class="feature-section">
  <div class="container">
    <div class="feature-header">
      <h2>
        Globalna trgovačka platforma <span>izgrađena za rast</span>      </h2>
      <p>
        Pristupite više financijskih tržišta kroz jedan sustav osmišljen za brzinu, preciznost i pouzdanu globalnu izvedbu.      </p>
    </div>
    <div class="feature-grid">
      <div class="feature-card">
        ...
        <p>
          Trgujte kriptovalutama, forexom, dionicama i robama na jednoj platformi, bez mijenjanja aplikacija.        </p>
      </div>
      <div class="feature-card featured">
        <div class="accent"></div>
        <h3>Brza izvršenja naloga</h3>
        <p>
          Optimizirana platforma za brzu i pouzdanu izvršenja naloga na globalnim tržištima.        </p>
      </div>
      <div class="feature-card">
        <div class="accent"></div>
        <h3>Analitika u stvarnom vremenu</h3>
        <p>
          Podaci uživo, napredni indikatori i uvidi za brze, informirane odluke.        </p>
      </div>
    </div>
  </div>
</section>
...
<div class="py-8 md:py-10" id="how-it-works">
  <div class="container-base grid gap-6 md:gap-10">
    <div class="grid items-center gap-6 lg:grid-cols-2">
      <h2>Kako radi <?= e(SITE_NAME) ?>: od registracije do trgovanja</h2>
      <p class="rounded-custom sm:border sm:p-8">
        Jednostavan proces u šest koraka: registracija, verifikacija, uplata, konfiguracija strategije i korištenje tržišnih alata. Nadzorna ploča jasno pokazuje rokove, opcije i kontrole.      </p>
    </div>
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Stvorite račun</p>
          <p>Registrirajte se osnovnim podacima za siguran pristup službenoj <?= e(SITE_NAME) ?> platformi. Ovaj brzi korak otvara glavnu nadzornu ploču.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Potvrdite identitet</p>
          <p>Potvrdite e-poštu kako biste otključali sve značajke: grafikone uživo, analitičke alate i resurse za strukturirani početak.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Pristupite trgovačkoj platformi</p>
          <p>Uplatite na račun najmanje <?= e(money_min()) ?>. Možete odabrati veći iznos prema ciljevima; sve opcije plaćanja i naknade vidljive su prije potvrde.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          ...
          <p>Odaberite bankovni prijenos, e-novčanik ili karticu. Vrijeme i naknade su transparentni — vi kontrolirate uplatu.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Odredite strategiju</p>
          <p>Prilagodite rizik, željena tržišta i pristup trgovanju. <?= e(SITE_NAME) ?>: AI podrška bira signale i praćenje tržišta, bez zamjene vaših odluka.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Istražite dostupna tržišta</p>
          <p>Kad je račun aktivan i konfiguriran, pratite cijene uživo, planirajte trgovine i koristite integriranu platformu za kriptovalute i ostalu imovinu.</p>
        </div>
      </div>
    </div>
    <div class="grid gap-6 md:grid-cols-2">
      <a class="btn btn-black" href="<?= page_url('sign.php') ?>">Započnite trgovanje</a>
    </div>
  </div>
</div>
    <!-- payments -->
    <div class="py-8 md:py-10">
      <div class="container-base grid items-center gap-6 lg:grid-cols-2">
        <p class="text-lg">
          <?= e(SITE_NAME) ?> podržava razne načine plaćanja za klijente diljem svijeta.        </p>
        ...
        <div class="grid items-end gap-6 md:grid-cols-2">
          ...
          <div class="inline-flex justify-end gap-8 max-md:hidden">
            <button class="text-primary hover:text-primary-dark -scale-x-100 cursor-pointer transition-colors"
              data-prev="reviews" aria-label="prethodni slajd">
          ...
          <div class="-ml-6">
            <div class="basis-full pl-6 md:basis-1/2">
              <div
                ...
                <p>
                  A fantastic trgovačke platforme is <?= e(SITE_NAME) ?>! The
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10" style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
    <div class="flex items-center justify-between gap-6 mb-6 reviews-flex-block">
      <h2 class="text-2xl font-bold">Recenzije korisnika</h2>
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
            <p>
              <?= e(SITE_NAME) ?> je nadmašio moja očekivanja. Registracija je bila jednostavna, naknade jasne, podrška brza. Sveukupno pouzdana, fluidna platforma koju rado koristim.            </p>
            <div class="flex items-center gap-4">
              <div class="initials">FE</div>
              <p class="font-bold">Specijalist za devize</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Odabrao sam <?= e(SITE_NAME) ?> za kripto trgovanje i zadovoljan sam. Početak je bio jasan i transparentan. Pouzdan izbor, osobito za početnike.                </p>
            <div class="flex items-center gap-4">
              <div class="initials">IM</div>
              <p class="font-bold">Analitičar investicijskih tržišta</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Smatram da je <?= e(SITE_NAME) ?> kao pouzdanu, dosljednu platformu. Otvaranje računa bilo je jednostavno, uvjeti transparentni, podrška stručna. Trgovanje ovdje je ugodno.                </p>
            <div class="flex items-center gap-4">
        ...
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Trgovanje kriptovalutama uz <?= e(SITE_NAME) ?> pristupačna. Registracija je bila laka, naknade razumljive, pomoć dostupna kad zatreba. Kao novi trader osjećam stvarnu razliku.                </p>
            <div class="flex items-center gap-4">
              <div class="initials">FA</div>
              <p class="font-bold">Financijski analitičar</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="grid gap-3 md:gap-6" data-accordion>
      ...
      <div id="accordion-6" class="group border-primary rounded-custom border transition-all">
        ...
        <div id="content-6" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p style="margin-bottom:16px;"><?= e(SITE_NAME) ?> je međunarodna trgovačka platforma za korisnike koji žele dosljednu izvedbu, brzu izvršenja i punu kontrolu okruženja. Umjesto odvojenih usluga spaja ključne značajke u jedan tijek.</p>
            <p style="margin-bottom:16px;">Od pristupa tržištu do izvršenja i analize svaki element radi bez trenja. Usredotočite se na odluke, ne na mijenjanje alata.</p>
            <p style="margin-bottom:10px; font-weight:500;">Trgujte na više financijskih tržišta s jedne platforme:</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Vodeće i rastuće kriptovalute</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Forex tržišta s cijenama uživo</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Globalne dionice i opcije na dionice</li>
              <li><span style="color:var(--color-primary);">•</span> Robe za širenje mogućnosti</li>
            </ul>
            <p style="margin-bottom:16px;">Izvedba je prioritet. Sustav je optimiziran za nisku latenciju i pouzdan rad u vršnim satima, da reagirate na cijene bez tehničkih kašnjenja.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Brza, pouzdana obrada naloga na tržištima</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Stalni tok tržišnih podataka</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Unaprijed instalirana analitika i tržišni indikatori</li>
              <li><span style="color:var(--color-primary);">•</span> Ručno i automatizirano trgovanje</li>
            </ul>
            <p style="margin-bottom:16px;">Sigurnost i operativna pouzdanost prioritet su na svim razinama. Platforma drži industrijske standarde i štiti podatke i financijske aktivnosti neprekidno.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Potpuno šifrirana komunikacija podataka</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Provjera identiteta i višeslojni sigurnosni protokoli</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Nadzirani i validirani procesi transakcija</li>
              <li><span style="color:var(--color-primary);">•</span> Infrastruktura osmišljena za pouzdanu globalnu povezanost</li>
            </ul>
            <p style="margin-bottom:16px;">Korisničko iskustvo jednako je važno. Dizajn je namjerno jednostavan i intuitivan, da se trader usredotoči na strategiju.</p>
            <p style="margin-bottom:16px;">Ova mješavina solidnih funkcija i jednostavnosti čini <?= e(SITE_NAME) ?> idealnom za početnike i iskusne tradere. Tko počinje, brzo hvata tempo bez strme krivulje učenja; napredni korisnici zadržavaju slobodu za složene taktike.</p>
            <p><?= e(SITE_NAME) ?> donosi skalabilnost, pouzdanost i visoku izvedbu na jednoj platformi — za siguran, uređen pristup međunarodnim financijskim tržištima.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <section style="padding:60px 0;" class="md:!py-[100px]">
    ...
    ">
      ...
      ">
        ...
        ">
          Ključne značajke <span style='color:var(--color-primary);'><?= e(SITE_NAME) ?> trgovačke platforme</span>        </h2>
      <p style="margin-top:14px;color:#6b7280;font-size:17px;">
        Funkcije koje povećavaju brzinu, preciznost i sigurnost trgovanja.      </p>
    </div>
    <div style="
      border-radius:16px;
      overflow:hidden;
    ...
    ">
      ...
      " onmouseover="this.style.background='#f9f9fb'" class="row-block" onmouseout="this.style.background='transparent'">
        ...
        <div class="row-text" style="color:#6b7280;">
          Napredna trgovačka tehnologija temeljena na AI-ju        </div>
      </div>
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          ...
          Načini uplate        </div>
        <div class="row-text" style="color:#6b7280;">
          Kartice, prijenosi, PayPal opcije        </div>
      </div>
      <div class="row-block" style="
        display:grid;
        grid-template-columns: 1fr 2fr;
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          <span style="color:var(--color-primary);">📱</span>
          Dostupnost platforme        </div>
        <div class="row-text" style="color:#6b7280;">
          Radi na više uređaja        </div>
      </div>
      <div class="row-block" style="
        display:grid;
        grid-template-columns: 1fr 2fr;
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          <span style="color:var(--color-primary);">📊</span>
          Dostupni instrumenti        </div>
        <div class="row-text" style="color:#6b7280;">
          Forex, dionice, kriptovalute, robe i više        </div>
      </div>
      <div class="row-block" style="
        display:grid;
        grid-template-columns: 1fr 2fr;
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          ...
          Vodič za otvaranje računa        </div>
        <div class="row-text" style="color:#6b7280;">
          Brz, glatki onboarding        </div>
      </div>
      <div class="row-block" style="
        display:grid;
      ...
      ">
        <div class="customer-block" style="display:flex;gap:10px;font-weight:600;">
          <span style="color:var(--color-primary);">📞</span>
          Korisnička podrška          <span style="font-weight:400;color:#6b7280;margin-left:10px;">
            Profesionalna podrška 24/7          </span>
        </div>
...
<div class="md:border-primary-light md:rounded-[20px] md:border md:px-20 md:py-8">
  <div class="border-primary-light grid justify-items-center gap-6 rounded-[20px] border px-4 py-5 md:gap-4 md:px-8 md:py-6 text-center md:text-left">
    <h2 class="h3 flex flex-wrap items-center justify-center md:justify-start gap-x-4 gap-y-3">
      Što kažu korisnici <?= e(SITE_NAME) ?>      <span class="inline-flex items-center justify-center rounded-full bg-emerald-600 px-2 py-1 text-sm leading-none text-white uppercase">
        Pouzdana      </span>
    </h2>
    <div class="flex flex-wrap items-center justify-center md:justify-start gap-2.5 text-center md:text-left">
      ...
      <span class="leading-none text-amber-500" role="img"
        aria-label="4.7 Ocjena (od 5)">
        ★★★★★      </span>
      <span class="flex flex-wrap justify-center md:justify-start gap-1 text-sm text-gray-400">
        <span>
          <strong>124</strong> recenzija klijenata ·
        </span>
        <span>
          Na temelju <strong>337</strong> ocjena ·
        </span>
        <span>
          Ocjena (od 5)        </span>
      </span>
    ...
    <p class="text-center md:text-left">
      Intuitivna platforma s naprednim alatima automatizacije i bogatim edukacijskim materijalima.    </p>
  </div>
</div>
      </div>
    </section>
