...
$page_title = 'Podrška | Pomoć tima ' . SITE_NAME;
$page_description = 'Kontaktirajte tim ' . SITE_NAME . ' za račune, uplate, isplate i pitanja o platformi.';
...
<h1>Kontakt</h1>
  <p class="lead max-w-3xl justify-self-center text-center md:text-left">Tim <?= e(SITE_NAME) ?> odgovara na pitanja o računima, uplatama, isplatama, grafikonima i AI alatima. Pomoć ide službenim kanalima — bez osobnih investicijskih preporuka ili jamstava dobiti.</p>
<div class="grid gap-4 text-center md:gap-6 md:text-left max-w-3xl justify-self-center">
  <h3>Pišite nam za daljnju pomoć</h3>  <p>Prije slanja imajte pri ruci e-poštu računa, temu (registracija, plaćanje, tehničko) i snimke zaslona ako treba. Što su detalji jasniji, to je rješenje brže.</p>  <p>Upiti o aktivnim trgovinama ili čekajućim isplatama imaju prioritet kad je moguće. Radi sigurnosti nikada nećemo tražiti punu lozinku ni 2FA kodove u nezatraženim e-porukama.</p>  <p>Ako se još niste registrirali, otvorite račun u nekoliko minuta na stranici registracije i vratite se ovdje. Pogledajte i FAQ o naknadama, sigurnosti i dostupnim tržištima.</p>  <p>Navedite jasan predmet (npr. «Isplata na čekanju», «Problem 2FA», «Pitanje o naknadi»). Većina upita dobiva prvi odgovor unutar nekoliko sati; veliki obujam ili provjere plaćanja mogu produžiti vrijeme.</p></div>
