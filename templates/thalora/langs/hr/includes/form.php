...
$form_submit = $form_submit ?? 'Stvorite račun';
...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__text">
      Vaš zahtjev kod <?= e(SITE_NAME) ?> je zaprimljen. Pričekajte poziv našeg savjetnika.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <div class="apx-lead-row lead-form-row">
      <label class="apx-lead-field field" data-field="fname">
        ...
        <input class="input" type="text" name="fname" placeholder="Ime" required pattern="[^\d]+" autocomplete="given-name" minlength="2" maxlength="50" inputmode="text" autocapitalize="words" spellcheck="false" title="Koristite samo slova (bez brojeva i simbola)">
    ...
    <div class="apx-lead-row lead-form-row">
      <label class="apx-lead-field field" data-field="lname">
        ...
        <input class="input" type="text" name="lname" placeholder="Prezime" required pattern="[^\d]+" autocomplete="family-name" minlength="2" maxlength="50" inputmode="text" autocapitalize="words" spellcheck="false" title="Koristite samo slova (bez brojeva i simbola)">
        <span class="field-error hide" role="alert" aria-live="polite"></span>
      </label>
    </div>
    <label class="apx-lead-field field" data-field="email">
      <span class="field-label">Adresa e-pošte</span>
      <input class="input" type="email" name="email" placeholder="Adresa e-pošte" required autocomplete="email" inputmode="email">
      <span class="field-error hide" role="alert" aria-live="polite"></span>
    </label>
    ...
    <div class="apx-lead-badges" aria-hidden="true">
      ...
      <img src="<?= asset('static/img/svg/payment-4.svg') ?>" alt="Sigurno plaćanje">
    </div>
  </div>
</form>
</div>
