...
$page_title = $page_title ?? (SITE_NAME . ' | Vodeća trgovačka platforma pokretana AI-jem');
$page_description = $page_description ?? ('Pristupite kriptovalutama, forexu i globalnoj imovini s jedne platforme. ' . SITE_NAME . ' spaja analitiku uživo, potpomognutu automatizaciju i stručnu podršku.');
...
<?php endif; ?>
  ...
  window.APP_LANG = {
    ...
    valPhoneCountry: 'Nevažeći kod zemlje',
    valPhoneShort: 'Broj je prekratak',
    valPhoneLong: 'Broj je predugačak',
    valPhoneEmpty: 'Unesite broj telefona',
    valSessionExpired: 'Sesija je istekla. Osvježite stranicu i pokušajte ponovno.',
    valGenericError: 'Nešto je pošlo po krivu. Pokušajte ponovno kasnije.',
    valConnectionError: 'Pogreška veze. Provjerite internet i pokušajte ponovno.'
  };
