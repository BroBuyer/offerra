        ...
        <div style="background-color: #1a1a1e !important; border-bottom: 1px solid #27272a !important; padding: 14px 18px !important; display: flex !important; align-items: center !important; justify-content: space-between !important; flex-direction: row !important;">
            <div style="display: flex !important; align-items: center !important; gap: 12px !important; flex-direction: row !important;">
                ...
                <div style="text-align: left !important;">
                    ...
                    <p style="color: #a1a1aa !important; font-size: 11px !important; margin: 0 !important; padding: 0 !important; opacity: 0.85;">Vodič za onboarding</p>
                </div>
            </div>
            <button id="chat-close-btn" type="button" aria-label="Zatvori chat" style="color: #a1a1aa !important; background: transparent !important; border: none !important; cursor: pointer !important; padding: 6px !important; display: flex !important; align-items: center !important; transition: color 0.2s;">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const quizLang = {
        welcome: `Bok! Ja sam Olivia, vaša vodičica za onboarding u <?= e(SITE_NAME) ?>. Vaš je pristup unaprijed odobren. Izgradimo vaš profil.`,
        q1: `Potvrdite da živite <?= e(geo_country_in()) ?>, kako biste u potpunosti ispunili zakonske zahtjeve.`,
        a1_yes: `Yes, I live here now`,
        a1_no: `Ne`,
        q2: `Odlično. Odaberite dobnu skupinu kako bismo preporučili odgovarajuće proizvode:`,
        q3: `Imate li trenutačno aktivan bankovni ili kreditni račun za dnevne isplate?`,
        a3_yes: `Da, moj je račun aktivan`,
        a3_no: `Trenutačno ne`,
        q4: `Koji je vaš glavni izvor prihoda? Pomaže nam prilagoditi postavke rizika.`,
        a4_1: `Zaposlen ili freelancer`,
        a4_2: `Štednja ili pasivni prihod`,
        a4_3: `Ostale vrste prihoda`,
        q5: `Još trenutak! Netko iz tima nazvat će vas između 11:00 i 20:00 radi kratke verifikacije. Možete li primiti poziv?`,
        a5_yes: `Da, to vrijeme mi odgovara`,
        a5_no: `Kontaktirajte me uskoro`,
        loaderText: `Provjeravamo odgovore i stvaramo vaš siguran račun...`,
        finalTitle: `Verifikacija završena! 🎉 Vaš siguran račun je spreman. Slijedite upute ispod kako biste omogućili dnevna plaćanja:`,
    ...
    function appendAgentMessage(text) {
        ...
        msg.innerHTML = `
            <div style="width: 28px; height: 28px; border-radius: 50%; border: 1px solid var(--color-primary); background-color: #27272a; display: flex; align-items: center; justify-content: center; overflow: hidden; flex-shrink: 0; margin-top: 2px;">
                <img alt="Slika trgovačke platforme" src="<?= asset('static/img/consultant.webp') ?>" width="28" height="28" decoding="async" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';" style="width:100%; height:100%; object-fit:cover;" class="cq-consultant-img">
