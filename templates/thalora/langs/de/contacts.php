...
$page_title = 'Support | Hilfe vom Team ' . SITE_NAME;
$page_description = 'Kontaktieren Sie das Team von ' . SITE_NAME . ' bei Konten, Einzahlungen, Auszahlungen und Plattformfragen.';
...
<h1>Kontakt</h1>
  <p class="lead max-w-3xl justify-self-center text-center md:text-left">Das Team von <?= e(SITE_NAME) ?> beantwortet Fragen zu Konten, Einzahlungen, Auszahlungen, Charts und KI-Tools. Hilfe läuft über offizielle Kanäle — ohne persönliche Anlageempfehlungen oder Gewinnversprechen.</p>
<div class="grid gap-4 text-center md:gap-6 md:text-left max-w-3xl justify-self-center">
  <h3>Schreiben Sie uns für weitere Hilfe</h3>  <p>Halten Sie vor der Kontaktaufnahme Ihre Konto-E-Mail, das Thema (Registrierung, Zahlung, Technik) und ggf. Screenshots bereit. Je klarer die Angaben, desto schneller die Lösung.</p>  <p>Anfragen zu aktiven Trades oder ausstehenden Auszahlungen haben nach Möglichkeit Vorrang. Zu Ihrer Sicherheit fordern wir niemals das vollständige Passwort oder 2FA-Codes per unaufgeforderter E-Mail.</p>  <p>Wenn Sie noch nicht registriert sind, eröffnen Sie in wenigen Minuten ein Konto auf der Anmeldeseite und kommen Sie danach zurück. Siehe auch FAQ zu Gebühren, Sicherheit und verfügbaren Märkten.</p>  <p>Geben Sie eine klare Betreffzeile an (z. B. «Auszahlung ausstehend», «2FA-Problem», «Gebührenfrage»). Die meisten Anfragen erhalten eine erste Antwort innerhalb weniger Stunden; hohes Aufkommen oder Zahlungsprüfungen können länger dauern.</p></div>
