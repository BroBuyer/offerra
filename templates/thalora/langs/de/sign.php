...
$page_title = 'Konto eröffnen | Trading starten mit ' . SITE_NAME;
$page_description = 'Richten Sie schnell Ihr ' . SITE_NAME . '-Konto ein und schalten Sie erweiterte KI-Trading-Funktionen frei.';
$page_canonical = page_url("sign.php");
$active_page = "sign";
$schema_extra = ['breadcrumb' => schema_breadcrumb('Anmelden / Registrieren', 'sign.php')];
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      ...
      <span class="breadcrumb-item">Anmelden / Registrieren</span>
    </nav>
  </div>
</div>
      <!-- registration-1 -->
...
<h1>Eröffnen Sie Ihr <?= e(SITE_NAME) ?>-Konto noch heute</h1>
