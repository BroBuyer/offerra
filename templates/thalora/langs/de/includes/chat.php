        ...
        <div style="background-color: #1a1a1e !important; border-bottom: 1px solid #27272a !important; padding: 14px 18px !important; display: flex !important; align-items: center !important; justify-content: space-between !important; flex-direction: row !important;">
            <div style="display: flex !important; align-items: center !important; gap: 12px !important; flex-direction: row !important;">
                ...
                <div style="text-align: left !important;">
                    ...
                    <p style="color: #a1a1aa !important; font-size: 11px !important; margin: 0 !important; padding: 0 !important; opacity: 0.85;">Onboarding-Leitfaden</p>
                </div>
            </div>
            <button id="chat-close-btn" type="button" aria-label="Chat schließen" style="color: #a1a1aa !important; background: transparent !important; border: none !important; cursor: pointer !important; padding: 6px !important; display: flex !important; align-items: center !important; transition: color 0.2s;">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const quizLang = {
        welcome: `Hallo! Ich bin Olivia, Ihre Onboarding-Begleitung bei <?= e(SITE_NAME) ?>. Ihr Zugang ist vorab genehmigt. Lassen Sie uns Ihr Profil aufbauen.`,
        q1: `Bitte bestätigen Sie Ihren Wohnsitz <?= e(geo_country_in()) ?>, um die gesetzlichen Anforderungen vollständig zu erfüllen.`,
        a1_yes: `Yes, I live here now`,
        a1_no: `Nein`,
        q2: `Sehr gut. Wählen Sie Ihre Altersgruppe, damit wir passende Produkte empfehlen können:`,
        q3: `Haben Sie derzeit ein aktives Bank- oder Kreditkartenkonto für tägliche Auszahlungen?`,
        a3_yes: `Ja, mein Konto ist aktiv`,
        a3_no: `Derzeit nicht`,
        q4: `Was ist Ihre Haupteinnahmequelle? So können wir die Risiko­einstellungen anpassen.`,
        a4_1: `Angestellt oder selbstständig`,
        a4_2: `Ersparnisse oder passives Einkommen`,
        a4_3: `Andere Einkommensarten`,
        q5: `Noch ein Schritt! Jemand aus dem Team ruft zwischen 11:00 und 20:00 zur kurzen Verifizierung an. Können Sie den Anruf entgegennehmen?`,
        a5_yes: `Ja, diese Zeit passt`,
        a5_no: `Bitte kontaktieren Sie mich bald`,
        loaderText: `Wir prüfen Ihre Angaben und richten Ihr sicheres Konto ein...`,
        finalTitle: `Verifizierung abgeschlossen! 🎉 Ihr sicheres Konto ist bereit. Folgen Sie den Anweisungen unten, um tägliche Zahlungen zu aktivieren:`,
    ...
    function appendAgentMessage(text) {
        ...
        msg.innerHTML = `
            <div style="width: 28px; height: 28px; border-radius: 50%; border: 1px solid var(--color-primary); background-color: #27272a; display: flex; align-items: center; justify-content: center; overflow: hidden; flex-shrink: 0; margin-top: 2px;">
                <img alt="Bild der Handelsplattform" src="<?= asset('static/img/consultant.webp') ?>" width="28" height="28" decoding="async" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';" style="width:100%; height:100%; object-fit:cover;" class="cq-consultant-img">
