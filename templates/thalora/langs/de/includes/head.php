...
$page_title = $page_title ?? (SITE_NAME . ' | Führende KI-gestützte Handelsplattform');
$page_description = $page_description ?? ('Greifen Sie über eine Plattform auf Kryptowährungen, Forex und globale Vermögenswerte zu. ' . SITE_NAME . ' verbindet Live-Analytik, unterstützte Automatisierung und Experten-Support.');
...
<?php endif; ?>
  ...
  <script>
  window.APP_LANG = {
    valPhoneInvalid: 'Bitte geben Sie eine gültige Telefonnummer ein',
    valPhoneCountry: 'Ungültiger Ländercode',
    valPhoneShort: 'Die Nummer ist zu kurz',
    valPhoneLong: 'Die Nummer ist zu lang',
    valPhoneEmpty: 'Bitte geben Sie Ihre Telefonnummer ein',
