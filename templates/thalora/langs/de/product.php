...
$page_title = 'Handelsinstrumente | KI-gestützte Funktionen von ' . SITE_NAME;
$page_description = 'Nutzen Sie Live-Marktcharts, KI-Einblicke und Trading-Tools von ' . SITE_NAME . ' — mit vertrauenswürdiger Sicherheit.';
$page_canonical = page_url("product.php");
$active_page = "product";
$schema_extra = ['breadcrumb' => schema_breadcrumb('Plattformfunktionen', 'product.php')];
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      ...
      <span class="breadcrumb-item">Plattformfunktionen</span>
    </nav>
  </div>
</div>
      <!-- analytics -->
  ...
  <div class="container-base grid gap-6 lg:grid-cols-2">
    ...
    >
      <h1 class="relative z-20">KI-gestütztes Trading & Analytik</h1>
      <p class="relative z-20">
        Umfassende Markt- und Portfolio-Einblicke mit der Analytik von <?= e(SITE_NAME) ?>. Echtzeit-Charts, integrierte Indikatoren und KI-Analyse für fundierte Entscheidungen.      </p>
    </div>
    <div class="relative grid min-h-[355px] content-end">
      ...
      <div class="bg-before-custom relative z-30 grid grid-cols-2 gap-3 md:gap-6">
        <a class="btn btn-black col-span-full" href="<?= page_url('sign.php') ?>">Registrieren</a>
        <a class="btn btn-black btn-square" href="<?= page_url('sign.php') ?>">
          <img src="<?= asset('static/img/svg/google-play.svg') ?>" alt="Bei Google Play laden" />
        </a>
        <a class="btn btn-black btn-square" href="<?= page_url('sign.php') ?>">
          <img src="<?= asset('static/img/svg/app-store.svg') ?>" alt="Im App Store laden" />
        </a>
      </div>
    </div>
  </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-8 max-w-4xl">
    <p class="text-lg"><?= e(SITE_NAME) ?> liefert eine integrierte Plattform: Trading-Tools, umfassendes Marktmonitoring und unterstützte Automatisierung. Funktionen und Vorteile finden Sie unten.</p>    <p>Die Plattform öffnet Märkte — Krypto, Forex, Aktien und Rohstoffe — mit Live-Kursen. Steuern Sie Orders und Risiko von einem Dashboard, ohne zwischen Apps zu wechseln.</p>    <p>Analysetools verbinden Echtzeitdaten und KI-Einblicke, um Trends und wesentliche Bewegungen zu erkennen. Sie stützen Entscheidungen; Sie steuern Strategie, Volumen und Limits. Die Oberfläche setzt auf Einfachheit und effiziente Ausführung.</p>    <p>Sicherheit und Zuverlässigkeit sind Grundlage: verschlüsselte Verbindungen, starker Kontoschutz und klare Einzahlungen. Geeignet für Einsteiger und Experten, skaliert von der Basisnutzung bis zum fortgeschrittenen Trading ohne Plattformwechsel.</p>    <div class="grid gap-6 md:grid-cols-2">
            <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-3">Märkte & Handelsinstrumente</h2>
        <p>Verfolgen Sie digitale Währungen, Forex, Aktien und Rohstoffe mit integrierten Tools, Watchlists und Alerts. <?= e(SITE_NAME) ?> verbindet Analyse mit Order- und Portfoliomanagement.</p>
      </div>
                  <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-3">Transparenz, Sicherheit & Kontrolle</h2>
        <p>Sichere Verbindungen, geprüfte Abläufe, transparente Ein- und Auszahlungen. Gebühren sehen Sie vor der Bestätigung.</p>
      </div>
          </div>
  </div>
</div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>Browserbasierte Handelsplattform</h2>
      <div class="grid grid-cols-2 gap-x-8 gap-y-6">
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Finanzmärkte</p>
            <p>Sofortiger Zugang zu allen Funktionen</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Markteinblicke</p>
            <p>Schneller Zugriff auf vollständige Datenhistorie</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Mobil optimiert</p>
            <p>Optimierte mobile Nutzung überall</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Kryptoverwaltung</p>
            <p>Verwalten Sie Ihr gesamtes Portfolio einfach</p>
          </div>
        </div>
      </div>
    </div>
    <div class="flex items-center justify-center">
        ...
        <img
          ...
          alt="<?= e(SITE_NAME) ?> — Handelsplattform mobil"
...
<div class="py-8 md:py-10">
  ...
  >
    ...
    >
      ...
      <p class="h3">Transaktionsvolumen</p>
    </div>
    <div
      class="rounded-custom grid content-start gap-5 border p-4 md:p-6"
    >
      <p class="h2 lowercase">100+</p>
      <p class="h3">Unterstützte Länder</p>
    </div>
  </div>
</div>
      <!-- capabilities -->
    ...
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Zentrale Investmentfunktionen</p>
          <p>Expertise, gezeigt in konkreten Projekten und kreativen Ansätzen.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Krypto-Kauf</p>
          <p>Eine sichere, benutzerfreundliche Umgebung zum Krypto-Kauf. Schnelle Abwicklung, geringe Gebühren. Starten Sie sofort.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Marktanalytik</p>
          <p>Verstehen Sie Kurse und Trends für fundierte Anlageentscheidungen.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Handel mit digitalen Assets</p>
          <p>Handeln Sie Krypto-Futures. Entdecken, investieren und erweitern Sie Ihr Portfolio.</p>
        </div>
      </div>
    </div>
  </div>
...
<p class="h2">Jetzt starten</p>
<p>
  Entdecken Sie Krypto-Trading mit <?= e(SITE_NAME) ?>. Trader in <?= e(geo_country_name()) ?> finden eine Plattform aus fortschrittlicher Technologie, Effizienz und benutzerfreundlichen Tools.</p>
          </div>
