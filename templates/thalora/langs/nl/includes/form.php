...
$form_submit = $form_submit ?? 'Account aanmaken';
...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__title">Je bent al geregistreerd</p>
    <p class="form-already-registered__text">
      Je aanvraag bij <?= e(SITE_NAME) ?> is ontvangen. Wacht op een belletje van een adviseur.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <div class="apx-lead-row lead-form-row">
      <label class="apx-lead-field field" data-field="fname">
        <span class="field-label">Voornaam</span>
        <input class="input" type="text" name="fname" placeholder="Voornaam" required pattern="[^\d]+" autocomplete="given-name" minlength="2" maxlength="50" inputmode="text" autocapitalize="words" spellcheck="false" title="Gebruik alleen letters (geen cijfers of symbolen)">
        <span class="field-error hide" role="alert" aria-live="polite"></span>
      </label>
    </div>
    <div class="apx-lead-row lead-form-row">
      <label class="apx-lead-field field" data-field="lname">
        <span class="field-label">Achternaam</span>
        <input class="input" type="text" name="lname" placeholder="Achternaam" required pattern="[^\d]+" autocomplete="family-name" minlength="2" maxlength="50" inputmode="text" autocapitalize="words" spellcheck="false" title="Gebruik alleen letters (geen cijfers of symbolen)">
        <span class="field-error hide" role="alert" aria-live="polite"></span>
      </label>
    </div>
    <label class="apx-lead-field field" data-field="email">
      <span class="field-label">E-mailadres</span>
      <input class="input" type="email" name="email" placeholder="E-mailadres" required autocomplete="email" inputmode="email">
      <span class="field-error hide" role="alert" aria-live="polite"></span>
    </label>
    ...
    <div class="apx-lead-badges" aria-hidden="true">
      ...
      <img src="<?= asset('static/img/svg/payment-4.svg') ?>" alt="Veilige betaling">
    </div>
  </div>
</form>
</div>
