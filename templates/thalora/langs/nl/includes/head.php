...
$page_title = $page_title ?? (SITE_NAME . ' | Toonaangevend AI-handelsplatform');
$page_description = $page_description ?? ('Krijg toegang tot cryptovaluta, forex en wereldwijde activa via één platform. ' . SITE_NAME . ' combineert live-analyse, ondersteunde automatisering en expert support.');
...
<?php endif; ?>
  ...
  window.APP_LANG = {
    ...
    valPhoneEmpty: 'Voer je telefoonnummer in',
    valSessionExpired: 'Sessie verlopen. Laad de pagina opnieuw en probeer het nog eens.',
    valGenericError: 'Er ging iets mis. Probeer het later opnieuw.',
    valConnectionError: 'Verbindingsfout. Controleer je internetverbinding en probeer het opnieuw.'
  };
