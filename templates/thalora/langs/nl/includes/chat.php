        ...
        <div style="background-color: #1a1a1e !important; border-bottom: 1px solid #27272a !important; padding: 14px 18px !important; display: flex !important; align-items: center !important; justify-content: space-between !important; flex-direction: row !important;">
            <div style="display: flex !important; align-items: center !important; gap: 12px !important; flex-direction: row !important;">
                ...
                <div style="text-align: left !important;">
                    ...
                    <p style="color: #a1a1aa !important; font-size: 11px !important; margin: 0 !important; padding: 0 !important; opacity: 0.85;">Onboardinggids</p>
                </div>
            </div>
            <button id="chat-close-btn" type="button" aria-label="Chat sluiten" style="color: #a1a1aa !important; background: transparent !important; border: none !important; cursor: pointer !important; padding: 6px !important; display: flex !important; align-items: center !important; transition: color 0.2s;">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const quizLang = {
        welcome: `Hoi! Ik ben Olivia, je onboardinggids bij <?= e(SITE_NAME) ?>. Je toegang is vooraf goedgekeurd. Laten we je profiel opbouwen.`,
        q1: `Bevestig dat je woont <?= e(geo_country_in()) ?> om volledig te voldoen aan de wettelijke eisen.`,
        a1_yes: `Yes, I live here now`,
        a1_no: `Nee`,
        q2: `Mooi. Kies je leeftijdsgroep zodat we passende producten kunnen aanbevelen:`,
        q3: `Heb je nu een actieve bankrekening of creditcard om dagelijkse uitkeringen te ontvangen?`,
        a3_yes: `Ja, mijn account is actief`,
        a3_no: `Nu niet`,
        q4: `Wat is je belangrijkste inkomstenbron? Dat helpt ons de risico-instellingen af te stemmen.`,
        a4_1: `In loondienst of freelancer`,
        a4_2: `Spaargeld of passief inkomen`,
        a4_3: `Andere inkomsten`,
        q5: `Nog even! Iemand van het team belt je tussen 11:00 en 20:00 voor een korte verificatie. Kun je de oproep aannemen?`,
        a5_yes: `Ja, dat tijdstip past`,
        a5_no: `Neem snel contact op`,
        loaderText: `Antwoorden controleren en je beveiligde account aanmaken...`,
        finalTitle: `Verificatie voltooid! 🎉 Je beveiligde account is klaar. Volg de instructies hieronder om dagelijkse betalingen te activeren:`,
    ...
    function appendAgentMessage(text) {
        ...
        msg.innerHTML = `
            <div style="width: 28px; height: 28px; border-radius: 50%; border: 1px solid var(--color-primary); background-color: #27272a; display: flex; align-items: center; justify-content: center; overflow: hidden; flex-shrink: 0; margin-top: 2px;">
                <img alt="Afbeelding van het handelsplatform" src="<?= asset('static/img/consultant.webp') ?>" width="28" height="28" decoding="async" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';" style="width:100%; height:100%; object-fit:cover;" class="cq-consultant-img">
