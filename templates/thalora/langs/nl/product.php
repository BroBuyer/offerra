...
$page_title = 'Handelsinstrumenten | AI-versterkte functies — ' . SITE_NAME;
$page_description = 'Gebruik de livediagrammen, AI-inzichten en handelstools van ' . SITE_NAME . ', met betrouwbare beveiliging.';
$page_canonical = page_url("product.php");
$active_page = "product";
$schema_extra = ['breadcrumb' => schema_breadcrumb('Platformfuncties', 'product.php')];
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      ...
      <span class="breadcrumb-item">Platformfuncties</span>
    </nav>
  </div>
</div>
      <!-- analytics -->
  ...
  <div class="container-base grid gap-6 lg:grid-cols-2">
    ...
    >
      <h1 class="relative z-20">AI-versterkt handelen en analyse</h1>
      <p class="relative z-20">
        Krijg uitgebreide markt- en portefeuille-inzichten met de analyse van <?= e(SITE_NAME) ?>. Realtime-diagrammen, geïntegreerde indicatoren en AI-analyse voor geïnformeerde keuzes.      </p>
    </div>
    <div class="relative grid min-h-[355px] content-end">
      ...
      <div class="bg-before-custom relative z-30 grid grid-cols-2 gap-3 md:gap-6">
        <a class="btn btn-black col-span-full" href="<?= page_url('sign.php') ?>">Aanmelden</a>
        <a class="btn btn-black btn-square" href="<?= page_url('sign.php') ?>">
          <img src="<?= asset('static/img/svg/google-play.svg') ?>" alt="Downloaden via Google Play" />
        </a>
        <a class="btn btn-black btn-square" href="<?= page_url('sign.php') ?>">
          <img src="<?= asset('static/img/svg/app-store.svg') ?>" alt="Downloaden in de App Store" />
        </a>
      </div>
    </div>
  </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-8 max-w-4xl">
    <p class="text-lg"><?= e(SITE_NAME) ?> biedt een geïntegreerd platform: handelstools, brede marktmonitoring en ondersteunde automatisering. Ontdek de functies en dagelijkse voordelen hieronder.</p>    <p>Het platform geeft toegang tot meerdere markten — cryptovaluta, forex, aandelen en grondstoffen — met liveprijzen. Beheer orders en risico vanuit één dashboard, zonder tussen apps te springen.</p>    <p>Analysetools combineren realtimedata en AI-inzichten om trends en relevante bewegingen te zien. Ze ondersteunen beslissingen; jij stuurt strategie, volume en limieten. De interface mikt op eenvoud en efficiënte uitvoering.</p>    <p>Beveiliging en betrouwbaarheid zijn de basis: versleutelde verbindingen, sterke accountbescherming en duidelijke stortingen. Geschikt voor beginners en experts, en schaalt van basisgebruik naar geavanceerd handelen zonder van platform te wisselen.</p>    <div class="grid gap-6 md:grid-cols-2">
            <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-3">Markten en handelsinstrumenten</h2>
        <p>Volg digitale valuta, forex, aandelen en grondstoffen met geïntegreerde tools, watchlists en alerts. <?= e(SITE_NAME) ?> koppelt analyse aan order- en portefeuillebeheer.</p>
      </div>
                  <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-3">Transparantie, beveiliging en controle</h2>
        <p>Veilige verbindingen, geverifieerde procedures, transparante stortingen en opnames. Kosten zie je vóór bevestiging.</p>
      </div>
          </div>
  </div>
</div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>Handelsplatform in de browser</h2>
      <div class="grid grid-cols-2 gap-x-8 gap-y-6">
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Financiële markten</p>
            <p>Directe toegang tot alle functies</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Marktinzichten</p>
            <p>Snelle toegang tot complete datahistoriek</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Geoptimaliseerd voor mobiel</p>
            <p>Een soepele mobiele ervaring, waar je ook bent</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Cryptobeheer</p>
            <p>Beheer de hele portefeuille eenvoudig</p>
          </div>
        </div>
      </div>
    </div>
    <div class="flex items-center justify-center">
        ...
        <img
          ...
          alt="<?= e(SITE_NAME) ?> — handelsplatform op mobiel"
...
<div class="py-8 md:py-10">
  ...
  >
    ...
    >
      ...
      <p class="h3">Transactievolume</p>
    </div>
    <div
      class="rounded-custom grid content-start gap-5 border p-4 md:p-6"
    >
      <p class="h2 lowercase">100+</p>
      <p class="h3">Ondersteunde landen</p>
    </div>
  </div>
</div>
      <!-- capabilities -->
    ...
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Belangrijke beleggingsfuncties</p>
          <p>Expertise in de praktijk via concrete projecten en creatieve aanpak.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Crypto kopen</p>
          <p>Een veilige, eenvoudige omgeving om cryptovaluta te kopen. Snelle verwerking, lage kosten. Begin meteen met handelen.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Marktanalyse</p>
          <p>Begrijp prijzen en trends voor geïnformeerde beleggingsbeslissingen.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Handelen in digitale activa</p>
          <p>Handel in cryptofutures. Verken, beleg en bouw de portefeuille uit.</p>
        </div>
      </div>
    </div>
  </div>
...
<p class="h2">Begin nu</p>
<p>
  Ontdek cryptotrading met <?= e(SITE_NAME) ?>. Traders in <?= e(geo_country_name()) ?> vinden een platform dat geavanceerde technologie, efficiëntie en gebruiksvriendelijke tools combineert.</p>
          </div>
