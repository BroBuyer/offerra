...
$page_title = 'Support | Hulp van het team ' . SITE_NAME;
$page_description = 'Neem contact op met het team ' . SITE_NAME . ' voor accounts, stortingen, opnames en platformvragen.';
...
<h1>Contact</h1>
  <p class="lead max-w-3xl justify-self-center text-center md:text-left">Het team van <?= e(SITE_NAME) ?> beantwoordt vragen over accounts, stortingen, opnames, diagrammen en AI-tools. Hulp loopt via officiële kanalen — zonder persoonlijke beleggingsaanbevelingen of winstgarantie.</p>
<div class="grid gap-4 text-center md:gap-6 md:text-left max-w-3xl justify-self-center">
  <h3>Mail ons voor extra hulp</h3>  <p>Heb vóór je schrijft het account-e-mailadres, het onderwerp (registratie, betaling, technisch) en eventuele screenshots klaar. Hoe duidelijker de details, hoe sneller de oplossing.</p>  <p>Verzoeken over actieve trades of lopende opnames krijgen waar mogelijk voorrang. Voor je veiligheid vragen we nooit het volledige wachtwoord of 2FA-codes via ongevraagde e-mails.</p>  <p>Nog niet geregistreerd? Open in minuten een account via de aanmeldpagina en kom hier terug. Bekijk ook de FAQ voor kosten, beveiliging en beschikbare markten.</p>  <p>Geef een duidelijk onderwerp (bijv. «Opname in behandeling», «2FA-probleem», «Vraag over kosten»). De meeste verzoeken krijgen binnen enkele uren een eerste antwoord; hoog volume of betalingscontroles kunnen de tijd verlengen.</p></div>
