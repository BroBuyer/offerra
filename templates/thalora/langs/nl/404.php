...
<main class="flex grow flex-col overflow-hidden">
  <section class="notfound-page">
    <div class="container-base" style="max-width: 560px;">
      ...
      <p>Die link bestaat niet. Ga terug naar home of open een account om te starten.</p>
      <div class="flex items-center justify-center gap-4" style="margin-top: 1.5rem;">
        <a href="<?= page_url() ?>" class="btn btn-black">Naar home</a>
        <a href="<?= page_url('sign.php') ?>" class="btn btn-black">Account openen</a>
      </div>
    </div>
  </section>
</main>
