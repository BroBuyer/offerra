...
$page_title = 'Atidarykite savo sąskaitą | Pradėkite prekybą su' . SITE_NAME;
$page_description = 'Greitai nustatykite savo' . SITE_NAME . 'paskyrą, kad atrakintumėte išplėstines AI prekybos galimybes.';
$page_canonical = page_url("sign.php");
$active_page = "sign";
$schema_extra = ['breadcrumb' => schema_breadcrumb('Prisijungti / Registruotis', 'sign.php')];
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      ...
      <span class="breadcrumb-item">Prisijungti / Registruotis</span>
    </nav>
  </div>
</div>
      <!-- registration-1 -->
...
<h1>Atidarykite savo<?= e(SITE_NAME) ?>sąskaitą šiandien</h1>
