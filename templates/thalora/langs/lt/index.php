...
$page_title = SITE_NAME . ' | Aukščiausia AI pagrįsta prekybos platforma';
$page_description = 'Susiekite su kriptovaliutų, Forex ir pasaulio rinkomis naudodami ' . SITE_NAME . ' dirbtinio intelekto pagrįstą analizę ir intuityvią platformą, pritaikytą " . geo_country_name() . ' klientai.';
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h1 id="heading-style-h1">Prekyba skaidriai. Kontroliuokite kiekvieną sprendimą.</h1>
            <p>Pasiekite kriptovaliutas, Forex ir pasaulinį turtą per vieną platformą.<?= e(SITE_NAME) ?>sujungia tiesioginę analizę, pagalbinį automatizavimą ir ekspertų palaikymą, kad padėtų jums naršyti rinkose naudojant aiškius įrankius ir nuoseklius procesus.</p>
        </div>
...
<div class="py-8 md:py-10">
  <div class="stats-cards container-base grid gap-3 md:grid-cols-2 md:gap-6 xl:grid-cols-4">
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      ...
      <p class="h3">Palaikomos valiutos</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase">42m</p>
      <p class="h3">Patvirtinti vartotojai</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase">440 milijonų svarų sterlingų</p>
      <p class="h3">Sandorių apyvarta</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase">100+</p>
      <p class="h3">Aptarnaujamos šalys</p>
    </div>
  </div>
</div>
    <!-- features -->
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 max-lg:order-2 md:gap-10">
      <h2>Kodėl rinktis<?= e(SITE_NAME) ?></h2>
      <p class="md:text-lg">
        Ši platforma, kuriai pirmenybę teikia šiuolaikiniai kriptovaliutų prekiautojai, nustato naują standartą. Mes sujungiame tvirtą saugumą, visišką skaidrumą, pažangų AI ir intuityvią sąsają, kad palaikytume patikimą prekybą.      </p>
        ...
        <div class="grid grid-cols-2 gap-x-8 gap-y-6 max-sm:flex">
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Patikimas saugumas</p>
              <p>Tvirtos apsaugos priemonės nuolat saugo jūsų asmeninę informaciją ir investicijas.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Personalizuota prekyba</p>
              <p>Pritaikykite savo prekybos metodus, kad atitiktumėte savo unikalius tikslus ir pageidavimus.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Išmanieji AI sprendimai</p>
              <p>Tikslios prekybos įžvalgos, padedančios priimti gerai pagrįstus sprendimus.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Automatizuoti prekybos sprendimai</p>
              <p>Dirbtinio intelekto valdomi robotai veikia nuolat, kad įgalintų labiau struktūrizuotą, signalais pagrįstą prekybos metodą.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Intuityvi sąsaja</p>
              <p>Lengva naudoti sąsaja, sukurta paprastam prekybai nuo pat pradžių.</p>
            </div>
          </div>
        </div>
      </div>
      <p class="h3">
        Pagerinkite savo finansinę kelionę su<?= e(SITE_NAME) ?>.
      </p>
      <a class="btn btn-black" href="<?= page_url('sign.php') ?>">Prisiregistruokite dabar</a>
    </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>Lengva prekyba!</h2>
      <p class="text-lg">
        Lengvai ir užtikrintai prekiaukite pirmaujančiomis kriptovaliutomis, tokiomis kaip Bitcoin, Ethereum ir Dogecoin.      </p>
      <a class="btn btn-black max-md:hidden" href="<?= page_url('sign.php') ?>">Pradėkite dabar</a>
    </div>
    <div class="grid gap-3 md:gap-6" data-trading></div>
    <a class="btn btn-black md:hidden" href="<?= page_url('sign.php') ?>">Pradėkite dabar</a>
  </div>
</div>
<section class="feature-section">
  <div class="container">
    <div class="feature-header">
      <h2>
        Pasaulinė prekybos platforma<span>skirtas plėsti</span>      </h2>
      <p>
        Pasiekite kelias finansų rinkas per vieną sistemą, sukurtą greičiui, tikslumui ir patikimam pasauliniam veikimui.      </p>
    </div>
    <div class="feature-grid">
      <div class="feature-card">
        <div class="accent"></div>
        <h3>Prieiga prie kelių rinkų</h3>
        <p>
          Prekiaukite kriptovaliutomis, Forex, akcijomis ir prekėmis vienoje platformoje neperjungdami programų.        </p>
      </div>
      <div class="feature-card featured">
        <div class="accent"></div>
        <h3>Greitas užsakymų vykdymas</h3>
        <p>
          Optimizuota platforma užtikrina greitą ir patikimą užsakymų vykdymą visose pasaulio rinkose.        </p>
      </div>
      <div class="feature-card">
        <div class="accent"></div>
        <h3>Analizė realiuoju laiku</h3>
        <p>
          Tiesioginiai rinkos duomenys, pažangūs rodikliai ir įžvalgos, padėsiančios greitai priimti pagrįstus sprendimus.        </p>
      </div>
    </div>
  </div>
</section>
...
<div class="py-8 md:py-10" id="how-it-works">
  <div class="container-base grid gap-6 md:gap-10">
    <div class="grid items-center gap-6 lg:grid-cols-2">
      <h2>Kaip veikia <?= e(SITE_NAME) ?>: nuo registracijos iki prekybos</h2>
      <p class="rounded-custom sm:border sm:p-8">
        Paprastas šešių žingsnių procesas: registracija, patikrinimas, finansavimas, strategijos konfigūravimas ir rinkos įrankių naudojimas. Prietaisų skydelyje aiškiai rodomas laikas, parinktys ir valdikliai.      </p>
    </div>
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Susikurkite paskyrą</p>
          <p>Užsiregistruokite naudodami pagrindinę informaciją, kad galėtumėte saugiai pasiekti pareigūną<?= e(SITE_NAME) ?>platforma. Šis greitas veiksmas suteikia prieigą prie pagrindinio prietaisų skydelio.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Patvirtinkite savo tapatybę</p>
          <p>Patvirtinkite el. pašto adresą, kad atrakintumėte visas funkcijas: tiesiogines diagramas, analizės įrankius ir išteklius, skirtus struktūriškai pradžiai.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Prisijunkite prie savo prekybos platformos</p>
          <p>Finansuokite savo sąskaitą bent<?= e(money_min()) ?>. Galite pasirinkti didesnes sumas pagal savo tikslus, o visos mokėjimo parinktys ir mokesčiai aiškiai rodomi prieš patvirtinant.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Pridėti lėšų</p>
          <p>Rinkitės iš banko pavedimo, elektroninės piniginės arba mokėjimo kortele. Visos apdorojimo trukmės ir mokesčiai yra skaidrūs, todėl galite visiškai kontroliuoti finansavimą.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Apibrėžkite savo strategiją</p>
          <p>Koreguokite savo rizikos nustatymus, pageidaujamas rinkas ir prekybos metodą.<?= e(SITE_NAME) ?>AI palaikymas kuruoja signalus ir rinkos sekimą nepaisydamas jūsų pasirinkimų.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Naršykite turimas rinkas</p>
          <p>Kai paskyra bus aktyvi ir sukonfigūruota, stebėkite tiesiogines kainas, planuokite sandorius ir naudokite integruotą kriptovaliutų ir kito turto platformą.</p>
        </div>
      </div>
    </div>
    <div class="grid gap-6 md:grid-cols-2">
      <a class="btn btn-black" href="<?= page_url('sign.php') ?>">Pradėti prekybą</a>
    </div>
  </div>
</div>
    <!-- payments -->
    <div class="py-8 md:py-10">
      <div class="container-base grid items-center gap-6 lg:grid-cols-2">
        <p class="text-lg">
          <?= e(SITE_NAME) ?>palaiko įvairius mokėjimo būdus klientams visame pasaulyje.        </p>
        ...
        <div class="grid items-end gap-6 md:grid-cols-2">
          ...
          <div class="inline-flex justify-end gap-8 max-md:hidden">
            <button class="text-primary hover:text-primary-dark -scale-x-100 cursor-pointer transition-colors"
              data-prev="reviews" aria-label="ankstesnė skaidrė">
          ...
          <div class="-ml-6">
            <div class="basis-full pl-6 md:basis-1/2">
              <div
                ...
                <p>
                  A fantasticprekybos platforma is <?= e(SITE_NAME) ?>! The
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10" style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
    <div class="flex items-center justify-between gap-6 mb-6 reviews-flex-block">
      <h2 class="text-2xl font-bold">Vartotojų atsiliepimai</h2>
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
            <p>
              <?= e(SITE_NAME) ?>viršijo mano lūkesčius. Prisiregistravimas buvo paprastas, mokesčiai aiškūs, o palaikymas yra greitas. Apskritai, patikima ir sklandi platforma, kurią mielai naudojuosi.            </p>
            <div class="flex items-center gap-4">
              <div class="initials">FE</div>
              <p class="font-bold">Užsienio valiutos specialistas</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  aš pasirinkau<?= e(SITE_NAME) ?>kriptovaliutų prekybai ir likome patenkinti. Sąrankos procesas buvo paprastas ir skaidrus. Tai atrodo kaip patikimas pasirinkimas, ypač naujokams.                </p>
            <div class="flex items-center gap-4">
              <div class="initials">IM</div>
              <p class="font-bold">Investicijų rinkos analitikas</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  randu<?= e(SITE_NAME) ?>būti patikima ir nuoseklia platforma. Paskyros nustatymas buvo lengvas, sąlygos yra skaidrios ir išmanantis palaikymą. Prekyba čia buvo patogi.                </p>
            <div class="flex items-center gap-4">
              <div class="initials">OT</div>
              <p class="font-bold">Internetinis prekybininkas</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Prekyba kriptovaliutomis su<?= e(SITE_NAME) ?>jaučiasi pasiekiamas. Registracija buvo paprasta, mokesčiai suprantami, o prireikus buvo suteikta pagalba. Kadangi esate naujas prekybininkas, tai tikrai pasikeitė.                </p>
            <div class="flex items-center gap-4">
              <div class="initials">FA</div>
              <p class="font-bold">Finansų analitikas</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="grid gap-3 md:gap-6" data-accordion>
      ...
      <div id="accordion-6" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Apie Platformą</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-6" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p style="margin-bottom:16px;"><?= e(SITE_NAME) ?>yra tarptautinė prekybos platforma, sukurta vartotojams, siekiantiems nuoseklaus našumo, greito vykdymo ir visiškos prekybos aplinkos kontrolės. Užuot valdę atskiras paslaugas ar vietines platformas, ji siūlo vieningą sistemą, integruojančią visas pagrindines funkcijas į vieną darbo eigą.</p>
            <p style="margin-bottom:16px;">Nuo patekimo į rinką iki užsakymų vykdymo ir analizės, kiekvienas elementas yra sukurtas taip, kad veiktų sklandžiai, sumažinant trukdžius. Tai leidžia vartotojams sutelkti dėmesį į prekybos sprendimus, o ne į platformos perjungimą ar naršymą.</p>
            <p style="margin-bottom:10px; font-weight:500;">Prekiaukite įvairiose finansų rinkose vienoje platformoje:</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Populiariausios ir besivystančios kriptovaliutos</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Forex rinkos su tiesioginiais kainų kanalais</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Pasaulinės akcijos ir akcijų opcionai</li>
              <li><span style="color:var(--color-primary);">•</span> Prekės, skirtos išplėsti investavimo galimybes</li>
            </ul>
            <p style="margin-bottom:16px;">Našumas yra svarbiausias. Sistema optimizuota mažo delsimo pavedimų vykdymui ir patikimam veikimui esant intensyviai rinkos veiklai, užtikrinant savalaikę reakciją į kainų pokyčius be techninių vėlavimų.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Greitas, patikimas užsakymų apdorojimas visose rinkose</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Nuolatinis rinkos duomenų srautas</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Iš anksto įdiegta analizė ir rinkos rodikliai</li>
              <li><span style="color:var(--color-primary);">•</span> Palaikymas tiek rankinei, tiek automatinei prekybai</li>
            </ul>
            <p style="margin-bottom:16px;">Saugumas ir veikimo patikimumas yra prioritetai visais lygiais. Platforma atitinka pramonės standartus ir naudoja vidinę apsaugą, kad visada būtų apsaugota vartotojų informacija ir finansinė veikla.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Visiškai užšifruotas duomenų ryšys</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Išsamus tapatybės patikrinimas ir kelių sluoksnių saugos protokolai</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Stebimi ir tikrinami sandorių procesai</li>
              <li><span style="color:var(--color-primary);">•</span> Infrastruktūra sukurta patikimam pasauliniam ryšiui</li>
            </ul>
            <p style="margin-bottom:16px;">Mes teikiame vienodą reikšmę vartotojo patirčiai. Dizainas yra sąmoningai paprastas ir intuityvus, sumažinantis sudėtingumą, kad prekybininkai galėtų sutelkti dėmesį į savo strategijas.</p>
            <p style="margin-bottom:16px;">Šis tvirto funkcionalumo ir paprastumo derinys sukuria<?= e(SITE_NAME) ?>idealiai tinka tiek naujokams, tiek patyrusiems prekybininkams. Pradedantieji gali greitai įsibėgėti be sudėtingos mokymosi kreivės, o pažengę vartotojai gali lanksčiai atlikti sudėtingas taktikas.</p>
            <p><?= e(SITE_NAME) ?>užtikrina mastelio keitimą, patikimumą ir aukštą našumą vienoje platformoje, užtikrinant saugią, organizuotą prieigą prie tarptautinių finansų rinkų.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h2>Dirbkite reguliuojamoje platformoje™</h2>
          <p>
            Pasitiki atskiri prekybininkai ir įmonės saugiam kriptovaliutų pirkimui, pardavimui ir valdymui.          </p>
        </div>
  ...
  <section style="padding:60px 0;" class="md:!py-[100px]">
    ...
    ">
      ...
      ">
        ...
        ">
          Pagrindinės savybės<span style='color:var(--color-primary);'><?= e(SITE_NAME) ?>prekybos platforma</span>        </h2>
      <p style="margin-top:14px;color:#6b7280;font-size:17px;">
        Pagrindinės funkcijos, skirtos pagerinti jūsų prekybos greitį, tikslumą ir pasitikėjimą.      </p>
    </div>
    <div style="
      border-radius:16px;
      overflow:hidden;
    ...
    ">
      ...
      " onmouseover="this.style.background='#f9f9fb'" class="row-block" onmouseout="this.style.background='transparent'">
        <div style="display:flex;align-items:center;gap:10px;font-weight:600;">
          ...
          Techninė struktūra        </div>
        <div class="row-text" style="color:#6b7280;">
          Pažangi AI pagrįsta prekybos technologija        </div>
      </div>
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          <span style="color:var(--color-primary);">💳</span>
          Finansavimo metodai        </div>
        <div class="row-text" style="color:#6b7280;">
          Debeto kortelės, banko pavedimai, PayPal galimybės        </div>
      </div>
      <div class="row-block" style="
        display:grid;
        grid-template-columns: 1fr 2fr;
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          <span style="color:var(--color-primary);">📱</span>
          Platformos prieinamumas        </div>
        <div class="row-text" style="color:#6b7280;">
          Veikia keliuose įrenginiuose        </div>
      </div>
      <div class="row-block" style="
        display:grid;
        grid-template-columns: 1fr 2fr;
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          <span style="color:var(--color-primary);">📊</span>
          Galimi instrumentai        </div>
        <div class="row-text" style="color:#6b7280;">
          Forex, akcijos, kriptovaliutos, žaliavos ir kt        </div>
      </div>
      <div class="row-block" style="
        display:grid;
        grid-template-columns: 1fr 2fr;
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          ...
          Paskyros sąrankos vadovas        </div>
        <div class="row-text" style="color:#6b7280;">
          Greitas ir sklandus prisijungimas        </div>
      </div>
      <div class="row-block" style="
        display:grid;
      ...
      ">
        <div class="customer-block" style="display:flex;gap:10px;font-weight:600;">
          <span style="color:var(--color-primary);">📞</span>
          Pagalba klientams          <span style="font-weight:400;color:#6b7280;margin-left:10px;">
            Profesionalus palaikymas pasiekiamas 24 valandas per parą          </span>
        </div>
        ...
        onmouseout="this.style.background='var(--color-primary)'">
          Susisiekite su palaikymo tarnyba        </a>
      </div>
    </div>
  </div>
</section>
<div class="md:border-primary-light md:rounded-[20px] md:border md:px-20 md:py-8">
  <div class="border-primary-light grid justify-items-center gap-6 rounded-[20px] border px-4 py-5 md:gap-4 md:px-8 md:py-6 text-center md:text-left">
    <h2 class="h3 flex flex-wrap items-center justify-center md:justify-start gap-x-4 gap-y-3">
      Ką sako <?= e(SITE_NAME) ?> vartotojai      <span class="inline-flex items-center justify-center rounded-full bg-emerald-600 px-2 py-1 text-sm leading-none text-white uppercase">
        Patikimas      </span>
    </h2>
    <div class="flex flex-wrap items-center justify-center md:justify-start gap-2.5 text-center md:text-left">
      ...
      <span class="leading-none text-amber-500" role="img"
        aria-label="4.7 Rezultatas (iš 5)">
        ★★★★★      </span>
      <span class="flex flex-wrap justify-center md:justify-start gap-1 text-sm text-gray-400">
        <span>
          <strong>124</strong>klientų atsiliepimai ·
        </span>
        <span>
          Remiantis<strong>337</strong>įvertinimai ·
        </span>
        <span>
          Rezultatas (iš 5)        </span>
      </span>
    </div>
    <p class="text-center md:text-left">
      Intuityvi prekybos platforma, apimanti pažangius automatizavimo įrankius ir didelius mokymo išteklius.    </p>
  </div>
</div>
      </div>
    </section>
