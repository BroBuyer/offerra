    ...
    <div class="container-base">
      <div class="relative grid gap-7 md:gap-10">
        <div class="grid gap-5">
          <nav class="flex flex-col flex-wrap justify-between gap-x-10 gap-y-5 text-white md:flex-row">
            ...
            <ul class="flex flex-col gap-x-5 gap-y-4 md:flex-row md:gap-x-7 lg:gap-x-12">
              ...
              <li><a href="<?= page_url('product.php') ?>">Prekybos platforma</a></li>
              ...
              <li><a href="<?= page_url('about.php') ?>">Apie mus</a></li>
            </ul>
            <ul class="flex flex-col gap-x-5 gap-y-4 md:flex-row">
              <li><a href="<?= page_url('privacy.php') ?>">Privatumo pranešimas</a></li>
              <li><a href="<?= page_url('conditions.php') ?>">Taisyklės ir sąlygos</a></li>
            </ul>
          </nav>
          <div class="flex justify-between gap-5">
            <div class="grid gap-5 text-white">
              <p style="color:var(--color-primary);">Jūsų patikimas prekybos partneris</p>
        ...
        <div class="grid gap-2.5 text-sm text-gray-500">
            <p>
                <?= e(SITE_NAME) ?>neprisiima jokios atsakomybės už jokius nuostolius ar žalą, patirtą naudojant šios svetainės informaciją, įskaitant šviečiamąjį turinį, kainas, diagramas ar rinkos analizę. Prekyba finansinėmis priemonėmis kelia didelę riziką; Prašome nuodugniai įvertinti savo asmenines aplinkybes. Prieš pradėdami prekybą, pasitarkite su profesionaliu patarėju. Skirkite tik kapitalą, kurį galite sau leisti prarasti, nes tokie produktai kaip Forex, CFD ir kriptovaliutos gali būti netinkami visiems investuotojams.
            </p>
        </div>
