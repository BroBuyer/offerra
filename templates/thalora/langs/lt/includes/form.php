...
$form_submit = $form_submit ?? 'Sukurti paskyrą';
...
<?php endif; ?>
    ...
    <div class="apx-lead-row lead-form-row">
      <label class="apx-lead-field field" data-field="fname">
        ...
        <input class="input" type="text" name="fname" placeholder="Vardas" required pattern="[^\d]+" autocomplete="given-name" minlength="2" maxlength="50" inputmode="text" autocapitalize="words" spellcheck="false" title="Naudokite tik raides (be skaičių ar simbolių)">
    ...
    <div class="apx-lead-row lead-form-row">
      <label class="apx-lead-field field" data-field="lname">
        ...
        <input class="input" type="text" name="lname" placeholder="Pavardė" required pattern="[^\d]+" autocomplete="family-name" minlength="2" maxlength="50" inputmode="text" autocapitalize="words" spellcheck="false" title="Naudokite tik raides (be skaičių ar simbolių)">
        <span class="field-error hide" role="alert" aria-live="polite"></span>
      </label>
    </div>
    <label class="apx-lead-field field" data-field="email">
      <span class="field-label">Pašto adresas</span>
      <input class="input" type="email" name="email" placeholder="Pašto adresas" required autocomplete="email" inputmode="email">
      <span class="field-error hide" role="alert" aria-live="polite"></span>
    </label>
    <label class="apx-lead-field apx-lead-field--phone lead-form-field lead-form-field--phone field" data-field="phone">
      <span class="field-label">Telefono numeris</span>
    ...
    <p class="apx-lead-consent">
      Pateikdami savo duomenis sutinkate su
    ...
    <div class="apx-lead-badges" aria-hidden="true">
      ...
      <img src="<?= asset('static/img/svg/payment-4.svg') ?>" alt="Saugus mokėjimas">
    </div>
  </div>
</form>
</div>
