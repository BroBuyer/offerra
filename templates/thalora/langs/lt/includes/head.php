...
$page_title = $page_title ?? (SITE_NAME . ' | Aukščiausia AI pagrįsta prekybos platforma');
$page_description = $page_description ?? ('Pasiekite kriptovaliutas, Forex ir pasaulinį turtą per vieną platformą.' . SITE_NAME . 'sujungia tiesioginę analizę, pagalbinį automatizavimą ir ekspertų palaikymą.');
...
<?php endif; ?>
  ...
  window.APP_LANG = {
    ...
    valPhoneEmpty: 'Įveskite savo telefono numerį',
