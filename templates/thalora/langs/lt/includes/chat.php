        ...
        <div style="background-color: #1a1a1e !important; border-bottom: 1px solid #27272a !important; padding: 14px 18px !important; display: flex !important; align-items: center !important; justify-content: space-between !important; flex-direction: row !important;">
            <div style="display: flex !important; align-items: center !important; gap: 12px !important; flex-direction: row !important;">
                ...
                <div style="text-align: left !important;">
                    ...
                    <p style="color: #a1a1aa !important; font-size: 11px !important; margin: 0 !important; padding: 0 !important; opacity: 0.85;">Priėmimo vadovas</p>
                </div>
            </div>
            <button id="chat-close-btn" type="button" aria-label="Uždaryti pokalbį" style="color: #a1a1aa !important; background: transparent !important; border: none !important; cursor: pointer !important; padding: 6px !important; display: flex !important; align-items: center !important; transition: color 0.2s;">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const quizLang = {
        welcome: `Sveiki! Aš Olivija, tavo<?= e(SITE_NAME) ?>įstojimo vadovas. Jūsų prieiga iš anksto patvirtinta. Pradėkime kurti jūsų profilį.`,
        q1: `Patvirtinkite, kad gyvenate<?= e(geo_country_in()) ?>visiškai laikytis teisės aktų reikalavimų.`,
        a1_yes: `Taip, aš dabar čia gyvenu`,
        a1_no: „Ne“.,
        q2: `Puiku. Pasirinkite savo amžiaus grupę, kad galėtume rekomenduoti tinkamus finansinius produktus:`,
        q3: `Ar šiuo metu turite aktyvią banko ar kredito kortelės sąskaitą, kad gautumėte kasdienius dividendų mokėjimus?`,
        a3_yes: `Taip, mano paskyra aktyvi`,
        a3_no: `Šiuo metu ne`,
        q4: `Koks yra jūsų pagrindinis pajamų šaltinis? Tai padeda mums pritaikyti platformos rizikos nustatymus jums.`,
        a4_1: `Darbuotojas arba laisvai samdomas darbuotojas`,
        a4_2: `Santaupos arba pasyvios pajamos`,
        a4_3: `Kitos pajamų rūšys`,
        q5: `Tik šiek tiek daugiau! Kažkas iš mūsų komandos jums paskambins nuo 11:00 iki 20:00 ir trumpai patvirtins. Ar galėsite priimti skambutį?`,
        a5_yes: `Taip, tas laikas veikia`,
        a5_no: `Nedelsdami susisiekite su manimi`,
        loaderText: `Tikrinami jūsų atsakymai ir nustatoma saugi paskyra...`,
        finalTitle: `Patvirtinimas baigtas! 🎉 Jūsų saugi paskyra paruošta. Vadovaukitės toliau pateiktomis instrukcijomis, kad įgalintumėte kasdienius mokėjimus:`,
    ...
    function appendAgentMessage(text) {
        ...
        msg.innerHTML = `
            <div style="width: 28px; height: 28px; border-radius: 50%; border: 1px solid var(--color-primary); background-color: #27272a; display: flex; align-items: center; justify-content: center; overflow: hidden; flex-shrink: 0; margin-top: 2px;">
                <img alt="Prekybos platformos vaizdas" src="<?= asset('static/img/consultant.webp') ?>" width="28" height="28" decoding="async" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';" style="width:100%; height:100%; object-fit:cover;" class="cq-consultant-img">
