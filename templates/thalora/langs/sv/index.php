...
$page_title = SITE_NAME . ' | Ledande AI-driven handelsplattform';
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h1 id="heading-style-h1">Handla transparent. Behåll kontrollen över varje beslut.</h1>
            <p>Få tillgång till kryptovalutor, forex och globala tillgångar via en och samma plattform. <?= e(SITE_NAME) ?> kombinerar liveanalys, assisterad automatisering och expertstöd så att du navigerar marknaderna med tydliga verktyg och konsekventa processer.</p>
        </div>
...
<div class="py-8 md:py-10">
  <div class="stats-cards container-base grid gap-3 md:grid-cols-2 md:gap-6 xl:grid-cols-4">
    ...
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      ...
      <p class="h3">Transaktionsomsättning</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase">100+</p>
      <p class="h3">Länder vi betjänar</p>
    </div>
  </div>
</div>
    <!-- features -->
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 max-lg:order-2 md:gap-10">
      <h2>Varför välja <?= e(SITE_NAME) ?></h2>
      <p class="md:text-lg">
        Föredragen av dagens kryptohandlare sätter den här plattformen en ny standard. Vi kombinerar stark säkerhet, full transparens, avancerad AI och ett intuitivt gränssnitt för trygg handel.      </p>
        ...
        <div class="grid grid-cols-2 gap-x-8 gap-y-6 max-sm:flex">
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Pålitlig säkerhet</p>
              <p>Starka skyddsvärn skyddar dina personuppgifter och investeringar hela tiden.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Anpassad handel</p>
              <p>Anpassa dina handelsmetoder efter dina mål och preferenser.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Smarta AI-lösningar</p>
              <p>Precisa handelsinsikter som stöder välgrundade beslut.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Automatiserade handelslösningar</p>
              <p>AI-drivna bottar körs kontinuerligt för mer strukturerade, signalbaserade handelsupplägg.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Intuitivt gränssnitt</p>
              <p>Ett lättanvänt gränssnitt utformat för tydlig handel från första stund.</p>
            </div>
          </div>
        </div>
      </div>
      <p class="h3">
        Stärk din ekonomiska resa med <?= e(SITE_NAME) ?>.
      </p>
      <a class="btn btn-black" href="<?= page_url('sign.php') ?>">Registrera dig nu</a>
    </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>Enkel handel!</h2>
      <p class="text-lg">
        Handla ledande kryptovalutor som Bitcoin, Ethereum och Dogecoin — enkelt och tryggt.      </p>
      <a class="btn btn-black max-md:hidden" href="<?= page_url('sign.php') ?>">Börja nu</a>
    </div>
    <div class="grid gap-3 md:gap-6" data-trading></div>
    <a class="btn btn-black md:hidden" href="<?= page_url('sign.php') ?>">Börja nu</a>
  </div>
</div>
<section class="feature-section">
  <div class="container">
    <div class="feature-header">
      <h2>
        En global handelsplattform <span>byggd för tillväxt</span>      </h2>
      <p>
        Få tillgång till flera finansmarknader via ett system utformat för hastighet, noggrannhet och pålitlig global prestanda.      </p>
    </div>
    <div class="feature-grid">
      <div class="feature-card">
        ...
        <p>
          Handla kryptovalutor, forex, aktier och råvaror på en och samma plattform utan att byta app.        </p>
      </div>
      <div class="feature-card featured">
        <div class="accent"></div>
        <h3>Snabb orderutförande</h3>
        <p>
          En optimerad plattform för snabb och pålitlig orderutförande på globala marknader.        </p>
      </div>
      <div class="feature-card">
        <div class="accent"></div>
        <h3>Realtidsanalys</h3>
        <p>
          Livedata, avancerade indikatorer och insikter som hjälper dig att besluta snabbt och informerat.        </p>
      </div>
    </div>
  </div>
</section>
...
<div class="py-8 md:py-10" id="how-it-works">
  <div class="container-base grid gap-6 md:gap-10">
    <div class="grid items-center gap-6 lg:grid-cols-2">
      <h2>Så fungerar <?= e(SITE_NAME) ?>: från registrering till handel</h2>
      <p class="rounded-custom sm:border sm:p-8">
        En tydlig process i sex steg: registrering, verifiering, insättning, strategiinställning och användning av marknadsverktyg. Instrumentpanelen visar tider, val och kontroller klart.      </p>
    </div>
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Skapa ditt konto</p>
          <p>Registrera dig med dina grunduppgifter för säker åtkomst till den officiella <?= e(SITE_NAME) ?>-plattformen. Det här snabba steget öppnar din huvudinstrumentpanel.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Bekräfta din identitet</p>
          <p>Bekräfta din e-post för att låsa upp alla funktioner: livediagram, analysverktyg och material för en strukturerad start.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Gå till handelsplattformen</p>
          <p>Sätt in minst <?= e(money_min()) ?>. Du kan välja ett högre belopp utifrån dina mål; alla betalningsmetoder och avgifter visas innan bekräftelse.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Lägg till medel</p>
          <p>Välj banköverföring, e-plånbok eller kort. Handläggningstider och avgifter är transparenta — du har full kontroll över insättningen.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Definiera din strategi</p>
          <p>Justera risk, favoritmarknader och handelssätt. <?= e(SITE_NAME) ?>:s AI-stöd tar fram signaler och marknadsuppföljning utan att åsidosätta dina val.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Utforska tillgängliga marknader</p>
          <p>När kontot är aktivt och inställt följer du livepriser, planerar affärer och använder den integrerade plattformen för krypto och andra tillgångar.</p>
        </div>
      </div>
    </div>
    <div class="grid gap-6 md:grid-cols-2">
      <a class="btn btn-black" href="<?= page_url('sign.php') ?>">Börja handla</a>
    </div>
  </div>
</div>
    <!-- payments -->
    <div class="py-8 md:py-10">
      <div class="container-base grid items-center gap-6 lg:grid-cols-2">
        <p class="text-lg">
          <?= e(SITE_NAME) ?> stöder många betalningsmetoder för kunder över hela världen.        </p>
        ...
        <div class="grid items-end gap-6 md:grid-cols-2">
          ...
          <div class="inline-flex justify-end gap-8 max-md:hidden">
            <button class="text-primary hover:text-primary-dark -scale-x-100 cursor-pointer transition-colors"
              data-prev="reviews" aria-label="föregående bild">
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10" style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
    <div class="flex items-center justify-between gap-6 mb-6 reviews-flex-block">
      <h2 class="text-2xl font-bold">Användaromdömen</h2>
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
            <p>
              <?= e(SITE_NAME) ?> överträffade mina förväntningar. Registreringen var enkel, avgifterna tydliga och supporten snabb. Sammantaget en pålitlig, smidig plattform som jag gärna använder.            </p>
        ...
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Jag valde <?= e(SITE_NAME) ?> för kryptohandel och är nöjd. Uppstarten var tydlig och transparent. Ett tryggt val, särskilt för nybörjare.                </p>
            <div class="flex items-center gap-4">
              <div class="initials">IM</div>
              <p class="font-bold">Investeringsanalytiker</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Jag tycker att <?= e(SITE_NAME) ?> som en pålitlig och konsekvent plattform. Kontoöppningen var enkel, villkoren transparenta och supporten kunnig. Handeln här känns bekväm.                </p>
            <div class="flex items-center gap-4">
              <div class="initials">OT</div>
              <p class="font-bold">Onlinehandlare</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Att handla kryptovalutor hos <?= e(SITE_NAME) ?> känns lättillgänglig. Registreringen var enkel, avgifterna begripliga och hjälp finns när det behövs. Som ny handlare har det gjort skillnad på riktigt.                </p>
            <div class="flex items-center gap-4">
    ...
    <div class="grid gap-3 md:gap-6" data-accordion>
      <div id="accordion-1" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Vilka steg behövs för att börja handla?</span>
        ...
        <div id="content-1" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Att komma igång är enkelt. Registrera dig med dina viktigaste uppgifter, bekräfta e-posten och sätt in minst <?= e(money_min()) ?>. Då låser du upp hela plattformen: livediagram, handelsverktyg, marknadsanalys och dedikerad support. Ingen tidigare erfarenhet krävs — tydliga guider följer dig i varje steg.</p>
          </div>
        </div>
      </div>
      <div id="accordion-2" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Är <?= e(SITE_NAME) ?> pålitlig när det gäller mina pengar och min information?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
      ...
      <div id="accordion-3" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Hur snabbt kan jag ta ut mina medel?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-3" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Uttag kan begäras när som helst från kontoportalen. Handläggning tar vanligtvis 1–3 bankdagar beroende på metod. Avgifter och uppskattade tider visas innan du bekräftar. Behöver du hjälp att följa ett uttag står supporten redo.</p>
          </div>
        </div>
      </div>
      <div id="accordion-4" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Hur vet jag om plattformen passar mina handelsbehov?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-4" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Vi rekommenderar att du börjar med minsta insättning för att bekanta dig med funktionerna. <?= e(SITE_NAME) ?> passar både nybörjare och erfarna handlare: ett lättanvänt gränssnitt, valfria AI-verktyg och kundsupport dygnet runt. Du behåller full kontroll över ordrar, gränser och riskinställningar.</p>
          </div>
        </div>
      </div>
      <div id="accordion-5" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Behöver jag handelserfarenhet innan jag börjar?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-5" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Ingen tidigare handelserfarenhet krävs. Plattformen är lätt att använda från start, med onboarding, guider och AI-förstärkta verktyg. Du lär dig i din egen takt — från kärnmarknader till mer avancerad analys och automatisering.</p>
          </div>
        </div>
      </div>
      <div id="accordion-7" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Vilka marknader kan jag följa hos <?= e(SITE_NAME) ?>?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-7" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>I ett och samma gränssnitt följer du ledande kryptovalutor, forex med realtidspriser, globala aktier och råvaror. Utan att byta app kan du fokusera på analys och beslut.</p>
          </div>
        </div>
      </div>
      <div id="accordion-8" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Hur fungerar AI-analysen?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-8" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p><?= e(SITE_NAME) ?> erbjuder AI-verktyg som organiserar handelssignaler, markerar tydliga prisrörelser och hjälper dig att följa marknaden. De stöder dina val utan att ersätta strategin eller garantera ett visst utfall. Du avgör när du agerar och hur mycket du allokerar.</p>
          </div>
        </div>
      </div>
      <div id="accordion-9" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Hur lång tid tar det vanligtvis från registrering till första affären?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-9" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Kontoöppning och verifiering tar vanligtvis bara några minuter. Tiden till första affären beror på insättningen och betalningsmetoden. På startsidan finns en tydlig steg-för-steg-guide utan dolda moment.</p>
          </div>
        </div>
      </div>
      <div id="accordion-10" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Finns det support för kontofrågor?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-10" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Teamet nås via Kontaktsidan eller FAQ för frågor om kontoåtkomst, insättningar, uttag eller funktioner. Hjälpen är operativ, inte investeringsrådgivning.</p>
          </div>
        </div>
      </div>
      <div id="accordion-6" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Om plattformen</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-6" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p style="margin-bottom:16px;"><?= e(SITE_NAME) ?> är en internationell handelsplattform för användare som vill ha konsekvent prestanda, snabb utförande och full kontroll över handelsmiljön. Istället för separata tjänster samlar den nyckelfunktionerna i ett enda arbetsflöde.</p>
            <p style="margin-bottom:16px;">Från marknadsåtkomst till orderutförande och analys är varje del utformad för att fungera smidigt. Du fokuserar på besluten, inte på att byta verktyg.</p>
            <p style="margin-bottom:10px; font-weight:500;">Handla på flera finansmarknader från en plattform:</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Ledande och framväxande kryptovalutor</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Forexmarknader med livepriser</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Globala aktier och aktieoptioner</li>
              <li><span style="color:var(--color-primary);">•</span> Råvaror för att bredda möjligheterna</li>
            </ul>
            <p style="margin-bottom:16px;">Prestanda kommer först. Systemet är optimerat för låg latens och pålitlig drift vid hög aktivitet, så att du reagerar på priser utan tekniska fördröjningar.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Snabb, pålitlig orderhantering på marknaderna</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Kontinuerligt flöde av marknadsdata</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Förinstallerad analys och marknadsindikatorer</li>
              <li><span style="color:var(--color-primary);">•</span> Stöd för både manuell och automatiserad handel</li>
            </ul>
            <p style="margin-bottom:16px;">Säkerhet och operativ pålitlighet är prioriterade på alla nivåer. Plattformen följer branschstandarder och skyddar användaruppgifter och finansiella aktiviteter hela tiden.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Fullt krypterad datakommunikation</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Identitetsverifiering och flerskiktade säkerhetsprotokoll</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Övervakade och validerade transaktionsprocesser</li>
              <li><span style="color:var(--color-primary);">•</span> Infrastruktur för pålitlig global anslutning</li>
            </ul>
            <p style="margin-bottom:16px;">Användarupplevelsen är lika viktig. Designen är medvetet enkel och intuitiv så att du kan fokusera på strategin.</p>
            <p style="margin-bottom:16px;">Den här blandningen av robusta funktioner och enkelhet gör <?= e(SITE_NAME) ?> till ett idealiskt val för både nybörjare och erfarna handlare. Nybörjaren kommer igång utan brant inlärningskurva; avancerade användare behåller friheten till komplexa taktiker.</p>
            <p><?= e(SITE_NAME) ?> ger skalbarhet, pålitlighet och hög prestanda på en plattform — säker, strukturerad åtkomst till internationella finansmarknader.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <section style="padding:60px 0;" class="md:!py-[100px]">
    ...
    ">
      ...
      ">
        ...
        ">
          Nyckelfunktioner hos <span style='color:var(--color-primary);'><?= e(SITE_NAME) ?> handelsplattform</span>        </h2>
      <p style="margin-top:14px;color:#6b7280;font-size:17px;">
        Funktioner som höjer handelns hastighet, precision och trygghet.      </p>
    </div>
    <div style="
      border-radius:16px;
      overflow:hidden;
    ...
    ">
      ...
      " onmouseover="this.style.background='#f9f9fb'" class="row-block" onmouseout="this.style.background='transparent'">
        <div style="display:flex;align-items:center;gap:10px;font-weight:600;">
          ...
          Tekniskt ramverk        </div>
        <div class="row-text" style="color:#6b7280;">
          Avancerad AI-baserad handelsteknik        </div>
      </div>
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          <span style="color:var(--color-primary);">💳</span>
          Insättningsmetoder        </div>
        <div class="row-text" style="color:#6b7280;">
          Betalkort, banköverföringar, PayPal-alternativ        </div>
      </div>
      <div class="row-block" style="
        display:grid;
        grid-template-columns: 1fr 2fr;
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          <span style="color:var(--color-primary);">📱</span>
          Plattformens tillgänglighet        </div>
        <div class="row-text" style="color:#6b7280;">
          Fungerar på flera enheter        </div>
      </div>
      <div class="row-block" style="
        display:grid;
        grid-template-columns: 1fr 2fr;
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          <span style="color:var(--color-primary);">📊</span>
          Tillgängliga instrument        </div>
        <div class="row-text" style="color:#6b7280;">
          Forex, aktier, kryptovalutor, råvaror och mer        </div>
      </div>
      <div class="row-block" style="
        display:grid;
        grid-template-columns: 1fr 2fr;
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          ...
          Guide till kontoöppning        </div>
        <div class="row-text" style="color:#6b7280;">
          Snabb, smidig onboarding        </div>
      </div>
      <div class="row-block" style="
        display:grid;
      ...
      ">
        <div class="customer-block" style="display:flex;gap:10px;font-weight:600;">
          <span style="color:var(--color-primary);">📞</span>
          Kundsupport          <span style="font-weight:400;color:#6b7280;margin-left:10px;">
            Professionell support dygnet runt          </span>
        </div>
...
<div class="md:border-primary-light md:rounded-[20px] md:border md:px-20 md:py-8">
  <div class="border-primary-light grid justify-items-center gap-6 rounded-[20px] border px-4 py-5 md:gap-4 md:px-8 md:py-6 text-center md:text-left">
    <h2 class="h3 flex flex-wrap items-center justify-center md:justify-start gap-x-4 gap-y-3">
      Vad <?= e(SITE_NAME) ?>-användare säger      <span class="inline-flex items-center justify-center rounded-full bg-emerald-600 px-2 py-1 text-sm leading-none text-white uppercase">
        Betrodd      </span>
    </h2>
    <div class="flex flex-wrap items-center justify-center md:justify-start gap-2.5 text-center md:text-left">
      ...
      <span class="leading-none text-amber-500" role="img"
        aria-label="4.7 Betyg (av 5)">
        ★★★★★      </span>
      <span class="flex flex-wrap justify-center md:justify-start gap-1 text-sm text-gray-400">
        <span>
          <strong>124</strong> kundomdömen ·
        </span>
        <span>
          Baserat på <strong>337</strong> betyg ·
        </span>
        <span>
          Betyg (av 5)        </span>
      </span>
    ...
    <p class="text-center md:text-left">
      En intuitiv plattform med avancerade automatiseringsverktyg och omfattande utbildningsmaterial.    </p>
  </div>
</div>
      </div>
    </section>
