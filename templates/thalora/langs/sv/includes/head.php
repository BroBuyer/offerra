...
$page_title = $page_title ?? (SITE_NAME . ' | Ledande AI-driven handelsplattform');
$page_description = $page_description ?? ('Få tillgång till kryptovalutor, forex och globala tillgångar via en och samma plattform. ' . SITE_NAME . ' kombinerar liveanalys, assisterad automatisering och expertstöd.');
...
<?php endif; ?>
  ...
  window.APP_LANG = {
    ...
    valPhoneShort: 'Numret är för kort',
    valPhoneLong: 'Numret är för långt',
    valPhoneEmpty: 'Ange ditt telefonnummer',
