        ...
        <div style="background-color: #1a1a1e !important; border-bottom: 1px solid #27272a !important; padding: 14px 18px !important; display: flex !important; align-items: center !important; justify-content: space-between !important; flex-direction: row !important;">
            <div style="display: flex !important; align-items: center !important; gap: 12px !important; flex-direction: row !important;">
                ...
                <div style="text-align: left !important;">
                    ...
                    <p style="color: #a1a1aa !important; font-size: 11px !important; margin: 0 !important; padding: 0 !important; opacity: 0.85;">Onboardingguide</p>
                </div>
            </div>
            <button id="chat-close-btn" type="button" aria-label="Stäng chatten" style="color: #a1a1aa !important; background: transparent !important; border: none !important; cursor: pointer !important; padding: 6px !important; display: flex !important; align-items: center !important; transition: color 0.2s;">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const quizLang = {
        welcome: `Hej! Jag är Olivia, din onboardingguide hos <?= e(SITE_NAME) ?>. Din åtkomst är förhandsgodkänd. Nu bygger vi din profil.`,
        q1: `Bekräfta att du bor <?= e(geo_country_in()) ?>, för att uppfylla alla lagkrav.`,
        a1_yes: `Yes, I live here now`,
        a1_no: `Nej`,
        q2: `Toppen. Välj din åldersgrupp så att vi kan rekommendera lämpliga produkter:`,
        q3: `Har du just nu ett aktivt bank- eller kreditkortskonto för att ta emot dagliga utdelningar?`,
        a3_yes: `Ja, mitt konto är aktivt`,
        a3_no: `Inte just nu`,
        q4: `Vad är din huvudsakliga inkomstkälla? Det hjälper oss att anpassa riskinställningarna.`,
        a4_1: `Anställd eller frilansare`,
        a4_2: `Sparande eller passiv inkomst`,
        a4_3: `Andra inkomsttyper`,
        q5: `Lite till! Någon från vårt team ringer mellan 11:00 och 20:00 för en kort verifiering. Kan du ta samtalet?`,
        a5_yes: `Ja, den tiden passar`,
        a5_no: `Kontakta mig snart`,
        loaderText: `Vi kontrollerar dina svar och skapar ditt säkra konto...`,
        finalTitle: `Verifiering klar! 🎉 Ditt säkra konto är redo. Följ instruktionerna nedan för att aktivera dagliga utbetalningar:`,
        processing: `Vi behandlar din förfrågan...`
    };
    ...
    function appendAgentMessage(text) {
        ...
        msg.innerHTML = `
            <div style="width: 28px; height: 28px; border-radius: 50%; border: 1px solid var(--color-primary); background-color: #27272a; display: flex; align-items: center; justify-content: center; overflow: hidden; flex-shrink: 0; margin-top: 2px;">
                <img alt="Bild på handelsplattformen" src="<?= asset('static/img/consultant.webp') ?>" width="28" height="28" decoding="async" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';" style="width:100%; height:100%; object-fit:cover;" class="cq-consultant-img">
