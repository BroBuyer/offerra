...
$page_title = 'Handelsinstrument | AI-förstärkta funktioner — ' . SITE_NAME;
$page_description = 'Använd livediagram, AI-insikter och handelsverktyg hos ' . SITE_NAME . ' med pålitlig säkerhet.';
$page_canonical = page_url("product.php");
$active_page = "product";
$schema_extra = ['breadcrumb' => schema_breadcrumb('Plattformsfunktioner', 'product.php')];
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      ...
      <span class="breadcrumb-item">Plattformsfunktioner</span>
    </nav>
  </div>
</div>
      <!-- analytics -->
  ...
  <div class="container-base grid gap-6 lg:grid-cols-2">
    ...
    >
      <h1 class="relative z-20">AI-förstärkt handel och analys</h1>
      <p class="relative z-20">
        Få omfattande marknads- och portföljinsikter med analysen hos <?= e(SITE_NAME) ?>. Realtidsdiagram, integrerade indikatorer och AI-analys för välgrundade val.      </p>
    </div>
    <div class="relative grid min-h-[355px] content-end">
      ...
      <div class="bg-before-custom relative z-30 grid grid-cols-2 gap-3 md:gap-6">
        <a class="btn btn-black col-span-full" href="<?= page_url('sign.php') ?>">Registrera</a>
        <a class="btn btn-black btn-square" href="<?= page_url('sign.php') ?>">
          <img src="<?= asset('static/img/svg/google-play.svg') ?>" alt="Hämta på Google Play" />
        </a>
        <a class="btn btn-black btn-square" href="<?= page_url('sign.php') ?>">
          <img src="<?= asset('static/img/svg/app-store.svg') ?>" alt="Ladda ner från App Store" />
        </a>
      </div>
    </div>
  </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-8 max-w-4xl">
    <p class="text-lg"><?= e(SITE_NAME) ?> ger en integrerad plattform: handelsverktyg, omfattande marknadsuppföljning och assisterad automatisering. Funktioner och dagliga fördelar nedan.</p>    <p>Plattformen ger tillgång till flera marknader — kryptovalutor, forex, aktier och råvaror — med livepriser. Hantera ordrar och risk från en samlad instrumentpanel utan att byta app.</p>    <p>Analysverktyg förenar realtidsdata och AI-insikter för att identifiera trender och tydliga rörelser. De stöder besluten; du styr strategi, volym och gränser. Gränssnittet betonar enkelhet och effektiv utförande.</p>    <p>Säkerhet och pålitlighet är grunden: krypterade anslutningar, starkt kontoskydd och tydliga insättningar. Passar både nybörjare och experter och skalar från grundbruk till avancerad handel utan att byta plattform.</p>    <div class="grid gap-6 md:grid-cols-2">
            <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-3">Marknader och handelsinstrument</h2>
        <p>Följ digitala valutor, forex, aktier och råvaror med integrerade verktyg, bevakningslistor och aviseringar. <?= e(SITE_NAME) ?> kopplar analysen till order- och portföljhantering.</p>
      </div>
                  <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-3">Transparens, säkerhet och kontroll</h2>
        <p>Säkra anslutningar, verifierade rutiner och transparenta insättningar och uttag. Avgifter visas innan bekräftelse.</p>
      </div>
          </div>
  </div>
</div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>Webbläsarbaserad handelsplattform</h2>
      <div class="grid grid-cols-2 gap-x-8 gap-y-6">
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Finansmarknader</p>
            <p>Omedelbar tillgång till alla funktioner</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Marknadsinsikter</p>
            <p>Snabb åtkomst till omfattande datahistorik</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Optimerad för mobil</p>
            <p>Smidig mobilupplevelse var du än är</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Hantering av kryptovaluta</p>
            <p>Hantera hela portföljen enkelt</p>
          </div>
        </div>
      </div>
    </div>
    <div class="flex items-center justify-center">
        ...
        <img
          ...
          alt="<?= e(SITE_NAME) ?> — handelsplattform i mobilen"
...
<div class="py-8 md:py-10">
  ...
  >
    ...
    >
      ...
      <p class="h3">Valutor som stöds</p>
    </div>
    <div
      class="rounded-custom grid content-start gap-5 border p-4 md:p-6"
    >
      <p class="h2 lowercase">42m</p>
      <p class="h3">Verifierade användare</p>
    </div>
    <div
      class="rounded-custom grid content-start gap-5 border p-4 md:p-6"
    >
      <p class="h2 lowercase"><?= e(currency_symbol()) ?>440m</p>
      <p class="h3">Transaktionsvolym</p>
    </div>
    <div
      class="rounded-custom grid content-start gap-5 border p-4 md:p-6"
    >
      <p class="h2 lowercase">100+</p>
      <p class="h3">Länder som stöds</p>
    </div>
  </div>
</div>
      <!-- capabilities -->
    ...
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Nyckelfunktioner för investering</p>
          <p>Kompetensen syns i konkreta projekt och kreativa angreppssätt.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Köpa krypto</p>
          <p>En säker, lättanvänd miljö för att köpa kryptovalutor. Snabb handläggning, låga avgifter. Börja handla direkt.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Marknadsanalys</p>
          <p>Förstå priser och trender för välgrundade investeringsbeslut.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Handel med digitala tillgångar</p>
          <p>Handla krypto-futures. Utforska, investera och bredda portföljen.</p>
        </div>
      </div>
    </div>
  </div>
...
<p class="h2">Börja nu</p>
<p>
  Utforska kryptohandel hos <?= e(SITE_NAME) ?>. Handlare i <?= e(geo_country_name()) ?> får en plattform som förenar banbrytande teknik, effektivitet och lättanvända verktyg.</p>
          </div>
