...
$page_title = 'Destek | ' . SITE_NAME;
$page_description = '' . SITE_NAME . ' ekibiyle hesaplar, yatırmalar, çekimler ve platform soruları için iletişime geçin.';
$page_canonical = page_url("contacts.php");
$active_page = "contacts";
$schema_extra = ['breadcrumb' => schema_breadcrumb('İletişim', 'contacts.php')];
...
<h1>İletişim</h1>
  <p class="lead max-w-3xl justify-self-center text-center md:text-left"><?= e(SITE_NAME) ?> ekibi hesaplar, yatırmalar, çekimler, grafikler ve yapay zekâ araçları sorularına yanıt verir. Yardım resmi kanallardan gider — kişisel yatırım önerisi veya kâr garantisi yoktur.</p>
<div class="grid gap-4 text-center md:gap-6 md:text-left max-w-3xl justify-self-center">
  <h3>Daha fazla yardım için bize yazın</h3>  <p>İletişime geçmeden önce hesap e-postanız, konu (kayıt, ödeme, teknik) ve gerekirse ekran görüntüleri hazır olsun. Ayrıntılar ne kadar netse çözüm o kadar hızlıdır.</p>  <p>Aktif işlemler veya bekleyen çekimler mümkün olduğunda önceliklidir. Güvenliğiniz için istenmeyen e-postalarla tam şifre veya 2FA kodu asla istemeyiz.</p>  <p>Henüz kaydolmadıysanız kayıt sayfasında dakikalar içinde hesap açın ve buraya dönün. Ücretler, güvenlik ve mevcut piyasalar için SSS’ye de bakın.</p>  <p>Net bir konu yazın (ör. «Bekleyen çekim», «2FA sorunu», «Ücret sorusu»). Çoğu talep birkaç saat içinde ilk yanıt alır; yoğunluk veya ödeme kontrolleri süreyi uzatabilir.</p></div>
