...
$page_title = 'Hesap açın | İşleme başlayın — ' . SITE_NAME;
$page_description = '' . SITE_NAME . ' hesabını hızlıca açın ve ileri yapay zekâ işlem özelliklerini açın.';
$page_canonical = page_url("sign.php");
$active_page = "sign";
$schema_extra = ['breadcrumb' => schema_breadcrumb('Giriş / Kayıt', 'sign.php')];
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      ...
      <span class="breadcrumb-item">Giriş / Kayıt</span>
    </nav>
  </div>
</div>
      <!-- registration-1 -->
...
<h1><?= e(SITE_NAME) ?> hesabınızı bugün açın</h1>
