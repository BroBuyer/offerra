        ...
        <div style="background-color: #1a1a1e !important; border-bottom: 1px solid #27272a !important; padding: 14px 18px !important; display: flex !important; align-items: center !important; justify-content: space-between !important; flex-direction: row !important;">
            <div style="display: flex !important; align-items: center !important; gap: 12px !important; flex-direction: row !important;">
                ...
                <div style="text-align: left !important;">
                    ...
                    <p style="color: #a1a1aa !important; font-size: 11px !important; margin: 0 !important; padding: 0 !important; opacity: 0.85;">Onboarding rehberi</p>
                </div>
            </div>
            <button id="chat-close-btn" type="button" aria-label="Sohbeti kapat" style="color: #a1a1aa !important; background: transparent !important; border: none !important; cursor: pointer !important; padding: 6px !important; display: flex !important; align-items: center !important; transition: color 0.2s;">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const quizLang = {
        welcome: `Merhaba! Ben Olivia, <?= e(SITE_NAME) ?> onboarding rehberiniz. Erişiminiz önceden onaylandı. Profilinizi oluşturalım.`,
        q1: `Lütfen <?= e(geo_country_in()) ?> ikamet ettiğinizi onaylayın; yasal gereklilikleri tam karşılamak için.`,
        a1_yes: `Yes, I live here now`,
        a1_no: `Hayır`,
        q2: `Harika. Uygun ürünler önerebilmemiz için yaş grubunuzu seçin:`,
        q3: `Günlük ödemeler için şu anda aktif bir banka veya kredi kartı hesabınız var mı?`,
        a3_yes: `Evet, hesabım aktif`,
        a3_no: `Şu anda değil`,
        q4: `Ana gelir kaynağınız nedir? Risk ayarlarını buna göre uyarlamamıza yardımcı olur.`,
        a4_1: `Çalışan veya serbest meslek`,
        a4_2: `Tasarruf veya pasif gelir`,
        a4_3: `Diğer gelir türleri`,
        q5: `Bir adım daha! Ekibimizden biri kısa doğrulama için 11:00–20:00 arasında arayacak. Aramayı alabilir misiniz?`,
        a5_yes: `Evet, bu saat uygun`,
        a5_no: `Lütfen yakında iletişime geçin`,
        loaderText: `Yanıtlarınızı kontrol ediyor ve güvenli hesabınızı oluşturuyoruz...`,
        finalTitle: `Doğrulama tamam! 🎉 Güvenli hesabınız hazır. Günlük ödemeleri açmak için aşağıdaki adımları izleyin:`,
        processing: `Talebiniz işleniyor...`
    };
    ...
    function appendAgentMessage(text) {
        ...
        msg.innerHTML = `
            <div style="width: 28px; height: 28px; border-radius: 50%; border: 1px solid var(--color-primary); background-color: #27272a; display: flex; align-items: center; justify-content: center; overflow: hidden; flex-shrink: 0; margin-top: 2px;">
                <img alt="İşlem platformu görseli" src="<?= asset('static/img/consultant.webp') ?>" width="28" height="28" decoding="async" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';" style="width:100%; height:100%; object-fit:cover;" class="cq-consultant-img">
