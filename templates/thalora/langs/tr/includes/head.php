...
$page_title = $page_title ?? (SITE_NAME . ' | Önde gelen yapay zekâ destekli işlem platformu');
$page_description = $page_description ?? ('Kripto paralar, forex ve küresel varlıklara tek bir platformdan erişin. ' . SITE_NAME . ' canlı analitik, destekli otomasyon ve uzman desteğini birleştirir.');
...
<?php endif; ?>
  ...
  window.APP_LANG = {
    ...
    valPhoneShort: 'Numara çok kısa',
    valPhoneLong: 'Numara çok uzun',
    valPhoneEmpty: 'Lütfen telefon numaranızı girin',
    valSessionExpired: 'Oturum süresi doldu. Lütfen sayfayı yenileyip tekrar deneyin.',
    valGenericError: 'Bir şeyler ters gitti. Lütfen daha sonra tekrar deneyin.',
    valConnectionError: 'Bağlantı hatası. İnternetinizi kontrol edin ve tekrar deneyin.'
  };
