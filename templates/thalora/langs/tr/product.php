...
$page_title = 'İşlem enstrümanları | Yapay zekâ destekli özellikler — ' . SITE_NAME;
$page_description = '' . SITE_NAME . ' canlı grafikleri, yapay zekâ içgörüleri ve işlem araçlarını güvenilir güvenlikle kullanın.';
$page_canonical = page_url("product.php");
$active_page = "product";
$schema_extra = ['breadcrumb' => schema_breadcrumb('Platform özellikleri', 'product.php')];
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      ...
      <span class="breadcrumb-item">Platform özellikleri</span>
    </nav>
  </div>
</div>
      <!-- analytics -->
  ...
  <div class="container-base grid gap-6 lg:grid-cols-2">
    ...
    >
      <h1 class="relative z-20">Yapay zekâ destekli işlem ve analitik</h1>
      <p class="relative z-20">
        Piyasa ve portföy içgörülerine <?= e(SITE_NAME) ?> analitiğiyle erişin. Gerçek zamanlı grafikler, entegre göstergeler ve yapay zekâ analizi bilinçli seçimler için yardımcı olur.      </p>
    </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-8 max-w-4xl">
    <p class="text-lg"><?= e(SITE_NAME) ?> entegre bir platform sunar: işlem araçları, geniş piyasa izleme ve destekli otomasyon. Özellikler ve günlük faydalar aşağıdadır.</p>    <p>Platform kripto, forex, hisse ve emtia dahil birçok piyasayı canlı fiyatlarla açar. Emirleri ve riski tek panelden yönetin, uygulama değiştirmeyin.</p>    <p>Analitik araçlar gerçek zamanlı veriyi ve yapay zekâ içgörülerini birleştirerek trendleri ve önemli hareketleri yakalar. Kararları destekler; strateji, hacim ve limitler sizde kalır. Arayüz sadelik ve verimli gerçekleştirmeye odaklanır.</p>    <p>Güvenlik ve güvenilirlik temeldir: şifreli bağlantılar, güçlü hesap koruması ve net yatırma. Yeni başlayanlara ve uzmanlara uyar; temel kullanımdan ileri işleme platform değiştirmeden ölçeklenir.</p>    <div class="grid gap-6 md:grid-cols-2">
            <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-3">Piyasalar ve işlem enstrümanları</h2>
        <p>Dijital para birimleri, forex, hisse ve emtiaları entegre araçlar, izleme listeleri ve uyarılarla takip edin. <?= e(SITE_NAME) ?> analizi emir ve portföy yönetimiyle birleştirir.</p>
      </div>
                  <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-3">Şeffaflık, güvenlik ve kontrol</h2>
        <p>Güvenli bağlantılar, doğrulanmış süreçler, şeffaf yatırma ve çekim. Ücretler onaydan önce görünür.</p>
      </div>
          </div>
  </div>
</div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>Tarayıcı tabanlı işlem platformu</h2>
      <div class="grid grid-cols-2 gap-x-8 gap-y-6">
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Finansal piyasalar</p>
            <p>Tüm özelliklere anında erişim</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Piyasa içgörüleri</p>
            <p>Kapsamlı veri geçmişine hızlı erişim</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Mobil uyumlu</p>
            <p>Her yerde akıcı mobil deneyim</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Kripto yönetimi</p>
            <p>Tüm portföyü kolayca yönetin</p>
          </div>
        </div>
      </div>
    </div>
    <div class="flex items-center justify-center">
        ...
        <img
          ...
          alt="<?= e(SITE_NAME) ?> — mobilde işlem platformu"
...
<div class="py-8 md:py-10">
  ...
  >
    ...
    >
      ...
      <p class="h3">İşlem hacmi</p>
    </div>
    <div
      class="rounded-custom grid content-start gap-5 border p-4 md:p-6"
    >
      <p class="h2 lowercase">100+</p>
      <p class="h3">Desteklenen ülkeler</p>
    </div>
  </div>
</div>
      <!-- capabilities -->
    ...
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Temel yatırım özellikleri</p>
          <p>Uzmanlık somut projeler ve yaratıcı yaklaşımlarla gösterilir.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Kripto alımı</p>
          <p>Kripto almak için güvenli, kullanıcı dostu ortam. Hızlı işlem, düşük ücretler. Hemen işleme başlayın.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Piyasa analitiği</p>
          <p>Bilinçli yatırım kararları için fiyatları ve trendleri anlayın.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Dijital varlık işlemleri</p>
          <p>Kripto vadeli işlemleri yapın. Keşfedin, yatırım yapın ve portföyü büyütün.</p>
        </div>
      </div>
    </div>
  </div>
...
<p class="h2">Şimdi başlayın</p>
<p>
  <?= e(SITE_NAME) ?> ile kripto işlemini keşfedin. <?= e(geo_country_name()) ?> yatırımcıları ileri teknoloji, verimlilik ve kullanıcı dostu araçları birleştiren bir platform bulur.</p>
          </div>
