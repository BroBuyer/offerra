...
$page_title = SITE_NAME . ' | Önde gelen yapay zekâ destekli işlem platformu';
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h1 id="heading-style-h1">Şeffaf işlem yapın. Her kararda kontrolü elinizde tutun.</h1>
            <p>Kripto paralar, forex ve küresel varlıklara tek bir platformdan erişin. <?= e(SITE_NAME) ?> canlı analitik, destekli otomasyon ve uzman desteğini birleştirerek piyasaları net araçlar ve tutarlı süreçlerle yönetmenize yardımcı olur.</p>
        </div>
...
<div class="py-8 md:py-10">
  <div class="stats-cards container-base grid gap-3 md:grid-cols-2 md:gap-6 xl:grid-cols-4">
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      ...
      <p class="h3">Desteklenen para birimleri</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase">42m</p>
      <p class="h3">Doğrulanmış kullanıcılar</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase"><?= e(currency_symbol()) ?>440m</p>
      <p class="h3">İşlem cirosu</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase">100+</p>
      <p class="h3">Hizmet verilen ülkeler</p>
    </div>
  </div>
</div>
    <!-- features -->
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 max-lg:order-2 md:gap-10">
      <h2>Neden <?= e(SITE_NAME) ?></h2>
      <p class="md:text-lg">
        Günümüz kripto yatırımcılarının tercih ettiği bu platform yeni bir standart belirler. Güçlü güvenlik, tam şeffaflık, ileri yapay zekâ ve sezgisel bir arayüzü birleştirerek güvenli işlem yapmanızı destekleriz.      </p>
        ...
        <div class="grid grid-cols-2 gap-x-8 gap-y-6 max-sm:flex">
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Güvenilir güvenlik</p>
              <p>Güçlü korumalar kişisel bilgilerinizi ve yatırımlarınızı sürekli güvende tutar.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Kişiselleştirilmiş işlem</p>
              <p>İşlem yöntemlerinizi hedeflerinize ve tercihlerinize göre uyarlayın.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Akıllı yapay zekâ çözümleri</p>
              <p>Bilinçli kararlar için doğru işlem içgörüleri.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Otomatik işlem çözümleri</p>
              <p>Yapay zekâ botları kesintisiz çalışarak daha yapılandırılmış, sinyal tabanlı yaklaşımlar sağlar.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Sezgisel arayüz</p>
              <p>İlk kullanımdan itibaren net işlem için tasarlanmış kolay arayüz.</p>
            </div>
          </div>
        </div>
      </div>
      <p class="h3">
        Finansal yolculuğunuzu güçlendirin: <?= e(SITE_NAME) ?>.
      </p>
      <a class="btn btn-black" href="<?= page_url('sign.php') ?>">Şimdi kaydolun</a>
    </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>Zahmetsiz işlem!</h2>
      <p class="text-lg">
        Bitcoin, Ethereum ve Dogecoin gibi önde gelen kripto paralarla kolay ve güvenle işlem yapın.      </p>
      <a class="btn btn-black max-md:hidden" href="<?= page_url('sign.php') ?>">Şimdi başlayın</a>
    </div>
    <div class="grid gap-3 md:gap-6" data-trading></div>
    <a class="btn btn-black md:hidden" href="<?= page_url('sign.php') ?>">Şimdi başlayın</a>
  </div>
</div>
<section class="feature-section">
  <div class="container">
    <div class="feature-header">
      <h2>
        Küresel bir işlem platformu <span>büyümek için tasarlandı</span>      </h2>
      <p>
        Hız, doğruluk ve güvenilir küresel performans için tasarlanmış tek bir sistemle birden fazla finansal piyasaya erişin.      </p>
    </div>
    <div class="feature-grid">
      <div class="feature-card">
        ...
        <p>
          Kripto, forex, hisse ve emtiaları tek platformda, uygulama değiştirmeden işlem yapın.        </p>
      </div>
      <div class="feature-card featured">
        <div class="accent"></div>
        <h3>Hızlı emir gerçekleştirmesi</h3>
        <p>
          Optimize platform, küresel piyasalarda hızlı ve güvenilir emir gerçekleştirmesi sağlar.        </p>
      </div>
      <div class="feature-card">
        <div class="accent"></div>
        <h3>Gerçek zamanlı analitik</h3>
        <p>
          Hızlı, bilinçli kararlar için canlı piyasa verileri, gelişmiş göstergeler ve içgörüler.        </p>
      </div>
    </div>
  </div>
</section>
...
<div class="py-8 md:py-10" id="how-it-works">
  <div class="container-base grid gap-6 md:gap-10">
    <div class="grid items-center gap-6 lg:grid-cols-2">
      <h2><?= e(SITE_NAME) ?> nasıl çalışır: kayıttan işleme</h2>
      <p class="rounded-custom sm:border sm:p-8">
        Altı adımlı net süreç: kayıt, doğrulama, fonlama, strateji kurulumu ve piyasa araçları. Panel süreleri, seçenekleri ve kontrolleri açıkça gösterir.      </p>
    </div>
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Hesabınızı oluşturun</p>
          <p>Temel bilgilerinizle kaydolun ve resmi <?= e(SITE_NAME) ?> platformuna güvenle erişin. Bu hızlı adım ana panele giriş sağlar.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Kimliğinizi doğrulayın</p>
          <p>Tüm özellikleri açmak için e-postanızı doğrulayın: canlı grafikler, analitik araçlar ve yapılandırılmış bir başlangıç için kaynaklar.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">İşlem platformuna girin</p>
          <p>Hesabınıza en az <?= e(money_min()) ?> yatırın. Hedeflerinize göre daha yüksek tutar seçebilirsiniz; tüm ödeme seçenekleri ve ücretler onaydan önce görünür.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Bakiye ekleyin</p>
          <p>Havale, e-cüzdan veya kart seçin. Süreler ve ücretler şeffaftır — fonlamayı siz kontrol edersiniz.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Stratejinizi belirleyin</p>
          <p>Riski, tercih ettiğiniz piyasaları ve işlem yaklaşımını ayarlayın. <?= e(SITE_NAME) ?>: yapay zekâ desteği sinyalleri ve piyasa takibini seçer, kararlarınızın yerini almaz.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Mevcut piyasaları keşfedin</p>
          <p>Hesabınız aktif ve ayarlı olduğunda canlı fiyatları izleyin, işlem planlayın ve entegre platformu kripto ve diğer varlıklar için kullanın.</p>
        </div>
      </div>
    </div>
    <div class="grid gap-6 md:grid-cols-2">
      <a class="btn btn-black" href="<?= page_url('sign.php') ?>">İşleme başlayın</a>
    </div>
  </div>
</div>
    <!-- payments -->
    <div class="py-8 md:py-10">
      <div class="container-base grid items-center gap-6 lg:grid-cols-2">
        <p class="text-lg">
          <?= e(SITE_NAME) ?> dünya genelindeki müşteriler için çeşitli ödeme yöntemlerini destekler.        </p>
        ...
        <div class="grid items-end gap-6 md:grid-cols-2">
          ...
          <div class="inline-flex justify-end gap-8 max-md:hidden">
            <button class="text-primary hover:text-primary-dark -scale-x-100 cursor-pointer transition-colors"
              data-prev="reviews" aria-label="önceki slayt">
          ...
          <div class="-ml-6">
            <div class="basis-full pl-6 md:basis-1/2">
              <div
                ...
                <p>
                  A fantastic işlem platformunun temel özellikleri is <?= e(SITE_NAME) ?>! The
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10" style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
    <div class="flex items-center justify-between gap-6 mb-6 reviews-flex-block">
      <h2 class="text-2xl font-bold">Kullanıcı yorumları</h2>
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
            <p>
              <?= e(SITE_NAME) ?> beklentilerimi aştı. Kayıt basitti, ücretler net, destek hızlı. Genel olarak güvenilir, akıcı bir platform; memnuniyetle kullanıyorum.            </p>
            <div class="flex items-center gap-4">
              <div class="initials">FE</div>
              <p class="font-bold">Döviz uzmanı</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  <?= e(SITE_NAME) ?> kripto işlemleri için seçtim ve memnunum. Başlangıç net ve şeffaftı. Özellikle yeni başlayanlar için güvenilir bir tercih.                </p>
            <div class="flex items-center gap-4">
              <div class="initials">IM</div>
              <p class="font-bold">Yatırım piyasası analisti</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  <?= e(SITE_NAME) ?> güvenilir ve tutarlı bir platform. Hesap açılışı kolaydı, koşullar şeffaf, destek bilgili. Burada işlem yapmak rahat.                </p>
            <div class="flex items-center gap-4">
              <div class="initials">OT</div>
              <p class="font-bold">Çevrimiçi yatırımcı</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Kripto işlemleri <?= e(SITE_NAME) ?> erişilebilir geliyor. Kayıt kolaydı, ücretler anlaşılır, ihtiyaç olduğunda yardım vardı. Yeni bir yatırımcı olarak gerçek bir fark hissediyorum.                </p>
            <div class="flex items-center gap-4">
              <div class="initials">FA</div>
              <p class="font-bold">Finans analisti</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="grid gap-3 md:gap-6" data-accordion>
      <div id="accordion-1" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">İşleme başlamak için hangi adımlar gerekir?</span>
        ...
        <div id="content-1" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Başlamak kolay. Temel bilgilerinizle kaydolun, e-postanızı doğrulayın ve hesabınıza en az <?= e(money_min()) ?> yatırın. Canlı grafikler, işlem araçları, piyasa analizi ve destek açılır. Deneyim gerekmez — kapsamlı eğitimler adım adım yol gösterir.</p>
          </div>
        </div>
      </div>
      <div id="accordion-2" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors"><?= e(SITE_NAME) ?> paramı ve bilgilerimi yönetmede güvenilir mi?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-2" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p><?= e(SITE_NAME) ?> platformunda veri ve fon koruması önceliktir. Oturumlar SSL ile şifrelenir, iki faktörlü kimlik doğrulama mevcuttur, gizlilik uygulamaları açıkça anlatılır. Finansal işlemler güvenilir ortaklar ve iç protokollerle yürür. Güvenilirliğe çalışırız, ancak getiri garanti edilemez.</p>
          </div>
        </div>
      </div>
      <div id="accordion-3" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Fonlarımı ne kadar sürede çekebilirim?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-3" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Çekimleri hesap portalından istediğiniz zaman talep edebilirsiniz. İşlem genellikle yönteme göre 1–3 iş günü sürer. Ücretler ve tahmini süreler onaydan önce görünür. Çekimi takip etmeniz gerekirse destek ekibi yardıma hazırdır.</p>
          </div>
        </div>
      </div>
      <div id="accordion-4" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Platformun işlem ihtiyaçlarıma uyup uymadığını nasıl anlarım?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-4" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Özellikleri tanımak için minimum yatırma ile başlamanızı öneririz. <?= e(SITE_NAME) ?> hem yeni başlayanlara hem deneyimli yatırımcılara uyar: kullanıcı dostu arayüz, isteğe bağlı yapay zekâ araçları ve 7/24 destek. Emirler, limitler ve risk üzerinde tam kontrol sizde kalır.</p>
          </div>
        </div>
      </div>
      <div id="accordion-5" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Başlamak için işlem deneyimi gerekir mi?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-5" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Önceki deneyim gerekmez. Platform baştan kullanıcı dostudur: onboarding, eğitimler ve yapay zekâ destekli araçlar. Kendi hızınızda öğrenirsiniz — temel piyasalardan ileri analiz ve otomasyona.</p>
          </div>
        </div>
      </div>
      <div id="accordion-7" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Hangi piyasalara <?= e(SITE_NAME) ?>?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-7" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Tek arayüzde önde gelen kriptoları, gerçek zamanlı forex, küresel hisseleri ve emtiaları takip edersiniz. Uygulama değiştirmeden analize ve kararlara odaklanırsınız.</p>
          </div>
        </div>
      </div>
      <div id="accordion-8" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Yapay zekâ analitiği nasıl çalışır?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-8" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p><?= e(SITE_NAME) ?> sinyalleri düzenleyen, önemli fiyat hareketlerini işaretleyen ve piyasa izlemeye yardımcı olan yapay zekâ araçları sunar. Seçiminizi destekler, stratejinin yerini almaz ve sonuç garanti etmez. Ne zaman hareket edeceğinize ve ne kadar ayıracağınıza siz karar verirsiniz.</p>
          </div>
        </div>
      </div>
      <div id="accordion-9" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Kayıttan ilk işleme genellikle ne kadar sürer?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-9" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Hesap açılışı ve doğrulama genellikle birkaç dakika sürer. İlk işleme kadar geçen süre yatırmaya ve ödeme yöntemine bağlıdır. Ana sayfa gizli adım olmadan net bir adım adım rehber gösterir.</p>
          </div>
        </div>
      </div>
      <div id="accordion-10" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Hesap soruları için destek var mı?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-10" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Ekip, hesap erişimi, yatırma, çekim veya özellikler için İletişim veya SSS üzerinden ulaşılabilir. Yardım operasyoneldir, yatırım tavsiyesi değildir.</p>
          </div>
        </div>
      </div>
      <div id="accordion-6" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Platform hakkında</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-6" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p style="margin-bottom:16px;"><?= e(SITE_NAME) ?> tutarlı performans, hızlı gerçekleşme ve tam kontrol isteyen kullanıcılar için uluslararası bir işlem platformudur. Ayrı hizmetler yerine temel özellikleri tek bir akışta birleştirir.</p>
            <p style="margin-bottom:16px;">Piyasa erişiminden emir gerçekleştirmeye ve analize her öğe sürtünmesiz çalışır. Kararlara odaklanırsınız, araç değiştirmeye değil.</p>
            <p style="margin-bottom:10px; font-weight:500;">Tek platformda birden fazla finansal piyasada işlem yapın:</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Önde gelen ve yükselen kripto paralar</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Canlı fiyatlı forex piyasaları</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Küresel hisseler ve hisse opsiyonları</li>
              <li><span style="color:var(--color-primary);">•</span> Fırsatları genişleten emtialar</li>
            </ul>
            <p style="margin-bottom:16px;">Performans önceliklidir. Sistem düşük gecikme ve yoğun saatlerde güvenilir çalışma için optimize edilmiştir; fiyatlara teknik gecikme olmadan tepki verirsiniz.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Piyasalarda hızlı, güvenilir emir işleme</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Sürekli piyasa veri akışı</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Önceden yüklü analitik ve piyasa göstergeleri</li>
              <li><span style="color:var(--color-primary);">•</span> Manuel ve otomatik işlem</li>
            </ul>
            <p style="margin-bottom:16px;">Güvenlik ve operasyonel güvenilirlik her düzeyde önceliktir. Platform sektör standartlarını tutar ve kullanıcı bilgileri ile finansal faaliyetleri sürekli korur.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Tam şifreli veri iletişimi</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Kimlik doğrulama ve çok katmanlı güvenlik protokolleri</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> İzlenen ve doğrulanan işlem süreçleri</li>
              <li><span style="color:var(--color-primary);">•</span> Güvenilir küresel bağlantı için tasarlanmış altyapı</li>
            </ul>
            <p style="margin-bottom:16px;">Kullanıcı deneyimi eşit ağırlıktadır. Tasarım kasıtlı olarak sade ve sezgiseldir; yatırımcı stratejiye odaklanır.</p>
            <p style="margin-bottom:16px;">Sağlam işlev ve sadelik karışımı <?= e(SITE_NAME) ?> hem yeni başlayanlar hem deneyimli yatırımcılar için ideal kılar. Başlayanlar dik öğrenme eğrisi olmadan hızlanır; ileri kullanıcılar karmaşık taktikler için esnekliği korur.</p>
            <p><?= e(SITE_NAME) ?> tek platformda ölçeklenebilirlik, güvenilirlik ve yüksek performans sunar — uluslararası finansal piyasalara güvenli, düzenli erişim.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h2>Düzenlenmiş bir platformda işlem yapın™</h2>
          <p>
            Kripto paraların güvenli alımı, satımı ve yönetiminde bireysel yatırımcılar ve şirketlerin güveni.          </p>
        </div>
  ...
  <section style="padding:60px 0;" class="md:!py-[100px]">
    ...
    ">
      ...
      ">
        ...
        ">
          <span style='color:var(--color-primary);'><?= e(SITE_NAME) ?> işlem platformunun temel özellikleri</span>        </h2>
      <p style="margin-top:14px;color:#6b7280;font-size:17px;">
        İşlem hızını, doğruluğunu ve güveni artıran işlevler.      </p>
    </div>
    <div style="
      border-radius:16px;
      overflow:hidden;
    ...
    ">
      ...
      " onmouseover="this.style.background='#f9f9fb'" class="row-block" onmouseout="this.style.background='transparent'">
        ...
        <div class="row-text" style="color:#6b7280;">
          İleri yapay zekâ tabanlı işlem teknolojisi        </div>
      </div>
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          <span style="color:var(--color-primary);">💳</span>
          Yatırma yöntemleri        </div>
        <div class="row-text" style="color:#6b7280;">
          Kartlar, havaleler, PayPal seçenekleri        </div>
      </div>
      <div class="row-block" style="
        display:grid;
        grid-template-columns: 1fr 2fr;
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          <span style="color:var(--color-primary);">📱</span>
          Platform erişimi        </div>
        <div class="row-text" style="color:#6b7280;">
          Birden fazla cihazda çalışır        </div>
      </div>
      <div class="row-block" style="
        display:grid;
        grid-template-columns: 1fr 2fr;
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          <span style="color:var(--color-primary);">📊</span>
          Mevcut enstrümanlar        </div>
        <div class="row-text" style="color:#6b7280;">
          Forex, hisseler, kripto paralar, emtialar ve daha fazlası        </div>
      </div>
      <div class="row-block" style="
        display:grid;
        grid-template-columns: 1fr 2fr;
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          ...
          Hesap açılış rehberi        </div>
        <div class="row-text" style="color:#6b7280;">
          Hızlı, sorunsuz onboarding        </div>
      </div>
      <div class="row-block" style="
        display:grid;
      ...
      ">
        <div class="customer-block" style="display:flex;gap:10px;font-weight:600;">
          <span style="color:var(--color-primary);">📞</span>
          Müşteri desteği          <span style="font-weight:400;color:#6b7280;margin-left:10px;">
            7/24 profesyonel destek          </span>
        </div>
...
<div class="md:border-primary-light md:rounded-[20px] md:border md:px-20 md:py-8">
  <div class="border-primary-light grid justify-items-center gap-6 rounded-[20px] border px-4 py-5 md:gap-4 md:px-8 md:py-6 text-center md:text-left">
    <h2 class="h3 flex flex-wrap items-center justify-center md:justify-start gap-x-4 gap-y-3">
      <?= e(SITE_NAME) ?> kullanıcıları ne diyor      <span class="inline-flex items-center justify-center rounded-full bg-emerald-600 px-2 py-1 text-sm leading-none text-white uppercase">
        Güvenilir      </span>
    </h2>
    <div class="flex flex-wrap items-center justify-center md:justify-start gap-2.5 text-center md:text-left">
      ...
      <span class="leading-none text-amber-500" role="img"
        aria-label="4.7 Puan (5 üzerinden)">
        ★★★★★      </span>
      <span class="flex flex-wrap justify-center md:justify-start gap-1 text-sm text-gray-400">
        <span>
          <strong>124</strong> müşteri yorumu ·
        </span>
        <span>
          Kaynak: <strong>337</strong> değerlendirme ·
        </span>
        <span>
          Puan (5 üzerinden)        </span>
      </span>
    </div>
    <p class="text-center md:text-left">
      İleri otomasyon araçları ve zengin eğitim materyalleri içeren sezgisel bir işlem platformu.    </p>
  </div>
</div>
      </div>
    </section>
