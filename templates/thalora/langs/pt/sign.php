...
$page_title = 'Abre a tua conta | Começa a operar com ' . SITE_NAME;
$page_description = 'Abre depressa a tua conta ' . SITE_NAME . ' para desbloquear funções de trading com IA avançadas.';
$page_canonical = page_url("sign.php");
$active_page = "sign";
$schema_extra = ['breadcrumb' => schema_breadcrumb('Entrar / Registar', 'sign.php')];
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      ...
      <span class="breadcrumb-item">Entrar / Registar</span>
    </nav>
  </div>
</div>
      <!-- registration-1 -->
...
<h1>Abre a tua conta <?= e(SITE_NAME) ?> hoje</h1>
<h2>Opera numa plataforma regulamentada™</h2>
<p>
  A confiança de traders particulares e empresas para comprar, vender e gerir criptomoedas com segurança.</p>
          </div>
