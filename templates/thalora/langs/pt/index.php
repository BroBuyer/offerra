...
$page_title = SITE_NAME . ' | Plataforma de trading com IA de primeiro nível';
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h1 id="heading-style-h1">Opera com transparência. Mantém o controlo de cada decisão.</h1>
            <p>Acede a criptomoedas, forex e ativos globais a partir de uma só plataforma. <?= e(SITE_NAME) ?> combina análise em direto, automatização assistida e suporte especializado para te ajudar a navegar nos mercados com ferramentas claras e processos constantes.</p>
        </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 max-lg:order-2 md:gap-10">
      <h2>Porquê escolher <?= e(SITE_NAME) ?></h2>
      <p class="md:text-lg">
        Preferida pelos traders de cripto de hoje, esta plataforma define um novo padrão. Unimos segurança sólida, transparência total, IA avançada e uma interface intuitiva para um trading com confiança.      </p>
        ...
        <div class="grid grid-cols-2 gap-x-8 gap-y-6 max-sm:flex">
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Segurança fiável</p>
              <p>Proteções sólidas resguardam de forma contínua os teus dados pessoais e os teus investimentos.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              ...
              <p>Adapta os teus métodos de trading aos teus objetivos e preferências.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Soluções de IA inteligentes</p>
              <p>Insights de trading precisos para decisões informadas.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Soluções de trading automatizado</p>
              <p>Bots com IA operam de forma contínua para abordagens de trading mais estruturadas, guiadas por sinais.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Interface intuitiva</p>
              <p>Uma interface simples, pensada para operar com clareza desde o primeiro uso.</p>
            </div>
          </div>
        </div>
      </div>
      <p class="h3">
        Impulsiona o teu percurso financeiro com <?= e(SITE_NAME) ?>.
      </p>
      <a class="btn btn-black" href="<?= page_url('sign.php') ?>">Regista-te agora</a>
    </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>Trading sem esforço!</h2>
      <p class="text-lg">
        Opera as principais criptomoedas como Bitcoin, Ethereum e Dogecoin, com facilidade e confiança.      </p>
      <a class="btn btn-black max-md:hidden" href="<?= page_url('sign.php') ?>">Começa agora</a>
    </div>
    <div class="grid gap-3 md:gap-6" data-trading></div>
    <a class="btn btn-black md:hidden" href="<?= page_url('sign.php') ?>">Começa agora</a>
  </div>
</div>
<section class="feature-section">
  <div class="container">
    <div class="feature-header">
      <h2>
        Uma plataforma de trading global <span>feita para crescer</span>      </h2>
      <p>
        Acede a vários mercados financeiros com um sistema pensado para velocidade, precisão e um desempenho global fiável.      </p>
    </div>
    <div class="feature-grid">
      <div class="feature-card">
        <div class="accent"></div>
        <h3>Acesso a vários mercados</h3>
        <p>
          Opera criptomoedas, forex, ações e matérias-primas numa só plataforma, sem mudar de app.        </p>
      </div>
      <div class="feature-card featured">
        <div class="accent"></div>
        <h3>Execução rápida de ordens</h3>
        <p>
          Uma plataforma otimizada para uma execução rápida e fiável das ordens nos mercados globais.        </p>
      </div>
      <div class="feature-card">
        <div class="accent"></div>
        <h3>Análise em tempo real</h3>
        <p>
          Dados de mercado em direto, indicadores avançados e insights para decidir rápido e com informação.        </p>
      </div>
    </div>
  </div>
</section>
...
<div class="py-8 md:py-10" id="how-it-works">
  <div class="container-base grid gap-6 md:gap-10">
    <div class="grid items-center gap-6 lg:grid-cols-2">
      <h2>Como funciona o <?= e(SITE_NAME) ?>: do registo ao trading</h2>
      <p class="rounded-custom sm:border sm:p-8">
        Um processo em seis passos: registo, verificação, depósito, configuração da estratégia e uso das ferramentas de mercado. O painel mostra com clareza prazos, opções e controlos.      </p>
    </div>
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Cria a tua conta</p>
          <p>Regista-te com os teus dados básicos para acederes de forma segura à plataforma oficial <?= e(SITE_NAME) ?>. Este passo rápido abre o teu painel principal.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Confirma a tua identidade</p>
          <p>Confirma o teu e-mail para desbloquear todas as funções: gráficos em direto, ferramentas de análise e recursos para um início estruturado.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Acede à tua plataforma de trading</p>
          <p>Deposita na tua conta pelo menos <?= e(money_min()) ?>. Podes escolher um montante maior consoante os teus objetivos; todas as opções de pagamento e os encargos aparecem antes de confirmares.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Adicionar fundos</p>
          <p>Escolhe transferência bancária, carteira eletrónica ou cartão. Os prazos e as comissões são transparentes, para controlares o depósito.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Define a tua estratégia</p>
          <p>Ajusta o risco, os mercados preferidos e a tua abordagem de trading. <?= e(SITE_NAME) ?>: o suporte de IA seleciona sinais e acompanhamento de mercado sem substituir as tuas decisões.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Explora os mercados disponíveis</p>
          <p>Quando a conta estiver ativa e configurada, segue os preços em direto, planeia operações e usa a plataforma integrada para criptomoedas e outros ativos.</p>
        </div>
      </div>
    </div>
    <div class="grid gap-6 md:grid-cols-2">
      <a class="btn btn-black" href="<?= page_url('sign.php') ?>">Começa a operar</a>
    </div>
  </div>
</div>
    <!-- payments -->
    <div class="py-8 md:py-10">
      <div class="container-base grid items-center gap-6 lg:grid-cols-2">
        <p class="text-lg">
          <?= e(SITE_NAME) ?> admite vários métodos de pagamento para clientes em todo o mundo.        </p>
        ...
        <div class="grid items-end gap-6 md:grid-cols-2">
          ...
          <div class="inline-flex justify-end gap-8 max-md:hidden">
            <button class="text-primary hover:text-primary-dark -scale-x-100 cursor-pointer transition-colors"
              data-prev="reviews" aria-label="diapositivo anterior">
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10" style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
    <div class="flex items-center justify-between gap-6 mb-6 reviews-flex-block">
      <h2 class="text-2xl font-bold">Opiniões de utilizadores</h2>
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
            <p>
              <?= e(SITE_NAME) ?> superou as minhas expectativas. O registo foi simples, as comissões são claras e o suporte é rápido. No conjunto, uma plataforma fiável e fluida que uso com gosto.            </p>
            <div class="flex items-center gap-4">
              <div class="initials">FE</div>
              <p class="font-bold">Especialista em câmbios</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Escolhi <?= e(SITE_NAME) ?> para trading de cripto e estou satisfeito. A abertura foi simples e transparente. Uma opção de confiança, sobretudo para quem começa.                </p>
            <div class="flex items-center gap-4">
              <div class="initials">IM</div>
              <p class="font-bold">Analista de mercados de investimento</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Encontro <?= e(SITE_NAME) ?> uma plataforma fiável e constante. Abrir a conta foi fácil, os termos são transparentes e o suporte, competente. Operar aqui é cómodo.                </p>
            <div class="flex items-center gap-4">
        ...
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Operar criptomoedas com <?= e(SITE_NAME) ?> é acessível. O registo foi fácil, as comissões compreensíveis e a ajuda disponível quando é preciso. Como trader novo, fez a diferença.                </p>
            <div class="flex items-center gap-4">
              <div class="initials">FA</div>
              <p class="font-bold">Analista financeiro</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="grid gap-3 md:gap-6" data-accordion>
      <div id="accordion-1" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Quais são os passos para começar a operar?</span>
        ...
        <div id="content-1" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>É simples. Regista-te com os teus dados essenciais, confirma o e-mail e deposita na conta um mínimo de <?= e(money_min()) ?>. Assim desbloqueias todas as funções: gráficos em direto, ferramentas de trading, análise de mercado e suporte dedicado. Não é preciso experiência: tutoriais completos guiam-te em cada passo.</p>
          </div>
        </div>
      </div>
      <div id="accordion-2" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">O <?= e(SITE_NAME) ?> é fiável para gerir o meu dinheiro e a minha informação?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-2" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>No <?= e(SITE_NAME) ?> a proteção de dados e fundos é uma prioridade. As sessões vão cifradas com SSL, há autenticação de dois fatores e as práticas de privacidade explicam-se com clareza. As transações financeiras passam por parceiros de confiança e protocolos internos. Procuramos fiabilidade, mas os rendimentos não podem ser garantidos.</p>
          </div>
        </div>
      </div>
      <div id="accordion-3" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Quanto demora um levantamento de fundos?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-3" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Os levantamentos podem ser pedidos a qualquer momento no portal da conta. O processamento costuma demorar 1 a 3 dias úteis, consoante o método. Comissões e prazos estimados aparecem antes de confirmares. Se precisares de acompanhamento, a equipa de suporte está disponível.</p>
          </div>
        </div>
      </div>
      <div id="accordion-4" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Como sei se esta plataforma se adequa às minhas necessidades de trading?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-4" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Recomendamos começar com o depósito mínimo para conheceres as funções. <?= e(SITE_NAME) ?> serve tanto principiantes como traders com experiência, com uma interface simples, ferramentas de IA opcionais e suporte 24/7. Conservas o controlo total de ordens, limites e definições de risco.</p>
          </div>
        </div>
      </div>
      <div id="accordion-5" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">É preciso experiência em trading para começar?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-5" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Não é preciso experiência prévia. A plataforma é simples desde o início, com onboarding, tutoriais e ferramentas potenciadas por IA. Aprendes ao teu ritmo: dos mercados de base até análise e automatização mais avançadas.</p>
          </div>
        </div>
      </div>
      <div id="accordion-7" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Que mercados posso seguir com <?= e(SITE_NAME) ?>?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-7" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Numa só interface segues as principais criptomoedas, o forex em tempo real, ações globais e matérias-primas. Sem saltar entre apps: concentras-te na análise e nas decisões.</p>
          </div>
        </div>
      </div>
      <div id="accordion-8" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Como funciona a análise de IA?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-8" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p><?= e(SITE_NAME) ?> oferece ferramentas de IA que organizam sinais, marcam movimentos de preço relevantes e ajudam no acompanhamento. Apoiam as tuas decisões, sem substituir a estratégia nem garantir um resultado. Tu decides quando agir e quanto atribuir.</p>
          </div>
        </div>
      </div>
      <div id="accordion-9" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Quanto costuma passar do registo à primeira operação?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-9" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Abrir a conta e verificá-la costuma levar só alguns minutos. O tempo até à primeira operação depende do depósito e do método de pagamento. A página inicial mostra um guia claro, sem passos ocultos.</p>
          </div>
        </div>
      </div>
      <div id="accordion-10" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Há suporte para questões da conta?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-10" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>A equipa está disponível em Contacto ou nas FAQ para acesso à conta, depósitos, levantamentos ou funções. A ajuda é operativa, não aconselhamento de investimento.</p>
          </div>
        </div>
      </div>
      <div id="accordion-6" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Sobre a plataforma</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-6" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p style="margin-bottom:16px;"><?= e(SITE_NAME) ?> é uma plataforma internacional pensada para um desempenho constante, execução rápida e controlo total do ambiente de trading. Em vez de vários serviços, reúne as funções-chave num só fluxo.</p>
            <p style="margin-bottom:16px;">Do acesso ao mercado à execução e à análise, cada elemento está pensado para funcionar sem fricção. Concentras-te nas decisões, não em mudar de ferramenta.</p>
            <p style="margin-bottom:10px; font-weight:500;">Opera em vários mercados financeiros a partir de uma só plataforma:</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Criptomoedas principais e emergentes</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Mercados forex com preços em direto</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Ações globais e opções sobre ações</li>
              <li><span style="color:var(--color-primary);">•</span> Matérias-primas para diversificar oportunidades</li>
            </ul>
            <p style="margin-bottom:16px;">O desempenho é prioritário. O sistema está otimizado para uma execução de baixa latência e um funcionamento fiável em momentos de elevada atividade, para reagir aos preços sem atrasos técnicos.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Processamento rápido e fiável de ordens nos mercados</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Fluxo contínuo de dados de mercado</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Análise e indicadores de mercado pré-instalados</li>
              <li><span style="color:var(--color-primary);">•</span> Trading manual e automatizado</li>
            </ul>
            <p style="margin-bottom:16px;">A segurança e a fiabilidade operativa são prioridade em todos os níveis. A plataforma segue padrões do setor e protege de forma contínua a informação e as operações financeiras.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Comunicação de dados cifrada</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Verificação de identidade e protocolos de segurança em várias camadas</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Processos de transação supervisionados e validados</li>
              <li><span style="color:var(--color-primary);">•</span> Infraestrutura desenhada para uma conectividade global fiável</li>
            </ul>
            <p style="margin-bottom:16px;">Damos o mesmo peso à experiência de utilização. O design é deliberadamente simples e intuitivo, para que o trader se centre na estratégia.</p>
            <p style="margin-bottom:16px;">Esta mistura de funções sólidas e simplicidade faz com que <?= e(SITE_NAME) ?> seja ideal para principiantes e traders com experiência. Quem começa avança rápido, sem uma curva de aprendizagem demasiado dura; os perfis avançados continuam livres para táticas complexas.</p>
            <p><?= e(SITE_NAME) ?> oferece escalabilidade, fiabilidade e elevado desempenho numa só plataforma, para um acesso seguro e organizado aos mercados financeiros internacionais.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <section style="padding:60px 0;" class="md:!py-[100px]">
    ...
    ">
      ...
      ">
        ...
        ">
          Funções-chave da <span style='color:var(--color-primary);'><?= e(SITE_NAME) ?> plataforma de trading</span>        </h2>
      <p style="margin-top:14px;color:#6b7280;font-size:17px;">
        Funções pensadas para ganhares em velocidade, precisão e confiança.      </p>
    </div>
    <div style="
      border-radius:16px;
      overflow:hidden;
    ...
    ">
      ...
      " onmouseover="this.style.background='#f9f9fb'" class="row-block" onmouseout="this.style.background='transparent'">
        <div style="display:flex;align-items:center;gap:10px;font-weight:600;">
          ...
          Enquadramento técnico        </div>
        <div class="row-text" style="color:#6b7280;">
          Tecnologia de trading avançada baseada em IA        </div>
      </div>
      ...
      ">
        ...
        <div class="row-text" style="color:#6b7280;">
          Cartões, transferências, opções PayPal        </div>
      </div>
      <div class="row-block" style="
        display:grid;
        grid-template-columns: 1fr 2fr;
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          <span style="color:var(--color-primary);">📱</span>
          Acessibilidade da plataforma        </div>
        <div class="row-text" style="color:#6b7280;">
          Funciona em vários dispositivos        </div>
      </div>
      <div class="row-block" style="
        display:grid;
        grid-template-columns: 1fr 2fr;
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          <span style="color:var(--color-primary);">📊</span>
          Instrumentos disponíveis        </div>
        <div class="row-text" style="color:#6b7280;">
          Forex, ações, criptomoedas, matérias-primas e mais        </div>
      </div>
      <div class="row-block" style="
        display:grid;
        grid-template-columns: 1fr 2fr;
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          ...
          Guia de abertura de conta        </div>
        <div class="row-text" style="color:#6b7280;">
          Onboarding rápido e fluido        </div>
      </div>
      <div class="row-block" style="
        display:grid;
      ...
      ">
        <div class="customer-block" style="display:flex;gap:10px;font-weight:600;">
          <span style="color:var(--color-primary);">📞</span>
          Apoio ao cliente          <span style="font-weight:400;color:#6b7280;margin-left:10px;">
            Suporte profissional 24/7          </span>
        </div>
...
<div class="md:border-primary-light md:rounded-[20px] md:border md:px-20 md:py-8">
  <div class="border-primary-light grid justify-items-center gap-6 rounded-[20px] border px-4 py-5 md:gap-4 md:px-8 md:py-6 text-center md:text-left">
    <h2 class="h3 flex flex-wrap items-center justify-center md:justify-start gap-x-4 gap-y-3">
      O que dizem os utilizadores do <?= e(SITE_NAME) ?>      <span class="inline-flex items-center justify-center rounded-full bg-emerald-600 px-2 py-1 text-sm leading-none text-white uppercase">
        De confiança      </span>
    </h2>
    <div class="flex flex-wrap items-center justify-center md:justify-start gap-2.5 text-center md:text-left">
      ...
      <span class="leading-none text-amber-500" role="img"
        aria-label="4.7 Pontuação (em 5)">
        ★★★★★      </span>
      <span class="flex flex-wrap justify-center md:justify-start gap-1 text-sm text-gray-400">
        <span>
          <strong>124</strong> avaliações de clientes ·
        </span>
        <span>
          Com base em <strong>337</strong> classificações ·
        </span>
        <span>
          Pontuação (em 5)        </span>
      </span>
    ...
    <p class="text-center md:text-left">
      Uma plataforma intuitiva, com ferramentas de automatização avançadas e muitos recursos formativos.    </p>
  </div>
</div>
      </div>
    </section>
