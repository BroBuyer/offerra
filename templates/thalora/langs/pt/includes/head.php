...
$page_title = $page_title ?? (SITE_NAME . ' | Plataforma de trading com IA de primeiro nível');
$page_description = $page_description ?? ('Acede a criptomoedas, forex e ativos globais a partir de uma só plataforma. ' . SITE_NAME . ' combina análise em direto, automatização assistida e suporte especializado.');
...
<?php endif; ?>
  ...
  <script>
  window.APP_LANG = {
    valPhoneInvalid: 'Introduz um número de telefone válido',
    valPhoneCountry: 'Código de país inválido',
    valPhoneShort: 'O número é demasiado curto',
    valPhoneLong: 'O número é demasiado longo',
    valPhoneEmpty: 'Introduz o teu número de telefone',
    valSessionExpired: 'A sessão expirou. Recarrega a página e tenta novamente.',
    valGenericError: 'Algo correu mal. Tenta novamente mais tarde.',
    valConnectionError: 'Erro de ligação. Verifica a tua ligação à internet e tenta novamente.'
  };
