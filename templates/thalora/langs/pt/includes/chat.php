        ...
        <div style="background-color: #1a1a1e !important; border-bottom: 1px solid #27272a !important; padding: 14px 18px !important; display: flex !important; align-items: center !important; justify-content: space-between !important; flex-direction: row !important;">
            <div style="display: flex !important; align-items: center !important; gap: 12px !important; flex-direction: row !important;">
                ...
                <div style="text-align: left !important;">
                    ...
                    <p style="color: #a1a1aa !important; font-size: 11px !important; margin: 0 !important; padding: 0 !important; opacity: 0.85;">Guia de onboarding</p>
                </div>
            </div>
            <button id="chat-close-btn" type="button" aria-label="Fechar o chat" style="color: #a1a1aa !important; background: transparent !important; border: none !important; cursor: pointer !important; padding: 6px !important; display: flex !important; align-items: center !important; transition: color 0.2s;">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const quizLang = {
        welcome: `Olá! Sou a Olivia, a tua guia de onboarding de <?= e(SITE_NAME) ?>. O teu acesso está pré-aprovado. Vamos criar o teu perfil.`,
        q1: `Confirma que resides <?= e(geo_country_in()) ?> para cumprir plenamente os requisitos legais.`,
        a1_yes: `Yes, I live here now`,
        a1_no: `Não`,
        q2: `Perfeito. Escolhe a tua faixa etária para te recomendarmos produtos adequados:`,
        q3: `Tens agora uma conta bancária ou um cartão de crédito ativo para receber pagamentos diários?`,
        a3_yes: `Sim, a minha conta está ativa`,
        a3_no: `Agora não`,
        q4: `Qual é a tua principal fonte de rendimento? Ajuda-nos a adaptar as definições de risco.`,
        a4_1: `Empregado ou freelancer`,
        a4_2: `Poupanças ou rendimentos passivos`,
        a4_3: `Outros tipos de rendimento`,
        q5: `Só mais um momento! Alguém da equipa liga-te entre as 11:00 e as 20:00 para uma verificação breve. Consegues atender a chamada?`,
        a5_yes: `Sim, esse horário serve-me`,
        a5_no: `Contactem-me em breve`,
        loaderText: `A verificar as tuas respostas e a criar a tua conta segura...`,
        finalTitle: `Verificação concluída! 🎉 A tua conta segura está pronta. Segue as instruções abaixo para ativares os pagamentos diários:`,
        processing: `A processar o teu pedido...`
    };
    ...
    function appendAgentMessage(text) {
        ...
        msg.innerHTML = `
            <div style="width: 28px; height: 28px; border-radius: 50%; border: 1px solid var(--color-primary); background-color: #27272a; display: flex; align-items: center; justify-content: center; overflow: hidden; flex-shrink: 0; margin-top: 2px;">
                <img alt="Imagem da plataforma de trading" src="<?= asset('static/img/consultant.webp') ?>" width="28" height="28" decoding="async" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';" style="width:100%; height:100%; object-fit:cover;" class="cq-consultant-img">
