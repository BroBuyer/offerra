    ...
    <div class="container-base">
      <div class="relative grid gap-7 md:gap-10">
        <div class="grid gap-5">
          <nav class="flex flex-col flex-wrap justify-between gap-x-10 gap-y-5 text-white md:flex-row">
            ...
            <ul class="flex flex-col gap-x-5 gap-y-4 md:flex-row md:gap-x-7 lg:gap-x-12">
              ...
              <li><a href="<?= page_url('about.php') ?>">Quem somos</a></li>
            </ul>
            <ul class="flex flex-col gap-x-5 gap-y-4 md:flex-row">
              <li><a href="<?= page_url('privacy.php') ?>">Aviso de privacidade</a></li>
              <li><a href="<?= page_url('conditions.php') ?>">Termos e condições</a></li>
            </ul>
          </nav>
          <div class="flex justify-between gap-5">
            <div class="grid gap-5 text-white">
              <p style="color:var(--color-primary);">O teu parceiro de trading de confiança</p>
        ...
        <div class="grid gap-2.5 text-sm text-gray-500">
            <p>
                <?= e(SITE_NAME) ?> não aceita responsabilidade por perdas ou danos decorrentes do uso da informação deste site, incluindo conteúdos formativos, preços, gráficos ou análises. O trading de instrumentos financeiros envolve um risco elevado; avalia a tua situação. Consulta um consultor antes de operares. Investe só capital que possas perder: forex, CFD e criptomoedas não são adequados para todos os investidores.
            </p>
        </div>
