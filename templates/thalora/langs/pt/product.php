...
$page_title = 'Instrumentos de trading | Funções potenciadas por IA — ' . SITE_NAME;
$page_description = 'Usa os gráficos em direto, os insights de IA e as ferramentas de trading de ' . SITE_NAME . ', com uma segurança de confiança.';
$page_canonical = page_url("product.php");
$active_page = "product";
$schema_extra = ['breadcrumb' => schema_breadcrumb('Funções da plataforma', 'product.php')];
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      <a href="<?= page_url() ?>" class="breadcrumb-item">Página inicial</a>
      <span class="breadcrumb-item">Funções da plataforma</span>
    </nav>
  </div>
</div>
      <!-- analytics -->
  ...
  <div class="container-base grid gap-6 lg:grid-cols-2">
    ...
    >
      <h1 class="relative z-20">Trading e análise potenciados por IA</h1>
      <p class="relative z-20">
        Acede a insights de mercado e de carteira com a análise de <?= e(SITE_NAME) ?>. Gráficos em tempo real, indicadores integrados e análise de IA para decisões informadas.      </p>
    </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-8 max-w-4xl">
    <p class="text-lg"><?= e(SITE_NAME) ?> oferece uma plataforma integrada: ferramentas de trading, acompanhamento amplo de mercado e automatização assistida. Descobre as funções e vantagens diárias mais abaixo.</p>    <p>A plataforma dá acesso a vários mercados — criptomoedas, forex, ações e matérias-primas — com preços em direto. Gere ordens e risco a partir de um só painel, sem saltar de uma app para outra.</p>    <p>As ferramentas de análise unem dados em tempo real e insights de IA para detetar tendências e movimentos relevantes. Apoiam as decisões; tu controlas estratégia, volumes e limites. A interface procura simplicidade e uma execução eficiente.</p>    <p>A segurança e a fiabilidade são a base: ligações cifradas, proteções de conta sólidas e depósitos claros. Serve principiantes e especialistas, e escala do uso básico ao trading avançado sem mudar de plataforma.</p>    <div class="grid gap-6 md:grid-cols-2">
            <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-3">Mercados e instrumentos de trading</h2>
        <p>Segue moedas digitais, forex, ações e matérias-primas com ferramentas integradas, listas de acompanhamento e alertas. <?= e(SITE_NAME) ?> liga a análise à gestão de ordens e de carteira.</p>
      </div>
                  <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-3">Transparência, segurança e controlo</h2>
        <p>Ligações seguras, procedimentos verificados, depósitos e levantamentos transparentes. As comissões veem-se antes de confirmares.</p>
      </div>
          </div>
  </div>
</div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>Plataforma de trading no browser</h2>
      <div class="grid grid-cols-2 gap-x-8 gap-y-6">
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Mercados financeiros</p>
            <p>Acesso imediato a todas as funções</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            ...
            <p>Acesso rápido a históricos de dados completos</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Otimizada para telemóvel</p>
            <p>Uma experiência móvel fluida, onde estiveres</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Gestão de criptomoedas</p>
            <p>Gere toda a carteira de forma simples</p>
          </div>
        </div>
      </div>
    </div>
    <div class="flex items-center justify-center">
        ...
        <img
          ...
          alt="<?= e(SITE_NAME) ?> — plataforma de trading no telemóvel"
...
<div class="py-8 md:py-10">
  ...
  >
    ...
    >
      ...
      <p class="h3">Moedas suportadas</p>
    </div>
    <div
      class="rounded-custom grid content-start gap-5 border p-4 md:p-6"
    >
      <p class="h2 lowercase">42m</p>
      <p class="h3">Utilizadores verificados</p>
    </div>
    <div
      class="rounded-custom grid content-start gap-5 border p-4 md:p-6"
    >
      <p class="h2 lowercase"><?= e(currency_symbol()) ?>440m</p>
      <p class="h3">Volume de transações</p>
    </div>
    <div
      class="rounded-custom grid content-start gap-5 border p-4 md:p-6"
    >
      <p class="h2 lowercase">100+</p>
      <p class="h3">Países suportados</p>
    </div>
  </div>
</div>
      <!-- capabilities -->
    ...
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Funções-chave de investimento</p>
          <p>Experiência aplicada em projetos concretos e abordagens criativas.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          ...
          <p>Um ambiente seguro e simples para comprar criptomoedas. Processamento rápido, comissões baixas. Começa a operar já.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Análise de mercado</p>
          <p>Compreende preços e tendências para decisões de investimento informadas.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Trading de ativos digitais</p>
          <p>Opera futuros de criptomoedas. Explora, investe e desenvolve a carteira.</p>
        </div>
      </div>
    </div>
  </div>
...
<p class="h2">Começa agora</p>
<p>
  Explora o trading de cripto com <?= e(SITE_NAME) ?>. Os traders de <?= e(geo_country_name()) ?> encontram uma plataforma que une tecnologia avançada, eficiência e ferramentas fáceis de usar.</p>
          </div>
