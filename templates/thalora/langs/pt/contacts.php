...
$page_title = 'Suporte | Assistência da equipa ' . SITE_NAME;
$page_description = 'Contacta a equipa ' . SITE_NAME . ' para contas, depósitos, levantamentos e questões da plataforma.';
...
<h1>Contacto</h1>
  <p class="lead max-w-3xl justify-self-center text-center md:text-left">A equipa do <?= e(SITE_NAME) ?> responde a questões sobre contas, depósitos, levantamentos, gráficos e ferramentas de IA. A assistência passa por canais oficiais — sem recomendações de investimento personalizadas nem garantias de lucro.</p>
<div class="grid gap-4 text-center md:gap-6 md:text-left max-w-3xl justify-self-center">
  <h3>Escreve-nos para mais ajuda</h3>  <p>Antes de nos escreveres, tem à mão o e-mail da conta, o tema (registo, pagamento, técnico) e capturas se aplicável. Quanto mais claros forem os detalhes, mais rápida é a resolução.</p>  <p>Os pedidos sobre operações ativas ou levantamentos pendentes têm prioridade quando possível. Por segurança nunca pediremos a palavra-passe completa nem códigos 2FA por e-mails não solicitados.</p>  <p>Se ainda não te registaste, abre uma conta em minutos na página de registo e volta aqui. Consulta também as FAQ para comissões, segurança e mercados disponíveis.</p>  <p>Indica um assunto claro (p. ex. «Levantamento pendente», «Problema 2FA», «Questão de comissões»). A maioria das questões recebe uma primeira resposta em poucas horas; um volume alto ou verificações de pagamento podem alongar os prazos.</p></div>
