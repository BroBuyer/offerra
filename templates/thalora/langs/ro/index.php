...
$page_title = SITE_NAME . ' | Platformă de tranzacționare de top, bazată pe AI';
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h1 id="heading-style-h1">Tranzacționați transparent. Păstrați controlul asupra fiecărei decizii.</h1>
            <p>Accesați criptomonede, forex și active globale dintr-o singură platformă. <?= e(SITE_NAME) ?> combină analitica live, automatizarea asistată și suportul de specialitate, ca să navigați piețele cu instrumente clare și procese consecvente.</p>
        </div>
...
<div class="py-8 md:py-10">
  <div class="stats-cards container-base grid gap-3 md:grid-cols-2 md:gap-6 xl:grid-cols-4">
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      ...
      <p class="h3">Monede acceptate</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase">42m</p>
      <p class="h3">Utilizatori verificați</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase"><?= e(currency_symbol()) ?>440m</p>
      <p class="h3">Cifră de afaceri a tranzacțiilor</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase">100+</p>
      <p class="h3">Țări deservite</p>
    </div>
  </div>
</div>
    <!-- features -->
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 max-lg:order-2 md:gap-10">
      <h2>De ce să alegeți <?= e(SITE_NAME) ?></h2>
      <p class="md:text-lg">
        Preferată de traderii crypto de azi, această platformă stabilește un nou standard. Combinăm securitate solidă, transparență deplină, AI avansat și o interfață intuitivă pentru tranzacționare cu încredere.      </p>
        ...
        <div class="grid grid-cols-2 gap-x-8 gap-y-6 max-sm:flex">
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Securitate de încredere</p>
              <p>Măsuri solide protejează continuu datele personale și investițiile.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Tranzacționare personalizată</p>
              <p>Adaptați metodele de tranzacționare la obiectivele și preferințele dvs.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Soluții AI inteligente</p>
              <p>Perspective precise de tranzacționare pentru decizii informate.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Soluții de tranzacționare automatizată</p>
              <p>Boții bazați pe AI rulează non-stop și permit o abordare mai structurată, bazată pe semnale.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Interfață intuitivă</p>
              <p>O interfață simplă, gândită pentru tranzacționare clară de la primul pas.</p>
            </div>
          </div>
        </div>
      </div>
      <p class="h3">
        Consolidați-vă parcursul financiar cu <?= e(SITE_NAME) ?>.
      </p>
      <a class="btn btn-black" href="<?= page_url('sign.php') ?>">Înregistrați-vă acum</a>
    </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>Tranzacționare fără efort!</h2>
      <p class="text-lg">
        Tranzacționați criptomonede de top precum Bitcoin, Ethereum și Dogecoin — simplu și cu încredere.      </p>
      <a class="btn btn-black max-md:hidden" href="<?= page_url('sign.php') ?>">Începeți acum</a>
    </div>
    <div class="grid gap-3 md:gap-6" data-trading></div>
    <a class="btn btn-black md:hidden" href="<?= page_url('sign.php') ?>">Începeți acum</a>
  </div>
</div>
<section class="feature-section">
  <div class="container">
    <div class="feature-header">
      <h2>
        O platformă globală de tranzacționare <span>construită pentru creștere</span>      </h2>
      <p>
        Accesați mai multe piețe financiare printr-un sistem gândit pentru viteză, precizie și performanță globală de încredere.      </p>
    </div>
    <div class="feature-grid">
      <div class="feature-card">
        <div class="accent"></div>
        <h3>Acces la mai multe piețe</h3>
        <p>
          Tranzacționați criptomonede, forex, acțiuni și mărfuri pe o singură platformă, fără a schimba aplicațiile.        </p>
      </div>
      <div class="feature-card featured">
        <div class="accent"></div>
        <h3>Executare rapidă a ordinelor</h3>
        <p>
          Platformă optimizată pentru executare rapidă și de încredere a ordinelor pe piețele globale.        </p>
      </div>
      <div class="feature-card">
        <div class="accent"></div>
        <h3>Analitică în timp real</h3>
        <p>
          Date live, indicatori avansați și perspective pentru decizii rapide și informate.        </p>
      </div>
    </div>
  </div>
</section>
...
<div class="py-8 md:py-10" id="how-it-works">
  <div class="container-base grid gap-6 md:gap-10">
    <div class="grid items-center gap-6 lg:grid-cols-2">
      <h2>Cum funcționează <?= e(SITE_NAME) ?>: de la înregistrare la tranzacționare</h2>
      <p class="rounded-custom sm:border sm:p-8">
        Un proces clar în șase pași: înregistrare, verificare, depunere, configurarea strategiei și folosirea instrumentelor de piață. Panoul arată clar termenele, opțiunile și controalele.      </p>
    </div>
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Creați-vă contul</p>
          <p>Înregistrați-vă cu datele de bază pentru acces sigur la platforma oficială <?= e(SITE_NAME) ?>. Acest pas rapid deschide panoul principal.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Confirmați identitatea</p>
          <p>Confirmați e-mailul pentru a debloca toate funcțiile: grafice live, instrumente analitice și resurse pentru un început structurat.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Accesați platforma de tranzacționare</p>
          <p>Alimentați contul cu cel puțin <?= e(money_min()) ?>. Puteți alege o sumă mai mare în funcție de obiective; toate opțiunile de plată și taxele sunt vizibile înainte de confirmare.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Adăugați fonduri</p>
          <p>Alegeți transfer bancar, e-portofel sau card. Duratele și taxele sunt transparente — depunerea rămâne sub controlul dvs.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Definiți strategia</p>
          <p>Ajustați riscul, piețele preferate și abordarea de tranzacționare. <?= e(SITE_NAME) ?>: suportul AI selectează semnale și urmărirea pieței, fără a înlocui alegerile dvs.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Explorați piețele disponibile</p>
          <p>Când contul este activ și configurat, urmăriți prețurile live, planificați tranzacții și folosiți platforma integrată pentru crypto și alte active.</p>
        </div>
      </div>
    </div>
    <div class="grid gap-6 md:grid-cols-2">
      <a class="btn btn-black" href="<?= page_url('sign.php') ?>">Începeți tranzacționarea</a>
    </div>
  </div>
</div>
    <!-- payments -->
    <div class="py-8 md:py-10">
      <div class="container-base grid items-center gap-6 lg:grid-cols-2">
        <p class="text-lg">
          <?= e(SITE_NAME) ?> acceptă diverse metode de plată pentru clienți din întreaga lume.        </p>
        ...
        <div class="grid items-end gap-6 md:grid-cols-2">
          ...
          <div class="inline-flex justify-end gap-8 max-md:hidden">
            <button class="text-primary hover:text-primary-dark -scale-x-100 cursor-pointer transition-colors"
              data-prev="reviews" aria-label="diapozitivul anterior">
          ...
          <div class="-ml-6">
            <div class="basis-full pl-6 md:basis-1/2">
              <div
                ...
                <p>
                  A fantastic is <?= e(SITE_NAME) ?>! The
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10" style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
    <div class="flex items-center justify-between gap-6 mb-6 reviews-flex-block">
      <h2 class="text-2xl font-bold">Recenzii ale utilizatorilor</h2>
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
            <p>
              <?= e(SITE_NAME) ?> a depășit așteptările. Înregistrarea a fost simplă, taxele clare, suportul prompt. Per total, o platformă de încredere și fluidă, pe care o folosesc cu plăcere.            </p>
            <div class="flex items-center gap-4">
              <div class="initials">FE</div>
              <p class="font-bold">Specialist în schimb valutar</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Am ales <?= e(SITE_NAME) ?> pentru tranzacționare crypto și sunt mulțumit. Începutul a fost clar și transparent. O alegere de încredere, mai ales pentru începători.                </p>
            <div class="flex items-center gap-4">
              <div class="initials">IM</div>
              <p class="font-bold">Analist al piețelor de investiții</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Consider <?= e(SITE_NAME) ?> ca o platformă de încredere și consecventă. Deschiderea contului a fost ușoară, termenii transparenți, suportul competent. Tranzacționarea aici este confortabilă.                </p>
            <div class="flex items-center gap-4">
        ...
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Tranzacționarea criptomonedelor cu <?= e(SITE_NAME) ?> accesibilă. Înregistrarea a fost ușoară, taxele clare, ajutorul disponibil când e nevoie. Ca trader nou, face o diferență reală.                </p>
            <div class="flex items-center gap-4">
              <div class="initials">FA</div>
              <p class="font-bold">Analist financiar</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="grid gap-3 md:gap-6" data-accordion>
      <div id="accordion-1" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Care sunt pașii pentru a începe tranzacționarea?</span>
        ...
        <div id="content-1" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Începutul e simplu. Înregistrați-vă cu datele esențiale, confirmați e-mailul și alimentați contul cu cel puțin <?= e(money_min()) ?>. Deblocați toate funcțiile: grafice live, instrumente de tranzacționare, analiză de piață și suport. Nu e nevoie de experiență — ghidurile complete vă conduc pas cu pas.</p>
          </div>
        </div>
      </div>
      <div id="accordion-2" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Este <?= e(SITE_NAME) ?> de încredere pentru gestionarea banilor și a datelor mele?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-2" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>La <?= e(SITE_NAME) ?>, protecția datelor și a fondurilor este prioritară. Sesiunile sunt criptate SSL, autentificarea în doi pași este disponibilă, iar practicile de confidențialitate sunt descrise clar. Tranzacțiile financiare trec prin parteneri de încredere și protocoale interne. Urmărim fiabilitatea, dar randamentele nu pot fi garantate.</p>
          </div>
        </div>
      </div>
      <div id="accordion-3" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Cât de curând pot retrage fondurile?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-3" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Retragerile se pot solicita oricând din portalul contului. Procesarea durează de obicei 1–3 zile lucrătoare, în funcție de metodă. Taxele și termenele estimate sunt vizibile înainte de confirmare. Dacă aveți nevoie să urmăriți o retragere, echipa de suport este disponibilă.</p>
          </div>
        </div>
      </div>
      <div id="accordion-4" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Cum știu dacă platforma se potrivește nevoilor mele de tranzacționare?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-4" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Recomandăm să începeți cu depozitul minim, ca să cunoașteți funcțiile. <?= e(SITE_NAME) ?> se potrivește începătorilor și traderilor experimentați: interfață simplă, instrumente AI opționale și suport 24/7. Păstrați controlul deplin asupra ordinelor, limitelor și riscului.</p>
          </div>
        </div>
      </div>
      <div id="accordion-5" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Este necesară experiență de tranzacționare înainte de a începe?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-5" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Nu e nevoie de experiență anterioară. Platforma e simplă de la început: onboarding, ghiduri și instrumente îmbunătățite cu AI. Învățați în ritmul dvs. — de la piețele de bază la analiză avansată și automatizare.</p>
          </div>
        </div>
      </div>
      <div id="accordion-7" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Ce piețe pot urmări cu <?= e(SITE_NAME) ?>?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-7" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Într-o singură interfață urmăriți criptomonede de top, forex în timp real, acțiuni globale și mărfuri. Fără a schimba aplicațiile, vă concentrați pe analiză și decizii.</p>
          </div>
        </div>
      </div>
      <div id="accordion-8" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Cum funcționează analitica AI?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-8" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p><?= e(SITE_NAME) ?> oferă instrumente AI care organizează semnalele, marchează mișcări notabile de preț și ajută la urmărirea pieței. Sprijină alegerile dvs., fără a înlocui strategia sau a garanta un rezultat. Dvs. decideți când acționați și cât alocați.</p>
          </div>
        </div>
      </div>
      <div id="accordion-9" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Cât durează de obicei de la înregistrare până la prima tranzacție?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-9" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Deschiderea și verificarea contului durează de obicei câteva minute. Timpul până la prima tranzacție depinde de depunere și de metoda de plată. Pagina principală arată un ghid clar, pas cu pas, fără etape ascunse.</p>
          </div>
        </div>
      </div>
      <div id="accordion-10" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Există suport pentru întrebări legate de cont?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-10" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Echipa este disponibilă prin Contact sau FAQ pentru acces la cont, depuneri, retrageri sau funcții. Ajutorul este operațional, nu consiliere de investiții.</p>
          </div>
        </div>
      </div>
      <div id="accordion-6" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Despre platformă</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-6" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p style="margin-bottom:16px;"><?= e(SITE_NAME) ?> este o platformă internațională de tranzacționare pentru utilizatori care vor performanță consecventă, execuție rapidă și control deplin al mediului. În loc de servicii separate, integrează funcțiile cheie într-un singur flux.</p>
            <p style="margin-bottom:16px;">De la accesul pe piață la execuție și analiză, fiecare element funcționează fără fricțiune. Vă concentrați pe decizii, nu pe schimbarea instrumentului.</p>
            <p style="margin-bottom:10px; font-weight:500;">Tranzacționați pe mai multe piețe financiare dintr-o singură platformă:</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Criptomonede de top și emergente</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Piețe forex cu prețuri live</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Acțiuni globale și opțiuni pe acțiuni</li>
              <li><span style="color:var(--color-primary);">•</span> Mărfuri pentru a lărgi oportunitățile</li>
            </ul>
            <p style="margin-bottom:16px;">Performanța este prioritară. Sistemul e optimizat pentru latență redusă și funcționare de încredere la vârf, ca să reacționați la prețuri fără întârzieri tehnice.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Procesare rapidă și de încredere a ordinelor pe piețe</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Flux continuu de date de piață</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Analitică preinstalată și indicatori de piață</li>
              <li><span style="color:var(--color-primary);">•</span> Tranzacționare manuală și automatizată</li>
            </ul>
            <p style="margin-bottom:16px;">Securitatea și fiabilitatea operațională sunt priorități la toate nivelurile. Platforma respectă standardele industriei și protejează informațiile și activitățile financiare în permanență.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Comunicare de date complet criptată</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Verificare a identității și protocoale de securitate pe mai multe straturi</li>
              <li style="margin-bottom:8px;"><span style="color:var(--color-primary);">•</span> Procese de tranzacții monitorizate și validate</li>
              <li><span style="color:var(--color-primary);">•</span> Infrastructură gândită pentru conectivitate globală de încredere</li>
            </ul>
            <p style="margin-bottom:16px;">Experiența utilizatorului are aceeași greutate. Designul e intenționat simplu și intuitiv, ca traderul să se concentreze pe strategie.</p>
            <p style="margin-bottom:16px;">Această combinație de funcții solide și simplitate face <?= e(SITE_NAME) ?> ideală pentru începători și traderi experimentați. Cine începe prinde ritmul rapid, fără o curbă de învățare abruptă; utilizatorii avansați păstrează libertatea pentru tactici complexe.</p>
            <p><?= e(SITE_NAME) ?> oferă scalabilitate, fiabilitate și performanță ridicată pe o singură platformă — pentru acces sigur și organizat la piețele financiare internaționale.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h2>Tranzacționați pe o platformă reglementată™</h2>
          <p>
            De încredere pentru traderi individuali și companii la cumpărarea, vânzarea și gestionarea sigură a criptomonedelor.          </p>
        </div>
  ...
  <section style="padding:60px 0;" class="md:!py-[100px]">
    ...
    ">
      ...
      ">
        ...
        ">
          Funcții cheie ale platformei de tranzacționare <span style='color:var(--color-primary);'><?= e(SITE_NAME) ?></span>        </h2>
      <p style="margin-top:14px;color:#6b7280;font-size:17px;">
        Funcții care cresc viteza, precizia și încrederea în tranzacționare.      </p>
    </div>
    <div style="
      border-radius:16px;
      overflow:hidden;
    ...
    ">
      ...
      " onmouseover="this.style.background='#f9f9fb'" class="row-block" onmouseout="this.style.background='transparent'">
        ...
        <div class="row-text" style="color:#6b7280;">
          Tehnologie avansată de tranzacționare bazată pe AI        </div>
      </div>
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          <span style="color:var(--color-primary);">💳</span>
          Metode de depunere        </div>
        <div class="row-text" style="color:#6b7280;">
          Carduri, transferuri, opțiuni PayPal        </div>
      </div>
      <div class="row-block" style="
        display:grid;
        grid-template-columns: 1fr 2fr;
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          <span style="color:var(--color-primary);">📱</span>
          Accesibilitatea platformei        </div>
        <div class="row-text" style="color:#6b7280;">
          Funcționează pe mai multe dispozitive        </div>
      </div>
      <div class="row-block" style="
        display:grid;
        grid-template-columns: 1fr 2fr;
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          <span style="color:var(--color-primary);">📊</span>
          Instrumente disponibile        </div>
        <div class="row-text" style="color:#6b7280;">
          Forex, acțiuni, criptomonede, mărfuri și altele        </div>
      </div>
      <div class="row-block" style="
        display:grid;
        grid-template-columns: 1fr 2fr;
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          ...
          Ghid de deschidere a contului        </div>
        <div class="row-text" style="color:#6b7280;">
          Onboarding rapid și fluid        </div>
      </div>
      <div class="row-block" style="
        display:grid;
      ...
      ">
        <div class="customer-block" style="display:flex;gap:10px;font-weight:600;">
          <span style="color:var(--color-primary);">📞</span>
          Suport clienți          <span style="font-weight:400;color:#6b7280;margin-left:10px;">
            Suport profesional 24/7          </span>
        </div>
...
<div class="md:border-primary-light md:rounded-[20px] md:border md:px-20 md:py-8">
  <div class="border-primary-light grid justify-items-center gap-6 rounded-[20px] border px-4 py-5 md:gap-4 md:px-8 md:py-6 text-center md:text-left">
    <h2 class="h3 flex flex-wrap items-center justify-center md:justify-start gap-x-4 gap-y-3">
      Ce spun utilizatorii <?= e(SITE_NAME) ?>      <span class="inline-flex items-center justify-center rounded-full bg-emerald-600 px-2 py-1 text-sm leading-none text-white uppercase">
        De încredere      </span>
    </h2>
    <div class="flex flex-wrap items-center justify-center md:justify-start gap-2.5 text-center md:text-left">
      ...
      <span class="leading-none text-amber-500" role="img"
        aria-label="4.7 Scor (din 5)">
        ★★★★★      </span>
      <span class="flex flex-wrap justify-center md:justify-start gap-1 text-sm text-gray-400">
        <span>
          <strong>124</strong> recenzii ale clienților ·
        </span>
        <span>
          Pe baza a <strong>337</strong> evaluări ·
        </span>
        <span>
          Scor (din 5)        </span>
      </span>
    ...
    <p class="text-center md:text-left">
      O platformă intuitivă cu instrumente avansate de automatizare și resurse educaționale ample.    </p>
  </div>
</div>
      </div>
    </section>
