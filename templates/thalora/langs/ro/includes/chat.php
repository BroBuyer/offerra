        ...
        <div style="background-color: #1a1a1e !important; border-bottom: 1px solid #27272a !important; padding: 14px 18px !important; display: flex !important; align-items: center !important; justify-content: space-between !important; flex-direction: row !important;">
            <div style="display: flex !important; align-items: center !important; gap: 12px !important; flex-direction: row !important;">
                ...
                <div style="text-align: left !important;">
                    ...
                    <p style="color: #a1a1aa !important; font-size: 11px !important; margin: 0 !important; padding: 0 !important; opacity: 0.85;">Ghid de onboarding</p>
                </div>
            </div>
            <button id="chat-close-btn" type="button" aria-label="Închide chatul" style="color: #a1a1aa !important; background: transparent !important; border: none !important; cursor: pointer !important; padding: 6px !important; display: flex !important; align-items: center !important; transition: color 0.2s;">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const quizLang = {
        welcome: `Salut! Sunt Olivia, ghidul tău de onboarding la <?= e(SITE_NAME) ?>. Accesul tău este preaprobat. Hai să construim profilul.`,
        q1: `Confirmă că locuiești <?= e(geo_country_in()) ?>, pentru a îndeplini pe deplin cerințele legale.`,
        a1_yes: `Yes, I live here now`,
        a1_no: `Nu`,
        q2: `Excelent. Selectează grupa de vârstă, ca să putem recomanda produse potrivite:`,
        q3: `Ai momentan un cont bancar sau de card activ pentru plăți zilnice?`,
        a3_yes: `Da, contul meu este activ`,
        a3_no: `Nu momentan`,
        q4: `Care este principala ta sursă de venit? Ne ajută să adaptăm setările de risc.`,
        a4_1: `Angajat sau freelancer`,
        a4_2: `Economii sau venit pasiv`,
        a4_3: `Alte tipuri de venit`,
        q5: `Încă puțin! Cineva din echipă te va suna între 11:00 și 20:00 pentru o verificare scurtă. Poți prelua apelul?`,
        a5_yes: `Da, intervalul mi se potrivește`,
        a5_no: `Contactează-mă curând`,
        loaderText: `Verificăm răspunsurile și creăm contul tău securizat...`,
        finalTitle: `Verificare finalizată! 🎉 Contul tău securizat este gata. Urmează instrucțiunile de mai jos pentru a activa plățile zilnice:`,
        processing: `Procesăm cererea ta...`
    };
    ...
    function appendAgentMessage(text) {
        ...
        msg.innerHTML = `
            <div style="width: 28px; height: 28px; border-radius: 50%; border: 1px solid var(--color-primary); background-color: #27272a; display: flex; align-items: center; justify-content: center; overflow: hidden; flex-shrink: 0; margin-top: 2px;">
                <img alt="Imagine a platformei de tranzacționare" src="<?= asset('static/img/consultant.webp') ?>" width="28" height="28" decoding="async" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';" style="width:100%; height:100%; object-fit:cover;" class="cq-consultant-img">
