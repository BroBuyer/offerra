...
$page_title = $page_title ?? (SITE_NAME . ' | Platformă de tranzacționare de top, bazată pe AI');
$page_description = $page_description ?? ('Accesați criptomonede, forex și active globale dintr-o singură platformă. ' . SITE_NAME . ' combină analitica live, automatizarea asistată și suportul de specialitate.');
...
<?php endif; ?>
  ...
  window.APP_LANG = {
    ...
    valPhoneShort: 'Numărul este prea scurt',
    valPhoneLong: 'Numărul este prea lung',
    valPhoneEmpty: 'Introduceți numărul de telefon',
    ...
    valConnectionError: 'Eroare de conexiune. Verificați internetul și încercați din nou.'
  };
