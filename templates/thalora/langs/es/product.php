...
$page_title = 'Instrumentos de trading | Funciones potenciadas por IA — ' . SITE_NAME;
$page_description = 'Usa los gráficos en vivo, los insights de IA y las herramientas de trading de ' . SITE_NAME . ', con una seguridad de confianza.';
$page_canonical = page_url("product.php");
$active_page = "product";
$schema_extra = ['breadcrumb' => schema_breadcrumb('Funciones de la plataforma', 'product.php')];
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      <a href="<?= page_url() ?>" class="breadcrumb-item">Página de inicio</a>
      <span class="breadcrumb-item">Funciones de la plataforma</span>
    </nav>
  </div>
</div>
      <!-- analytics -->
  ...
  <div class="container-base grid gap-6 lg:grid-cols-2">
    ...
    >
      <h1 class="relative z-20">Trading y analítica potenciados por IA</h1>
      <p class="relative z-20">
        Accede a insights de mercado y de cartera con el análisis de <?= e(SITE_NAME) ?>. Gráficos en tiempo real, indicadores integrados y análisis de IA para decisiones informadas.      </p>
    </div>
    <div class="relative grid min-h-[355px] content-end">
      ...
      <div class="bg-before-custom relative z-30 grid grid-cols-2 gap-3 md:gap-6">
        <a class="btn btn-black col-span-full" href="<?= page_url('sign.php') ?>">Registrarse</a>
        <a class="btn btn-black btn-square" href="<?= page_url('sign.php') ?>">
          <img src="<?= asset('static/img/svg/google-play.svg') ?>" alt="Disponible en Google Play" />
        </a>
        <a class="btn btn-black btn-square" href="<?= page_url('sign.php') ?>">
          <img src="<?= asset('static/img/svg/app-store.svg') ?>" alt="Descárgalo en App Store" />
        </a>
      </div>
    </div>
  </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-8 max-w-4xl">
    <p class="text-lg"><?= e(SITE_NAME) ?> ofrece una plataforma integrada: herramientas de trading, seguimiento amplio de mercado y automatización asistida. Descubre las funciones y ventajas diarias más abajo.</p>    <p>La plataforma da acceso a varios mercados — criptomonedas, forex, acciones y materias primas — con precios en vivo. Gestiona órdenes y riesgo desde un solo panel, sin saltar de una app a otra.</p>    <p>Las herramientas de análisis unen datos en tiempo real e insights de IA para detectar tendencias y movimientos relevantes. Apoyan las decisiones; tú controlas estrategia, volúmenes y límites. La interfaz busca simplicidad y una ejecución eficiente.</p>    <p>La seguridad y la fiabilidad son la base: conexiones cifradas, protecciones de cuenta sólidas y depósitos claros. Sirve a principiantes y expertos, y escala del uso básico al trading avanzado sin cambiar de plataforma.</p>    <div class="grid gap-6 md:grid-cols-2">
            <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-3">Mercados e instrumentos de trading</h2>
        <p>Sigue divisas digitales, forex, acciones y materias primas con herramientas integradas, listas de seguimiento y alertas. <?= e(SITE_NAME) ?> conecta el análisis con la gestión de órdenes y de cartera.</p>
      </div>
                  <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-3">Transparencia, seguridad y control</h2>
        <p>Conexiones seguras, procedimientos verificados, depósitos y retiros transparentes. Las comisiones se ven antes de confirmar.</p>
      </div>
          </div>
  </div>
</div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>Plataforma de trading en el navegador</h2>
      <div class="grid grid-cols-2 gap-x-8 gap-y-6">
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Mercados financieros</p>
        ...
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Insights de mercado</p>
            <p>Acceso rápido a históricos de datos completos</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Optimizada para móvil</p>
            <p>Una experiencia móvil fluida, donde sea</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Gestión de criptomonedas</p>
            <p>Gestiona toda la cartera de forma sencilla</p>
          </div>
        </div>
      </div>
    </div>
    <div class="flex items-center justify-center">
        ...
        <img
          ...
          alt="<?= e(SITE_NAME) ?> — plataforma de trading en móvil"
    ...
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Funciones clave de inversión</p>
          <p>Experiencia aplicada en proyectos concretos y enfoques creativos.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Compra de cripto</p>
          <p>Un entorno seguro y sencillo para comprar criptomonedas. Procesamiento rápido, comisiones bajas. Empieza a operar ya.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Analítica de mercado</p>
          <p>Comprende precios y tendencias para decisiones de inversión informadas.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Trading de activos digitales</p>
          <p>Opera futuros de criptomonedas. Explora, invierte y desarrolla la cartera.</p>
        </div>
      </div>
    </div>
  </div>
...
<p class="h2">Empieza ahora</p>
<p>
  Explora el trading de cripto con <?= e(SITE_NAME) ?>. Los traders de <?= e(geo_country_name()) ?> encuentran una plataforma que une tecnología avanzada, eficiencia y herramientas fáciles de usar.</p>
          </div>
