...
$page_title = 'Abre tu cuenta | Empieza a operar con ' . SITE_NAME;
$page_description = 'Abre rápido tu cuenta ' . SITE_NAME . ' para desbloquear funciones de trading con IA avanzadas.';
$page_canonical = page_url("sign.php");
$active_page = "sign";
$schema_extra = ['breadcrumb' => schema_breadcrumb('Acceder / Registrarse', 'sign.php')];
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      ...
      <span class="breadcrumb-item">Acceder / Registrarse</span>
    </nav>
  </div>
</div>
      <!-- registration-1 -->
...
<h1>Abre tu cuenta <?= e(SITE_NAME) ?> hoy</h1>
