        ...
        <div style="background-color: #1a1a1e !important; border-bottom: 1px solid #27272a !important; padding: 14px 18px !important; display: flex !important; align-items: center !important; justify-content: space-between !important; flex-direction: row !important;">
            <div style="display: flex !important; align-items: center !important; gap: 12px !important; flex-direction: row !important;">
                ...
                <div style="text-align: left !important;">
                    ...
                    <p style="color: #a1a1aa !important; font-size: 11px !important; margin: 0 !important; padding: 0 !important; opacity: 0.85;">Guía de onboarding</p>
                </div>
            </div>
            <button id="chat-close-btn" type="button" aria-label="Cerrar el chat" style="color: #a1a1aa !important; background: transparent !important; border: none !important; cursor: pointer !important; padding: 6px !important; display: flex !important; align-items: center !important; transition: color 0.2s;">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const quizLang = {
        welcome: `¡Hola! Soy Olivia, tu guía de onboarding de <?= e(SITE_NAME) ?>. Tu acceso está preaprobado. Empecemos a crear tu perfil.`,
        q1: `Confirma que resides <?= e(geo_country_in()) ?> para cumplir plenamente los requisitos legales.`,
        a1_yes: `Sí, vivo aquí actualmente`,
        a1_no: `No`,
        q2: `Perfecto. Elige tu franja de edad para recomendarte productos adecuados:`,
        q3: `¿Tienes ahora una cuenta bancaria o una tarjeta de crédito activa para recibir pagos diarios?`,
        a3_yes: `Sí, mi cuenta está activa`,
        a3_no: `Ahora no`,
        q4: `¿Cuál es tu principal fuente de ingresos? Nos ayuda a adaptar los ajustes de riesgo.`,
        a4_1: `Empleado o autónomo`,
        a4_2: `Ahorros o rentas pasivas`,
        a4_3: `Otros tipos de ingresos`,
        q5: `¡Un momento más! Alguien del equipo te llamará entre las 11:00 y las 20:00 para una verificación breve. ¿Podrás atender la llamada?`,
        a5_yes: `Sí, ese horario me va bien`,
        a5_no: `Contactadme pronto`,
        loaderText: `Comprobando tus respuestas y creando tu cuenta segura...`,
        finalTitle: `¡Verificación completada! 🎉 Tu cuenta segura está lista. Sigue las instrucciones de abajo para activar los pagos diarios:`,
    ...
    function appendAgentMessage(text) {
        ...
        msg.innerHTML = `
            <div style="width: 28px; height: 28px; border-radius: 50%; border: 1px solid var(--color-primary); background-color: #27272a; display: flex; align-items: center; justify-content: center; overflow: hidden; flex-shrink: 0; margin-top: 2px;">
                <img alt="Imagen de la plataforma de trading" src="<?= asset('static/img/consultant.webp') ?>" width="28" height="28" decoding="async" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';" style="width:100%; height:100%; object-fit:cover;" class="cq-consultant-img">
