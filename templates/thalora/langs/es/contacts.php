...
$page_title = 'Soporte | Asistencia del equipo ' . SITE_NAME;
$page_description = 'Contacta con el equipo ' . SITE_NAME . ' para cuentas, depósitos, retiros y consultas de la plataforma.';
$page_canonical = page_url("contacts.php");
$active_page = "contacts";
$schema_extra = ['breadcrumb' => schema_breadcrumb('Contacto', 'contacts.php')];
      ...
      <div class="pt-5">
        <div class="container-base">
          ...
          >
            ...
            <span class="breadcrumb-item">Contacto</span>
          </nav>
        </div>
      </div>
      <!-- contact -->
...
<h1>Contacto</h1>
  <p class="lead max-w-3xl justify-self-center text-center md:text-left">El equipo de <?= e(SITE_NAME) ?> responde a consultas sobre cuentas, depósitos, retiros, gráficos y herramientas de IA. La asistencia pasa por canales oficiales — sin recomendaciones de inversión personalizadas ni garantías de beneficio.</p>
<div class="grid gap-4 text-center md:gap-6 md:text-left max-w-3xl justify-self-center">
  <h3>Escríbenos para más ayuda</h3>  <p>Antes de escribirnos, ten a mano el correo de la cuenta, el tema (registro, pago, técnico) y capturas si aplica. Cuanto más claros sean los detalles, más rápida es la resolución.</p>  <p>Las solicitudes sobre operaciones activas o retiros pendientes tienen prioridad cuando es posible. Por tu seguridad nunca pediremos la contraseña completa ni códigos 2FA por correos no solicitados.</p>  <p>Si aún no te has registrado, abre una cuenta en minutos desde la página de alta y vuelve aquí. Consulta también las FAQ para comisiones, seguridad y mercados disponibles.</p>  <p>Indica un asunto claro (p. ej. «Retiro pendiente», «Problema 2FA», «Consulta de comisiones»). La mayoría de las consultas recibe una primera respuesta en pocas horas; un volumen alto o comprobaciones de pago pueden alargar los plazos.</p></div>
