...
$page_title = 'Támogatás | Segítség a(z) ' . SITE_NAME;
$page_description = 'Lépjen kapcsolatba a(z) ' . SITE_NAME . ' csapatával fiókok, feltöltések, kifizetések és platformkérdések ügyében.';
$page_canonical = page_url("contacts.php");
$active_page = "contacts";
$schema_extra = ['breadcrumb' => schema_breadcrumb('Kapcsolat', 'contacts.php')];
      ...
      <div class="pt-5">
        <div class="container-base">
          ...
          >
            ...
            <span class="breadcrumb-item">Kapcsolat</span>
          </nav>
        </div>
      </div>
      <!-- contact -->
...
<h1>Kapcsolat</h1>
  <p class="lead max-w-3xl justify-self-center text-center md:text-left">A(z) <?= e(SITE_NAME) ?> csapata fiókok, feltöltések, kifizetések, grafikonok és MI-eszközök kérdéseire válaszol. A segítség hivatalos csatornákon megy — személyes befektetési ajánlás vagy nyereségígéret nélkül.</p>
<div class="grid gap-4 text-center md:gap-6 md:text-left max-w-3xl justify-self-center">
  <h3>Írjon nekünk további segítségért</h3>  <p>Kapcsolatfelvétel előtt legyen kéznél a fiók e-mailje, a téma (regisztráció, fizetés, technikai) és szükség esetén képernyőképek. Minél világosabbak a részletek, annál gyorsabb a megoldás.</p>  <p>Az aktív ügyletekre vagy függő kifizetésekre vonatkozó kérések lehetőség szerint elsőbbséget kapnak. Biztonsága érdekében soha nem kérjük a teljes jelszót vagy a 2FA-kódokat kéretlen e-mailben.</p>  <p>Ha még nem regisztrált, nyisson fiókot perceken belül a regisztrációs oldalon, majd térjen vissza ide. Nézze meg a GYIK-et is a díjakról, a biztonságról és az elérhető piacokról.</p>  <p>Adjon meg világos tárgyat (pl. «Függő kifizetés», «2FA-probléma», «Díjkérdés»). A legtöbb megkeresés néhány órán belül első választ kap; nagy forgalom vagy fizetésellenőrzés hosszabbíthatja az időt.</p></div>
