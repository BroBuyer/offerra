...
$form_submit = $form_submit ?? 'Fiók létrehozása';
...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__text">
      A(z) <?= e(SITE_NAME) ?> felé küldött kérelmét megkaptuk. Várja tanácsadónk hívását.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <div class="apx-lead-row lead-form-row">
      <label class="apx-lead-field field" data-field="fname">
        <span class="field-label">Keresztnév</span>
        <input class="input" type="text" name="fname" placeholder="Keresztnév" required pattern="[^\d]+" autocomplete="given-name" minlength="2" maxlength="50" inputmode="text" autocapitalize="words" spellcheck="false" title="Csak betűket használjon (számok és szimbólumok nélkül)">
        <span class="field-error hide" role="alert" aria-live="polite"></span>
      </label>
    </div>
    <div class="apx-lead-row lead-form-row">
      <label class="apx-lead-field field" data-field="lname">
        <span class="field-label">Vezetéknév</span>
        <input class="input" type="text" name="lname" placeholder="Vezetéknév" required pattern="[^\d]+" autocomplete="family-name" minlength="2" maxlength="50" inputmode="text" autocapitalize="words" spellcheck="false" title="Csak betűket használjon (számok és szimbólumok nélkül)">
        <span class="field-error hide" role="alert" aria-live="polite"></span>
      </label>
    </div>
    <label class="apx-lead-field field" data-field="email">
      <span class="field-label">E-mail-cím</span>
      <input class="input" type="email" name="email" placeholder="E-mail-cím" required autocomplete="email" inputmode="email">
      <span class="field-error hide" role="alert" aria-live="polite"></span>
    </label>
    <label class="apx-lead-field apx-lead-field--phone lead-form-field lead-form-field--phone field" data-field="phone">
      <span class="field-label">Telefonszám</span>
    ...
    <div class="apx-lead-badges" aria-hidden="true">
      ...
      <img src="<?= asset('static/img/svg/payment-4.svg') ?>" alt="Biztonságos fizetés">
    </div>
  </div>
</form>
</div>
