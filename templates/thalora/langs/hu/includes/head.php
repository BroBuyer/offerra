...
$page_title = $page_title ?? (SITE_NAME . ' | Vezető MI-alapú kereskedési platform');
$page_description = $page_description ?? ('Érje el a kriptovalutákat, a forexet és a globális eszközöket egyetlen platformon. ' . SITE_NAME . ' élő elemzést, támogatott automatizálást és szakértői támogatást ötvöz.');
...
<?php endif; ?>
  ...
  <script>
  window.APP_LANG = {
    valPhoneInvalid: 'Adjon meg egy érvényes telefonszámot',
    valPhoneCountry: 'Érvénytelen országkód',
    valPhoneShort: 'A szám túl rövid',
    valPhoneLong: 'A szám túl hosszú',
    valPhoneEmpty: 'Adja meg a telefonszámát',
    valSessionExpired: 'A munkamenet lejárt. Frissítse az oldalt, és próbálja újra.',
    valGenericError: 'Valami hiba történt. Próbálja újra később.',
    valConnectionError: 'Kapcsolódási hiba. Ellenőrizze az internetet, és próbálja újra.'
  };
