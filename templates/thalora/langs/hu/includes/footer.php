    ...
    <div class="container-base">
      <div class="relative grid gap-7 md:gap-10">
        <div class="grid gap-5">
          <nav class="flex flex-col flex-wrap justify-between gap-x-10 gap-y-5 text-white md:flex-row">
            ...
            <ul class="flex flex-col gap-x-5 gap-y-4 md:flex-row md:gap-x-7 lg:gap-x-12">
              ...
              <li><a href="<?= page_url('product.php') ?>">Kereskedési platform</a></li>
            ...
            <ul class="flex flex-col gap-x-5 gap-y-4 md:flex-row">
              <li><a href="<?= page_url('privacy.php') ?>">Adatvédelmi tájékoztató</a></li>
              <li><a href="<?= page_url('conditions.php') ?>">Feltételek</a></li>
            </ul>
          </nav>
          <div class="flex justify-between gap-5">
            <div class="grid gap-5 text-white">
              <p style="color:var(--color-primary);">Megbízható partnere a kereskedésben</p>
        ...
        <div class="grid gap-2.5 text-sm text-gray-500">
            <p>
                <?= e(SITE_NAME) ?> nem vállal felelősséget az oldalon található információk — oktatási tartalom, árak, grafikonok vagy elemzések — használatából eredő veszteségekért vagy károkért. A pénzügyi instrumentumokkal való kereskedés jelentős kockázattal jár; mérje fel helyzetét. Kereskedés előtt konzultáljon tanácsadóval. Csak olyan tőkét kockáztasson, amelynek elvesztését megengedheti magának: a forex, a CFD-k és a kriptovaluták nem minden befektetőnek alkalmasak.
            </p>
        </div>
