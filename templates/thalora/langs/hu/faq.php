...
$page_title = 'Kereskedési GYIK | Feltöltés és biztonság | ' . SITE_NAME;
$page_description = 'Világos válaszok a regisztrációról, a minimális befizetésről, az eszközök biztonságáról, a kifizetésekről és a piaci hozzáférésről a(z) ' . SITE_NAME . '.';
$page_canonical = page_url("faq.php");
$active_page = "faq";
$schema_extra = ['breadcrumb' => schema_breadcrumb('GYIK', 'faq.php')];
...
<span class="breadcrumb-item">GYIK</span>
          </nav>
        </div>
      </div>
      <!-- contact -->
