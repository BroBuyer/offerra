...
$page_title = 'Nyissa meg fiókját | Kezdjen kereskedni a(z) ' . SITE_NAME;
$page_description = 'Állítsa be gyorsan a(z) ' . SITE_NAME . ' fiókját, hogy feloldja a fejlett MI-kereskedési funkciókat.';
$page_canonical = page_url("sign.php");
$active_page = "sign";
$schema_extra = ['breadcrumb' => schema_breadcrumb('Bejelentkezés / Regisztráció', 'sign.php')];
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      ...
      <span class="breadcrumb-item">Bejelentkezés / Regisztráció</span>
    </nav>
  </div>
</div>
      <!-- registration-1 -->
...
<h1>Nyissa meg <?= e(SITE_NAME) ?> fiókját még ma</h1>
