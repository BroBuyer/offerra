...
$page_title = 'Instruments de trading | Fonctionnalités enrichies par l’IA — ' . SITE_NAME;
$page_description = 'Utilisez les graphiques en direct, les insights IA et les outils de trading de ' . SITE_NAME . ', avec une sécurité de confiance.';
$page_canonical = page_url("product.php");
$active_page = "product";
$schema_extra = ['breadcrumb' => schema_breadcrumb('Fonctionnalités de la plateforme', 'product.php')];
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      <a href="<?= page_url() ?>" class="breadcrumb-item">Page d’accueil</a>
      <span class="breadcrumb-item">Fonctionnalités de la plateforme</span>
    </nav>
  </div>
</div>
      <!-- analytics -->
  ...
  <div class="container-base grid gap-6 lg:grid-cols-2">
    ...
    >
      <h1 class="relative z-20">Trading et analyses enrichis par l’IA</h1>
      <p class="relative z-20">
        Accédez à des insights marché et portefeuille étendus avec les analyses <?= e(SITE_NAME) ?>. Graphiques en temps réel, indicateurs intégrés et analyse IA pour des choix éclairés.      </p>
    </div>
    <div class="relative grid min-h-[355px] content-end">
      ...
      <div class="bg-before-custom relative z-30 grid grid-cols-2 gap-3 md:gap-6">
        <a class="btn btn-black col-span-full" href="<?= page_url('sign.php') ?>">S’inscrire</a>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-8 max-w-4xl">
    <p class="text-lg"><?= e(SITE_NAME) ?> propose une plateforme intégrée : outils de trading, suivi de marché étendu et automatisation assistée. Découvrez les fonctionnalités et les bénéfices au quotidien ci-dessous.</p>    <p>La plateforme donne accès à plusieurs marchés — cryptomonnaies, forex, actions et matières premières — avec des prix en direct. Gérez ordres et risques depuis un tableau de bord unique, sans jongler entre les applications.</p>    <p>Les outils d’analyse fusionnent données en temps réel et insights IA pour repérer tendances et mouvements importants. Ils éclairent vos décisions ; vous contrôlez stratégie, volumes et limites. L’interface vise la simplicité et une exécution efficace.</p>    <p>Sécurité et fiabilité sont au fondement : connexions chiffrées, protections de compte solides et processus de financement clairs. Adapté aux débutants comme aux experts, le service évolue du usage simple au trading avancé, sans changer de plateforme.</p>    <div class="grid gap-6 md:grid-cols-2">
            <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-3">Marchés et instruments de trading</h2>
        <p>Suivez devises numériques, forex, actions et matières premières avec outils intégrés, listes de surveillance et alertes. <?= e(SITE_NAME) ?> relie l’analyse à la gestion des ordres et du portefeuille.</p>
      </div>
                  <div class="border-primary rounded-custom border p-4 md:p-6">
        <h2 class="h3 mb-3">Transparence, sécurité et contrôle</h2>
        <p>Connexions sécurisées, procédures vérifiées, dépôts et retraits transparents. Les frais s’affichent avant confirmation.</p>
      </div>
          </div>
  </div>
</div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>Plateforme de trading dans le navigateur</h2>
      <div class="grid grid-cols-2 gap-x-8 gap-y-6">
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Marchés financiers</p>
        ...
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Insights de marché</p>
            <p>Accès rapide à des historiques de données complets</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Optimisé mobile</p>
            <p>Une expérience mobile fluide, partout</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Gestion des cryptomonnaies</p>
            <p>Gérez l’ensemble de votre portefeuille simplement</p>
          </div>
        </div>
      </div>
    </div>
    <div class="flex items-center justify-center">
        ...
        <img
          ...
          alt="<?= e(SITE_NAME) ?> — plateforme de trading sur mobile"
...
<div class="py-8 md:py-10">
  ...
  >
    ...
    >
      ...
      <p class="h3">Pays pris en charge</p>
    </div>
  </div>
</div>
      <!-- capabilities -->
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10">
    <h2>Fonctionnalités numériques</h2>
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Fonctionnalités d’investissement clés</p>
          <p>Une expertise mise en pratique via des projets concrets et des approches créatives.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Acquisition de crypto</p>
          <p>Un environnement sûr et simple pour acheter des cryptomonnaies. Traitement rapide, frais réduits. Commencez à trader tout de suite.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Analyses de marché</p>
          <p>Comprenez prix et tendances pour des décisions d’investissement éclairées.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Trading d’actifs numériques</p>
          <p>Tradez des contrats à terme crypto. Explorez, investissez et développez votre portefeuille.</p>
        </div>
      </div>
    </div>
  </div>
...
<p class="h2">Commencez dès maintenant</p>
<p>
