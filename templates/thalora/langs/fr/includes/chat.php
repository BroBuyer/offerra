...
<div id="chat-quiz-root" style="position: fixed !important; bottom: 20px !important; right: 20px !important; z-index: 999999 !important; font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, sans-serif !important; box-sizing: border-box !important;">
    ...
    <div id="chat-window" style="display: none; position: absolute !important; bottom: 0 !important; right: 0 !important; background-color: #121214 !important; border: 1px solid #27272a !important; border-radius: 20px !important; box-shadow: 0 25px 60px -10px rgba(0, 0, 0, 0.8) !important; flex-direction: column !important; overflow: hidden !important; transition: all 0.35s cubic-bezier(0.165, 0.84, 0.44, 1) !important; opacity: 0 !important; transform: translateY(20px) !important;">
        ...
        <div style="background-color: #1a1a1e !important; border-bottom: 1px solid #27272a !important; padding: 14px 18px !important; display: flex !important; align-items: center !important; justify-content: space-between !important; flex-direction: row !important;">
            <div style="display: flex !important; align-items: center !important; gap: 12px !important; flex-direction: row !important;">
                ...
                <div style="text-align: left !important;">
                    ...
                    <p style="color: #a1a1aa !important; font-size: 11px !important; margin: 0 !important; padding: 0 !important; opacity: 0.85;">Guide d’intégration</p>
                </div>
            </div>
            <button id="chat-close-btn" type="button" aria-label="Fermer le chat" style="color: #a1a1aa !important; background: transparent !important; border: none !important; cursor: pointer !important; padding: 6px !important; display: flex !important; align-items: center !important; transition: color 0.2s;">
        ...
        <div id="typing-indicator" style="display: none; padding: 10px 18px !important; font-size: 12px !important; color: #71717a !important; font-style: italic !important; background-color: #121214 !important; text-align: left !important;">
            Olivia est en train d’écrire...        </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const quizLang = {
        welcome: `Bonjour ! Je suis Olivia, votre guide d’intégration <?= e(SITE_NAME) ?>. Votre accès est préapprouvé. Commençons à constituer votre profil.`,
        q1: `Veuillez confirmer que vous résidez <?= e(geo_country_in()) ?> afin de respecter pleinement les exigences légales.`,
        a1_yes: `Oui, j’y vis actuellement`,
        a1_no: `Non`,
        q2: `Parfait. Sélectionnez votre tranche d’âge pour que nous recommandions des produits adaptés :`,
        q3: `Disposez-vous actuellement d’un compte bancaire ou d’une carte de crédit active pour recevoir des versements quotidiens ?`,
        a3_yes: `Oui, mon compte est actif`,
        a3_no: `Pas pour le moment`,
        q4: `Quelle est votre principale source de revenus ? Cela nous aide à adapter les paramètres de risque.`,
        a4_1: `Salarié ou indépendant`,
        a4_2: `Épargne ou revenus passifs`,
        a4_3: `Autres types de revenus`,
        q5: `Encore un instant ! Un membre de notre équipe vous appellera entre 11 h 00 et 20 h 00 pour une courte vérification. Pourrez-vous prendre l’appel ?`,
        a5_yes: `Oui, cet horaire me convient`,
        a5_no: `Contactez-moi bientôt`,
        loaderText: `Vérification de vos réponses et création de votre compte sécurisé...`,
        finalTitle: `Vérification terminée ! 🎉 Votre compte sécurisé est prêt. Suivez les instructions ci-dessous pour activer les versements quotidiens :`,
    ...
    function appendAgentMessage(text) {
        ...
        msg.innerHTML = `
            <div style="width: 28px; height: 28px; border-radius: 50%; border: 1px solid var(--color-primary); background-color: #27272a; display: flex; align-items: center; justify-content: center; overflow: hidden; flex-shrink: 0; margin-top: 2px;">
                <img alt="Image de la plateforme de trading" src="<?= asset('static/img/consultant.webp') ?>" width="28" height="28" decoding="async" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';" style="width:100%; height:100%; object-fit:cover;" class="cq-consultant-img">
