...
$page_title = 'Support | Assistance de l’équipe ' . SITE_NAME;
$page_description = 'Contactez l’équipe ' . SITE_NAME . ' pour les comptes, dépôts, retraits et questions sur la plateforme.';
$page_canonical = page_url("contacts.php");
$active_page = "contacts";
$schema_extra = ['breadcrumb' => schema_breadcrumb('Nous contacter', 'contacts.php')];
      ...
      <div class="pt-5">
        <div class="container-base">
          ...
          >
            ...
            <span class="breadcrumb-item">Nous contacter</span>
          </nav>
        </div>
      </div>
      <!-- contact -->
...
<h1>Nous contacter</h1>
  <p class="lead max-w-3xl justify-self-center text-center md:text-left">L’équipe <?= e(SITE_NAME) ?> répond aux questions sur les comptes, les dépôts, les retraits, les graphiques et les outils d’IA. L’assistance passe par les canaux officiels — pas de recommandation d’investissement personnalisée ni de garantie de profit.</p>
<div class="grid gap-4 text-center md:gap-6 md:text-left max-w-3xl justify-self-center">
  <h3>Écrivez-nous pour une assistance complémentaire</h3>  <p>Avant de nous écrire, préparez l’e-mail du compte, le sujet (inscription, paiement, technique) et d’éventuelles captures. Plus les détails sont clairs, plus la résolution est rapide.</p>  <p>Les demandes liées à des trades actifs ou des retraits en cours sont priorisées lorsque c’est possible. Pour votre sécurité, nous ne demanderons jamais votre mot de passe complet ni vos codes 2FA par e-mail non sollicité.</p>  <p>Si vous n’êtes pas encore inscrit, ouvrez un compte en quelques minutes sur la page d’inscription, puis revenez ici. Consultez aussi la FAQ pour les frais, la sécurité et les marchés disponibles.</p>  <p>Indiquez un objet clair (ex. « Retrait en cours », « Problème 2FA », « Question sur les frais »). La plupart des demandes reçoivent une première réponse sous quelques heures ; un fort volume ou des contrôles de paiement peuvent allonger le délai.</p></div>
