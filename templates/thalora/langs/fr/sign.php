...
$page_title = 'Ouvrez votre compte | Commencez à trader avec ' . SITE_NAME;
$page_description = 'Ouvrez rapidement votre compte ' . SITE_NAME . ' pour débloquer des capacités de trading IA avancées.';
$page_canonical = page_url("sign.php");
$active_page = "sign";
$schema_extra = ['breadcrumb' => schema_breadcrumb('Connexion / Inscription', 'sign.php')];
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      ...
      <span class="breadcrumb-item">Connexion / Inscription</span>
    </nav>
  </div>
</div>
      <!-- registration-1 -->
...
<h1>Ouvrez votre compte <?= e(SITE_NAME) ?> dès aujourd’hui</h1>
