...
<script>
window.APP_LANG = {
  valTeleponInvalid: <?= json_encode(t('val_phone_invalid'), JSON_UNESCAPED_UNICODE) ?>,
  valTeleponCountry: <?= json_encode(t('val_phone_country'), JSON_UNESCAPED_UNICODE) ?>,
  valTeleponShort: <?= json_encode(t('val_phone_short'), JSON_UNESCAPED_UNICODE) ?>,
  valTeleponLong: <?= json_encode(t('val_phone_long'), JSON_UNESCAPED_UNICODE) ?>,
  valTeleponRequired: <?= json_encode(t('val_phone_required'), JSON_UNESCAPED_UNICODE) ?>
};
</script>
