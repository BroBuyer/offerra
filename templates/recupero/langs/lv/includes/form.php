...
$form_submit = $form_submit ?? t('cta_start');
...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__title"><?= te('form_already_title') ?></p>
    <p class="form-already-registered__text"><?= te('form_already_text') ?></p>
  </div>
...
<?php endif; ?>
    ...
    <div class="form-grid ra-form-grid">
      <label class="field" data-field="fname">
        <span class="visually-hidden"><?= te('label_fname') ?></span>
        <input class="input" type="text" name="fname" placeholder="<?= te('ph_fname') ?>" required pattern="[^\d]+" autocomplete="given-name">
      </label>
      <label class="field" data-field="lname">
        <span class="visually-hidden"><?= te('label_lname') ?></span>
        <input class="input" type="text" name="lname" placeholder="<?= te('ph_lname') ?>" required pattern="[^\d]+" autocomplete="family-name">
      </label>
      <label class="field field-full" data-field="email">
        <span class="visually-hidden"><?= te('label_email') ?></span>
        <input class="input" type="email" name="email" placeholder="<?= te('ph_email') ?>" required autocomplete="email" inputmode="email">
      </label>
      <label class="field field-full" data-field="phone">
        <span class="visually-hidden"><?= te('label_phone') ?></span>
        <input class="input" type="tel" name="fullphone" placeholder="<?= te('ph_phone') ?>" autocomplete="tel" inputmode="tel">
