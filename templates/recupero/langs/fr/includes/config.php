<?php
define('SITE_NAME', 'Recupero AI');
define('SITE_URL', 'https://recuperoai-app.com');
define('SITE_LANG', 'fr');
...
define('CRM_FUNNEL', 'recuperoai');
define('CRM_COUNTRY', 'FR');
...
define('FORM_PHONE_COUNTRY', 'fr');
define('FORM_ALLOWED_COUNTRIES', 'fr');
