  ...
  <section class="hero">
    <div class="container hero-grid">
      <div class="hero-content">
        <p class="eyebrow">AI trading platform for <?= e($audience) ?></p>
        <h1>AI trading platform <?= e($brand) ?>:<br><span class="text-accent">automated analysis &amp; smarter trading</span></h1>
        <p class="lead">
