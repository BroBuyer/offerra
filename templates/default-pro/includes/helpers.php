...
function market_country_code(): string
{
    return strtoupper(trim((string) (defined('CRM_COUNTRY') ? CRM_COUNTRY : '')));
}

function market_country_name(): string
{
    $names = [
        'AE' => 'the UAE', 'AR' => 'Argentina', 'AT' => 'Austria', 'AU' => 'Australia',
        'BE' => 'Belgium', 'BG' => 'Bulgaria', 'BR' => 'Brazil', 'CA' => 'Canada',
        'CH' => 'Switzerland', 'CL' => 'Chile', 'CO' => 'Colombia', 'CR' => 'Costa Rica',
        'CZ' => 'Czechia', 'DE' => 'Germany', 'DK' => 'Denmark', 'DO' => 'the Dominican Republic',
        'EC' => 'Ecuador', 'ES' => 'Spain', 'FI' => 'Finland', 'FR' => 'France',
        'GB' => 'the United Kingdom', 'GE' => 'Georgia', 'GR' => 'Greece', 'HK' => 'Hong Kong',
    ...
    $code = market_country_code();

    return $names[$code] ?? ($code !== '' ? $code : 'your market');
}
