...
>
  <div class="form-already-registered hidden" data-already-registered>
    ...
    <p class="form-already-registered__text">
      Vi har mottagit din förfrågan hos <?= e(SITE_NAME) ?> Du blir snart oppringt av og spesialist.
    </p>
  </div>
...
<?php endif; ?>
    ...
    <button type="submit" class="btn btn-primary btn-block submit">Skapa <?= e(SITE_NAME) ?>-konto</button>
    ...
    <p class="form-legal">
      Genom att skicka in dina uppgifter godkänner du vår
      <a href="privacy.php">Integritetbeleid</a> and
