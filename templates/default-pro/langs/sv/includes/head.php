...
$page_title = $page_title ?? SITE_NAME . ' | Intelligent handelsplattform';
$page_description = $page_description ?? SITE_NAME . ' är en global handelsplattform utvecklad för users som vill ha jämn prestanda, snabb exekvering och full kontroll över miljön.';
