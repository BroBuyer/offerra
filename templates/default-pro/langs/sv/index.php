...
$page_title = page_title('Intelligent handelsplattform');
$page_description = $brand . ' är en global handelsplattform utvecklad för ' . $audience
    . ' som vill ha jämn prestanda, snabb exekvering och full kontroll över miljön.';
...
<main>
  ...
  <section class="hero">
    <div class="container hero-grid">
      <div class="hero-content">
        <p class="eyebrow">AI-handelsplattform <?= e($audience) ?></p>
        <h1>AI-handelsplattform <?= e($brand) ?>:<br><span class="text-accent">automatiserad analys och smartare trading</span></h1>
        <p class="lead">
        ...
        <a href="sign.php" class="btn btn-primary">Start med <?= e($brand) ?> — <?= MIN_DEPOSIT ?> <?= CURRENCY ?></a>
      </div>
  ...
  <section class="platform-section" id="platform" aria-label="<?= e($brand) ?> trading platform preview">
    <div class="container platform-layout">
      ...
      <div class="platform-copy">
        ...
        <a href="sign.php" class="btn btn-primary">Prøv <?= e($brand) ?></a>
      </div>
    </div>
  </section>
  ...
  <section class="section" id="about-platform" style="background: var(--surface); border-block: 1px solid var(--border);">
    <div class="container seo-prose">
      ...
      <p>
        ...
        Oppdag handelsverktygene til the product pages before exposing significant amounts.
      </p>
      <div class="seo-grid">
        <article class="feature-card">
  ...
  <section class="section-sm payment-section">
    <div class="container" style="max-width: 720px; margin-inline: auto; text-align: center;">
      ...
      <?php
      $payment_context = $brand . ' insättning och kontofinansiering';
  ...
  <section class="cta-band">
    <div class="container cta-band-grid">
      ...
      <div class="form-card">
        <?php
        $form_id = 'bottom-form';
        $form_heading = 'Skapa ditt konto bij ' . $brand . ' account';
        require __DIR__ . '/includes/form.php';
        ?>
      </div>
    </div>
