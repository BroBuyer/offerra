...
$page_title = page_title('Inteligentna platforma za trgovanje');
$page_description = $brand . ' je globalna platforma za trgovanje razvijena za ' . $audience
    . ' koji žele dosljedne rezultate, brzu izvršbu i potpunu kontrolu okruženja.';
...
<main>
  ...
  <section class="hero">
    <div class="container hero-grid">
      <div class="hero-content">
        <p class="eyebrow">AI platforma za trgovanje <?= e($audience) ?></p>
        <h1>AI platforma za trgovanje <?= e($brand) ?>:<br><span class="text-accent">automatizirana analiza i pametnije trgovanje</span></h1>
        <p class="lead">
        ...
        <a href="sign.php" class="btn btn-primary">Počnite s <?= e($brand) ?> — <?= MIN_DEPOSIT ?> <?= CURRENCY ?></a>
      </div>
  ...
  <section class="platform-section" id="platform" aria-label="<?= e($brand) ?> trading platform preview">
    <div class="container platform-layout">
      ...
      <div class="platform-copy">
        ...
        <a href="sign.php" class="btn btn-primary">Isprobajte <?= e($brand) ?></a>
      </div>
    </div>
  </section>
  ...
  <section class="section" id="how-it-works">
    <div class="container">
      <div class="section-header centered">
        ...
        <p class="lead">Registration is besplatno. Access to the full <?= e($brand) ?> desk follows verification and the stated minimum deposit.</p>
      </div>
  ...
  <section class="section" id="about-platform" style="background: var(--surface); border-block: 1px solid var(--border);">
    <div class="container seo-prose">
      ...
      <p>
        ...
        Istražite alate za trgovanje na the product pages before exposing significant amounts.
      </p>
      <div class="seo-grid">
        <article class="feature-card">
  ...
  <section class="section-sm payment-section">
    <div class="container" style="max-width: 720px; margin-inline: auto; text-align: center;">
      ...
      <?php
      $payment_context = $brand . ' depoziti i financiranje računa';
  ...
  <section class="cta-band">
    <div class="container cta-band-grid">
      ...
      <div class="form-card">
        <?php
        $form_id = 'bottom-form';
        $form_heading = 'Stvorite račun na ' . $brand . ' account';
        require __DIR__ . '/includes/form.php';
        ?>
      </div>
    </div>
