...
$page_description = 'Kontaktirajte podršku ' . SITE_NAME . ' support. Help for ' . market_audience() . ' on accounts, deposits, and the trading desk.';
    ...
    <div class="container" style="max-width: 640px; margin-inline: auto;">
      <div class="features-grid" style="grid-template-columns: 1fr;">
        ...
        <article class="feature-card">
          ...
          <a href="sign.php" class="btn btn-primary">Otvori <?= e(SITE_NAME) ?> račun</a>
        </article>
      </div>
    </div>
  </section>
