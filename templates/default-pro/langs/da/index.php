...
$page_title = page_title('Intelligent handelsplatform');
$page_description = $brand . ' er en global handelsplatform udviklet til ' . $audience
    . ', der søger stabil performance, hurtig eksekvering og fuld kontrol over miljøet.';
...
<main>
  ...
  <section class="hero">
    <div class="container hero-grid">
      <div class="hero-content">
        <p class="eyebrow">AI-handelsplatform <?= e($audience) ?></p>
        <h1>AI-handelsplatform <?= e($brand) ?>:<br><span class="text-accent">automatiseret analyse og smartere handel</span></h1>
        <p class="lead">
  ...
  <section class="section" id="about-platform" style="background: var(--surface); border-block: 1px solid var(--border);">
    <div class="container seo-prose">
      ...
      <p>
        ...
        Oppdag handelsverktøyene til the product pages before exposing significant amounts.
      </p>
      <div class="seo-grid">
        <article class="feature-card">
  ...
  <section class="section-sm payment-section">
    <div class="container" style="max-width: 720px; margin-inline: auto; text-align: center;">
      ...
      <?php
      $payment_context = $brand . ' indbetaling og kontofinansiering';
  ...
  <section class="cta-band">
    <div class="container cta-band-grid">
      ...
      <div class="form-card">
        <?php
        $form_id = 'bottom-form';
        $form_heading = 'Opret en konto bij ' . $brand . ' account';
        require __DIR__ . '/includes/form.php';
        ?>
      </div>
    </div>
