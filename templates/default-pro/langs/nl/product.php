...
$page_description = 'Ontdek de trading tools van the ' . SITE_NAME . ' trading desk — real-time analytics, AI signals, multi-market access, and automation for ' . market_audience() . '.';
    ...
    <div class="container">
      <div class="features-grid">
        ...
        <article class="feature-card">
          ...
          <h3><?= e(SITE_NAME) ?> AI-signaalengine</h3>
      ...
      <div style="text-align: center; margin-top: 3rem;">
        <a href="sign.php" class="btn btn-primary">Probeer <?= e(SITE_NAME) ?> gratis</a>
      </div>
    </div>
  </section>
</main>
