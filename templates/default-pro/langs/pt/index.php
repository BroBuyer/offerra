...
$page_title = page_title('Plataforma inteligente para trading');
$page_description = $brand . ' é uma plataforma global de trading desenvolvida para ' . $audience
    . ' que buscam desempenho consistente, execução rápida e controle total do ambiente.';
...
<main>
  ...
  <section class="hero">
    <div class="container hero-grid">
      <div class="hero-content">
        <p class="eyebrow">Plataforma de trading com IA <?= e($audience) ?></p>
        <h1>Plataforma de trading com IA <?= e($brand) ?>:<br><span class="text-accent">análise automatizada e trading mais inteligente</span></h1>
        <p class="lead">
        ...
        <a href="sign.php" class="btn btn-primary">Comece com <?= e($brand) ?> — <?= MIN_DEPOSIT ?> <?= CURRENCY ?></a>
      </div>
  ...
  <section class="platform-section" id="platform" aria-label="<?= e($brand) ?> trading platform preview">
    <div class="container platform-layout">
      ...
      <div class="platform-copy">
        ...
        <a href="sign.php" class="btn btn-primary">Experimente a <?= e($brand) ?></a>
      </div>
    </div>
  </section>
  ...
  <section class="section" id="how-it-works">
    <div class="container">
      <div class="section-header centered">
        ...
        <p class="lead">Registration is gratuitamente. Access to the full <?= e($brand) ?> desk follows verification and the stated minimum deposit.</p>
      </div>
  ...
  <section class="section" id="about-platform" style="background: var(--surface); border-block: 1px solid var(--border);">
    <div class="container seo-prose">
      ...
      <p>
        ...
        Explore as ferramentas de trading da the product pages before exposing significant amounts.
      </p>
      <div class="seo-grid">
        <article class="feature-card">
  ...
  <section class="section-sm payment-section">
    <div class="container" style="max-width: 720px; margin-inline: auto; text-align: center;">
      ...
      <?php
      $payment_context = $brand . ' depósitos e financiamento de conta';
    ...
    <div class="container">
      ...
      <div class="specs-table">
        ...
        <div class="specs-row specs-row-highlight">
          ...
          <div class="specs-value">24/7 <?= e($brand) ?> assistance — <a href="contacts.php" style="color: var(--accent); font-weight: 600;">Contactos</a></div>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="cta-band">
    <div class="container cta-band-grid">
      ...
      <div class="form-card">
        <?php
        $form_id = 'bottom-form';
        $form_heading = 'Crie a sua conta na ' . $brand . ' account';
        require __DIR__ . '/includes/form.php';
        ?>
      </div>
    </div>
