    ...
    $faq = [
        ...
        'mainEntity' => [
            ...
            [
                ...
                'acceptedAnswer' => [
                    '@type' => 'Answer',
                    'text' => 'Levantamentos can be requested anytime from the ' . $site . ' dashboard. Processing typically takes 1–3 business days depending on the method. Fees and timelines are shown on ' . $site . ' before you confirm.',
                ],
            ],
            [
                '@type' => 'Question',
