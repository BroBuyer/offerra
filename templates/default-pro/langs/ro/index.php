...
$page_title = page_title('Platformă inteligentă de trading');
$page_description = $brand . ' este o platformă globală de trading dezvoltată pentru ' . $audience
    . ' care vor performanță constantă, execuție rapidă și control total al mediului.';
...
<main>
  ...
  <section class="hero">
    <div class="container hero-grid">
      <div class="hero-content">
        <p class="eyebrow">Platformă de trading AI <?= e($audience) ?></p>
        <h1>Platformă de trading AI <?= e($brand) ?>:<br><span class="text-accent">analiză automată și trading mai inteligent</span></h1>
        <p class="lead">
        ...
        <a href="sign.php" class="btn btn-primary">Începe de la <?= e($brand) ?> — <?= MIN_DEPOSIT ?> <?= CURRENCY ?></a>
      </div>
  ...
  <section class="section" id="about-platform" style="background: var(--surface); border-block: 1px solid var(--border);">
    <div class="container seo-prose">
      ...
      <p>
        ...
        Descoperă instrumentele de tranzacționare the product pages before exposing significant amounts.
      </p>
      <div class="seo-grid">
        <article class="feature-card">
  ...
  <section class="section-sm payment-section">
    <div class="container" style="max-width: 720px; margin-inline: auto; text-align: center;">
      ...
      <?php
      $payment_context = $brand . ' depuneri și finanțarea contului';
  ...
  <section class="cta-band">
    <div class="container cta-band-grid">
      ...
      <div class="form-card">
        <?php
        $form_id = 'bottom-form';
        $form_heading = 'Creează-ți contul pe ' . $brand . ' account';
        require __DIR__ . '/includes/form.php';
        ?>
      </div>
    </div>
