  ...
  <section class="hero">
    <div class="container hero-grid">
      <div class="hero-content">
        <p class="eyebrow">Plateforme de trading IA <?= e($audience) ?></p>
        <h1>Plateforme de trading IA <?= e($brand) ?>:<br><span class="text-accent">analyse automatisée et trading plus intelligent</span></h1>
        <p class="lead">
        ...
        <a href="sign.php" class="btn btn-primary">Commencez avec <?= e($brand) ?> — <?= MIN_DEPOSIT ?> <?= CURRENCY ?></a>
      </div>
  ...
  <section class="platform-section" id="platform" aria-label="<?= e($brand) ?> trading platform preview">
    <div class="container platform-layout">
      ...
      <div class="platform-copy">
        ...
        <a href="sign.php" class="btn btn-primary">Essayez <?= e($brand) ?></a>
      </div>
    </div>
  </section>
  ...
  <section class="section" id="how-it-works">
    <div class="container">
      <div class="section-header centered">
        ...
        <p class="lead">Registration is gratuitement. Access to the full <?= e($brand) ?> desk follows verification and the stated minimum deposit.</p>
      </div>
