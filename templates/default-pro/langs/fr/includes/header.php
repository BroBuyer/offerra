...
<header class="site-header" data-header>
  <div class="container header-inner">
    <a href="<?= page_url() ?>" class="logo" aria-label="<?= e(SITE_NAME) ?> — page d'accueil">
    ...
    <nav class="nav-desktop" aria-label="Main navigation">
      ...
      <a href="product.php" class="<?= $active_page === 'product' ? 'is-active' : '' ?>">Produit</a>
      <a href="offer.php" class="<?= $active_page === 'offer' ? 'is-active' : '' ?>">Offre</a>
    ...
    <div class="header-actions">
      <a href="sign.php" class="btn btn-primary btn-sm">Ouvrir <?= e(SITE_NAME) ?></a>
  ...
  <nav class="nav-mobile" data-mobile-nav aria-label="Mobile navigation" hidden>
    ...
    <a href="sign.php" class="btn btn-primary">Ouvrir <?= e(SITE_NAME) ?></a>
  </nav>
</header>
