...
$page_title = page_title('Inteligentní obchodní platforma');
$page_description = $brand . ' je globální obchodní platforma vytvořená pro ' . $audience
    . ' hledající konzistentní výkon, rychlé plnění a plnou kontrolu nad prostředím.';
...
<main>
  ...
  <section class="hero">
    <div class="container hero-grid">
      <div class="hero-content">
        <p class="eyebrow">AI obchodní platforma <?= e($audience) ?></p>
        <h1>AI obchodní platforma <?= e($brand) ?>:<br><span class="text-accent">automatická analýza a chytřejší obchodování</span></h1>
        <p class="lead">
  ...
  <section class="section-sm payment-section">
    <div class="container" style="max-width: 720px; margin-inline: auto; text-align: center;">
      ...
      <?php
      $payment_context = $brand . ' vklady a financování účtu';
  ...
  <section class="cta-band">
    <div class="container cta-band-grid">
      ...
      <div class="form-card">
        <?php
        $form_id = 'bottom-form';
        $form_heading = 'Vytvořte si účet na ' . $brand . ' account';
        require __DIR__ . '/includes/form.php';
        ?>
      </div>
    </div>
