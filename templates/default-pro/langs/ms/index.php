...
$page_title = page_title('Platform dagangan pintar');
$page_description = $brand . ' ialah platform dagangan global yang dibangunkan untuk ' . $audience
    . ' yang mahu prestasi konsisten, pelaksanaan pantas dan kawalan penuh ke atas persekitaran.';
  ...
  <section class="hero">
    <div class="container hero-grid">
      <div class="hero-content">
        <p class="eyebrow">Platform dagangan AI <?= e($audience) ?></p>
        <h1>Platform dagangan AI <?= e($brand) ?>:<br><span class="text-accent">analisis automatik dan dagangan lebih pintar</span></h1>
        <p class="lead">
  ...
  <section class="stats" aria-label="<?= e($brand) ?> platform statistics">
    <div class="container stats-grid">
      <div class="stat-item">
        ...
        <div class="stat-label">Pasaran on <?= e($brand) ?></div>
      </div>
      <div class="stat-item">
