...
<main>
  ...
  <section class="section-sm">
    <div class="container prose">
      <p>This Politica de privacidad describes how <?= e(SITE_NAME) ?> ("we", "us") collects and processes personal information when you use our website and services.</p>
      ...
      <h2>Your rights</h2>
      <p>Depending on your jurisdiction, you may have rights to access, correct, or delete your personal data. Contacta con el soporte de <?= e(SUPPORT_EMAIL) ?> to exercise these rights.</p>

      <h2>Contacto</h2>
      <p>Questions about this policy? Correo electronico <a href="mailto:<?= e(SUPPORT_EMAIL) ?>" style="color: var(--accent);"><?= e(SUPPORT_EMAIL) ?></a></p>
    </div>
  </section>
</main>
