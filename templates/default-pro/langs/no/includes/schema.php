...
function render_schema(string $page = 'home', array $extra = []): void {
    ...
    $howto = [
        ...
        'step' => [
            ...
            ['@type' => 'HowToStep', 'position' => 3, 'name' => 'Fund your ' . $site . ' account', 'text' => 'Sett inn minst ' . MIN_DEPOSIT . ' ' . CURRENCY . ' via bank transfer, card, or e-wallet.'],
    ...
    if ($page === 'home') {
        ...
        $blocks[] = [
            '@context' => 'https://schema.org',
            '@type' => 'ImageObject',
            'name' => $site . ' AI Trading Plattform',
