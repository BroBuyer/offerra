...
$page_description = $brand . ' er en global handelsplattform utviklet for ' . $audience
    . ' som ønsker jevn ytelse, rask eksekvering og full kontroll over miljøet.';
...
<main>
  ...
  <section class="hero">
    <div class="container hero-grid">
      <div class="hero-content">
        ...
        <h1>AI-handelsplattform <?= e($brand) ?>:<br><span class="text-accent">automatisert analyse og smartere trading</span></h1>
        <p class="lead">
  ...
  <section class="section-sm payment-section">
    <div class="container" style="max-width: 720px; margin-inline: auto; text-align: center;">
      ...
      <?php
      $payment_context = $brand . ' innskudd og kontofinansiering';
  ...
  <section class="cta-band">
    <div class="container cta-band-grid">
      ...
      <div class="form-card">
        <?php
        $form_id = 'bottom-form';
        $form_heading = 'Opprett og konto bij ' . $brand . ' account';
        require __DIR__ . '/includes/form.php';
        ?>
      </div>
    </div>
