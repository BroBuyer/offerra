...
$page_title = $page_title ?? SITE_NAME . ' | インテリジェント取引プラットフォーム';
$page_description = $page_description ?? SITE_NAME . ' は、users 向けに開発されたグローバル取引プラットフォームです。安定したパフォーマンス、高速執行、環境の完全なコントロールを求めます。';
