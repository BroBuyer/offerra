...
$page_title = page_title('インテリジェント取引プラットフォーム');
$page_description = $brand . ' は、' . $audience
    . ' 向けに開発されたグローバル取引プラットフォームです。安定したパフォーマンス、高速執行、環境の完全なコントロールを求めます。';
  ...
  <section class="hero">
    <div class="container hero-grid">
      <div class="hero-content">
        <p class="eyebrow">AI取引プラットフォーム <?= e($audience) ?></p>
        <h1>AI取引プラットフォーム <?= e($brand) ?>:<br><span class="text-accent">自動分析と、よりスマートな取引</span></h1>
        <p class="lead">
    ...
    <div class="container">
      ...
      <div class="specs-table">
        ...
        <div class="specs-row specs-row-highlight">
          ...
          <div class="specs-value">24/7 <?= e($brand) ?> assistance — <a href="contacts.php" style="color: var(--accent); font-weight: 600;">お問い合わせ</a></div>
        </div>
      </div>
    </div>
  </section>
