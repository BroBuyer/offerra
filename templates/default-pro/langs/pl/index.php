...
$page_title = page_title('Inteligentna platforma tradingowa');
$page_description = $brand . ' to globalna platforma tradingowa stworzona dla ' . $audience
    . ' szukających stabilnych wyników, szybkiej realizacji i pełnej kontroli nad środowiskiem.';
  ...
  <section class="hero">
    <div class="container hero-grid">
      <div class="hero-content">
        <p class="eyebrow">Platforma tradingowa AI <?= e($audience) ?></p>
        <h1>Platforma tradingowa AI <?= e($brand) ?>:<br><span class="text-accent">automatyczna analiza i mądrzejszy trading</span></h1>
        <p class="lead">
        ...
        <a href="sign.php" class="btn btn-primary">Zacznij od <?= e($brand) ?> — <?= MIN_DEPOSIT ?> <?= CURRENCY ?></a>
      </div>
  ...
  <section class="platform-section" id="platform" aria-label="<?= e($brand) ?> trading platform preview">
    <div class="container platform-layout">
      ...
      <div class="platform-copy">
        ...
        <a href="sign.php" class="btn btn-primary">Wypróbuj <?= e($brand) ?></a>
      </div>
    </div>
  </section>
  ...
  <section class="section" id="how-it-works">
    <div class="container">
      <div class="section-header centered">
        ...
        <p class="lead">Registration is za darmo. Access to the full <?= e($brand) ?> desk follows verification and the stated minimum deposit.</p>
      </div>
