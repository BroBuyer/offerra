...
<header class="site-header" data-header>
  <div class="container header-inner">
    ...
    <nav class="nav-desktop" aria-label="Main navigation">
      <a href="<?= page_url() ?>" class="<?= $active_page === 'home' ? 'is-active' : '' ?>">Startseite</a>
    ...
    <div class="header-actions">
      <a href="sign.php" class="btn btn-primary btn-sm"><?= e(SITE_NAME) ?> öffnen</a>
  ...
  <nav class="nav-mobile" data-mobile-nav aria-label="Mobile navigation" hidden>
    ...
    <a href="sign.php" class="btn btn-primary"><?= e(SITE_NAME) ?> öffnen</a>
  </nav>
</header>
