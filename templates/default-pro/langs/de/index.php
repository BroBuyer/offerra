...
$page_title = page_title('Intelligente Handelsplattform');
$page_description = $brand . ' ist eine globale Handelsplattform für ' . $audience
    . ', die konstante Performance, schnelle Ausführung und volle Kontrolle über die Umgebung suchen.';
...
<main>
  ...
  <section class="hero">
    <div class="container hero-grid">
      <div class="hero-content">
        <p class="eyebrow">KI-Handelsplattform <?= e($audience) ?></p>
        <h1>KI-Handelsplattform <?= e($brand) ?>:<br><span class="text-accent">automatisierte Analyse und smarteres Trading</span></h1>
        <p class="lead">
        ...
        <a href="sign.php" class="btn btn-primary">Starten Sie mit <?= e($brand) ?> — <?= MIN_DEPOSIT ?> <?= CURRENCY ?></a>
      </div>
  ...
  <section class="section" id="about-platform" style="background: var(--surface); border-block: 1px solid var(--border);">
    <div class="container seo-prose">
      ...
      <p>
        ...
        Entdecken Sie die Trading-Tools von the product pages before exposing significant amounts.
      </p>
      <div class="seo-grid">
        <article class="feature-card">
  ...
  <section class="section-sm payment-section">
    <div class="container" style="max-width: 720px; margin-inline: auto; text-align: center;">
      ...
      <?php
      $payment_context = $brand . ' Einzahlungen und Kontofinanzierung';
  ...
  <section class="cta-band">
    <div class="container cta-band-grid">
      ...
      <div class="form-card">
        <?php
        $form_id = 'bottom-form';
        $form_heading = 'Erstellen Sie ein Konto bei ' . $brand . ' account';
        require __DIR__ . '/includes/form.php';
        ?>
      </div>
    </div>
