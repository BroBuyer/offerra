...
$page_description = 'Kontaktieren Sie den Support von ' . SITE_NAME . ' support. Help for ' . market_audience() . ' on accounts, deposits, and the trading desk.';
    ...
    <div class="container" style="max-width: 640px; margin-inline: auto;">
      <div class="features-grid" style="grid-template-columns: 1fr;">
        ...
        <article class="feature-card">
          ...
          <a href="sign.php" class="btn btn-primary"><?= e(SITE_NAME) ?>-Konto erstellen</a>
        </article>
      </div>
    </div>
  </section>
