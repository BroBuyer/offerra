...
$page_title = $page_title ?? SITE_NAME . ' | Intelligens kereskedési platform';
$page_description = $page_description ?? SITE_NAME . ' egy globális kereskedési platform, amelyet azoknak fejlesztettek, akik users – stabil teljesítményt, gyors végrehajtást és teljes kontrollt az környezet felett.';
