...
$page_description = 'GYIK for ' . $brand . ' — how the AI trading platform works for ' . $audience
...
<main>
  <section class="page-hero">
    <div class="container">
      <p class="eyebrow"><?= e($brand) ?> GYIK</p>
      <h1>Gyakran ismételt kérdések about <?= e($brand) ?></h1>
