...
$page_title = page_title('Platform trading pintar');
$page_description = $brand . ' ialah platform trading global yang dikembangkan untuk ' . $audience
    . ' yang mencari performa konsisten, eksekusi cepat dan kontrol penuh atas lingkungan.';
  ...
  <section class="hero">
    <div class="container hero-grid">
      <div class="hero-content">
        <p class="eyebrow">Platform trading AI <?= e($audience) ?></p>
        <h1>Platform trading AI <?= e($brand) ?>:<br><span class="text-accent">analisis otomatis dan trading lebih cerdas</span></h1>
        <p class="lead">
        ...
        <a href="sign.php" class="btn btn-primary">Start with <?= e($brand) ?> — <?= MIN_DEPOSIT ?> <?= CURRENCY ?></a>
      </div>
  ...
  <section class="stats" aria-label="<?= e($brand) ?> platform statistics">
    <div class="container stats-grid">
      <div class="stat-item">
        ...
        <div class="stat-label">Pasar on <?= e($brand) ?></div>
      </div>
      <div class="stat-item">
    ...
    <div class="container platform-layout">
      ...
      <div class="platform-copy">
        ...
        <ul class="platform-points">
          ...
          <li>Selamat <?= e($brand) ?> account area</li>
        </ul>
        <a href="sign.php" class="btn btn-primary">Try <?= e($brand) ?></a>
      </div>
    </div>
  </section>
  ...
  <section class="section" id="features">
    <div class="container">
      <div class="section-header">
        ...
        <p class="lead">Keamanan, speed, and AI-assisted analysis — one platform for <?= e($audience) ?> who want a single desk for several assets.</p>
      </div>
  ...
  <section class="section" id="how-it-works">
    <div class="container">
      <div class="section-header centered">
        ...
        <p class="lead">Registration is free. Access to the full <?= e($brand) ?> desk follows verification and the stated minimum deposit.</p>
      </div>
      ...
      <div class="steps">
        ...
        <article class="step-card">
          ...
          <p>Live charts, tickets, and Dukungan 24/7 stay in the same dashboard.</p>
        </article>
      </div>
  ...
  <section class="section-sm">
    <div class="container">
      <div class="section-header centered" style="margin-bottom: 2rem;">
        <p class="eyebrow">Dipercayai infrastructure</p>
    ...
    <div class="container" style="max-width: 800px; margin-inline: auto;">
      ...
      <div class="faq-list" data-faq>
        ...
        <div class="faq-item">
          ...
          <div class="faq-content">
            <div class="faq-content-inner">
              Complete the <?= e($brand) ?> form, finish verification, and open the dashboard. Deposit minimum is <?= MIN_DEPOSIT ?> <?= CURRENCY ?>.
            </div>
          </div>
        </div>
      </div>
  ...
  <section class="section-sm">
    <div class="container">
      ...
      <div class="specs-table">
        ...
        <div class="specs-row">
          <div class="specs-label">Pasar</div>
        ...
        <div class="specs-row specs-row-highlight">
          <div class="specs-label">Dukungan</div>
          <div class="specs-value">24/7 <?= e($brand) ?> assistance — <a href="contacts.php" style="color: var(--accent); font-weight: 600;">Hubungi</a></div>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section-sm">
    <div class="container">
      <div class="trust-card">
        <div>
          <span class="trust-badge">Dipercayai</span>
          <h3 style="margin-top: 0.75rem; font-size: 1.25rem;"><?= e($brand) ?> reviews</h3>
        </div>
        <div class="trust-score">4.7</div>
        <div class="trust-stars">★★★★★</div>
        <div class="trust-meta">
          <strong>342</strong> reviews · Berdasarkan <strong>1,842</strong> ratings of <?= e($brand) ?>
        </div>
      </div>
    </div>
  </section>
