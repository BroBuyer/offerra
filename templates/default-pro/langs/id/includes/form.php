...
<?php endif; ?>
    ...
    <button type="submit" class="btn btn-primary btn-block submit">Buat akun <?= e(SITE_NAME) ?></button>
    ...
    <p class="form-legal">
      Dengan mengirim detail Anda, Anda setuju dengan
      <a href="privacy.php">Kebijakan Privasi</a> and
      <a href="conditions.php">Ketentuan Penggunaan</a>.
    </p>
  </div>
</form>
