...
<header class="site-header" data-header>
  <div class="container header-inner">
    ...
    <nav class="nav-desktop" aria-label="Navigasi utama">
      <a href="<?= page_url() ?>" class="<?= $active_page === 'home' ? 'is-active' : '' ?>">Beranda</a>
      <a href="product.php" class="<?= $active_page === 'product' ? 'is-active' : '' ?>">Produk</a>
      <a href="offer.php" class="<?= $active_page === 'offer' ? 'is-active' : '' ?>">Penawaran</a>
    ...
    <div class="header-actions">
      <a href="sign.php" class="btn btn-primary btn-sm">Buka <?= e(SITE_NAME) ?></a>
  ...
  <nav class="nav-mobile" data-mobile-nav aria-label="Navigasi seluler" hidden>
    ...
    <a href="offer.php">Penawaran</a>
    <a href="contacts.php">Hubungi</a>
    <a href="faq.php">FAQ</a>
    <a href="sign.php" class="btn btn-primary">Buka <?= e(SITE_NAME) ?></a>
  </nav>
</header>
