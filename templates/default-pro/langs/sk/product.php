...
$page_description = 'Objevte obchodní nástroje the ' . SITE_NAME . ' trading desk — real-time analytics, AI signals, multi-market access, and automation for ' . market_audience() . '.';
    ...
    <div class="container">
      <div class="features-grid">
        ...
        <article class="feature-card">
          ...
          <h3><?= e(SITE_NAME) ?> AI signální engine</h3>
