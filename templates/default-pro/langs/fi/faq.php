...
$page_description = 'UKK for ' . $brand . ' — how the AI trading platform works for ' . $audience
...
<main>
  <section class="page-hero">
    <div class="container">
      <p class="eyebrow"><?= e($brand) ?> UKK</p>
      <h1>Usein kysytyt kysymykset about <?= e($brand) ?></h1>
