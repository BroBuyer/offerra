...
$page_title = page_title('Älykäs kaupankäyntialusta');
$page_description = $brand . ' on globaali kaupankäyntialusta, joka on kehitetty ' . $audience
    . ' jotka hakevat tasaista suorituskykyä, nopeaa toteutusta ja täyttä hallintaa ympäristöstä.';
  ...
  <section class="hero">
    <div class="container hero-grid">
      <div class="hero-content">
        <p class="eyebrow">AI-kaupankäyntialusta <?= e($audience) ?></p>
        <h1>AI-kaupankäyntialusta <?= e($brand) ?>:<br><span class="text-accent">automaattinen analyysi ja fiksumpi treidaus</span></h1>
        <p class="lead">
        ...
        <a href="sign.php" class="btn btn-primary">Aloita <?= e($brand) ?> — <?= MIN_DEPOSIT ?> <?= CURRENCY ?></a>
      </div>
  ...
  <section class="platform-section" id="platform" aria-label="<?= e($brand) ?> trading platform preview">
    <div class="container platform-layout">
      ...
      <div class="platform-copy">
        ...
        <a href="sign.php" class="btn btn-primary">Kokeile <?= e($brand) ?></a>
      </div>
    </div>
  </section>
  ...
  <section class="section" id="how-it-works">
    <div class="container">
      <div class="section-header centered">
        ...
        <p class="lead">Registration is -palvelua ilmaiseksi. Access to the full <?= e($brand) ?> desk follows verification and the stated minimum deposit.</p>
      </div>
  ...
  <section class="section" id="about-platform" style="background: var(--surface); border-block: 1px solid var(--border);">
    <div class="container seo-prose">
      ...
      <p>
        ...
        Tutustu the product pages before exposing significant amounts.
      </p>
      <div class="seo-grid">
        <article class="feature-card">
    ...
    <div class="container">
      ...
      <div class="specs-table">
        ...
        <div class="specs-row specs-row-highlight">
          ...
          <div class="specs-value">24/7 <?= e($brand) ?> assistance — <a href="contacts.php" style="color: var(--accent); font-weight: 600;">Yhteystiedot</a></div>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="cta-band">
    <div class="container cta-band-grid">
      ...
      <div class="form-card">
        <?php
        $form_id = 'bottom-form';
        $form_heading = 'Luo ' . $brand . ' account';
        require __DIR__ . '/includes/form.php';
        ?>
      </div>
    </div>
