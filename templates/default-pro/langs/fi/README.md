...
SEO-first fork of `default`: same layout, form, CRM and Keitaro, but the brand (`SITE_NAME`) and GEO (`CRM_COUNTRY`) are written into H1, title, UKK, article block, and inner pages.
