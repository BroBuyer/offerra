...
$page_title = $page_title ?? SITE_NAME . ' | Älykäs kaupankäyntialusta';
$page_description = $page_description ?? SITE_NAME . ' on globaali kaupankäyntialusta, joka on kehitetty users jotka hakevat tasaista suorituskykyä, nopeaa toteutusta ja täyttä hallintaa ympäristöstä.';
