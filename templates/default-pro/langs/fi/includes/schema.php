...
function render_schema(string $page = 'home', array $extra = []): void {
    ...
    $faq = [
        ...
        'mainEntity' => [
            ...
            [
                ...
                'acceptedAnswer' => [
                    '@type' => 'Answer',
                    'text' => 'Nostot can be requested anytime from the ' . $site . ' dashboard. Processing typically takes 1–3 business days depending on the method. Fees and timelines are shown on ' . $site . ' before you confirm.',
                ],
            ],
            [
                '@type' => 'Question',
    ...
    $howto = [
        ...
        'step' => [
            ...
            ['@type' => 'HowToStep', 'position' => 3, 'name' => 'Fund your ' . $site . ' account', 'text' => 'Talleta vähintään ' . MIN_DEPOSIT . ' ' . CURRENCY . ' via bank transfer, card, or e-wallet.'],
            ['@type' => 'HowToStep', 'position' => 4, 'name' => 'Set ' . $site . ' limits', 'text' => 'Valitse riskitaso ja kaupankäyntimieltymykset — manuaalisesti tai automatisoidusti.'],
