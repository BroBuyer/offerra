  ...
  <section class="section-sm">
    <div class="container prose">
      ...
      <ul>
        ...
        <li>Lakien ja sääntelyvelvoitteiden noudattamiseen</li>
        <li>Palveluidemme kehittämiseen ja petosten estämiseen</li>
      </ul>
      ...
      <h2>Oikeutesi</h2>
      <p>Oikeusalueestasi riippuen sinulla voi olla oikeus tarkastaa, korjata tai poistaa henkilötietosi. Ota yhteyttä osoitteeseen <?= e(SUPPORT_EMAIL) ?> käyttääksesi näitä oikeuksia.</p>

      <h2>Yhteystiedot</h2>
      <p>Kysymyksiä tästä käytännöstä? Lähetä sähköpostia osoitteeseen <a href="mailto:<?= e(SUPPORT_EMAIL) ?>" style="color: var(--accent);"><?= e(SUPPORT_EMAIL) ?></a></p>
    </div>
  </section>
</main>
