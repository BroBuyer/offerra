...
$page_title = $page_title ?? SITE_NAME . ' | Akıllı alım satım platformu';
$page_description = $page_description ?? SITE_NAME . ', users için geliştirilmiş küresel bir alım satım platformudur. İstikrarlı performans, hızlı emir iletimi ve ortam üzerinde tam kontrol arayanlara yöneliktir.';
