...
$page_title = page_title('Akıllı alım satım platformu');
$page_description = $brand . ', ' . $audience
    . ' için geliştirilmiş küresel bir alım satım platformudur. İstikrarlı performans, hızlı emir iletimi ve ortam üzerinde tam kontrol arayanlara yöneliktir.';
  ...
  <section class="hero">
    <div class="container hero-grid">
      <div class="hero-content">
        <p class="eyebrow">Yapay zekâ alım satım platformu <?= e($audience) ?></p>
        <h1>Yapay zekâ alım satım platformu <?= e($brand) ?>:<br><span class="text-accent">otomatik analiz ve daha akıllı işlem</span></h1>
        <p class="lead">
    ...
    <div class="container">
      ...
      <div class="specs-table">
        ...
        <div class="specs-row specs-row-highlight">
          ...
          <div class="specs-value">24/7 <?= e($brand) ?> assistance — <a href="contacts.php" style="color: var(--accent); font-weight: 600;">İletişim</a></div>
        </div>
      </div>
    </div>
  </section>
