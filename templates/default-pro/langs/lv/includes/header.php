...
<header class="site-header" data-header>
  <div class="container header-inner">
    ...
    <nav class="nav-desktop" aria-label="Main navigation">
      ...
      <a href="product.php" class="<?= $active_page === 'product' ? 'is-active' : '' ?>">Produkts</a>
      <a href="offer.php" class="<?= $active_page === 'offer' ? 'is-active' : '' ?>">Piedāvājums</a>
    ...
    <div class="header-actions">
      <a href="sign.php" class="btn btn-primary btn-sm">Atvērt <?= e(SITE_NAME) ?></a>
  ...
  <nav class="nav-mobile" data-mobile-nav aria-label="Mobile navigation" hidden>
    ...
    <a href="product.php">Produkts</a>
    <a href="offer.php">Piedāvājums</a>
    <a href="contacts.php">Kontakti</a>
    <a href="faq.php">FAQ</a>
    <a href="sign.php" class="btn btn-primary">Atvērt <?= e(SITE_NAME) ?></a>
  </nav>
</header>
