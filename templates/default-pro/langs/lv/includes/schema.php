...
function render_schema(string $page = 'home', array $extra = []): void {
    ...
    $faq = [
        ...
        'mainEntity' => [
            ...
            [
                ...
                'acceptedAnswer' => [
                    '@type' => 'Answer',
                    'text' => 'No. ' . $site . ' guides registration, deposit, and basic navigation for ' . market_audience() . '. Advanced tools stay available when you are ready. Atbalsts is available 24/7.',
                ],
            ],
            [
                '@type' => 'Question',
    ...
    $howto = [
        ...
        'step' => [
            ...
            ['@type' => 'HowToStep', 'position' => 3, 'name' => 'Fund your ' . $site . ' account', 'text' => 'Iemaksājiet vismaz ' . MIN_DEPOSIT . ' ' . CURRENCY . ' ar bankas pārskaitījumu, karti vai e-maku.'],
            ['@type' => 'HowToStep', 'position' => 4, 'name' => 'Set ' . $site . ' limits', 'text' => 'Izvēlieties riska līmeni un tirdzniecības preferences — manuāli vai automatizēti.'],
