...
<?php endif; ?>
    ...
    <button type="submit" class="btn btn-primary btn-block submit">Izveidot <?= e(SITE_NAME) ?> kontu</button>
    ...
    <p class="form-legal">
      Iesniedzot datus, jūs piekrītat mūsu
      <a href="privacy.php">Privātuma politika</a> and
