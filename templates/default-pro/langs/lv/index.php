...
$page_title = page_title('Intelektuāla tirdzniecības platforma');
$page_description = $brand . ' ir globāla tirdzniecības platforma, kas izstrādāta ' . $audience
    . ', kuri meklē stabilu veiktspēju, ātru izpildi un pilnīgu vides kontroli.';
  ...
  <section class="hero">
    <div class="container hero-grid">
      <div class="hero-content">
        <p class="eyebrow">AI tirdzniecības platforma <?= e($audience) ?></p>
        <h1>AI tirdzniecības platforma <?= e($brand) ?>:<br><span class="text-accent">automatizēta analīze un gudrāka tirdzniecība</span></h1>
        <p class="lead">
  ...
  <section class="stats" aria-label="<?= e($brand) ?> platform statistics">
    <div class="container stats-grid">
      <div class="stat-item">
        ...
        <div class="stat-label">Tirgi on <?= e($brand) ?></div>
      </div>
      <div class="stat-item">
  ...
  <section class="section-sm">
    <div class="container">
      <div class="section-header centered" style="margin-bottom: 2rem;">
        <p class="eyebrow">Uzticams infrastructure</p>
    ...
    <div class="container">
      ...
      <div class="specs-table">
        ...
        <div class="specs-row specs-row-highlight">
          ...
          <div class="specs-value">24/7 <?= e($brand) ?> assistance — <a href="contacts.php" style="color: var(--accent); font-weight: 600;">Kontakti</a></div>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section-sm">
    <div class="container">
      <div class="trust-card">
        <div>
          <span class="trust-badge">Uzticams</span>
          <h3 style="margin-top: 0.75rem; font-size: 1.25rem;"><?= e($brand) ?> reviews</h3>
        </div>
        <div class="trust-score">4.7</div>
        <div class="trust-stars">★★★★★</div>
        <div class="trust-meta">
          <strong>342</strong> reviews · Pamatojoties uz <strong>1,842</strong> ratings of <?= e($brand) ?>
        </div>
      </div>
    </div>
  </section>
