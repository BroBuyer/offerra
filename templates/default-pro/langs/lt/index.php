...
$page_title = page_title('Intelektuali prekybos platforma');
$page_description = $brand . ' yra pasaulinė prekybos platforma, sukurta ' . $audience
    . ', ieškantiems stabilaus našumo, greito vykdymo ir visiškos aplinkos kontrolės.';
  ...
  <section class="hero">
    <div class="container hero-grid">
      <div class="hero-content">
        <p class="eyebrow">AI prekybos platforma <?= e($audience) ?></p>
        <h1>AI prekybos platforma <?= e($brand) ?>:<br><span class="text-accent">automatinė analizė ir protingesnė prekyba</span></h1>
        <p class="lead">
  ...
  <section class="stats" aria-label="<?= e($brand) ?> platform statistics">
    <div class="container stats-grid">
      <div class="stat-item">
        ...
        <div class="stat-label">Rinkos on <?= e($brand) ?></div>
      </div>
      <div class="stat-item">
    ...
    <div class="container">
      ...
      <div class="specs-table">
        ...
        <div class="specs-row specs-row-highlight">
          ...
          <div class="specs-value">24/7 <?= e($brand) ?> assistance — <a href="contacts.php" style="color: var(--accent); font-weight: 600;">Susisiekite</a></div>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="trust-card">
        ...
        <div class="trust-meta">
          <strong>342</strong> reviews · Remiantis <strong>1,842</strong> ratings of <?= e($brand) ?>
        </div>
      </div>
    </div>
  </section>
