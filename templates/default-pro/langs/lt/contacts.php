...
$page_description = 'Susisiekite ' . SITE_NAME . ' support. Help for ' . market_audience() . ' on accounts, deposits, and the trading desk.';
    ...
    <div class="container" style="max-width: 640px; margin-inline: auto;">
      <div class="features-grid" style="grid-template-columns: 1fr;">
        ...
        <article class="feature-card">
          ...
          <a href="sign.php" class="btn btn-primary">Sukurti <?= e(SITE_NAME) ?> paskyrą</a>
        </article>
      </div>
    </div>
  </section>
