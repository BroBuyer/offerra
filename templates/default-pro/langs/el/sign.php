...
$page_description = 'Δημιουργήστε τον λογαριασμό σας στην ' . SITE_NAME . ' account and start trading with AI-powered tools. For ' . market_audience() . '. Minimum ' . MIN_DEPOSIT . ' ' . CURRENCY . '.';
