...
$page_description = 'Μάθετε πώς η ' . SITE_NAME . ' συλλέγει, χρησιμοποιεί και προστατεύει τα προσωπικά σας δεδομένα.';
...
<main>
  ...
  <section class="section-sm">
    <div class="container prose">
      <p>This Πολιτική Απορρήτου describes how <?= e(SITE_NAME) ?> ("we", "us") collects and processes personal information when you use our website and services.</p>
      ...
      <h2>Your rights</h2>
      <p>Depending on your jurisdiction, you may have rights to access, correct, or delete your personal data. Επικοινωνήστε με την υποστήριξη της <?= e(SUPPORT_EMAIL) ?> to exercise these rights.</p>
