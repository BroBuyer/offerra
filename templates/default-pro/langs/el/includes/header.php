...
<header class="site-header" data-header>
  <div class="container header-inner">
    <a href="<?= page_url() ?>" class="logo" aria-label="<?= e(SITE_NAME) ?> - αρχική σελίδα">
    ...
    <div class="header-actions">
      <a href="sign.php" class="btn btn-primary btn-sm">Άνοιγμα <?= e(SITE_NAME) ?></a>
  ...
  <nav class="nav-mobile" data-mobile-nav aria-label="Mobile navigation" hidden>
    ...
    <a href="sign.php" class="btn btn-primary">Άνοιγμα <?= e(SITE_NAME) ?></a>
  </nav>
</header>
