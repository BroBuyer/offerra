...
$page_title = $page_title ?? SITE_NAME . ' | Έξυπνη πλατφόρμα συναλλαγών';
$page_description = $page_description ?? SITE_NAME . ' είναι μια παγκόσμια πλατφόρμα συναλλαγών σχεδιασμένη για users που αναζητούν σταθερή απόδοση, γρήγορη εκτέλεση και πλήρη έλεγχο του περιβάλλοντος.';
