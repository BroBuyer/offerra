...
$page_title = page_title('Piattaforma intelligente per il trading');
$page_description = $brand . ' è una piattaforma globale di trading sviluppata per ' . $audience
    . ' che cercano performance costanti, esecuzione rapida e pieno controllo dell'ambiente.';
  ...
  <section class="hero">
    <div class="container hero-grid">
      <div class="hero-content">
        <p class="eyebrow">Piattaforma di trading IA <?= e($audience) ?></p>
        <h1>Piattaforma di trading IA <?= e($brand) ?>:<br><span class="text-accent">analisi automatizzata e trading più intelligente</span></h1>
        <p class="lead">
        ...
        <a href="sign.php" class="btn btn-primary">Inizia da <?= e($brand) ?> — <?= MIN_DEPOSIT ?> <?= CURRENCY ?></a>
      </div>
  ...
  <section class="platform-section" id="platform" aria-label="<?= e($brand) ?> trading platform preview">
    <div class="container platform-layout">
      ...
      <div class="platform-copy">
        ...
        <a href="sign.php" class="btn btn-primary">Prova <?= e($brand) ?></a>
      </div>
    </div>
  </section>
  ...
  <section class="section" id="about-platform" style="background: var(--surface); border-block: 1px solid var(--border);">
    <div class="container seo-prose">
      ...
      <p>
        ...
        Scopri gli strumenti di trading di the product pages before exposing significant amounts.
      </p>
      <div class="seo-grid">
        <article class="feature-card">
    ...
    <div class="container">
      ...
      <div class="specs-table">
        ...
        <div class="specs-row specs-row-highlight">
          ...
          <div class="specs-value">24/7 <?= e($brand) ?> assistance — <a href="contacts.php" style="color: var(--accent); font-weight: 600;">Contatti</a></div>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="cta-band">
    <div class="container cta-band-grid">
      ...
      <div class="form-card">
        <?php
        $form_id = 'bottom-form';
        $form_heading = 'Crea il tuo account su ' . $brand . ' account';
        require __DIR__ . '/includes/form.php';
        ?>
      </div>
    </div>
