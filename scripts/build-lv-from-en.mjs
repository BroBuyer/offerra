/**
 * Copy an English template tree into langs/lv and apply EN→Latvian replacements.
 *
 * Usage:
 *   node scripts/build-lv-from-en.mjs noctra
 *   node scripts/build-lv-from-en.mjs default
 *   node scripts/build-lv-from-en.mjs multilang
 */
import fs from 'fs';
import path from 'path';
import { fileURLToPath } from 'url';
import thaloraLv from './thalora-i18n/lv.mjs';
...
const TEMPLATES = {
  noctra: { src: 'templates/noctra', dest: 'templates/noctra/langs/lv' },
  default: { src: 'templates/default', dest: 'templates/default/langs/lv' },
  multilang: { src: 'templates/multilang', dest: 'templates/multilang/langs/lv' },
};
