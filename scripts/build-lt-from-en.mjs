/**
 * Copy an English template tree into langs/lt and apply EN→Lithuanian replacements.
 *
 * Usage:
 *   node scripts/build-lt-from-en.mjs noctra
 *   node scripts/build-lt-from-en.mjs default
 *   node scripts/build-lt-from-en.mjs multilang
 */
import fs from 'fs';
import path from 'path';
import { fileURLToPath } from 'url';
import thaloraLt from './thalora-i18n/lt.mjs';
...
const TEMPLATES = {
  noctra: { src: 'templates/noctra', dest: 'templates/noctra/langs/lt' },
  default: { src: 'templates/default', dest: 'templates/default/langs/lt' },
  multilang: { src: 'templates/multilang', dest: 'templates/multilang/langs/lt' },
};
